...
in {
  ...
  ceph-single-node-bluestore =
    handleTestOn [ "x86_64-linux" ] ./ceph-single-node-bluestore.nix { };
  ...
  mastodon = handleTestOn [ "x86_64-linux" "i686-linux" "aarch64-linux" ]
    ./web-apps/mastodon.nix { };
  ...
  podman-dnsname =
    handleTestOn [ "aarch64-linux" "x86_64-linux" ] ./podman/dnsname.nix { };
