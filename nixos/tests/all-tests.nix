...
in {
  ...
  cassandra_2_1 =
    handleTest ./cassandra.nix { testPackage = pkgs.cassandra_2_1; };
  cassandra_2_2 =
    handleTest ./cassandra.nix { testPackage = pkgs.cassandra_2_2; };
  cassandra_3_0 =
  ...
  firefox-esr-91 =
    handleTest ./firefox.nix { firefoxPackage = pkgs.firefox-esr-91; };
  ...
  mariadb-galera-mariabackup =
    handleTest ./mysql/mariadb-galera-mariabackup.nix { };
  ...
  podman-tls-ghostunnel =
    handleTestOn [ "x86_64-linux" ] ./podman-tls-ghostunnel.nix { };
