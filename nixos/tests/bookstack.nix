...
in
{
  ...
  testScript = ''
    bookstackMysql1.wait_for_unit("phpfpm-bookstack.service")
    bookstackMysql1.wait_for_unit("nginx.service")
    bookstackMysql1.wait_for_unit("mysql.service")
    bookstackMysql1.succeed("curl -fvvv -Ls http://localhost/ | grep 'Log In'")
    bookstackMysql2.wait_for_unit("phpfpm-bookstack.service")
    bookstackMysql2.wait_for_unit("nginx.service")
    bookstackMysql2.wait_for_unit("mysql.service")
    bookstackMysql2.succeed("curl -fvvv -Ls http://localhost/ | grep 'Log In'")
  '';
}
