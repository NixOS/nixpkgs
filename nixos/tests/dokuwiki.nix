import ./make-test-python.nix ({ pkgs, ... }:
  ...
  let
    template-bootstrap3 = pkgs.stdenv.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://github.com/giterlizzi/dokuwiki-template-bootstrap3/archive/v2019-05-22.zip";
        sha256 =
    ...
    plugin-icalevents = pkgs.stdenv.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://github.com/real-or-random/dokuwiki-plugin-icalevents/releases/download/2017-06-16/dokuwiki-plugin-icalevents-2017-06-16.zip";
        sha256 =
          "e40ed7dd6bbe7fe3363bbbecb4de481d5e42385b5a0f62f6a6ce6bf3a1f9dfa8";
      };
      # We need unzip to build this package
      nativeBuildInputs = [ pkgs.unzip ];
      sourceRoot = ".";
  ...
  in {
    name = "dokuwiki";
    meta = with pkgs.lib; {
      maintainers = with maintainers; [ _1000101 onny ];
    };
