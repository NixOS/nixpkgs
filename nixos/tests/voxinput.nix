...

{
  ...
  nodes.machine =
    { config, ... }:
    {
      imports = [
        ...
        # Second module setting environment to test that attrsOf str merges across modules
        { services.voxinput.environment.VOXINPUT_LANG = "en"; }
      ];
  ...
  testScript =
    ...
    ''
      ...
      t.assertIn("VOXINPUT_LANG=en", env)
