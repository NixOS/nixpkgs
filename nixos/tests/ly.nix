...
in
{
  ...
  testScript =
    ...
    ''
      ...
      machineShell.wait_until_tty_matches("2", "password:")
      machineShell.send_key("ctrl-alt-f2")
      ...
      machineShell.wait_until_tty_matches("2","alice@machineShell")
      machineShell.send_chars("echo The shell is alive.")
      machineShell.send_key("ret")
      machineShell.wait_until_tty_matches("2","alive")
      machineShell.sleep(1)
