            ...
            prometheusSeleniumScript =
              pkgs.writers.writePython3Bin "prometheus-selenium-script"
                ...
                ''
                  ...
                  query_execute_button = driver.find_element(
                  ...
                  status_link = driver.find_element(
                    By.XPATH, "//span[text()='Status']").click()

                  targets_link = driver.find_element(
                  ...
                  # Go back to homepage
                  query_link = driver.find_element(
                  ...
                  runtime_link = driver.find_element(
