  ...
  pamOpts = { config, name, ... }: let cfg = config; in let config = parentConfig; in {
    ...
    config = {
      ...
      text = mkDefault
        ...
        (optionalString (cfg.unixAuth && (config.security.pam.enableEcryptfs || cfg.pamMount || cfg.enableKwallet || cfg.enableGnomeKeyring || cfg.googleAuthenticator.enable || cfg.duoSecurity.enable)) ''
          ...
          ${optionalString cfg.enableKwallet
            ("auth optional ${pkgs.plasma5.kwallet-pam}/lib/security/pam_kwallet5.so" + " kwalletd=${pkgs.libsForQt5.kwallet.bin}/bin/kwalletd5")}
        ...
        ''}
          ...
          ${optionalString (cfg.enableKwallet)
            ("session optional ${pkgs.plasma5.kwallet-pam}/lib/security/pam_kwallet5.so" + " kwalletd=${pkgs.libsForQt5.kwallet.bin}/bin/kwalletd5")}
          ${optionalString (cfg.enableGnomeKeyring)
