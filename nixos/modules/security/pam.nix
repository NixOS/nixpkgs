...
in
{
  ...
  config = {
    ...
    environment.systemPackages =
      ...
      [ package ]
      ++ lib.optionals config.users.ldap.enable [ pam_ldap ]
      ++ lib.optionals config.services.kanidm.enablePam [ config.services.kanidm.package ]
      ++ lib.optionals config.services.sssd.enable [ pkgs.sssd ]
