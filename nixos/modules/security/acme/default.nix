  ...
  certToConfig =
    ...
    in
    {
      ...
      baseService = lockfileName: {
        ...
        wants = [ "acme-setup.service" "acme-order-renew-${cert}.service" ];
        ...
        unitConfig = {
          # "X-OnlyManualStart" = true; # XXX yes, no, maybe?
      ...
      orderRenewService = lockfileName: {
        ...
        wants = [ "network-online.target" "acme-setup.service" "acme-${cert}.service"];
