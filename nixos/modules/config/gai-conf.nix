...
let
  ...
  gaiConfText = lib.concatStringsSep "\n" (
    [
      "# Generated by NixOS module networking.gaiConf"
...
in
{
  options.networking.gaiConf = {
    ...
    precedence = lib.mkOption {
      ...
      default = null;
      description = ''
        Similar to {option}`networking.gaiConf.label`, but this option
