...

{
  options = {
    environment.noXlibs = lib.mkOption {
      ...
      default = false;
      description = ''
        This is an advanced options that switches off options in the default configuration that require GUI libraries
        ...
        When enabling this option you should be able to recognize such build failures and act accordingly on them.
        :::
      '';
    };
  };
