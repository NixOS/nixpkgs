  ...
  options = {
    ...
    hardware.pulseaudio = {
      ...
      extraConfigPre = mkOption {
        ...
        default = "";
        description = ''
          Literal string to prepend to `configFile`
          and the config file generated by the pulseaudio module.

          Use this instead of `extraConfig` when you wish to alter module
          arguments which cannot be done once the main config file has been
          loaded.
        '';
      };
