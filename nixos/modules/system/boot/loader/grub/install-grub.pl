...
my $efiSysMountPointRoot = $grubBoot;
if ($bootPath ne $efiSysMountPoint){
    # efiSysMountPoint is a mount point.
    $efiSysMountPointRoot = GrubFs($efiSysMountPoint);
}
# Generate the header.
