    ...
    system.build.virtualBoxOVA = import ../../lib/make-disk-image.nix {
      ...
      postVM = ''
        ...
        VBoxManage modifyvm "$vmName" \
          ...
          ${lib.cli.toCommandLineShell lib.cli.gnuOptionFormat cfg.params}
        VBoxManage storagectl "$vmName" ${lib.cli.toCommandLineShell lib.cli.gnuOptionFormat cfg.storageController}
