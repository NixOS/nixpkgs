  ...
  options = {
    services.alertmanager-executor = {
      ...
      user = mkOption {
        ...
        description = lib.mdDoc "User to run the service and executed commands under.";
      };

      group = mkOption {
        type = types.str;
        default = "alertmanager-executor";
        description = lib.mdDoc "Group to run the service and executed commands under.";
      };
      ...
      extraFlags = mkOption {
        ...
        default = [];
        example = [ "-v" ];
        description = lib.mdDoc "Extra flags passed to the program.";
      };
