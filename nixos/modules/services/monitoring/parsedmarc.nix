    ...
    services.grafana = {
      ...
      provision = {
        ...
        datasources = let
          ...
          esVersion =
            if lib.versionOlder pkgVer "7"
            then "60"
            else if lib.versionOlder pkgVer "8"
            then "70"
            else throw "When provisioning parsedmarc grafana datasources: unknown Elasticsearch version.";
        in
