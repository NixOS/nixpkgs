...
in
{
  ...
  options.services.otelite = {
    ...
    retentionDays = lib.mkOption {
      type = lib.types.ints.between 0 365;
      default = 90;
      description = ''
        Number of days to retain telemetry data. Set to 0 to disable automatic purging and retain
        data indefinitely.
      '';
    };
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.otelite = {
      ...
      environment = {
        ...
        OTELITE_RETENTION_DAYS = toString cfg.retentionDays;
      };
