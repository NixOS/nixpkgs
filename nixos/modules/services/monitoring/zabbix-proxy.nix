...

{
  ...
  options = {
    ...
    services.zabbixProxy = {
      enable = lib.mkEnableOption "the Zabbix Proxy";
      ...
      package = lib.mkOption {
        ...
        defaultText = lib.literalExpression "pkgs.zabbix.proxy-pgsql";
      ...
      database = {
        ...
        name = lib.mkOption {
          ...
          defaultText = lib.literalExpression "zabbix";
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.zabbixProxy.settings = lib.mkMerge [
      {
        LogType = "console";
