  ...
  options = {
    services.uptime-kuma = {
      ...
      package = lib.mkPackageOption pkgs "uptime-kuma" { } // {
        default = if lib.versionOlder stateVersion "25.11" then pkgs.uptime-kuma else pkgs.uptime-kuma_2;
        defaultText = lib.literalExpression ''if lib.versionOlder config.system.stateVersion "25.11" then pkgs.uptime-kuma else pkgs.uptime-kuma_2'';
      };
