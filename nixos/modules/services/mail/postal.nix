        ...
        options = {
          postal = {
            ...
            signing_key_path = mkOption {
              ...
              description = "Path to the signing private key, will be automaticaly generated by default";
            };
          };
      ...
      in
      {
        postal-update = serviceDefaults // {
          ...
          serviceConfig = serviceConfigDefaults // {
            ...
            ExecStartPre = optionals (cfg.settings.postal.signing_key_path == "/var/lib/signing.key") (
              pkgs.writeShellScript "postal-generate-signing-key" ''
                if ! test -f "${cfg.settings.postal.signing_key_path}" ; then
                  ${lib.getExe pkgs.openssl} genrsa 4096 > "${cfg.settings.postal.signing_key_path}"
                fi
              ''
            );
          };
