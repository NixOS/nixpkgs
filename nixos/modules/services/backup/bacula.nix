    ...
    options = {
      ...
      verifyPeer = mkOption {
        ...
        description = mdDoc ''
          ...
          If the TLSAllowed CN configuration directive is used,
          the client's x509 certificate Common Name must also correspond to
          one of the CN specified in the TLS Allowed CN directive.
      ...
      caCertificateFile = mkOption {
        ...
        One of TLS CA Certificate File or TLS CA Certificate Dir are required in a server context, unless TLS
