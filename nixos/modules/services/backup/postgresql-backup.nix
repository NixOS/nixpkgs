...
in
{
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      ...
      {
        assertion = cfg.backupAllExcept != [ ] -> cfg.databases == [ ];
        message = "services.postgresqlBackup.backupAllExcept cannot be used together with services.postgresqlBackup.databases";
      }
      {
