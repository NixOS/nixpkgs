...
in
{
  options.services.meowlnir = {
    ...
    registration = lib.mkOption {
      ...
      description = ''
        See https://docs.mau.fi/bridges/general/registering-appservices.html for more information.
      '';
    };
    ...
    systemd.services = {
      ...
      meowlnir-registration = {
        ...
        script = ''
          ...
          config_has_tokens=$(yq '.meowlnir | has("as_token") and has("hs_token")' '${settingsFile}')
          ...
          if [[ $config_has_tokens == "false" && $registration_already_exists == "true" ]]; then
            ...
            yq -sY '.[0].meowlnir.as_token = .[1].as_token
              | .[0].meowlnir.hs_token = .[1].hs_token
          ...
          if [[ $config_has_tokens == "true" || $registration_already_exists == "true" ]]; then
            ...
            yq -sY '.[1].as_token = .[0].meowlnir.as_token
              | .[1].hs_token = .[0].meowlnir.hs_token
