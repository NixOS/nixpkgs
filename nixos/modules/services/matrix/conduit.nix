      ...
      type = lib.types.submodule {
        ...
        options = {
          ...
          global.database_backend = lib.mkOption {
            ...
            default = if lib.versionAtLeast config.system.stateVersion "26.11" then "rocksdb" else "sqlite";
            defaultText = lib.literalExpression ''if lib.versionAtLeast config.system.stateVersion "26.11" then "rocksdb" else "sqlite"'';
            description = ''
