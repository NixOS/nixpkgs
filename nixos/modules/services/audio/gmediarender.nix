...
in
{
  options.services.gmediarender = {
    ...
    uuid = lib.mkOption {
      ...
      default = null;
      description = ''
        A UUID for lib.uniquely identifying the endpoint.  If you have
      ...
      services.gmediarender = {
        ...
        serviceConfig = {
          ...
          ExecStart =
            ...
            lib.optionalString (cfg.audioDevice != null) ("--gstout-audiodevice=${utils.lib.escapeSystemdExecArg cfg.audioDevice} ") +
            lib.optionalString (cfg.audioSink != null) ("--gstout-audiosink=${utils.lib.escapeSystemdExecArg cfg.audioSink} ") +
            lib.optionalString (cfg.friendlyName != null) ("--friendly-name=${utils.lib.escapeSystemdExecArg cfg.friendlyName} ") +
            ...
            lib.optionalString (cfg.uuid != null) ("--uuid=${utils.lib.escapeSystemdExecArg cfg.uuid} ");
          Restart = "always";
