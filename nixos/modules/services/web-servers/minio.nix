  ...
  config = mkIf cfg.enable {
    ...
    systemd = lib.mkMerge [{
      ...
      services.minio = {
        ...
        serviceConfig = {
          ExecStart = "${cfg.package}/bin/minio server --json --address ${cfg.listenAddress} --console-address ${cfg.consoleAddress} --certs-dir=${cfg.certsDir} ${toString cfg.dataDir}";
          Type = "simple";
          User = "minio";
          Group = "minio";
          LimitNOFILE = 65536;
