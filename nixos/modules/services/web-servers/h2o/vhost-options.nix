          ...
          options = {
            ...
            useHost = mkOption {
              ...
              description = ''
                ...
                Note that this option neither create any certificates nor does it
                add subdomains to existing ones — you will need to create them
            ...
            # TODO: probably requires Mruby scripting to implement
            #fallbackHost = mkOption {
            #  type = types.nullOr types.nonEmptyStr;
            #  default = null;
            #};
          };
