...
in
{
  imports = [
    ...
    (mkAliasOptionModule [ "services" "nginx" "tailscaleAuth" "expectedTailnet" ] [ "services" "tailscaleAuth" "expectedTailnet" ])
    ...
    services.nginx.virtualHosts = genAttrs
      ...
      (vhost: {
        ...
        locations."/".extraConfig = ''
          ...
          ${lib.optionalString (cfgAuth.expectedTailnet != "") ''proxy_set_header Expected-Tailnet "${cfgAuth.expectedTailnet}";''}
        '';
      });
  };
