...

{
  options = {
    ...
    app.python = lib.mkOption {
      ...
      defaultText = lib.literalExpression "services.gunicorn.instances.<name>.app.package.python";
      description = ''
    ...
    app.module = lib.mkOption {
      ...
      defaultText = lib.literalExpression "services.gunicorn.instances.<name>.app.package.wsgiModule";
      description = ''
    ...
    process.group = lib.mkOption {
      type = lib.types.nullOr lib.types.str;
      default = null;
      description = "Group as which this instance of gunicorn will be run.";
    };
