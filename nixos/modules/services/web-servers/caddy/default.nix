  ...
  options.services.caddy = {
    ...
    admin = mkOption {
      ...
      description = ''
        ...
        unix socket named `admin.sock` located in Caddy's data directory.
    ...
    enableReload = mkOption {
      ...
      description = ''
        ...
        to be enabled (will be turned on by default transitively through the default admin API configuration).
