...
Currently, the NixOS firewall must be disabled to connect to the NordVPN service,
as its rules conflict with NordVPN’s firewall requirements.
...
**Disclaimer:** Currently firewall must be disabled to use NordVPN.
