        ...
        type = with lib.types; attrsOf (submodule ({ config, ... }: {
          options = {
            ...
            debugLevel = lib.mkOption {
              default = 0;
              type = lib.types.addCheck lib.types.int (l: l >= 0 && l <= 5);
              description = ''
          ...
          config = {
            ...
            settings = {
              ...
              Ed25519PrivateKeyFile = lib.mkIf (config.ed25519PrivateKeyFile != null) (lib.mkDefault config.ed25519PrivateKeyFile);
              PrivateKeyFile = lib.mkIf (config.rsaPrivateKeyFile != null) (lib.mkDefault config.rsaPrivateKeyFile);
              ListenAddress = lib.mkIf (config.listenAddress != null) (lib.mkDefault config.listenAddress);
              BindToAddress = lib.mkIf (config.bindToAddress != null) (lib.mkDefault config.bindToAddress);
            };
          };
        }));
