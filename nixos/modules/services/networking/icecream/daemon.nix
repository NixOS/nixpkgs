  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.icecc-daemon = {
      ...
      serviceConfig = {
        ...
        ++ lib.optionals (cfg.schedulerHost != null) ["-s" cfg.schedulerHost]
        ++ lib.optionals (cfg.netName != null) [ "-n" cfg.netName ]
        ++ lib.optionals (cfg.cacheLimit != null) [ "--cache-limit" (toString cfg.cacheLimit) ]
        ++ lib.optionals (cfg.maxProcesses != null) [ "-m" (toString cfg.maxProcesses) ]
        ++ lib.optionals (cfg.hostname != null) [ "-N" (cfg.hostname) ]
