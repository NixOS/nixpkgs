...

{
  ...
  options.services.minidlna.user = mkOption {
    ...
    default = defaultUser;
    example = "yourUser";
    description = lib.mdDoc "Overrides the default user used to run MiniDLNA.  Skips the creation of the default `${defaultUser}` user.";
  };
  ...
  options.services.minidlna.group = mkOption {
    ...
    example = "yourGroup";
    description = lib.mdDoc "Overrides the default group used to run MiniDLNA.  Skips the creation of the default `${defaultGroup}` group.";
  };
