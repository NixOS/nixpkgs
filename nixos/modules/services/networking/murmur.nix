...
in
{
  ...
  options = {
    services.murmur = {
      ...
      clientCertRequired = lib.mkOption {
        type = lib.types.bool;
        default = false;
      ...
      dbus = lib.mkOption {
        type = lib.types.enum [ null "session" "system" ];
        default = null;
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.dbus.packages = lib.mkIf (cfg.dbus == "system") [(pkgs.writeTextFile {
