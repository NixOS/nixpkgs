...
let
  ...
  makeOpenVPNJob = cfg: name:
    let
      ...
      hasUpScript =
        cfg.up != "" || cfg.updateResolvConf || cfg.updatedResolved;

      hasDownScript =
        cfg.down != "" || cfg.updateResolvConf || cfg.updatedResolved;
      ...
      upScript = ''
        ...
        ${optionalString cfg.updateResolved
      ...
      servers = mkOption {
        ...
        type = with types; attrsOf (submodule {
          ...
          options = {
            ...
            updateResolved = mkOption {
              default = config.services.resolved.enable;
              type = types.bool;
              description = ''
                Update systemd-resolved with the DNS information received from openvpn.
                The script will be run after the "up" commands and before the "down" commands.
              '';
            };
