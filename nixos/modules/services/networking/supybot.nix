...
let
  ...
  isStateDirHome = lib.hasPrefix "/home/" cfg.stateDir;
...
in
{
  options = {
    ...
    services.supybot = {
      ...
      stateDir = lib.mkOption {
        type = lib.types.path;
        default = if lib.versionAtLeast config.system.stateVersion "20.09"
          then "/var/lib/supybot"
          else "/home/supybot";
        defaultText = lib.literalExpression "/var/lib/supybot";
      ...
      extraPackages = lib.mkOption {
        ...
        '';
        example = lib.literalExpression "p: [ p.lxml p.requests ]";
      };
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.supybot = {
      ...
      // lib.optionalAttrs isStateDirVar {
        StateDirectory = "supybot";
        ProtectSystem = "strict";
      }
      // lib.optionalAttrs (!isStateDirHome) {
        ProtectHome = true;
      };
    };
    ...
    ++ (lib.flip lib.mapAttrsToList cfg.plugins (name: dest:
