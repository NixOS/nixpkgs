          ...
          type = types.submodule [
            {
              ...
              options = {
                ...
                COOKIE_DOMAIN = mkDefaultOption "settings.COOKIE_DOMAIN" {
                  default = null;
                  description = ''
                    The domain the Anubis challenge pass cookie should be set to.
                    This should be set to the domain you bought from your registrar (EG: techaro.lol if your webapp is running on anubis.techaro.lol).
                    See [here](https://stackoverflow.com/a/1063760) for more information.
                  '';
                  example = "example.com";
                  type = types.nullOr types.str;
                };
                COOKIE_PARTITIONED = mkDefaultOption "settings.COOKIE_PARTITIONED" {
                  default = false;
                  description = ''
                    If set to true, enables the [partitioned (CHIPS) flag](https://developers.google.com/privacy-sandbox/cookies/chips), meaning that Anubis inside an iframe has a different set of cookies than the domain hosting the iframe.
                  '';
                  type = types.bool;
                };
