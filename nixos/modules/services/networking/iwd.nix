...
let
  ...
  # Basically `types.str`, but the `check` function validates the string-length as well.
  fixedStringLength = min: max: mkOptionType {
    name = "str-with-length";
  ...
  options.networking.wireless.iwd = {
    ...
    networks = mkOption {
      ...
      type = types.attrsOf (types.submodule {
        options = {
          psk = mkOption {
            type = types.nullOr (fixedStringLength 64 64);
            default = null;
            description = ''
          ...
          passphrase = mkOption {
            type = types.nullOr (fixedStringLength 8 63);
            default = null;
            description = ''
