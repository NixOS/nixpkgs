...
let
  ...
  writeConfig = pkgs.writeText "squid.conf";

  squidConfig =
    if cfg.configFile == null && cfg.configText == null
    then writeConfig defaultConfig
    else if cfg.configFile == null
    then writeConfig cfg.configText
    else cfg.configFile;
in

{
    ...
    services.squid = {
      ...
      extraConfig = mkOption {
        ...
        description = ''
          ...
          verbatim to the default autogenerated NixOS
          configuration file.
        '';
      };
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [{
      ...
      message = "options: services.squid.configFile and services.squid.configText are mutually exclusive";
    }];
