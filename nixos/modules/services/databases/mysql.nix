  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.mysql = {
      ...
      script = ''
        ...
        exec ${cfg.package}/bin/${binaryPrefix}d --defaults-file=/etc/my.cnf ${mysqldOptions} $_WSREP_NEW_CLUSTER $_WSREP_START_POSITION
      '';
      ...
      postStart =
        ...
        ''
          ...
          ${lib.optionalString isMariaDB ''
            ...
            if ${cfg.package}/bin/${binaryPrefix} -u ${superUser} -N -e "SHOW VARIABLES LIKE 'wsrep_on'" 2>/dev/null | ${lib.getExe' pkgs.gnugrep "grep"} -q 'ON'; then
              echo "Galera cluster detected, waiting for node to be synced..."
              while true; do
                STATE=$(${cfg.package}/bin/${binaryPrefix} -u ${superUser} -N -e "SHOW STATUS LIKE 'wsrep_local_state_comment'" | ${lib.getExe' pkgs.gawk "awk"} '{print $2}')
          ...
          then
              ...
              ) | ${cfg.package}/bin/${binaryPrefix} -u ${superUser} -N
              ...
              ${lib.optionalString (cfg.initialScript != null) ''
                ...
                cat ${toString cfg.initialScript} | ${cfg.package}/bin/${binaryPrefix} -u ${superUser} -N
              ''}
          ...
          ${lib.optionalString (cfg.ensureDatabases != [ ]) ''
            ...
            '') cfg.ensureDatabases}
            ) | ${cfg.package}/bin/${binaryPrefix} -N
          ''}
