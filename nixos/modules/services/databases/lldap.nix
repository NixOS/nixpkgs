...
in
{
        ...
        options = {
          ...
          ldap_user_pass_file = mkOption {
            ...
            description = ''
              ...
              **Deprecated**: Use `credentials.LLDAP_LDAP_USER_PASS_FILE` instead.
          ...
          jwt_secret_file = mkOption {
            ...
            description = ''
              ...
              **Deprecated**: Use `credentials.LLDAP_JWT_SECRET_FILE` instead.
            '';
          };
        };
      };
  ...
  config = lib.mkIf cfg.enable {
    ...
    warnings =
      ...
      ++ lib.optionals (cfg.settings.ldap_user_pass_file or null != null) [
        "lldap: `settings.ldap_user_pass_file` is deprecated. Use `credentials.LLDAP_LDAP_USER_PASS_FILE` instead."
      ]
      ++ lib.optionals (cfg.settings.jwt_secret_file or null != null) [
        "lldap: `settings.jwt_secret_file` is deprecated. Use `credentials.LLDAP_JWT_SECRET_FILE` instead."
      ]
      ++
        lib.optionals
