...
In this case, to allow access for a service, you have two options:

  1. Create a database role matching your system user during [initialization](#module-services-postgres-initializing).
  2. Create a [user name map](https://www.postgresql.org/docs/current/auth-username-maps.html) between system roles and an existing database role.
