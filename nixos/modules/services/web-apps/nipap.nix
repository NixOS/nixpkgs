  ...
  options.services.nipap = {
    ...
    nipapd = {
      ...
      package = lib.mkOption {
        ...
        default = pkgs.nipap;
        defaultText = lib.literalExpression "pkgs.nipap";
        description = "nipapd package to use.";
      };
    ...
    nipap-www = {
      ...
      package = lib.mkOption {
        type = lib.types.package;
        default = pkgs.nipap-www;
        defaultText = lib.literalExpression "pkgs.nipap-www";
        description = "nipap-www package to use.";
      };
