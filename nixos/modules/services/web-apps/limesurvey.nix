...
{
  imports = [
    (mkRenamedOptionModule [ "services" "limesurvey" "virtualHost" ] [ "services" "limesurvey" "httpd" "virtualHost" ])
  ];
  ...
  config = mkIf (cfg.enable) (mkMerge [
    {
      ...
      services.limesurvey.config = mapAttrs (name: mkDefault) {
        ...
        config = {
          ...
          force_ssl = mkIf (
            cfg.${cfg.webserver}.virtualHost.addSSL || cfg.${cfg.webserver}.virtualHost.forceSSL || cfg.${cfg.webserver}.virtualHost.onlySSL
          ) "on";
