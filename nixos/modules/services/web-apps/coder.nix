  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.coder = {
      ...
      environment = cfg.environment.extra // {
        ...
        CODER_PG_CONNECTION_URL = "user=${cfg.database.username} ${lib.optionalString (cfg.database.password != null) "password=${cfg.database.password}"} database=${cfg.database.database} host=${cfg.database.host} ${lib.optionalString (cfg.database.sslmode != null) "sslmode=${cfg.database.sslmode}"}";
