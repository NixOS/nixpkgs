  ...
  options.services.monica = {
    ...
    appURL = mkOption {
      description = ''
        ...
        If you change this in the future you may need to run a command to update stored URLs in the database. Command example: <code>php artisan monica:update-url https://old.example.com https://new.example.com</code>
      '';
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.monica-setup = {
      ...
      script =
        ...
        ${pkgs.php}/bin/php artisan db:seed --force
      '';
    };
