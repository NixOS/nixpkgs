...
let
  ...
  pkg = hostName: cfg: pkgs.stdenv.mkDerivation rec {
    ...
    installPhase = ''
      ...
      mkdir -p $out/share/wordpress/wp-content/languages/plugins
      ${concatStringsSep "\n" (mapAttrsToList (name: plugin: "cp -r ${plugin.i18n}/. $out/share/wordpress/wp-content/languages/plugins/") cfg.plugins)}
