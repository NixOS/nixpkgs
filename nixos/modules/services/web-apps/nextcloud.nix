...
in
{
  ...
  options.services.nextcloud = {
    ...
    disableApps = lib.mkOption {
      ...
      default = [ ];
      description = ''
        Apps to disable. Should be a list of appid to packages generated by fetchNextcloudApp.
          ...
          nextcloud-setup =
            ...
            in
            {
              ...
              script = ''
                ...
                ${lib.optionalString (cfg.disableApps != [ ]) ''
                  # Try to disable apps
                  $OCC_BIN app:disable ${lib.concatStringsSep " " cfg.disableApps}
                ''}
