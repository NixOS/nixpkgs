...
in
{
  ...
  options.services.nextcloud = {
    ...
    enableCompressedAssets = lib.mkOption {
      type = lib.types.bool;
      default = true;
      description = "Whether to provide gzip, brotli and zstd pre-compressed assets for lower CPU usage and less transfer size in production. This leads to longer build times.";
    };
