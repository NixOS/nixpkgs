...
```nix
{
  services.akkoma.config.":pleroma" = with (pkgs.formats.elixirConf { }).lib; {
    ...
    ":mrf_simple" = {
      ...
      reject = mkMap { "kiwifarms.cc" = "Persistent harassment of users, no moderation"; };

      # Force posts to be visible by followers only
      followers_only = mkMap { "beta.birdsite.live" = "Avoid polluting timelines with Twitter posts"; };
    };
  };
}
```
