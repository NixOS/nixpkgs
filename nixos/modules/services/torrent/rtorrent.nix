      ...
      services = {
        ...
        in {
          ...
          serviceConfig = {
            ...
            ExecStartPre=''${lib.getExe pkgs.bash} -c "if test -e ${cfg.dataDir}/session/rtorrent.lock && test -z $(${pkgs.procps}/bin/pidof rtorrent); then rm -f ${cfg.dataDir}/session/rtorrent.lock; fi"'';
