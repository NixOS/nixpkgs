...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.sshguard = {
      ...
      preStart = lib.optionalString config.networking.firewall.enable ''
      ...
      postStop = lib.optionalString config.networking.firewall.enable ''
      ...
      serviceConfig = {
        ...
        ExecStart = let
          args = lib.concatStringsSep " " ([
            ...
            (lib.optionalString (cfg.blacklist_threshold != null) "-b ${toString cfg.blacklist_threshold}:${cfg.blacklist_file}")
