...
in
{
  ...
  options.services.crowdsec = {
    ...
    autoUpdateService = lib.mkEnableOption "Auto Hub Update";
    ...
    lib.mkIf (cfg.enable) {
      ...
      networking.firewall.allowedTCPPorts =
        ...
        lib.mkIf cfg.openFirewall [
          ...
          parsePortFromURLOption
          cfg.settings.general.api.server.listen_uri
          "config.services.crowdsec.settings.general.api.server.listen_uri"
        ];
    };
