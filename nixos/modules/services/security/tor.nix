...
in {
  imports = [
    ...
    (mkRemovedOptionModule [ "services" "tor" "client" "dns" "listenAddress" ]
      "Use services.tor.settings.DNSPort instead.")
    ...
    (mkRemovedOptionModule [ "services" "tor" "client" "socksIsolationOptions" ]
    ...
    (mkRemovedOptionModule [ "services" "tor" "extraConfig" ]
      "Plese use services.tor.settings instead.")
  ...
  options = {
    services.tor = {
      ...
      openFirewall =
        mkEnableOption "opening of the relay port(s) in the firewall";
      ...
      relay = {
        enable = mkEnableOption ''
          relaying of Tor traffic for others.
      ...
      settings = mkOption {
        ...
        type = types.submodule {
          ...
          options.AuthDirHasIPv6Connectivity =
            optionBool "AuthDirHasIPv6Connectivity";
          ...
          options.AuthDirSharedRandomness =
            optionBool "AuthDirSharedRandomness";
          options.AuthDirTestEd25519LinkKeys =
            optionBool "AuthDirTestEd25519LinkKeys";
          ...
          options.ConnDirectionStatistics =
            optionBool "ConnDirectionStatistics";
          ...
          options.ControlPortFileGroupReadable =
            optionBool "ControlPortFileGroupReadable";
          ...
          options.ControlSocketsGroupWritable =
            optionBool "ControlSocketsGroupWritable";
          ...
          options.DisableDebuggerAttachment =
            optionBool "DisableDebuggerAttachment";
          ...
          options.DoSCircuitCreationEnabled =
            optionBool "DoSCircuitCreationEnabled";
          options.DoSConnectionEnabled =
            optionBool "DoSConnectionEnabled"; # default is null and like "auto"
          options.DoSRefuseSingleHopClientRendezvous =
            optionBool "DoSRefuseSingleHopClientRendezvous";
          ...
          options.ExitPolicyRejectLocalInterfaces =
            optionBool "ExitPolicyRejectLocalInterfaces";
          options.ExitPolicyRejectPrivate =
            optionBool "ExitPolicyRejectPrivate";
          options.ExitPortStatistics = optionBool "ExitPortStatistics";
          options.ExitRelay =
            optionBool "ExitRelay"; # default is null and like "auto"
          ...
          options.ExtORPortCookieAuthFileGroupReadable =
            optionBool "ExtORPortCookieAuthFileGroupReadable";
          options.ExtendAllowPrivateAddresses =
            optionBool "ExtendAllowPrivateAddresses";
          ...
          options.HiddenServiceNonAnonymousMode =
            optionBool "HiddenServiceNonAnonymousMode";
          options.HiddenServiceStatistics =
            optionBool "HiddenServiceStatistics";
          ...
          options.KeyDirectoryGroupReadable =
            optionBool "KeyDirectoryGroupReadable";
          ...
          options.OptimisticData =
            optionBool "OptimisticData"; # default is null and like "auto"
          ...
          options.TransProxyType = mkOption {
            ...
            type = with types;
              nullOr (enum [ "default" "TPROXY" "ipfw" "pf-divert" ]);
            default = null;
          };
          ...
          options.V3AuthoritativeDirectory =
            optionBool "V3AuthoritativeDirectory";
          options.VersioningAuthoritativeDirectory =
            optionBool "VersioningAuthoritativeDirectory";
          options.VirtualAddrNetworkIPv4 =
            optionString "VirtualAddrNetworkIPv4";
          options.VirtualAddrNetworkIPv6 =
            optionString "VirtualAddrNetworkIPv6";
  ...
  config = mkIf cfg.enable {
    ...
    services.tor.settings = mkMerge [
      ...
      (mkIf cfg.relay.enable (optionalAttrs (cfg.relay.role != "exit") {
        ...
        ServerTransportPlugin.exec =
          mkDefault "${pkgs.obfs4}/bin/obfs4proxy managed";
    ...
    networking.firewall = mkIf cfg.openFirewall {
      allowedTCPPorts = concatMap (o:
        if isInt o && o > 0 then
          ...
          [ ]) (flatten [ cfg.settings.ORPort cfg.settings.DirPort ]);
    };
    ...
    systemd.services.tor = {
      ...
      serviceConfig = {
        ...
        StateDirectory = [ "tor" "tor/onion" ] ++ flatten (mapAttrsToList
