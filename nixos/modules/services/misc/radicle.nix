    ...
    serviceConfig = lib.mkMerge [
      {
        ...
        ++
          lib.optional (cfg.publicKey != null) # setting the publicKey to null means you write the public key externally
            "${
    ...
    services.radicle = {
      ...
      privateKeyFile = lib.mkOption {
        ...
        description = ''
          ...
          If it is null the module does not interact with the private
          key. This is useful if you want to handle it externally like
          with sops-nix.
        '';
      };
      publicKey = lib.mkOption {
        ...
        description = ''
          ...
          If it is null the module does not interact with the public key. This
          is useful if you want to handle it externally like with sops-nix.
        '';
      };
      node = {
    ...
    lib.mkMerge [
      {
        systemd.services.radicle-node = lib.mkMerge [
          ...
          {
            serviceConfig = lib.mkIf (cfg.privateKeyFile != null) (
              let
