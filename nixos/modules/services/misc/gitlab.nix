        ...
        example = lib.literalExpression ''
          {
            ...
            # Turns on AWS Server-Side Encryption with Amazon S3-Managed Keys for backups, this is lib.optional
            encryption = "AES256";

            # Specifies Amazon S3 storage class to use for backups, this is lib.optional
