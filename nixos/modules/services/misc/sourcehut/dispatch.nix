...
in {
  ...
  config = with scfg;
    lib.mkIf (cfg.enable && elem "dispatch" cfg.services) {
      ...
      services.sourcehut.settings = {
        ...
        "dispatch.sr.ht".connection-string = mkDefault
      ...
      services.nginx.virtualHosts."dispatch.${cfg.originBase}" = {
        ...
        locations."/static".root =
          "${pkgs.sourcehut.dispatchsrht}/${pkgs.sourcehut.python.sitePackages}/dispatchsrht";
      };
    };
}
