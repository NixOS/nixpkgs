...
in {
  ...
  config = mkIf cfg.enable {
    assertions = [
      {
        ...
        message =
          "Option klipper.octoprintIntegration requires Octoprint to be enabled on this system. Please enable services.octoprint to use it.";
      }
      {
    ...
    environment.etc."klipper.cfg".source =
    ...
    in {
      ...
      serviceConfig = {
        ExecStart =
          "${cfg.package}/lib/klipper/klippy.py ${klippyArgs} /etc/klipper.cfg";
