...

{
  ...
  config = mkIf (xcfg.enable && cfg.enable) {
      ...
      { name = "kde4_next";
        ...
        start =
          ''
            ...
            # Start KDE.
            exec ${pkgs.kde4_next.kdebase_workspace}/bin/startkde
          '';
      };

    security.setuidOwners = singleton
      { program = "kcheckpass";
        source = "${pkgs.kde4_next.kdebase_workspace}/lib/kde4/libexec/kcheckpass";
        owner = "root";
        group = "root";
        setuid = true;
      };
    ...
    environment.systemPackages =
        [ pkgs.kde4_next.kdelibs

          pkgs.kde4_next.kde_baseapps # Splitted kdebase
          pkgs.kde4_next.kde_workspace
          pkgs.kde4_next.kde_runtime
          pkgs.kde4_next.konsole
          pkgs.kde4_next.kate
          pkgs.kde4_next.kmix  # Volume control

          pkgs.kde4_next.kde_wallpapers # contains kdm's default background
          pkgs.kde4_next.oxygen_icons
          pkgs.virtuoso # to enable Nepomuk to find Virtuoso

          # Starts KDE's Polkit authentication agent.
          pkgs.kde4_next.polkit_kde_agent

          # Miscellaneous runtime dependencies.
          pkgs.kde4_next.qt4 # needed for qdbus
