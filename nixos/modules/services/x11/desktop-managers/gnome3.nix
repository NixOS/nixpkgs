...
let
  ...
  nixos-gsettings-desktop-schemas = pkgs.stdenv.mkDerivation {
    ...
    buildCommand = ''
     ...
     cat - > $out/share/nixos-gsettings-schemas/nixos-gsettings-desktop-schemas/glib-2.0/schemas/org.gnome.desktop.background.nixos.gschema.override <<- EOF
       [org.gnome.desktop.background]
       picture-uri='${pkgs.nixos-artwork}/share/artwork/gnome/Gnome_Dark.png'
     EOF
     cat - > $out/share/nixos-gsettings-schemas/nixos-gsettings-desktop-schemas/glib-2.0/schemas/org.gnome.desktop.screensaver.nixos.gschema.override <<- EOF
