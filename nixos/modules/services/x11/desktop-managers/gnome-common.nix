...
let
  cfg = config.services.xserver.desktopManager.gnome-common;
  cfg3 = config.services.xserver.desktopManager.gnome3;
  ...
  nixos-gsettings-desktop-schemas = pkgs.runCommand "nixos-gsettings-desktop-schemas" {}
    ''
     ...
     ${concatMapStrings (pkg: "cp -rf ${pkg}/share/gsettings-schemas/*/glib-2.0/schemas/*.xml $out/share/gsettings-schemas/nixos-gsettings-overrides/glib-2.0/schemas\n") cfg3.extraGSettingsOverridePackages}
...
in {
  ...
  options = {
    ...
    services.xserver.desktopManager.gnome-common = {
      enable = mkOption {
        default = false;
        internal = true;
  ...
  config = mkIf cfg.enable {
    ...
    environment.variables.GNOME_SESSION_DEBUG = optionalString cfg3.debug "1";
    ...
    environment.systemPackages = pkgs.gnome3.corePackages ++ cfg3.sessionPath
