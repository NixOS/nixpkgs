  ...
  options.services.xserver.windowManager.i3 = {
    ...
    configText = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        It allows you to also include derivation paths, such as
        scripts generated by pkgs.writeScript in your config file,
        without needing to add them as a package to make sure they in the path.
      '';
    };
