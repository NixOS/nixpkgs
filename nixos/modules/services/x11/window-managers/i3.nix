  ...
  options.services.xserver.windowManager.i3 = {
    ...
    configText = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        This setting will take precedence over configFile option.

        It is equivalent to using pkgs.writeTextFile to pass data to configFile option,
        except less verbose, and leads to less confusion as to how to pass in derivation paths.
      '';
    };
