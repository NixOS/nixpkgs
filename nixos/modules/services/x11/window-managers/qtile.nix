...

{
  ...
  options.services.xserver.windowManager.qtile = {
    ...
    package = mkPackageOption pkgs [ "python3Packages" "qtile" ] { };
  ...
  config = mkIf cfg.enable {
    services = {
      xserver.windowManager.qtile.finalPackage = cfg.package.override { extraPackages = cfg.extraPackages pkgs.python3.pkgs; };
