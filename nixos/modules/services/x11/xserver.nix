...

{
  ...
  imports =
    [ ./display-managers/default.nix
      ...
      (lib.mkRenamedOptionModule [ "services" "xserver" "layout" ] [ "services" "xkb" "layout" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "extraLayouts" ] [ "services" "xkb" "extraLayouts" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "layout" ] [ "services" "xkb" "layout" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "dir" ] [ "services" "xkb" "dir" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "model" ] [ "services" "xkb" "model" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "options" ] [ "services" "xkb" "options" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkb" "variant" ] [ "services" "xkb" "variant" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkbDir" ] [ "services" "xkb" "dir" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkbModel" ] [ "services" "xkb" "model" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkbOptions" ] [ "services" "xkb" "options" ])
      (lib.mkRenamedOptionModule [ "services" "xserver" "xkbVariant" ] [ "services" "xkb" "variant" ])
    ];
