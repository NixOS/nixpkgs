...
in
{
  options = {
    ...
    services.packetbeat = {
      ...
      configFile = mkOption {
        ...
        default = null;
        description = ''
          A user managed configuration file to be used instead of one
          generated by the options in the module.
        '';
      };
  ...
  config = mkIf cfg.enable {
    warnings = optional (cfg.configFile != null && (cfg.configProtocols != null || cfg.configFlows != null || cfg.extraConfig != null)) ''
      Setting services.packetbeat.configFile will overrule the other configuration settings in the module.
    '';
    assertions = [
      {
        assertion = (cfg.configProtocols != "" || cfg.configFlows != "") || cfg.configFile != null;
        message = ''
          The options services.packetbeat.configProtocols, services.packetbeat.configFlows and/or services.packetbeat.configFile should be set or else packetbeat won't do anything useful and error out.
        '';
      }
    ];
      ...
      serviceConfig = {
        ...
        ExecStart = ''
          ${cfg.package}/bin/packetbeat \
            -c ${if cfg.configFile != null then cfg.configFile else packetbeatYml} \
