  ...
  qemuBinary = qemuPkg:
    let
      ...
      linuxHostGuestMatrix = {
        i686-linux = "${qemuPkg}/bin/qemu-system-i386 -machine type=q35,accel=hvf:tcg -cpu max";
        ...
        x86_64-darwin = "${qemuPkg}/bin/qemu-system-x86_64 -machine type=q35,accel=hvf:tcg -cpu max";
      };
