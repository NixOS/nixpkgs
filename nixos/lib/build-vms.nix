...
with lib; rec {
  ...
  buildVirtualNetwork = nodes: let nodesOut = mapAttrs (n: buildVM nodesOut) (assignIPAddresses nodes); in nodesOut;
            ...
            networkConfig = {
              ...
              in
                ...
                ({
                  ...
                  qemu-common.qemuNICFlags snd fst m.snd);
            };
          in {
            key = "ip-address";
            config =
