...
in
{
  ...
  optionsJSON = pkgs.runCommand "options.json"
    ...
    ''
      ...
      cp ${builtins.toFile "options.json"
        (builtins.unsafeDiscardStringContext (builtins.toJSON optionsNix))} $dst/options.json
