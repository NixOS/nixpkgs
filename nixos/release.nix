with import ../lib;
  {
    ...
    in rec {
      ...
      netboot = forMatchingSystems supportedSystems (system:
        makeNetboot {
          module = ./modules/installer/netboot/netboot-minimal.nix;
          inherit system;
        });

      iso_minimal = forAllSystems (system:
        makeIso {
      ...
      iso_plasma5 = forMatchingSystems ["x86_64-linux"] (system:
        makeIso {
      ...
      iso_gnome = forMatchingSystems ["x86_64-linux"] (system:
        makeIso {
      ...
      iso_minimal_new_kernel = forMatchingSystems ["x86_64-linux" "aarch64-linux"] (system:
        makeIso {
      ...
      sd_image = forMatchingSystems ["armv6l-linux" "armv7l-linux" "aarch64-linux"] (system:
        makeSdImage {
          module =
            {
      ...
      lxdImage = forMatchingSystems ["x86_64-linux" "aarch64-linux"] (
        system:
          with import ./.. {inherit system;};
            hydraJob ((import lib/eval-config.nix {
              inherit system;
      ...
      lxdMeta = forMatchingSystems ["x86_64-linux" "aarch64-linux"] (
        system:
          with import ./.. {inherit system;};
            hydraJob ((import lib/eval-config.nix {
              inherit system;
