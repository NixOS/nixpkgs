  ...
  tested =
    ...
    in pkgs.releaseTools.aggregate {
      ...
      constituents = pkgs.lib.concatLists [
        ...
        (onFullSupported "nixos.ova")
        (onSystems ["aarch64-linux"] "nixos.sd_image")
        (onFullSupported "nixos.tests.boot.biosCdrom")
        ...
        (onFullSupported "nixos.tests.docker")
        ...
        (onFullSupported "nixos.tests.installer.btrfsSimple")
        (onFullSupported "nixos.tests.installer.btrfsSubvolDefault")
        (onFullSupported "nixos.tests.installer.btrfsSubvols")
        (onFullSupported "nixos.tests.installer.luksroot")
        (onFullSupported "nixos.tests.installer.lvm")
        (onFullSupported "nixos.tests.installer.separateBootFat")
        (onFullSupported "nixos.tests.installer.separateBoot")
        (onFullSupported "nixos.tests.installer.simpleLabels")
        (onFullSupported "nixos.tests.installer.simpleProvided")
        (onFullSupported "nixos.tests.installer.simpleUefiSystemdBoot")
        (onFullSupported "nixos.tests.installer.simple")
        (onFullSupported "nixos.tests.installer.swraid")
