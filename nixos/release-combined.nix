  ...
  tested =
    ...
    in pkgs.releaseTools.aggregate {
      ...
      constituents = pkgs.lib.concatLists [
        ...
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-bond")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-bridge")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-dhcpOneIf")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-dhcpSimple")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-link")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-loopback")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-macvlan")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-privacy")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-routes")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-sit")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-static")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-virtual")
        (onFullSupported "nixos.tests.networking.implementation-scripted.testcase-vlan")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-bond")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-bridge")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-dhcpOneIf")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-dhcpSimple")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-link")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-loopback")
        # Fails nondeterministically (https://github.com/NixOS/nixpkgs/issues/96709)
        #(onFullSupported "nixos.tests.networking.implementation-networkd.testcase-macvlan")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-privacy")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-routes")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-sit")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-static")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-virtual")
        (onFullSupported "nixos.tests.networking.implementation-networkd.testcase-vlan")
