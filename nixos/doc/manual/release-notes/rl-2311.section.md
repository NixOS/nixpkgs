...
- [LANraragi](https://github.com/Difegue/LANraragi/), a web application for archival and reading of manga/doujinshi. Available as [services.lanraragi](#opt-services.lanraragi.enable)
