...
- `gitea` now starts it's optional unix socket with 750 permission instead of 755. You might need to adjust you're webserver's groups to continue serving it over unix socket.
