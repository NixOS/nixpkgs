...
- `services.postgresql` now offers more ensure-style options for users and databases.
  - Added `ensureUsers.*.passwordFile` to define a password for authentication
  - Added various database creation options for `ensureDatabases`
