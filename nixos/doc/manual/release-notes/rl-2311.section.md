...
- `teleport` has been upgraded to major version 13. Please see upstream [upgrade instructions](https://goteleport.com/docs/management/operations/upgrading/) and [release notes](https://goteleport.com/docs/changelog/#1300-050823).
