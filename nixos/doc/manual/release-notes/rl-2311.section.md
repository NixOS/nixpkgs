...
- `nixVersions.nix_2_3` has been removed, since it is the last version to not support compression agility using `libarchive`. Nix 2.4 or higher will be required to use the binary cache.
