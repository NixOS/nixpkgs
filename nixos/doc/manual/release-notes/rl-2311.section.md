...
- [AMDVLK](https://github.com/GPUOpen-Drivers/AMDVLK), AMD's open source
  Vulkan driver, is now available to be configured as
  [hardware.amdgpu.amdvlk](#opt-hardware.amdgpu.amdvlk.enable).
  This also allows configuring runtime settings of AMDVLK and enabling
