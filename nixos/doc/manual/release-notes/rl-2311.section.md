...
## New Modules {#sec-release-23.11-new-modules}
...
<!-- Find their modules and add them to the previous list -->
miscellaneous
: - [matrix-whatsapp](https://docs.mau.fi/bridges/go/whatsapp/index.html), a Matrix-WhatsApp puppeting bridge
