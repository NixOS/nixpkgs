...
## Backward Incompatibilities {#sec-release-23.11-incompatibilities}
  ...
  - Package `transmission` has been upgraded from 3 to 4. The update seem to have introduced a configuration data-loss bug, tracked upstram at [transmission/transmission#5153](https://github.com/transmission/transmission/issues/5153), and was mentioned downstream at [#215316](https://github.com/NixOS/nixpkgs/pull/215316#issuecomment-1485097961).
