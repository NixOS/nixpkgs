...
- [Croodle](https://github.com/jelhan/croodle), a privacy-respecting web application to schedule a date or run a poll. Available as [services.croodle](#opt-services.croodle.enable).
