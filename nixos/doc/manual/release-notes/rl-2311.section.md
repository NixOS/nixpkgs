...
- The modules `services.pipewire.deepfilter` and `services.pipewire.rnnoise` have been added, for using [DeepFilterNet](https://github.com/Rikorose/DeepFilterNet) and [RNNoise](https://github.com/werman/noise-suppression-for-voice) with PipeWire.
