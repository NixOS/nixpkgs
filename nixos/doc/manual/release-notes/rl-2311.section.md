...
- `services.pipewire.socketActivation` is now disabled by default, as some bluetooth audio devices had trouble connecting if the service is not already running.
