...
- [Sunshine](https://app.lizardbyte.dev/Sunshine), a self-hosted game stream host for Moonlight was backported from unstable. Available as [services.sunshine](#opt-services.sunshine.enable).
