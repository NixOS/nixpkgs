...
- [stalwart](https://stalw.art), an all-in-one collaboration and email server (SMTP, IMAP,
  JMAP, CalDAV, CardDAV, WebDAV). Available as
  [services.stalwart](#opt-services.stalwart.enable).
