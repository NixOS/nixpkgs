...
- `mumble` and `murmur` have been updated to version 1.5.517, which includes the removal of Murmur's gRPC control interface. Affected applications are encouraged to switch to the still-supported DBus or ZeroC ICE interfaces.
