...
- [osmo-hlr](https://osmocom.org/projects/osmo-hlr/wiki/OsmoHLR), is the Home Location Register for Osmocom. It stores subscriber IMSI, phone number and auth. Available as [services.osmo-hlr](#opt-services.osmo-hlr.enable)

- [osmo-msc](https://osmocom.org/projects/osmomsc/wiki), is the Osmocom implementation of a Mobile Switching Center (MSC). Available as [services.osmo-msc](#opt-services.osmo-msc.enable)
