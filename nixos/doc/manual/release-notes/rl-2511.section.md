...
- `bugwarrior` has been updated to major version 2.0.0 which will likely require manual intervention. See [release notes](https://github.com/GothenburgBitFactory/bugwarrior/releases/tag/2.0.0).
