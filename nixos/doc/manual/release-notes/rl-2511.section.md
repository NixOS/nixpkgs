...
- [katrain](https://github.com/sanderland/katrain), a tool for analyzing games and playing against AI in Go (Baduk). Available as [programs.katrain](#opt-programs.katrain.enable).
