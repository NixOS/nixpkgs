...
- [nufetch](https://github.com/gignsky/nufetch), a nix extensible version of [neofetch](https://github.com/dylanaraps/neofetch) that allows configuration of neofetch to be handled system-wide as [programs.nufetch](#opt-programs.nufetch.enable).
