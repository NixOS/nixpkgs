...
- [Immich Kiosk](https://github.com/damongolding/immich-kiosk), a lightweight slideshow for running on kiosk devices and browsers that uses Immich as a data source. Available as [services.immich-kiosk](#opt-services.immich-kiosk.enable).
