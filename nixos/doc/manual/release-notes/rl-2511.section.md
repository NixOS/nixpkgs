...
- [xwayland-satellite](https://github.com/Supreeeme/xwayland-satellite), rootless XWayland integration for any Wayland compositor. Available as [](#opt-services.xwayland-satellite.enable).
