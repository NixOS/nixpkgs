...
- [qbit\_manage](https://github.com/StuffAnThings/qbit_manage), a tool to help manage tedious tasks in qBittorrent and automate them. Available as [services.qbit\_manage](#opt-services.qbit_manage.enable).
