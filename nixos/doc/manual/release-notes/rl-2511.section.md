...
- [hydroxide](https://github.com/emersion/hydroxide), a third-party open-source ProtonMail bridge server. Available as [services.hydroxide](#opt-services.hydroxide.enable)
