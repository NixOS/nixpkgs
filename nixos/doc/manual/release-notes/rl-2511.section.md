...
- The `pkgs.uptime-kuma` package now shows a warning regarding migration to v2.x.x series. Migration can be completed by setting `services.uptime-kuma.package` to `pkgs.uptime-kuma_2`.
