...
- [services.libvirtd.autoSnapshot](options.html#opt-services.libvirtd.autoSnapshot.enable), a backup service for libvirt managed vms.
...
- [graphhopper](https://github.com/graphhopper/graphhopper), a high-performance routing engine for OpenStreetMap and GTFS data. Available as [services.graphhopper](#opt-services.graphhopper.enable).
