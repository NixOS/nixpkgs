...
- [OpenFOAM](https://github.com/OpenFOAM/OpenFOAM-12), An open source computational fluid dynamics toolkit. Available as [programs.openfoam](options.html#opt-programs.openfoam.enable).
