...
- `python3Packages.gbulb` was removed because it [was deprecated upstream](https://github.com/beeware/gbulb#this-project-has-been-archived)
  in favor of the native support included with  `python3Packages.pygobject3` versions 3.5.0 and higher.
