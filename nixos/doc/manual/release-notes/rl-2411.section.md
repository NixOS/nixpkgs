...
- The Factor programming language packages were reworked and `factor-lang-scope` now provides a `buildFactorApplication` function to deploy factor programs as binaries. It has also received proper documentation in the Nixpkgs manual.
