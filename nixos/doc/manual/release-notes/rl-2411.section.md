...
- `python3Packages.coreapi` was removed because it was [deprecated upstream](https://www.django-rest-framework.org/community/3.9-announcement/#whats-next).
  [OpenAPI](https://openapis.org) is the recommended replacement.
