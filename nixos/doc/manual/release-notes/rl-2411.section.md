...
- [Cyrus IMAP](https://github.com/cyrusimap/cyrus-imapd), email, contacts and calendar server. Available as [services.cyrus-imap](#opt-services.cyrus-imap.enable) service.
