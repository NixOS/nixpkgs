...
- [ssh3](https://github.com/francoismichel/ssh3), an **unaudited and experimental** alternative to OpenSSH and Dropbear, incompatible with the SSHv2 protocol, [based on HTTP/3](https://datatracker.ietf.org/doc/draft-michel-ssh3/). Available as [`services.ssh3-server`](#opt-services.ssh3-server.enable).
