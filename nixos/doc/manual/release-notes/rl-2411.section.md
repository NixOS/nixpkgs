...
- The `services.samba.extraConfig` setting has been removed and converted to the freeform type option named [`services.samba.settings`](#opt-services.samba.settings) according to RFC42.
