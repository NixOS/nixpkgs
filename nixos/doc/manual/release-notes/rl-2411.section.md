...
- The [Xen Hypervisor](https://xenproject.org) is once again available as a virtualisation option under [`virtualisation.xen`](#opt-virtualisation.xen.enable).
  - This release includes Xen [4.16.6](https://wiki.xenproject.org/wiki/Xen_Project_4.16_Release_Notes), [4.17.4](https://wiki.xenproject.org/wiki/Xen_Project_4.17_Release_Notes), [4.18.2](https://wiki.xenproject.org/wiki/Xen_Project_4.18_Release_Notes) and [4.19.0](https://wiki.xenproject.org/wiki/Xen_Project_4.19_Release_Notes), as well as support for booting the hypervisor on EFI systems.
    ::: {.warning}
      Xen 4.16 is due to be **deprecated** on [2024-12-02](https://xenbits.xenproject.org/docs/unstable/support-matrix.html).
    :::
