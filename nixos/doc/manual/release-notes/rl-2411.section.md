...
- The `parsoid` service has been removed, along with its associated package,
  as it's been deprecated by Wikimedia. Current versions of MediaWiki include
  the new version of Parsoid as an internal dependendency via Composer, so this
