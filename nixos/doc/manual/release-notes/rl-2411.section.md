...
- The `octoprint` service has gained a default disabled `enableRaspberryPi` option.
  Users running on raspberry pi should enable the option to restore full functionality.
