...
## Module updates {#sec-release-24.11-module-updates}

- [rebuy-de/aws-nuke](https://github.com/rebuy-de/aws-nuke) is no longer maintained, updated to [ekristen/aws-nuke](https://github.com/ekristen/aws-nuke) as per recommendation from `rebuy-de/aws-nuke` maintainers.
