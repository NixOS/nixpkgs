...
- `nodePackages.coc-cmake` and the associated `vimPlugins.coc-cmake`
  has been removed due to the upstream repo being [archived on 2022-07-17](https://github.com/voldikss/coc-cmake).
