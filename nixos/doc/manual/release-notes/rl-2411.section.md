...
- [AMDVLK](https://github.com/GPUOpen-Drivers/AMDVLK), AMD's open source Vulkan driver, is now available as [hardware.amdvlk](options.html#opt-hardware.amdvlk.enable).
