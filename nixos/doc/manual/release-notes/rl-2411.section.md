...
- `jre_minimal.tests` is now an attribute set of package tests instead of a list, making it easier to access individual test cases. This change does not affect the CI, since `nix-build jre_minimal.tests` still works.
