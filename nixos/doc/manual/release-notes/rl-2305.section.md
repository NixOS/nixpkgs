...
- Pantheon now defaults to Mutter 43 and GNOME settings daemon 43 (due to changes with GLib 2.76), all Pantheon packages are now tracking elementary OS 7 updates.
