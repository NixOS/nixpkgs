...
### libgcc is now packaged separately, may affect downstream packages
...
#### What do the link failures look like?
...
#### How can I fix the link failures?
...
#### Why was libgcc moved to its own package?
...
#### Why can't this be fixed automatically in nixpkgs?
