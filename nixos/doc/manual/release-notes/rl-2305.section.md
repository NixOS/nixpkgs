...
- [Crater](https://craterapp.com), a self-hosted web application for managing invoices, clients and payments. Available as [services.crater](#opt-services.crater.enable).
