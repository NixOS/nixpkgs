...
- [OpenRCT2](https://openrct2.org/), an open-source re-implementation of RollerCoaster Tycoon 2. Available as [services.openrct2](options.html#opt-services.openrct2.enable).
