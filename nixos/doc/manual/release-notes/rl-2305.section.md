...
- [Forgejo](https://forgejo.org), a self-hosted lightweight software forge, forked from Gitea. Available as [services.forgejo](options.html#opt-services.forgejo.enable).
