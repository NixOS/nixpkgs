...
- Nix has been updated from 2.3 to 2.8. This mainly brings experimental support
  ...
  release notes for [nix-2.4](https://nix.dev/manual/nix/stable/release-notes/rl-2.4.html),
  [nix-2.5](https://nix.dev/manual/nix/stable/release-notes/rl-2.5.html),
  [nix-2.6](https://nix.dev/manual/nix/stable/release-notes/rl-2.6.html),
  [nix-2.7](https://nix.dev/manual/nix/stable/release-notes/rl-2.7.html) and
  [nix-2.8](https://nix.dev/manual/nix/stable/release-notes/rl-2.8.html)
