...
- `services.dendrite.httpPort` and `services.dendrite.httpsPort` have been replaced with `services.dendrite.httpAddress` and `services.dendrite.httpsAddress` respectively.
