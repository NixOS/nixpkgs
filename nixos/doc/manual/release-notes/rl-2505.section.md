...
- [Beszel](https://beszel.dev), a lightweight server monitoring hub with historical data, docker stats, and alerts. Available as `services.beszel.agent` and `services.beszel.hub`.
