...
- `services.seafile` has been reworked to accommodate the new Seafile 12 configuration format. Some settings, such as those in `ccnetSettings`, will need to be migrated to their new environment variables.
