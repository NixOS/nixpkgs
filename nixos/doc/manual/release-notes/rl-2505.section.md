...
- [dufs](https://github.com/sigoden/dufs), a file server that supports static serving, uploading, searching, accessing control and webdav. Available as [services.dufs](options.html#opt-services.dufs.enable).
