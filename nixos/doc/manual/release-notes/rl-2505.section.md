...
- The PostgreSQL module no longer accepts a strings as `services.postgresql.settings.shared_preload_libraries` and now only lists to properly merge the setting.
