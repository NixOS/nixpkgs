...
- The `maven.buildMaven` builder was removed. Instead, in-tree users should use
  `maven.buildMavenPackage`, and out-of-tree user who want to continue
  to use `mvn2nix` should see
  [the upstream repository](https://github.com/fzakaria/mvn2nix).
