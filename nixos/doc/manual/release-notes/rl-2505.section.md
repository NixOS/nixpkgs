...
-  `listmonk` was updated to v4.1.0 with significant changes to certain important features and behaviour. See the [Upgrading to v4.x.x](https://listmonk.app/docs/upgrade/#upgrading-to-v4xx) documentation for more details.
