...
- Added `services.nginx.mimeTypes` parameter for more flexible configuration of mime-types. If you use this parameter, the `services.nginx.defaultMimeTypes` parameter is disabled.
