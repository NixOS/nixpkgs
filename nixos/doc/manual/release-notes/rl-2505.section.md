...
- [ism7mqtt](https://github.com/zivillian/ism7mqtt), a MQTT connector for Wolf SmartSet-enabled domestic heating devices. Available as [services.ism7mqtt](options.html#opt-services.ism7mqtt)
