...
- `networking.wireguard` adds support for the [AmneziaWG](https://amnezia.org/en) variant of the protocol. The variant to be used is set per interface as `networking.wireguard.interfaces.<name>.type`, defaulting to wireguard.
