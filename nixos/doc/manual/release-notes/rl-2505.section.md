...
- `polaris` v0.15.0 will migrate the database to its new schema. Some config settings may have been renamed and are now stabilized. The open-api docs have been moved from `/swagger` to `/api-docs`.
