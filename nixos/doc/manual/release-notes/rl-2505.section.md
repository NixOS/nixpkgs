...
- `himalaya` has been updated to `v1.0.0`, which introduces breaking changes. Check out the [release note](https://github.com/pimalaya/himalaya/releases/tag/v1.0.0) for details.
