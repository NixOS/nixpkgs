...
- `services.btrfs.autoBalance` has been added, to periodically balance btrfs filesystems, reclaiming space from partially empty block groups and preventing metadata space from filling up.
