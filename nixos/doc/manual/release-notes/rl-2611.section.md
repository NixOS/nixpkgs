...
- The system-wide SSH client configuration can now be disabled via [`programs.ssh.enable`](#opt-programs.ssh.enable). It defaults to `true`, preserving the previous always-on behaviour.
