...
- [kosync-dotnet](https://github.com/jberlyn/kosync-dotnet), a self-hostable implementation of the KOReader sync server. Available as [services.kosync-dotnet](#opt-services.kosync-dotnet.enable).
