...
- [nanobot](https://github.com/HKUDS/nanobot), a lightweight, open-source personal AI agent that bundles a WebUI, chat-channel integrations, tools, memory, MCP, model routing, and an OpenAI-compatible API. Available as [services.nanobot](#opt-services.nanobot.enable).
