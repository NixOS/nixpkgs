...
- `services.smartd` has been hardened. This might affect you if you have enabled mail notifications with a sendmail implementation that has unusual requirements.
