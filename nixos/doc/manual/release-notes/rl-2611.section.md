...
- [vouch-proxy](https://github.com/vouch/vouch-proxy) An SSO solution for Nginx using the auth_request module. Vouch Proxy forces visitors to login and authenticate with an IdP before allowing them access to a website. Available as [services.vouch-proxy](#opt-services.vouch-proxy.enable).
