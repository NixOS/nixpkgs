...
- [Spotify Soloist](https://developer.spotify.com/documentation/soloist), a headless Spotify Connect client. Available as [services.soloist](#opt-services.soloist.enable).
