...
- [bonfire](https://bonfirenetworks.org), an open-source framework for building federated digital spaces where people can gather, interact, and form communities online. Available as [services.bonfire](#opt-services.bonfire.enable).
