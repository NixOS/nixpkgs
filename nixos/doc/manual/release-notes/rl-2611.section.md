...
- [jail-ai](https://github.com/cyrinux/jail-ai), a podman-based sandbox for AI coding agents, together with the setcap wrapper its eBPF host-blocking filter needs. Available as [programs.jail-ai](#opt-programs.jail-ai.enable).
