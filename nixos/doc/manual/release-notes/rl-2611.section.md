...
- The `programs.dms-shell.enableVPN`, `enableDynamicTheming`, `enableAudioWavelength`, and `enableCalendarEvents` options have been removed. These options only installed optional dependencies; install the required dependencies separately and configure their use in DankMaterialShell.
