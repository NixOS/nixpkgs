...
- [NV Broadcast](https://github.com/Hkshoonya/nvidia-broadcast-linux), an AI-powered virtual camera and microphone application with background removal and noise cancellation. Available as [programs.nvbroadcast](#opt-programs.nvbroadcast.enable).
