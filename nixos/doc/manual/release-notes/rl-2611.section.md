...
- `services.nar-serve.domain` now applies. The option was declared, but the service never got it, thus it did nothing. With it set, nar-serve serves each store path under its own sub-domain.
