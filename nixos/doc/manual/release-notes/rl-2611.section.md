...
- [Dynacat](https://github.com/Panonim/dynacat), a self-hosted dashboard forked from Glance, with OIDC login, a web UI editor and a read-only JSON API. Available as [services.dynacat](#opt-services.dynacat.enable).
