...
- [Wavelog](https://www.wavelog.org/), a web based amateur radio logging software for tracking QSOs, with LoTW, Clublog, eQSL and QRZ integration. Available as [services.wavelog](#opt-services.wavelog.enable).
