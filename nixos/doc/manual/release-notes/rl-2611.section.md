...
- `services.porn-vault.settings.persistence.libraryPath` needs to be appended with "/library" for existing users using a non-default value for that option, due to upstream changes.
