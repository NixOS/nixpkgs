...
- [UniFi Endpoint](https://ui.com/download/app/identity-desktop), Ubiquiti's UniFi Identity VPN and WiFi client. Available as [programs.unifi-endpoint](#opt-programs.unifi-endpoint.enable).
