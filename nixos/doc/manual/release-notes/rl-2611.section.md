...
- [river](https://isaacfreund.com/software/river/), a non-monolithic Wayland compositor.  Unlike other Wayland compositors, river does not combine the compositor and window manager into one program. Instead, users can choose any window manager implementing the [river-window-management-v1](https://isaacfreund.com/docs/wayland/river-window-management-v1) protocol.  Available as [programs.river](#opt-programs.river.enable).

- [kwm](https://github.com/kewuaa/kwm), a DWM-like dynamic tiling window manager implementing the river-window-management-v1 protocol.  Available as [programs.kwm](#opt-programs.kwm.enable).
