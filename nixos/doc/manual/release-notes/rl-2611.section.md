...
- [lprint](https://github.com/michaelrsweet/lprint), a print application for label printers. Available as [services.printing.lprint](#opt-services.printing.lprint.enable).
