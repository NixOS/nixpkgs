...
- [hindsight-api](https://github.com/vectorize-io/hindsight), a semantic agent-memory server exposing retain/recall/reflect operations over a PostgreSQL+pgvector store. Available as [services.hindsight-api](#opt-services.hindsight-api.enable).
