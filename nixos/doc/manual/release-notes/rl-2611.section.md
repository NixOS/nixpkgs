...
- [OpenObserve](https://openobserve.ai/), a cloud-native observability platform for logs, metrics, traces and analytics. Available as [services.openobserve](#opt-services.openobserve.enable).
