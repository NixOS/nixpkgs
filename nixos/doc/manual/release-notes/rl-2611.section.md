...
- `services.mtprotoproxy.extraConfig`, `services.mtprotoproxy.adTag`, `services.mtprotoproxy.users` and `services.mtprotoproxy.port` have been removed in favor of [`services.mtprotoproxy.settings`](#opt-services.mtprotoproxy.settings).
