...
- [bpfilter](https://github.com/facebook/bpfilter), an eBPF-based packet filtering framework for linux. Available as [networking.bpfilter](#opt-networking.bpfilter.enable)
