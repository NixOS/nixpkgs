...
- [Linux Arctis Manager](https://github.com/elegos/Linux-Arctis-Manager) is an open-source replacement for SteelSeries GG, to manage your Arctis headset on Linux. Available as [programs.linux-arctis-manager](#opt-programs.linux-arctis-manager.enable).
