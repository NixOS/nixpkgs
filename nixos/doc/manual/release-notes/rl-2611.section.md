...
- `services.sickbeard` has been renamed to `services.sickgear`. For basic usage of the module, this change should be completely transparent, but if you are directly modifying the user or systemd service, this change will cause backwards incompatible breakage.
