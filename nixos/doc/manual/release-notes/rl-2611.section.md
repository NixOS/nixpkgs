...
- The [`parsedmarc`](#module-services-parsedmarc) module has switched its default search engine from Elasticsearch to OpenSearch. The `services.parsedmarc.provision.elasticsearch` option has been replaced by [`services.parsedmarc.provision.opensearch`](#opt-services.parsedmarc.provision.opensearch).
