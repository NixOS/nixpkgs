...
- [bindery](https://github.com/vavallee/bindery) is an  automated book download manager for Usenet. Monitor authors, search indexers, download via SABnzbd, and organize your library. The modern replacement for Readarr. Available as [services.bindery](#opt-services.bindery.enable).
