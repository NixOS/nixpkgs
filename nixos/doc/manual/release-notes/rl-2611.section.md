...
- [Paperclip](https://github.com/paperclipai/paperclip), a control plane for AI-agent companies, is available through `services.paperclip.instances` on x86_64-linux. Each enabled instance has its own service account and persistent state and can use an embedded or separately provisioned PostgreSQL database. Supply runtime credential files before enabling an instance.
