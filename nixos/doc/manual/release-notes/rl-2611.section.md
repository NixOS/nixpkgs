...
- [stalwart-provision](https://stalw.art/docs/management/cli/apply/), a system allowing the all-in-one Stalwart collaboration and mail server to be fully declaratively configured with Nix. Available as [services.stalwart.provision](#opt-services.stalwart.provision.enable)
...
- [`services.stalwart.settings`](#opt-services.stalwart.settings) now supports [configuring the database](https://stalw.art/docs/ref/object/data-store/) for versions 0.16+.
