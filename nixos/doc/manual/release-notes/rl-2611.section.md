...
- `services.suwayomi-server.dataDir` has changed to store data at the specified path rather than `${dataDir}/.local/share/Tachidesk`, as of 26.05.
  To migrate to the 26.05 and above behaviour, see the [Migrating the data directory](https://nixos.org/manual/nixos/unstable#module-services-suwayomi-migrating-data-directory)
