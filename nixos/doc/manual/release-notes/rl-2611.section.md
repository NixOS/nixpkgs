...
- [Proxmox Backup Server](https://pbs.proxmox.com/docs/), a backup server for VMs and containers with deduplication, compression and authenticated encryption. Available as [services.proxmox-backup-server](#opt-services.proxmox-backup-server.enable).
