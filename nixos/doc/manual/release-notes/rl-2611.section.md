...
- [git-pages](https://git-pages.org/), a static site server that publishes sites from a Git forge, like GitHub Pages or Netlify. Available as [services.git-pages](#opt-services.git-pages.enable).
