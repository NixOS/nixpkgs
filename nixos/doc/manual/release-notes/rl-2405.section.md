...
- `buildDubPackage` can now be used to build Programs written in [D](https://dlang.org/) using the `dub` build
  system and package manager and utilizing lockfiles provided by the new `dub-to-nix` helper program.
