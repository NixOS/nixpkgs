...
- `boot.kernel.sysctl` adds a custom merge option for `net.core.wmem_max` (taking the highest value defined to avoid conflicts between multiple services trying to set that value).
