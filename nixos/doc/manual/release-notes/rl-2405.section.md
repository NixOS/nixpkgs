...
- `stalwart` has been updated to v0.5.3, which includes [breaking changes](https://github.com/stalwartlabs/stalwart/blob/v0.5.3/UPGRADING.md).
...
- `services.stalwart` uses the legacy version 0.6.X as default because newer `stalwart` versions require a [manual upgrade process](https://github.com/stalwartlabs/stalwart/blob/main/UPGRADING.md). Change [`services.stalwart.package`](#opt-services.stalwart.package) to `pkgs.stalwart` if you wish to switch to the new version.
