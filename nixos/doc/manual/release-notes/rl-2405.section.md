...
- The `gamin` and `fileschanged` packages have been removed since they haven't been maintained in over a decade, aren't depended on and have compilation issues.
