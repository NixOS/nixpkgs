...
- Docker now defaults to 25.x, because version 24.x stopped receiving security updates and bug fixes after [February 1, 2024](https://github.com/moby/moby/pull/46772#discussion_r1686464084).
...
- [AMDVLK](https://github.com/GPUOpen-Drivers/AMDVLK), AMD's open source Vulkan driver, is now available to be configured as [hardware.amdgpu.amdvlk](#opt-hardware.amdgpu.amdvlk.enable).
...
- [Misskey](https://github.com/misskey-dev/misskey), an interplanetary microblogging platform. Available as [services.misskey](#opt-services.misskey.enable).
...
- `zed-editor` has been removed since it was outdated (and newer versions cannot be backported as they require rust>=1.80 which is not present on this channel). It remains available in following releases.
