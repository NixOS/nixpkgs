...
- [`lib.path.hasStorePathPrefix`](https://nixos.org/manual/nixpkgs/unstable#function-library-lib.path.hasStorePathPrefix): Whether a [path](https://nix.dev/manual/nix/latest/language/values.html#type-path) has a [store path](https://nix.dev/manual/nix/latest/store/store-path.html#store-path) as a prefix.
