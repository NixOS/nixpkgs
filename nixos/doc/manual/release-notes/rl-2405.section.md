...
- [Tachidesk Serber](https://github.com/Suwayomi/Tachidesk-Server), a free and open source manga reader server that runs extensions built for [Tachiyomi](https://tachiyomi.org). Available as [services.tachidesk-server](#opt-services.tachidesk-server.enable).
