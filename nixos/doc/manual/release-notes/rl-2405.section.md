...
- [filebrowser](https://filebrowser.org/), a web-based file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files. Available as [services.filebrowser](#opt-services.filebrowser.enable).
