...
- [linkding](https://github.com/sissbruecker/linkding), a self-hosted bookmark manager that is designed be to be minimal, fast, and easy to set up using Docker. Available as [services.linkding](#opt-services.linkding.enable).
