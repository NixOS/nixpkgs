...
- [fwknopd](https://www.cipherdyne.org/fwknop/), a Single Packet Authorization (and Port Knocking) server/client. Available as [services.fwknopd](#opt-services.fwknopd.enable).
