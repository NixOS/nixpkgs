...
- `services.hledger-web.capabilities.view`/`add` has been renamed to `services.hledger-web.allow.view`/`add`; `services.hledger-web.capabilities.manage` has been renamed to `services.hledger-web.allow.edit`.
