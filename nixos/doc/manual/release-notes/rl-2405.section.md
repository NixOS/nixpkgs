...
- [Ctrld](https://github.com/Control-D-Inc/ctrld), a highly configurable, multi-protocol DNS forwarding proxy. Available as [services.ctrld](#opt-services.ctrld.enable).
