...
- The `conda` package has been updated to 24.1.2. This package no longer relies on entering a shell to install miniconda. Running `conda init` is still required.
