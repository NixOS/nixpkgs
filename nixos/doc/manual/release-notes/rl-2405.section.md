...
- `optparse-bash` package is now dropped due to upstream inactivity. Alternatives available in Nixpkgs include [`argc`](https://github.com/sigoden/argc), [`argbash`](https://github.com/matejak/argbash), [`bashly`](https://github.com/DannyBen/bashly) and [`gum`](https://github.com/charmbracelet/gum), to name a few.
...
- `budgie` module installs `gnome.gnome-terminal` by default (instead of `mate.mate-terminal`).
...
- `btrbk` module now automatically selects and provides required compression
