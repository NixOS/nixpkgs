...
- The `services.networkmanager.extraConfig` was renamed to `services.networkmanager.extraConfig` and was changed to use the ini type instead of using a multiline string.
