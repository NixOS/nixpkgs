...
- [Gancio](https://gancio.org/), a shared agenda for local communities. Available as [services.gancio](#opt-services.gancio.enable). Register as 'admin' to create the initial administrator user of the gancio instance.
