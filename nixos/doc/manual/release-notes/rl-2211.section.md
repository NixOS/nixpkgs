...
- [asusd](https://asus-linux.org/asusctl), an utility for controlling the lighting, fan curve, GPU mode and more on supported Asus laptops. Available at [services.asusd].
