...
- [Prometheus ZFS exporter](https://github.com/pdf/zfs_exporter), a Prometheus ZFS exporter that reports datasets' sizes/properties. Available as [services.prometheus.exporters.zfs](#opt-services.prometheus.exporters).
