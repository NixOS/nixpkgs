...
- Nix has been upgraded from v2.8.1 to v2.11.0. For more information, please see the release notes for [2.9](https://nix.dev/manual/nix/stable/release-notes/rl-2.9.html), [2.10](https://nix.dev/manual/nix/stable/release-notes/rl-2.10.html) and [2.11](https://nix.dev/manual/nix/stable/release-notes/rl-2.11.html).
