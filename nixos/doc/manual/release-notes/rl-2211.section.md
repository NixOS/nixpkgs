...
- [alacritty](https://github.com/alacritty/alacritty), a cross-platform, OpenGL terminal emulator. Available as [programs.alacritty](#opt-programs.alacritty.enable).
