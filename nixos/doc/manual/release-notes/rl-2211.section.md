...
- The `kratos` package has been updated from `0.9.0-alpha.3` to `0.10.1`. This is the second beta release for kratos, and does have breaking changes. See the [upstream changelog](https://github.com/ory/kratos/releases/tag/v0.10.0) for more details on those breaking changes.
