...
- [Pelican Panel](https://pelican.dev), a game server management panel. Available as [services.pelican-panel](#opt-services.pelican-panel.enable) and [services.wings](#opt-services.wings.enable) (for the control plane).
