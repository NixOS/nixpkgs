...
- `services.logrotate.configFile` has been removed. If you still need to load a config from another directory, use `include` directives within `config.logrotate.settings`.
