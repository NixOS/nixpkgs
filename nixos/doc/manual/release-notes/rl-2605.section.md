...
- `rocmPackages_6` has been removed. `rocmPackages` now defaults to ROCm 7.x. Packages which rely on obsolete hipblas APIs or compile time constant warp size will not build.
