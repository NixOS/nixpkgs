...
- [services.activemq.extraJavaOptions](#opt-services.activemq.extraJavaOptions) type was changed to a list of strings for better consistency and flexibility in specifying multiple Java options.
