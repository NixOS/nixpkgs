...
- `sing-box` has been updated to 1.13.0, and support for NaïveProxy outbound has been added.  This release has removed some deprecated options.  See [upstream documentation](https://sing-box.sagernet.org/configuration/) for details and migration options.
