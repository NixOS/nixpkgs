...
- `services.radicle` now supports richer systemd-creds configurations for the private key file.  This should serve as a model for supporting encrypted credentials in other modules.
