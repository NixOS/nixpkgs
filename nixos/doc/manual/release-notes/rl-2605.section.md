...
- [uMap](https://umap-project.org), an open-source collaborative mapping platform that lets you create maps with OpenStreetMap layers and embed them in your site. Available as [services.umap](#opt-services.umap.enable).
