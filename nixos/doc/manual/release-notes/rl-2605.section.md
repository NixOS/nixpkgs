...
- [Yamtrack](https://github.com/FuzzyGrim/Yamtrack), a self hosted media tracker for movies, tv shows, anime, manga, video games, books, comics, and board games. Available as [services.yamtrack](#opt-services.yamtrack.enable).
