...
- The [recyclarr](#opt-services.recyclarr.enable) module now automatically triggers an immediate sync when the NixOS-level configuration changes during activation instead of waiting for the next scheduled run.
