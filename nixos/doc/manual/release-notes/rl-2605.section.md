...
- `services.freshrss.authType` no longer supports `"none"` as authenticathion method, in line with upstream. If you still need this behavior, you can use `services.freshrss.extensions = [freshrss-extensions.unsafe-auto-login];`.
