...
- `recyclarr` was upgraded to 8.x.y, which contains breaking changes. Refer to [upstream documentation](https://recyclarr.dev/guide/upgrade-guide/v8.0/) for changes in outputs and configs and update config approprately.
