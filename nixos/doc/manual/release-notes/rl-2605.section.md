...
- `services.overseerr` has been removed as the `overseerr` and `jellyseerr` projects were merged under `seerr`; you can migrate the existing services to `services.seerr`.
