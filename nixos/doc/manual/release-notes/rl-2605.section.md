...
- User-Mode Linux, a version of Linux which can be run as a program on Linux without an external virtual machine. Available as [system.build.uml-loader](#opt-system.build) and configured through [virtualisation.uml](#opt-virtualisation.uml.drives)
