...
- [Booklore](https://github.com/booklore-app/booklore), a self-hosted app for managing and reading books & comics (PDF, EPUB, CBZ) with metadata editing, OPDS, reading progress, and multi-user support. Available as [services.booklore](#opt-services.booklore.enable).
