...
- [daed](https://github.com/daeuniverse/daed), a modern dashboard with dae, a high-performance transparent proxy solution based on eBPF. Available as [services.daed](#opt-services.daed.enable).
