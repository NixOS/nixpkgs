...
- [mautrix-googlechat](https://github.com/mautrix/googlechat), a Matrix <-> Google Chat puppeting bridge. Available as [services.mautrix-googlechat](#opt-services.mautrix-googlechat.enable).
