...
4.  ::: note
    ...
    At this point it is time to prepare your target partition. Please refer to the partitioning, file-system creation, and mounting steps of [](#sec-installation)
...
5.  Generate your NixOS configuration:
    ...
    You\'ll probably want to edit the configuration files. Refer to the `nixos-generate-config` step in [](#sec-installation) for more information.
...
7.  Download/build/install NixOS:
    ...
    Again, please refer to the `nixos-install` step in [](#sec-installation) for more information.
...
9.  ::: note
    ...
    Note that this will place the generated configuration files in `/etc/nixos`. You\'ll probably want to edit the configuration files. Refer to the `nixos-generate-config` step in [](#sec-installation) for more information.
