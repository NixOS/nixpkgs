{ lib, mkDerivation, fetchFromGitHub, cmake, pkg-config, lxqt, qtbase, qttools
, qtx11extras, libfm-qt, menu-cache, lxmenu-data, lxqtUpdateScript }:
...
mkDerivation rec {
  ...
  buildInputs =
    [ qtbase qttools qtx11extras libfm-qt libfm-qt menu-cache lxmenu-data ];
