...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    # Remove when https://gitlab.com/ubports/development/core/lomiri-download-manager/-/merge_requests/32 merged & in release
    ./1001-treewide-Make-pkg-config-includedir-values-reasonable.patch
  ];
