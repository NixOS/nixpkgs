{ atk, autoreconfHook, cacert, cinnamon-desktop, cinnamon-menus, cjs, dbus-glib, fetchFromGitHub, gdk-pixbuf, glib, gobject-introspection, gtk3, intltool, json-glib, libcroco, libsoup, libstartup_notification, libXtst, muffin, networkmanager, pkgconfig, polkit, stdenv, wrapGAppsHook, libxml2, gnome2, python3 }:
