...
stdenv.mkDerivation rec {
  ...
  configureFlags = [ "--with-tests=none" "--enable-sdl" "--enable-egl" "--enable-drm" "--enable-drm-hw-accel" "--with-opengl=full" "--enable-image-loader-jp2k" "--enable-xinput22" "--enable-multisense" "--enable-systemd" "--enable-image-loader-webp" "--enable-harfbuzz" "--enable-wayland" "--enable-xine" "--enable-fb" "--disable-tslib" "--with-systemdunitdir=$out/systemd/user" "--enable-lua-old" ];
