{ mkXfceDerivation, exo, garcon, glib, gobject-introspection, gtk3
...
mkXfceDerivation {
  ...
  propagatedBuildInputs = [ glib gtk3 libxfce4util ];
  ...
  meta = { description = "Panel for the Xfce desktop environment"; };
}
