...
lib.makeScope pkgs.newScope (self:
  with self;
  {
    ...
    gitLister = url: "${pkgs.common-updater-scripts}/bin/list-git-tags ${url}";
    ...
    xfce4-hardware-monitor-plugin =
      callPackage ./panel-plugins/xfce4-hardware-monitor-plugin { };
    ...
    xfce4-mixer = throw
      "deprecated 2019-08-18: obsoleted by xfce4-pulseaudio-plugin"; # added 2019-08-18
    gtk-xfce-engine = throw
      "deprecated 2019-09-17: Xfce 4.14 deprecated gtk-xfce-engine"; # added 2019-09-17
    xfce4-dict-plugin = throw
      "deprecated 2020-04-19: xfce4-dict-plugin is now part of xfce4-dict."; # added 2020-04-19
    ...
    gtk = pkgs.gtk2;
    libxfcegui4 = throw
      "libxfcegui4 is the deprecated Xfce GUI library. It has been superseded by the libxfce4ui library";
    xinitrc = xfce4-session.xinitrc;
    inherit (pkgs.gnome2) libglade;
    inherit (pkgs.gnome) vte gtksourceview;
    xfce4-mixer-pulse = xfce4-mixer;
    thunar-bare = thunar.override { thunarPlugins = [ ]; };
