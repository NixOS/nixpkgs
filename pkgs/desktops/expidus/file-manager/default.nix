...
flutter.buildFlutterApplication rec {
  ...
  postInstall = ''
    ...
    ln -s $out/app/$name/file_manager $out/bin/expidus-file-manager

    mkdir -p $out/share/applications
    mv $out/app/$name/data/com.expidusos.file_manager.desktop $out/share/applications

    mkdir -p $out/share/icons
    mv $out/app/$name/data/com.expidusos.file_manager.png $out/share/icons

    mkdir -p $out/share/metainfo
    mv $out/app/$name/data/com.expidusos.file_manager.metainfo.xml $out/share/metainfo
