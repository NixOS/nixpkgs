...
flutter.buildFlutterApplication rec {
  ...
  postInstall = ''
    ...
    ln -s $out/app/$name/calculator $out/bin/expidus-calculator

    mkdir -p $out/share/applications
    mv $out/app/$name/data/com.expidusos.calculator.desktop $out/share/applications

    mkdir -p $out/share/icons
    mv $out/app/$name/data/com.expidusos.calculator.png $out/share/icons

    mkdir -p $out/share/metainfo
    mv $out/app/$name/data/com.expidusos.calculator.metainfo.xml $out/share/metainfo
