{ stdenv, lib, fetchurl, meson, ninja, pkg-config, libxml2, gnome, gtk3, gettext
, libX11, itstool, wrapGAppsHook }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ meson ninja pkg-config gettext itstool libxml2 wrapGAppsHook ];
