{ lib, stdenv, gettext, meson, ninja, fetchurl, fetchpatch, apacheHttpd
, nautilus, pkg-config, gtk3, glib, libxml2, systemd, wrapGAppsHook, itstool
, libnotify, mod_dnssd, gnome, libcanberra-gtk3, python3 }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://gitlab.gnome.org/GNOME/gnome-user-share/commit/8772980d4732c15505b15dccff2ca3c97e96d49d.patch";
  ...
  nativeBuildInputs =
    [ pkg-config meson ninja gettext itstool libxml2 wrapGAppsHook python3 ];
