{ lib, stdenv, meson, ninja, gettext, fetchurl, pkg-config, gtk3, glib, libxml2
, gnome-desktop, adwaita-icon-theme, libhandy, wrapGAppsHook, gnome, harfbuzz }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ gtk3 glib gnome-desktop adwaita-icon-theme harfbuzz libhandy ];
