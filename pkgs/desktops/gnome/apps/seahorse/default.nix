{ lib, stdenv, fetchurl, vala, meson, ninja, libpwquality, pkg-config, gtk3
, glib, glib-networking, wrapGAppsHook, itstool, gnupg, libsoup, gnome, gpgme
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ meson ninja pkg-config vala itstool wrapGAppsHook python3 ];
