{ lib, stdenv, itstool, fetchurl, gdk-pixbuf, adwaita-icon-theme, telepathy-glib
, gjs, meson, ninja, gettext, telepathy-idle, libxml2, desktop-file-utils
, pkg-config, gtk4, gtk3, glib, libsecret, libsoup, webkitgtk
