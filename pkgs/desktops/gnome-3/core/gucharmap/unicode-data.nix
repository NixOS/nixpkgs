...
stdenv.mkDerivation {
  ...
  srcs = [
    ...
    (fetchurl {
      url = "https://www.unicode.org/Public/10.0.0/ucd/DerivedAge.txt";
      sha256 = "1h9p1g0wnh686l6cqar7cmky465vwc6vjzzn1s7v0i9zcjaqkr4h";
    })
    (fetchurl {
      url = "https://www.unicode.org/Public/10.0.0/ucd/NamesList.txt";
    ...
    (fetchurl {
      url = "https://www.unicode.org/Public/10.0.0/ucd/Unihan.zip";
