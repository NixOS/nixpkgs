...
, attica, baloo, boost, fontconfig, kactivities, kactivities-stats, kauth, kcmutils
...
plasmaPackage rec {
  ...
  buildInputs = [
    ...
    xf86inputsynaptics xkeyboard_config xinput baloo kactivities kactivities-stats kauth
