...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchurl {
      name =
        "CVE-2020-12695_0001-WPS-UPnP-Do-not-allow-event-subscriptions-with-URLs-.patch";
      url =
    ...
    (fetchurl {
      name =
        "CVE-2020-12695_0002-WPS-UPnP-Fix-event-message-generation-using-a-long-U.patch";
      url =
    ...
    (fetchurl {
      name =
        "CVE-2020-12695_0003-WPS-UPnP-Handle-HTTP-initiation-failures-for-events-.patch";
      url =
