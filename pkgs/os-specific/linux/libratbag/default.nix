...
, json-glib, libunistring, wrapGAppsNoGuiHook, gobject-introspection }:
...
stdenv.mkDerivation rec {
  ...
  preFixup = ''
    gappsWrapperArgs+=(
      --prefix PYTHONPATH : "${python3.pkgs.makePythonPath [ python3.pkgs.evdev python3.pkgs.pygobject3 ]}"
    )
  '';
