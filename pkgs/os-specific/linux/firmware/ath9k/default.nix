...
stdenv.mkDerivation (finalAttrs: {
  ...
  stable =
    ...
    common.overrideAttrs(prevAttrs: {
      ...
      passthru.update = prevAttrs.passthru.update.overrideAttrs(prevAttrs: {
  ...
  unstable = common.overrideAttrs(prevAttrs: {
    pname = "ath9k-htc-blobless-firmware-unstable";
    version = "2022-05-22";
    src = fetchFromGitHub {
      owner = "qca";
      repo = "open-ath9k-htc-firmware";
