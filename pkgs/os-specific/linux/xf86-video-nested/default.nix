{ stdenv, fetchgit, autoreconfHook, libX11, libXext
, pixman, pkgconfig, xorgproto, utilmacros, xorgserver
}:
...
stdenv.mkDerivation {
  ...
  buildInputs =
    [ autoreconfHook libX11 libXext pixman
      pkgconfig xorgproto utilmacros xorgserver
    ];
