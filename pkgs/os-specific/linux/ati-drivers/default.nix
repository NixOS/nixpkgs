...
stdenv.mkDerivation {
  name = "ati-drivers-14.9" + (optionalString (!libsOnly) "-${kernel.version}");
  ...
  src = fetchurl {
    url = http://www2.ati.com/drivers/linux/amd-catalyst-14-9-linux-x86-x86-64.zip;
    sha256 = "0yn037kfn4m7yk7zmzyfvilaydwba2gaizgsw0y44apr1nbz32pj";
