{ lib, stdenv, fetchFromGitHub, fetchpatch, autoreconfHook, pkg-config, glib
, ncurses, libcap_ng }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/Irqbalance/irqbalance/commit/f8bdd0e64284d841544fd3ebe22f4652902ba8d2.patch";
