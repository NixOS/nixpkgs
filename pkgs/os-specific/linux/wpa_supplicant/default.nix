{ lib, stdenv, fetchurl, fetchpatch, openssl, pkg-config, libnl, nixosTests
, withDbus ? true, dbus, withReadline ? true, readline, withPcsclite ? true
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl libnl ] ++ optional withDbus dbus
  ...
  passthru.tests = { inherit (nixosTests) wpa_supplicant; };
