...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://kernel.org/pub/linux/utils/nfs-utils/${version}/${pname}-${version}.tar.xz";
  ...
  patches = lib.optionals stdenv.hostPlatform.isMusl [
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/alpinelinux/aports/cb880042d48d77af412d4688f24b8310ae44f55f/main/nfs-utils/0011-exportfs-only-do-glibc-specific-hackery-on-glibc.patch";
