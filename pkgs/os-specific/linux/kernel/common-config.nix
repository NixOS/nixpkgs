...
''
  ...
  XEN? y
  XEN_DOM0? y
  ${optionalString ("xen_dom0" ? features && features.xen_dom0 ) ''
    X86_IO_APIC y
    ACPI y
    ACPI_PROCFS y
    PCI_XEN y
    ...
    XEN_GNTDEV y
    XEN_BACKEND y
    XEN_NETDEV_BACKEND y
    XEN_BLKDEV_BACKEND y
    XEN_PCIDEV_BACKEND y
    ...
    XEN_PRIVCMD y
    XEN_XENBUS_DEV y
    XEN_NETDEV_ACCEL_SFC_UTIL y
    XEN_BLKDEV_TAP y
    XEN_BLKDEV_TAP2 y
    XEN_BLKBACK_PAGEMAP y
    XEN_NETDEV_TX_SHIFT 10
    XEN_NETDEV_ACCEL_SFC_BACKEND y
    XEN_NETDEV_LOOPBACK y
    XEN_PCIDEV_BACKEND_VPCI y
    XEN_TPMDEV_BACKEND y
    XEN_SCSI_BACKEND y
    XEN_USB_BACKEND y
    XEN_BLKDEV_FRONTEND y
    XEN_NETDEV_FRONTEND y
    XEN_NETDEV_ACCEL_SFC_FRONTEND y
    XEN_SCSI_FRONTEND y
    XEN_USB_FRONTEND y
    XEN_GRANT_DEV y
    XEN_FRAMEBUFFER y
    XEN_KEYBOARD y
    XEN_SYSFS y
    XEN_NR_GUEST_DEVICES 2048
    XEN_COMPAT_030300_AND_LATER y
    XEN_COMPAT 0x030300
    XEN_VCPU_INFO_PLACEMENT y
    XEN_SMPBOOT y
    XEN_DEVMEM y
  ''}
