...
in {
  ...
  config ? stdenv.lib.optionalAttrs allowImportFromDerivation (parseConfig configfile),
  # Cross-compiling config
  crossConfig ? if allowImportFromDerivation then parseConfig crossConfigfile else config,
...
let
  ...
  drvAttrs = config: platform: kernelPatches: configfile:
