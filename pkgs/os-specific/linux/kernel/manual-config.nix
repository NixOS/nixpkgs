...
, fetchpatch
, rustc, rust-bindgen, rustPlatform, diffutils, strace
# We run make oldconfig as part of the build. When this flag is set to false, we will die when make oldconfig
# changes the configuration. This is useful for debugging the derivation, as configs generated by generic.nix
# should not be modified by make oldconfig.
  ...
  drvAttrs = config_: kernelConf: kernelPatches: configfile:
    ...
    in (optionalAttrs isModular { outputs = [ "out" "dev" ]; }) // {
      ...
      nativeBuildInputs = [
        ...
        ++ optionals withRust [ rustc rust-bindgen ]
        ++ optional  (!allowConfigChanges) diffutils;
      ...
      '' + lib.optionalString (!allowConfigChanges) ''
        # Fail the build if the config file was modified.
        diff -u ${configfile} $buildRoot/.config
      '' + ''
