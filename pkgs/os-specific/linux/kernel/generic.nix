...
, # A list of patches to apply to the kernel.  Each element of this list
  ...
  kernelPatches ? []
, ignoreConfigErrors ? stdenv.hostPlatform.linux-kernel.name or null != "pc" ||
...
, autoModules ? stdenv.hostPlatform.linux-kernel.autoModules or false
...
let
  ...
  configfile = stdenv.mkDerivation {
    ...
    platformName = stdenv.hostPlatform.linux-kernel.name or "";
    # e.g. "defconfig"
    kernelBaseConfig = if defconfig != null then defconfig else stdenv.hostPlatform.linux-kernel.baseConfig;
    # e.g. "bzImage"
    kernelTarget = stdenv.hostPlatform.linux-kernel.target or "Image";
