{
  ...
  assert !versionOlder version "391" -> stdenv.hostPlatform.system == "x86_64-linux"; let
    ...
    self = stdenv.mkDerivation {
      ...
      passthru =
        {
          settings = (if settings32Bit
          then pkgsi686Linux.callPackage
          else callPackage) (import ./settings.nix self settingsSha256) {
            withGtk2 = preferGtk2;
            withGtk3 = !preferGtk2;
          };
