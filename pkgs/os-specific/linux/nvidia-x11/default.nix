...
rec {
  ...
  beta = generic {
    version = "495.46";
    sha256_64bit = "sha256-2Dt30X2gxUZnqlsT1uqVpcUTBCV7Hs8vjUo7WuMcYvU=";
    settingsSha256 = "sha256-vbcZYn+UBBGwjfrJ6SyXt3+JLBeNcXK4h8mjj7qxZPk=";
    persistencedSha256 = "sha256-ieYqkVxe26cLw1LUgBsFSSowAyfZkTcItIzQCestCXI=";
  };
