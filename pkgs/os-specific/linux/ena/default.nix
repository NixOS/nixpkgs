...
stdenv.mkDerivation rec {
  ...
  patches = [
    # kernel 6.2/6.3 support, https://github.com/amzn/amzn-drivers/issues/270
    (fetchpatch {
      name = "devlink_6_2_fix.patch";
    ...
    # kernel 6.2+ support, https://github.com/amzn/amzn-drivers/issues/269
    (fetchpatch {
      name = "phc_kernel_6_2_fix.patch";
