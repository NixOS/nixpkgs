...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    # Addition of comments needed for next patch to apply.
    (fetchpatch {
      url = "https://git.busybox.net/busybox/patch/?id=029740a3e43835d2a71696449baba5250a346e0a";
      hash = "sha256-HTN7swL74yrPw7XDJx0H8OMpV0thmzewc+uOUHTqd68=";
    })
