...

{
  ...
  Libc =
    applePackage' "Libc" "1439.40.11" "macos-11.0.1"
      "12k5sbz2k1pl839w2lk9iw414zzl50zdjzgq2x6bm20yjbfj69qm"
      { };
  Libinfo =
    applePackage' "Libinfo" "542.40.3" "macos-11.0.1"
      "18jvl7cdg64x6clhsfv5pbzxis2aldddpca5r81xqakrmi9mck80"
      { };
  Libnotify =
    applePackage' "Libnotify" "279.40.4" "macos-11.0.1"
  ...
  Libsystem =
    applePackage' "Libsystem" "1292.50.1" "macos-11.0.1"
      "0d3flh1p4kskic8ypi8wia4kinfbprx9fvyfqc3mcq0710i0gy77"
      { };
  PowerManagement =
    applePackage' "PowerManagement" "1132.50.3" "macos-11.0.1"
      ...
      { };
  Security =
    applePackage' "Security" "59754.41.1" "macos-11.0.1"
  ...
  architecture =
    applePackage' "architecture" "279" "macos-11.0.1"
      "19s93rqr9r98qh0rlndf7kv3v4n1ifh9i539mbpsx6kbixcx8vvp"
      { };
  basic_cmds =
    applePackage' "basic_cmds" "55" "macos-11.0.1"
      "1913pzk376zfap2fwmrb233rkn4h4l2c65nd7s8ixvrz1r7cz0q5"
      { };
  bootstrap_cmds =
    applePackage' "bootstrap_cmds" "121" "macos-11.0.1"
      "0qgbgwijv7xqmm9gn74jibyw2dh516xpj7h1grj2j1i80m3b16bl"
      { };
  configd =
    applePackage' "configd" "1109.40.9" "macos-11.0.1"
      "024ny63lpwzgnm8g28hh8dldvmmislmrl298n721rm0blqjhahz5"
      { };
  copyfile =
    applePackage' "copyfile" "173.40.2" "macos-11.0.1"
      "1j20909inn2iw8n51b8vk551wznfi3bhfziy8nbv08qj5lk50m04"
      { };
  diskdev_cmds =
    applePackage' "diskdev_cmds" "667.40.1" "macos-11.0.1"
      "0wr60vyvgkbc4wyldnsqas0xss2k1fgmbdk3vnhj6v6jqa98l1ny"
      { };
  dtrace =
    applePackage' "dtrace" "370.40.1" "macos-11.0.1"
  ...
  eap8021x =
    applePackage' "eap8021x" "304.40.1" "macos-11.0.1"
      "1aihyklri64w380d1mvi830n5cnzs9gd38z8i9ccd37n48gmz88p"
      { };
  file_cmds =
    applePackage' "file_cmds" "321.40.3" "macos-11.0.1"
  ...
  libclosure =
    applePackage' "libclosure" "78" "macos-11.0.1"
      "0vf9n0k3m8dbprv1bf45zqg0g43bidy2i5z1v9a826bsf8lv7am7"
      { };
  libdispatch =
    applePackage' "libdispatch" "1271.40.12" "macos-11.0.1"
      "1ck5srcjapg18vqb8wl08gacs7ndc6xr067qjn3ngx39q1jdcywz"
      { };
  libmalloc =
    applePackage' "libmalloc" "317.40.8" "macos-11.0.1"
      "sha256-Tdhb0mq3w4Hwvp3xHB79Vr22hCOQK6h28HCsd7jvITI="
      { };
  libplatform =
    applePackage' "libplatform" "254.40.4" "macos-11.0.1"
      "1qf3ri0yd8b1xjln1j1gyx7ks6k3a2jhd63blyvfby75y9s7flky"
      { };
  libpthread =
    applePackage' "libpthread" "454.40.3" "macos-11.0.1"
  ...
  libunwind =
    applePackage' "libunwind" "200.10" "macos-11.0.1"
      "0wa4ssr7skn5j0ncm1rigd56qmbs982zvwr3qpjn28krwp8wvigd"
      { };
  libutil =
    applePackage' "libutil" "58.40.2" "macos-11.0.1"
      "11s0vizk7bg0k0yjx21j8vaji4j4vk57131qbp07i9lpksb3bcy4"
      { };
  mDNSResponder =
    applePackage' "mDNSResponder" "1310.40.42" "macos-11.0.1"
      ...
      { };
  network_cmds =
    applePackage' "network_cmds" "606.40.2" "macos-11.0.1"
  ...
  removefile =
    applePackage' "removefile" "49.40.3" "macos-11.0.1"
      "0870ihxpmvj8ggaycwlismbgbw9768lz7w6mc9vxf8l6nlc43z4f"
      { };
  shell_cmds =
    applePackage' "shell_cmds" "216.40.4" "macos-11.0.1"
      "0wbysc9lwf1xgl686r3yn95rndcmqlp17zc1ig9gsl5fxyy5bghh"
      { };
  text_cmds =
    applePackage' "text_cmds" "106" "macos-11.0.1"
  ...
  xnu =
    applePackage' "xnu" "7195.50.7.100.1" "macos-11.0.1"
      "11zjmpw11rcc6a0xlbwramra1rsr65s4ypnxwpajgbr2c657lipl"
      { };
}
