...
appleDerivation {
  ...
  patchPhase = ''
    substituteInPlace file_cmds.xcodeproj/project.pbxproj \
      --replace-fail "FC8A8CAA14B655FD001B97AD /* PBXTargetDependency */," "" \
      --replace-fail "FC8A8C9C14B655FD001B97AD /* PBXTargetDependency */," "" \
      --replace-fail "productName = file_cmds;" "" \
      --replace-fail '/usr/lib/libcurses.dylib' 'libncurses.dylib'
