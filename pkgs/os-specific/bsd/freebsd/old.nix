...
assert stdenv.hostPlatform.isFreeBSD;
let
  inherit (buildPackages.buildPackages) rsync;
  versionInfos = {
    "x86_64-freebsd13" = rec { version = "13.1.0"; rev = "release/${version}"; hash = "14nhk0kls83xfb64d5xy14vpi6k8laswjycjg80indq9pkcr2rlv"; };
    "x86_64-freebsd14" = rec { version = "14.0.0-ALPHA1"; rev = "d1d7a273707a50d4ad1691b2c4dbf645dfa253ea"; hash = "14nhk0kls83xfb64d5xy14vpi6k8laswjycjg80indq9pkcr2rlv"; };
  };
  versionInfo = versionInfos.${stdenv.hostPlatform.system};
