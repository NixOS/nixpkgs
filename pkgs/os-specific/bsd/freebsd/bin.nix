{ libc, mkDerivation, buildPackages, buildFreebsd, libjail, libmd, libnetbsd, libcapsicum, libcasper, libelf, libxo, libncurses-tinfo, libedit, lib, stdenv, libkvm, ...}:
mkDerivation {
  pname = "bins";
  path = "bin";
  ...
  '' + ''
    export NIX_CFLAGS_COMPILE="-I$BSDSRCDIR/sys $NIX_CFLAGS_COMPILE -D_WCHAR_T -D_VA_LIST -D_VA_LIST_DECLARED -Dva_list=__builtin_va_list -D_SIZE_T -DIUTF8=0x4000"
