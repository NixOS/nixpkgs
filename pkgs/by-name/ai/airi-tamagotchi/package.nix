...
rustPlatform.buildRustPackage (final: {
  ...
  src = fetchFromGitHub {
    owner = "moeru-ai";
    repo = "airi";
    rev = "0e907295ab1dc9dc717885a598b8011d9fe76619";
    hash = "sha256-/2SkcQadRI+JmJ7SonmB+N/nu9r7K0F8grALv+/ZEbI=";
  };
  ...
  pnpmDeps = pnpm.fetchDeps {
    ...
    hash = "sha256-lIDGjFXZF6D02WOxWQEL/oTVqzWT7pWKOdR8VNRmVlQ=";
  };
