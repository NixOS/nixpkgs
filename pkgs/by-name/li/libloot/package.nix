...
stdenv.mkDerivation rec {
  ...
  checkPhase = ''
    ...
    ./libloot_internals_tests --gtest_filter='-CompareFilenames.shouldBeCaseInsensitiveAndLocaleInvariant:NormalizeFilename.shouldCaseFoldStringsAndBeLocaleInvariant'
    ./libloot_tests
