...
let
  cef = cef-binary.override {
    version = "135.0.17"; # follow upstream. https://github.com/Almamu/linux-wallpaperengine/blob/da273b5012ed60f0ad4094f45a0395c3e1aba972/CMakeLists.txt#L47
    gitRevision = "cbc1c5b";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "da273b5012ed60f0ad4094f45a0395c3e1aba972";
    fetchSubmodules = true;
    hash = "sha256-4+Dr69RXz62UXPdKtwQZxxbilj/7UEPRX/B98vGWy9Y=";
  };
