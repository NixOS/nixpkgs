{
  ...
  config,
  customtkinter ? python312Packages.customtkinter,
  cv2-enumerate-cameras ? python312Packages.cv2-enumerate-cameras,
  fetchFromGitHub,
  fetchurl,
  gfpgan ? python312Packages.gfpgan,
  insightface ? python312Packages.insightface,
  lib,
  ...
  opennsfw2 ? python312Packages.opennsfw2,
  pillow ? python312Packages.pillow,
  protobuf,
  psutil ? python312Packages.psutil,
  pygrabber ? python312Packages.pygrabber,
  python312Packages,
  ...
  tk,
  tkinter ? python312Packages.tkinter,
  ...
  typing-extensions ? python312Packages.typing-extensions,
