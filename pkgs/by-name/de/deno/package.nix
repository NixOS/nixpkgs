...
rustPlatform.buildRustPackage rec {
  ...
  preInstall = ''
    ...
    find ./target -name libtest_ffi${stdenv.hostPlatform.extensions.sharedLibrary} -delete
    find ./target -name libtest_napi${stdenv.hostPlatform.extensions.sharedLibrary} -delete
  '';
