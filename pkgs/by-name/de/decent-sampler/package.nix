...
let
  ...
  decent-sampler = stdenv.mkDerivation {
    ...
    src = fetchzip {
      ...
      url = "https://www.dropbox.com/scl/fo/a0i0udw7ggfwnjoi05hh3/AGoykmfpMYaMq1eu_5bZvZU/Decent_Sampler-${version}-Linux-Static-x86_64.tar.gz?rlkey=${rlkey}&dl=0";
      hash = "sha256-kJPdy5i++/Saf9KtHFfQtH+vceeztf70IrZ1E7WxqWU=";
    };
