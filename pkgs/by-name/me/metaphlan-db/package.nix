...
stdenvNoCC.mkDerivation (
  finalAttrs:
  let
    version = builtins.substring 2 (builtins.stringLength finalAttrs.version) finalAttrs.version; # Remove the prefix 0- from the version (needed to satisfy the numerical prefix in pkgs/CONTRIBUTING.md)
  in
  {
    pname = "metaphlan-db";
    version = "0-Jun23_CHOCOPhlAnSGB_202307";
    ...
    installPhase =
      let
        mpa_database = builtins.elemAt finalAttrs.srcs 0;
        mpa_checksum = builtins.elemAt finalAttrs.srcs 1;
        mpa_marker_info = builtins.elemAt finalAttrs.srcs 2;
        mpa_species = builtins.elemAt finalAttrs.srcs 3;
        mpa_bowtie_db = builtins.elemAt finalAttrs.srcs 4;
        mpa_bowtie_checksum = builtins.elemAt finalAttrs.srcs 5;
      in
      ''
        runHook preInstall
