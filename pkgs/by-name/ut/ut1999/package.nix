...
let
  ...
  srcs = rec {
    x86_64-linux = fetchurl {
      url = "https://github.com/OldUnreal/UnrealTournamentPatches/releases/download/v${version}${version-suffix}/OldUnreal-UTPatch${version}-Linux-amd64.tar.bz2";
      hash = "sha256-VR4Ldb2LVqO/6kIZINLyndaxf1qzmB1xJrzZHAaoOU0=";
    };
    aarch64-linux = fetchurl {
      url = "https://github.com/OldUnreal/UnrealTournamentPatches/releases/download/v${version}${version-suffix}/OldUnreal-UTPatch${version}-Linux-arm64.tar.bz2";
      hash = "sha256-vMZfmdD0THSIt//ku90bmURqGIRAcsOojJncis2Cr4w=";
    };
    i686-linux = fetchurl {
      url = "https://github.com/OldUnreal/UnrealTournamentPatches/releases/download/v${version}${version-suffix}/OldUnreal-UTPatch${version}-Linux-x86.tar.bz2";
      hash = "sha256-Qel/p5wDLsrmD+Nd/+6+s4b6rjcPFDbRw18VHsMH47M=";
    };
    x86_64-darwin = fetchurl {
      url = "https://github.com/OldUnreal/UnrealTournamentPatches/releases/download/v${version}${version-suffix}/OldUnreal-UTPatch${version}-macOS-.dmg";
