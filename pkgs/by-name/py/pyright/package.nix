...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "pyright";
    rev = "${version}";
    hash = "sha256-6P2gaFgHjE4FrV43HcnchVtMH1/vbrHLgCAnsqU9X30=";
  };
  ...
  pyright-internal = buildNpmPackage {
    ...
    npmDepsHash = "sha256-wr3vp4s0vegjMr9jIKWVUI/DNAERvIOdKO28+AvxUmQ=";
    dontNpmBuild = true;
    installPhase = ''
      runHook preInstall
      cp -r . "$out"
...
buildNpmPackage rec {
  ...
  npmDepsHash = "sha256-U6AJXpn+Ccj4hE7peZdewJf6K3dqmL9KnFFaEQPAnKM=";
