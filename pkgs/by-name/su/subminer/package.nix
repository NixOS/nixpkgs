...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-5wD2uivFd/KQg2o7Ci/rUJ6ja2FIrXaziFUPyTr2YUk=";
  ...
  rootDeps = mkBunDeps {
    ...
    name = "root";
    hashes = {
      aarch64-darwin = "sha256-dvHiXSfnwSxq6dFTFJ8/1puqdRpzgaI0NkQd/SqSNBg=";
      x86_64-linux = "sha256-6LEdrfFgBcgN5URhBp86Ni1JayZccPVBhdl4vWZ6X1A=";
    };
  };
