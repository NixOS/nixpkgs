...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    makeWrapper $out/lib/slack/slack $out/bin/slack \
      ...
      --add-flags "\''${NIXOS_OZONE_WL:+\''${WAYLAND_DISPLAY:+--ozone-platform-hint=auto --ozone-platform=wayland --enable-features=WaylandWindowDecorations,WebRTCPipeWireCapturer --enable-wayland-ime=true}}"
