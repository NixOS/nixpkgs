  ...
  sources =
    ...
    in
    {
      ...
      aarch64-linux = {
        version = "4.1.0.13";
        src = fetchurl {
          url = "https://web.archive.org/web/20251121053934/https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_arm64.AppImage";
      ...
      x86_64-linux = {
        version = "4.1.0.13";
        src = fetchurl {
          url = "https://web.archive.org/web/20251121053850/https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_x86_64.AppImage";
