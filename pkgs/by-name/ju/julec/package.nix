...
clangStdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-K8eKC5RmW3yTawNsVfOUTVBhVskQRvciYM8Pp+3akts=";
  };
  ...
  irSrc = fetchFromGitHub {
    ...
    rev = "02854fbce42e22a6cfadf95d392b42640748e66a";
    name = "jule-ir-${finalAttrs.version}";
    hash = "sha256-ZlszBaaVPRMEDhz/o6IUFjLK24mhnvQrGMjjDdTcwi8=";
  };
