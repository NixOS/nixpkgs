{
  ...
  # Codecs
  # exhale # Missing from nixpkgs as of 2025/07/21 ?
  faac, # free = false
  faad2,
  fdk_aac,
  ffmpeg,
  ...
  libcdio,
  libcdio-paranoia,
  # libcdrip, # Missing from nixpkgs as of 2025/07/21 ?
  libogg,
  libopus,
  libsamplerate,
  libsndfile,
  libvorbis,
  # mac, # Same APE codec as monkeysAudio ?
  monkeysAudio,
  mp4v2,
  mpg123,
  # musepack, # Missing from nixpkgs as of 2025/07/21 ? or libmpcdec ?
  rnnoise,
  rubberband,
  speex,
  wavpack,
...
stdenv.mkDerivation (finalAttrs: {
  ...
  postBuild = ''
    ...
    install -Dm 444 ${lib.getLib libcdio}/lib/libcdio.so.19        $out
