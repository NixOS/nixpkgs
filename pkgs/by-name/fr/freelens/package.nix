...
let
  ...
  k8sProxy = buildGoModule rec {
    ...
    src = fetchFromGitHub {
      ...
      tag = "v${version}";
      hash = "sha256-PixT2vIO38f93HwzKfeFTHutyN9o1bs34ebeLYoNHGY=";
    };

    vendorHash = "sha256-wpkzK4mdL+veKOoMoYvGYu9nkdUlScScLXuSHgEgMhw=";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-lkIFlYZ989qVZHVj7M8/suxcmpJBSN9Uc43eyALaIqs=";
  };
  ...
  pnpmDeps = fetchPnpmDeps {
    ...
    inherit pnpm;
    fetcherVersion = 4;
    hash = "sha256-trQIr20n1yhg/GAW2lwtSvEpMDRjZHDJw6T6C5Ua2JM=";
  };
