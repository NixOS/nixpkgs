...
let
  ...
  python = python312.override {
    ...
    packageOverrides = self: super: {
      # newer versions break the tests of starlette-context
      # https://github.com/tomwojcik/starlette-context/issues/151
      starlette = super.starlette.overridePythonAttrs rec {
        version = "0.41.2";
