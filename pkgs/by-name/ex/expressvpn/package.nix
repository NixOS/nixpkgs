...
let
  ...
  expressvpnBase = stdenvNoCC.mkDerivation {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-D2ke+T8jJ4fC8gKwIdx3C6fWUtMW/0L2koNaret9zvw=";
      executable = true;
    };
    ...
    installPhase = ''
      ...
      install -D ${archDir}/installfiles/app-icon.png "$out/share/icons/hicolor/256x256/apps/expressvpn.png"
