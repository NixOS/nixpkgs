...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  # TODO: revisit when https://github.com/DelSkayn/rquickjs/pull/648 is merged/released
  env.WASI_SDK = runCommand "wasi-sdk" { } ''
    mkdir -p $out/bin
    ln -s ${stdenv.cc}/bin/wasm32-unknown-wasi-clang $out/bin/clang
    ln -s ${stdenv.cc}/bin/wasm32-unknown-wasi-ar $out/bin/ar
