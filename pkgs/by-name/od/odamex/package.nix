{ copyDesktopItems, makeDesktopItem, lib, stdenv, fetchurl, cmake, pkg-config
, makeWrapper, SDL2, SDL2_mixer, wrapGAppsHook3, wxGTK32, zlib, fltk, curl
, alsa-lib, deutex, }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ copyDesktopItems cmake pkg-config makeWrapper deutex ];

  buildInputs =
    [ wrapGAppsHook3 fltk zlib SDL2 SDL2_mixer wxGTK32 curl alsa-lib ];
