...
let
  glideVersion = "0.1.56a";
  glideRevision = "888b95ba915d";
  firefoxVersion = "147.0b3";

  firefoxSrc = fetchurl {
    url = "mirror://mozilla/firefox/releases/${firefoxVersion}/source/firefox-${firefoxVersion}.source.tar.xz";
    hash = "sha512-TVWRnx6MZfRtKlxekB6cSz8dJpDOEaSbzMnkmL+m39VQEs138mTJarNJUq0Ynkuro1TQcDKmO9ssuJxnltO1MA==";
  };
  ...
  patchedSrc = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      repo = "glide";
      tag = glideVersion;
      hash = "sha256-/SybSrz35OsRh3X6b+1uLcGLq/mJ3VAGZ9q1BG3AWj4=";
    };
    ...
    pnpmDeps = pnpm.fetchDeps {
      ...
      fetcherVersion = 2;
      hash = "sha256-gV6/nSoFBQSAwQzey/FPZJ1Qvjpse5j3NBCmKEakWfU=";
    };
