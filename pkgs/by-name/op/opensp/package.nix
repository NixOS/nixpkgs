...
stdenv.mkDerivation rec {
  ...
  ++ lib.optional (stdenv.cc.isClang || stdenv.hostPlatform.isCygwin) autoreconfHook
  ++ lib.optional stdenv.hostPlatform.isCygwin updateAutotoolsGnuConfigScriptsHook;
