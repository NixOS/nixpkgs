...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://sourceforge.net/projects/ophcrack/files/ophcrack/${version}/ophcrack-${version}.tar.bz2";
  ...
  buildInputs = [ openssl ] ++ (if enableGui then [ libsForQt5.qtcharts ] else [ expat ]);
  ...
  postinstall = lib.optional enableGui ''
