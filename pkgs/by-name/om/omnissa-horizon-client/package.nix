...
let
  ...
  # exists and is owned by you. Then run horizon-usbarbitrator as root.

  mainProgram = "horizon-view";
  ...
  wrapBinCommands = path: name: ''
    ...
    --suffix LD_LIBRARY_PATH : "$out/lib/omnissa/view/crtbora:$out/lib/omnissa"
  '';
  ...
  omnissaHorizonClientFiles = stdenv.mkDerivation {
    ...
    inherit version;
    src = fetchurl {
      url = "https://download3.omnissa.com/software/CART25FQ4_LIN_2412_TARBALL/Omnissa-Horizon-Client-Linux-2412-8.14.0-12437214089.tar.gz";
      hash = "sha256-tgmPfZqHbvUfRoOmqUNZ+UNV5LhnzQuKXyEXsCCZPBE=";
      # If you'd like to check this SRI hash against the sha256 checksum provided by omnissa run:
