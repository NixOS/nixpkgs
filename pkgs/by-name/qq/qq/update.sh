...
darwin_hash=$(nix hash to-base64 "sha256:$darwin_hash")
...
# use friendlier hashes
linux_aarch64_hash=$(nix hash to-base64 "sha256:$linux_aarch64_hash")
linux_x86_64_hash=$(nix hash to-base64 "sha256:$linux_x86_64_hash")
