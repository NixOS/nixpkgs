...
darwin_hash=$(nix-prefetch-url "$(sign_url "$darwin_url")")
...
linux_aarch64_hash=$(nix-prefetch-url "$(sign_url "$linux_aarch64_url")")
linux_x86_64_hash=$(nix-prefetch-url "$(sign_url "$linux_x86_64_url")")
