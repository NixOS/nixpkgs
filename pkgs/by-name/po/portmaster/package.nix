...
let
  portmasterUI = buildNpmPackage (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-mj7S9sG0kjmCQPnH8QQxT0xIxwzKfaG1U1zlCvkjmis";
    };

    sourceRoot = "${finalAttrs.src.name}/desktop/angular";
    npmDepsHash = "sha256-8kfk7+5mePg6S/2/+eh6LhGRPMpcdopjR8bKuX7mZnw=";
  ...
  portmasterDesktop = rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-3+kqlKfKq8CF7wVpS9FryvF6beMC2XHZOpPWo+C8lRo=";
...
buildGoModule (finalAttrs: {
  ...
  vendorHash = "sha256-X8c4ry6I0M4FUA71W8lRDDSJLHvxxEdGna0VTE28LQ4=";
