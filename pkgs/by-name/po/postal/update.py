...
#! nix-shell -i python3 -p "python3.withPackages (ps: with ps; [ requests click click-log])" bundix bundler nixfmt nix-update
...
def update(rev):
    ...
    subprocess.check_output(["nixfmt", "gemset.nix"], cwd=rubyenv_dir)
