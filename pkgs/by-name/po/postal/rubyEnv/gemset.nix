{
  ...
  secure_headers = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "000c5bxhqi28w9svmn7psnic2lsjwjd1fjm6z3nidl00gs3ayj7x";
      type = "gem";
    };
    version = "7.3.0";
  };
  ...
  sentry-rails = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0v3xbmbd5j97pdr5sf1a0kshgn1qf1sn3f6897cwpz0ys9cn0m0i";
      type = "gem";
    };
    version = "6.6.1";
  };
  sentry-ruby = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "08a44w6c4wwslsqai0rsx7k1x4m2vp1ibrqaywfpvzdxwhd2acg7";
      type = "gem";
    };
    version = "6.6.1";
  };
