...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "pocket-id";
    tag = "v${version}";
    hash = "sha256-dNcoHzIek8B6L98jwzy9D2vHTxGMU+ga7e1keFOp/b0=";
  };
  ...
  backend = buildGoModule {
    ...
    vendorHash = "sha256-UmSXjP01szhFjAZ5yLWNxPfORONF+40s1PPWEFRG0Gs=";
  ...
  frontend = buildNpmPackage {
    ...
    npmDepsHash = "sha256-8fZ8fDkHo16s1R6Kk/5Vjn2tSnqARfuzmqjvbPR6qSk=";
