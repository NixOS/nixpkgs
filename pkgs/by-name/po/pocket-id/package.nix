...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "pocket-id";
    tag = "v${version}";
    hash = "sha256-NIn6DYDsP6ccvUfJt8goI9LwHlcXc3UmHfHJYZBh6/Y=";
  };
  ...
  backend = buildGoModule {
    ...
    vendorHash = "sha256-i5FIRPJ8vkjKq7xIyQoGYs9V32GmnZwo2G+qveO5Byg=";
  ...
  frontend = buildNpmPackage {
    ...
    npmDepsHash = "sha256-tilSKob2uO1CeqCwEOfiO/iyqiy9YPzP5cI3QMFhgtY=";
