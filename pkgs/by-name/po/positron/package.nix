...
stdenv.mkDerivation {
  ...
  src =
    if (stdenv.isDarwin) then
      fetchurl {
        ...
        hash = "sha256-iMiOb8/w0EZDuKM9T1FPQZXTCqo5aBbuYiTpDKss5XY=";
      }
    else
      fetchurl {
        url = "https://github.com/posit-dev/positron/releases/download/${version}/Positron-${version}.deb";
        hash = "sha256-T1MFTVutX/rW4sfvwcxmE0rAnUDhysdKqptuUkYYsg4=";
      };
  ...
  unpackPhase = lib.optionals stdenv.hostPlatform.isLinux ''
