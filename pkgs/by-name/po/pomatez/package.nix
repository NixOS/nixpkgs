...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = applyPatches {
    src = fetchFromGitHub {
      ...
      hash = "sha256-tmC82r7TzidXEK1i0jSWcuLa9QxgYIKjDLo3HTIbWbU=";
    };
    patches = [
      ...
      # The current lockfile doesn't work with yarn "--offline" flag.
      # The patch is just the diff after running `yarn install` on clean repo.
      # Upstream PR: https://github.com/zidoro/pomatez/pull/712
      ./0002-fixup-yarn-offline.patch
      ...
      ./0003-insecure-enable-node-integration.patch
    ];
  };

  yarnOfflineCache = fetchYarnDeps {
    yarnLock = "${finalAttrs.src}/yarn.lock";
    hash = "sha256-aSIwokW7cEZoNsTUmklFsOt2WYxVCmWe93Q0jdie8xY";
  };
