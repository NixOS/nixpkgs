...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = {
    ...
    longDescription = ''
      Important note: for gtklock to work you need to set
      "security.pam.services.gtklock = {};" manually. Otherwise
      you'll lock youself out of desktop and unable to authenticate.
