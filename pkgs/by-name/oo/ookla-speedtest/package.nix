...
let
  ...
  srcs = rec {
    ...
    i686-linux = fetchurl {
      url = "https://install.speedtest.net/app/cli/ookla-speedtest-${version}-linux-i386.tgz";
    ...
    armv7l-linux = fetchurl {
      url = "https://install.speedtest.net/app/cli/ookla-speedtest-${version}-linux-armhf.tgz";
      sha256 = "sha256-5F/N672KGFVTU1Uz3QMtaxC8jGTu5BObEUe5wJg10I0=";
    };
    x86_64-darwin = fetchurl {
      url = "https://install.speedtest.net/app/cli/ookla-speedtest-${version}-macosx-universal.tgz";
