...
let
  ...
  onlyoffice_build = rev: hash: fetchFromGitHub {
    inherit rev hash;
    owner = "cryptpad";
...
buildNpmPackage {
  ...
  nativeBuildInputs = [
    makeBinaryWrapper rdfind
  ];

  patches = [
    # fix package-lock.json
    # https://github.com/cryptpad/cryptpad/issues/1484
    (fetchpatch {
      url = "https://github.com/cryptpad/cryptpad/commit/2bd8ff8f23626378814987982c2ab4d6c451372d.patch";
      hash = "sha256-ptczUJSbjG80IFYhy9h43KZz6e9CaVAnaHaCGOZ8Nac=";
    })
    # fix ports handling
