...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # TODO: Remove after update to > 10.0.0
    (fetchpatch2 {
      url = "https://github.com/gazebosim/gz-gui/commit/3d785e8b9f1b5ebb02198f3a645d5de77e556759.patch?full_index=1";
      hash = "sha256-b40w5d8uMgCwIUf1zfMWGndGUKIBljjf0lIwO4nJUy4=";
    })
  ];
