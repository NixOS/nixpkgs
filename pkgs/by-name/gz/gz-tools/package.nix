...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # TODO: Remove after update to > 2.0.3
    (fetchpatch2 {
      url = "https://github.com/gazebosim/gz-tools/commit/48e36e4a44aae8ccbd09a805e337e5bfc528087c.patch?full_index=1";
      hash = "sha256-92EO3iXumMJxJPPZtPzvXyrSnW8Bj/fZLxYuxDKT8FU=";
    })
  ];
