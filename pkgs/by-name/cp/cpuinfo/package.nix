...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "pytorch";
    repo = "cpuinfo";
    rev = "c4b4f4bf08c0cf486fc3111d0244ebf2a48ad01b";
    hash = "sha256-5c9WFsfEfCoqKI6nGQ99OcaAnXsTFGyFIENK+HV/Ub4=";
  };
  ...
  meta = {
    ...
    # https://github.com/pytorch/cpuinfo/blob/c4b4f4bf08c0cf486fc3111d0244ebf2a48ad01b/CMakeLists.txt#L98
