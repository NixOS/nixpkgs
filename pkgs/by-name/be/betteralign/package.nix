...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "betteralign";
    tag = "v${version}";
    hash = "sha256-Hv+WSvAhGeT2hWxw5edg4uIbdSmDR/5e8o7LZ3IO7+E=";
  ...
  vendorHash = "sha256-Su0oXepXA17UAdDhIy8LCrSPxhlIDb5Fe4ZDgovrbLs=";
  ...
  meta = {
    ...
    changelog = "https://github.com/dkorunic/betteralign/releases/tag/v${version}";
