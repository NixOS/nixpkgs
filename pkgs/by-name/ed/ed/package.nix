...
# here should be included directly in Nixpkgs as files; further, those patches
# should be included in the directory (or subdirectories) where this package file
# belongs, given that ed now follows RFC 140.
