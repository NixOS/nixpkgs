...
stdenv.mkDerivation {
  ...
  src = fetchzip {
    url = "https://web.archive.org/web/20260404183103/https://www.fadeinpro.com/download/demo/fadein-linux-x64-demo.tar.gz";
    hash = "sha256-gbToQQt40QeGUVnifos5lmVTHVTYg8KuAA0az7FAU+k=";
  };
