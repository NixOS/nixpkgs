...
stdenv.mkDerivation {
  ...
  src = fetchzip {
    url = "https://web.archive.org/web/20260206215243/https://www.fadeinpro.com/download/demo/fadein-linux-x64-demo.tar.gz";
    hash = "sha256-zinaowv5UNKhp/KnPAHtEAPWyH8kgCvmDwY9Z3EHLgY=";
  };
