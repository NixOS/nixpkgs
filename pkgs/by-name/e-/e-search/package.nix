...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-sogIl+I4pRBvwmyvQwaBILIKf9nuWI16kDSaZtBA3LM=";
  };
  ...
  pnpmDeps = pnpm_10.fetchDeps {
    ...
    '';
    hash = "sha256-v03tswzim50v8ieKfyr5xlSjobRoW00HMPllnyXe29A=";
  };
  ...
  meta = {
    ...
    maintainers = builtins.attrValues { inherit (lib.maintainers) tuynia; };
