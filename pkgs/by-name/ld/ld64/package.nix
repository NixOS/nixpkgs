...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches =
    [
      ...
      ./patches/0003-Always-use-write-instead-of-mmap.patch
      ./patches/0005-Inline-missing-definitions-instead-of-using-private-.patch
      ./patches/0006-Removed-unused-Blob-clone-method.patch
      ./patches/0007-Use-std-atomics-and-std-mutex-for-portability.patch
      ./patches/0008-Add-Meson-build-system.patch
      ./patches/0009-Add-CrashReporterClient-header.patch
      ./patches/0010-Provide-mach-compatibility-headers-based-on-LLVM-s-h.patch
      ./patches/0011-Support-LTO-in-nixpkgs.patch
      ./patches/0012-Add-vendored-libtapi-to-the-ld64-build.patch
      ./patches/0013-Modify-vendored-libtapi-to-build-with-upstream-LLVM.patch
      ./patches/0014-Move-libcodedirectory-to-its-own-subproject.patch
      ./patches/0015-Set-the-version-string-in-the-build.patch
      ./patches/0016-Replace-corecrypto-and-CommonCrypto-with-OpenSSL.patch
      ./patches/0017-Add-libcd_is_blob_a_linker_signature-implementation.patch
      ./patches/0018-Add-dyldinfo-to-the-ld64-build.patch
      ./patches/0019-Fix-dyldinfo-build.patch
      ./patches/0020-Use-STL-containers-instead-of-LLVM-containers.patch
    ]
    ++ lib.optionals (hasEmbed) [
      ./patches/0004-Add-compile_stubs.h-using-Clang-s-embed-extension-fo.patch
    ];
