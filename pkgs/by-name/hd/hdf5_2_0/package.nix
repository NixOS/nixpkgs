...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    optional fortranSupport gfortran ++ optional szipSupport szip ++ optional javaSupport jdk;
  ...
  ++ lib.optional fortranSupport "-DHDF5_PROVIDES_FORTRAN=ON"
  ++ lib.optional szipSupport "-DHDF5_PROVIDES_SZIP_SUPPORT=ON"
  ++ lib.optional zlibSupport "-DHDF5_PROVIDES_ZLIB_SUPPORT=ON"
  ...
  ++ lib.optional usev114Api "-DDEFAULT_API_VERSION=v114"
