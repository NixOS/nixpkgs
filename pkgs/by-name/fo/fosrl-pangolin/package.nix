...
buildNpmPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-20AJyfAToCVKQKJa19wZxGc80H28mHoEieOkx+nwdcs=";
  };

  npmDepsHash = "sha256-ykWExQuCURh1enjw2SMYFqCtwHyAZJh0RsWUYpfkLDg=";
  ...
  preFixup =
    let
      variablesMapped =
        ...
        + " --run 'test -z \"$NIXOS_PANGOLIN_DATADIR\" || cd \"$NIXOS_PANGOLIN_DATADIR\"${
