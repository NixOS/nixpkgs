...
buildGoModule (finalAttrs: {
  pname = "foks-server";
  inherit (foks) src vendorHash version;
  ...
  meta = {
    description = "Federated key management and distribution system server";
