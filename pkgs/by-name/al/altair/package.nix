...
let
  ...
  appimageContents = appimageTools.extract {
    ...
    src = sources.x86_64-linux or throwSystem;
  };
  ...
  darwin = stdenv.mkDerivation {
    ...
    src = sources.aarch64-darwin or throwSystem;
    ...
    installPhase = ''
      ...
      makeWrapper $out/Applications/Contents/MacOS/Altair\ GraphQL\ Client $out/bin/altair
