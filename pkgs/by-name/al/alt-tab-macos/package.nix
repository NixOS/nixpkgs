      ...
      CFBundleURLTypes = [
        {
          ...
          CFBundleURLName = "com.lwouis.alt-tab-macos";
          CFBundleURLSchemes = [ "com.lwouis.alt-tab-macos" ];
        }
      ];
      CFBundleShortVersionString = version;
      CFBundleVersion = version;
      Domain = "alt-tab.app";
      ApiDomain = "alt-tab.app/api";
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-2ljxaEbIZGOOYNiABByneBQSg3hnsEdJkfRgTlLI2Ic=";
  };
