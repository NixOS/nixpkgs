...
buildGoModule rec {
  ...
  src =
    let
      src = fetchFromGitHub {
        ...
        tag = "v${version}";
        hash = "sha256-BTjnOWrIUDss+NpM/KxpgP8Y+JDikHo2Ifz++YMAElw=";
        fetchSubmodules = true;
      };
      # From .docs.version file. Automatically updated by updateScript.
      docsVersion = "37dbe14939557c199ddfcbeedc473617fc5699ad";
      ...
      docs = fetchurl {
        ...
        hash = "sha256-H3963o1OTsMfT9/Ku3xsW4CzPr8chnAOW+LWl1HEUi0=";
      };
    in
  ...
  vendorHash = "sha256-c/UjrJKEc32wwAtTR8wbATNq9hlF/qW8N1z4wIorjDs=";
