...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-kvaHpE9IgqkpAUv5t70K74h02qBA09kqNR/jCLB7+7I=";
  };
  ...
  postPatch = ''
    # Remove unused binary blob (only useful for microsoft windows)
  ...
  installPhase = ''
    ...
    install -Dm644 build/libs/plantuml-*.jar $out/lib/plantuml.jar
