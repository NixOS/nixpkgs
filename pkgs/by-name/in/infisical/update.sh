...
NFILE=pkgs/by-name/in/infisical/package.nix
HFILE=pkgs/by-name/in/infisical/hashes.json
rm -f "$HFILE" && touch "$HFILE"

printf "{ \"_comment\": \"@generated by pkgs/by-name/in/infisical/update.sh\"\n" >> "$HFILE"
