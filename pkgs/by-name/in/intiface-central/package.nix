...
flutterPackages.v3_19.buildFlutterApplication rec {
  ...
  # version directly.
  extraWrapProgramArgs = "--chdir $out/app/${pname}-${version}";

  postInstall = ''
    mkdir -p $out/share/pixmaps
    cp $out/app/$name/data/flutter_assets/assets/icons/intiface_central_icon.png $out/share/pixmaps/intiface-central.png
  '';
