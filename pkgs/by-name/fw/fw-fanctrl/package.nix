...
python3Packages.buildPythonPackage rec {
  ...
  postInstall = ''
    ...
    install $src/src/fw_fanctrl/_resources/config.json $out/share/fw-fanctrl/config.json
    install $src/services/system-sleep/fw-fanctrl-suspend $out/share/fw-fanctrl/fw-fanctrl-suspend
