...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/commit/e0126edeb3bc442741a8735c7221ae92024a5c14.patch?full_index=1";
    ...
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/pull/566.patch";
      hash = "sha256-VG3qyVC8QZUe3AmzmIAIsb5Y0rUEqNWRMu5kt30Xllc=";
    })

    # GCC 15 enforces CWG DR 1518: explicit default constructors cannot be
    # used in copy-list-initialization. Make STLAllocator's constructors
    # constexpr (and non-explicit) so STL containers can value-initialize
    # their allocator.
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/commit/8ec6166ea3a6453950edfba8a32d0e3fa5099833.patch?full_index=1";
    ...
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/commit/06c53d072271276e07aef2233114a2dc5fa18ae2.patch?full_index=1";
      hash = "sha256-tU8V/E2yWVkk7jp29t9oFeNH+sZwMjEdKONdGDcjjP4=";
    })
    ...
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/commit/0630ccd923160c4c489d1b8eefe7e39a89807a30.patch?full_index=1";
      hash = "sha256-pXlBWtsxkFAk/ffRJHv0lZwLYLHOJ5219cnfKJP/+Xk=";
    })
    ...
    # TODO: Remove after update to > 2.3.3
    (fetchpatch2 {
      url = "https://github.com/OGRECave/ogre-next/commit/f6b76053837674d879ab1eafca23cab1c1cf10f2.patch?full_index=1";
      hash = "sha256-lkSLBYg3i144Nj7tcFTXs5wF63LodSy1wEpe/cHRjsk=";
    })
  ];
