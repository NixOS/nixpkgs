...
let
  ...
  server-src = fetchFromGitHub {
    owner = "Euro-Office";
    repo = "server";
    rev = "d236627f860b259c286ce3b0b483a8cef58d0bb3";
    hash = "sha256-F03LFU6UE7LPfJAeaQStqMo1mPnnCjCq5bkB/vKzXiw=";
  };
  ...
  euro-office-documentserver = stdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      ...
      rev = "95b9e588ae84f18408ab0c99babc1a100dae76e3";
      hash = "sha256-zbvAfaEzFf1f6WrKdeYeBZND4KEHdvsgX4OKlQ+49vQ=";
    };
    ...
    meta = {
      description = "Euro-Office Document Server is an online office suite comprising viewers and editors";
      longDescription = ''
