...
let
  ...
  server-src = fetchFromGitHub {
    owner = "Euro-Office";
    repo = "server";
    rev = "f4afd0efaab0ed64406db3188d4c47d4fe2c6a0a";
    hash = "sha256-97MTQDt1YUUnlAw8j6v79vUTicSgn0Wm1Cg+O1dDZEo=";
  };
  ...
  euro-office-documentserver = stdenvNoCC.mkDerivation {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7a1406507c0ddfc25ae1dc7b7dfbc365c39d3fa5";
      hash = "sha256-ee8HG5QQKAYoYg9mAif+OGR9L9NDdjXy6CxEw9vbnBc=";
    };
