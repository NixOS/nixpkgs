...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "mirror://sourceforge/msgviewer/${uname}-${finalAttrs.version}/${uname}-${finalAttrs.version}.zip";
  ...
  buildCommand = ''
    ...
    mkdir -p $out/bin $dir
    unzip $src -d $dir
    mv $dir/${uname}-${finalAttrs.version}/* $dir
    rmdir $dir/${uname}-${finalAttrs.version}
