...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    mkdir dovecot
    echo "$(< ${dovecot}/lib/dovecot/dovecot-config)" > dovecot/dovecot-config
    substituteInPlace dovecot/dovecot-config --replace-fail "dovecot_moduledir=${dovecot}/lib/dovecot/modules" "dovecot_moduledir=${placeholder "out"}/lib/dovecot/modules"
  '';
