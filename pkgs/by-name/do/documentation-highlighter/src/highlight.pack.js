...
;hljs.registerLanguage("bash",e)})();/*! `nix` grammar compiled for Highlight.js 11.11.1 */
...
begin:/:([a-z]+|\?)/}])}}})();hljs.registerLanguage("nix",e)})();/*! `shell` grammar compiled for Highlight.js 11.11.1 */
