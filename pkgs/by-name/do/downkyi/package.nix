  ...
  passthru = {
    sources = {
      ...
      x86_64-darwin = fetchurl {
        url = "https://github.com/yaobiao131/downkyicore/releases/download/v${version}/DownKyi-${version}-osx-x64.dmg";
        hash = "sha256-qEo+++sxgzl7a22CC48CYZV/TEA5f1d1ksH4mFHdG0c=";
      };
      aarch64-darwin = fetchurl {
        url = "https://github.com/yaobiao131/downkyicore/releases/download/v${version}/DownKyi-${version}-osx-arm64.dmg";
        hash = "sha256-xDNV2K+XrqgK/QRs7QMHUVfWlHKt9B0+VjAQB5N63sI=";
      };
    };
...
if stdenvNoCC.hostPlatform.isDarwin then
  stdenvNoCC.mkDerivation {
    ...
    installPhase = ''
      ...
      cp -a 哔哩下载姬.app $out/Applications
