...
stdenv.mkDerivation (final: {
  ...
  cmakeFlags = [ "-DCMAKE_INSTALL_PREFIX=${placeholder "out"}/shared/dssat/" ];

  postInstall = ''
    mkdir -p $out/shared/dssat/Data
    cp -r $src/Data/* $out/shared/dssat/Data/
    cp -r ${dataRepo}/* $out/shared/dssat/Data/
    makeWrapper $out/shared/dssat/dscsm048 $out/bin/dscsm048
  '';
