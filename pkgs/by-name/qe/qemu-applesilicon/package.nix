...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "cb75d54aad7bc056d39339b36fde2859bb38e556";
    hash = "sha256-+YXMIC8J68rXRaWTrJAl7TDKAihHkhxaCnOlJzHSEcA=";
    leaveDotGit = true;
    nativeBuildInputs = [
      meson
    ];
  ...
  // lib.optionalAttrs userOnly {
    ...
    description = "Apple Silicon devices emulated on QEMU - user space, currently only iPhone 11";
  };
})
