...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  SCRAM_VERSION = "V${builtins.replaceStrings [ "." "-" ] [ "_" "_" ] finalAttrs.version}";
  ...
  makeFlagAttrs = {
    ...
    INSTALL_BASE = escapeMakeFlag "\"${lib.escapeShellArg (if finalAttrs.getCmsPathFromEnv != null then "\$ENV{'${finalAttrs.getCmsPathFromEnv}'}" else finalAttrs.CMS_PATH)}\"";
