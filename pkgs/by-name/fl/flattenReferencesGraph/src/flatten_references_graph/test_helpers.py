...
from .lib import not_None, graph_vertex_index_to_name
...
class CustomAssertions:
    def assertGraphEqual(self, g1, g2):
        self.assertSetEqual(frozenset(g1.vs["name"]), frozenset(g2.vs["name"]))

        self.assertSetEqual(edges_as_set(g1), edges_as_set(g2))
