...
stdenv.mkDerivation (finalAttrs: {
  ...
  postInstall = ''
    ...
    substituteInPlace ./cider-build/.vite/build/events-*.js \
      --replace-fail 'return{action:"allow",overrideBrowserWindowOptions:{autoHideMenuBar:!0}}' 'return{action:"allow",overrideBrowserWindowOptions:{autoHideMenuBar:!0,webPreferences:{devTools:!0,nodeIntegration:!1,contextIsolation:!0,webSecurity:!1,sandbox:!1,experimentalFeatures:!0}}}'
  ...
  postFixup = ''
    makeWrapper $out/lib/cider/Cider $out/bin/${finalAttrs.pname} \
      --add-flags "\$\{NIXOS_OZONE_WL:+\$\{WAYLAND_DISPLAY:+--ozone-platform-hint=auto --enable-features=WaylandWindowDecorations --enable-wayland-ime=true\}\}" \
      --add-flags "--no-sandbox --disable-gpu-sandbox" \
      --prefix LD_LIBRARY_PATH : "${lib.makeLibraryPath [ libGL ]}"

    mv $out/share/applications/cider.desktop $out/share/applications/${finalAttrs.pname}.desktop
    substituteInPlace $out/share/applications/${finalAttrs.pname}.desktop \
      --replace-warn 'Exec=cider' 'Exec=${finalAttrs.pname}' \
      --replace-warn 'Exec=/usr/lib/cider/Cider' 'Exec=${finalAttrs.pname}'
