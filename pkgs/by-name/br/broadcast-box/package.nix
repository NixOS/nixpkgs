...
let
  ...
  src = fetchFromGitHub {
    repo = "broadcast-box";
    owner = "Glimesh";
    rev = "ef2eb70afe9776bb1a2a63ca1d5c5e45bd4c4756";
    hash = "sha256-MwxB+b01mN60eJMiZW1uJT6Aq5yGi63OqQKsVrZ+k5w=";
  };
  ...
  frontend = buildNpmPackage {
    ...
    pname = "${name}-web";
    src = "${src}/web";
    npmDepsHash = "sha256-DOKZVvCPMxpH2/rh8DE09aRPFxUKo3eFFjk7eAJCgVU=";
    preBuild = ''
...
buildGoModule {
  ...
  pname = name;
  vendorHash = "sha256-iIlAusTKRMeeLwxpAnyCVh+2axh0vOC6HjmPppDw3bo=";
