...
stdenv.mkDerivation (finalAttrs:  {
  ...
  src = fetchurl {
    #url = "https://sf.net/projects/kshutdown/files/KShutdown/${finalAttrs.version}/kshutdown-source-${finalAttrs.version}.zip/download";
    url = "https://downloads.sourceforge.net/project/kshutdown/KShutdown/${finalAttrs.version}/kshutdown-source-${finalAttrs.version}.zip";
