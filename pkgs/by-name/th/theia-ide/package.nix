...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-9L5moX4yAitAe9A7q2CL6Gu/nwK0bNbVasIoDqUuykg=";
  };

  yarnOfflineCache = fetchYarnDeps {
    yarnLock = finalAttrs.src + "/yarn.lock";
    hash = "sha256-QCeDdmFLCX7TI638TtIDoeYlIKivk7SmVEJO30p8TBE=";
  };
  ...
  meta = {
    ...
    mainProgram = if stdenv.hostPlatform.isDarwin then "TheiaIDE" else "theia-ide";
