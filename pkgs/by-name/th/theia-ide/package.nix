...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "theia-ide";
    tag = "v${version}";
    hash = "sha256-r2E15HfuZ2EhCpTRz6x7lFDQDXmS+SmP7Ec4+polgh4=";
  };

  yarnOfflineCache = fetchYarnDeps {
    yarnLock = src + "/yarn.lock";
    hash = "sha256-PAZnB4GxeTmgWcFwJqaGylzrmaKHfdsJgRSjHCf2sUY=";
  };
  ...
  theiaPlugins = stdenv.mkDerivation {
    ...
    outputHash = "sha256-cNXpuoGMuPOUnmEIyrFm/aX0DB9o2tIVk4PJd9D/FcA=";
