...
stdenv.mkDerivation {
  ...
  meta = {
    description = "ET: Legacy (server) is an open source project based on the code of Wolfenstein: Enemy Territory which was released in 2010 under the terms of the GPLv3 license";
