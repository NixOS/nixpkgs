...
let
  ...
  hash = {
    x86_64-linux = "sha256-mPiZCUH7enUQeMYhlFBcXWH18lCm48bt6Xo4X2viBxY=";
    aarch64-linux = "sha256-6JkeA4rjeQvTC3q2w/OZepyzCpCRt6T7AUp1G7GJeLA=";
    x86_64-darwin = "sha256-UFDSNldECTj9A4GzM3Tn+ZMAe8qnssrQZ+jmmdV06VQ=";
    aarch64-darwin = "sha256-IxrnEmtlqgKzhY9Mhw2TdJEOnuTMYeL0qQIeRbaJQOs=";
  }.${system} or throwSystem;
