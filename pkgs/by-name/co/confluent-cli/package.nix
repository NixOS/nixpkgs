...
stdenv.mkDerivation (finalAttrs: {
  ...
  src =
    ...
    fetchurl {
      ...
      hash = selectSystem {
        x86_64-linux = "sha256-VREFRB7aDp5Sw/CAf2vHtPPO67q8NtKU9ibsz79ugCA=";
        aarch64-linux = "sha256-hudveArTgldZcDWZzByH7NNDBR/iYRe94ZjVaWx8Y6M=";
        x86_64-darwin = "sha256-fFCrlKKtDhYpP7ElzpGKhJIAMyZRPfxpff7mjTAYM5A=";
        aarch64-darwin = "sha256-yoXCbZrxLbnjLN1aclUxtM4xEBiF7xdsK5lXCDoPrwI=";
      };
    };
