...
let
  ...
  meta = {
    ...
    changelog = "https://github.com/ethereum/solidity/releases/tag/v${finalAttrs.version}";
  ...
  solc =
    if gccStdenv.hostPlatform.isLinux then
      gccStdenv.mkDerivation (finalAttrs: {
        ...
        src = fetchzip {
          url = "https://github.com/ethereum/solidity/releases/download/v${finalAttrs.version}/solidity_${finalAttrs.version}.tar.gz";
          hash = linuxHash;
        };
      ...
      gccStdenv.mkDerivation (finalAttrs: {
        ...
        src = pkgs.fetchurl {
          url = "https://github.com/ethereum/solidity/releases/download/v${finalAttrs.version}/solc-macos";
          hash = darwinHash;
        };
        dontUnpack = true;
        ...
        installPhase = ''
          ...
          mkdir -p $out/bin
          cp ${finalAttrs.src} $out/bin/solc
