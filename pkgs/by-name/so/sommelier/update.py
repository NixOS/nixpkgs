...
# documented.
with urlopen(
    "https://chromiumdash.appspot.com/cros/download_serving_builds_csv?deviceCategory=ChromeOS"
) as resp:
...
with urlopen(
    f"https://chromium.googlesource.com/chromiumos/platform2/+/refs/heads/{release_branch}?format=JSON"
) as resp:
...
with urlopen(
    f"https://chromium.googlesource.com/chromiumos/platform2/+log/refs/heads/main..{rev}/vm_tools/sommelier?format=JSON"
) as resp:
    resp.readline()  # Remove )]}' header
