...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    ...
    hash = "sha256-V/rdIqGHZsbtef+EY9yJt5fCPoCKV12Uieb6fd97+y4=";
  };
  ...
  postFixup = ''
    ...
    wrapProgram $out/libexec/Hydra/resources/hydra-download-manager/hydra-download-manager \
      --prefix LD_LIBRARY_PATH : ${lib.makeLibraryPath [ glibc ]}:$out/libexec/Hydra/resources/hydra-download-manager/lib
  '';
