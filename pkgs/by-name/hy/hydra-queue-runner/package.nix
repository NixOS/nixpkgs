...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  # The unit tests spin up a PostgreSQL instance, which is not available in the sandbox.
  doCheck = false;

  passthru.tests = { inherit (nixosTests) hydra; };

  meta = {
    description = "Queue runner for the Nix-based continuous build system Hydra";
