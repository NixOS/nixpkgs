...
appimageTools.wrapType2 {
  ...
  extraInstallCommands = ''
    ...
    cp ${extracted}/'FF Logs Uploader.desktop' $out/share/applications/
    sed -i 's@^Exec=AppRun --no-sandbox@Exec=fflogs@g' $out/share/applications/'FF Logs Uploader.desktop'
  '';
