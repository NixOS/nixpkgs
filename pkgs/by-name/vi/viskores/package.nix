...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    # viskoresConfig.cmake will include viskoresTargets.cmake only if
    # the downstream project uses a different CMAKE_BINARY_DIR (e.g., "/build/source/build")
    # than viskores's own (e.g., "/build/viskores-source/build")
    name = "viskores-source";
  };
