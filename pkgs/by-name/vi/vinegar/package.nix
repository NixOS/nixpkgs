      ...
      (oldAttrs: {
        ...
        patches = oldAttrs.patches or [ ] ++ [
          ...
          (fetchpatch {
            ...
            hash = "sha256-Fd/6t7Nvbkstr6WtxxBpPYd5FwwDDq+hk4O5Stqw65M=";
          })
          (fetchpatch {
            url = "https://raw.githubusercontent.com/vinegarhq/wine-builds/7b88b2e2d1d77a514793a5c9668f027c6caa6de4/xfixes-hide-cursor.patch";
            hash = "sha256-tZJw8+flCnhzTW+socSX6Io+RErTlc6GsImulm1JhXE=";
          })
        ];
