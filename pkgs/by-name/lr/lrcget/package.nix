...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "lrcget";
    rev = "${version}";
    hash = "sha256-9Wtb8Y+cj1ec8vNxvvs3wso62TavNveHRh2Gfx7Br4w=";
  };

  sourceRoot = "${src.name}/src-tauri";

  cargoHash = "sha256-nhED/fSexFfZ2MezBR3YW5wKsYklRg9HiA3lvClkYjI=";
  ...
  buildInputs = [ dbus openssl gtk3 webkitgtk alsa-lib ];
