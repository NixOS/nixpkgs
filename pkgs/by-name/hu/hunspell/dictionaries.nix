...
rec {
  ...
  en-us = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "YWNIrWRacW2RyKZkUGXnEPFendo//vYM337IpOJ5da8=";
    };
  };
  ...
  en-us-large = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "WpNhcxL/t8zMVMj9ij5nEusOnNSmnx01i4LrTTUgcrc=";
    };
  };
  ...
  en-ca = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "/2uR5O12g0jGGufDJuhIBZgQ+kOl1gHfaz9FrZwO9b8=";
    };
  };
  ...
  en-ca-large = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "RjRIkIb2QDeveqpLyo1s4X90QrZiYylW5d1MCU+Hvuo=";
    };
  };
  ...
  en-au = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "3CBVfEiuGXl4Tnn65vll6ZnI2y6aD4RjSOcAV/znglQ=";
    };
  };
  ...
  en-au-large = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "SW5HeuewGMe+Ng5gqqL5jn8cl8eJLfk7JFcRJCTGHjE=";
    };
  };
  ...
  en-gb-ise = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "LO1LLsnRiMO1QNu3W1FD9luZDa8XQ3dYcm/x+rXwGtM=";
    };
  };
  ...
  en-gb-ize = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "hpt0nsmAW4fNBfQzB/IJmGUTMbWqWwRQZBOvDC3y8jE=";
    };
  };
  ...
  en-gb-large = mkDictFromWordlist {
    ...
    src = fetchurl {
      ...
      sha256 = "+GvrdyKMc3yMaUaP/E6gZ1EocieIabmKXT7BjxJRB70=";
    };
  };
