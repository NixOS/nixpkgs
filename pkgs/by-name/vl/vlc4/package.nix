...
stdenv.mkDerivation (finalAttrs: {
  ...
  # Mark test_libvlc_media as expected to fail because source archive timestamps differ
  # and, for onlyLibVLC, do the same for tests requiring the omitted VLC executable
  # and external preparser
  checkFlags = [
    "XFAIL_TESTS=${
      toString (
        [ "test_libvlc_media" ]
