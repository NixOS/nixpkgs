...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://github.com/cpisciotta/xcbeautify/releases/download/${finalAttrs.version}/xcbeautify-${finalAttrs.version}-${stdenv.hostPlatform.darwinArch}-apple-macosx.zip";
