...
llvmPackages.stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    install -Dm644 -t $out/share/licenses/N64ModernRuntime ../lib/N64ModernRuntime/COPYING
    install -Dm644 -t $out/share/licenses/RmlUi ../lib/RmlUi/LICENSE.txt
    install -Dm644 -t $out/share/licenses/SDL_GameControllerDB ${gamecontrollerdb}/LICENSE
    install -Dm644 -t $out/share/licenses/lunasvg ../lib/lunasvg/LICENSE
    install -Dm644 -t $out/share/licenses/rt64 ../lib/rt64/LICENSE
    install -Dm644 -t $out/share/licenses/sse2neon ../lib/sse2neon/LICENSE
