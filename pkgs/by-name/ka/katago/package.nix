...
# TODO: Handle onnx and rocm backends eventually
...
let
  githash = "fd0723fdbc0e9d82cf269c9630af8c27c57c07c4";
...
stdenv'.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "katago";
    rev = "v${version}";
    sha256 = "sha256-Zotrh4bnMvQkTRfGznxj8VYTZ9qjBVDwrJ/1XF6olIE=";
  };
