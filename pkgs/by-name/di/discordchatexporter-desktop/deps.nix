...
[
  ...
  (fetchNuGet {
    ...
    hash = "sha256-tcIOUqi/EmV2mKfrhvIfYKSHt9fNbXeGzuqbvhY29pU=";
  })
  (fetchNuGet {
    pname = "Avalonia";
    version = "11.1.0";
  ...
  (fetchNuGet {
    ...
    version = "0.29.2";
    hash = "sha256-JRIIhn2Um+vWaaJtJ9ej5Ov6ywPNfd5EOAVtNXv++DE=";
  })
  (fetchNuGet {
    pname = "Deorcify";
    version = "1.0.2";
    hash = "sha256-deEn+hUElOZS7lq3SUeot7vDB3VFQxGDML20TGj2nVs=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "3.7.4";
    hash = "sha256-XRcAb8LPPCRCQx9qWVHrm8tbyNp74aTZmMhBlo7upWs=";
  })
  (fetchNuGet {
    pname = "Material.Icons";
    version = "2.1.10";
    hash = "sha256-Xn/CRyvLFiixRvA/NXMxX9geLJu9QKDKtKMkJAZN6po=";
  })
  (fetchNuGet {
    pname = "Material.Icons.Avalonia";
    version = "2.1.10";
    hash = "sha256-L7bjGcYOxC+7VgQNmpIKlHypNCD5GVEK7q47PG93HgI=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    pname = "RazorBlade";
    version = "0.6.0";
    hash = "sha256-2ihHI4leF0co2IyEsQDtLmNFNvL0TkqkPmS1dtqRYoY=";
  })
  (fetchNuGet {
    pname = "SkiaSharp";
    version = "2.88.8";
  ...
  (fetchNuGet {
    ...
    version = "6.4.3";
    hash = "sha256-y2mlhXO3KHz1CfksjCVEvh3LZqDUiXh5sHlioNR70Ww=";
  })
]
