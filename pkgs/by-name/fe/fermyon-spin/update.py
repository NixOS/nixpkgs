...
# TODO: replace with "nix-update" if https://github.com/Mic92/nix-update/pull/469 is merged
subprocess.run(["/home/m/nix-update/bin/nix-update", "fermyon-spin"])
...
for nixTuple in systems:
  url = (
    "https://github.com/fermyon/spin/releases/download/v"
