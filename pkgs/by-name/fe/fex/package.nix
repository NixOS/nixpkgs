...
llvmPackages.stdenv.mkDerivation (finalAttrs: {
  ...
  postPatch = ''
    ...
    substituteInPlace Source/Tools/LinuxEmulation/VDSO_Emulation.cpp \
      ...
      --replace-fail "FEX_CONFIG_OPT(ThunkGuestLibs32, THUNKGUESTLIBS32);" "auto ThunkGuestLibs32 = []() { return \"$out/share/fex-emu/GuestThunks_32/\"; };"
    ...
    substituteInPlace Source/Tools/LinuxEmulation/Thunks.cpp \
      ...
      --replace-fail "FEX_CONFIG_OPT(ThunkHostLibsPath32, THUNKHOSTLIBS32);" "fextl::string ThunkHostLibsPath32() { return \"$out/lib/fex-emu/HostThunks_32/\"; }"
