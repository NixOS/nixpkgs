{
  ...
  mupen64plus-core ? libretro.mupen64plus,
...
stdenv.mkDerivation (
  ...
  in
  {
    ...
    version = "7.12.0"; # Check ./parallel-n64-next.nix for updates when updating, too
    ...
    patches = [
      ...
      (replaceVars ./fix-version-checks.patch {
        ...
        parallelCoreVersion = reformatVersion' (lib.getVersion parallel-n64-core);
        mupenCoreVersion = mupen64plus-core.src.rev;
      })
    ];
