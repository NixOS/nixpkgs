...
stdenv.mkDerivation (finalAttrs: {
  ...
  postInstall = ''
    ...
    cp $src/flatpak/io.github.wojciech_graj.OrbVis.desktop $out/share/applications
    cp $src/flatpak/128x128/io.github.wojciech_graj.OrbVis.png $out/share/icons/hicolor/128x128/apps
  '';
