...
buildDotnetModule {
  ...
  patches = [
    # Put data in a writable location (XDG_DATA_HOME or ~/.local/share) instead of the installation directory
    ./writable-path.patch
  ...
  meta = {
    ...
    changelog = "https://github.com/Quaver/Quaver/releases";
