...
in
{
  ...
  BACKPORTS = [
    ...
    (qubesPatch {
      name = "0303-x86-x2APIC-correct-cluster-tracking-upon-CPUs-going-";
      hash = "sha256-pPTv5XXRh2GVlhdLZsTiVOHjsAoVvyVDBvt8vdfqiRM=";
    })
    (qubesPatch {
      name = "0304-xen-spinlock-Fix-UBSAN-load-of-address-with-insuffic";
      hash = "sha256-0iKrdLvCf3Va3z95xCVICkx9k++XJvZ3Mt26T3faagg=";
    })
  ];
  SECURITY_FIXES = [ ];
