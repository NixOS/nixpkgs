...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-OZ/SijcAEsv5MkzSHeXu867D8nitWNHmCO3ub7kJoE4=";
  };
  ...
  bazelVendorDeps =
    ...
    stdenv.mkDerivation {
      ...
      outputHash =
        {
          x86_64-linux = "sha256-cZBcaJb9U29DRou80JYvPNDfs5HyWtdG73GsNTMMkFA=";
          aarch64-linux = "sha256-eRCYSTDSR5D1dvKHOpZ+He7tlnq77WB69T6C09WFsIQ=";
          aarch64-darwin = "sha256-wHAeV3K9+GVOLzB9Gl2MbhwgHVaf5q14tv2XmYdw/OA=";
          x86_64-darwin = "sha256-Ux9RJKPearkrTzPoraoI3bXMSzjtHurljFwWM1KySmM=";
        }
        .${stdenv.hostPlatform.system};
