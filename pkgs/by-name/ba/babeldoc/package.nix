...
python3Packages.buildPythonApplication rec {
  ...
  patches = [
    (fetchpatch2 {
      ...
      url = "https://github.com/funstory-ai/BabelDOC/pull/542.patch";
      hash = "sha256-tPgXZdKNOA1fJeFEE3PVVwWZZ+jLkW1bfyymhFlVXE8=";
    })
  ];
  ...
  meta = {
    ...
    changelog = "https://github.com/funstory-ai/BabelDOC/releases/tag/v${version}";
