...
let
  ...
  mininalBuildGoModule = callPackage ./build-go-vendor.nix {
    inherit
      pname
      src
      vendorHash
...
in
mininalBuildGoModule.overrideAttrs (
  final: prev: {
    ldflags = [
      "-s"
      "-w"
    ...
    meta = {
      mainProgram = "stash";
      description = "An organizer for your adult videos/images, written in Go";
