...
llvmPackages_19.stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-Q0vqBdt5RspL6rQXNx6cUgJKG6nkEa/e5xV4M16Iczc=";
  ...
  desktopItems = [
    (makeDesktopItem {
      ...
      genericName = "Recompilation of Starfox 64";
  ...
  installPhase = ''
    ...
    install -Dm644 ../icons/512.png $out/share/icons/hicolor/scalable/apps/Starfox64Recompiled.png
  ...
  # This is needed as Starfox64Recompiled will segfault when not run from the same
