{ lib, stdenv, fetchurl, libpcap, bison, flex, cyrus-sasl, tcp_wrappers, pkg-config, perl, libtirpc, libnsl }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libpcap bison cyrus-sasl tcp_wrappers flex libnsl ];
