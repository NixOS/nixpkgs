...
let
  ...
  version = "2.2.0"; # Ensure both hashes (Linux and Darwin) are updated!

  hashes = {
    linux = "sha256-uBxpE2i4KYhjy2oJu5qhk/wuDhIkQ3e9QGdJqxBpFxk=";
    darwin = "sha256-TWMYZ+vrJDAz3JUK7707KTj+gdCL2T8zd+9F2pHBSQA=";
  };
