...
let
  ...
  version = "2.1.2"; # Ensure both hashes (Linux and Darwin) are updated!

  hashes = {
    linux = "sha256-DTmUdidi+91g+p0BNavkj+Q+iyZQ4kdYu9Uw9OCERDg=";
    darwin = "sha256-mjNi75dX4B/ov+zEmiJDTV+2o2nVn1zvOcD5kucJdno=";
  };
