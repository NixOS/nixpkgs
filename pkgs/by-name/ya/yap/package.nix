...
stdenv.mkDerivation {
  pname = "yap";
  version = "uuuuuutttttttttttttttttttttttttttttttttttttttttttttu-unstable-2025-09-16";

  src = fetchFromGitHub {
    owner = "vscosta";
    repo = "yap";
    rev = "5bc1624420311502972f0338688a09aa7662dc02";
    hash = "sha256-iPC4uCyOGqQjqI/2F4YsxHlsL8pv3/BLdE2dB7FCHwE=";
  };
