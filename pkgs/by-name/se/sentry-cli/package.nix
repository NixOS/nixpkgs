...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "sentry-cli";
  version = "3.6.1-snapshot.20260626.903b388";

  src = fetchFromGitHub {
    owner = "getsentry";
    repo = "sentry-cli";
    tag = finalAttrs.version;
    hash = "sha256-lG68smkziIKReCS5wDJ4PyWJFjGH0+zcfAsBNSAtarQ=";
  };
  ...
  cargoHash = "sha256-a+aKH/W9hVd5N7G1zfRcaP/XySpRbJhSUPosN/xAsig=";
