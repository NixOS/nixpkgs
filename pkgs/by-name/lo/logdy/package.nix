...
buildGoModule rec {
  ...
  # The first one is getting renamed besed on the documentation
  # The second one is just to launch a demo. This functionnality could be achieved with the first one
  postInstall = ''
