...
stdenv.mkDerivation (finalAttrs: {
  ...
  # maintained in https://codeberg.org/tropf/log4brains
  patches = [
    (fetchpatch2 {
      url = "https://codeberg.org/tropf/log4brains/commit/8c7af30fe7377235037c1a385f484f201ecfe063.patch";
      hash = "sha256-7AcoJ/oaYA4nc4T80oif6LOXBZbC4Ildqwli1nsA9AU=";
    })
    ...
    (replaceVars
      (fetchpatch2 {
        url = "https://codeberg.org/tropf/log4brains/commit/6a8571098024d1eb69efaae1f1622b3a91417b5f.patch";
        hash = "sha256-BNPv4SngKKO7DnsYId2aUdv0QFBpDz2Rd4ZShoyYifQ=";
      })
      {
