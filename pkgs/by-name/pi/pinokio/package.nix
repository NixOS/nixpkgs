...
let
  ...
  src = fetchurl {
    x86_64-darwin = {
      url = "https://github.com/pinokiocomputer/${pname}/releases/download/${version}/Pinokio-${version}.dmg";
      hash = "sha256-Il5zaVWu4icSsKmMjU9u1/Mih34fd+xNpF1nkFAFFGo=";
    };
    x86_64-linux = {
      url = "https://github.com/pinokiocomputer/${pname}/releases/download/${version}/Pinokio-${version}.AppImage";
