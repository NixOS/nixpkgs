...
let
  ...
  src = fetchurl {
    ...
    hash = selectSystem {
      x86_64-linux = "sha256-Pdv+M5sgdCbvAZMA28xhQjOO7mga0TW5rYdJ8ki7SyQ=";
      x86_64-darwin = "sha256-5utolNBT9zRS8RuxsiXMDepufZQ9IzxIRCDiJ6cEZqk=";
      aarch64-darwin = "sha256-XXdgZFReoU8R5KE0kK4QYqjyleBlR7vknL878MJoO2I=";
    };
  };
