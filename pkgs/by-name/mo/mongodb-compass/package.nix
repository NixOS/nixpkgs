...
let
  ...
  src = fetchurl {
    ...
    hash = selectSystem {
      x86_64-linux = "sha256-cwhYiV5G8GRBT7MST20MPUxEMQM1mzxlLUfzGO6jv10=";
      x86_64-darwin = "sha256-TnoXaiSNYiblgJS5nygTHOe9HBgVCTfffX37wrwtxZ8=";
      aarch64-darwin = "sha256-naSOCYxdDLt/zDtR4MhTE96gJypfbk98CWKx2i8kiTk=";
    };
  };
