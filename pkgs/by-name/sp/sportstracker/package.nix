...
let
  ...
  mavenWithJFX = maven.override { jdk = jdkWithJFX; };
in
mavenWithJFX.buildMavenPackage rec {
  pname = "sportstracker";
  version = "8.0.1";
  ...
  mvnHash = "sha256-yHArehMJbAgGjvYHuM5hAW1n6uMbbZ4Y35FImh/N/QE=";
  ...
  meta = {
    ...
    description = "A desktop application for people who want to record and analyze their sporting activities";
