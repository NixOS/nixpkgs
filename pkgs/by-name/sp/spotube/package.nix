  ...
  passthru.sources =
    ...
    in
    {
      "aarch64-linux" = fetchArtifact {
        ...
        hash = "sha256-/ScJJa3NVwMiQ1VzOBqMnI8KxiEzlIbhaYW1Om25aTg=";
      };
      "x86_64-linux" = fetchArtifact {
        suffix = "linux-x86_64.deb";
        hash = "sha256-cz6yrpVp/CVg7jhQHhxvJ+Lm8N+xpOF4dptT3phxxcY=";
      };
      "x86_64-darwin" = fetchArtifact {
        suffix = "macos-universal.dmg";
        hash = "sha256-e6D3PK6WRVnpzhuC6w3STE+h1R3tkZ85OXzKUus6SbM=";
      };
