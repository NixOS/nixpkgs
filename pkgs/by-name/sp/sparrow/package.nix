...
let
  ...
  launcher = writeScript "sparrow" ''
    ...
    params=(
      ...
      --add-opens=jdk.jfr/jdk.jfr=com.sparrowwallet.merged.module
      --add-opens=jdk.jfr/jdk.jfr.internal=com.sparrowwallet.merged.module
  ...
  sparrow-modules = stdenvNoCC.mkDerivation {
    ...
    buildPhase = ''
      ...
      rm -fR com.sparrowwallet.merged.module/com/sun/jna/linux-riscv64
