...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    substituteInPlace tests/unittests/CMakeLists.txt \
      --replace-fail 'set_tests_properties(unittests PROPERTIES TIMEOUT 60)' 'set_tests_properties(unittests PROPERTIES TIMEOUT 200)'
  '';
