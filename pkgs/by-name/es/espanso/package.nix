...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-Au4f0fJvHflfbOLqu1FepfVYfAQJGcDdbc/G38ROa1M=";
  };

  cargoHash = "sha256-xcNAfhnfmxKJc2jrVDMKqUutf4qB3Z7yY4rCDfpTM5g=";
  ...
  postInstall =
    if stdenv.hostPlatform.isDarwin then
      ''
        ${stdenv.shell} ./scripts/create_bundle.sh
      ''
    else
      ''
