...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://github.com/tasks/tasks/releases/download/15.10/tasks-org-${version}-linux-amd64.tar.gz";
    hash = "sha256-EKjMBbPkdd4AYTTDv4JgEvsh4Cw6SWANM4xpWAn+9RI=";
  };
  ...
  postFixup = ''
    wrapProgram $out/bin/tasks-org \
      --prefix LD_LIBRARY_PATH : "$out/lib/runtime/lib:$out/lib/runtime/lib/server:${lib.makeLibraryPath [ dbus ]}"
  '';
