...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "windmill";
    rev = "v${version}";
    hash = "sha256-JFuuaBT8P3xXN3BRjBfIPOymEieDxdT6ZZeWXkejZpk=";
  };
in
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  cargoHash = "sha256-dconSOZg0OjUD7l0pMcNpk03VYzT/kACEO14TzCBTvs=";
  ...
  passthru.web-ui = buildNpmPackage {
    ...
    npmDepsHash = "sha256-SWaL31KCbfS40j3WaSgennYOMa1pe9I0OKWXg1VQ090=";
