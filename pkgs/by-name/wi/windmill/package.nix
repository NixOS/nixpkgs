...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "windmill";
    rev = "v${version}";
    hash = "sha256-2p1Cq+RzkBESReDNiUOgmfpN82ZWlBlvdeTwDbQr/TI=";
  };
in
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  cargoHash = "sha256-erV/I0ubF38XTuDlgfScA7lRGumkVUfJiOC+0rjRpgQ=";
  ...
  passthru.web-ui = buildNpmPackage {
    ...
    npmDepsHash = "sha256-NGiUCj3dN0HmBhkw1XV1kmdgyvj4mmyQx0AU8pwaT9k=";
