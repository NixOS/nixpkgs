...
let
  ...
  getDefaultPlugins = map (plugin: callPackage (buildPlugin plugin) { });
in
...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    ${lib.optionalString stdenv.hostPlatform.isLinux ''
      ...
      cp -r dist/*unpacked/resources/* "$out/share/joplin-desktop"
      ...
      makeWrapper ${lib.getExe electron} $out/bin/joplin-desktop \
        --add-flags $out/share/joplin-desktop/app.asar \
