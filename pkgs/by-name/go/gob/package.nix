...
buildGoModule (finalAttrs: {
  ...
  checkFlags = lib.optionals stdenv.hostPlatform.isDarwin [
    # spins up an httptest server, which cannot bind a loopback socket in the darwin sandbox
    "-skip=^TestLoggerDoesNotOutputToStderr$"
  ];
  ...
  meta = {
    ...
    changelog = "https://github.com/juanibiapina/gob/blob/${finalAttrs.src.tag}/CHANGELOG.md";
