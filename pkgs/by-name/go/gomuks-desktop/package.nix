...
buildNpmPackage (finalAttrs: {
  ...
  postConfigure = ''
    cp ${gomuks-web}/bin/gomuks-web gomuks
  ...
  installPhase = ''
    ...
    cp -r out/gomuks-desktop-*/* $out/share/gomuks-desktop
    ...
    makeWrapper ${lib.getExe electron} $out/bin/gomuks-desktop \
      ...
      --set-default GOMUKS_DESKTOP_BINARY_PATH $out/share/gomuks-desktop/resources/gomuks \
