...
def collect_font(google_fonts_src: Path, font_dir: Path) -> FontFamily:
    ...
    # https://github.com/googlefonts/gftools/blob/v0.10.0/Lib/gftools/util/google_fonts.py#L178
    ...
    return FontFamily(
        ...
        # https://github.com/googlefonts/gf-metadata/blob/v0.2.5/resources/protos/fonts_public.proto#L25-L27
...
def collect_fonts(google_fonts_src: Path) -> list[FontFamily]:
    ...
    assert len(fonts) == len({font["name"] for font in fonts})
...
def main():
    ...
    nixpkgs_google_fonts = nixpkgs / "pkgs/by-name/go/google-fonts-full"
            ...
            [
                {
                    ...
                    "files": [
                        str(nixpkgs_google_fonts / "package.nix"),
