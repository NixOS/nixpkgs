...
buildGoModule (
  ...
  let
    ui = buildNpmPackage {
      ...
      pname = "ntfy-sh-ui";
      npmDepsHash = "sha256-ZN6HzJdbEqWA1mB4o9x3O8wRKj3LSqjNMlKu+FkKeDE=";
  ...
  in
  {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-nWR/lHH3DIT6Gmv3kMM9WO9di1ySZD63HNXruERuJxs=";
    };

    vendorHash = "sha256-nRliqGDdn5qMArwisjrZWUtPNrz+RIi1s1xW+vS7/ww=";
