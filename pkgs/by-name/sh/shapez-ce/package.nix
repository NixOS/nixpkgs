...
let
  ...
  src = fetchFromGitHub {
    ...
    rev = "f9b2ccfbe37a066c71f8ecf9051984d42f5214bd";
    hash = "sha256-QjUVaL27V1y4uG/snp2xDqhiLF5S6FY4GNNNxNmGPkU=";
  };
...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    # https://github.com/tobspr-games/shapez-community-edition/pull/96
    ./0001-Update-imagemin-pngquant-to-the-newest-version.patch
    # https://github.com/tobspr-games/shapez-community-edition/pull/97
    ./0002-Add-desktopName-to-package.json.patch
  ];
  ...
  installPhase = ''
    ...
    install -Dm644 electron/favicon.png $out/share/icons/hicolor/512x512/apps/io.shapez.png
