  ...
  cache = [
    ...
    }
    {
      ...
      src = fetchurl {
        ...
        meta.identifiers.purlParts = {
          type = "github";
          spec = "csukuangfj/kaldi-native-fbank@v1.22.3";
        };
      };
    }
    {
      ...
      src = fetchurl {
        ...
        meta.identifiers.purlParts = {
          type = "github";
          spec = "pkufool/simple-sentencepiece@v0.7";
        };
      };
    }
    {
    ...
    }
    {
      ...
      src = fetchurl {
        ...
        meta.identifiers.purlParts = {
          type = "github";
          spec = "k2-fsa/kaldi-decoder@v0.3.0";
        };
      };
    }
    {
    ...
    }
    {
      ...
      src = fetchurl {
        ...
        meta.identifiers.purlParts = {
          type = "github";
          spec = "csukuangfj/openfst@v1.8.5-2026-04-11";
        };
      };
    }
    {
