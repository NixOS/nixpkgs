...
let
  ...
  src = fetchurl {
    url = "https://web.archive.org/web/20250602031258/https://launcher.cdn.ankama.com/installers/production/Ankama%20Launcher-Setup-x86_64.AppImage";
    hash = "sha256-d9FEXVuN7wiilskKhPbp/ssn16l8F1a/C6VBNVv3x20=";
  };
