...
let
  ...
  src = fetchurl {
    url = "https://web.archive.org/web/20241226115409/https://launcher.cdn.ankama.com/installers/production/Ankama%20Launcher-Setup-x86_64.AppImage";
...
appimageTools.wrapType2 {
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ harbiinger ];
