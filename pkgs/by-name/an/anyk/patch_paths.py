...
patches = [
    ...
    (
        "(Lorg/w3c/dom/Element;)Lcom/sun/xml/internal/ws/api/message/Header;",
        "(Lorg/w3c/dom/Element;)Lcom/sun/xml/ws/api/message/Header;",
    ),
    (
        "([Lcom/sun/xml/internal/ws/api/message/Header;)V",
        "([Lcom/sun/xml/ws/api/message/Header;)V",
    ),
]
