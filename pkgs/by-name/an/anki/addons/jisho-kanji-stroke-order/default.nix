...
anki-utils.buildAnkiAddon (finalAttrs: {
  ...
  meta = {
    ...
    longDescription = ''
      This add-on must be configured to apply to certain note types. The options to configure this add-on can be found [here](https://github.com/soleuniverse101/anki-jisho-strokes/blob/main/addon/config.md).
      Example:
