...
let
  ...
  netbeansPlatform = fetchurl {
    url = "https://web.archive.org/web/20260911112523/https://archive.apache.org/dist/netbeans/netbeans/17/netbeans-17-bin.zip";
...
stdenv.mkDerivation {
  ...
  meta = {
    ...
    changelog = "https://github.com/aaron-siegel/cgsuite/releases/tag/${src.tag}";
