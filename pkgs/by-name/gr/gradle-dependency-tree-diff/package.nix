...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    mkdir -p $out/{bin,share/dependency-tree-diff}
    cp build/dependency-tree-diff.jar $out/share/dependency-tree-diff
    makeWrapper ${lib.getExe jre} $out/bin/dependency-tree-diff \
