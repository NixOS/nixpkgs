...
stdenv.mkDerivation (finalAttrs: {
  ...
  postPatch = ''
    ...
    substituteInPlace as/driver.c \
      --subst-var-by clang-unwrapped '${lib.getBin buildPackages.clang.cc}/bin/' \
      --replace '../libexec/as/' '${placeholder "gas"}/libexec/as/' \
      --replace '../local/libexec/as/' '${placeholder "gas"}/libexec/as/'
