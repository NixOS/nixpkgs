...
buildGoModule rec {
  ...
  rev = "e0847582313b687c789d014e23ed3459ac15ef41";
  ...
  src = fetchFromGitHub {
    ...
    repo = "prow";
    hash = "sha256-pQN5xgVRagJ/06ggomQ7LzgXrJ7PXV79/UyuYnpf4i0=";
  };

  vendorHash = "sha256-PAvfX1V5nRxxQjAImkiedtUgn7M2QwkFygZZGX5XEpU=";
