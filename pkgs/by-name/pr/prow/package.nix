...
buildGoModule rec {
  ...
  rev = "1a000594c40919068dd43a5704f279f273135d18";
  ...
  src = fetchFromGitHub {
    ...
    repo = "prow";
    hash = "sha256-jEIKPpODzn+R+UoRsB08bQGkNfp0fpcRfFjTRpriCJo=";
  };

  vendorHash = "sha256-ZsNKa9juXepHJQw2KDOMV6LZtng7RUjGslQb/HU4H7A=";
