...
buildGoModule rec {
  ...
  # version.
  version = "4.6.0-4.8.3"; # N.B: If you change this, update dcgm as well to the matching version.

  src = fetchFromGitHub {
    owner = "NVIDIA";
    repo = "dcgm-exporter";
    tag = version;
    hash = "sha256-SUnR+1Z74nHXWaY2brWy6KYV8K3SvFG6e3wNRGYvmlw=";
  };
  ...
  vendorHash = "sha256-35gmJtiOiVzEND7u2VtPStoRVZJ6bSww8Ah7nKqFh7I=";
