...
latestBuildInfoAarch64=$(curl "https://copr.fedorainfracloud.org/api_3/package/?ownername=useidel&projectname=signal-desktop&packagename=signal-desktop&with_latest_succeeded_build=true" | jq '.builds.latest_succeeded')
