...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-LvTGbMNmbafIaHA2Pi3nwSMovyBkj+rr4V91jXHySCY=";
  };
  ...
  kernel = buildGo123Module {
    ...
    vendorHash = "sha256-K02ePDDijU5k0xh6yXAFPHzdX3vjWIYrdflj93qVDL8=";
  ...
  pnpmDeps = pnpm.fetchDeps {
    inherit (finalAttrs)
      ...
      sourceRoot
      ;
    hash = "sha256-DLmLRrfHx1nhid25qJvReI+MwT3Lm+AD1tQjx0QPoeU=";
  };
