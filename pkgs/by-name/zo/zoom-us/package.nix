...
let
  ...
  versions.aarch64-darwin = "7.2.0.88195";

  # This is the fallback version so that evaluation can produce a meaningful result.
  versions.x86_64-linux = "7.2.0.5705";

  srcs = {
    aarch64-darwin = fetchurl {
      url = "https://zoom.us/client/${versions.aarch64-darwin}/zoomusInstallerFull.pkg?archType=arm64";
      name = "zoomusInstallerFull.pkg";
      hash = "sha256-DfR9GiSzWrfiMU76mFfxrnFIBvKF197qCGlxB9FAXvM=";
    };
    x86_64-linux = fetchurl {
      url = "https://zoom.us/client/${versions.x86_64-linux}/zoom_x86_64.pkg.tar.xz";
      hash = "sha256-QFgKOr/qHRnEA9junGRLhnTz7YddyZwK7UhPVnz3Rrs=";
    };
  };
