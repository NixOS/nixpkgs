...
let
  ...
  versions.aarch64-darwin = "6.3.5.46181";
  versions.x86_64-darwin = "6.3.5.46181";
  versions.x86_64-linux = "6.3.5.6065";

  srcs = {
    aarch64-darwin = fetchurl {
      url = "https://zoom.us/client/${versions.aarch64-darwin}/zoomusInstallerFull.pkg?archType=arm64";
      name = "zoomusInstallerFull.pkg";
      hash = "sha256-DPX9CTurHA57W7srZw5h7CqrI6OQqkiSrLUsvNiwoC0=";
    };
    x86_64-darwin = fetchurl {
      url = "https://zoom.us/client/${versions.x86_64-darwin}/zoomusInstallerFull.pkg";
      hash = "sha256-a4l43a1WfA3o0oGOn6ZMsIaUWXPrwiIMfAygbf/+JAo=";
    };
