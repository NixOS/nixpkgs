...
stdenv.mkDerivation {
  ...
  src = fetchzip {
    url = "https://web.archive.org/web/20250401040353/https://s3proxy.cdn-zlib.sk/te_public_files/soft/linux/zlibrary-setup-latest.tar.gz";
    hash = "sha256-nL/pWTmmiPacu81xfxU6UwVqtVinWGUzN00FWCvZEfw=";
  };
