...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    install -Dm444 OFL.txt OFL-FAQ.txt README.txt FONTLOG.txt -t $out/share/doc/charis-${finalAttrs.version}
  ...
  meta = {
    ...
    longDescription = ''
      This Charis font is essentially the same design as the SIL Charis font first released by SIL in 1997. Charis is similar to Bitstream Charter, one of the first fonts designed specifically for laser printers. It is highly readable and holds up well in less-than-ideal reproduction environments. It also has a full set of styles – regular, italic, bold, bold italic. Charis is a serif, proportionally-spaced font optimized for readability in long printed documents.
