...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    hash =
      {
        aarch64-linux = "sha256-WPxH7UiiyVexDqLQcJAxJTnYKmgjf+146nVGCObF/oU=";
        armv7l-linux = "sha256-VzZYL8bhPQVUiu5rDdaoY2OUlcAxDUWXqE+J+6aDIMY=";
        x86_64-linux = "sha256-qtsXj0Adc6iQU5LkoYJhqv3LGDs8/6Ovgt0ZVAhvVMo=";
      }
      .${stdenv.hostPlatform.system} or (throw "Unsupported system: ${stdenv.hostPlatform.system}");
  };
