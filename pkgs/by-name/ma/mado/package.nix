{
  ...
  inherit (stdenv.hostPlatform) system isAarch64 isx86_64 isDarwin isLinux;
  ...
  arch =
    ...
    then "x86_64"
    else throw "mado: unsupported architecture for ${system}";
  ...
  os =
    ...
    then "Linux-gnu"
    else throw "mado: unsupported OS for ${system}";
  ...
  hash =
    ...
    .${
      system
    } or (throw "mado: unsupported system ${system}");
in
