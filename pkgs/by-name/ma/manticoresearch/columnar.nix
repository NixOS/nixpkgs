...
let
  ...
  hnswlib = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchzip {
      url = "https://github.com/manticoresoftware/hnswlib/archive/d7bb3bbd59220f62203012b2f649aa537cc97cdc.zip";
  ...
  streamvbyte = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchzip {
      url = "https://github.com/manticoresoftware/streamvbyte/archive/efdd9dace81a4a8f844267631879b500c6d913cf.zip";
