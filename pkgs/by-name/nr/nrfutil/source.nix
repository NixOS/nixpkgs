{
  aarch64-linux = {
    ...
    packages = {
      ...
      nrfutil-device = {
        version = "2.14.2";
        hash = "sha256-O0pb8LkxSC+Yfyo6zGCUQEqIHf61vq3utoVPF4Av9x4=";
      };
      nrfutil-mcu-manager = {
        version = "0.7.0";
        hash = "sha256-xZvhfGdU0zJWYwQOqCiO5A5GWwz/HHcnWCYc6ZwxeKs=";
      };
      nrfutil-sdk-manager = {
        version = "1.7.1";
        hash = "sha256-PqzWGYIbgLYCQcBGRgSZniXr6U5+6DdhNaUOdvICDqY=";
      };
      nrfutil-trace = {
        version = "4.0.1";
  ...
  x86_64-linux = {
    ...
    packages = {
      ...
      nrfutil-device = {
        version = "2.14.2";
        hash = "sha256-T94iREERr46RSr25qndlua2EqGa7TNPHgX5KzBiAVnU=";
      };
      nrfutil-mcu-manager = {
        version = "0.7.0";
        hash = "sha256-PBh8cDJozNhrQiXIJNs+Hi7BRXheHO0L8J4N7/WjpMI=";
      };
      nrfutil-npm = {
        version = "0.3.1";
      ...
      nrfutil-sdk-manager = {
        version = "1.7.1";
        hash = "sha256-/CtXul/jMNOeesIOl+atbGSySlLf1uvT8BiDioUwOtA=";
      };
      nrfutil-suit = {
        version = "0.9.0";
