...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # XSA #488
    (fetchpatch {
      url = "https://xenbits.xenproject.org/xsa/xsa488.patch";
      hash = "sha256-R3FzMLBNrZSc8ZKrP0x+6+94zaAZLmPG4c9ykrsmeyE=";
    })
  ];
  ...
  src = fetchFromGitHub {
    ...
    repo = "xen";
    tag = "RELEASE-4.21.1";
    hash = "sha256-yQCmyCa6sN7s1VtoM3Vf1AbbaabvdzFg32pYiXzWpmM=";
  };
