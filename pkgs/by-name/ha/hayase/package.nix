...
stdenv.mkDerivation (finalAttrs: {
  pname = "hayase";
  version = "6.4.18-unstable-2025-07-30";

  src = fetchFromGitHub {
    owner = "hayase-app";
    repo = "electron";
    rev = "877536e26f0ffafbe4250d9f5f9e92fadf20b5ef";
    hash = "sha256-XQlagzoVkhEW1u108GnwzsyHfF95KWco0u5Th0ojhzA=";
  };

  pnpmDeps = pnpm_10.fetchDeps {
    inherit (finalAttrs) pname version src;
    fetcherVersion = 2;
    hash = "sha256-BE6ipwzijAvNH08FsCUk0XyqXmm9/PMVfqXMiLmE7HE=";
  };
