...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  cargoRoot = "src-tauri";
  cargoHash = "sha256-B9vl5epJc9z0yfTZHknomL5gwp3r33hvDjL2pf1Odpo=";
  ...
  passthru = {
    ...
    frontendDeps = stdenv.mkDerivation {
      ...
      outputHash =
        {
          "x86_64-linux" = "sha256-bkBgSjXPPLCG2ex67jP/euEX/i4IDaK38g6YkXDDAW0=";
          "aarch64-linux" = "sha256-D2NbqAu3kWWwVlSJ8gjjfU2+Ibej/00D422kVbokeGw=";
          "aarch64-darwin" = "sha256-FTE7l5Cls6Hky49SKFHArPQRlRsEfDhldLP/XqeFTKM=";
        }
