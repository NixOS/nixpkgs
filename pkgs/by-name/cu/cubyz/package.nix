...
stdenv.mkDerivation (finalAttrs: {
  ...
  # Change some env variables, move a bunch of stuff under .config for modding purposes, add a desktop entry
  postInstall = ''
    wrapProgram $out/bin/Cubyz \
      ...
      --run "
        ...
        [ ! -f \$HOME/.local/share/applications/cubyz.desktop ] && printf \"
          [Desktop Entry]
          Name=Cubyz
          Exec=$out/bin/Cubyz
          ...
          Type=Application
          Categories=Game;
        \" > \$HOME/.local/share/applications/cubyz.desktop
      "
  '';
