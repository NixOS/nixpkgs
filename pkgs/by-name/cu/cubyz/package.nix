...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-uJvc6Np8BaXO4kLahI/nh5plPGU542ih98ZEX1l7Pzg=";
  };
  ...
  cubAssets = fetchFromGitHub {
    ...
    repo = "Cubyz-Assets";
    tag = "0.3.6";
    hash = "sha256-z7ivohADXiqJYJ3yx2c22MDBixug+YpwnvrC072FRYc=";
  };

  zigDeps = zig_0_16.fetchDeps {
    inherit (finalAttrs) src pname version;
    fetchAll = true;
    hash = "sha256-Ggvq+hTTmFmIolz6mR7L366tSjK4aIHs13A1fnRhC90=";
  };
