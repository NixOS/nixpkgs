...
# Note: curlMinimal (derived from this package) is used for bootstrapping fetchurl,
# and thus cannot use fetchpatch! All mutable patches (generated by GitHub or
# cgit) that are needed here should be included directly in Nixpkgs as files.
