...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "lemonade";
    rev = "v${version}";
    hash = "sha256-gmYvjvz0ZBHexqLUrfwpIJxl5OCroF61/9wdCB9aBik=";
  };
...
stdenv.mkDerivation (finalAttrs: {
  ...
  preFixup = ''
    substituteInPlace $out/lib/pkgconfig/libwebsockets_static.pc --replace-fail "//" "/"
    substituteInPlace $out/lib/pkgconfig/libwebsockets.pc --replace-fail "//" "/"
  '';
