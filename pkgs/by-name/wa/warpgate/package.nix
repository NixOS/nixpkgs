...
rustPlatform.buildRustPackage (
  ...
  let
    warpgate-web =
      ...
      buildNpmPackage {
        ...
        npmDepsHash = "sha256-z9rCE7flOfBAULN9V0sAPTzvDV4d2+RFyf6lOTHR6cs=";
  ...
  in
  {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-r2azy8k5tnuQMzVkHh0/5Sv/NHKNvtzzTMhpPIJ4cGo=";
    };

    cargoHash = "sha256-LzVOD5+qjcP+aOg7B4wuCwrlsMmG4gAz81ufe3t4lLo=";

    patches = [
      ./hardcode-version.patch
