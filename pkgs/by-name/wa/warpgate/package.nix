...
rustPlatform.buildRustPackage (
  ...
  let
    warpgate-web =
      ...
      buildNpmPackage {
        ...
        npmDepsHash = "sha256-hCn0+w9nTKLOsB8TgqK5tzXpuisrbyzTIgb36RL8qow=";
  ...
  in
  {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-NO73dbeO3tz9QNLrxRXoAZrlBKivp7sCxgf/xcQIwnQ=";
    };

    cargoHash = "sha256-rYCed88Ska3rHWkoSPTly9GXTLOvlJajsgk75YGiWqo=";
