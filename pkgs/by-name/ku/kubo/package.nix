...
buildGoModule rec {
  pname = "kubo";
  version = "0.30.0"; # When updating, also check if the repo version changed and adjust repoVersion below
  rev = "v${version}";
  ...
  src = fetchurl {
    ...
    hash = "sha256-+GO23A9DHIHuKzGNkPLBNvvPzFL3FfQYRYu9TfPii08=";
  };
