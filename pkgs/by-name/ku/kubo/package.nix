...
buildGoModule rec {
  pname = "kubo";
  version = "0.38.1"; # When updating, also check if the repo version changed and adjust repoVersion below
  rev = "v${version}";
  ...
  src = fetchurl {
    ...
    hash = "sha256-PMuOF7g5tnm4rI5jNkAv0vPaUR4n5KBJIgvBba0DxD8=";
  };
