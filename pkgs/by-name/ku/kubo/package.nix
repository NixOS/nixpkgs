...
buildGoModule rec {
  pname = "kubo";
  version = "0.31.0"; # When updating, also check if the repo version changed and adjust repoVersion below
  rev = "v${version}";
  ...
  src = fetchurl {
    ...
    hash = "sha256-bk9E6K5eOIoPURFaWnwXiyUhqZxW6k/pmpGvTgrM4Qg=";
  };
