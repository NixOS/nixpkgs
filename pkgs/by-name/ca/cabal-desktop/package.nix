...
let
  ...
  libPath =
    lib.makeLibraryPath dependencies + ":" + lib.makeSearchPathOutput "lib" "lib64" dependencies;
...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    makeBinaryWrapper $out/share/cabal-desktop/cabal-desktop $out/bin/cabal-desktop \
