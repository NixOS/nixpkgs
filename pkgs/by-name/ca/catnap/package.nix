...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    sed -i 's|./../bin/catnap|${placeholder "out"}/bin/catnap|g' scripts/test-commandline-args.sh
    sed -i 's|../config|${placeholder "out"}/share/config|g' scripts/test-commandline-args.sh
    sed -i 's|./test_config.toml|${placeholder "testsout"}/scripts/test_config.toml|g' scripts/test-commandline-args.sh
