...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    owner = "robur-coop";
    repo = "dnsvizor";
    rev = "2a7a1ef18d39f1a4a7c0b269432b5e84147347f3";
    hash = "sha256-RqkaLsDEeiebwEoTQZ1CDBc7R8P8z7kT7I+dJnQBytE=";
  };

  # x509 1.2.0 typed `Distinguished_name` drop when dnsvizor adapts
  # https://github.com/mirleft/ocaml-x509/pull/188
  patches = [ ./x509-1.2.0.patch ];
