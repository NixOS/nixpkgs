...
python3.pkgs.buildPythonApplication rec {
  ...
  patches = [
    ...
    # remove next release
    # https://github.com/NVIDIA/garak/pull/1283/
    (fetchpatch2 {
    ...
    # https://github.com/NVIDIA/garak/pull/1314/
    (fetchpatch2 {
      name = "use-numpy-v2.patch";
      url = "https://github.com/NVIDIA/garak/pull/1314/commits/f673432af43550d976ea6a6dfbefce9963091817.patch";
      hash = "sha256-8+ML+MmMV2JTHLpXtKdZ5nn5hPfOz9rPieOvh0GCXy4=";
    })


    # update to cohere v5
    # remove next release
    # https://github.com/NVIDIA/garak/pull/1252
    ./cohere-version-upgrade.patch
    ...
    (fetchpatch2 {
      name = "tweaks-to-how-wn-is-used.patch";
      url = "https://github.com/NVIDIA/garak/pull/1316/commits/79400c37f750efed284c1024552da080b7f754ee.patch?full_index=1";
      hash = "sha256-ZuW1cx54j3Lvn1ualb+qNiT34fv28TE5TUofXqOia4g=";
    })

    # upstream report using flit to build and release packages
    # this pr adjusts pyproject.toml to match
    # https://github.com/NVIDIA/garak/pull/1317
    ./flit.patch
  ];
  ...
  preCheck =
    ...
    ''
      ...
      # cat tests/probes/test_probes_topic.py
      # exit 1
    '';
