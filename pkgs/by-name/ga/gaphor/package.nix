...
python3Packages.buildPythonApplication rec {
  ...
  postInstall = ''
    ...
    install -Dm644 data/logos/gaphor-24x24.png \
                   $out/share/icons/hicolor/24x24/apps/org.gaphor.Gaphor.png
    install -Dm644 data/logos/gaphor-48x48.png \
                   $out/share/icons/hicolor/48x48/apps/org.gaphor.Gaphor.png
    install -Dm644 data/logos/org.gaphor.Gaphor.svg -t \
                   $out/share/icons/hicolor/scalable/apps/
    install -Dm644 data/logos/org.gaphor.Gaphor-symbolic.svg -t  \
                   $out/share/icons/hicolor/symbolic/apps/

    $out/bin/gaphor install-schemas \
                    --schemas-dir $out/share/glib-2.0/schemas \
                    --glib-compile-schemas ${glib.dev}/bin/glib-compile-schemas
  '';
