...
A _generator_ represents a collection of secret files, usually generated by a script. In case the generation is not meant to be done programmatically, the files can also be imported manually via the CLI (more on this later (TODO)).
