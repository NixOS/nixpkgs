        ...
        Token(
            ...
            children=[
                Token(
                    ...
                    tag="span",
                    nesting=1,
                    attrs={"class": "test1 test2 test3 test4", "id": "foo"},
                    map=None,
                    level=0,
                    children=None,
                    content="",
...
def test_heading_attributes() -> None:
    ...
    assert c._parse("# foo--bar {#id-with--double-dashes}") == [
        Token(
            ...
            tag="h1",
            nesting=1,
            attrs={"id": "id-with--double-dashes"},
            map=[0, 1],
            level=0,
            children=None,
            content="",
        ...
        Token(
            ...
            map=[0, 1],
            level=1,
            content="foo--bar {#id-with--double-dashes}",
            markup="",
            info="",
            meta={},
            block=True,
...
def test_example() -> None:
    ...
    assert c._parse("::: {.example}\n### foo: `code`\nbar\n:::\nbaz") == [
        ...
        Token(
            type="paragraph_open", tag="p", nesting=1, map=[2, 3], level=1, block=True
        ),
        Token(
            type="inline",
            tag="",
            ...
            content="bar",
            block=True,
            children=[Token(type="text", tag="", nesting=0, content="bar")],
        ),
        ...
        Token(
            ...
            content="baz",
            block=True,
            children=[Token(type="text", tag="", nesting=0, content="baz")],
        ),
