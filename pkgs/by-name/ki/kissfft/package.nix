...
assert lib.warnIf (withTools != null) "kissfft: `withTools` is unnecessary and deprecated" true;
...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch2 {
      url = "https://github.com/mborgerding/kissfft/commit/a73134e594d85abc32e27a34a78ce75c5f006f92.patch?full_index=1";
      hash = "sha256-/LyyBCIyaxDxEBd6gWPSItsT9AxxQfEZAtRYbTdaAlk=";
    })
  ];
