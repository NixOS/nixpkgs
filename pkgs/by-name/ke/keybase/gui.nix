...
let
  versionSuffix = "20260306163447.79477565ce";
in

stdenv.mkDerivation rec {
  pname = "keybase-gui";
  version = "6.6.0"; # Find latest version and versionSuffix from https://prerelease.keybase.io/deb/dists/stable/main/binary-amd64/Packages

  src = fetchurl {
    url = "https://s3.amazonaws.com/prerelease.keybase.io/linux_binaries/deb/keybase_${version + "-" + versionSuffix}_amd64.deb";
    hash = "sha256-ebETpawagHyVzLSJ8LkPYmM/MCQmfv0RuC9+ocKoSTU=";
  };
