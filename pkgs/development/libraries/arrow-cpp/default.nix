  ...
  GTEST_FILTER =
    let
      ...
      filteredTests = lib.optionals stdenv.hostPlatform.isAarch64 [
        ...
        "TestS3FSGeneric.CopyFile"
        "TestS3FSGeneric.CreateDir"
        "TestS3FSGeneric.DeleteDir"
        "TestS3FSGeneric.DeleteDirContents"
        "TestS3FSGeneric.DeleteFile"
        "TestS3FSGeneric.DeleteFiles"
        "TestS3FSGeneric.DeleteRootDirContents"
        "TestS3FSGeneric.GetFileInfo"
        "TestS3FSGeneric.GetFileInfoAsync"
        "TestS3FSGeneric.GetFileInfoGenerator"
        "TestS3FSGeneric.GetFileInfoSelector"
        "TestS3FSGeneric.GetFileInfoSelectorWithRecursion"
        "TestS3FSGeneric.GetFileInfoVector"
        "TestS3FSGeneric.MoveFile"
        "TestS3FSGeneric.OpenInputFile"
        "TestS3FSGeneric.OpenInputFileAsync"
        "TestS3FSGeneric.OpenInputFileWithFileInfo"
        "TestS3FSGeneric.OpenInputStream"
        "TestS3FSGeneric.OpenInputStreamAsync"
        "TestS3FSGeneric.OpenInputStreamWithFileInfo"
        "TestS3FSGeneric.OpenOutputStream"
        "TestS3FSGeneric.SpecialChars"
      ];
    in
