...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl libev zlib ]
    ++ stdenv.lib.optional enableHpack jansson
    ++ stdenv.lib.optional enableAsioLib boost
    ++ stdenv.lib.optional enableGetAssets libxml2
    ++ stdenv.lib.optional enableJemalloc jemalloc;
