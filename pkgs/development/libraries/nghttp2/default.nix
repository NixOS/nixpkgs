...
, openssl, zlib
, enableLibEv ? !stdenv.hostPlatform.isWindows, libev
, enableCAres ? !stdenv.hostPlatform.isWindows, c-ares
...
, enablePython ? false, pythonPackages, ncurses
}:

let inherit (pythonPackages) python cython setuptools; in
