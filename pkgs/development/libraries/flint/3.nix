...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    (fetchpatch {
      name = "fix-checkPhase-linker-errors";
      url = "https://patch-diff.githubusercontent.com/raw/flintlib/flint/pull/2411.patch";
      hash = "sha256-MKSfjNJuqi/fouUAz4bPPM8zFTcnxoAae6fGNWOjTBg=";
    })
  ];
