{ lib, stdenv, fetchFromGitHub, abseil-cpp, c-ares, cmake, crc32c, curl
, gbenchmark, grpc, gtest, ninja, nlohmann_json, pkg-config, protobuf
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ abseil-cpp c-ares crc32c curl grpc nlohmann_json protobuf ];
  ...
  installCheckInputs = lib.optionals doInstallCheck [ gbenchmark gtest ];
