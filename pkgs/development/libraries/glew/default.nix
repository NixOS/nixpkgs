...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # fix for CMake v4
    # ref. https://github.com/nigels-com/glew/pull/391, merged upstream
    (fetchpatch {
      url = "https://github.com/nigels-com/glew/commit/a4d8b2a2a30576eb1b984ba5d573702acfc5b92e.patch";
