{ lib, stdenv, runCommand, fetchurl, perl, python3, ruby, bison, gperf, cmake
, ninja, pkg-config, gettext, gobject-introspection, libnotify, gnutls
, libgcrypt, libgpg-error, gtk3, wayland, libwebp, enchant2, xorg, libxkbcommon
, libepoxy, at-spi2-core, libxml2, libsoup, libsecret, libxslt, harfbuzz
, libpthreadstubs, pcre, nettle, libtasn1, p11-kit, libidn, libedit, readline
, apple_sdk, libGL, libGLU, mesa, libintl, lcms2, libmanette, openjpeg
, enableGeoLocation ? true, geoclue2, sqlite, enableGLES ? true
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    libintl
    lcms2
  ] ++ lib.optionals stdenv.isLinux [ libmanette ] ++ [
    libnotify
    libpthreadstubs
    libsecret
    libtasn1
  ...
  cmakeFlags = [
    ...
    "-DUSE_SOUP2=${
      if lib.versions.major libsoup.version == "2" then "ON" else "OFF"
    }"
  ...
  ] ++ lib.optionals (!stdenv.isLinux) [ "-DUSE_SYSTEMD=OFF" ]
