...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.lysator.liu.se/~nisse/misc/argp-standalone-${version}.tar.gz";
    sha256 = "dec79694da1319acd2238ce95df57f3680fea2482096e483323fddf3d818d8be";
  };

  patches = lib.optionals stdenv.hostPlatform.isDarwin [ patch-argp-fmtstream ]
  ...
  preConfigure = lib.optionalString stdenv.hostPlatform.isLinux
    "export CFLAGS='-fgnu89-inline -fPIC'";
