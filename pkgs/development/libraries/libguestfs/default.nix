...
, ncurses, cpio, gperf, cdrkit, flex, bison, qemu, pcre, augeas, libxml2, acl
...
, ocamlPackages, libtirpc, appliance ? null, javaSupport ? false, jdk ? null }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/libguestfs/libguestfs/commit/210959cc344d6a4a1e3afa26d276b130651def74.patch";
