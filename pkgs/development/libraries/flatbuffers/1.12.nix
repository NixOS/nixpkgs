...
callPackage ./generic.nix {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/google/flatbuffers/commit/988164f6e1675bbea9c852e2d6001baf4d1fcf59.patch";
    ...
    (fetchpatch {
      ...
      # Should be included in the next release after 1.12.0
      url =
        "https://github.com/google/flatbuffers/pull/6020/commits/44c7a4cf439b0a298720b5a448bcc243a882b0c9.patch";
