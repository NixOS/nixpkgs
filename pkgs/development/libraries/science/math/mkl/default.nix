{ lib, stdenv, callPackage, stdenvNoCC, fetchurl, rpmextract, undmg, darwin
...
let
  ...
  oneapi-tbb = fetchurl {
    url =
      "https://yum.repos.intel.com/oneapi/intel-oneapi-tbb-${mklVersion}-${mklVersion}-${tbbRel}.x86_64.rpm";
