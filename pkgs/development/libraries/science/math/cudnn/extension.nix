  ...
  in {
    ...
    "8.6.0" = [
      rec {
        ...
        url = "${urlPrefix}/v${majorMinorPatch fullVersion}/local_installers/${fileVersion}/cudnn-linux-x86_64-${fullVersion}_cuda${lib.versions.major fileVersion}-archive.tar.xz";
        supportedCudaVersions = [ "10.2" ];
      }
      rec {
        fileVersion = "11.8";
