...
let local = config.openblas.preferLocalBuild or false;
    ...
    # https://github.com/NixOS/nixpkgs/issues/10866
    version = if stdenv.isDarwin
      then "0.2.14"
      else "0.2.15";
    sha256 = if stdenv.isDarwin
      then "0av3pd96j8rx5i65f652xv9wqfkaqn0w4ma1gvbyz73i6j2hi9db"
      else "0i4hrjx622vw5ff35wm6cnga3ic8hcfa88p1wlj24a3qb770mi3k";
in
stdenv.mkDerivation {
