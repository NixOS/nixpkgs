{ lib, stdenv, fetchurl, fetchpatch, boost, cmake, doxygen, eigen, mpi4py, numpy
, pkg-config, pybind11, pytest, pythonPackages, six, sympy, gtest, hdf5, mpi
, ply, python, scotch, setuptools, sphinx, suitesparse, swig, zlib, blas, lapack
}:
let
  version = "2019.1.0";
