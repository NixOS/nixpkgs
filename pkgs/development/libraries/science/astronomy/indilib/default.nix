{ stdenv, lib, fetchFromGitHub, cmake, cfitsio, libusb1, zlib, boost, libnova
, curl, libjpeg, gsl, fftw }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ curl cfitsio libusb1 zlib boost libnova libjpeg gsl fftw ];
