...
, enableUnfree ? false, enableIpp ? false, enablePython ? false
, pythonPackages ? null, enableGtk2 ? false, gtk2, enableGtk3 ? false, gtk3
, enableVtk ? false, vtk, enableFfmpeg ? false, ffmpeg, enableGStreamer ? false
, gst_all_1, enableTesseract ? false, tesseract, leptonica, enableTbb ? false
, tbb, enableOvis ? false, ogre, enableGPhoto2 ? false, libgphoto2
...
in stdenv.mkDerivation {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/opencv/opencv/commit/384875f4fcf1782b10699a379aa245a03cb27a04.patch";
