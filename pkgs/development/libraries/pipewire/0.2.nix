...
, valgrind, glib, dbus, gst_all_1, alsa-lib, ffmpeg_4, libjack2, udev, libva
, xorg, sbc, SDL2, makeFontsConf }:
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ meson ninja pkg-config doxygen graphviz valgrind ];
  buildInputs = [
    glib
    dbus
