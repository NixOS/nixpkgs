...
, compat26 ? true, compat28 ? true, unicode ? true
, withGtk2 ? false
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "1w7pgfqjab7n84lc4aarydl3g55d1hdgl2ilwml766r6inc7y5cn";
  };
  ...
  configureFlags =
    [ "--disable-precomp-headers" "--enable-mediactrl"
      (enableFeature compat26 "compat26")
  ...
  passthru = {
    inherit compat26 compat28 unicode withGtk2 withWebKit;
