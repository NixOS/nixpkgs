...
stdenv.mkDerivation rec {
  pname = "grpc";
  version =
    "1.42.0"; # N.B: if you change this, change pythonPackages.grpcio-tools to a matching version too
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/grpc/grpc/commit/2f4cf1d9265c8e10fb834f0794d0e4f3ec5ae10e.patch";
    ...
    (fetchpatch {
      url =
        "https://github.com/grpc/grpc/commit/931f91b745cd5b2864a0d1787815871d0bd844ae.patch";
