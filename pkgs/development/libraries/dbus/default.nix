...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    ++ lib.optional stdenv.hostPlatform.isStatic
      (fetchpatch {
        url = "https://gitlab.freedesktop.org/dbus/dbus/-/commit/3d789d5c59abdf6ad01f62462cec5e62bbada12c.patch";
        sha256 = "1l7nlp07p3gv9pycsml3z7w6ky5rimcz5sqmd3sr5i8mix98yaqm";
      });
  ...
  nativeBuildInputs = lib.optionals stdenv.hostPlatform.isStatic
