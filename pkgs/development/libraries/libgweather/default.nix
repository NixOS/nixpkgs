{ lib, stdenv, fetchurl, meson, ninja, pkg-config, libxml2, glib, gtk3, gettext
, libsoup, gtk-doc, docbook-xsl-nons, docbook_xml_dtd_43, gobject-introspection
, python3, tzdata, geocode-glib, vala, gnome }:
