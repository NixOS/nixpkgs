{ fetchpatch, fetchurl, stdenv, lib, ncurses, termcap
}:
...
stdenv.mkDerivation rec {
  ...
  strictDeps = true;
  propagatedBuildInputs = lib.optionals (!stdenv.hostPlatform.isMinGW) [ ncurses ]
    ++ lib.optionals stdenv.hostPlatform.isMinGW [ termcap ];
