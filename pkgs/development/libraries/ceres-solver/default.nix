...
, suitesparse, runTests ? false, enableStatic ? stdenv.hostPlatform.isStatic
, withBlas ? true }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/ceres-solver/ceres-solver/commit/4998c549396d36a491f1c0638fe57824a40bcb0d.patch";
