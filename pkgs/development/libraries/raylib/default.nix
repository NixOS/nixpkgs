{ stdenv, lib, fetchFromGitHub, cmake, mesa, libGLU, glfw, libX11, libXi
, libXcursor, libXrandr, libXinerama, alsaSupport ? stdenv.hostPlatform.isLinux
, alsa-lib, pulseSupport ? stdenv.hostPlatform.isLinux, libpulseaudio
...
stdenv.mkDerivation rec {
  ...
  cmakeFlags = [ "-DUSE_EXTERNAL_GLFW=ON" "-DBUILD_EXAMPLES=OFF" ]
