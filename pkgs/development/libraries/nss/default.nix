{ stdenv, fetchurl, nspr, perl, zlib, sqlite, fixDarwinDylibNames, buildPackages, ninja, coreutils }:
...
in stdenv.mkDerivation rec {
  ...
  prePatch = ''
    ...
    substituteInPlace nss/coreconf/config.gypi --replace "/usr/bin/grep" "grep"
  '';
