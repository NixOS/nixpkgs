{ fetchFromGitHub, lib, stdenv, pkg-config, autoreconfHook, acl, attr, bzip2
, e2fsprogs, libxml2, lzo, openssl, sharutils, xz, zlib, zstd,
...
stdenv.mkDerivation rec {
  ...
  buildInputs = lib.optional stdenv.hostPlatform.isUnix sharutils
  ...
  meta = {
    ...
    changelog =
      "https://github.com/libarchive/libarchive/releases/tag/v${version}";
