{ lib, stdenv, fetchurl, fetchpatch, substituteAll, pkg-config, glib, shadow
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ dbus gettext gobject-introspection meson ninja pkg-config python3 ];
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://gitlab.freedesktop.org/accountsservice/accountsservice/-/merge_requests/58.patch";
    ...
    (fetchpatch {
      url =
        "https://gitlab.freedesktop.org/accountsservice/accountsservice/commit/ced73d0fcbd2a54085a660d260482fc70d79bd5c.patch";
