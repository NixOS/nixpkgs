{ stdenv, lib, fetchFromGitHub, fetchpatch, autoreconfHook, pkg-config, libxml2
, xdg-desktop-portal, gtk3, gnome, glib, wrapGAppsHook
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/flatpak/xdg-desktop-portal-gtk/commit/e34f49ca8365801a7fcacccb46ab1e62aec17435.patch";
      sha256 = "umMsSP0fuSQgxlHLaZlg25ln1aAL1mssWzPMIWAOUt4=";
    })
    (fetchpatch {
      url =
        "https://github.com/flatpak/xdg-desktop-portal-gtk/commit/19c5385b9f5fe0f8dac8ae7cc4493bb08f802de6.patch";
