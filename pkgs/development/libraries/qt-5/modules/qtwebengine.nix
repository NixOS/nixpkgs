...
qtModule {
  ...
  nativeBuildInputs = [
    bison flex git gperf ninja pkg-config python pkg-config-wrapped-without-prefix which gn nodejs perl
  ...
  '' + lib.optionalString (stdenv.hostPlatform != stdenv.buildPlatform) ''
    export PKG_CONFIG_EXECUTABLE='${buildPackages.pkg-config}/bin/${buildPackages.pkg-config.targetPrefix}pkg-config'
  '';
