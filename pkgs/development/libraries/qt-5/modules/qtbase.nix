...
# darwin support
, libiconv, libobjc, xcbuild, AGL, AppKit, ApplicationServices, Carbon, Cocoa
, CoreAudio, CoreBluetooth, CoreLocation, CoreServices, DiskArbitration
, Foundation, OpenGL, MetalKit, IOKit
...
, cups ? null, libmysqlclient ? null, postgresql ? null, withGtk3 ? false
, dconf ? null, gtk3 ? null

  # options
, libGLSupported ? !stdenv.isDarwin, libGL, buildExamples ? false
, buildTests ? false, debug ? false, developerBuild ? false
...
in stdenv.mkDerivation {
  ...
  NIX_CFLAGS_COMPILE = toString ([
    ...
    ++ lib.optional stdenv.isLinux "-DUSE_X11" ++ lib.optionals withGtk3 [
      ''
