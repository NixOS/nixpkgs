  ...
  patches = {
    qtbase = [
      ...
      (fetchpatch {
        ...
        url =
          "https://codereview.qt-project.org/gitweb?p=qt/qtbase.git;a=patch;h=c5d904639dbd690a36306e2b455610029704d821";
    ...
    qtwebengine = [
      ...
      (fetchpatch {
        ...
        url =
          "https://raw.githubusercontent.com/archlinux/svntogit-packages/fc77d6b3d5ec74e421b58f199efceb2593cbf951/trunk/qtbug-77037-workaround.patch";
