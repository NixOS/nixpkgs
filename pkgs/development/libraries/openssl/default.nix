{ lib, stdenv, fetchurl, buildPackages, perl, coreutils, withCryptodev ? false
, cryptodev, enableSSL2 ? false, enableSSL3 ? false, static ?
  ...
  common =
    ...
    stdenv.mkDerivation rec {
      ...
      configureFlags = [
        ...
        ++ lib.optional enableSSL3 "enable-ssl3" ++ lib.optional
...
in {
  ...
  openssl_1_1 = common {
    ...
    ] ++ lib.optionals (stdenv.isDarwin) [ ./1.1/macos-yosemite-compat.patch ];
    withDocs = true;
  };
