...
let
  ...
  common =
    ...
    stdenv.mkDerivation (finalAttrs: {
      pname = "openssl";
      version =
        lib.warnIf (enableFIPS && !builtins.elem version fipsValidatedVersions)
          "openssl ${version} with enableFIPS=true: this version is not FIPS 140 validated. Validated versions: ${lib.concatStringsSep ", " fipsValidatedVersions}"
          version;
      ...
      installTargets = "install" + lib.optionalString enableFIPS " install_fips";
