{ stdenv, lib, fetchurl, fetchpatch, zlib, xz, libintl, python, gettext, ncurses
, findXMLCatalogs, libiconv
, pythonSupport ? enableShared && stdenv.buildPlatform == stdenv.hostPlatform
, icuSupport ? false, icu ? null, enableShared ? stdenv.hostPlatform.libc
  != "msvcrt" && !stdenv.hostPlatform.isStatic, enableStatic ? !enableShared }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://gitlab.gnome.org/GNOME/libxml2/commit/85b1792e37b131e7a51af98a37f92472e8de5f3f.patch";
  ...
  buildInputs = lib.optional pythonSupport python
    ...
    ++ lib.optional
    (stdenv.isDarwin && pythonSupport && python ? isPy2 && python.isPy2) libintl
  ...
  propagatedBuildInputs = [ zlib findXMLCatalogs ]
    ++ lib.optional stdenv.isDarwin libiconv ++ lib.optional icuSupport icu;
  ...
  preCheck = lib.optionalString
    (pythonSupport && !(python ? pythonOlder && python.pythonOlder "3.5")) ''
