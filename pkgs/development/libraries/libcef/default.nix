...
stdenv.mkDerivation (finalAttrs: {
  ...
  version = "138.0.48";
  gitRevision = "8bf7dad";
  chromiumVersion = "138.0.7204.255";
  buildType = "Release";

  srcHash = selectSystem {
    aarch64-linux = "sha256-k7X2xZdiO0YV1/btQVWCumOaE70TDsEKanye2IkNzAA=";
    x86_64-linux = "sha256-+GsOmYg8m9TLRcfHPqsBNR5qdBomc/2MSXOjzMbIpi0=";
  };
