...
stdenv.mkDerivation (finalAttrs: {
  ...
  version = "138.0.41";
  gitRevision = "b70914d";
  chromiumVersion = "138.0.7204.221";
  buildType = "Release";

  srcHash = selectSystem {
    aarch64-linux = "sha256-uPhHCyYH021iRKftVm9tPGShTRQWnIbjVg14EqcuPGI=";
    x86_64-linux = "sha256-oUeebUiXuXF0aw+4HwrYuXAJr4G7C/jmqx44vBMkswA=";
  };
