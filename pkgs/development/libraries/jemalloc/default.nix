...
stdenv.mkDerivation rec {
  ...
  configureFlags =
    ...
    # depending on avx2 is just a guess, setting -march=skylake triggered the following assertion:
    # src/psset.c:122: Failed assertion: "pind < PSSET_NPSIZES"
    ++ lib.optional (stdenv.isAarch64 || stdenv.hostPlatform.avx2Support) "--with-lg-page=16"
