{stdenv, fetchurl} : {
  ...
  gnomeicontheme = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gnome-icon-theme-2.8.0.tar.bz2;
  ...
  gnomekeyring = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gnome-keyring-0.4.1.tar.bz2;
  ...
  gtkhtml = {
    name = "gtkhtml-3.2.5";
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gtkhtml-3.2.5.tar.bz2;
  ...
  gtksourceview = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gtksourceview-1.1.1.tar.bz2;
  ...
  scrollkeeper = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/scrollkeeper-0.3.14.tar.gz;
  ...
  gnomedesktop = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gnome-desktop-2.8.3.tar.bz2;
  ...
  libwnck = {
    name = "libwnck-2.8.1";
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/libwnck-2.8.1.tar.bz2;
  ...
  gnomepanel = {
    ...
    src = fetchurl {
      url = http://nix.cs.uu.nl/dist/tarballs/gnome-panel-2.8.3.tar.bz2;
