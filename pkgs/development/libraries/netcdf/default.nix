{ lib, stdenv, fetchpatch, fetchurl, hdf5, m4, curl # for DAP
, removeReferencesTo }:
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.unidata.ucar.edu/downloads/netcdf/ftp/${pname}-c-${version}.tar.gz";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/Unidata/netcdf-c/commit/9fc8ae62a8564e095ff17f4612874581db0e4db5.patch";
