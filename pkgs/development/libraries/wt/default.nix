...
, pango, fcgi, firebird-client-lib, libmysqlclient, postgresql, graphicsmagick, glew, openssl
, pcre, harfbuzz, icu
}:
  ...
  generic =
    ...
    stdenv.mkDerivation {
      ...
      buildInputs = [
        ...
        pango fcgi firebird-client-lib libmysqlclient postgresql graphicsmagick glew
