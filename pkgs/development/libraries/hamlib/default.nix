...
, pythonBindings ? true, tclBindings ? true
, perlBindings ? stdenv.buildPlatform == stdenv.hostPlatform, buildPackages }:
...
stdenv.mkDerivation rec {
  ...
  configureFlags = [ "CC_FOR_BUILD=${stdenv.cc.targetPrefix}cc" ]
