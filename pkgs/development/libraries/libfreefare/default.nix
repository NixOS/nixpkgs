{ lib, stdenv, fetchurl, pkg-config, libnfc, openssl, libobjc ? null }:
...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url =
      "https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/libfreefare/libfreefare-0.4.0.tar.bz2";
