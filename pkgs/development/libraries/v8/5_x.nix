...
stdenv.mkDerivation rec {
  ...
  NIX_CFLAGS_COMPILE = "-Wno-error=strict-overflow -Wno-error=unused-function -Wno-error=attributes" + stdenv.lib.optionalString stdenv.cc.isClang " -Wno-error=unused-lambda-capture";
