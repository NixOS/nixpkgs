{ stdenv, lib, fetchgit, fetchFromGitHub, gn, ninja, python, pythonPackages
, glib, pkg-config, icu, xcbuild, darwin, fetchpatch }:
...
in stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/saiarcot895/chromium-ubuntu-build/663dbfc492fd2f8ba28d9af40fb3b1327e6aa56e/debian/patches/revert-Xclang-instcombine-lower-dbg-declare.patch";
