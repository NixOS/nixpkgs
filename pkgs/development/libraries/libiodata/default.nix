...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    # Remove when https://github.com/sailfishos/libiodata/pull/6 merged & in release
    (fetchpatch {
      name = "0001-libiodata-Fix-dependencies-between-sub-projects.patch";
      url = "https://github.com/sailfishos/libiodata/commit/b91ec8171a4afb53ad7bab392c6bdfbc9dd0f695.patch";
