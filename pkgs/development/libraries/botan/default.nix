{
  ...
  with_nist_policy ? false,
}:

assert (!with_bsi_policy && !with_nist_policy) || (with_bsi_policy != with_nist_policy);
  ...
  common =
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      botanConfigureFlags =
        ...
        ++ lib.optionals (lib.versionAtLeast version "3.7.0" && with_bsi_policy) [
          "--module-policy=bsi"
          "--enable-module=ffi"
          "--enable-module=shake"
        ]
        ++ lib.optionals (lib.versionAtLeast version "3.7.0" && with_nist_policy) [
          "--module-policy=nist"
        ];
      ...
      doCheck = !with_tpm2 && !with_bsi_policy;
