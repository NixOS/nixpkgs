{ lib, stdenv, fetchFromGitLab, meson, ninja, hwdata, cmake, pkg-config, wayland-scanner
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitLab {
    ...
    repo = "wlroots";
    rev = version;
    sha256 = "k7BFx1xvvsdCXNWX0XeZYwv8H/myk4p42i2Y6vjILqM=";
  };
  ...
  nativeBuildInputs = [ meson ninja pkg-config wayland-scanner glslang cmake hwdata ];
