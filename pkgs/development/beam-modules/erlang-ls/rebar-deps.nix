  ...
  packages = with self; {
    ...
    quickrand = builder {
      ...
      src = fetchHex {
        pkg = "quickrand";
        version = "2.0.7";
        hash = "sha256-uKy/iaIkvCF8MHDKi+vG6yNtvn+XZ5k7J0CE6gRNNfA=";
      };
      beamDeps = [ ];
    };
    providers = builder {
    ...
    katana_code = builder {
      ...
      src = fetchHex {
        pkg = "katana_code";
        version = "2.1.1";
        hash = "sha256-BoDzNSW5qILm9NMCJRixXEb2SL17Db6GkAmA/hwpFAQ=";
      };
      beamDeps = [ ];
    };
    bucs = builder {
    ...
    yamerl = builder {
      ...
      src = fetchFromGitHub {
        ...
        hash = "sha256-WsNdh9/emdekfBCA0aaIOP7ISSmu1EFI7byre8QmZL0=";
      };
      beamDeps = [ ];
    };
    uuid = builder {
    ...
    json_polyfill = builder {
      ...
      src = fetchHex {
        pkg = "json_polyfill";
        version = "0.1.4";
        hash = "sha256-SMOX7iVH+kWe3gGjDsDoVxer7TAQhnpj7qrF8gMnQwM=";
      };
      beamDeps = [ ];
    };
    jsx = builder {
      ...
      src = fetchHex {
        pkg = "jsx";
        version = "2.10.0";
        hash = "sha256-moPjcEgHKYAWlo21Bvn60PAn3jdUbrg4s64QZMOgrWI=";
      };
      beamDeps = [ ];
    };
    gradualizer = builder {
      ...
      src = fetchFromGitHub {
        ...
        hash = "sha256-AHhu1w/emDBJFEGmURldQ3LrXCEn0LkuAN6P1FNHThQ=";
      };
      beamDeps = [ ];
    };
    erlfmt = builder {
      ...
      src = fetchHex {
        pkg = "erlfmt";
        version = "1.5.0";
        hash = "sha256-OTOkDPvnkK2U5bZQs2iB3nBFYxkmPBR5tVbpr9vYDHU=";
      };
      beamDeps = [ ];
    };
    ephemeral = builder {
    ...
    elvis_core = builder {
      ...
      src = fetchHex {
        pkg = "elvis_core";
        version = "3.2.5";
        hash = "sha256-NNkhjwuAclEZA79sy/WesXZd7Pxz/MaDO6XIlZ2384M=";
      };
      beamDeps = [
        katana_code
        zipper
