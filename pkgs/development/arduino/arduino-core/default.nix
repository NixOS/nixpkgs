...
if withTeensyduino && (stdenv.hostPlatform.system != "x86_64-linux") then throw
  ...
  let
    ...
    teensy_architecture =
      lib.optionalString (stdenv.hostPlatform.system == "x86_64-linux") "linux64" + lib.optionalString (stdenv.hostPlatform.system == "i686-linux") "linux32" + lib.optionalString (stdenv.hostPlatform.system == "arm-linux") "linuxarm";

    flavor = (if withTeensyduino then "teensyduino" else "arduino") + stdenv.lib.optionalString (!withGui) "-core";
  in
  stdenv.mkDerivation rec {
    ...
    teensyduino_src = fetchurl {
      ...
      sha256 =
        lib.optionalString (teensy_architecture == "linux64")
          "09ysanip5d2f5axzd81z2l74ayng60zqhjxmxs7xa5098fff46il" + lib.optionalString (teensy_architecture == "linux32")
          "1zw3cfv2p62dwg8838vh0gd1934b18cyx7c13azvwmrpj601l0xx" + lib.optionalString (teensy_architecture == "linuxarm")
    ...
    arduino_dist_src = fetchurl {
      ...
      sha256 =
        lib.optionalString (teensy_architecture == "linux64")
          "1lv4in9j0r8s0cis4zdvbk2637vlj12w69wdxgcxcrwvkcdahkpa" + lib.optionalString (teensy_architecture == "linux32")
          "0zla3a6gd9prclgrbbgsmhf8ds8zb221m65x21pvz0y1cwsdvjpm" + lib.optionalString (teensy_architecture == "linuxarm")
