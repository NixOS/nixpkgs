...
let
  ocamlPackages = coq.ocamlPackages.overrideScope' (self: super: {
    ppxlib = super.ppxlib.override { version = "0.15.0"; };
    # the following does not work
    ppx_sexp_conv = super.ppx_sexp_conv.overrideAttrs (_: {
      src = fetchzip {
        url =
          "https://github.com/janestreet/ppx_sexp_conv/archive/v0.14.1.tar.gz";
  ...
  release = {
    "8.14+rc1+0.14.0".sha256 =
      "1w7d7anvcfx8vz51mnrf1jkw6rlpzjkjlr06avf58wlhymww7pja";
...
in (with lib;
  mkCoqDerivation rec {
    ...
    in {
      src = fetchzip {
        url = if version == "8.14+rc1+0.14.0" then
          "https://github.com/ejgallego/coq-serapi/archive/refs/tags/8.14+rc1+0.14.0.tar.gz"
        else
