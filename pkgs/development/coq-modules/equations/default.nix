...
(mkCoqDerivation {
  ...
  release."1.2+coq8.8".hash = "sha256:06452fyzalz7zcjjp73qb7d6xvmqb6skljkivf8pfm55fsc8s7kx";
  release."1.2.1+coq8.9".version = "1.2.1";
  release."1.2.1+coq8.9".rev = "v1.2.1-8.9";
  release."1.2.1+coq8.9".hash = "sha256:0d8ddj6nc6p0k25cd8fs17cq427zhzbc3v9pk2wd2fnvk70nlfij";
  release."1.2.1+coq8.10-2".version = "1.2.1";
  release."1.2.1+coq8.10-2".rev = "v1.2.1-8.10-2";
  release."1.2.1+coq8.10-2".hash = "sha256:0j3z4l5nrbyi9zbbyqkc6kassjanwld2188mwmrbqspaypm2ys68";
  release."1.2.3+coq8.11".version = "1.2.3";
  release."1.2.3+coq8.11".rev = "v1.2.3-8.11";
  release."1.2.3+coq8.11".hash = "sha256:1srxz1rws8jsh7402g2x2vcqgjbbsr64dxxj5d2zs48pmhb20csf";
  ...
  release."1.2.4+coq8.11".hash = "sha256:01fihyav8jbjinycgjc16adpa0zy5hcav5mlkf4s9zvqxka21i52";
  ...
  release."1.3+8.14".hash = "sha256:19bj9nncd1r9g4273h5qx35gs3i4bw5z9bhjni24b413hyj55hkv";
