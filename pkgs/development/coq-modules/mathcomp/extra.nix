...
let
  ...
  packageGen =
    ...
    let
      theCompatibleCoqVersions =
        if compatibleCoqVersions == null
  ...
  all = (for-version "1.7.0" "1_7") //
    ...
    (recurseIntoAttrs (mapDerivationAttrset dontDistribute (
      mapAttrs'
        (n: pkg: { name = "mathcomp-${n}"; value = (packageGen pkg).${n}; })
