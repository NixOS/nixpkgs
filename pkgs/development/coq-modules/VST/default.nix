    ...
    lib.optionalString
      ...
      ''
        substituteInPlace Makefile \
          --replace-fail 'COQVERSION= ' 'COQVERSION= 9.1.0 or-else 9.0.1 or-else 8.20.1 or-else 8.19.2 or-else 8.17.1 or-else 8.16.1 or-else 8.16.0 or-else 8.15.2 or-else 8.15.1 or-else '\
