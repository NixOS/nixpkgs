...
mkCoqDerivation {
  ...
  defaultVersion = with lib.versions; lib.switch [coq.coq-version ssreflect.version] [
    { case = [(range "8.17" "8.18") (isGe "2.0.0")] ; out = "0.2.0"; }
    { case = [(range "8.11" "8.18") (isLe "2.0.0")] ; out = "0.1.1"; }
  ] null;

  releaseRev = v: "v${v}";

  release."0.2.0".sha256 = "sha256-t+4WMwzXvr/yxJ4jM9Ie9Mfv6yrKeJGgg4ltIxUOMLg=";
