...
class TestCasePython(unittest.TestCase):
    ...
    @unittest.skipIf(IS_NIXENV and IS_VENV, "Unsupported: Import from site-package does not work in nixenv-venv.")
    @unittest.skipIf(IS_NIXENV and IS_VIRTUALENV, "Unsupported: Import from site-package does not work in nixenv-virtualenv.")
