...
, toPythonModule, namePrefix, update-python-libraries, setuptools, flitBuildHook
, pipBuildHook, pipInstallHook, pythonCatchConflictsHook, pythonImportsCheckHook
, pythonNamespacesHook, pythonRemoveBinBytecodeHook, pythonRemoveTestsDirHook
...
if disabled then
  ...
  let
    ...
    self = toPythonModule (stdenv.mkDerivation ((builtins.removeAttrs attrs [
      ...
      ] ++ lib.optionals catchConflicts [ setuptools pythonCatchConflictsHook ]
