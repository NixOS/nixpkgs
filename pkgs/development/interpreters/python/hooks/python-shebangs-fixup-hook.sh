...
# Many python packages have shell scripts which end up using the host python interpreter.
# This shell hook goes through the outputs and changes it from the host python interpreter to the target.
