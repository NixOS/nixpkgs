...
stdenv.mkDerivation (finalAttrs: rec {
  ...
  src =
    {
      aarch64-darwin = fetchurl {
        url = "https://download.racket-lang.org/releases/${version}/installers/racket-${version}-aarch64-macosx-cs.dmg";
        sha256 = "a15727e5eb8da18d81839c9f552e388217d49917a86298a83c9d280b249de8f7";
      };
      x86_64-darwin = fetchurl {
        url = "https://download.racket-lang.org/releases/${version}/installers/racket-${version}-x86_64-macosx-cs.dmg";
  ...
  buildPhase = ''
    ...
    cp -r "Racket v${version}/"*.app "$out/Applications"
    cp -r "Racket v${version}/"{bin,collects,doc,etc,include,lib,man,share} $out
