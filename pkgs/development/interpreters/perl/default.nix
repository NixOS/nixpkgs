{ config, lib, stdenv, fetchurl, fetchpatch, fetchFromGitHub, pkgs
, buildPackages, callPackage, enableThreading ? true, coreutils, makeWrapper }:
...
let
  ...
  common = { perl, buildPerl, version, sha256 }:
    stdenv.mkDerivation (rec {
      ...
      outputs = [ "out" "man" "devdoc" ] ++ optional crossCompiling "mini";
      ...
      patches = [
        ...
        ++ optionals crossCompiling [
          ...
          (fetchpatch {
            url =
              "https://github.com/arsv/perl-cross/commit/3c318ae6572f8b36cb077c8b49c851e2f5fe181e.patch";
      ...
      configureScript =
        optionalString (!crossCompiling) "${stdenv.shell} ./Configure";
