addPerlLibPath () {
    appendToSearchPath PERL5LIB $1/lib/perl5/site_perl/@version@
    appendToSearchPath PERL5LIB $1/lib/perl5/site_perl/cross_perl/@version@
    ...
    appendToSearchPath PERL5LIB $1/lib/perl5/site_perl/@version@/@runtimeArch@
}
