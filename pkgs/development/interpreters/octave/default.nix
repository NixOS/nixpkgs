...
, libsndfile, portaudio, libX11, graphicsmagick, pcre, pkg-config, libGL, libGLU
, fltk
# Both are needed for discrete Fourier transform
, fftw, fftwSinglePrec, zlib, curl, blas, lapack
...
, qscintilla ? null, qttools ? null
  # - JIT compiler for loops:
, enableJIT ? false, llvm ? null, libiconv, darwin }:
