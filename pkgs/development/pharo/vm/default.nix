{ stdenv, fetchurl, cmake, bash, unzip, glibc, libssl, gcc, mesa, freetype, xorg, alsaLib, cairo }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ bash unzip cmake glibc libssl gcc mesa freetype xorg.libX11 xorg.libICE xorg.libSM alsaLib cairo ];
