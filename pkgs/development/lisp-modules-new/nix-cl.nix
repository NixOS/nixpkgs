...
let
  ...
  mkLisp = {
    ...
    args = { inherit pkg program flags loadFlags evalFlags faslExt asdf; };
    in pkg // {
      pkgs = lispPackagesFor args;
      withPackages = lispWithPackages args;
      build-asdf-system = body: build-asdf-system (body // args);
    };
