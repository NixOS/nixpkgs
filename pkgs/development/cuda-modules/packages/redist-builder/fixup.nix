...
in
{
  ...
  meta = prevAttrs.meta or { } // {
    ...
    downloadPage = "https://developer.download.nvidia.com/compute/${redistBuilderArg.redistName}/redist/${redistBuilderArg.packageName}";
    # NOTE:
    ...
    license = [
      ...
      (
        licenses.nvidiaCudaRedist
        // {
          url = finalAttrs.meta.downloadPage + "/LICENSE.txt";
        }
      )
    ];
    teams = [ teams.cuda ];
