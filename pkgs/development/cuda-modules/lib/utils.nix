{ cudaLib, lib }:
{
  ...
  */
  ...
  /**
    ...
    ```
    _mkVersionedName :: (name :: String) -> (version :: Version) -> String
    ```
    ...
    :::{.example}
    ## `cudaLib.utils._mkVersionedName` usage examples

    ```nix
    _mkVersionedName "hello" "1.2.3"
    => "hello_1_2_3"
    ```

    ```nix
    _mkVersionedName "cudaPackages" "12.8"
    => "cudaPackages_12_8"
    ```
    :::
  */
