...
in
{
  options.cuda = {
    ...
    manifestMetas = options.mkOption {
      ...
      default = builtins.map cfg.utils.manifestPathToManifestMeta config.cuda.manifestPaths;
    ...
    manifests = options.mkOption {
      ...
      default = cfg.utils.manifestMetasToManifests config.cuda.manifestMetas;
