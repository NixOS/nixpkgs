...
in
{
  ...
  brokenConditions =
    let
      cudaTooOld = cudaOlder constraints.cuda.">=" or cudaMajorMinorVersion;
      cudaTooNew = strings.versionAtLeast constraints.cuda."<" or "" cudaMajorMinorVersion;
  ...
  passthru = prevAttrs.passthru or { } // {
    ...
    cudnn =
      let
        desiredName = mkVersionedPackageName "cudnn" constraints."cudnn".">=" or "";
      in
