...
in rec {
  ...
  # See: https://rocm.docs.amd.com/en/docs-6.0.2/_images/image.004.png
  # See: https://rocm.docs.amd.com/en/docs-6.0.2/deploy/linux/os-native/package_manager_integration.html
  meta = rec {
