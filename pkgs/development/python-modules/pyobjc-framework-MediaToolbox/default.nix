...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/MediaToolbox/__init__.py \
      --replace '/System/Library/Frameworks/MediaToolbox.framework' "${darwin.apple_sdk.frameworks.MediaToolbox}/Library/Frameworks/MediaToolbox.framework"
  '';
