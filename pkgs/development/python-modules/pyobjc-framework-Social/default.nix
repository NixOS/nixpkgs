...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/Social/__init__.py \
      --replace '/System/Library/Frameworks/Social.framework' "${darwin.apple_sdk.frameworks.Social}/Library/Frameworks/Social.framework"
  '';
