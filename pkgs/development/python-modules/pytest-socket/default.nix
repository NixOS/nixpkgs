{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch, poetry-core, pytest
, pythonOlder }:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/miketheman/pytest-socket/commit/32519170e656e731d24b81770a170333d3efa6a8.patch";
