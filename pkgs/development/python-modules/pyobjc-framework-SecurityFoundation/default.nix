...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SecurityFoundation/__init__.py \
      --replace '/System/Library/Frameworks/SecurityFoundation.framework' "${darwin.apple_sdk.frameworks.SecurityFoundation}/Library/Frameworks/SecurityFoundation.framework"
  '';
