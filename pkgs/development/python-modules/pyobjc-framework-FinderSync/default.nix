...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/FinderSync/__init__.py \
      --replace '/System/Library/Frameworks/FinderSync.framework' "${darwin.apple_sdk.frameworks.FinderSync}/Library/Frameworks/FinderSync.framework"
  '';
