...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "OpenUSD";
    tag = "v${version}";
    hash = "sha256-EF+fdM0xb9p6pjDpkVfDMPZbvqF9HeOtDu7EfWNEhIg=";
  };
  ...
  patches = [
    (fetchpatch {
      ...
      url = "https://github.com/PixarAnimationStudios/OpenUSD/commit/9ea3bc1ab550ec46c426dab04292d9667ccd2518.patch";
