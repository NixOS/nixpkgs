{ lib, arrow, buildPythonPackage, fetchPypi, importlib-metadata, isPy27, logfury
, pytestCheckHook, pytest-lazy-fixture, pytest-mock, pythonOlder, requests
, setuptools-scm, tqdm }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytestCheckHook pytest-lazy-fixture pytest-mock ];
