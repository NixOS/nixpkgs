...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/EventKit/__init__.py \
      --replace '/System/Library/Frameworks/EventKit.framework' "${darwin.apple_sdk.frameworks.EventKit}/Library/Frameworks/EventKit.framework"
  '';
