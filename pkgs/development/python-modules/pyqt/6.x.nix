...
buildPythonPackage rec {
  ...
  src = fetchurl {
    urls = [
      ...
      "https://web.archive.org/web/20241206152612if_/https://riverbankcomputing.com/pypi/packages/PyQt6/PyQt6-${version}.tar.gz"
    ];
    hash = "sha256-R6PHWBOunVnk997WNQq0P+X617/gAr+TdNSR7nSNRRA=";
  };
