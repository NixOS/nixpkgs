...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreMediaIO/__init__.py \
      --replace '/System/Library/Frameworks/CoreMediaIO.framework' "${darwin.apple_sdk.frameworks.CoreMediaIO}/Library/Frameworks/CoreMediaIO.framework"
  '';
  ...
  # pythonImportsCheck = [ "CoreMediaIO" ];
