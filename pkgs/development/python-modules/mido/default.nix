{ stdenv, lib, buildPythonPackage, fetchPypi, substituteAll, portmidi, pygame
, python-rtmidi, rtmidi-python, pytestCheckHook }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ pygame python-rtmidi rtmidi-python ];
