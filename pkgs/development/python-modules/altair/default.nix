...
, jinja2, jsonschema, numpy, pandas, pytest, pythonOlder, recommonmark, six
, sphinx, toolz, typing ? null, vega_datasets }:
...
buildPythonPackage rec {
  ...
  checkInputs =
    [ glibcLocales ipython pytest recommonmark sphinx vega_datasets ];
