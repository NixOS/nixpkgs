...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/GameController/__init__.py \
      --replace '/System/Library/Frameworks/GameController.framework' "${darwin.apple_sdk.frameworks.GameController}/Library/Frameworks/GameController.framework"
  '';
