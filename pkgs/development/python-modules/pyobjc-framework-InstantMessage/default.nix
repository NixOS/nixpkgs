...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/InstantMessage/__init__.py \
      --replace '/System/Library/Frameworks/InstantMessage.framework' "${darwin.apple_sdk.frameworks.InstantMessage}/Library/Frameworks/InstantMessage.framework"
  '';
  ...
  # pythonImportsCheck = [ "InstantMessage" ];
