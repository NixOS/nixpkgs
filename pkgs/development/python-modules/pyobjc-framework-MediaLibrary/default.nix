...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/MediaLibrary/__init__.py \
      --replace '/System/Library/Frameworks/MediaLibrary.framework' "${darwin.apple_sdk.frameworks.MediaLibrary}/Library/Frameworks/MediaLibrary.framework"
  '';
