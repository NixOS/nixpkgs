...
, requests-mock, pythonOlder, pytest-asyncio, pytestCheckHook, python-dateutil
, requests }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ requests-mock pytest-asyncio pytestCheckHook ];
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/cnico/flipr-api/commit/f14be1dfd4f46d4d43d9ea47e51cafca3cc18e86.patch";
