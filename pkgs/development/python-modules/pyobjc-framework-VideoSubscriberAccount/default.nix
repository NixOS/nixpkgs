...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/VideoSubscriberAccount/__init__.py \
      --replace '/System/Library/Frameworks/VideoSubscriberAccount.framework' "${darwin.apple_sdk.frameworks.VideoSubscriberAccount}/Library/Frameworks/VideoSubscriberAccount.framework"
  '';
  ...
  # pythonImportsCheck = [ "VideoSubscriberAccount" ];
