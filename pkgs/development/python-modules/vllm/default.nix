...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "vllm";
    tag = "v${version}";
    hash = "sha256-bPky3Y9aorvufxVYlu+wNPzC1GrQyuqorzo20Uw/Iq8=";
  };
  ...
  ++ lib.optionals cudaSupport [
    ...
    pynvml
    flashinfer
    # triton-kernels is pinned to triton v3.5.0 for mxfp4 fused MoE kernels
    # Should be updated when vLLM's requirements/cuda.txt changes
    # See: https://github.com/vllm-project/vllm/blob/v0.11.1rc3/requirements/cuda.txt
    triton-kernels
  ];
