...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/Vision/__init__.py \
      --replace '/System/Library/Frameworks/Vision.framework' "${darwin.apple_sdk.frameworks.Vision}/Library/Frameworks/Vision.framework"
  '';
