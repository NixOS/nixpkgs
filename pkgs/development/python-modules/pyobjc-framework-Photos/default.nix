...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace setup.py \
      --replace 'extra_link_args=["-framework", "Photos"]' 'extra_link_args=[]'
    # Import Nix Framework instead of system one
    substituteInPlace Lib/Photos/__init__.py \
      --replace '/System/Library/Frameworks/Photos.framework' "${darwin.apple_sdk.frameworks.Photos}/Library/Frameworks/Photos.framework"
  '';
