...
let
  pnpm_10' = pnpm_10.override { nodejs = nodejs_24; };
  pnpm_10_fetchDeps = pnpm_10'.fetchDeps.override { pnpm = pnpm_10'; };
  pnpm_10_configHook = pnpm_10'.configHook.override { pnpm = pnpm_10'; };
in
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "gradio";
    tag = "gradio@${version}";
    hash = "sha256-MBgiPTTJTQrLIRhmVvULpqhKSXbIKQMoHkVDPyZTMhI=";
  };

  pnpmDeps = pnpm_10_fetchDeps {
    inherit pname version src;
    fetcherVersion = 2;
    hash = "sha256-RGLCgeQKe8qj2yzuJ5MPBsOQtW9b2i293P2MRvrqefM=";
  };
