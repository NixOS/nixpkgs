...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/StoreKit/__init__.py \
      --replace '/System/Library/Frameworks/StoreKit.framework' "${darwin.apple_sdk.frameworks.StoreKit}/Library/Frameworks/StoreKit.framework"
  '';
