...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/Network/__init__.py \
      --replace '/System/Library/Frameworks/Network.framework' "${darwin.apple_sdk.frameworks.Network}/Library/Frameworks/Network.framework"
  '';
