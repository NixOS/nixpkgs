...
assert mklSupport -> mkl != null; let
  ...
  _bazel-build = (buildBazelPackage.override (lib.optionalAttrs stdenv.isDarwin {
    ...
    fetchAttrs = {
      ...
      sha256 =
        if cudaSupport
        then "sha256-+szc2mRoImwijzbj3nw6HmZp3DeRjjPRU5yC+5AEbkg="
        else if stdenv.isDarwin
        then "sha256-+bwIzp6t7gRJPcI8B5oyuf9z0AjCAyggUR7x+vv5kFs="
        else "sha256-5yOYmeGpJq4Chi55H7iblxyRXVktgnePtpYTPvBs538=";
    };
