      ...
      sha256 =
        {
          x86_64-linux =
            if cudaSupport then
              "sha256-VTU1d6CLaIFcsPcQdsTsLHoiAVvd8feZdNC74IrMmSc="
            else
              "sha256-FmLhZsDZGpJBrwpqRdIMHGdWMdA2COIvD7f3hck514Y=";
          aarch64-linux =
            if cudaSupport then
              "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="
            else
              "sha256-GQdGaLjZVEsudmCc6lwGpEv/vY3LvAqSu7bqq9ZlSOI=";
