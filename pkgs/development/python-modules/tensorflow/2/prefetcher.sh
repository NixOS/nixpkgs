...
url_and_key_list=(
  ...
  "linux_py_38_gpu https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow_gpu-${version}-cp38-cp38-manylinux2010_x86_64.whl"
  "linux_py_38_cpu https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow_cpu-${version}-cp38-cp38-manylinux2010_x86_64.whl"
  ...
  "mac_py_38_cpu https://storage.googleapis.com/tensorflow/mac/cpu/tensorflow-${version}-cp38-cp38-macosx_10_14_x86_64.whl"
)
