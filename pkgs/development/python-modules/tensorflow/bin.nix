...
, astor, gast, google-pasta, wrapt, numpy, six, termcolor, protobuf, absl-py
, grpcio, mock, scipy, wheel, opt-einsum, backports_weakref
, tensorflow-estimator, tensorflow-tensorboard, cudaSupport ? false, cudatoolkit
, cudnn, patchelfUnstable, zlib, python, keras-applications, keras-preprocessing
, addOpenGLRunpath, astunparse, flatbuffers, h5py, typing-extensions }:
...
let packages = import ./binary-hashes.nix;
