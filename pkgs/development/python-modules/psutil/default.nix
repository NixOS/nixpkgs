{ lib, stdenv, buildPythonPackage, fetchPypi, isPy27, python, darwin
, pytestCheckHook, mock, ipaddress, unittest2 }:
...
buildPythonPackage rec {
  ...
  disabledTests =
    [ "user" "disk_io_counters" "sensors_battery" "cpu_times" "cpu_freq" ];
