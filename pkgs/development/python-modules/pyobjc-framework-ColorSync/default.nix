...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ColorSync/__init__.py \
      --replace '/System/Library/Frameworks/ColorSync.framework' "${darwin.apple_sdk.frameworks.ColorSync}/Library/Frameworks/ColorSync.framework"
  '';
