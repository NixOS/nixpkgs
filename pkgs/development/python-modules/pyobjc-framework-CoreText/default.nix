...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreText/__init__.py \
      --replace '/System/Library/Frameworks/CoreText.framework' "${darwin.apple_sdk.frameworks.CoreText}/Library/Frameworks/CoreText.framework"
  '';
