...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      name = "update-attrs.patch";
      url = "https://github.com/python-attrs/cattrs/commit/290d162a589acf10ea63b825b7b283e23ca7698a.patch";
      hash = "sha256-n6c3qVg9umGKAxeTALq3QTJgO9DIj3SY0ZHhtsDeW94=";
      includes = ["tests/test_validation.py"];
    })
  ];
