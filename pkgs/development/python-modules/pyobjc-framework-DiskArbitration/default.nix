...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/DiskArbitration/__init__.py \
      --replace '/System/Library/Frameworks/DiskArbitration.framework' "${darwin.apple_sdk.frameworks.DiskArbitration}/Library/Frameworks/DiskArbitration.framework"
  '';
