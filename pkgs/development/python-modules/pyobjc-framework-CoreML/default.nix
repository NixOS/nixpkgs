...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreML/__init__.py \
      --replace '/System/Library/Frameworks/CoreML.framework' "${darwin.apple_sdk.frameworks.CoreML}/Library/Frameworks/CoreML.framework"
  '';
