...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "firedrake";
    tag = version;
    hash = "sha256-mezo1YTTuKLxC5zgBTsl4JF+//ymu6/KTwirJ2MQF1A=";
  };
  ...
  postPatch =
    ...
    ''
    +
    # https://github.com/firedrakeproject/firedrake/pull/4624
    ''
      substituteInPlace tests/firedrake/regression/test_locate_cell.py \
        --replace-fail '[0.25, 0.605]' '[0.25, 0.605], cell_ignore=3'
    '';
