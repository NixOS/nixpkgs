{ lib, buildPythonPackage, fetchPypi, curtsies, greenlet, jedi, pygments, pyxdg
, requests, substituteAll, urwid, watchdog, which }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ curtsies greenlet pygments pyxdg requests urwid ];
