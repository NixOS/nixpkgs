...
buildPythonPackage {
  ...
  postPatch =
    ...
    + lib.optionalString stdenv.hostPlatform.isAarch64 ''
      # Broken test on aarch64. Since unittest doesn't support disabling
      # a single test, and pytest isn't compatible, we patch the test
  ...
  nativeCheckInputs =
    ...
    ++ lib.optionals (!paddlepaddle.disabled) [
