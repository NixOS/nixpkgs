...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/FileProviderUI/__init__.py \
      --replace '/System/Library/Frameworks/FileProviderUI.framework' "${darwin.apple_sdk.frameworks.FileProviderUI}/Library/Frameworks/FileProviderUI.framework"
  '';
  ...
  # pythonImportsCheck = [ "FileProviderUI" ];
