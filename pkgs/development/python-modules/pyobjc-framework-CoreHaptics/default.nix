...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreHaptics/__init__.py \
      --replace '/System/Library/Frameworks/CoreHaptics.framework' "${darwin.apple_sdk.frameworks.CoreHaptics}/Library/Frameworks/CoreHaptics.framework"
  '';
  ...
  # pythonImportsCheck = [ "CoreHaptics" ];
