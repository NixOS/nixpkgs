...
buildPythonPackage rec {
  ...
  src = fetchgit {
    url = "https://git.fmrib.ox.ac.uk/fsl/fslpy.git";
    rev = version;
    hash = "sha256-D7yiZIP4uUzAf7s8YULZnU3Ms8LGwvhsxdiqtnuZLwA=";
  };

  postPatch = ''
    substituteInPlace pyproject.toml --replace-fail "--cov=fsl" ""
  '';
