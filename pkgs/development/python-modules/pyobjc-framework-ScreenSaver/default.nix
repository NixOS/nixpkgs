...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ScreenSaver/__init__.py \
      --replace '/System/Library/Frameworks/ScreenSaver.framework' "${darwin.apple_sdk.frameworks.ScreenSaver}/Library/Frameworks/ScreenSaver.framework"
  '';
