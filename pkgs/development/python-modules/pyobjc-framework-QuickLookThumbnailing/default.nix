...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/QuickLookThumbnailing/__init__.py \
      --replace '/System/Library/Frameworks/QuickLookThumbnailing.framework' "${darwin.apple_sdk.frameworks.QuickLookThumbnailing}/Library/Frameworks/QuickLookThumbnailing.framework"
  '';
  ...
  # pythonImportsCheck = [ "QuickLookThumbnailing" ];
