{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch, antlr4-python3-runtime
, igraph, pygments }:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/SkyTemple/ExplorerScript/commit/47d8b3d246881d675a82b4049b87ed7d9a0e1b15.patch";
