...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/VideoToolbox/__init__.py \
      --replace '/System/Library/Frameworks/VideoToolbox.framework' "${darwin.apple_sdk.frameworks.VideoToolbox}/Library/Frameworks/VideoToolbox.framework"
  '';
  ...
  # pythonImportsCheck = [ "VideoToolbox" ];
