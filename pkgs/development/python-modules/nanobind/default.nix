{ lib, buildPythonPackage, pythonOlder, fetchFromGitHub, cmake, eigen, ninja
, scikit-build, pytestCheckHook, numpy, scipy, torch, jax, jaxlib, tensorflow
, setuptools }:
buildPythonPackage rec {
  ...
  nativeBuildInputs = [ cmake ninja scikit-build setuptools ];
  buildInputs = [ eigen ];
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/wjakob/nanobind/blob/${src.rev}/docs/changelog.rst";
