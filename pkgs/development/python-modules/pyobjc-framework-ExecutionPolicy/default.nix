...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ExecutionPolicy/__init__.py \
      --replace '/System/Library/Frameworks/ExecutionPolicy.framework' "${darwin.apple_sdk.frameworks.ExecutionPolicy}/Library/Frameworks/ExecutionPolicy.framework"
  '';
  ...
  # pythonImportsCheck = [ "ExecutionPolicy" ];
