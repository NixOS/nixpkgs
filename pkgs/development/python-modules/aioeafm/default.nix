{ lib, aiohttp, buildPythonPackage, fetchFromGitHub, poetry, pytest-aiohttp
, pytest-asyncio, pytest-cov, pytestCheckHook }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytest-aiohttp pytest-asyncio pytest-cov pytestCheckHook ];
