...
buildPythonPackage rec {
  ...
  # https://github.com/jupyterlab/jupyterlab-server/blob/v2.15.2/pyproject.toml#L61
  doCheck = false;
  ...
  meta = with lib; {
    ...
    changelog = "https://github.com/jupyterlab/jupyterlab-server/blob/v${version}/CHANGELOG.md";
