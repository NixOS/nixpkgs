...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/MediaAccessibility/__init__.py \
      --replace '/System/Library/Frameworks/MediaAccessibility.framework' "${darwin.apple_sdk.frameworks.MediaAccessibility}/Library/Frameworks/MediaAccessibility.framework"
  '';
