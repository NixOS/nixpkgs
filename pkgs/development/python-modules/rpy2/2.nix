...
, rWrapper, rPackages, pcre, xz, bzip2, zlib, icu, singledispatch, six, jinja2
...
buildPythonPackage rec {
  ...
  buildInputs = [ readline R pcre xz bzip2 zlib icu ] ++ (with rPackages; [
  ...
  postPatch = ''
    ...
    } --replace '@NIX_R_LIBS_SITE@' "$R_LIBS_SITE"
  '';
