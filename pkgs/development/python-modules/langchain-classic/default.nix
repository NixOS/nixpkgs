...
buildPythonPackage rec {
  ...
  disabledTests = [
    ...
    "test_person"
    "test_aliases_hidden"
    # ImportError: OpenAI is required for FlareChain. Please install langchain-openai.pip install langchain-openai
    "test_from_llm_rejects_non_chatopenai"
  ];
  ...
  meta = {
    description = "Langchain release compatible with older packages";
