...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SoundAnalysis/__init__.py \
      --replace '/System/Library/Frameworks/SoundAnalysis.framework' "${darwin.apple_sdk.frameworks.SoundAnalysis}/Library/Frameworks/SoundAnalysis.framework"
  '';
  ...
  # pythonImportsCheck = [ "SoundAnalysis" ];
