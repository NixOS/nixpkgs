...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/DiscRecording/__init__.py \
      --replace '/System/Library/Frameworks/DiscRecording.framework' "${darwin.apple_sdk.frameworks.DiscRecording}/Library/Frameworks/DiscRecording.framework"
  '';
