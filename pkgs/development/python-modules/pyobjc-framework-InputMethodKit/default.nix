...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/InputMethodKit/__init__.py \
      --replace '/System/Library/Frameworks/InputMethodKit.framework' "${darwin.apple_sdk.frameworks.InputMethodKit}/Library/Frameworks/InputMethodKit.framework"
  '';
