...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/Speech/__init__.py \
      --replace '/System/Library/Frameworks/Speech.framework' "${darwin.apple_sdk.frameworks.Speech}/Library/Frameworks/Speech.framework"
  '';
