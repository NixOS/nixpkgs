...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/OSLog/__init__.py \
      --replace '/System/Library/Frameworks/OSLog.framework' "${darwin.apple_sdk.frameworks.OSLog}/Library/Frameworks/OSLog.framework"
  '';
