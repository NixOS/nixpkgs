...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ExceptionHandling/__init__.py \
      --replace '/System/Library/Frameworks/ExceptionHandling.framework' "${darwin.apple_sdk.frameworks.ExceptionHandling}/Library/Frameworks/ExceptionHandling.framework"
  '';
  ...
  # pythonImportsCheck = [ "ExceptionHandling" ];
