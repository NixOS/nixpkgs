{ lib, buildPythonPackage, fetchFromGitHub, pythonOlder, factory_boy, faker
, numpy, importlib-metadata, pytestCheckHook, pytest-xdist }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytestCheckHook pytest-xdist numpy factory_boy faker ];
