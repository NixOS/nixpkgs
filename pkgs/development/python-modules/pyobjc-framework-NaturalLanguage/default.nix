...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/NaturalLanguage/__init__.py \
      --replace '/System/Library/Frameworks/NaturalLanguage.framework' "${darwin.apple_sdk.frameworks.NaturalLanguage}/Library/Frameworks/NaturalLanguage.framework"
  '';
