...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreAudio/__init__.py \
      --replace '/System/Library/Frameworks/CoreAudio.framework' "${darwin.apple_sdk.frameworks.CoreAudio}/Library/Frameworks/CoreAudio.framework"
  '';
