...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/UserNotifications/__init__.py \
      --replace '/System/Library/Frameworks/UserNotifications.framework' "${darwin.apple_sdk.frameworks.UserNotifications}/Library/Frameworks/UserNotifications.framework"
  '';
  ...
  # pythonImportsCheck = [ "UserNotifications" ];
