...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "numba";
    repo = "numba";
    rev = "b8db41c873640fabdcebeb241b98556b693ef02b";
    ...
    postFetch = ''
      sed -i 's/git_refnames = "[^"]*"/git_refnames = " (tag: 0.62.0-rc1)"/' $out/numba/_version.py
    '';
    hash = "sha256-nPIwsUgVg10RNRSNE8oxGTjb/gkVfuPbI+CVfxtIVls=";
  };
