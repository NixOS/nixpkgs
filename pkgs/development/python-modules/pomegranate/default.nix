{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch, numpy, scipy, cython
, networkx, joblib, pandas, nose, pyyaml }:
...
buildPythonPackage rec {
  ...
  patches = lib.optionals (lib.versionOlder version "13.6") [
    ...
    (fetchpatch {
      url =
        "https://github.com/jmschrei/pomegranate/commit/42d14bebc44ffd4a778b2a6430aa845591b7c3b7.patch";
