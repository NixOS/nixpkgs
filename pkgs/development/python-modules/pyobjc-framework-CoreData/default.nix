...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreData/__init__.py \
      --replace '/System/Library/Frameworks/CoreData.framework' "${darwin.apple_sdk.frameworks.CoreData}/Library/Frameworks/CoreData.framework"
  '';
