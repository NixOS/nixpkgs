{ lib, buildPythonPackage, fetchPypi, python, fonttools, lxml, fs, unicodedata2
, defcon, fontpens, fontmath, booleanoperations, pytest, setuptools-scm }:
...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/robotools/fontParts/releases/tag/v${version}";
