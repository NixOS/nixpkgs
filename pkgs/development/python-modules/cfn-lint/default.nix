...
, importlib-metadata, importlib-resources, jsonpatch, jsonschema, junit-xml
, networkx, pathlib2, pyyaml, requests, setuptools, six, mock, pydot
, pytestCheckHook }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ mock pydot pytestCheckHook ];
