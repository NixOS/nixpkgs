{ lib, buildPythonPackage, fetchFromGitLab, pythonOlder, typing-extensions
, wsproto, toml, h2, priority, mock, pytest-asyncio, pytest-cov, pytest-sugar
...
buildPythonPackage rec {
  ...
  checkInputs =
    [ pytest-asyncio pytest-cov pytest-sugar pytest-trio pytestCheckHook ]
