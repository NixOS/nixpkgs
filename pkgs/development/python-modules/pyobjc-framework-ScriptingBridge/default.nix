...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ScriptingBridge/__init__.py \
      --replace '/System/Library/Frameworks/ScriptingBridge.framework' "${darwin.apple_sdk.frameworks.ScriptingBridge}/Library/Frameworks/ScriptingBridge.framework"
  '';
