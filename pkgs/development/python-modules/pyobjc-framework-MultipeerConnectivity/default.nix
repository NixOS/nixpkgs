...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace setup.py \
      --replace 'extra_link_args=["-framework", "MultipeerConnectivity"]' 'extra_link_args=[]'
    # Import Nix Framework instead of system one
    substituteInPlace Lib/MultipeerConnectivity/__init__.py \
      --replace '/System/Library/Frameworks/MultipeerConnectivity.framework' "${darwin.apple_sdk.frameworks.MultipeerConnectivity}/Library/Frameworks/MultipeerConnectivity.framework"
  '';
