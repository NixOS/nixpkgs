{ buildPackages, lib, fetchpatch, python, buildPythonPackage, isPy37, protobuf
, google-apputils ? null, six, pyext, isPy27, disabled, doCheck ? true }:

buildPythonPackage {
  inherit (protobuf) pname src version;
  inherit disabled;
  doCheck = doCheck
    && !isPy27; # setuptools>=41.4 no longer collects correctly on python2
  ...
  patches = lib.optional
    (isPy37 && (lib.versionOlder protobuf.version "3.6.1.2"))
