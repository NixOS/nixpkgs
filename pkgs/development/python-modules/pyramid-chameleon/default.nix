...
buildPythonPackage rec {
  ...
  patches = [
    # https://github.com/Pylons/pyramid-chameleon/pull/25
    ./test-renderers-pyramid-import.patch
    # Compatibility with pyramid 2, https://github.com/Pylons/pyramid-chameleon/pull/34
    (fetchpatch {
  ...
  meta = with lib; {
    ...
    homepage = "https://github.com/Pylons/pyramid-chameleon";
