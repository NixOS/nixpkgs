...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SystemConfiguration/__init__.py \
      --replace '/System/Library/Frameworks/SystemConfiguration.framework' "${darwin.apple_sdk.frameworks.SystemConfiguration}/Library/Frameworks/SystemConfiguration.framework"
  '';
