...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CFNetwork/__init__.py \
      --replace '/System/Library/Frameworks/CFNetwork.framework' "${darwin.apple_sdk.frameworks.CFNetwork}/Library/Frameworks/CFNetwork.framework"
  '';
