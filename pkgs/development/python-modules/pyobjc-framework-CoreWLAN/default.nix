...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreWLAN/__init__.py \
      --replace '/System/Library/Frameworks/CoreWLAN.framework' "${darwin.apple_sdk.frameworks.CoreWLAN}/Library/Frameworks/CoreWLAN.framework"
  '';
