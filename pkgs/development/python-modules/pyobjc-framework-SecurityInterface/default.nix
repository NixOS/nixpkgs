...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SecurityInterface/__init__.py \
      --replace '/System/Library/Frameworks/SecurityInterface.framework' "${darwin.apple_sdk.frameworks.SecurityInterface}/Library/Frameworks/SecurityInterface.framework"
  '';
