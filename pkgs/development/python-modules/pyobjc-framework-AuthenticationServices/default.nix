...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/AuthenticationServices/__init__.py \
      --replace '/System/Library/Frameworks/AuthenticationServices.framework' "${darwin.apple_sdk.frameworks.AuthenticationServices}/Library/Frameworks/AuthenticationServices.framework"
  '';
  ...
  # pythonImportsCheck = [ "AuthenticationServices" ];
