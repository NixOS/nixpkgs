{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch, importlib-metadata
, ipython, lark-parser, networkx, numpy, poetry-core, pytest-asyncio
, pytest-freezegun, pytest-httpx, pytest-mock, pytestCheckHook, pythonOlder
, qcs-api-client, retry, respx, rpcq, scipy }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/rigetti/pyquil/commit/2e35a4fdf65262fdf39c5091aeddfa3f3564925a.patch";
  ...
  propagatedBuildInputs =
    [ lark-parser networkx numpy qcs-api-client retry rpcq scipy ]
  ...
  disabledTests =
    [ "test_compile_with_quilt_calibrations" "test_sets_timeout_on_requests" ];
