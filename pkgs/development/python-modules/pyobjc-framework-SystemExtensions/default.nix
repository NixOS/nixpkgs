...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SystemExtensions/__init__.py \
      --replace '/System/Library/Frameworks/SystemExtensions.framework' "${darwin.apple_sdk.frameworks.SystemExtensions}/Library/Frameworks/SystemExtensions.framework"
  '';
  ...
  # pythonImportsCheck = [ "SystemExtensions" ];
