...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/OpenDirectory/__init__.py \
      --replace '/System/Library/Frameworks/OpenDirectory.framework' "${darwin.apple_sdk.frameworks.OpenDirectory}/Library/Frameworks/OpenDirectory.framework"
  '';
