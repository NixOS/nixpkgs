...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/InstallerPlugins/__init__.py \
      --replace '/System/Library/Frameworks/InstallerPlugins.framework' "${darwin.apple_sdk.frameworks.InstallerPlugins}/Library/Frameworks/InstallerPlugins.framework"
  '';
