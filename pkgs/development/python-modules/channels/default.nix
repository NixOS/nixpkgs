{ lib, buildPythonPackage, fetchFromGitHub, asgiref, django, daphne
, pytest-asyncio, pytest-django, pytestCheckHook }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytest-asyncio pytest-django pytestCheckHook ];
