...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/DeviceCheck/__init__.py \
      --replace '/System/Library/Frameworks/DeviceCheck.framework' "${darwin.apple_sdk.frameworks.DeviceCheck}/Library/Frameworks/DeviceCheck.framework"
  '';
  ...
  # pythonImportsCheck = [ "DeviceCheck" ];
