{ lib, buildPythonPackage, fetchFromGitHub, matplotlib, mock, numpy, pillow
, cython, pytest-cov, pytest, fetchpatch }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/amueller/word_cloud/commit/858a8ac4b5b08494c1d25d9e0b35dd995151a1e5.patch";
