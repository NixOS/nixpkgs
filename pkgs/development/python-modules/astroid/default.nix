{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch, pythonOlder, isPyPy
, lazy-object-proxy, wrapt, typing-extensions, typed-ast, pytestCheckHook
, setuptools-scm, pylint }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://github.com/PyCQA/astroid/commit/fd510e08c2ee862cd284861e02b9bcc9a7fd9809.patch";
