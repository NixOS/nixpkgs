...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/LocalAuthentication/__init__.py \
      --replace '/System/Library/Frameworks/LocalAuthentication.framework' "${darwin.apple_sdk.frameworks.LocalAuthentication}/Library/Frameworks/LocalAuthentication.framework"
  '';
