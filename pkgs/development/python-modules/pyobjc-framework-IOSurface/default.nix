...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/IOSurface/__init__.py \
      --replace '/System/Library/Frameworks/IOSurface.framework' "${darwin.apple_sdk.frameworks.IOSurface}/Library/Frameworks/IOSurface.framework"
  '';
