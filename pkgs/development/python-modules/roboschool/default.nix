{ lib, buildPythonPackage, isPy3k, python, fetchFromGitHub, fetchpatch, qtbase
, boost, assimp, gym, bullet-roboschool, pkg-config, which }:
...
buildPythonPackage rec {
  ...
  buildInputs = [ bullet-roboschool assimp qtbase boost ];
