...
, jinja2, pytestCheckHook, pytest-check, pythonOlder, markdown, testVersion
, tomlkit, staticjinja }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytestCheckHook pytest-check markdown tomlkit ];
  ...
  passthru.tests.version = testVersion { package = staticjinja; };
