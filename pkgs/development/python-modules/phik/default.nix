{ lib, buildPythonPackage, cmake, fetchPypi, isPy3k, pytest, pytest-pylint
, nbconvert, joblib, jupyter-client, numpy, scipy, pandas, matplotlib, ninja
, numba, pybind11 }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytest pytest-pylint nbconvert jupyter-client ];
