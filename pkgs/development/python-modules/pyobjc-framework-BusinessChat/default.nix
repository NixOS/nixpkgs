...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/BusinessChat/__init__.py \
      --replace '/System/Library/Frameworks/BusinessChat.framework' "${darwin.apple_sdk.frameworks.BusinessChat}/Library/Frameworks/BusinessChat.framework"
  '';
  ...
  # pythonImportsCheck = [ "BusinessChat" ];
