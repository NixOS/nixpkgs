...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/FileProvider/__init__.py \
      --replace '/System/Library/Frameworks/FileProvider.framework' "${darwin.apple_sdk.frameworks.FileProvider}/Library/Frameworks/FileProvider.framework"
  '';
  ...
  # pythonImportsCheck = [ "FileProvider" ];
