...
buildPythonPackage rec {
  ...
  meta = with lib; {
    description = "Dear PyGui is an easy-to-use, dynamic, GPU-Accelerated, cross-platform graphical user interface toolkit(GUI) for Python. It is “built with” Dear ImGui.";
