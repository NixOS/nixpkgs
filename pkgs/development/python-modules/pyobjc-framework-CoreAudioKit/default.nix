...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreAudioKit/__init__.py \
      --replace '/System/Library/Frameworks/CoreAudioKit.framework' "${darwin.apple_sdk.frameworks.CoreAudioKit}/Library/Frameworks/CoreAudioKit.framework"
  '';
  ...
  # pythonImportsCheck = [ "CoreAudioKit" ];
