...
, pytest-asyncio, pytest-tornado, sqlalchemy, tornado, twisted, mock, gevent
, six, pytz, tzlocal, funcsigs, setuptools, pythonOlder }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ six pytz tzlocal funcsigs setuptools ];
