...
buildPythonPackage (finalAttrs: {
  ...
  postPatch =
    ...
    ''
      ...
      substituteInPlace build_pynng.py \
        --replace-fail "ffibuilder.cdef(cdef_content + callbacks)" \
        'ffibuilder.cdef(cdef_content.replace("enum nng_pipe_ev", "nng_pipe_ev") + callbacks)'
    '';
