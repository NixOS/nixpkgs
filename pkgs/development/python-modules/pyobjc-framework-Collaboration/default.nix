...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/Collaboration/__init__.py \
      --replace '/System/Library/Frameworks/Collaboration.framework' "${darwin.apple_sdk.frameworks.Collaboration}/Library/Frameworks/Collaboration.framework"
  '';
  ...
  # pythonImportsCheck = [ "Collaboration" ];
