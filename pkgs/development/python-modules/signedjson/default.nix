{ lib, buildPythonPackage, fetchPypi, fetchpatch, canonicaljson, unpaddedbase64
, pynacl, typing-extensions, setuptools-scm, importlib-metadata, pythonOlder }:
...
buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/matrix-org/python-signedjson/commit/c40c83f844fee3c1c7b0c5d1508f87052334b4e5.patch";
