...
, pytest-flake8, glibcLocales, packaging, isPy38, importlib-metadata, fetchpatch
}:
...
buildPythonPackage rec {
  ...
  disabledTests = [ "TestPerformance" ]
    ++ lib.optionals isPy38 [ "test_version" ];
  ...
  patches = [
    (fetchpatch {
      url =
        "https://github.com/jaraco/path.py/commit/02eb16f0eb2cdc0015972ce963357aaa1cd0b84b.patch";
