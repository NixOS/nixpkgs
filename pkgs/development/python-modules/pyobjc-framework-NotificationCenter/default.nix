...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace setup.py \
      --replace 'extra_link_args=["-framework", "NotificationCenter"]' 'extra_link_args=[]'
    # Import Nix Framework instead of system one
    substituteInPlace Lib/NotificationCenter/__init__.py \
      --replace '/System/Library/Frameworks/NotificationCenter.framework' "${darwin.apple_sdk.frameworks.NotificationCenter}/Library/Frameworks/NotificationCenter.framework"
  '';
