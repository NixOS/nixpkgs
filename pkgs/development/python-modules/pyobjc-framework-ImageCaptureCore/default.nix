...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ImageCaptureCore/__init__.py \
      --replace '/System/Library/Frameworks/ImageCaptureCore.framework' "${darwin.apple_sdk.frameworks.ImageCaptureCore}/Library/Frameworks/ImageCaptureCore.framework"
  '';
