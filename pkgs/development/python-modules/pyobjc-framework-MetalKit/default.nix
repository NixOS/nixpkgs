...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/MetalKit/__init__.py \
      --replace '/System/Library/Frameworks/MetalKit.framework' "${darwin.apple_sdk.frameworks.MetalKit}/Library/Frameworks/MetalKit.framework"
  '';
