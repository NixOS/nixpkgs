...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace setup.py \
      --replace 'extra_link_args=["-framework", "SafariServices"]' 'extra_link_args=[]'
    # Import Nix Framework instead of system one
    substituteInPlace Lib/SafariServices/__init__.py \
      --replace '/System/Library/Frameworks/SafariServices.framework' "${darwin.apple_sdk.frameworks.SafariServices}/Library/Frameworks/SafariServices.framework"
  '';
