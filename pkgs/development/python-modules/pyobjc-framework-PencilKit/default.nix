...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/PencilKit/__init__.py \
      --replace '/System/Library/Frameworks/PencilKit.framework' "${darwin.apple_sdk.frameworks.PencilKit}/Library/Frameworks/PencilKit.framework"
  '';
