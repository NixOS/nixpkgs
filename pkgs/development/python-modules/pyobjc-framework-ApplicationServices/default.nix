...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/ApplicationServices/__init__.py \
      --replace '/System/Library/Frameworks/ApplicationServices.framework' "${darwin.apple_sdk.frameworks.ApplicationServices}/Library/Frameworks/ApplicationServices.framework"
  '';
