...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreMedia/__init__.py \
      --replace '/System/Library/Frameworks/CoreMedia.framework' "${darwin.apple_sdk.frameworks.CoreMedia}/Library/Frameworks/CoreMedia.framework"
  '';
