{ buildPythonPackage, fetchPypi, fetchpatch, pytestCheckHook, brotli, cairosvg
, fonttools, pydyf, pyphen, cffi, cssselect, lxml, html5lib, tinycss, zopfli
, glib, harfbuzz, pango, fontconfig, lib, stdenv, ghostscript, isPy3k
, substituteAll }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ pytestCheckHook ghostscript ];
