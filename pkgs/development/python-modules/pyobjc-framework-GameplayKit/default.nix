...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/GameplayKit/__init__.py \
      --replace '/System/Library/Frameworks/GameplayKit.framework' "${darwin.apple_sdk.frameworks.GameplayKit}/Library/Frameworks/GameplayKit.framework"
  '';
  ...
  # pythonImportsCheck = [ "GameplayKit" ];
