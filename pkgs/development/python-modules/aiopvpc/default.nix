...
, fetchFromGitHub, holidays, poetry-core, pytest-asyncio, pytest-timeout
, pytestCheckHook, pythonOlder, tzdata }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ aiohttp backports-zoneinfo holidays tzdata async-timeout ];
