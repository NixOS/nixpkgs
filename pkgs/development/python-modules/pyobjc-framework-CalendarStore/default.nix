...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CalendarStore/__init__.py \
      --replace '/System/Library/Frameworks/CalendarStore.framework' "${darwin.apple_sdk.frameworks.CalendarStore}/Library/Frameworks/CalendarStore.framework"
  '';
  ...
  # pythonImportsCheck = [ "CalendarStore" ];
