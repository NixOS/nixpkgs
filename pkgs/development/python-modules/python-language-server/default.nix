...
, backports_functools_lru_cache ? null, configparser ? null, futures ? null
, future, jedi, pluggy, python-jsonrpc-server, flake8, pytestCheckHook, mock
, pytest-cov, coverage, setuptools, ujson, flaky
...
in buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ setuptools jedi pluggy future python-jsonrpc-server ujson ]
    ...
    ++ lib.optional isPy27 configparser ++ lib.optionals (pythonOlder "3.2") [
