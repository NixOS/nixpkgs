{ lib, fetchPypi, fetchpatch, buildPythonPackage, flake8, flake8-polyfill
, python }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ flake8 flake8-polyfill ];
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/PyCQA/pep8-naming/commit/03b8f36f6a8bb8bc79dfa5a71ad9be2a0bf8bbf5.patch";
