...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/SceneKit/__init__.py \
      --replace '/System/Library/Frameworks/SceneKit.framework' "${darwin.apple_sdk.frameworks.SceneKit}/Library/Frameworks/SceneKit.framework"
  '';
