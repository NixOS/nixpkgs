...
, iana-etc, libredirect, lxml, mock, netifaces, pastedeploy, pbr, pyeclib
, requests, setuptools, six, stestr, swiftclient, xattr }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ boto3 mock stestr swiftclient ];
