...
, osqp, scipy, scs, useOpenmp ? (!stdenv.isDarwin)
# Check inputs
, pytestCheckHook }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ cvxopt ecos numpy osqp scipy scs ];
  ...
  disabledTests = [ "test_tv_inpainting" "test_diffcp_sdp_example" ]
