{ lib, buildPythonPackage, fetchFromGitHub, isPy27, numpy, scikit-learn
, pytestCheckHook, pytorch, torchvision, tqdm }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ numpy pytorch scikit-learn torchvision tqdm ];
