...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/CoreBluetooth/__init__.py \
      --replace '/System/Library/Frameworks/CoreBluetooth.framework' "${darwin.apple_sdk.frameworks.CoreBluetooth}/Library/Frameworks/CoreBluetooth.framework"
  '';
