{ lib, fetchFromGitHub, fetchurl, buildPythonPackage, rustPlatform
, setuptools-rust, numpy, datasets, pytestCheckHook, requests }:
...
in buildPythonPackage rec {
  ...
  checkInputs = [ datasets pytestCheckHook requests ];
