...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/LinkPresentation/__init__.py \
      --replace '/System/Library/Frameworks/LinkPresentation.framework' "${darwin.apple_sdk.frameworks.LinkPresentation}/Library/Frameworks/LinkPresentation.framework"
  '';
  ...
  # pythonImportsCheck = [ "LinkPresentation" ];
