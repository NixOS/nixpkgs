{ lib, buildPythonPackage, isPy27, fetchPypi, jsonschema
, openapi-schema-validator, pyyaml, six, pathlib, mock, pytest, pytest-cov
, pytest-flake8, tox, setuptools }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ jsonschema openapi-schema-validator pyyaml six setuptools ]
