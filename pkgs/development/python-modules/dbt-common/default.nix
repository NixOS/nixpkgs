...
buildPythonPackage rec {
  pname = "dbt-common";
  version = "1.38.0-unstable-2026-05-29";
  pyproject = true;

  src = fetchFromGitHub {
    owner = "dbt-labs";
    repo = "dbt-common";
    rev = "fccab625928bd2f3a1fa0125cba49e408a5aac79"; # They don't tag releases
    hash = "sha256-xVDtTGr5xr3uN4wLHaKvijdrm4wuXcUlQx4RphqHon4=";
  };
