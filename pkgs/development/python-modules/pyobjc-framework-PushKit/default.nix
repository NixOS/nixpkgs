...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/PushKit/__init__.py \
      --replace '/System/Library/Frameworks/PushKit.framework' "${darwin.apple_sdk.frameworks.PushKit}/Library/Frameworks/PushKit.framework"
  '';
