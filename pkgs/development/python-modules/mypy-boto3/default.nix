...
rec {
  ...
  mypy-boto3-pricing =
    buildMypyBoto3Package "pricing" "1.37.0"
      "sha256-Hg/vHZN0t8YZvoQqaQeFXBhWgQ1ynwUmjzgrFJdOwIU=";
  ...
  mypy-boto3-ssm =
    buildMypyBoto3Package "ssm" "1.37.0"
      "sha256-0lDEHof5mDuIXwsQVEmlS3TeGXZK77FuYGbI4GxbV64=";
