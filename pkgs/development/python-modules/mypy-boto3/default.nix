...
rec {
  ...
  mypy-boto3-budgets =
    buildMypyBoto3Package "budgets" "1.40.32"
      "sha256-L6pjxkpa3FMTLql9+9c8uhui+bd/3//h2L7ycqYwWIY=";
  ...
  mypy-boto3-ec2 =
    buildMypyBoto3Package "ec2" "1.40.33"
      "sha256-sXJhr2TCURYpVvDn3JDjjFK9GcqVpCxdoxvvSIfXA8A=";
