{ lib, fetchPypi, buildPythonPackage, fetchpatch, configobj, six, traitsui
, pytestCheckHook, tables, pandas, pythonOlder, importlib-resources }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ tables pandas pytestCheckHook ];
