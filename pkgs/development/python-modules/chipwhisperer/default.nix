...
buildPythonPackage rec {
  ...
  postInstall = ''
    # Install udev rules
    # The 50-newae.rules file isn't directly installed, since it installs to
    # the chipwhisperer group (and not to uaccess)
  ...
  meta = with lib; {
    ...
    maintainers = [ maintainers.krishnans2006 ];
  };
}
