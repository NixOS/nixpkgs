...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace Lib/WebKit/__init__.py \
      --replace '/System/Library/Frameworks/WebKit.framework' "${darwin.apple_sdk.frameworks.WebKit}/Library/Frameworks/WebKit.framework"
  '';
