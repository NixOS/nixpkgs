{ buildPythonPackage, lib, isPy27, nixosTests, fetchPypi, alembic, aniso8601
, Babel, blinker, cachetools, click, dnspython, email_validator, flask
, flask-babel, flask-cors, flask_mail, flask_migrate, flask-restful
, flask_sqlalchemy, flask-talisman, flask_wtf, debts, idna, itsdangerous, jinja2
, Mako, markupsafe, python-dateutil, pytz, requests, six, sqlalchemy
, sqlalchemy-utils, sqlalchemy-continuum, sqlalchemy-i18n, werkzeug, wtforms
...
let
  ...
  pinned_sqlalchemy = sqlalchemy.overridePythonAttrs (old: rec {
    pname = "SQLAlchemy";
    version = "1.3.24";
...
in buildPythonPackage rec {
  ...
  propagatedBuildInputs = [
    ...
    (flask_migrate.override {
      flask_sqlalchemy =
        flask_sqlalchemy.override { sqlalchemy = pinned_sqlalchemy; };
      alembic = alembic.override { sqlalchemy = pinned_sqlalchemy; };
    })
    flask-restful
    flask-talisman
    flask_wtf
    ...
    ((sqlalchemy-continuum.override {
      ...
      sqlalchemy-utils =
        sqlalchemy-utils.override { sqlalchemy = pinned_sqlalchemy; };
  ...
  checkInputs = [ flask_testing pytestCheckHook ];
