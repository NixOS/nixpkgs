{ lib, buildPythonPackage, fetchPypi, pytestCheckHook, isodate, jsonschema
, pytest-flake8, pytest-cov, rfc3339-validator, six, strict-rfc3339 }:
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ isodate jsonschema six strict-rfc3339 rfc3339-validator ];
