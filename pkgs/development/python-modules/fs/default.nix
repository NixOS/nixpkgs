{ lib, glibcLocales, buildPythonPackage, fetchPypi, six, appdirs, scandir ? null
, backports_os ? null, typing ? null, pytz, enum34, pyftpdlib, psutil, mock
, pythonAtLeast, isPy3k, pytestCheckHook, stdenv }:
...
buildPythonPackage rec {
  ...
  disabledTests = [ "user_data_repr" ] ++ lib.optionals (stdenv.isDarwin)
