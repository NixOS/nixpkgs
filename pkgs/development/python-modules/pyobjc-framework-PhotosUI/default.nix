...
buildPythonPackage rec {
  ...
  postPatch = ''
    ...
    substituteInPlace setup.py \
      --replace 'extra_link_args=["-framework", "PhotosUI"]' 'extra_link_args=[]'
    # Import Nix Framework instead of system one
    substituteInPlace Lib/PhotosUI/__init__.py \
      --replace '/System/Library/Frameworks/PhotosUI.framework' "${darwin.apple_sdk.frameworks.PhotosUI}/Library/Frameworks/PhotosUI.framework"
  '';
