...
python3.pkgs.buildPythonApplication rec {
  ...
  src = python3.pkgs.fetchPypi {
    ...
    hash = "sha256-6bxVF47i1iCtY7TmKgKZmWsq9BiyXGvKxlJyIyXemDg=";
  };
  ...
  postPatch = ''
    sed -e '5i import shutil' -e 's/click.get_terminal_size/shutil.get_terminal_size/' -i samcli/commands/_utils/table_print.py
