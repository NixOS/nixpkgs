{ stdenv, lib, fetchFromGitHub, writeScript, fetchpatch, cmake, rocm-runtime
, python3, rocm-cmake, busybox, gnugrep
...
stdenv.mkDerivation rec {
  ...
  cmakeFlags = [ "-DROCM_DIR=${rocm-runtime}" "-DROCRTST_BLD_TYPE=Release" ];
