{ stdenv, lib, fetchFromGitHub, nix-update-script, meson, ninja, python3
, rustPlatform, pkg-config, glib, libshumate, gst_all_1, gtk4, libadwaita
...
stdenv.mkDerivation rec {
  ...
  BINDGEN_EXTRA_CLANG_ARGS = "-I${llvmPackages.libclang.lib}/lib/clang/${
      lib.getVersion llvmPackages.clang
    }/include -I${glibc.dev}/include";
