...
let
  ...
  src = fetchurl {
    ...
    sha512 =
      "1aik88wi9axv66axjmmjmlna1sp0pz92z8i2x6pq3bs0gcs4i1q3qxxbrfc14ynbpa65knimfhwzrrshchnijgdazx3qjzh8jwzfiwl";
  };
...
in appimageTools.wrapType2 {
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/beekeeper-studio/beekeeper-studio/releases/tag/v2.1.4";
