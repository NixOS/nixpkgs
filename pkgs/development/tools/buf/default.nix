...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = pname;
    rev = "v${version}";
    sha256 = "sha256-nRrFMl/u+lx1BHVA159sz+RpA+Bni5yT5IZWMyItxsk=";
  };

  vendorSha256 = "sha256-vXF9945Yctrxe8SfHXiznMIzmONJ4DPVU1hKiuj+tp8=";
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ raboof jk lrewega lucperkins ];
  };
}
