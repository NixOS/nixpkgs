  ...
  mkGenealogosPackage =
    ...
    rustPlatform.buildRustPackage rec {
      ...
      src = fetchFromGitHub {
        ...
        repo = "genealogos";
        rev = "v${version}";
        hash = "sha256-L+VC7mQatrhQIMjeht0T+pjXnKrWxYWNcKwhFT3qPEY=";
      ...
      cargoLock = {
        lockFile = ./Cargo.lock;
        outputHashes = {
          "nixtract-0.3.0" = "sha256-36ciPNSlB1LU+UXP8MLakrBRRqbyiVFN8Jp/JbCe1OY=";
        };
      };

      cargoBuildFlags = [ "-p" "genealogos-${crate}" ];
