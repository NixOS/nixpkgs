...
rec {
  ...
  features_.aho_corasick."0.6.4" = deps: f: updateFeatures f
    (rec {
  ...
  features_.atty."0.2.10" = deps: f: updateFeatures f
    (rec {
  ...
  features_.backtrace."0.3.7" = deps: f: updateFeatures f
    (rec {
  ...
  features_.backtrace_sys."0.1.16" = deps: f: updateFeatures f
    (rec {
  ...
  features_.bitflags."1.0.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.byteorder."1.2.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.bytes."0.4.7" = deps: f: updateFeatures f
    (rec {
  ...
  features_.cc."1.0.15" = deps: f: updateFeatures f
    (rec {
  ...
  features_.cfg_if."0.1.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.clap."2.31.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.clicolors_control."0.2.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.console."0.6.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.failure."0.1.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.failure_derive."0.1.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.gcc."0.3.54" = deps: f: updateFeatures f
    (rec {
  ...
  features_.lazy_static."0.2.11" = deps: f: updateFeatures f
    (rec {
  ...
  features_.lazy_static."1.0.0" = deps: f: updateFeatures f
    (rec {
      lazy_static = fold recursiveUpdate { } [
        {
  ...
  features_.libc."0.2.40" = deps: f: updateFeatures f
    (rec {
  ...
  features_.memchr."2.0.1" = deps: f: updateFeatures f
    (rec {
      libc = fold recursiveUpdate { } [
        {
  ...
  crates.nix."0.10.0" = deps: { features ? (features_.nix."0.10.0" deps { }) }: buildRustCrate {
    ...
    ++ (if kernel == "dragonfly" then
      mapFeatures features
        ([
        ]) else [ ]);
  };
  features_.nix."0.10.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.owning_ref."0.3.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.parking_lot."0.5.5" = deps: f: updateFeatures f
    (rec {
  ...
  features_.parking_lot_core."0.2.14" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand."0.4.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.redox_syscall."0.1.37" = deps: f: updateFeatures f
    (rec {
  ...
  features_.regex."0.2.11" = deps: f: updateFeatures f
    (rec {
  ...
  features_.regex."1.0.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.regex_syntax."0.5.6" = deps: f: updateFeatures f
    (rec {
  ...
  features_.regex_syntax."0.6.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rustc_demangle."0.1.8" = deps: f: updateFeatures f
    (rec {
  ...
  features_.smallvec."0.6.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.socket2."0.3.5" = deps: f: updateFeatures f
    (rec {
  ...
  features_.stable_deref_trait."1.0.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.syn."0.11.11" = deps: f: updateFeatures f
    (rec {
  ...
  features_.synstructure."0.6.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.systemfd."0.3.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.termios."0.2.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.thread_local."0.3.5" = deps: f: updateFeatures f
    (rec {
  ...
  features_.utf8_ranges."1.0.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.uuid."0.6.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.vec_map."0.8.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.void."1.0.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.winapi."0.3.4" = deps: f: updateFeatures f
    (rec {
