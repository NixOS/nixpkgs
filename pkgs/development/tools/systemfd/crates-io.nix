...
in rec {
  ...
  crates.aho_corasick."0.6.4" = deps: {features ? (features_.aho_corasick."0.6.4" deps {})}:
    buildRustCrate {
  ...
  crates.ansi_term."0.11.0" = deps: {features ? (features_.ansi_term."0.11.0" deps {})}:
    buildRustCrate {
      crateName = "ansi_term";
      version = "0.11.0";
      ...
      dependencies = (if kernel == "windows"
      then
  ...
  crates.atty."0.2.10" = deps: {features ? (features_.atty."0.2.10" deps {})}:
    buildRustCrate {
      crateName = "atty";
      version = "0.2.10";
  ...
  crates.backtrace."0.3.7" = deps: {features ? (features_.backtrace."0.3.7" deps {})}:
    buildRustCrate {
      crateName = "backtrace";
      version = "0.3.7";
      ...
      dependencies =
        ...
        ++ (if (kernel == "linux" || kernel == "darwin") && !(kernel == "fuchsia") && !(kernel == "emscripten") && !(kernel == "darwin") && !(kernel == "ios")
        then
          mapFeatures features ([
          ]
          ++ (if features.backtrace."0.3.7".backtrace-sys or false
          then [(crates.backtrace_sys."${deps."backtrace"."0.3.7".backtrace_sys}" deps)]
          else []))
        else [])
        ++ (if (kernel == "linux" || kernel == "darwin")
        then
        ...
        then
          ...
          ++ (if features.backtrace."0.3.7".winapi or false
          then [(crates.winapi."${deps."backtrace"."0.3.7".winapi}" deps)]
          else []))
        else []);
  ...
  crates.backtrace_sys."0.1.16" = deps: {features ? (features_.backtrace_sys."0.1.16" deps {})}:
    buildRustCrate {
  ...
  crates.bitflags."1.0.3" = deps: {features ? (features_.bitflags."1.0.3" deps {})}:
    buildRustCrate {
      crateName = "bitflags";
      version = "1.0.3";
  ...
  crates.byteorder."1.2.3" = deps: {features ? (features_.byteorder."1.2.3" deps {})}:
    buildRustCrate {
      crateName = "byteorder";
      version = "1.2.3";
  ...
  crates.bytes."0.4.7" = deps: {features ? (features_.bytes."0.4.7" deps {})}:
    buildRustCrate {
      crateName = "bytes";
      version = "0.4.7";
  ...
  crates.cc."1.0.15" = deps: {features ? (features_.cc."1.0.15" deps {})}:
    buildRustCrate {
      crateName = "cc";
      version = "1.0.15";
  ...
  crates.cfg_if."0.1.3" = deps: {features ? (features_.cfg_if."0.1.3" deps {})}:
    buildRustCrate {
      crateName = "cfg-if";
      version = "0.1.3";
  ...
  crates.clap."2.31.2" = deps: {features ? (features_.clap."2.31.2" deps {})}:
    buildRustCrate {
      crateName = "clap";
      version = "2.31.2";
      ...
      dependencies =
        ...
        ++ (if features.clap."2.31.2".atty or false
        then [(crates.atty."${deps."clap"."2.31.2".atty}" deps)]
        else [])
        ++ (if features.clap."2.31.2".strsim or false
        then [(crates.strsim."${deps."clap"."2.31.2".strsim}" deps)]
        else [])
        ++ (if features.clap."2.31.2".vec_map or false
        then [(crates.vec_map."${deps."clap"."2.31.2".vec_map}" deps)]
        else []))
        ++ (if !(kernel == "windows")
        then
          mapFeatures features ([
          ]
          ++ (if features.clap."2.31.2".ansi_term or false
          then [(crates.ansi_term."${deps."clap"."2.31.2".ansi_term}" deps)]
          else []))
        else []);
  ...
  crates.clicolors_control."0.2.0" = deps: {features ? (features_.clicolors_control."0.2.0" deps {})}:
    buildRustCrate {
  ...
  crates.console."0.6.1" = deps: {features ? (features_.console."0.6.1" deps {})}:
    buildRustCrate {
      crateName = "console";
      version = "0.6.1";
  ...
  crates.failure."0.1.1" = deps: {features ? (features_.failure."0.1.1" deps {})}:
    buildRustCrate {
      crateName = "failure";
      version = "0.1.1";
      ...
      ++ (if features.failure."0.1.1".backtrace or false
      then [(crates.backtrace."${deps."failure"."0.1.1".backtrace}" deps)]
      else [])
      ++ (if features.failure."0.1.1".failure_derive or false
      then [(crates.failure_derive."${deps."failure"."0.1.1".failure_derive}" deps)]
      else []));
  ...
  crates.failure_derive."0.1.1" = deps: {features ? (features_.failure_derive."0.1.1" deps {})}:
    buildRustCrate {
  ...
  crates.fuchsia_zircon."0.3.3" = deps: {features ? (features_.fuchsia_zircon."0.3.3" deps {})}:
    buildRustCrate {
  ...
  crates.fuchsia_zircon_sys."0.3.3" = deps: {features ? (features_.fuchsia_zircon_sys."0.3.3" deps {})}:
    buildRustCrate {
  ...
  crates.gcc."0.3.54" = deps: {features ? (features_.gcc."0.3.54" deps {})}:
    buildRustCrate {
      crateName = "gcc";
      version = "0.3.54";
      description = "A build-time dependency for Cargo build scripts to assist in invoking the native\nC compiler to compile native C code into a static archive to be linked into Rust\ncode.\n";
  ...
  crates.iovec."0.1.2" = deps: {features ? (features_.iovec."0.1.2" deps {})}:
    buildRustCrate {
      crateName = "iovec";
      version = "0.1.2";
  ...
  crates.kernel32_sys."0.2.2" = deps: {features ? (features_.kernel32_sys."0.2.2" deps {})}:
    buildRustCrate {
  ...
  crates.lazy_static."0.2.11" = deps: {features ? (features_.lazy_static."0.2.11" deps {})}:
    buildRustCrate {
  ...
  crates.lazy_static."1.0.0" = deps: {features ? (features_.lazy_static."1.0.0" deps {})}:
    buildRustCrate {
      crateName = "lazy_static";
      version = "1.0.0";
      description = "A macro for declaring lazily evaluated statics in Rust.";
  ...
  crates.libc."0.2.40" = deps: {features ? (features_.libc."0.2.40" deps {})}:
    buildRustCrate {
      crateName = "libc";
      version = "0.2.40";
  ...
  crates.memchr."2.0.1" = deps: {features ? (features_.memchr."2.0.1" deps {})}:
    buildRustCrate {
      crateName = "memchr";
      version = "2.0.1";
      ...
      ++ (if features.memchr."2.0.1".libc or false
      then [(crates.libc."${deps."memchr"."2.0.1".libc}" deps)]
      else []));
  ...
  crates.nix."0.10.0" = deps: {features ? (features_.nix."0.10.0" deps {})}:
    buildRustCrate {
      crateName = "nix";
      version = "0.10.0";
  ...
  crates.owning_ref."0.3.3" = deps: {features ? (features_.owning_ref."0.3.3" deps {})}:
    buildRustCrate {
  ...
  crates.parking_lot."0.5.5" = deps: {features ? (features_.parking_lot."0.5.5" deps {})}:
    buildRustCrate {
      ...
      ++ (if features.parking_lot."0.5.5".owning_ref or false
      then [(crates.owning_ref."${deps."parking_lot"."0.5.5".owning_ref}" deps)]
      else []));
  ...
  crates.parking_lot_core."0.2.14" = deps: {features ? (features_.parking_lot_core."0.2.14" deps {})}:
    buildRustCrate {
  ...
  crates.quote."0.3.15" = deps: {features ? (features_.quote."0.3.15" deps {})}:
    buildRustCrate {
      crateName = "quote";
      version = "0.3.15";
  ...
  crates.rand."0.4.2" = deps: {features ? (features_.rand."0.4.2" deps {})}:
    buildRustCrate {
      crateName = "rand";
      version = "0.4.2";
      ...
      dependencies =
        ...
        then
          ...
          ++ (if features.rand."0.4.2".libc or false
          then [(crates.libc."${deps."rand"."0.4.2".libc}" deps)]
          else []))
        else [])
        ++ (if kernel == "windows"
        then
  ...
  crates.redox_syscall."0.1.37" = deps: {features ? (features_.redox_syscall."0.1.37" deps {})}:
    buildRustCrate {
  ...
  crates.redox_termios."0.1.1" = deps: {features ? (features_.redox_termios."0.1.1" deps {})}:
    buildRustCrate {
  ...
  crates.regex."0.2.11" = deps: {features ? (features_.regex."0.2.11" deps {})}:
    buildRustCrate {
      crateName = "regex";
      version = "0.2.11";
  ...
  crates.regex."1.0.0" = deps: {features ? (features_.regex."1.0.0" deps {})}:
    buildRustCrate {
      crateName = "regex";
      version = "1.0.0";
      description = "An implementation of regular expressions for Rust. This implementation uses\nfinite automata and guarantees linear time matching on all inputs.\n";
  ...
  crates.regex_syntax."0.5.6" = deps: {features ? (features_.regex_syntax."0.5.6" deps {})}:
    buildRustCrate {
  ...
  crates.regex_syntax."0.6.0" = deps: {features ? (features_.regex_syntax."0.6.0" deps {})}:
    buildRustCrate {
      crateName = "regex-syntax";
      version = "0.6.0";
      description = "A regular expression parser.";
  ...
  crates.rustc_demangle."0.1.8" = deps: {features ? (features_.rustc_demangle."0.1.8" deps {})}:
    buildRustCrate {
  ...
  crates.smallvec."0.6.1" = deps: {features ? (features_.smallvec."0.6.1" deps {})}:
    buildRustCrate {
      crateName = "smallvec";
      version = "0.6.1";
  ...
  crates.socket2."0.3.5" = deps: {features ? (features_.socket2."0.3.5" deps {})}:
    buildRustCrate {
      crateName = "socket2";
      version = "0.3.5";
  ...
  crates.stable_deref_trait."1.0.0" = deps: {features ? (features_.stable_deref_trait."1.0.0" deps {})}:
    buildRustCrate {
  ...
  crates.strsim."0.7.0" = deps: {features ? (features_.strsim."0.7.0" deps {})}:
    buildRustCrate {
      crateName = "strsim";
      version = "0.7.0";
  ...
  crates.syn."0.11.11" = deps: {features ? (features_.syn."0.11.11" deps {})}:
    buildRustCrate {
      crateName = "syn";
      version = "0.11.11";
      ...
      ++ (if features.syn."0.11.11".quote or false
      then [(crates.quote."${deps."syn"."0.11.11".quote}" deps)]
      else [])
      ++ (if features.syn."0.11.11".synom or false
      then [(crates.synom."${deps."syn"."0.11.11".synom}" deps)]
      else [])
      ++ (if features.syn."0.11.11".unicode-xid or false
      then [(crates.unicode_xid."${deps."syn"."0.11.11".unicode_xid}" deps)]
      else []));
  ...
  crates.synom."0.11.3" = deps: {features ? (features_.synom."0.11.3" deps {})}:
    buildRustCrate {
      crateName = "synom";
      version = "0.11.3";
  ...
  crates.synstructure."0.6.1" = deps: {features ? (features_.synstructure."0.6.1" deps {})}:
    buildRustCrate {
  ...
  crates.systemfd."0.3.0" = deps: {features ? (features_.systemfd."0.3.0" deps {})}:
    buildRustCrate {
      crateName = "systemfd";
      version = "0.3.0";
  ...
  crates.termion."1.5.1" = deps: {features ? (features_.termion."1.5.1" deps {})}:
    buildRustCrate {
      crateName = "termion";
      version = "1.5.1";
  ...
  crates.termios."0.2.2" = deps: {features ? (features_.termios."0.2.2" deps {})}:
    buildRustCrate {
      crateName = "termios";
      version = "0.2.2";
  ...
  crates.textwrap."0.9.0" = deps: {features ? (features_.textwrap."0.9.0" deps {})}:
    buildRustCrate {
      crateName = "textwrap";
      version = "0.9.0";
  ...
  crates.thread_local."0.3.5" = deps: {features ? (features_.thread_local."0.3.5" deps {})}:
    buildRustCrate {
  ...
  crates.ucd_util."0.1.1" = deps: {features ? (features_.ucd_util."0.1.1" deps {})}:
    buildRustCrate {
      crateName = "ucd-util";
      version = "0.1.1";
  ...
  crates.unicode_width."0.1.4" = deps: {features ? (features_.unicode_width."0.1.4" deps {})}:
    buildRustCrate {
  ...
  crates.unicode_xid."0.0.4" = deps: {features ? (features_.unicode_xid."0.0.4" deps {})}:
    buildRustCrate {
  ...
  crates.unreachable."1.0.0" = deps: {features ? (features_.unreachable."1.0.0" deps {})}:
    buildRustCrate {
  ...
  crates.utf8_ranges."1.0.0" = deps: {features ? (features_.utf8_ranges."1.0.0" deps {})}:
    buildRustCrate {
  ...
  crates.uuid."0.6.3" = deps: {features ? (features_.uuid."0.6.3" deps {})}:
    buildRustCrate {
      crateName = "uuid";
      version = "0.6.3";
      ...
      ++ (if features.uuid."0.6.3".rand or false
      then [(crates.rand."${deps."uuid"."0.6.3".rand}" deps)]
      else []));
  ...
  crates.vec_map."0.8.1" = deps: {features ? (features_.vec_map."0.8.1" deps {})}:
    buildRustCrate {
      crateName = "vec_map";
      version = "0.8.1";
  ...
  crates.void."1.0.2" = deps: {features ? (features_.void."1.0.2" deps {})}:
    buildRustCrate {
      crateName = "void";
      version = "1.0.2";
  ...
  crates.winapi."0.2.8" = deps: {features ? (features_.winapi."0.2.8" deps {})}:
    buildRustCrate {
      crateName = "winapi";
      version = "0.2.8";
  ...
  crates.winapi."0.3.4" = deps: {features ? (features_.winapi."0.3.4" deps {})}:
    buildRustCrate {
      crateName = "winapi";
      version = "0.3.4";
  ...
  crates.winapi_build."0.1.1" = deps: {features ? (features_.winapi_build."0.1.1" deps {})}:
    buildRustCrate {
  ...
  crates.winapi_i686_pc_windows_gnu."0.4.0" = deps: {features ? (features_.winapi_i686_pc_windows_gnu."0.4.0" deps {})}:
    buildRustCrate {
  ...
  crates.winapi_x86_64_pc_windows_gnu."0.4.0" = deps: {features ? (features_.winapi_x86_64_pc_windows_gnu."0.4.0" deps {})}:
    buildRustCrate {
