...
in rec {
  ...
  __all = [ (systemfd { }) ];
  deps.aho_corasick."0.6.4" = { memchr = "2.0.1"; };
  deps.ansi_term."0.11.0" = { winapi = "0.3.4"; };
  deps.atty."0.2.10" = {
    termion = "1.5.1";
    libc = "0.2.40";
    winapi = "0.3.4";
  ...
  deps.owning_ref."0.3.3" = { stable_deref_trait = "1.0.0"; };
  ...
  deps.redox_termios."0.1.1" = { redox_syscall = "0.1.37"; };
  deps.regex."0.2.11" = {
    aho_corasick = "0.6.4";
    memchr = "2.0.1";
    regex_syntax = "0.5.6";
  ...
  deps.regex_syntax."0.5.6" = { ucd_util = "0.1.1"; };
  deps.regex_syntax."0.6.0" = { ucd_util = "0.1.1"; };
  ...
  deps.termios."0.2.2" = { libc = "0.2.40"; };
