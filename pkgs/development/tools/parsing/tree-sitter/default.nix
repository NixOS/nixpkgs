...
let
  ...
  grammarsSrc' = import ./grammars { inherit lib; } // extraGrammars;
  grammarsSrc = grammarsSrc' //
    { tree-sitter-ocaml = grammarsSrc'.tree-sitter-ocaml // { location = "ocaml"; }; } //
    { tree-sitter-ocaml-interface = grammarsSrc'.tree-sitter-ocaml // { location = "interface"; }; } //
    { tree-sitter-org-nvim = grammarsSrc'.tree-sitter-org-nvim // { language = "org"; }; } //
    { tree-sitter-typescript = grammarsSrc'.tree-sitter-typescript // { location = "typescript"; }; } //
    { tree-sitter-tsx = grammarsSrc'.tree-sitter-typescript // { location = "tsx"; }; } //
    { tree-sitter-markdown = grammarsSrc'.tree-sitter-markdown // { location = "tree-sitter-markdown"; }; } //
    { tree-sitter-markdown-inline = grammarsSrc'.tree-sitter-markdown // { language = "markdown_inline"; location = "tree-sitter-markdown-inline"; }; } //
    { tree-sitter-wing = grammarsSrc'.tree-sitter-wing // { location = "libs/tree-sitter-wing"; generate = true; }; };
  ...
  grammarsWasmSrc = (builtins.removeAttrs grammarsSrc [ "tree-sitter-llvm" ]) //
    { tree-sitter-ql-dbscheme = grammarsSrc'.tree-sitter-ql-dbscheme // { wasmName = "dbscheme"; }; };
...
rustPlatform.buildRustPackage {
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ Profpatsch oxalica aabccd021 ];
  };
}
