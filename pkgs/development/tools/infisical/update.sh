...
RELEASE_NAME=$(curl -s https://api.github.com/repos/infisical/cli/releases \
...
for arch in "${ARCHS[@]}"; do
    ...
    sha256hash="$(nix-prefetch-url --type sha256 "https://github.com/infisical/cli/releases/download/${RELEASE_NAME}/cli_${VERSION}_${arch_target}.tar.gz")"
