{ stdenv, fetchurl, lib, autoPatchelfHook, wrapQtAppsHook, libbsd, python27
, gmpxx, ncurses5, gnustep, libffi }:
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libbsd python27 gmpxx ncurses5 gnustep.libobjc ];
