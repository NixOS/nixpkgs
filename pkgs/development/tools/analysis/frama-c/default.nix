{ lib, stdenv, fetchurl, makeWrapper, writeText, autoconf, ncurses, graphviz
, doxygen, ocamlPackages, ltl2ba, coq, why3, gdk-pixbuf, wrapGAppsHook }:
...
in stdenv.mkDerivation rec {
  ...
  preConfigure = lib.optionalString stdenv.cc.isClang
    ''configureFlagsArray=("--with-cpp=clang -E -C")'';
