{ lib, stdenv, fetchurl, makeWrapper, sbcl_2_0_8, sqlite, freetds, libzip, curl
, git, cacert, openssl }:
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/dimitri/pgloader/releases/download/v3.6.2/pgloader-bundle-3.6.2.tgz";
