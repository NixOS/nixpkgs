...
stdenv.mkDerivation rec {
  pname = "dune";
  version = "3.11.0_alpha3";

  src = fetchurl {
    url = "https://github.com/ocaml/dune/releases/download/${version}/dune-3.11.0.alpha3.tbz";
    hash = "sha256-sBQ7tQZLKvvC/pfXYfi15K7D4Rr4LR1Q9gTVHCVjNqg=";
  };
