...
let
  srcs = {
    ...
    "mccs" = fetchurl {
      url = "https://github.com/ocaml-opam/ocaml-mccs/archive/refs/tags/1.1+17.tar.gz";
      sha256 = "03v7j64xs59lvs3zjzvq3wkcnhbdhk9k1gwhlqpapmb40jr6pjzp";
    };
    "ocamlgraph" = fetchurl {
    ...
    opam = fetchurl {
      url = "https://github.com/ocaml/opam/archive/2.1.6.zip";
      sha256 = "0cwcbji4acivv6g7nrz7447wk178bmm74647qqflk65nwxr702pz";
    };
  };
in
stdenv.mkDerivation {
...
# Generated by: ./opam.nix.pl -v 2.1.6 -p opam-shebangs.patch
