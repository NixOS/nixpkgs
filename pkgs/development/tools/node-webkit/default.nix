...
in stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    makeWrapper $out/share/node-webkit/nw $out/bin/nw --prefix LD_LIBRARY_PATH : "${nwEnv}/lib:$out/share/node-webkit"
    makeWrapper $out/share/node-webkit/nwsnapshot $out/bin/nwsnapshot --prefix LD_LIBRARY_PATH : "${nwEnv}/lib"
  '';
