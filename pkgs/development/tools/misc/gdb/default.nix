...
, debuginfodSupport ? false, elfutils
, guile ? null
, safePaths ? [
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ ncurses readline gmp mpfr expat libipt zlib guile ]
    ...
    ++ lib.optional debuginfodSupport (elfutils.override { debuginfodSupport = true; });
  ...
  configureFlags = with lib; [
    ...
    ++ lib.optional debuginfodSupport "--with-debuginfod=yes";
