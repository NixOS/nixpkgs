{ lib, stdenv, fetchFromGitHub, autoreconfHook, coreutils, pkg-config, perl
, python3Packages, libiconv, jansson }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ autoreconfHook coreutils pkg-config python3Packages.docutils ];
