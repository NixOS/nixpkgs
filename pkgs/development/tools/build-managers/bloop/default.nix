{ stdenv, fetchurl, coursier, autoPatchelfHook, installShellFiles, makeWrapper
, jre, lib, zlib }:
...
stdenv.mkDerivation rec {
  ...
  bloop-coursier = stdenv.mkDerivation rec {
    ...
    outputHash = if stdenv.isLinux && stdenv.isx86_64 then
      "0c02n779z4l7blzla5820bzfhblbp5nlizx9f8wns4miwnph357f"
    else if stdenv.isDarwin && stdenv.isx86_64 then
      "1gy5k9ii86rxyv2v9if4n1clvmb1hi4ym32mp6miwgcjla10sv30"
    else
      throw "unsupported platform";
  };
