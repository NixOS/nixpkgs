...
, bazel_3, lr, xe, zip, unzip, bash, writeCBin, coreutils, which, gawk, gnused
...
in stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/bazelbuild/bazel/commit/ae0a6c98d4f94abedbedb2d51c27de5febd7df67.patch";
