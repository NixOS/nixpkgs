...
let
  sources = {
    ...
    "dotf-1.5.2" = {
      ...
      version = "1.5.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/dotf/-/dotf-1.5.2.tgz";
        sha512 = "smj4fTLodemYeQFq3cSTvo50jpI7rC/7h1WMrEs+ujnL0TxXQisd29quIGpDdEC1ijx+ZAckeVm8vB/X+reKvg==";
      };
    };
    "duplexer3-0.1.4" = {
      name = "duplexer3";
    ...
    "ts2gas-3.6.3" = {
      ...
      version = "3.6.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts2gas/-/ts2gas-3.6.3.tgz";
        sha512 = "iJsl47L6rsADoumwBMPzL6Jxuhcul2JKsVxRX8iwgONnPY3daYwCABkvr06lENSGO9AmvyWLSZw/EKm2H2kLAA==";
      };
    };
    "tslib-1.14.1" = {
      name = "tslib";
