...
stdenvNoCC.mkDerivation rec {
  ...
  passthru = {
    sources = {
      "x86_64-darwin" = fetchurl {
        ...
        sha256 = "b2c33968b81ed0a3a0eb573668eaab2d3de268add91b47cbfc712b4ecf15b0ff";
      };
      "x86_64-linux" = fetchurl {
        url = "https://github.com/oven-sh/bun/releases/download/bun-v${version}/bun-linux-x64-baseline.zip";
        sha256 = "809b89b3e1c88343c0219f353d165a40a46a0b78802ccae6fbc51b4e01850ec7";
      };
    };
  ...
  meta = with lib; {
    ...
    maintainers = with maintainers; [ mathletedev ];
