...
rustPlatform.buildRustPackage rec {
  ...
  # The v8 crate will try to download a `librusty_v8.a` release at build time to our read-only filesystem
  # To avoid this we pre-download the file and point to it with RUSTY_V8_ARCHIVE
  preBuild = ''
