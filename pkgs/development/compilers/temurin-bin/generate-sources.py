...
# Enter a GitHub token here to avoid rate limits - use an unprivileged token just in
# case you accidentally commit it ;). TODO make this a parameter.
GITHUB_TOKEN = None

feature_versions = (8, 11, 17, 21, 23)
ea_feature_versions = (24,)
...
for feature_version in ea_feature_versions:
    ...
    asset_descriptions = []
    for asset in resp.json()[0]['assets']:
        name = asset['name']
