...
# bug fix or improvement from newer GHC releases.
#
...
++ lib.optionals (lib.versionOlder version "9.6.7") [
  ...
  (
    if lib.versionOlder version "9.6" then
      ...
      # <https://gitlab.haskell.org/ghc/ghc/-/merge_requests/13841>
      fetchpatch {
        name = "ghc-9.6-llvm-fix-version-detection.patch";
        url = "https://gitlab.haskell.org/ghc/ghc/-/commit/9f9a3b26f16a3f77494ac99439f423facb2dc930.patch";
        excludes = [ "testsuite/*" ];
        hash = "sha256-0xYcjfvuzvbunSua4X5WvzGHZEnbrBnQEJ3BAt251MQ=";
      }
  )
]

++ lib.optionals (lib.versionAtLeast version "9.6" && lib.versionOlder version "9.8") [
  # The backport of !13763 to 9.6 removed an unused import that is
  # required by the next series.
  ./ghc-9.6-llvm-restore-import.patch
]
