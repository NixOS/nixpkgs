...
, filepath, genprimopcode, ghc-boot, ghc-boot-th-next, ghc-heap
, ghci, happy, hpc, lib, os-string, process, rts, semaphore-compat
, stm, time, transformers, unix
}:
mkDerivation {
  pname = "ghc";
  version = "9.14.1";
  ...
  libraryHaskellDepends = [
    ...
    exceptions filepath ghc-boot ghc-boot-th-next ghc-heap ghci hpc
