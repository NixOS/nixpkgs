...
let
  ...
  jdk8 = fetchurl {
             ...
             sha256 = if stdenv.isAarch64 then "1a2adw51af064rzlngsdlhs9gl47h3lv6dzvr8swqgl2n93nlbxa"
                      else "00yw7wkwbqhzni95qyj4rkgly87iidz4c196p8v7ih1jqs5maxzd";
          };
  langtools = fetchurl {
