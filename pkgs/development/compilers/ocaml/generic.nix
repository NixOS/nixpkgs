...
in
  {
    ...
    assert spaceTimeSupport -> lib.versionAtLeast version "4.04"; let
      src =
        args.src
        or (fetchurl {
    ...
    in
      ...
      // {
        ...
        buildInputs =
          optional (!lib.versionAtLeast version "4.07") ncurses
        ...
        preConfigure =
          optionalString (!lib.versionAtLeast version "4.04") ''
            CAT=$(type -tp cat)
