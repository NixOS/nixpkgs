...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/erictapen/ispc/commit/338119b2f4e11fcf0b0852de296c320928e572a2.patch";
      sha256 = "sha256-+RqDq1LMWomu/K4SgK0Nip47b1RwyM6W0cTSNGD4+m4=";
    })
  ];

  nativeBuildInputs =
    [ cmake which m4 bison flex python3 llvmPackages.llvm.dev ];
  buildInputs = with llvmPackages; [ llvm llvmPackages.libclang ];
  ...
  meta = with lib; {
    ...
    platforms =
      [ "x86_64-linux" "x86_64-darwin" ]; # TODO: buildable on more platforms?
