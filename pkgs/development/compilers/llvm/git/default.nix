...
let
  ...
  rev = "3644726a78e37823b1687a7aa8d186e91570ffe2"; # When using a Git commit
  rev-version = "unstable-2021-06-30"; # When using a Git commit
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "0gwcj864crrsylssmynpqpaq5xfp6zsqmrrblpd3lix9q0fbpagc";
  };
