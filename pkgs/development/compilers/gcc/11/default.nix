...
, zlib ? null, gnatboot ? null, enableMultilib ? false, enablePlugin ?
  stdenv.hostPlatform
  ...
  patches = optional (targetPlatform != hostPlatform) ../libstdc++-target.patch
    ...
    */
    ...
    ++ optional (stdenv.isDarwin && stdenv.isAarch64) (fetchpatch {
      url =
        "https://github.com/fxcoudert/gcc/compare/releases/gcc-11.1.0...gcc-11.1.0-arm-20210504.diff";
...
in stdenv.mkDerivation ({
  ...
  nativeBuildInputs = [ texinfo which gettext ]
    ++ (optional (perl != null) perl) ++ (optional langAda gnatboot);
  ...
  configureFlags = import ../common/configure-flags.nix {
    inherit lib stdenv targetPackages crossStageStatic libcCross version
      ...
      langC langCC langFortran langAda langGo langObjC langObjCpp langJit;
  };
