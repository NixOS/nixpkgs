...
let
  ...
  canApplyIainsDarwinPatches =
    ...
    && buildPlatform.equals hostPlatform
    && hostPlatform.equals targetPlatform;
...
++ optional (targetPlatform.notEquals hostPlatform) ./libstdc++-target.patch
++ optionals (noSysDirs) (
...
++
  optional
    (is10 && buildPlatform.system == "aarch64-darwin" && targetPlatform.notEquals buildPlatform)
    (fetchpatch {
