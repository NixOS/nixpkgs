...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (getVersionFile "gcc/find-prefixed-progs.patch")
  ...
  preConfigure =
    ...
    + ''
      ...
      cp ${selfBuildBuild.libbacktrace}/lib/libbacktrace.a "$buildRoot/libbacktrace/.libs/libbacktrace.a"
      cp -r ${selfBuildBuild.libbacktrace}/lib/*.la "$buildRoot/libbacktrace"
      cp -r ${selfBuildBuild.libbacktrace.dev}/include/*.h "$buildRoot/libbacktrace"

      mkdir -p "$buildRoot/libiberty/pic"
      cp ${selfBuildBuild.libiberty}/lib/libiberty.a "$buildRoot/libiberty"
      cp ${selfBuildBuild.libiberty}/lib/libiberty_pic.a "$buildRoot/libiberty/pic/libiberty.a"
