  ...
  f =
    ...
    in
    {
      ...
      gfortran = wrapCCWith rec {
        ...
        extraBuildCommands =
          ''
            echo "-B${targetGccPackages.libgcc}/lib" >> $out/nix-support/cc-cflags
            echo "-B${targetGccPackages.libssp}/lib" >> $out/nix-support/cc-cflags
            echo "-B${targetGccPackages.libatomic}/lib" >> $out/nix-support/cc-cflags
          ''
