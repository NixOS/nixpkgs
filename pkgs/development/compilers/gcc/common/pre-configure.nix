...
# We need to reconfigure the build system when `withoutTargetLibc` is
# set. This is because libstdcxx tries to run link tests, which we
# can't do without a libc.
