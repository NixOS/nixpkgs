...
let
  ...
  llvmSharedForBuild = pkgsBuildBuild.llvmPackages_8.llvm.override { enableSharedLibraries = true; };
  llvmSharedForHost = pkgsBuildHost.llvmPackages_8.llvm.override { enableSharedLibraries = true; };
  llvmSharedForTarget = pkgsBuildTarget.llvmPackages_8.llvm.override { enableSharedLibraries = true; };
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "0jypz2mrzac41sj0zh07yd1z36g2s2rvgsb8g624sk4l14n84ijm";
  };
