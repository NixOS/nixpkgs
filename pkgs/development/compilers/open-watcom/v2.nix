...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "sha256-u9ljy4dZRoXKyUqdolxZijpc99TuhKPPlL6xlV3xJXA=";
  };
  ...
  env.NIX_LDFLAGS = lib.optionalString (stdenv.isDarwin && stdenv.cc.isClang && stdenv.cc.libcxx != null) "-l${stdenv.cc.libcxx.cxxabi.libName}";
