  ...
  edk2 = buildStdenv.mkDerivation {
    ...
    patches = [
      ...
      (fetchpatch {
        ...
        url =
          "https://github.com/google/brotli/commit/0a3944c8c99b8d10cc4325f721b7c273d2b41f7b.patch";
    ...
    makeFlags = [ "-C BaseTools" ] ++ lib.optional (stdenv.cc.isClang)
      [ "BUILD_CC=clang BUILD_CXX=clang++ BUILD_AS=clang" ];

    NIX_CFLAGS_COMPILE = "-Wno-return-type"
    ...
    passthru = {
      mkDerivation = projectDscPath: attrs:
