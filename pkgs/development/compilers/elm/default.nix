{ lib, stdenv, pkgs, haskell, haskellPackages, nodejs, fetchurl, fetchpatch
, makeWrapper, writeScriptBin
# Rust dependecies
  ...
  */
  ...
  elmNodePackages = with elmLib;
    ...
    in with hsPkgs.elmPkgs; {
      ...
      inherit (nodePkgs)
        elm-doc-preview elm-live elm-upgrade elm-xref elm-analyse;
    };

in hsPkgs.elmPkgs // elmNodePackages // elmRustPackages // { lib = elmLib; }
