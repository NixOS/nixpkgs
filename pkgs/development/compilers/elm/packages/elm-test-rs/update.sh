...
# the version is obtained from src/deps.rs
RUNNER_VERSION=$(grep -A 1 'Pkg::new("mpizenberg", "elm-test-runner")' "$WORK_DIR/src/deps.rs" | grep "Range::exact" | sed 's/.*(\([0-9]*\), \([0-9]*\), \([0-9]*\)).*/\1.\2.\3/')
deps+=("mpizenberg elm-test-runner $RUNNER_VERSION")
...
"$(
  ...
  github:dwayne/elm2nix/ea5293850cc98d7acd3f7fc45fc95d9308334e27 \
