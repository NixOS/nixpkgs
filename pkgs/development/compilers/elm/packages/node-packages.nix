...
let
  sources = {
    ...
    "elm-tooling-1.12.0" = {
      ...
      version = "1.12.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-tooling/-/elm-tooling-1.12.0.tgz";
        sha512 = "ySc57WhLltqqpBmkYp9EGuDfd8+PhVgin3fYdAU5MvoOLLRf5O+6oHl26XK37T3FEH6yLi5zEHauYgNTGeHbwg==";
      };
    };
