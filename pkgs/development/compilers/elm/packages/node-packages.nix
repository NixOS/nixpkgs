...
in
{
  ...
  "@elm-tooling/elm-language-server" = nodeEnv.buildNodePackage {
    ...
    version = "2.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@elm-tooling/elm-language-server/-/elm-language-server-2.0.1.tgz";
      sha512 = "dHD0Ym5G7WFLX+NB5s71n4EOONHTzKMLjmWaJJIC5IG4zNAL/FsqCOnjMxHQbqzzXRPUx2nk3P9RZOGC5UugBA==";
    };
    dependencies = [
