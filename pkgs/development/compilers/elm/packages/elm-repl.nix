...
, containers, directory, elm-compiler, elm-package, fetchgit, filepath
, haskeline, HUnit, mtl, parsec, QuickCheck, stdenv, test-framework
...
mkDerivation {
  ...
  src = fetchgit {
    ...
    sha256 = "0x188kk2h6ij1znzz5rfcnr0hl6ibipdlxabzl5905b8z3qhrm9n";
