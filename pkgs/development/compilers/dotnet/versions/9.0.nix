  ...
  aspnetcore_9_0 = buildAspNetCore {
    ...
    srcs = {
      ...
      osx-arm64 = {
        ...
        hash = "sha512-eyCHMuOsE1gfFXPL2ofYhx36YT26WHsUfHIFPmi9uKvO4p+mFmK3q3IgItjmdGeyEn/jjNaYqTb+GYmJp2a1dw==";
      };
      osx-x64 = {
        url = "https://builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/9.0.5/aspnetcore-runtime-9.0.5-osx-x64.tar.gz";
        hash = "sha512-hK7nZ9GJqvV4JzAgBiKI8I9cxGoxhPufMEUZuIcJ8fFLb5ACq9IzZdz9ojrFmoltQpeDPcFBGRe6TXYQd50IOw==";
      };
    };
  };
  ...
  runtime_9_0 = buildNetRuntime {
    ...
    srcs = {
      ...
      osx-arm64 = {
        ...
        hash = "sha512-gJ2LNvTRMzsOAMzSma0l0cr05mn7QdgU/OTv0SNHsQR+GMzGyjBC/oEySpuTFCxfnFho3hYnOVbgH5lC0B2ULw==";
      };
      osx-x64 = {
        url = "https://builds.dotnet.microsoft.com/dotnet/Runtime/9.0.5/dotnet-runtime-9.0.5-osx-x64.tar.gz";
        hash = "sha512-eTLIFs9MmxPVlMpbtxa27ujdCamFnQTbQfkWF5/cgGpCgB1RhV2crVzv6LuTxQG3dmQKFb6a1W2pinTx+R1TBA==";
      };
    };
  };
  ...
  sdk_9_0_2xx = buildNetSdk {
    ...
    srcs = {
      ...
      osx-arm64 = {
        ...
        hash = "sha512-8OkS47e04fJevmsIDE512byp76GyzzkUmqMUmYFlNq0d6wxmVPCfqmDh16VNV1/4mnM1I21zF8haTEjFClzyDg==";
      };
      osx-x64 = {
        url = "https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.204/dotnet-sdk-9.0.204-osx-x64.tar.gz";
        hash = "sha512-X19pVRAE4Ajhwgsc3lgcIToab7/FmZj6MhUWaKhaUt/4+GoqyN+nCBQLEOGGEX7rnX7Vow+ASQaeyZycFnmKWQ==";
      };
    };
    inherit commonPackages hostPackages targetPackages;
    runtime = runtime_9_0;
  ...
  sdk_9_0_1xx = buildNetSdk {
    ...
    srcs = {
      ...
      osx-arm64 = {
        ...
        hash = "sha512-9bf8CKlT4aUr8oizuvZ7+amZUeJrQ/iscX6eN34QJiVSPgwFkQWUiAIoDRyGljxonZGzCk/0PHBllIyHvhIrpA==";
      };
      osx-x64 = {
        url = "https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.106/dotnet-sdk-9.0.106-osx-x64.tar.gz";
        hash = "sha512-jJvbodCyiUBZ9J1IS3MvKblHTt3nSuS/9liJmGv+BgOM6iP9FCx8VXCX3mXLpsjJEIfthOAZAqSujHvFHLvp+w==";
      };
    };
    inherit commonPackages hostPackages targetPackages;
    runtime = runtime_9_0;
