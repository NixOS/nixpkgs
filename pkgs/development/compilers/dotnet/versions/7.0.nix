...
# v7.0 (active)
{
  ...
  sdk_7_0 = buildNetSdk {
    ...
    srcs = {
      x86_64-linux = {
        url     = "https://download.visualstudio.microsoft.com/download/pr/4d8ba1a1-4241-4735-bac7-8d8c9f69832a/2c0f2741c551eb49c37fc941ed4d04bf/dotnet-sdk-7.0.200-linux-x64.tar.gz";
      ...
      aarch64-linux = {
        url     = "https://download.visualstudio.microsoft.com/download/pr/2fefd13b-24e6-4c0c-b3ad-a7285c6b9480/00d9e656a4263e002dab53d9ef901b75/dotnet-sdk-7.0.200-linux-arm64.tar.gz";
      ...
      x86_64-darwin = {
        url     = "https://download.visualstudio.microsoft.com/download/pr/3dbc2141-13e7-435f-baf1-356345a89e9a/147b4382943eaedfdc36827ac8dd49bc/dotnet-sdk-7.0.200-osx-x64.tar.gz";
        sha512  = "487f753bd8bbacbe60da6c8c161fa710fb12a5ed2e0b1f2dfd7fb1bd37a56e8cc5fff9c75ca90ede3447353eb3cd08287e44fe1420b69eb5c8e9651277d99c74";
      };
      aarch64-darwin = {
        url     = "https://download.visualstudio.microsoft.com/download/pr/44ffe43b-29d3-4dc1-b020-14db7e907228/bd849660e6f7ba54495326973408a4eb/dotnet-sdk-7.0.200-osx-arm64.tar.gz";
        sha512  = "dc14ba208f89301577cfe4ca6a1901db92f05f9e0f15a4731012adfb3d7010382a18f41e0df91d132cb481653689cc31db4c8628f453c607d665c4237e7b49ed";
      };
    };
    packages = { fetchNuGet }: [
