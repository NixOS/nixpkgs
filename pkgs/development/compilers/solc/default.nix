...
in
{
  solc_0_8_11 = makeSolc {
    version = "0.8.11";
    linuxHash = "sha256-HZxxd4Xg+BlOipfotYL8IRdNvq4tESRFd4xy3wR/JqQ=";
    macosHash = "sha256-EM3MjY6k3en9i5U7lYhdxzfyS4ox/qZfRxX/0Ae4AoE=";
  };
  solc_0_8_13 = makeSolc {
    version = "0.8.13";
    linuxHash = "sha256-cFC9M65kSYgYq9rhBXZKEdfvIMbMaDiDwdPmU8v9s7k=";
    macosHash = "sha256-FNTvAT6oKtlekf2Um3+nt4JxpIP/GnnEPWzFi4JvW+o=";
  };
}
