{ lib, gccStdenv, fetchzip, boost, cmake, coreutils, fetchpatch, ncurses
, python3, z3Support ? true, z3 ? null, cvc4Support ? gccStdenv.isLinux
, cvc4 ? null, cln ? null, gmp ? null }:
...
let
  ...
  solc = gccStdenv.mkDerivation rec {
    ...
    cmakeFlags = [ "-DBoost_USE_STATIC_LIBS=OFF" ]
      ++ lib.optionals (!z3Support) [ "-DUSE_Z3=OFF" ]
