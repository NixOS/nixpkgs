...
let
  glslang = fetchFromGitHub {
    ...
    sha256 = "sha256-BAgDQosiO3e4yy2DpQ6SjrJNrHTUDSduHFRvzWvd4v0=";
  };
  spirv-tools = fetchFromGitHub {
    owner = "KhronosGroup";
    repo = "SPIRV-Tools";
    rev = "d9446130d5165f7fafcb3599252a22e264c7d4bd";
    sha256 = "sha256-fuYhzfkWXDm1icLHifc32XZCNQ6Dj5f5WJslT2JoMbc=";
  };
  spirv-headers = fetchFromGitHub {
    owner = "KhronosGroup";
    repo = "SPIRV-Headers";
    rev = "c214f6f2d1a7253bb0e9f195c2dc5b0659dc99ef";
    sha256 = "sha256-/9EDOiqN6ZzDhRKP/Kv8D/BT2Cs7G8wyzEsGATLpmrA=";
  };
in
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "shaderc";
    rev = "v${version}";
    sha256 = "sha256-/p2gJ7Lnh8IfvwBwHPDtmfLJ8j+Rbv+Oxu9lxY6fxfk=";
  };
