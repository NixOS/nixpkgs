  ...
  src =
    let
      ...
      getHash =
        arch:
        {
          "macos-aarch64" = "sha256-lSoFbVvtIMejbSYhrDRNdvuFCdH8HLrX0+Yl9pz1hYE=";
          "macos-x86_64" = "sha256-EZFTSzLUiDJWYeU9YmzzNqH+TdyDTZctRkC4dKQWFKo=";
          "linux-x86_64" = "sha256-7Xcq8WSOrQbazlqw8WVFKo45VTgcJsOT1L6nanEQioE=";
        }
        .${arch};
    in
    fetchurl {
