...
if (version == "2.095.1") then callPackage ./sourcebuild.nix ({
  ...
  HOST_DMD = "${callPackage ./bootstrap.nix { }}/bin/dmd";
  dmdSha256 = "sha256:0rbbsxz91sp9kmn8qjkqjbx5p49l4xldjf55bay22nc6v6k5p3mk";
  druntimeSha256 = "sha256:18jwqvls0dwjxr1zf76igybrr5kq0p1raskm26hrih9jh47vlpdx";
  phobosSha256 = "sha256:1ipa3804zqnvywqw0g7rcy3vvd16sik2gvhjg1r8klnqviizvhgh";
} // args)
