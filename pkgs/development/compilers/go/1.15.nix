...
, patch, procps, pcre, cacert, Security, Foundation, mailcap, runtimeShell
, buildPackages, pkgsBuildTarget, fetchpatch, callPackage }:
...
in stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/golang/go/commit/58fe2cd4022c77946ce4b598cf3e30ccc8367143.patch";
