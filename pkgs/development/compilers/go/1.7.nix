...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "0rg7061k0yc0ds456nyk21gpfcgq64a112pxzlwkn489m07p6m1z";
  };
  ...
  prePatch = ''
    ...
    # Remove cgo DNS tests (they require a working resolver)
    sed -i '/TestCgoLookupPort/areturn' src/net/cgo_unix_test.go
    sed -i '/TestCgoLookupPortWithCancel/areturn' src/net/cgo_unix_test.go
    sed -i '/TestCgoLookupPTR/areturn' src/net/cgo_unix_test.go
    sed -i '/TestCgoLookupPTRCancel/areturn' src/net/cgo_unix_test.go
