...
{ useGccGoBootstrap, goBootstrap, version, hash, patches }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  preInstall = lib.optionalString (lib.versionOlder finalAttrs.version "1.20") ''
    rm -r pkg/obj
  '' + ''
  ...
  installPhase = ''
    ...
    cp -a bin pkg src lib misc api doc${lib.optionalString (lib.versionAtLeast finalAttrs.version "1.21") " go.env"} $GOROOT_FINAL
    mkdir -p $out/bin
