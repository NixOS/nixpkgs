...
selfPop (gerbil-support: with gerbil-support; {
  inherit POP;
  ...
  prePackage-defaults = pop { defaults = {
  ...
  gerbilPackages-unstable =
    builtins.mapAttrs (_: gerbilPackage) (unpop prePackages-unstable);
  ...
  pkgsOverrideGerbilPackageSrc = name: pre-src: pkgs: super: {
    gerbil-support = extendPop super.gerbil-support (_: super: {
      prePackages-unstable = extendPop super.prePackages-unstable (_:
