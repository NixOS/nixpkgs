...
AER = derive { name="AER"; version="1.2-4"; sha256="0cfhnh6ijwvbywk6falfq852jgx969v35j2l1q3cghwj9yggapbh"; depends=[car lmtest sandwich survival zoo Formula]; };
...
APSIM = derive { name="APSIM"; version="0.8.0"; sha256="0ph4wl6c9jy2w0w3yh8ba12nqbsldicpn2aii675vrvdrx36vwn7"; depends=[data_table lubridate stringr plyr sirad]; };
...
ARTool = derive { name="ARTool"; version="0.9.5"; sha256="1wfan4v3498libqgjdgn4l4ihf1khp3smj0lmyxd7vb4iaawlzci"; depends=[lme4 car plyr pbkrtest]; };
...
ApacheLogProcessor = derive { name="ApacheLogProcessor"; version="0.1.5"; sha256="1xnx6syn365s4w4pks7xq6rng7hk30xln8hvszxwhwfnkzr8qqn2"; depends=[foreach doParallel]; };
...
BayesGESM = derive { name="BayesGESM"; version="1.4"; sha256="0qw2byb48f67461m1k8a1rqh6a0c3zq1rc4ni9xzxv8dih4wkq0f"; depends=[GIGrvg normalp Formula]; };
...
BrailleR = derive { name="BrailleR"; version="0.20"; sha256="1cfg5jfhal77n1pmwcj0awhnprqw6bha7q7z3s2m3q4g1ar49shv"; depends=[knitr gridGraphics gridSVG moments nortest rmarkdown xtable]; };
...
ClustVarLV = derive { name="ClustVarLV"; version="1.4.0"; sha256="1dm4vyfq4mf9y2ha32fhirqyss4yjk5zxrb9i3fx4i8kbaw6160z"; depends=[Rcpp Rcpp]; };
...
CorReg = derive { name="CorReg"; version="1.0.5"; sha256="1b7l17i33bqvdzgqw5vc73fnpdgqbr01456qgmxls80ji8qjiv9x"; depends=[Rcpp lars Rmixmod elasticnet corrplot Matrix ridge rpart MASS mvtnorm mclust Rcpp RcppEigen]; };
...
DNMF = derive { name="DNMF"; version="1.3"; sha256="09yp6x6vd44ahklcag96fpjgyphyn45rkqkbwr1n36a2d8vxk9nc"; depends=[foreach Matrix gplots doParallel]; };
...
EditImputeCont = derive { name="EditImputeCont"; version="1.0.0"; sha256="1ghrax514hm8zymmaifwbls4wpic8qqzlf83p615k3d96p4lb304"; depends=[Rcpp editrules Rcpp]; };
...
FAOSTAT = derive { name="FAOSTAT"; version="2.0"; sha256="06z8c964sf73ld4v9vybqjsdxskxp3ssyv0a3mpcs9la5y7n9jaz"; depends=[RJSONIO plyr data_table MASS classInt ggplot2 labeling scales]; };
...
IATscores = derive { name="IATscores"; version="0.1-2"; sha256="0grl5m4ccwaxvhg1bziy3vv5jffkvr24z268ws5m4ia20haif0dm"; depends=[stringr dplyr reshape2 qgraph]; };
...
IFP = derive { name="IFP"; version="0.2.0"; sha256="02dm2qbnrs2yi6c64j90hdfimmdsld46k1wdkay8pfg62jy9rrwa"; depends=[haplo_stats coda]; };
...
JBTools = derive { name="JBTools"; version="0.7.2.9"; sha256="0bynqn3daqgmi3l9asy34mfwyfjkn35k465dfqqi3xwx6cbzlg5k"; depends=[foreach gplots colorspace plotrix]; };
...
MLCIRTwithin = derive { name="MLCIRTwithin"; version="1.0"; sha256="01fp2pyiwpzsby3iwn9w9ry4nksy2llwzawrmba80s5m7mrcljbn"; depends=[MASS limSolve MultiLCIRT]; };
...
MM2S = derive { name="MM2S"; version="1.0.0"; sha256="0g5x375c58xsihj43dh19hx6vh87f8ppjibik5sb7lxvl1xms49c"; depends=[kknn lattice pheatmap]; };
...
MVN = derive { name="MVN"; version="4.0"; sha256="1ql50ch6qig7r0xnfv5f74k3vc32k04jgmvjbndgyzbacn2ibrm7"; depends=[nortest moments MASS robustbase mvoutlier plyr psych]; };
...
NHMSAR = derive { name="NHMSAR"; version="1.1"; sha256="1qbgxb684qwcb29x95a48r6bndqwdi1drwzimkhkb2ldm98yga3z"; depends=[ucminf lars SIS caTools glasso]; };
...
OpasnetUtils = derive { name="OpasnetUtils"; version="1.2.0"; sha256="1ckagq14w9923a4x7pk9mfzqcfayi00apwd2kvqzgd0s6355r1q7"; depends=[rjson RCurl reshape2 triangle httpRequest digest xtable ggplot2 rgdal sp plyr]; };
...
PEIP = derive { name="PEIP"; version="2.0-1"; sha256="0zfvp3ngc4320sh6r6y746zxigr2wqgaqasnlkv3hxhzpzxq08lj"; depends=[bvls Matrix RSEIS pracma]; };
...
PrevMap = derive { name="PrevMap"; version="1.1.5"; sha256="0bzk09ygz4i3v8s39p0n157wrylp38h5xz32f18py8gr776x311n"; depends=[geoR maxLik raster pdist splancs]; };
...
R2WinBUGS = derive { name="R2WinBUGS"; version="2.1-20"; sha256="052frb3qlqfy6zl0qd2a9d4w2s7prfvdb0vn45rns68q03dma1ml"; depends=[coda boot]; };
...
RMark = derive { name="RMark"; version="2.1.13"; sha256="04wrl4i3d6kwy4masqc17qab24jv8p3kbfcx2z5l11wyf84xaqgx"; depends=[snowfall matrixcalc msm coda]; };
...
RSAGA = derive { name="RSAGA"; version="0.94-1"; sha256="0zr3rm3s5pf2l2gkvbsr60srj6s1xx7kn26krpbzz3xqgbfgmz6k"; depends=[gstat shapefiles plyr]; };
...
Rcell = derive { name="Rcell"; version="1.3-2"; sha256="1gfbwarbnv70sawaxv71har1m099icc2347wdvrz3hwmfgw6qm8n"; depends=[proto plyr reshape ggplot2 digest]; };
...
RcmdrPlugin_UCA = derive { name="RcmdrPlugin.UCA"; version="2.0-4"; sha256="066h5idmmjng4i1n84rbvqgjnj7f1xrj32l1icm1dw3gsh2ipa5l"; depends=[Rcmdr randtests tseries]; };
...
RcppArmadillo = derive { name="RcppArmadillo"; version="0.5.200.1.0"; sha256="0vz0yl5k0q57xrnjpz1bxs6j3hpysp1mkcxf5fs6xdy6nzaqsr7x"; depends=[Rcpp Rcpp]; };
...
RcppFaddeeva = derive { name="RcppFaddeeva"; version="0.1.0"; sha256="1rah18sdfmbcxy83i7vc9scrwyr34kn9xljkv9pa31js68gn2jrl"; depends=[Rcpp knitr Rcpp]; };
...
RefManageR = derive { name="RefManageR"; version="0.8.63"; sha256="17gmdyaqg8swfhpa1n8h1rj7aamrgdcprf56vx643ivhih8kgdj4"; depends=[XML RCurl RJSONIO plyr bibtex lubridate stringr]; };
...
RevEcoR = derive { name="RevEcoR"; version="0.99.2"; sha256="100sman51vvwg5xkypmksyyjqdb6g858z29vn7x4kvly8ncw4hfd"; depends=[Matrix igraph XML stringr magrittr gtools plyr]; };
...
RobustEM = derive { name="RobustEM"; version="1.0"; sha256="1li9r3bk7zhpxljgqvr2zila8nb05nasvlzqlswwgi9443i740zi"; depends=[mvtnorm e1071 ggplot2 ellipse doParallel foreach]; };
...
Rphylopars = derive { name="Rphylopars"; version="0.1.1"; sha256="04qd6zzgjgrfnv3ffv3jzlcl4ilfb67fxza49qq4rzinxc2s392b"; depends=[ape Rcpp doBy geiger phylolm phytools mvnmle Rcpp RcppArmadillo]; };
...
SemiParBIVProbit = derive { name="SemiParBIVProbit"; version="3.4"; sha256="038k5vvgrk20n2cbji8qrp9nkg0ck5dcbxnd7wc5hy1l780g4k5g"; depends=[mgcv magic VGAM survey trust VineCopula]; };
...
SpatialExtremes = derive { name="SpatialExtremes"; version="2.0-2"; sha256="0ywybk9gziy2hzb1ks88q4rzs3lzzy6y3fzhja2s39ngg195hi6l"; depends=[maps fields]; };
...
SpatialVx = derive { name="SpatialVx"; version="0.2-4"; sha256="0nm3mripq1fiqn7ydl854azwpl1sdh2ls8gj1k432xsvi02m05y3"; depends=[spatstat fields smoothie smatr turboEM distillery maps boot CircStats fastcluster waveslim]; };
...
StMoMo = derive { name="StMoMo"; version="0.2.0"; sha256="1pddlwf3kns9fzmqddfak6bir0mc1i4bv9cswj5pbhpavsd08r1c"; depends=[gnm forecast MASS rootSolve fanplot reshape2 fields]; };
...
Surrogate = derive { name="Surrogate"; version="0.1-61"; sha256="0jifjns0v22risy783a0s71v6sn165wn7w6a47sb7dsdimrvnn9d"; depends=[MASS nlme msm lme4 rgl lattice latticeExtra]; };
...
TAM = derive { name="TAM"; version="1.7-1"; sha256="1zsgdilxh7j7ay74a5id7iwm0mz3vf1rcgw7fvclic1ndwwj68z3"; depends=[CDM MASS Rcpp mirt lavaan WrightMap tensor sfsmisc GPArotation psych mvtnorm msm lattice plyr Rcpp RcppArmadillo]; };
...
TOC = derive { name="TOC"; version="0.0-2"; sha256="0zkwbjyi5dc6y0fzmwkbyrf32h0r5vhxxz67zjrhqc06vyasai8w"; depends=[raster bit rgdal]; };
...
VineCopula = derive { name="VineCopula"; version="1.5"; sha256="1ifb7y0y1b5kha9nv395mlf3h3cczlqkvk782a2z0xy5vf0frfhi"; depends=[MASS mvtnorm igraph copula ADGofTest lattice]; };
...
arqas = derive { name="arqas"; version="1.0"; sha256="1wqrvrmwpgkccr8vi0kn6xiy191ib1zxzrclb6v564bkj16s2w5q"; depends=[distr ggplot2 reshape iterators doParallel foreach fitdistrplus gridExtra]; };
...
backShift = derive { name="backShift"; version="0.1.1"; sha256="11mr2pdg63xa5yrybv91fxz69jizpshs67i7a8lb84n6ydaq1pj3"; depends=[jointDiag clue pcalg igraph matrixcalc reshape2]; };
...
bayesDccGarch = derive { name="bayesDccGarch"; version="1.1"; sha256="1gjba5c9vfgvhlard6k47rc2f4r497qy4ybjwr57rm3n3jb0vkl1"; depends=[numDeriv coda]; };
...
blme = derive { name="blme"; version="1.0-3"; sha256="0kr2svvjbsravvahg96f6q2whfgyx2y4wgbpj9caf3rc2bd5s4nj"; depends=[lme4]; };
...
cccd = derive { name="cccd"; version="1.5"; sha256="0m364zsrgr7mh1yhl2lqxpaf71gzq3y3pp9qgnj4spiy4iadyy7i"; depends=[igraph proxy deldir FNN]; };
...
cem = derive { name="cem"; version="1.1.16"; sha256="1crljw5ry3hynmfg9xfnbm3ypy57m33885xg39m88gzi6ydrnsvk"; depends=[lattice MatchIt combinat randomForest nlme]; };
...
clustMD = derive { name="clustMD"; version="1.1"; sha256="192li0nx2hwhh5y21xs70vrnzw3wxbzr95f06makaxcrwf4xlp16"; depends=[tmvtnorm mvtnorm truncnorm MASS mclust msm]; };
...
coefficientalpha = derive { name="coefficientalpha"; version="0.5"; sha256="0pfw64z7f0gp415nn7519rcw829a7wnwnjx94sc55jsvgb1di3kc"; depends=[rsem lavaan]; };
...
coreNLP = derive { name="coreNLP"; version="0.4-1"; sha256="0a6pc588ddi9qyi5gsnzzvm4k0p5sp5bnjrlsskaymzdq4rp6miz"; depends=[rJava XML plotrix]; };
...
cowplot = derive { name="cowplot"; version="0.3.1"; sha256="0sqnirrwm0x2gbmblrvpdghd4v76mhczkhlhr4nd7yjz4947gfcp"; depends=[ggplot2]; };
...
dMod = derive { name="dMod"; version="0.1"; sha256="0170hvgngwxr0qfl7knmj0l2gg053xj5yfd5hkfyjnl6ivcsw3c9"; depends=[cOde trust ggplot2]; };
...
datastepr = derive { name="datastepr"; version="0.0.1"; sha256="1dzx7mw9hl2f8q638m3vwva7mdlb59bgjc5rmpcjb5nxmylpx0vk"; depends=[dplyr lazyeval R6 magrittr rlist]; };
...
decctools = derive { name="decctools"; version="0.2.1"; sha256="01h119gdvvbfnqfxaca7ca0yhpp6wggq0b69k6ww5lnkfnlj0sgi"; depends=[XLConnect stringr XML reshape2 RCurl lubridate plyr]; };
...
decompr = derive { name="decompr"; version="4.0.0"; sha256="161y5fyy5yqbsl68q9bd4b0s87c3qzv7x9jrzb2k9lxhm4h8qh0w"; depends=[]; };
...
distcomp = derive { name="distcomp"; version="0.25.1"; sha256="04cq4hsv1yl65cchhran9s3844w4knsbfja5wxfib5gh4dadriwk"; depends=[survival shiny httr digest jsonlite stringr R6]; };
...
dplR = derive { name="dplR"; version="1.6.3"; sha256="0w94rdkpw5pbl9ywfvgpmzkwc88m5d5dwii5kw312nfhkb549q4x"; depends=[lattice Matrix digest gmp matrixStats png R_utils stringi stringr XML]; };
...
dygraphs = derive { name="dygraphs"; version="0.4.5"; sha256="08bc41d0f8adfnhv668p9sk4507i63xlfs3yswig1g7c0cnyaba9"; depends=[magrittr htmlwidgets zoo xts]; };
...
effects = derive { name="effects"; version="3.0-4"; sha256="0ypw49gighmg2azc2872y8r9rx9v3x0r2gsidgkwqlaqg95vfcd7"; depends=[lme4 nnet lattice colorspace]; };
...
ergm_graphlets = derive { name="ergm.graphlets"; version="1.0.3"; sha256="0xk45ialjckvjs96k19skk7imilcahgyzfwc74h6yand5q3mg6fz"; depends=[network ergm statnet_common ergm]; };
...
etasFLP = derive { name="etasFLP"; version="1.3.0"; sha256="1qh8s9ikd2lpchpp4h9z4zvcd9l2gi15dg0i54nxg9acn92yn3hi"; depends=[mapdata rgl fields maps]; };
...
fbroc = derive { name="fbroc"; version="0.2.1"; sha256="06qpdnh86klkbwiv593l57wnbamrmcj5ysabyrbjf9mr8mjzhkkj"; depends=[ggplot2 Rcpp Rcpp]; };
...
ffbase = derive { name="ffbase"; version="0.12.1"; sha256="1qgmk1cn8s89amfmzzr2zhg6w4wwn4k79i92ib15j02i4csvykjj"; depends=[ff fastmatch bit]; };
...
fishmethods = derive { name="fishmethods"; version="1.8-0"; sha256="1n5wwwnggflq2y7j3m3kf324mwdhf45ihi25gbqyv79qklg5xcai"; depends=[MASS boot bootstrap]; };
...
gMWT = derive { name="gMWT"; version="1.0"; sha256="12ryjpq0k3brw4xy4f6j89zm94j6phbzn9ga0nr9bzfvslhqjhna"; depends=[clinfun Rcpp Rcpp RcppArmadillo]; };
...
ggvis = derive { name="ggvis"; version="0.4.2"; sha256="07arzhczvh2sgqv9h30n32s6l2a3rc98rid2fpz6kp7vlin2pk1g"; depends=[assertthat jsonlite shiny magrittr dplyr lazyeval htmltools]; };
...
gmnl = derive { name="gmnl"; version="1.1"; sha256="1dz7fhacys88hpf13pbqc9ba37qhwspq7j5zqfy1bg4py1hsx1q7"; depends=[maxLik Formula plotrix msm mlogit truncnorm]; };
...
gstat = derive { name="gstat"; version="1.0-23"; sha256="0as4afwlwzmi37k8sbm0kssin8mikrny88smb71c0wf616yba4xi"; depends=[lattice sp zoo spacetime FNN]; };
...
hybridEnsemble = derive { name="hybridEnsemble"; version="1.0.0"; sha256="08y11cmlhnl456wxsvh3ll1f9ywkmgqjwlwr3v3qhm54nlanwvkr"; depends=[randomForest kernelFactory ada rpart ROCR nnet e1071 NMOF GenSA Rmalschains pso AUC soma genalg reportr nnls quadprog tabuSearch rotationForest FNN glmnet]; };
...
hypervolume = derive { name="hypervolume"; version="1.3.0"; sha256="07pnbkdqm4jssv6h31q68mawckiyxczsjfw4gndpyvxnl44p0qrz"; depends=[Rcpp rgl MASS geometry ks fastcluster Rcpp RcppArmadillo]; };
...
icenReg = derive { name="icenReg"; version="1.2.4"; sha256="0fqwg1xmks9zkmbnr1dala4b13l85ibqfd96w4vvrfhmvakqra1r"; depends=[survival foreach]; };
...
idm = derive { name="idm"; version="1.0"; sha256="001zvhw38qgq1l66yxz5kchvjspijdvqwgrdvh5ykiqifi8kc5xm"; depends=[corpcor ggplot2 dummies animation ca]; };
...
inferference = derive { name="inferference"; version="0.4.62"; sha256="12iag6l2digxb056qc765xi27ayc4qyqdqzbhxscr8a5lxfkdn4p"; depends=[numDeriv lme4 Formula]; };
...
jagsUI = derive { name="jagsUI"; version="1.3.7"; sha256="1zdrqxzjip4lgf99b4z76gvlhbmh0gcbkpghrlrj3j25wqzgn5y0"; depends=[lattice rjags coda]; };
...
kineticF = derive { name="kineticF"; version="1.0"; sha256="1k54zikgva9fw9c4vhkc9b0kv8sq5pmc962s8wxr6qv97liv9p46"; depends=[circular lqmm splancs sp plotrix MASS]; };
...
kwb_hantush = derive { name="kwb.hantush"; version="0.2.1"; sha256="0rjnhhzvjhhl0r2ixz9vkgnqkrnnk772253zy7xkpadj7ws69jsf"; depends=[lattice hydroGOF]; };
...
lfl = derive { name="lfl"; version="1.1"; sha256="1hrdhp2r17qwns5hya9sl03q93h934whqyqsn8mdrsavc64i649v"; depends=[Rcpp foreach forecast plyr tseries e1071 zoo Rcpp]; };
...
list = derive { name="list"; version="8.0"; sha256="09qpcsygs2clbgd42v6klgh1vjhv64s56ixxqlcpg9v7xqnms56j"; depends=[sandwich VGAM magic gamlss_dist MASS quadprog corpcor mvtnorm coda]; };
...
lmSupport = derive { name="lmSupport"; version="2.9.2"; sha256="0mdl5ih7zzxynawxx4prh08nq451x74bfw4ga7cygl2ahi6vqq50"; depends=[car psych gvlma AICcmodavg lme4 pbkrtest]; };
...
loopr = derive { name="loopr"; version="1.0.1"; sha256="1qzfjv15ymk8mnvb556g2bfk64jpl0qcvh4bm3wihplr1whrwq6y"; depends=[plyr dplyr magrittr lazyeval R6]; };
...
lsmeans = derive { name="lsmeans"; version="2.18"; sha256="1wnpn4hngjcfr44apsw85g3x4wm3ma7msg2n4dnadj0w0zbf0fq4"; depends=[estimability coda multcomp plyr mvtnorm]; };
...
metaSEM = derive { name="metaSEM"; version="0.9.4"; sha256="1d790z462g9qnrxl5p3a50abaachc2wih10zsk6jpbf10z694g13"; depends=[OpenMx Matrix MASS]; };
...
metaplus = derive { name="metaplus"; version="0.7-2"; sha256="1d9528z78vmkmv67s29g87kfdwydfwx4cnbcdmd0kq8rch9zjk07"; depends=[bbmle metafor boot numDeriv lme4 MASS]; };
...
mlVAR = derive { name="mlVAR"; version="0.1.0"; sha256="0xychak3xdqnsl9z1ifi0niqsrdc10f6frl6zg162mzpil33wp3g"; depends=[plyr lme4 arm qgraph]; };
...
mlxR = derive { name="mlxR"; version="2.2.0"; sha256="1ca0vfky45gvr2rqbgli79v1mqhi0d8mpd220xxs1p6xlwbyvn0m"; depends=[ggplot2 XML Rcpp]; };
...
mnlogit = derive { name="mnlogit"; version="1.2.2"; sha256="01wvlmkf9ddcmsb8pw08j05r7kfn8zr76zaaa3mv92h967v79grp"; depends=[mlogit lmtest Formula]; };
...
mpath = derive { name="mpath"; version="0.1-18"; sha256="04d6lbsqjmr6pkyfpr2vw3rhv5hi044rx1n1isgw96j2c0f7dgzv"; depends=[MASS glmnet pscl numDeriv]; };
...
mplot = derive { name="mplot"; version="0.6.2"; sha256="0lnslv471abhfr245wx24ps3c97qs54i43ybpc1f8mqsxh0vxz3s"; depends=[leaps foreach bestglm doParallel plyr shinydashboard shiny googleVis]; };
...
nodeHarvest = derive { name="nodeHarvest"; version="0.7-2"; sha256="18lmp7mly3ad95yz2cv330bg7y9fwldvagnzvjx0zgsx81f3bncr"; depends=[quadprog randomForest]; };
...
nonlinearTseries = derive { name="nonlinearTseries"; version="0.2.2"; sha256="1p78a9nqn53v9r885p4lg47vqlryw7335pxrid191xqabxxs3ba7"; depends=[Matrix rgl tseries TSA Rcpp Rcpp]; };
...
optCluster = derive { name="optCluster"; version="1.0.0"; sha256="1qpymgdy4pcl5isz88m2bb734c2c2qlh77c0i8c1wy4hkrx5ndpl"; depends=[clValid RankAggreg mclust cluster gplots kohonen MBCluster_Seq]; };
...
parallelSVM = derive { name="parallelSVM"; version="0.1-8"; sha256="19hmagv95nx8aw8xylk5vvpxw9a4fsa68r9q0x6irhq50wmah93r"; depends=[e1071 foreach doParallel]; };
...
parfm = derive { name="parfm"; version="2.5.8"; sha256="05bzmm5ahaip5apsv84fbqy8bag9pkkfsxvqw1cbcvlbr2zyxfgp"; depends=[survival eha msm]; };
...
party = derive { name="party"; version="1.0-21"; sha256="10kk3mw9kbkzhh5qacmq404d1r0scin2vc33wsf152lgc9fhs1xx"; depends=[mvtnorm modeltools strucchange survival coin zoo sandwich mvtnorm]; };
...
pavo = derive { name="pavo"; version="0.5-2"; sha256="13iy9dmg19v0gqg12224ci0zq8fa0ap2i0is8v0rkfp19wzy0ryg"; depends=[rgl geometry mapproj rcdd]; };
...
pcnetmeta = derive { name="pcnetmeta"; version="2.2.1"; sha256="0y4sn1aby38c458667fsy2ndq64i8kknmzdc32mbvzd530p1yxai"; depends=[rjags coda]; };
...
pedometrics = derive { name="pedometrics"; version="0.6-2"; sha256="137685gyd7k9vpjnsy6h280cdbl15bchrizfnalnz6nizi0q85lj"; depends=[car gstat Hmisc lattice latticeExtra MASS moments plyr pbapply Rcpp sp spsurvey xtable Rcpp]; };
...
pomp = derive { name="pomp"; version="0.65-1"; sha256="1fxfbqa6lb4x0d4h29in8crhac32aw71chyjyvnhadfqynxhhv4k"; depends=[mvtnorm deSolve coda subplex nloptr]; };
...
provenance = derive { name="provenance"; version="0.2"; sha256="07wgfb5hmdd4nddl42wpqsx9vzayvngrgmcsssilbm5qbrvgv4sr"; depends=[MASS smacof vegan shapes]; };
...
quanteda = derive { name="quanteda"; version="0.7.2-1"; sha256="1j6hjcr3sd1xymzznvz1r2z6rs3m6vp3ji5y6dqq5qr18g1bi4cm"; depends=[Matrix data_table SnowballC wordcloud proxy Rcpp ca Rcpp RcppArmadillo]; };
...
rNOMADS = derive { name="rNOMADS"; version="2.1.4"; sha256="0a0knxqqbn52i4ixpv16h1hnajhwx788cmdiq78ysds7yfkjrwzy"; depends=[rvest scrapeR stringr fields GEOmap MBA RCurl XML]; };
...
rchallenge = derive { name="rchallenge"; version="1.1"; sha256="1qad0mcadr3zw5r37rgwnqf4ic9brlw3zl5n4jcxyaj324fj4pa3"; depends=[rmarkdown knitr]; };
...
reconstructr = derive { name="reconstructr"; version="1.1.0"; sha256="1kswvpmhk3zzwm4nv6pjb80ww95n9bd4q9j7bhk9kql8v5mnfg5m"; depends=[Rcpp Rcpp]; };
recosystem = derive { name="recosystem"; version="0.3"; sha256="064rnnz4m85mwq3084m0ldj8sb5z6jwzqzkh22fagsq2xyqri15l"; depends=[Rcpp Rcpp]; };
...
rgbif = derive { name="rgbif"; version="0.8.4"; sha256="13rcqqa19w3gzab4xg006kj7m5zj4x1hbxpam8yg1r3n9dad1bjz"; depends=[XML ggplot2 httr data_table whisker magrittr jsonlite V8]; };
...
robustlmm = derive { name="robustlmm"; version="1.7-2"; sha256="0cwr5fsl3m78xvfv3cy6n82zsdwsyq2zrlnzdppba9ja6hnh32wm"; depends=[lme4 Matrix ggplot2 lattice nlme robustbase xtable]; };
...
rplexos = derive { name="rplexos"; version="1.1.1"; sha256="1s3srk5f1ciy43vblwsy7wrwp2k2j5q52dfl4vjg69i63bh9yrpf"; depends=[Rcpp dplyr RSQLite DBI data_table tidyr lubridate stringi doParallel foreach Rcpp]; };
...
sadists = derive { name="sadists"; version="0.2.1"; sha256="0m3rlbhgzl0xvx8bcaswbi9nsrgfhdmkywx7ynayl6q0lmslhk6a"; depends=[PDQutils hypergeo orthopolynom]; };
...
scrm = derive { name="scrm"; version="1.6.0-2"; sha256="1a3m56j4ca526mjhc7h0967k5bja336dw1bpna119l5yic6hkc1n"; depends=[Rcpp Rcpp]; };
...
selfea = derive { name="selfea"; version="1.0"; sha256="02ncccyjgdpp9hkd278jg8x1c3566fqhfmmh423596b1slzs8gqm"; depends=[pwr MASS plyr]; };
...
sem = derive { name="sem"; version="3.1-6"; sha256="1gx0j3ignpmgy3qvnp0qjmhlzbxj0wjfr6jfs9d29cnq8b38p73c"; depends=[matrixcalc MASS boot mi DiagrammeR]; };
...
seriation = derive { name="seriation"; version="1.1-0"; sha256="0lbkv005ws4khwp12mygrpvxxdz8g5a7q2xl62k43sz6vj7cp8cn"; depends=[TSP cluster gclus colorspace MASS gplots registry]; };
...
sglasso = derive { name="sglasso"; version="1.2.1"; sha256="18dag7wvz0l959igg4g77psi8idvqyikg676yy9ga3k69kl11hdk"; depends=[Matrix igraph]; };
...
sirt = derive { name="sirt"; version="1.7-0"; sha256="12z1gk92rll5lxycv3gvz6y5ia5pbysq5fr3y62xn3wwgm2vrpch"; depends=[TAM CDM Rcpp mirt lavaan qgraph semPlot combinat ic_infer sfsmisc sm psych pbivnorm gtools igraph coda mvtnorm MASS Matrix lavaan_survey survey Rcpp RcppArmadillo]; };
...
smnet = derive { name="smnet"; version="2.0"; sha256="0jd574cjkylcrlnlnw859f4vwadi1v955m2lb5z3w3gdpv0lbx3p"; depends=[SSN spam RSQLite igraph DBI]; };
...
spatstat = derive { name="spatstat"; version="1.42-1"; sha256="10889xg5l7vjmlv79dhdayifplzxhnykhhgjpsn54rncz0k0hd0p"; depends=[mgcv Matrix deldir abind tensor polyclip goftest]; };
spatsurv = derive { name="spatsurv"; version="0.9-9"; sha256="1zvf8n4isaxi8n47qvgw6zqrgsnf3g6jpm19k6w6zbp9v5r8fw7r"; depends=[survival sp spatstat raster iterators RandomFields fields rgl Matrix stringr rgeos RColorBrewer geostatsp]; };
...
spectral_methods = derive { name="spectral.methods"; version="0.7.2.133"; sha256="0k8kpk94d2qzqdk3fnf6h9jmwdyp8h3klr0ilm5siwq5wkcz339l"; depends=[Rssa raster nnet abind RNetCDF ncdf_tools foreach JBTools DistributionUtils RColorBrewer]; };
...
ssfa = derive { name="ssfa"; version="1.1"; sha256="0fkyalhsjmx2sf8xxkppf4vd272n99nbkxh1scidrsgp4jk6z7fx"; depends=[Matrix maxLik spdep sp]; };
...
ssym = derive { name="ssym"; version="1.5.3"; sha256="0d8d0s9k87w7mxlvkzj307wkmxghc0qzhn7crm3fvcb1phf115p8"; depends=[GIGrvg numDeriv normalp Formula survival]; };
...
strucchange = derive { name="strucchange"; version="1.5-1"; sha256="0cdgvl6kphm2i59bmnppn1y3kv65ml111bk7yzpcx7vv8wh2w3kl"; depends=[zoo sandwich]; };
...
strvalidator = derive { name="strvalidator"; version="1.5.0"; sha256="0b71drc80hqmqi4kspy0700wss4pm88x2gp83jsw1jrfrrrfw9jk"; depends=[gridExtra ggplot2 gWidgets gtable plyr scales gWidgetsRGtk2 RGtk2 data_table]; };
...
surveillance = derive { name="surveillance"; version="1.9-0"; sha256="1v087x0y8i2b4pbikdaj3xdb0qj1lnl8yjrzcp3l0ffcbfb8a8j2"; depends=[sp xtable polyCub Rcpp MASS Matrix spatstat Rcpp]; };
...
switchr = derive { name="switchr"; version="0.9.4"; sha256="16a8659x2r9adi3r0cqhsw8qg3jk6pkvrzgx8a50qyk4v50f2jsj"; depends=[]; };
switchrGist = derive { name="switchrGist"; version="0.2.1"; sha256="0n8fzzsxm0m4yic133q07vki803zywhijadymrgyq7qlx3d1m97d"; depends=[switchr gistr httpuv RJSONIO]; };
...
synbreed = derive { name="synbreed"; version="0.11-8"; sha256="1d58rlys0557xs1wwd9mrvsrnx8fkcs4igxwf70rw9zy6nl9zg9k"; depends=[doBy BLR regress abind igraph lattice MASS LDheatmap qtl]; };
...
systemfit = derive { name="systemfit"; version="1.1-16"; sha256="0b34cpwhmsmq7dcr3gymdvanj3q493aczgz3af7b14bsp3bbwpw6"; depends=[Matrix car lmtest sandwich MASS]; };
...
textcat = derive { name="textcat"; version="1.0-3"; sha256="0j3sp94bz57l70aqm11033nfshxdz3l9m4sq1gsfzkvxgnlpqrm5"; depends=[tau slam]; };
...
vardpoor = derive { name="vardpoor"; version="0.3.2"; sha256="0vb684yhvafdmzphx4vv8gqih10x3mj8vmwshppwfgd3jp76dnps"; depends=[data_table laeken stringr reshape2 foreach plyr gdata MASS]; };
...
vcd = derive { name="vcd"; version="1.4-0"; sha256="0gp137hlkg1wm8bhfdpswz0g05a4biprfa5r9i1fz5w0myqgpxca"; depends=[MASS colorspace lmtest]; };
...
vdmR = derive { name="vdmR"; version="0.1.1"; sha256="0hmn7xgi1dzril6jdwxkpxp8isin0kxn3yb5fmcyfjhf03kcv4d4"; depends=[ggplot2 plyr maptools gridSVG rjson GGally Rook dplyr]; };
...
wikipediatrend = derive { name="wikipediatrend"; version="1.1.4"; sha256="1ccqwnlp0zchjqwxpy1li4wlgjlmdq3vdz6nrcgg7npplq4f6pjl"; depends=[jsonlite stringr rvest httr RCurl]; };
...
wsrf = derive { name="wsrf"; version="1.5.14"; sha256="0j0zlnazz40sv02fl8m5z7rv877m6ak2cms2q3ivy344k8ynjs0m"; depends=[Rcpp Rcpp]; };
...
xml2 = derive { name="xml2"; version="0.1.1"; sha256="1k6xzgx87vqzg1lkc1jaxxlw7zyhzqsis51q5p9jn0q3pw02qf53"; depends=[Rcpp Rcpp BH]; };
