...
icenReg = derive { name="icenReg"; version="1.2.3"; sha256="1ggvhblxd8skgxz2ps5gc5dlz2sv4676mm4r7i971wi4j6f83ipz"; depends=[survival foreach]; };
...
parallelSVM = derive { name="parallelSVM"; version="0.1-7"; sha256="1gmnd0jbhxbap5x91z95p9vpg6p130vph9mjjq197xjbhpvwjjr3"; depends=[e1071 foreach doParallel]; };
...
progress = derive { name="progress"; version="1.0.1"; sha256="0p5n8yf7xzg7jkcrjg9kl8h6jkr76sv52424nc2m1ms17c4x7sic"; depends=[prettyunits R6]; };
...
spatstat = derive { name="spatstat"; version="1.42-0"; sha256="1x9ilv470y3bvmpqmw7wnvb1a4gy7ilkrvchfrkk0ihayd1kc8cf"; depends=[mgcv Matrix deldir abind tensor polyclip goftest]; };
