...
in with self; {
  ...
  FlowSorted_Blood_EPIC = derive2 { name="FlowSorted.Blood.EPIC"; version="2.4.0"; sha256="08zxj8vy8v93fhx7x2x0qyv0sdkzdjqcnp9azgzaygwjcnhndz23"; depends=[AnnotationHub ExperimentHub genefilter minfi nlme quadprog S4Vectors SummarizedExperiment]; };
  ...
  MetaScope = derive2 { name="MetaScope"; version="0.99.13"; sha256="1p14dsmhb5dfgnrlwm7yqvdgq36bcxmrjc3v9gvhbmfjrsyabp67"; depends=[BiocFileCache Biostrings data_table dplyr ggplot2 magrittr Matrix MultiAssayExperiment qlcMatrix R_utils Rbowtie2 readr rlang Rsamtools S4Vectors stringr SummarizedExperiment taxize tidyr]; };
  ...
  SingleCellMultiModal = derive2 { name="SingleCellMultiModal"; version="1.12.0"; sha256="0pd864h61iacp2127s5jlwm24gk4f7sn68af8hygm7lf73lnyz4f"; depends=[AnnotationHub BiocFileCache BiocGenerics ExperimentHub HDF5Array Matrix MultiAssayExperiment S4Vectors SingleCellExperiment SpatialExperiment SummarizedExperiment]; };
  ...
  celldex = derive2 { name="celldex"; version="1.10.0"; sha256="0zljqnwjmhjcml7r2932s6qvyx618n01q3h4lgs9mgjxinm4j5iv"; depends=[AnnotationDbi AnnotationHub DelayedArray DelayedMatrixStats ExperimentHub S4Vectors SummarizedExperiment]; };
  ...
  curatedTCGAData = derive2 { name="curatedTCGAData"; version="1.21.2"; sha256="1wz2fdxhyn4sj7zkkbldqsyxjxw8x1hjf0nwvq508shlmack5m4f"; depends=[AnnotationHub ExperimentHub HDF5Array MultiAssayExperiment S4Vectors SummarizedExperiment]; };
  ...
  RforProteomics = derive2 { name="RforProteomics"; version="1.35.1"; sha256="1igdx4idgk1j0mcs8zjzd6bppj4nadryxhw2q026hazx6kj5qbxh"; depends=[BiocManager biocViews MSnbase R_utils]; broken = true; };
