...
in with self; {
  ...
  MetaScope = derive2 { name="MetaScope"; version="1.3.0"; sha256="04lrmx2lssyl4dx803mdsvhd2jcyh6v2jrwdbi7m62lbv700rhr7"; depends=[BiocFileCache Biostrings data_table dplyr ggplot2 magrittr Matrix MultiAssayExperiment Rbowtie2 readr rlang Rsamtools S4Vectors stringr SummarizedExperiment taxize tidyr]; };
  ...
  TENxXeniumData = derive2 { name="TENxXeniumData"; version="0.99.2"; sha256="16w2yzcwsm7hw57vd63i2a7bj1pyvcr16y7lnd6nhixngfc0sbfx"; depends=[BumpyMatrix ExperimentHub SpatialExperiment SummarizedExperiment]; };
  ...
  TransOmicsData = derive2 { name="TransOmicsData"; version="1.0.0"; sha256="12brqbspwvfq2hl4xpmdp4vamw1qfkyky89yxza0vwvxq95nxgvz"; depends=[S4Vectors]; };
