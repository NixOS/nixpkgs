...
in with self; {
  ...
  BeadArrayUseCases = derive2 { name="BeadArrayUseCases"; version="1.19.1"; sha256="character(0)"; depends=[beadarray GEOquery limma]; };
  ...
  DAPARdata = derive2 { name="DAPARdata"; version="1.11.2"; sha256="1581cmfbdv4ij7j713asw4fdvaf193ij57gs34pybrf0gr7807wr"; depends=[knitr MSnbase]; };
  ...
  HD2013SGI = derive2 { name="HD2013SGI"; version="1.21.1"; sha256="character(0)"; depends=[EBImage geneplotter gplots limma LSD RColorBrewer splots vcd]; };
  ...
  KEGGandMetacoreDzPathwaysGEO = derive2 { name="KEGGandMetacoreDzPathwaysGEO"; version="1.1.0"; sha256="character(0)"; depends=[Biobase BiocGenerics]; };
  ...
  Mulder2012 = derive2 { name="Mulder2012"; version="0.21.1"; sha256="character(0)"; depends=[HTSanalyzeR igraph KEGG_db MASS org_Hs_eg_db PANR pvclust RedeR]; };
  ...
  OMICsPCAdata = derive2 { name="OMICsPCAdata"; version="0.99.11"; sha256="character(0)"; depends=[MultiAssayExperiment]; };
  ...
  RTCGA_PANCAN12 = derive2 { name="RTCGA.PANCAN12"; version="1.9.2"; sha256="character(0)"; depends=[RTCGA]; };
  ...
  RTCGA_methylation = derive2 { name="RTCGA.methylation"; version="1.9.2"; sha256="character(0)"; depends=[RTCGA]; };
  ...
  RnBeads_hg19 = derive2 { name="RnBeads.hg19"; version="1.13.1"; sha256="character(0)"; depends=[GenomicRanges]; };
  ...
  breakpointRdata = derive2 { name="breakpointRdata"; version="0.99.2"; sha256="character(0)"; depends=[]; };
  ...
  hgu133plus2CellScore = derive2 { name="hgu133plus2CellScore"; version="1.1.1"; sha256="character(0)"; depends=[Biobase]; };
  ...
  mammaPrintData = derive2 { name="mammaPrintData"; version="1.17.2"; sha256="character(0)"; depends=[]; };
  ...
  systemPipeRdata = derive2 { name="systemPipeRdata"; version="1.9.4"; sha256="character(0)"; depends=[BiocGenerics]; };
  ...
  tximportData = derive2 { name="tximportData"; version="1.9.2"; sha256="character(0)"; depends=[]; };
