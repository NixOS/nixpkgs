...
runCommand (positron.name + "-wrapper")
  ...
  ''
    mkdir -p $out $out/bin
    echo "# Autogenerated by wrapper-positron.nix from R_LIBS_SITE" > $out/$fixLibsR
    ...
    ${lib.optionalString stdenv.hostPlatform.isLinux ''
      # symlink files from unwrapped positron so that the desktop file and the icons
    ...
    makeWrapper ${lib.getExe positron} $out/bin/positron \
