...
Ecfun = derive { name="Ecfun"; version="0.1-3"; sha256="06i5q8pwlw9fgbpvf65mbnynbpyrmb0548y58a6yxfslz480vbis"; depends=[fda gdata RCurl XML tis jpeg MASS TeachingDemos]; };
...
GetoptLong = derive { name="GetoptLong"; version="0.0.8"; sha256="1lnh65gs1p5k2cj7py0b9aqr56lm8ibgb3yqr0hwmr85ylj47iin"; depends=[rjson GlobalOptions]; };
...
HDPenReg = derive { name="HDPenReg"; version="0.90"; sha256="0hi1pd6lmb5w4px32sgs4zibl8j7zpav15hyayzwm6jh9gngp591"; depends=[Rcpp Rcpp]; };
...
ONETr = derive { name="ONETr"; version="1.0.1"; sha256="05azlax5wc0qrr1aqfpdks38185szjlkiv9d3vrkcwmjlw6n109y"; depends=[XML RCurl]; };
...
SciencesPo = derive { name="SciencesPo"; version="0.11.21"; sha256="1mia4gpk6bmdag3iv3227p5f9m6x74s60xsrk4xc9vgnfp5hrbw1"; depends=[ggplot2 foreign data_table dplyr gridExtra xtable]; };
...
SphericalK = derive { name="SphericalK"; version="1.0"; sha256="09jgz7wm0i2gj9flvwv1g8z86n5ch3fmswpypzp76dcia88x5hhc"; depends=[]; };
...
bde = derive { name="bde"; version="1.0"; sha256="19h3dzfa33r178m2q20p3l0ah1i6nrajv0lan0r036kjza3h978i"; depends=[shiny ggplot2]; };
...
birk = derive { name="birk"; version="1.2"; sha256="0lp3bvp0qlsggmq65208vm1hiprhr1c4pzay6xf4lhwprx47i5kw"; depends=[]; };
...
fdatest = derive { name="fdatest"; version="2.0"; sha256="1flnfcsmak8zbq79sv8ims2ywx62983226ly3lp2j7mwj6dxflhw"; depends=[fda]; };
...
hht = derive { name="hht"; version="2.1.1"; sha256="1pfjqydgbcr75j3l18jf466zj4hxghqfm33m5v7f7kw97rr5vyzm"; depends=[EMD fields spatstat]; };
...
lava = derive { name="lava"; version="1.3"; sha256="1m8bnq1br6xj6ai05slgbr84g0l58hq6z8lmnk0gw0gbkqsxd2wa"; depends=[numDeriv]; };
...
lucid = derive { name="lucid"; version="1.0"; sha256="15fpwskyf5qhzdsm44ik3fz3wkxdc3frnnyqgksbc06w3jpm3jrb"; depends=[nlme]; };
...
mets = derive { name="mets"; version="1.0"; sha256="1jmvcnhxxqhfim8dxm2jglr616lj9dqzp9931m318m167gk4785z"; depends=[timereg lava numDeriv Rcpp survival Rcpp RcppArmadillo]; };
...
mvSLOUCH = derive { name="mvSLOUCH"; version="1.1.4"; sha256="00grmwqn8z5h5b4cbk0ip45a2474zjkqvssf53q40vwz7s2ilxnb"; depends=[ouch ape numDeriv mvtnorm corpcor]; };
...
pez = derive { name="pez"; version="0.9-0"; sha256="088rvlgc9d7i4g5n39iymaaqzjbcrk5vh526xl6sa31yd2cr8240"; depends=[ape caper picante quantreg mvtnorm vegan PVR ade4 apTreeshape FD]; };
...
phangorn = derive { name="phangorn"; version="1.99-11"; sha256="16ymrm0iifzimg7y7f7wkj2syj4mbhwxm0sx6kyw8jglx82qw7fs"; depends=[ape quadprog igraph Matrix fastmatch rgl]; };
...
poplite = derive { name="poplite"; version="0.99.5"; sha256="0xcq5m2yhslaip3aa2s23dwp8bgi9qcdfbqd0af5bsn7kqrgwh94"; depends=[dplyr DBI igraph lazyeval RSQLite]; };
...
sgof = derive { name="sgof"; version="2.1.1"; sha256="02gbqyzjrma48aw3p038hlc2a7gdmgb6ac81473w1rg495n9sx7p"; depends=[]; };
...
trustOptim = derive { name="trustOptim"; version="0.8.4.1"; sha256="1m4jp0nqrazpkpw0s8rnd5f4hhvckwy6kb6qh7zw9nmgq4nlb93k"; depends=[Matrix Rcpp Rcpp RcppEigen]; };
...
tufterhandout = derive { name="tufterhandout"; version="1.2"; sha256="0g0av6qfm8bpvlhxb3cckzmn997af2h9j367j4afrip7sdzc9bn6"; depends=[rmarkdown knitr]; };
