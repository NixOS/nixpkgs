...
in with self; {
  ABAEnrichment = derive2 { name="ABAEnrichment"; version="1.2.2"; sha256="0hmxxp12w67lp1g1djzlxffwlx32mnd1wbmz1hmv7y7z6h6ichvq"; depends=[ABAData gplots Rcpp]; };
  ...
  BiRewire = derive2 { name="BiRewire"; version="3.0.1"; sha256="15dqrj448jvg33ywmxqscydpvwphx2d7lvzl7bmhj30s7jvzi491"; depends=[igraph Matrix tsne]; };
  ...
  BubbleTree = derive2 { name="BubbleTree"; version="2.0.1"; sha256="1qkvmddd7l1xg5459gd9w86d4k4rjm40c93k6piwzv8hrzr4mjzc"; depends=[Biobase BiocGenerics BiocStyle biovizBase dplyr GenomicRanges ggplot2 gridExtra gtable gtools IRanges limma magrittr plyr rainbow RColorBrewer rgl scales WriteXLS]; };
  ...
  CRISPRseek = derive2 { name="CRISPRseek"; version="1.10.3"; sha256="13nilwj1mk0nh579cbdxb5nzq938vznziiz7rfl9iz5his4qfs8d"; depends=[BiocGenerics BiocParallel Biostrings BSgenome data_table IRanges S4Vectors seqinr]; };
  ...
  ChAMP = derive2 { name="ChAMP"; version="1.8.2"; sha256="0i7rms4p5gxxbmnfxwlf0wpyhzw5vj4w1xb96pzwklaaamhy8p1y"; depends=[ChAMPdata DNAcopy GenomicRanges Illumina450ProbeVariants_db IlluminaHumanMethylation450kmanifest impute IRanges limma marray minfi plyr preprocessCore RPMM sva wateRmelon]; };
  ...
  DOSE = derive2 { name="DOSE"; version="2.8.3"; sha256="1nscjai2xnr24sj00ivacqk4bimygidvrzwrnrip0wlnsx52k4iy"; depends=[AnnotationDbi DO_db ggplot2 GOSemSim igraph plyr qvalue reshape2 scales]; };
  ...
  ENCODExplorer = derive2 { name="ENCODExplorer"; version="1.2.4"; sha256="0vx4q628g0h1wdcp4hibs44h8avnyin0ccxijrdk94s5n2f91pc2"; depends=[jsonlite RSQLite]; };
  ...
  EnrichmentBrowser = derive2 { name="EnrichmentBrowser"; version="2.0.15"; sha256="1nj7s667gf8yfgyy2f7rxy85rcjix5pczdlkwwl7s6gb0k6x36m3"; depends=[AnnotationDbi Biobase biocGraph biomaRt ComplexHeatmap DESeq2 EDASeq edgeR geneplotter GO_db graph GSEABase hwriter KEGGgraph KEGGREST limma MASS mixtools neaGUI npGSEA PathNet pathview ReportingTools Rgraphviz S4Vectors safe SparseM SPIA stringr SummarizedExperiment topGO]; };
  ...
  GOsummaries = derive2 { name="GOsummaries"; version="2.4.7"; sha256="0kl77jqd2bdbp8v2rrjp21j265r05fnagpz8jwj8m9scgrd5hwh4"; depends=[ggplot2 gProfileR gtable limma plyr Rcpp reshape2]; };
  ...
  GSRI = derive2 { name="GSRI"; version="2.18.1"; sha256="1l52xifdl481lmf2hn8pgfkw68aciccqzn13rj2raqc89pcjrcch"; depends=[Biobase fdrtool genefilter GSEABase les]; };
  ...
  INSPEcT = derive2 { name="INSPEcT"; version="1.0.2"; sha256="14gi99iw2dw56z4y9i215q83lbdkk8gpjp8bbiwmcmjk8826c2d4"; depends=[Biobase BiocGenerics BiocParallel deSolve GenomicAlignments GenomicFeatures GenomicRanges IRanges preprocessCore pROC rootSolve Rsamtools S4Vectors]; };
  ...
  LedPred = derive2 { name="LedPred"; version="1.2.1"; sha256="08cdw4z28xnqiqhibaa7gkhk23qlmxfdyywr3b72jhrwiq93d3fj"; depends=[akima e1071 GenomicRanges irr jsonlite plot3D plyr RCurl ROCR testthat]; };
  ...
  MIMOSA = derive2 { name="MIMOSA"; version="1.8.1"; sha256="1mkxp83gwxw581gz13vb8lbl2pff7al75lhjcvwxv6gxb1k272xi"; depends=[Biobase coda data_table Formula ggplot2 Kmisc MASS MCMCpack modeest plyr pracma Rcpp RcppArmadillo reshape scales testthat]; };
  ...
  MLP = derive2 { name="MLP"; version="1.18.1"; sha256="0albnixp96bn15ync80pzg66gbcvcqvwaybgwx07pjiw1j9y04iy"; depends=[affy AnnotationDbi gdata gmodels gplots gtools plotrix]; };
  ...
  OncoSimulR = derive2 { name="OncoSimulR"; version="2.0.1"; sha256="1v7scla77npwrqfg7zkg99p8928wapkvg54jh7x48hpbkjjacr71"; depends=[data_table graph gtools igraph Rcpp Rgraphviz]; };
  ...
  ProteomicsAnnotationHubData = derive2 { name="ProteomicsAnnotationHubData"; version="1.0.1"; sha256="1wxx6mq1xs7l24p82rs0wsmfxhrjx6nv1m7wf73i33vrcy83g2i6"; depends=[AnnotationHub AnnotationHubData Biobase BiocInstaller Biostrings GenomeInfoDb MSnbase mzR RCurl]; };
  ...
  RMassBank = derive2 { name="RMassBank"; version="1.12.1"; sha256="15chxj5zxjckswxi2a02lps0dn6r89qbv8g4c44zfsiksjk7bk96"; depends=[mzR rcdk Rcpp RCurl rjson XML yaml]; };
  ...
  RNAither = derive2 { name="RNAither"; version="2.18.7"; sha256="1mgm6y5ijlw3rpfi0vkdlw0zrfd4ciz3qmmp42vykmm8c5jsjc0x"; depends=[biomaRt car geneplotter limma prada RankProd splots topGO]; };
  ...
  Rariant = derive2 { name="Rariant"; version="1.6.2"; sha256="1jf8p5i6jqlniwrmsk6ajcrf6j637cx267nvb2742yd1jzfm5yy3"; depends=[dplyr exomeCopy GenomeInfoDb GenomicRanges ggbio ggplot2 IRanges reshape2 Rsamtools S4Vectors shiny SomaticSignatures VariantAnnotation VGAM]; };
  ...
  SICtools = derive2 { name="SICtools"; version="1.0.1"; sha256="1fbc1m9jxhmrvrss6i8pif7dvw1v6kdpif23hxdrd2rq55dpv6k2"; depends=[Biostrings doParallel foreach GenomicRanges IRanges matrixStats Rsamtools stringr]; };
  ...
  SRAdb = derive2 { name="SRAdb"; version="1.28.1"; sha256="0irmdmjc15744knrpsmzmiywcnxmwdx9sddacn3qz3i0z9sw0w48"; depends=[GEOquery graph RCurl RSQLite]; };
  ...
  SomatiCA = derive2 { name="SomatiCA"; version="2.1.0"; sha256="1a4c8hnl93mnqmm9abc2njcqrlynzbsf39im2gi3ypyjnzabs7m8"; depends=[DNAcopy doParallel foreach GenomicRanges IRanges lars mvtnorm rebmix sn]; };
  SomaticSignatures = derive2 { name="SomaticSignatures"; version="2.6.1"; sha256="0assknxabz6zqj1fbb0j28yxm4i2z2sn0xhmg643zylimnchjqhv"; depends=[Biobase Biostrings GenomeInfoDb GenomicRanges ggbio ggplot2 IRanges NMF pcaMethods reshape2 S4Vectors VariantAnnotation]; };
  ...
  TCGAbiolinks = derive2 { name="TCGAbiolinks"; version="1.0.10"; sha256="1amivqckr6hf92658w3bgqq8i9z916nb9dmlz4jckcmmrfa1g0xx"; depends=[affy Biobase BiocGenerics biomaRt cghMCR CNTools coin ConsensusClusterPlus data_table devtools dnet doParallel downloader dplyr EDASeq edgeR genefilter GenomicFeatures GenomicRanges GGally ggplot2 gplots heatmap_plus igraph IRanges knitr limma plyr RColorBrewer RCurl rjson rvest S4Vectors scales stringr SummarizedExperiment supraHex survival TxDb_Hsapiens_UCSC_hg19_knownGene XML xml2 xtable]; };
  ...
  TFBSTools = derive2 { name="TFBSTools"; version="1.8.3"; sha256="0fm0ymczakwbhbfvyg0w6j4xcf1866j0r6cz11wcwiqm9a2i0z3j"; depends=[Biobase BiocGenerics BiocParallel Biostrings BSgenome caTools CNEr DirichletMultinomial GenomeInfoDb GenomicRanges gtools IRanges RSQLite rtracklayer S4Vectors seqLogo TFMPvalue XML XVector]; };
  ...
  TPP = derive2 { name="TPP"; version="2.0.4"; sha256="10n4izvkc5v0d94d287a2dpzjx8lvl0xkk5p74bnsaa504ljs5nf"; depends=[Biobase doParallel foreach ggplot2 gridExtra nls2 plyr RColorBrewer RCurl reshape2 VennDiagram VGAM]; };
  ...
  TSSi = derive2 { name="TSSi"; version="1.16.2"; sha256="0lvvzhm0npm9hc7n9rw9ipqgp7kgyvciapai0y8l4r3c07wh8nbs"; depends=[Biobase BiocGenerics Hmisc IRanges minqa plyr S4Vectors]; };
  TarSeqQC = derive2 { name="TarSeqQC"; version="1.0.3"; sha256="06a9kvyx73ysllid9mafgyp1czhyf06gxma1b6bkyksingpgnb68"; depends=[BiocGenerics BiocParallel GenomeInfoDb GenomicRanges ggplot2 IRanges plyr reshape2 Rsamtools S4Vectors]; };
  ...
  VariantFiltering = derive2 { name="VariantFiltering"; version="1.6.21"; sha256="0k8h50i4gin2pnb10h6brzx5iyxwmq112bvb4a8802dnbz8bxrqc"; depends=[AnnotationDbi Biobase BiocGenerics BiocParallel Biostrings BSgenome DBI GenomeInfoDb GenomicFeatures GenomicRanges graph Gviz IRanges RBGL Rsamtools RSQLite S4Vectors shiny VariantAnnotation XVector]; };
  ...
  bioassayR = derive2 { name="bioassayR"; version="1.8.37"; sha256="08b9bzrks6wbmix0aqbj4lyqz1jmsmmwdv4ccjs56rdwyrg63abj"; depends=[BiocGenerics ChemmineR DBI Matrix rjson RSQLite XML]; };
  ...
  cellHTS = derive2 { name="cellHTS"; version="1.40.2"; sha256="1cdzrmqr3fwxylc3m7g72bmc5iml266355i0mfdavp2q9y28kc85"; depends=[Biobase genefilter prada RColorBrewer]; };
  ...
  charm = derive2 { name="charm"; version="2.16.1"; sha256="00bvgpj705v9jb43skj5iljjf131dnz90n2rc1yww6s2kh4qqppm"; depends=[Biobase Biostrings BSgenome ff fields genefilter gtools IRanges limma nor1mix oligo oligoClasses preprocessCore RColorBrewer siggenes SQN sva]; };
  ...
  coMET = derive2 { name="coMET"; version="1.2.1"; sha256="017sjx9wamyg6jglnbw1ynkbnp9idj9142jhkqvy8xji6kqh5xpk"; depends=[biomaRt colortools corrplot GenomicRanges ggbio ggplot2 gridExtra Gviz hash IRanges psych rtracklayer S4Vectors trackViewer]; };
  ...
  cytofkit = derive2 { name="cytofkit"; version="1.2.4"; sha256="1pgaw18m4z3az3b0d5d2wlvfq0ha80k5bc0vyjd9grlbwcpvs6nr"; depends=[Biobase doParallel e1071 flowCore ggplot2 gplots igraph pdist plyr RANN Rcpp reshape reshape2 Rtsne shiny vegan VGAM]; };
  ...
  destiny = derive2 { name="destiny"; version="1.0.0"; sha256="1k8nf9gws6d60fp7mh43hjiaza7zxxfkpjzmi5qj2davjqbx1wn0"; depends=[Biobase BiocGenerics FNN igraph Matrix Rcpp RcppEigen scatterplot3d VIM]; };
  ...
  facopy = derive2 { name="facopy"; version="1.4.1"; sha256="07ggz86c48rz8asqvfglrvsimnzh3ii43kzpm8ji6sd43i141650"; depends=[annotate cgdsr coin data_table DOSE facopy_annot ggplot2 GO_db GOstats graphite gridExtra igraph IRanges MASS nnet reshape2 Rgraphviz scales]; };
  ...
  flowType = derive2 { name="flowType"; version="2.8.2"; sha256="0q7bk8pn71zyzc1m16rqimlyldnfj178k64vg0kw4yiwdjxlgdr4"; depends=[BH Biobase flowClust flowCore flowMeans flowMerge Rcpp rrcov sfsmisc]; };
  ...
  flowWorkspace = derive2 { name="flowWorkspace"; version="3.16.16"; sha256="1xa3rwal9vmsja0f5ffcjjy6sny06gz5jr1wwrn5ql7v58k7v6si"; depends=[BH Biobase BiocGenerics data_table dplyr flowCore flowUtils flowViz graph gridExtra jsonlite lattice latticeExtra ncdfFlow RBGL RColorBrewer Rcpp Rgraphviz stringr XML]; };
  ...
  les = derive2 { name="les"; version="1.20.1"; sha256="1l36a04icpxfxrzhi5shb4p2vy0xc6l9h4jswgmzqydiy7q2k44k"; depends=[boot fdrtool gplots RColorBrewer]; };
  ...
  metaX = derive2 { name="metaX"; version="1.0.3"; sha256="1v4519spcgvc2kc1cah5gmfjnx09zlam8p8d8m6wkw0ba600vv7b"; depends=[ape BBmisc boot bootstrap CAMERA caret data_table DiffCorr DiscriMiner doParallel dplyr faahKO ggplot2 igraph impute lattice missForest mixOmics Nozzle_R1 pcaMethods pheatmap pls plyr preprocessCore pROC RColorBrewer RCurl reshape2 scatterplot3d SSPA stringr VennDiagram vsn xcms]; };
  ...
  metagenomeSeq = derive2 { name="metagenomeSeq"; version="1.12.1"; sha256="11m8lkk2iz030cz8yx6b5jwy8cv3255gx489iw5xnv4y0657s5gv"; depends=[Biobase foreach glmnet gplots limma Matrix matrixStats RColorBrewer]; };
  ...
  methyAnalysis = derive2 { name="methyAnalysis"; version="1.12.2"; sha256="0m4qx7q1zm3g4m8kwjz7nvf93891bmbvac0n8wpgniap669af0yk"; depends=[annotate AnnotationDbi Biobase BiocGenerics biomaRt genefilter GenomeInfoDb GenomicFeatures GenomicRanges genoset Gviz IRanges lumi methylumi org_Hs_eg_db rtracklayer VariantAnnotation]; };
  ...
  mmnet = derive2 { name="mmnet"; version="1.8.1"; sha256="0ppcy11xnn593xig8gwz79vsbkdi3f5aai58zdhr59w52y2dafia"; depends=[Biobase flexmix ggplot2 igraph KEGGREST Matrix plyr RCurl reshape2 RJSONIO stringr XML]; };
  ...
  mosaics = derive2 { name="mosaics"; version="2.4.1"; sha256="18dx0xgbvwwap35b56cbqyhk83n28pyb2l9gi11153ajgj0c3sfx"; depends=[IRanges lattice MASS Rcpp]; };
  ...
  motifbreakR = derive2 { name="motifbreakR"; version="1.0.8"; sha256="1gy28n1ph9dsis4n6mbp2fw0qcab08sqj4kdl6f03pkhhhfc2lss"; depends=[BiocGenerics BiocParallel Biostrings BSgenome GenomeInfoDb GenomicRanges grImport Gviz IRanges matrixStats MotifDb motifStack rtracklayer S4Vectors stringr TFMPvalue VariantAnnotation]; };
  ...
  pRoloc = derive2 { name="pRoloc"; version="1.10.3"; sha256="1srjvdp2cq46pizfa4awhn4qwrflrv4w7m9xid6jidzim1x2y3c6"; depends=[Biobase BiocGenerics BiocParallel biomaRt caret class e1071 FNN ggplot2 gtools kernlab knitr lattice MASS mclust MLInterfaces MSnbase mvtnorm nnet plyr randomForest RColorBrewer Rcpp RcppArmadillo sampling scales]; };
  ...
  phyloseq = derive2 { name="phyloseq"; version="1.14.0"; sha256="0h34ac577d2lzh6rzbvwz04ngp3v4c728z0nzf646ab10nfk1i17"; depends=[ade4 ape Biobase BiocGenerics Biostrings cluster data_table foreach ggplot2 igraph multtest plyr reshape2 scales vegan]; };
  ...
  seqplots = derive2 { name="seqplots"; version="1.8.1"; sha256="0anv2048m5zp2ijfzk79avcwzp662gw0y58j7nafha21j5s2qyhm"; depends=[Biostrings BSgenome class DBI digest DT fields GenomeInfoDb GenomicRanges ggplot2 gridExtra IRanges jsonlite kohonen plotrix RColorBrewer reshape2 RSQLite rtracklayer S4Vectors shiny]; };
  ...
  sincell = derive2 { name="sincell"; version="1.2.0"; sha256="1qmjy9cwhnyg4s3jfzi0z0yfdza4dma0q6h73772mhh2l4q149h7"; depends=[cluster entropy fastICA fields ggplot2 igraph MASS Rcpp reshape2 Rtsne scatterplot3d statmod TSP]; };
  ...
  specL = derive2 { name="specL"; version="1.4.0"; sha256="0i7j5bzvlsyy72xg2gcxggrz25ln3287gcd433mwyiira4apz1il"; depends=[DBI Rcpp RSQLite seqinr]; };
  ...
  survcomp = derive2 { name="survcomp"; version="1.20.0"; sha256="174kh5cnbw1dg109wrzbf4xhslzn56fag4d3nxwswxinrdz360i9"; depends=[bootstrap ipred KernSmooth prodlim rmeta survival survivalROC]; };
