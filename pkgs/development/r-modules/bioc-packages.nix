...
AnalysisPageServer = derive { name="AnalysisPageServer"; version="1.1.4"; sha256="06b5hq9nsrn91nnzyfz3scq0z57yzpjsaa9wd750hlfjp2v58bgm"; depends=[Biobase graph log4r rjson]; };
...
AnnotationHubData = derive { name="AnnotationHubData"; version="0.1.0"; sha256="1hmx424pac48kqbvmzi3yd3p826r94zvbiapy2ban5c51gg62f76"; depends=[AnnotationDbi AnnotationForge AnnotationHub Biobase BiocGenerics BiocInstaller Biostrings DBI futile_logger GenomeInfoDb GenomicFeatures GenomicRanges GEOquery httr IRanges jsonlite OrganismDbi rBiopaxParser RCurl Rsamtools RSQLite rtracklayer S4Vectors XML]; };
...
BiocParallel = derive { name="BiocParallel"; version="1.3.51"; sha256="0gmz8a1f4f3cj9fiks1s03m7fm1b3yncpi0x0i3h5yh307wh2h1w"; depends=[futile_logger snow]; };
...
ChIPpeakAnno = derive { name="ChIPpeakAnno"; version="3.3.5"; sha256="1sqz2f1jna27vpwjsbn7nji4ndahwhhmlzwvw7vbffmrpaqnfyd7"; depends=[AnnotationDbi BiocGenerics BiocInstaller biomaRt Biostrings BSgenome DBI ensembldb GenomeInfoDb GenomicFeatures GenomicRanges graph IRanges limma matrixStats multtest RBGL regioneR S4Vectors VennDiagram]; };
ChIPseeker = derive { name="ChIPseeker"; version="1.5.9"; sha256="094a0jj88jk432p6igidr3gvmx0nhqx7h4c25nl7kvmjp1lqj44n"; depends=[AnnotationDbi BiocGenerics boot dplyr GenomeInfoDb GenomicFeatures GenomicRanges ggplot2 gplots gridBase gtools IRanges magrittr plotrix plyr RColorBrewer rtracklayer S4Vectors UpSetR]; };
...
ClassifyR = derive { name="ClassifyR"; version="1.3.15"; sha256="0i5lb5dsdbgjgnj05mwjflcyl11cf6y78s87p4plz1v27hp05ym1"; depends=[Biobase BiocParallel locfit ROCR]; };
...
ComplexHeatmap = derive { name="ComplexHeatmap"; version="1.4.1"; sha256="15xwqm8xayv20n7w2dhmwhxvslwaljccdj46kmfv95x8kfg6z80i"; depends=[circlize colorspace dendextend GetoptLong GlobalOptions RColorBrewer]; };
...
DECIPHER = derive { name="DECIPHER"; version="1.15.1"; sha256="0ydmkg7qbpwspvzxkzmvlbscbssp69qnfdjinbwpybps7pgfs3xf"; depends=[Biostrings DBI IRanges RSQLite S4Vectors XVector]; };
...
DESeq2 = derive { name="DESeq2"; version="1.9.34"; sha256="1j6h7qv1b1a7my9vv3ly1kwbd6gvp4bvz80wzrmykr79ivan7jvm"; depends=[Biobase BiocGenerics BiocParallel genefilter geneplotter GenomicRanges ggplot2 Hmisc IRanges locfit Rcpp RcppArmadillo S4Vectors SummarizedExperiment]; };
...
EBImage = derive { name="EBImage"; version="4.11.14"; sha256="0pzf3knpbvhmnclrcc4ylgdr7yha91cc4shjfz2a0zmd5zhi1jxv"; depends=[abind BiocGenerics fftwtools jpeg locfit png tiff]; };
...
ENmix = derive { name="ENmix"; version="1.1.10"; sha256="0f3k48pk86gfa8jzh6l9lk1awcjd4536k46x6vsc6z54zqpkii3f"; depends=[Biobase doParallel foreach geneplotter impute MASS minfi preprocessCore sva wateRmelon]; };
...
FGNet = derive { name="FGNet"; version="3.3.5"; sha256="1danigynjrp4cgqcf5b58c805nr3lkm65jdx6pzwi5v8ak7a1ajz"; depends=[hwriter igraph plotrix png R_utils RColorBrewer reshape2 XML]; };
...
GENESIS = derive { name="GENESIS"; version="1.1.2"; sha256="063awaxc02cwp1pr7b5rrpfz8fgp9kkvfgc1p823fxjfrkxqgfa8"; depends=[GWASTools]; };
...
GEOquery = derive { name="GEOquery"; version="2.35.6"; sha256="0zxbxz40jcs8s50gk5xs20gspvb2dzrkil89jd1prynhxvgc246d"; depends=[Biobase RCurl XML]; };
...
GenomeInfoDb = derive { name="GenomeInfoDb"; version="1.5.15"; sha256="0sx85703z3jxldzmb9qjqbwp4vm6bhkknxr7k4wai8d9a8vjwz7b"; depends=[BiocGenerics IRanges S4Vectors]; };
GenomicAlignments = derive { name="GenomicAlignments"; version="1.5.13"; sha256="1jvnkskwvra6c9bnqwyvgpdnfghn58mrj4ygv04d9slx6idfyl9z"; depends=[BiocGenerics BiocParallel Biostrings GenomeInfoDb GenomicRanges IRanges Rsamtools S4Vectors SummarizedExperiment]; };
GenomicFeatures = derive { name="GenomicFeatures"; version="1.21.22"; sha256="0xqsa8sz3lyscsvyb0xfnpyklrwhdcma6pifmlva84b2y33c5gsb"; depends=[AnnotationDbi Biobase BiocGenerics biomaRt Biostrings DBI GenomeInfoDb GenomicRanges IRanges RCurl RSQLite rtracklayer S4Vectors XVector]; };
...
GenomicRanges = derive { name="GenomicRanges"; version="1.21.23"; sha256="0g5i5gfak3ghh5x8zhaqi16aa4hk0ls4ckjf8irn2js0gz03mdxc"; depends=[BiocGenerics GenomeInfoDb IRanges S4Vectors XVector]; };
...
IONiseR = derive { name="IONiseR"; version="0.99.11"; sha256="1x77l9pyjd69zvr70p8asf09df4da9wvwjc05nzyial2jjvh43nj"; depends=[BiocGenerics Biostrings data_table dplyr ggplot2 magrittr rhdf5 ShortRead tidyr XVector]; };
...
IRanges = derive { name="IRanges"; version="2.3.19"; sha256="1l18rdjxm3v3r8jn7h98aapis7msca8lvfghlm6pjk8k1cg4l6m7"; depends=[BiocGenerics S4Vectors]; };
...
InPAS = derive { name="InPAS"; version="1.1.7"; sha256="1v1vs4na5l4mq393z1l5ld82qbv97x2gki3rlggn8l163i7v398r"; depends=[AnnotationDbi Biobase BiocParallel BSgenome cleanUpdTSeq depmixS4 GenomeInfoDb GenomicFeatures GenomicRanges Gviz IRanges limma preprocessCore S4Vectors seqinr]; };
...
LowMACA = derive { name="LowMACA"; version="1.1.2"; sha256="05n48zfdknjm2yfkf6a8h8yd4vz38qjbgccsaxanhwv9hhsv1g8d"; depends=[BiocParallel Biostrings cgdsr data_table motifStack RColorBrewer reshape2 stringr]; };
...
MLInterfaces = derive { name="MLInterfaces"; version="1.49.12"; sha256="0x9qra6kwx7k5892qxaiy4cqz84my4kjbglfs522g2hnnib0ylm6"; depends=[annotate Biobase BiocGenerics cluster fpc gbm gdata genefilter ggvis hwriter MASS mlbench pls RColorBrewer rda rgl rpart sfsmisc shiny threejs]; };
...
MSnbase = derive { name="MSnbase"; version="1.17.14"; sha256="0p6k2bhxly4w0gymmhzhpahanvd27581a9742nnyh7vk7ip0xpx2"; depends=[affy Biobase BiocGenerics BiocParallel digest ggplot2 impute IRanges lattice MALDIquant mzID mzR pcaMethods plyr preprocessCore ProtGenerics Rcpp reshape2 S4Vectors vsn]; };
...
PGA = derive { name="PGA"; version="0.99.10"; sha256="02rmhmcxq9i13wy65f7x9vx5g2mq4922k7dqbh3hdf8xz4dndpmy"; depends=[AnnotationDbi biomaRt Biostrings customProDB data_table GenomicFeatures GenomicRanges ggplot2 IRanges Nozzle_R1 pheatmap RCurl Rsamtools RSQLite rTANDEM rtracklayer stringr VariantAnnotation]; };
...
PWMEnrich = derive { name="PWMEnrich"; version="4.5.1"; sha256="1w2f78736n067ib4brc8cviavg074h3d9b6kkjmxrh72cczvz23z"; depends=[BiocGenerics Biostrings evd gdata seqLogo]; };
...
QuasR = derive { name="QuasR"; version="1.9.13"; sha256="0ai0l9km0i0xf2q7x3dr3mw7a8mi75vhhgnmwyn711za3hhsqpqs"; depends=[Biobase BiocGenerics BiocInstaller BiocParallel Biostrings BSgenome GenomeInfoDb GenomicAlignments GenomicFeatures GenomicFiles GenomicRanges IRanges Rbowtie Rsamtools rtracklayer S4Vectors ShortRead zlibbioc]; };
...
RCyjs = derive { name="RCyjs"; version="1.1.23"; sha256="1sia30yw04kl77lr2zc7cfsabxsmyh87fnz3f8k37bk6g4pbgaj7"; depends=[BiocGenerics BrowserViz graph httpuv igraph jsonlite Rcpp]; };
...
ReactomePA = derive { name="ReactomePA"; version="1.13.4"; sha256="0dj87zh9yfkw01zzc5nx2275nx5y9hfrn4n0fy3in912lkc8dc7i"; depends=[AnnotationDbi DOSE graphite igraph]; };
...
Rsamtools = derive { name="Rsamtools"; version="1.21.17"; sha256="1jbil51m4vx84ngfcj9bksk24wchc733jgrw9vpza0zdxsfzhsgk"; depends=[BiocGenerics BiocParallel Biostrings bitops GenomeInfoDb GenomicRanges IRanges S4Vectors XVector zlibbioc]; };
...
S4Vectors = derive { name="S4Vectors"; version="0.7.16"; sha256="00nppd7p8ak2q88d0rmhhs68fm5nhiw3hcfjns4n69whbff6gvna"; depends=[BiocGenerics]; };
...
SNPRelate = derive { name="SNPRelate"; version="1.3.9"; sha256="1aaxvpdvba2wa61rjwcx8kq4spnsm17xxa608wv5gy12admb46ks"; depends=[gdsfmt]; };
...
SeqArray = derive { name="SeqArray"; version="1.9.15"; sha256="1c0k828qalgyw7jwgzs37mxsgdipqqr0hvjmgpnqg5d3cw27hi6q"; depends=[Biostrings gdsfmt GenomicRanges IRanges S4Vectors VariantAnnotation]; };
...
SeqVarTools = derive { name="SeqVarTools"; version="1.7.4"; sha256="1rfnspmhy1mhbqpn6df8hii8sywyp7m0qva2fd3h37pf5ffk2si1"; depends=[gdsfmt GenomicRanges GWASExactHW IRanges S4Vectors SeqArray stringr VariantAnnotation]; };
...
SplicingGraphs = derive { name="SplicingGraphs"; version="1.9.2"; sha256="06zn35j98ca5wx37xaszjy391j20bs549gbv8ajiknpv2dvvwi0k"; depends=[BiocGenerics GenomeInfoDb GenomicAlignments GenomicFeatures GenomicRanges graph igraph IRanges Rgraphviz Rsamtools S4Vectors]; };
...
SummarizedExperiment = derive { name="SummarizedExperiment"; version="0.3.7"; sha256="1l3k0rmjp9l7nq10xx2p323lmf7j9sdkiq22mfkzwgw8kkxfg43h"; depends=[Biobase BiocGenerics GenomeInfoDb GenomicRanges IRanges S4Vectors]; };
...
TCC = derive { name="TCC"; version="1.9.3"; sha256="1lz2bfb9z1rkvap7cjgpgm552ljh6gn0dmljfivdj0xn3408273d"; depends=[baySeq DESeq DESeq2 edgeR ROC samr]; };
TCGAbiolinks = derive { name="TCGAbiolinks"; version="0.99.1"; sha256="0b6flc8kc866g4vz368m4p638dfknazgz3hkfadyiimizidbzm7k"; depends=[BiocGenerics biomaRt coin data_table devtools dnet downloader EDASeq edgeR GenomicFeatures GenomicRanges GGally ggplot2 igraph IRanges limma plyr RCurl rjson rvest S4Vectors scales stringr SummarizedExperiment supraHex survival XML]; };
...
TFBSTools = derive { name="TFBSTools"; version="1.7.1"; sha256="138224gl8dm8c8983nd5j3lmjjg1jzyzld0yknhsd5qkd7xcflcl"; depends=[BiocGenerics BiocParallel Biostrings BSgenome caTools CNEr DirichletMultinomial GenomicRanges gtools IRanges RSQLite rtracklayer S4Vectors seqLogo TFMPvalue XVector]; };
...
clusterProfiler = derive { name="clusterProfiler"; version="2.3.7"; sha256="1cr7j75l8qy71rgk2wzk6b1zrl7hy3zzw7jzirlwj4s5vg4w8jvz"; depends=[AnnotationDbi DOSE ggplot2 GOSemSim KEGGREST magrittr plyr qvalue topGO]; };
...
csaw = derive { name="csaw"; version="1.3.12"; sha256="0g1j29ljxcgmsw9qa7nmg0jlns0zrzazs765nmg9561jqpjsxy5d"; depends=[AnnotationDbi edgeR GenomeInfoDb GenomicAlignments GenomicFeatures GenomicRanges IRanges limma Rsamtools S4Vectors SummarizedExperiment]; };
...
diffHic = derive { name="diffHic"; version="1.1.15"; sha256="049ci5z3mj64na0ay0rqxy03mrmnrng1h3q7iywxj4xra6p8wpsq"; depends=[BiocGenerics Biostrings BSgenome csaw edgeR GenomeInfoDb GenomicRanges IRanges limma locfit rhdf5 Rsamtools S4Vectors]; };
...
ensemblVEP = derive { name="ensemblVEP"; version="1.9.4"; sha256="15rfmgka39ypvycq4zvrbvkq1lrxc4j2aind5fiywk65rs4fl2ya"; depends=[BiocGenerics Biostrings GenomicRanges VariantAnnotation]; };
...
erma = derive { name="erma"; version="0.1.27"; sha256="1iysak6wsxmxjlzi4ls7bivl9g2xks6fhlvjb5ms7j8pslwmm6rx"; depends=[Biobase BiocGenerics foreach GenomicFiles GenomicRanges ggplot2 rtracklayer S4Vectors shiny]; };
...
flowCore = derive { name="flowCore"; version="1.35.10"; sha256="0p7qnfsf7ri38id0lpb9ik6pncdkjn0zq9491v11mb001dci9zbr"; depends=[BH Biobase BiocGenerics corpcor graph Rcpp rrcov]; };
...
gQTLBase = derive { name="gQTLBase"; version="1.1.18"; sha256="1y51d9p3ab0b9apbvs1nisxcai73717azfi985b0dbxf7kjc1646"; depends=[BatchJobs BBmisc BiocGenerics bit doParallel ff ffbase foreach GenomicFiles GenomicRanges rtracklayer S4Vectors]; };
gQTLstats = derive { name="gQTLstats"; version="1.1.9"; sha256="1s923mr8749d58ni8km0j5hzmcmj1qcz7k9sz5v1av3zn7b6fsg5"; depends=[AnnotationDbi BatchJobs Biobase BiocGenerics doParallel dplyr ffbase foreach gam GenomeInfoDb GenomicFeatures GenomicRanges ggplot2 gQTLBase IRanges limma reshape2 S4Vectors snpStats SummarizedExperiment VariantAnnotation]; };
...
gdsfmt = derive { name="gdsfmt"; version="1.5.13"; sha256="1c30xh09s6zi1nshkzjl7ah2113f50b8kjrg0mzgcl296w77d3s5"; depends=[]; };
...
genomation = derive { name="genomation"; version="1.1.16"; sha256="1mppz3s8nj9bz5amfjn0hvw73a58s0by84jfdl15irv8az57sxf3"; depends=[data_table GenomeInfoDb GenomicAlignments GenomicRanges ggplot2 gridBase impute IRanges matrixStats plotrix plyr readr reshape2 Rsamtools rtracklayer]; };
...
gwascat = derive { name="gwascat"; version="2.1.18"; sha256="16s4pv6q4jwx8kw5g80pljp9nvslcsaasaad94dshxyvpvyllrsf"; depends=[AnnotationDbi AnnotationHub BiocGenerics Biostrings GenomeInfoDb GenomicFeatures GenomicRanges ggbio ggplot2 gQTLstats graph Gviz IRanges Rsamtools rtracklayer S4Vectors snpStats VariantAnnotation]; };
...
ldblock = derive { name="ldblock"; version="0.99.0"; sha256="1966dyxr1p4nhbcw0ikczlc21d7frikdb5q4rq7jxxxr9siq059d"; depends=[Matrix snpStats]; };
...
limma = derive { name="limma"; version="3.25.15"; sha256="0i30c00hvjriv8br96dwznsbsz6n03gkdazaxpm7nrm3df9gfzf7"; depends=[]; };
...
metagene = derive { name="metagene"; version="2.1.5"; sha256="1zf0l5cmfwf831l4l2c3z7463mh14b0jlz2i7q8d6klk7lwi7q48"; depends=[BiocParallel biomaRt GenomicAlignments GenomicRanges ggplot2 gplots muStat R6 Rsamtools rtracklayer]; };
...
miRNAtap = derive { name="miRNAtap"; version="1.3.1"; sha256="11z41i4p7wlhpcbvjig97bw1m13qxlr2q62cji4jkwkxhb69zyzj"; depends=[AnnotationDbi DBI plyr RSQLite sqldf stringr]; };
...
netbenchmark = derive { name="netbenchmark"; version="1.1.7"; sha256="1p5phz1f02aizfy7fhxg6yayigqiyn3k8lbpagf5amhzcaf8wimw"; depends=[c3net GeneNet Matrix minet PCIT pracma randomForest Rcpp]; };
...
rCGH = derive { name="rCGH"; version="0.99.9"; sha256="094qibkdyjf6bj7jrspfjqaqnp4mz6kb8b29ssfpv0chkc3nrxgm"; depends=[aCGH affy AnnotationDbi BiocGenerics DNAcopy GenomeInfoDb GenomicFeatures GenomicRanges ggplot2 lattice limma mclust plyr RUnit shiny]; };
...
regioneR = derive { name="regioneR"; version="1.1.7"; sha256="09pjk39cgn0hj99kz6ma49kifiyy6czcixbi2sndbrxr2vsf715f"; depends=[BSgenome GenomicRanges memoise rtracklayer]; };
...
ropls = derive { name="ropls"; version="1.1.8"; sha256="0miby88hv1r1hp8pjjqvf44y9sfz7xqjccck339mskc7vd8647ww"; depends=[]; };
...
rtracklayer = derive { name="rtracklayer"; version="1.29.26"; sha256="1ak095k0kjdmxdr0j22lm5vi5pfv0w5r669hkvkx8035md7w9rl1"; depends=[BiocGenerics Biostrings GenomeInfoDb GenomicAlignments GenomicRanges IRanges RCurl Rsamtools S4Vectors XML XVector zlibbioc]; };
...
seq2pathway = derive { name="seq2pathway"; version="1.1.4"; sha256="1m2xz9irpp4p8kkdqic5qlbfz5gn8qmf6mirnn68p3nl3rpc73hi"; depends=[biomaRt GenomicRanges GSA nnet WGCNA]; };
...
seqplots = derive { name="seqplots"; version="1.7.0"; sha256="0vk2f0grap5ckmdnqik5ac9p6qwwy69cpl9d5xyhpjmp2j4pz422"; depends=[Biostrings BSgenome Cairo class DBI digest DT fields GenomeInfoDb GenomicRanges ggplot2 gridExtra IRanges jsonlite kohonen plotrix RColorBrewer reshape2 RSQLite rtracklayer S4Vectors shiny]; };
...
snpStats = derive { name="snpStats"; version="1.19.2"; sha256="009mkjja5jky7jw62hbs6cnnqnaqm2y205d2v149xgjjxyym9r2v"; depends=[BiocGenerics Matrix survival zlibbioc]; };
...
systemPipeR = derive { name="systemPipeR"; version="1.3.38"; sha256="0anasyh5kxqz7ckjqh25g9crmdkwaqb6zgs27q1zwhcqyn06ryfd"; depends=[annotate BatchJobs BiocGenerics Biostrings DESeq2 edgeR GenomicFeatures GenomicRanges ggplot2 GOstats limma pheatmap rjson Rsamtools ShortRead SummarizedExperiment VariantAnnotation]; };
...
trackViewer = derive { name="trackViewer"; version="1.5.4"; sha256="00m3c8q61kdyz04h1mv6ck5wasqx6q1qjc4r1nw74z5wlypikl9k"; depends=[GenomicAlignments GenomicFeatures GenomicRanges Gviz gWidgets gWidgetstcltk IRanges pbapply Rsamtools rtracklayer scales]; };
...
variancePartition = derive { name="variancePartition"; version="0.99.7"; sha256="0nka0ial2q30nfqyd6mwlw8681a7yfqflnpaz8mdy6dhwbnvlr2k"; depends=[Biobase dendextend doParallel foreach ggplot2 iterators limma lme4 reshape]; };
