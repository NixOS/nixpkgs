...
in with self; {
  ...
  SomaticSignatures = derive2 { name="SomaticSignatures"; version="2.6.1"; sha256="0assknxabz6zqj1fbb0j28yxm4i2z2sn0xhmg643zylimnchjqhv"; depends=[Biobase Biostrings GenomeInfoDb GenomicRanges ggbio ggplot2 IRanges NMF pcaMethods proxy reshape2 S4Vectors VariantAnnotation]; };
  ...
  TPP = derive2 { name="TPP"; version="2.0.4"; sha256="10n4izvkc5v0d94d287a2dpzjx8lvl0xkk5p74bnsaa504ljs5nf"; depends=[Biobase doParallel foreach ggplot2 gridExtra nls2 openxlsx plyr RColorBrewer RCurl reshape2 VennDiagram VGAM]; };
  ...
  TarSeqQC = derive2 { name="TarSeqQC"; version="1.0.3"; sha256="06a9kvyx73ysllid9mafgyp1czhyf06gxma1b6bkyksingpgnb68"; depends=[BiocGenerics BiocParallel cowplot GenomeInfoDb GenomicRanges ggplot2 IRanges openxlsx plyr reshape2 Rsamtools S4Vectors]; };
