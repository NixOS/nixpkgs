...
, tezos-validation, tezos-store, tezos-workers, tezos-test-services
# , tezos-embedded-protocol-demo-noops
, tezos-test-helpers
# , tezos-protocol-plugin-alpha
, alcotest-lwt, crowbar }:
...
buildDunePackage {
  ...
  propagatedBuildInputs =
    [ tezos-p2p tezos-requester tezos-validation tezos-store tezos-workers ];
