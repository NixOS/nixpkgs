{ alcotest, base64, bigarray-compat, bigarray-overlap, bigstringaf
, buildDunePackage, fetchzip, fmt, jsonm, ke, lib, ptime }:
...
buildDunePackage rec {
  ...
  propagatedBuildInputs =
    [ bigarray-compat bigarray-overlap bigstringaf fmt ke ];
