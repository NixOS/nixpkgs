...
, bitstring, camlzip, cmdliner_1_1, core_kernel, ezjsonm, fileutils, ocaml_lwt, ocamlgraph, ocurl, re, uri, zarith, piqi, piqi-ocaml, uuidm, llvm, frontc, ounit, ppx_jane, parsexp
...
stdenv.mkDerivation rec {
  ...
  propagatedBuildInputs = [ bitstring camlzip cmdliner_1_1 ppx_bap core_kernel ezjsonm fileutils ocaml_lwt ocamlgraph ocurl re uri zarith piqi parsexp
