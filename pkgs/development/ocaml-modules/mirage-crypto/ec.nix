{ lib, buildDunePackage, mirage-crypto, dune-configurator, pkg-config, cstruct
, mirage-crypto-rng, mirage-crypto-pk, hex, alcotest, asn1-combinators
...
buildDunePackage {
  ...
  inherit (mirage-crypto) minimumOCamlVersion src version useDune2;
