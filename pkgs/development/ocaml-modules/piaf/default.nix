{ alcotest-lwt, buildDunePackage, dune-site, fetchzip, gluten-lwt-unix, lib
, logs, lwt_ssl, magic-mime, mrmime, openssl, pecu, psq, ssl, uri }:
...
buildDunePackage rec {
  ...
  checkInputs = [ alcotest-lwt dune-site ];
  doCheck = true;
