...
stdenv.mkDerivation {
  ...
  meta = with stdenv.lib; {
    description = "Uuidm is an OCaml module implementing 128 bits universally unique identifiers version 3, 5 (name based with MD5, SHA-1 hashing) and 4 (random based) according to RFC 4122.";
