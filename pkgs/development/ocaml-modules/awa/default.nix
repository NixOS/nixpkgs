...
, mirage-crypto-rng, mirage-crypto-pk, x509, cstruct, cstruct-unix, cstruct-sexp
, sexplib, rresult, mtime, logs, fmt, cmdliner, base64, hacl_x25519, zarith }:
...
buildDunePackage rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/mirage/awa-ssh/releases/download/v${version}/awa-v${version}.tbz";
