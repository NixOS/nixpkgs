...
, mirage-crypto-pk, mirage-crypto-rng, ocaml_lwt, ptime, rresult, sexplib, x509
...
buildDunePackage rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/mirleft/ocaml-tls/releases/download/v${version}/tls-v${version}.tbz";
