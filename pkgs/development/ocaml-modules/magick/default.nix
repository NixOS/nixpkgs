...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = https://www.linux-nantes.org/~fmonnier/OCaml/ImageMagick/ImageMagick/OCaml-ImageMagick-0.34.tgz;
  ...
  meta = {
    homepage = https://www.linux-nantes.org/~fmonnier/OCaml/ImageMagick/;
