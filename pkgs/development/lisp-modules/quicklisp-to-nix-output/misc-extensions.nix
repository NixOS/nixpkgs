...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/misc-extensions/2015-06-08/misc-extensions-20150608-git.tgz'';
...
/* (SYSTEM misc-extensions DESCRIPTION NIL SHA256
    ...
    https://beta.quicklisp.org/archive/misc-extensions/2015-06-08/misc-extensions-20150608-git.tgz
