...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/proc-parse/2016-03-18/proc-parse-20160318-git.tgz'';
...
/* (SYSTEM proc-parse DESCRIPTION Procedural vector parser SHA256
    ...
    https://beta.quicklisp.org/archive/proc-parse/2016-03-18/proc-parse-20160318-git.tgz
