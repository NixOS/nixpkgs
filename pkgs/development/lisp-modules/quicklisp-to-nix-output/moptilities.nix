...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/moptilities/2017-04-03/moptilities-20170403-git.tgz'';
...
/* (SYSTEM moptilities DESCRIPTION Common Lisp MOP utilities SHA256
    ...
    https://beta.quicklisp.org/archive/moptilities/2017-04-03/moptilities-20170403-git.tgz
