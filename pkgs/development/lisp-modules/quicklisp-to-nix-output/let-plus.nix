...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/let-plus/2017-01-24/let-plus-20170124-git.tgz'';
...
/* (SYSTEM let-plus DESCRIPTION Destructuring extension of LET*. SHA256
    ...
    https://beta.quicklisp.org/archive/let-plus/2017-01-24/let-plus-20170124-git.tgz
