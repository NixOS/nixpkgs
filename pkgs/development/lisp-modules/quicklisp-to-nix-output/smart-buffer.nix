...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/smart-buffer/2016-06-28/smart-buffer-20160628-git.tgz'';
...
/* (SYSTEM smart-buffer DESCRIPTION Smart octets buffer SHA256
    ...
    https://beta.quicklisp.org/archive/smart-buffer/2016-06-28/smart-buffer-20160628-git.tgz
