...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-cli/2015-12-18/cl-cli-20151218-git.tgz'';
...
/* (SYSTEM cl-cli DESCRIPTION Command line parser SHA256
    ...
    https://beta.quicklisp.org/archive/cl-cli/2015-12-18/cl-cli-20151218-git.tgz
