...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-vectors/2017-06-30/cl-vectors-20170630-git.tgz'';
...
/* (SYSTEM cl-vectors DESCRIPTION cl-paths: vectorial paths manipulation SHA256
    ...
    https://beta.quicklisp.org/archive/cl-vectors/2017-06-30/cl-vectors-20170630-git.tgz
