...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-yacc/2010-10-06/cl-yacc-20101006-darcs.tgz'';
...
/* (SYSTEM yacc DESCRIPTION A LALR(1) parser generator for Common Lisp SHA256
    ...
    https://beta.quicklisp.org/archive/cl-yacc/2010-10-06/cl-yacc-20101006-darcs.tgz
