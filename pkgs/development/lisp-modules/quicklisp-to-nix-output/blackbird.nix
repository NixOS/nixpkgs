...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/blackbird/2016-05-31/blackbird-20160531-git.tgz'';
...
/* (SYSTEM blackbird DESCRIPTION A promise implementation for Common Lisp.
    ...
    https://beta.quicklisp.org/archive/blackbird/2016-05-31/blackbird-20160531-git.tgz
