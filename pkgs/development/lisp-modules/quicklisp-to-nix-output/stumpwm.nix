...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/stumpwm/2017-07-25/stumpwm-20170725-git.tgz'';
...
/* (SYSTEM stumpwm DESCRIPTION A tiling, keyboard driven window manager SHA256
    ...
    https://beta.quicklisp.org/archive/stumpwm/2017-07-25/stumpwm-20170725-git.tgz
