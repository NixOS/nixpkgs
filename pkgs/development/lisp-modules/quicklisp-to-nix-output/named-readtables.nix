...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/named-readtables/2017-01-24/named-readtables-20170124-git.tgz'';
...
/* (SYSTEM named-readtables DESCRIPTION
  ...
  akin to the namespace of packages.
    ...
    https://beta.quicklisp.org/archive/named-readtables/2017-01-24/named-readtables-20170124-git.tgz
