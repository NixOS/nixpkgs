...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-annot/2015-06-08/cl-annot-20150608-git.tgz'';
...
/* (SYSTEM cl-annot DESCRIPTION Python-like Annotation Syntax for Common Lisp
    ...
    https://beta.quicklisp.org/archive/cl-annot/2015-06-08/cl-annot-20150608-git.tgz
