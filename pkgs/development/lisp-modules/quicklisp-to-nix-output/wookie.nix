...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/wookie/2017-02-27/wookie-20170227-git.tgz'';
...
/* (SYSTEM wookie DESCRIPTION An evented webserver for Common Lisp. SHA256
    ...
    https://beta.quicklisp.org/archive/wookie/2017-02-27/wookie-20170227-git.tgz
