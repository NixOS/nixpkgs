...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-anonfun/2011-12-03/cl-anonfun-20111203-git.tgz'';
...
/* (SYSTEM cl-anonfun DESCRIPTION Anonymous function helpers for Common Lisp
    ...
    https://beta.quicklisp.org/archive/cl-anonfun/2011-12-03/cl-anonfun-20111203-git.tgz
