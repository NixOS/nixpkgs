...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/fast-http/2017-06-30/fast-http-20170630-git.tgz'';
...
/* (SYSTEM fast-http DESCRIPTION A fast HTTP protocol parser in Common Lisp
    ...
    https://beta.quicklisp.org/archive/fast-http/2017-06-30/fast-http-20170630-git.tgz
