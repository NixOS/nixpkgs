...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/symbol-munger/2015-04-07/symbol-munger-20150407-git.tgz'';
...
/* (SYSTEM symbol-munger DESCRIPTION
  ...
  capitalization conventions of various environments
    ...
    https://beta.quicklisp.org/archive/symbol-munger/2015-04-07/symbol-munger-20150407-git.tgz
