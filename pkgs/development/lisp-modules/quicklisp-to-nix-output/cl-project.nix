...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-project/2016-05-31/cl-project-20160531-git.tgz'';
...
/* (SYSTEM cl-project DESCRIPTION Generate a skeleton for modern project SHA256
    ...
    https://beta.quicklisp.org/archive/cl-project/2016-05-31/cl-project-20160531-git.tgz
