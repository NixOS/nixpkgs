...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/cl-ansi-text/2015-08-04/cl-ansi-text-20150804-git.tgz'';
...
/* (SYSTEM cl-ansi-text DESCRIPTION
    ...
    https://beta.quicklisp.org/archive/cl-ansi-text/2015-08-04/cl-ansi-text-20150804-git.tgz
