...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/map-set/2016-06-28/map-set-20160628-hg.tgz'';
...
/* (SYSTEM map-set DESCRIPTION Set-like data structure. SHA256
    ...
    https://beta.quicklisp.org/archive/map-set/2016-06-28/map-set-20160628-hg.tgz
