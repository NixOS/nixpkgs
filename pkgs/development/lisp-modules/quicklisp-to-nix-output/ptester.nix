...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/ptester/2016-09-29/ptester-20160929-git.tgz'';
...
/* (SYSTEM ptester DESCRIPTION Portable test harness package SHA256
    ...
    https://beta.quicklisp.org/archive/ptester/2016-09-29/ptester-20160929-git.tgz
