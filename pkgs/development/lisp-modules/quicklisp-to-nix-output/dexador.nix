...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/dexador/2017-07-25/dexador-20170725-git.tgz'';
...
/* (SYSTEM dexador DESCRIPTION Yet another HTTP client for Common Lisp SHA256
    ...
    https://beta.quicklisp.org/archive/dexador/2017-07-25/dexador-20170725-git.tgz
