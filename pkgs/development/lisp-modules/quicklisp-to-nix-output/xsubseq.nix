...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/xsubseq/2015-01-13/xsubseq-20150113-git.tgz'';
...
/* (SYSTEM xsubseq DESCRIPTION Efficient way to manage "subseq"s in Common Lisp
    ...
    https://beta.quicklisp.org/archive/xsubseq/2015-01-13/xsubseq-20150113-git.tgz
