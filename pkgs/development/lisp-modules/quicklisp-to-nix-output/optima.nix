...
rec {
  ...
  src = fetchurl {
    url = ''https://beta.quicklisp.org/archive/optima/2015-07-09/optima-20150709-git.tgz'';
...
/* (SYSTEM optima DESCRIPTION Optimized Pattern Matching Library SHA256
    ...
    https://beta.quicklisp.org/archive/optima/2015-07-09/optima-20150709-git.tgz
