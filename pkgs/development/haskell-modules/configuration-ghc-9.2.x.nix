...
self: super: {
  ...
  tf-random =
    overrideCabal { doHaddock = !pkgs.stdenv.isAarch64; } super.tf-random;

  aeson = appendPatch (pkgs.fetchpatch {
    url =
      "https://gitlab.haskell.org/ghc/head.hackage/-/raw/dfd024c9a336c752288ec35879017a43bd7e85a0/patches/aeson-1.5.6.0.patch";
  ...
  basement = overrideCabal (drv: {
    ...
    url =
      "https://gitlab.haskell.org/ghc/head.hackage/-/raw/dfd024c9a336c752288ec35879017a43bd7e85a0/patches/basement-0.0.12.patch";
  ...
  cryptonite = appendPatch (pkgs.fetchpatch {
    url =
      "https://gitlab.haskell.org/ghc/head.hackage/-/raw/dfd024c9a336c752288ec35879017a43bd7e85a0/patches/cryptonite-0.29.patch";
  ...
  indexed-traversable-instances =
    doJailbreak super.indexed-traversable-instances;
  ...
  haskell-src-meta = appendPatch (pkgs.fetchpatch {
    url =
      "https://gitlab.haskell.org/ghc/head.hackage/-/raw/dfd024c9a336c752288ec35879017a43bd7e85a0/patches/haskell-src-meta-0.8.7.patch";
  ...
  memory = appendPatch (pkgs.fetchpatch {
    url =
      "https://gitlab.haskell.org/ghc/head.hackage/-/raw/dfd024c9a336c752288ec35879017a43bd7e85a0/patches/memory-0.16.0.patch";
  ...
  # Upper bound on `hashable` is too restrictive
  semigroupoids = overrideCabal (drv: {
    postPatch =
      "sed -i -e 's,hashable >= 1.2.7.0  && < 1.4,hashable >= 1.2.7.0  \\&\\& < 1.5,' semigroupoids.cabal";
  }) super.semigroupoids;
