  ...
  self: super:
    {
      ...
      vector = doJailbreak (if pkgs.stdenv.isi686
      then appendConfigureFlag "--ghc-options=-msse2" super.vector
      else super.vector);
      ...
      lucid = assert super.lucid.version == "2.9.12.1";
        overrideCabal (drv: {
          testFlags =
            [
              "--skip"
      ...
      swagger2 = assert super.swagger2.version == "2.6";
        overrideCabal (drv: {
          testTarget = "spec";
        })
        super.swagger2;
      ...
      katip = assert super.katip.version == "0.8.7.0";
        overrideCabal (drv: {
          testFlags =
            [
              "-p"
      ...
      hercules-ci-api-agent = assert super.hercules-ci-api-agent.version == "0.4.1.0";
        overrideCabal (drv: {
          testFlags =
            [
              "--skip"
