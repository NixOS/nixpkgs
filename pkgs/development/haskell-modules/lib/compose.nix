...
rec {
  ...
  */
  ...
  appendConfigureFlags = xs:
    overrideCabal
    (drv: { configureFlags = (drv.configureFlags or [ ]) ++ xs; });
  ...
  */
  ...
  addExtraLibraries = xs:
    overrideCabal
    (drv: { extraLibraries = (drv.extraLibraries or [ ]) ++ xs; });
  ...
  appendPatches = xs:
    overrideCabal (drv: { patches = (drv.patches or [ ]) ++ xs; });
  ...
  */
  triggerRebuild = i:
    overrideCabal (drv: { postUnpack = ": trigger rebuild ${toString i}"; });
  ...
  */
  ...
  addOptparseApplicativeCompletionScripts = exeName: pkg:
    builtins.trace
    "addOptparseApplicativeCompletionScripts is deprecated in favor of generateOptparseApplicativeCompletion. Please change ${pkg.name} to use the latter or its plural form."
  ...
  */
  generateOptparseApplicativeCompletion = exeName:
    overrideCabal (drv: {
