...
miscTests args@(Args {..}) = describe "Misc tests" $ do
  describe "works for a package outside the General registry" $ do
    testExpr args "CellFishing" [iii|(#{juliaAttr}.withPackages.override {
                                       packageOverrides = {
                                         "CellFishing" = pkgs.fetchFromGitHub {
                                           owner = "bicycle1885";
                                           repo = "CellFishing.jl";
                                           rev = "fd9e437631ec9c6f924c69f9cee15ee58d284206";
                                           sha256 = "sha256-NniPwrQwp0QqFjWtMhbF0SkLc9n4HKEntcgpINqV5RU=";
                                         };
                                       };
                                     }) [ "CellFishing" ]|]
