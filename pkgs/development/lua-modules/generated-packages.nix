...
final: prev: {
  alt-getopt = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua }:
  ...
  basexx = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        pname = "basexx";
        version = "scm-0";
        rockspecDir = "dist";
  ...
  busted = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl
    , lua, lua_cliargs, luafilesystem, luasystem, dkjson, say, luassert
    ...
    buildLuarocksPackage {
      ...
      knownRockspec = (fetchurl {
        url =
          "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/busted-2.0.0-1.rockspec";
  ...
  cassowary = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, penlight }:
      buildLuarocksPackage {
        pname = "cassowary";
        version = "2.3.1-2";
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/cassowary-2.3.1-2.rockspec";
  ...
  cosmo = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lpeg }:
      buildLuarocksPackage {
        pname = "cosmo";
        version = "16.06.04-1";
        knownRockspec = (fetchurl {
  ...
  coxpcall = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit }:
      buildLuarocksPackage {
        pname = "coxpcall";
        version = "1.17.0-1";
        knownRockspec = (fetchurl {
  ...
  digestif = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, lpeg }:
      buildLuarocksPackage {
        pname = "digestif";
        version = "dev-1";
  ...
  dkjson = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/dkjson-2.5-3.rockspec";
  ...
  fifo = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/fifo-0.2-0.rockspec";
  ...
  http = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl
    , lua, compat53, bit32, cqueues, luaossl, basexx, lpeg, lpeg_patterns
    , binaryheap, fifo }:
    buildLuarocksPackage {
      pname = "http";
      version = "0.3-0";
  ...
  ldoc = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit
    , penlight, markdown }:
    buildLuarocksPackage {
      pname = "ldoc";
      version = "scm-3";
  ...
  lpeg = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/lpeg-1.0.2-1.rockspec";
  ...
  lpeg_patterns = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua, lpeg }:
      buildLuarocksPackage {
        pname = "lpeg_patterns";
        version = "0.5-0";
        knownRockspec = (fetchurl {
  ...
  lrexlib-gnu = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/lrexlib-gnu-2.9.1-1.rockspec";
  ...
  lua-lsp = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit
    , lua, dkjson, lpeglabel, inspect }:
    buildLuarocksPackage {
      pname = "lua-lsp";
      version = "0.1.0-2";
      knownRockspec = (fetchurl {
  ...
  lua-resty-openidc = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast
    ...
    buildLuarocksPackage {
      ...
      disabled = with lua; (luaOlder "5.1");
      propagatedBuildInputs =
        [ lua lua-resty-http lua-resty-session lua-resty-jwt ];
  ...
  lua-term = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl }:
      buildLuarocksPackage {
        pname = "lua-term";
        version = "0.7-1";
        knownRockspec = (fetchurl {
  ...
  lua-yajl = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/lua-yajl-2.0-1.rockspec";
  ...
  luacheck = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit
    , lua, argparse, luafilesystem }:
    buildLuarocksPackage {
      pname = "luacheck";
      version = "0.25.0-1";
      knownRockspec = (fetchurl {
  ...
  luadbi-mysql = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, luadbi }:
      buildLuarocksPackage {
        pname = "luadbi-mysql";
        version = "0.7.2-1";
        knownRockspec = (fetchurl {
  ...
  luadbi-postgresql = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, luadbi }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/luadbi-postgresql-0.7.2-1.rockspec";
  ...
  luaexpat = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        src = fetchurl {
          url =
            "http://matthewwild.co.uk/projects/luaexpat/luaexpat-1.3.0.tar.gz";
  ...
  lualogging = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, luasocket }:
      buildLuarocksPackage {
        pname = "lualogging";
        version = "1.5.2-1";
        knownRockspec = (fetchurl {
  ...
  luaposix = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, bit32, lua }:
      buildLuarocksPackage {
        pname = "luaposix";
        version = "34.1.1-1";
        knownRockspec = (fetchurl {
  ...
  luasec = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, luasocket }:
      buildLuarocksPackage {
        pname = "luasec";
        version = "1.0.2-1";
        knownRockspec = (fetchurl {
  ...
  luasocket = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/luasocket-3.0rc1-2.rockspec";
  ...
  luassert = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua, say }:
      buildLuarocksPackage {
        pname = "luassert";
        version = "1.8.0-0";
        knownRockspec = (fetchurl {
        ...
        src = fetchurl {
          url =
            "https://github.com/Olivine-Labs/luassert/archive/v1.8.0.tar.gz";
  ...
  luv = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        src = fetchurl {
          url =
            "https://github.com/luvit/luv/releases/download/1.42.0-0/luv-1.42.0-0.tar.gz";
  ...
  lyaml = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua }:
      buildLuarocksPackage {
        ...
        knownRockspec = (fetchurl {
          url =
            "https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/master/lyaml-6.2.7-1.rockspec";
  ...
  mpack = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl }:
    buildLuarocksPackage {
      pname = "mpack";
      version = "1.0.9-0";
      knownRockspec = (fetchurl {
  ...
  penlight = callPackage ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit
    , lua, luafilesystem }:
    buildLuarocksPackage {
      pname = "penlight";
      version = "dev-1";
  ...
  plenary-nvim = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, luassert }:
      buildLuarocksPackage {
        pname = "plenary.nvim";
        version = "scm-1";
  ...
  readline = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchurl, lua, luaposix }:
      buildLuarocksPackage {
        pname = "readline";
        version = "3.0-0";
        knownRockspec = (fetchurl {
  ...
  std-normalize = callPackage
    ({ buildLuarocksPackage, luaOlder, luaAtLeast, fetchgit, lua, std-_debug }:
      buildLuarocksPackage {
        pname = "std.normalize";
        version = "git-1";
