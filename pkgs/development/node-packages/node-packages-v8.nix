...
let
  sources = {
    ...
    "colors-1.2.0" = {
      ...
      version = "1.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/colors/-/colors-1.2.0.tgz";
        sha512 = "02kdgwcna64wlvfb2kphqxn1yy1sjxfkfxwc48qh4199jy0sbr4q267wn8jiz3y4n2ijnn6j5kdk22f5g8bchd61ajsi7grqn0sw1wp";
      };
    };
    "pkginfo-0.4.1" = {
      name = "pkginfo";
