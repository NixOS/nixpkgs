...
let
  sources = {
    ...
    "aws-sdk-2.494.0" = {
      ...
      version = "2.494.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.494.0.tgz";
        sha512 = "qhNUe4rUbTfVKgDmfoLHpbkcgam2aFn7JtRZlfnH74g+ZOfNLbSj5ooRcLiHimffhXUo3Epj5bPX2tBOQ+BeXQ==";
      };
    };
    "aws-sign2-0.6.0" = {
      name = "aws-sign2";
