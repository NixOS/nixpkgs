...
let
  sources = {
    ...
    "aws-sdk-2.490.0" = {
      ...
      version = "2.490.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.490.0.tgz";
        sha512 = "8dCf+F360XEwOorTk0wVV/haaxYvUZnfZI6PVXfR8xbcVd7Ioh9KWRe+MqHNStEttE4UQzknEPrUj/mDW++NDw==";
      };
    };
    "aws-sign2-0.6.0" = {
      name = "aws-sign2";
    ...
    "ms-rest-2.5.2" = {
      ...
      version = "2.5.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ms-rest/-/ms-rest-2.5.2.tgz";
        sha512 = "ZyaAu0IX/TwgjwLbWHRmnzhsoE4IimGVhVW96gI5pHtSjqpnt6woPK/SzMjJTGeF4k1m1p5A5N/vKshyVUGC2Q==";
      };
    };
