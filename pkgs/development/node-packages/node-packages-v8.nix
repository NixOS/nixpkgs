...
let
  sources = {
    ...
    "@types/node-10.3.4" = {
      ...
      version = "10.3.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-10.3.4.tgz";
        sha512 = "100qf6z8rv79cf8z5ghxwziwm2ks55pbsc41fsqpc9scn4rzyv1khhyvncgb8j7423a41kr0iq1lhs60p9dzc07mn5hr74dsz6ybhk0";
      };
    };
