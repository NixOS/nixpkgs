...
let
  sources = {
    ...
    "npm-packlist-1.4.2" = {
      ...
      version = "1.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/npm-packlist/-/npm-packlist-1.4.2.tgz";
        sha512 = "pyJclkNoBBckB6K/XPcMp8fP60MaqSZBPQVsNY7Yyc9VP1TUnPMYwck5YaBejf0L7xYr8f4l16+IENeZ0by+yw==";
      };
    };
    "npm-run-path-2.0.2" = {
      name = "npm-run-path";
