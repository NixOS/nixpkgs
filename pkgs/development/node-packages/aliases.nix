...
in mapAliases {
  ...
  coc-imselect =
    throw "coc-imselect was removed because it was broken"; # added 2023-08-21
  ...
  git-ssb =
    throw "git-ssb was removed because it was broken"; # added 2023-08-21
  ...
  node-inspector =
    throw "node-inspector was removed because it was broken"; # added 2023-08-21
  inherit (pkgs) npm-check-updates; # added 2023-08-22
  ocaml-language-server = throw
    "ocaml-language-server was removed because it was abandoned upstream"; # added 2023-09-04
  inherit (pkgs) react-static; # added 2023-08-21
  readability-cli = pkgs.readability-cli; # Added 2023-06-12
  reveal-md = pkgs.reveal-md; # added 2023-07-31
  inherit (pkgs) rtlcss; # added 2023-08-29
  s3http = throw
    "s3http was removed because it was abandoned upstream"; # added 2023-08-18
  ...
  ssb-server =
    throw "ssb-server was removed because it was broken"; # added 2023-08-21
  ...
  vscode-langservers-extracted =
    pkgs.vscode-langservers-extracted; # Added 2023-05-27
