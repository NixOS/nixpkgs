  ...
  sources = {
    ...
    "pull-pushable-2.1.0" = {
      ...
      src = fetchurl {
        ...
        sha1 = "aa6c37cde7d54347c49762b4c8b467e814e52fbc";
      };
    };
    "pull-window-2.1.4" = {
      name = "pull-window";
    ...
    "aws-sdk-2.50.0" = {
      ...
      version = "2.50.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.50.0.tgz";
        sha1 = "6b2855741f8efe064f824a3db0bf4f3bc5bde018";
      };
    };
    "request-2.81.0" = {
      name = "request";
    ...
    "conf-1.1.0" = {
      ...
      version = "1.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/conf/-/conf-1.1.0.tgz";
        sha1 = "db5c4f9dc691c3c098b482d3d0c60a4e7a554d1c";
      };
    };
    "got-6.7.1" = {
      name = "got";
    ...
    "es5-ext-0.10.16" = {
      ...
      version = "0.10.16";
      src = fetchurl {
        url = "https://registry.npmjs.org/es5-ext/-/es5-ext-0.10.16.tgz";
        sha1 = "1ef1b04f3d09db6a5d630226d62202f2e425e45a";
      };
    };
    "es6-iterator-2.0.1" = {
      name = "es6-iterator";
    ...
    "simple-git-1.72.0" = {
      ...
      version = "1.72.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/simple-git/-/simple-git-1.72.0.tgz";
        sha1 = "e462ce8b46d4523f679e340000681582e9e965d2";
      };
    };
    ...
    "write-file-atomic-2.0.0" = {
      ...
      version = "2.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/write-file-atomic/-/write-file-atomic-2.0.0.tgz";
        sha1 = "bb99a5440d0d31dd860a68da392bffeef66251a1";
      };
    };
    ...
    "amqplib-0.5.1" = {
      ...
      version = "0.5.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/amqplib/-/amqplib-0.5.1.tgz";
        sha1 = "7cccfebabe56c2e984ea7a2243f7cefe6fbfc6cf";
      };
    };
    "base64-url-1.3.3" = {
      name = "base64-url";
...
in
{
  ...
  npm = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."configstore-3.1.0" // {
        dependencies = [
          sources."write-file-atomic-2.0.0"
        ];
      })
      sources."is-npm-1.0.0"
  ...
  TaigaIO-Events-undefined = nodeEnv.buildNodePackage {
    name = "TaigaIO-Events";
    packageName = "TaigaIO-Events";
    version = "0.0.1";
    src = fetchurl {
      name = "TaigaIO-Events-0.0.1.tar.gz";
      url = https://codeload.github.com/betaboon/taiga-events/legacy.tar.gz/4a0b0b1a21d224982b45c0fd84e4353f64ac95a8;
      sha256 = "4e75ccac255c90ce4714eda6b60211061c3ecce26d4cf1206cf78144d644de0f";
    };
    dependencies = [
      (sources."amqplib-0.5.1" // {
        dependencies = [
          sources."bluebird-3.5.0"
        ];
      })
  ...
  uglify-js = nodeEnv.buildNodePackage {
    ...
    version = "3.0.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/uglify-js/-/uglify-js-3.0.4.tgz";
      sha1 = "13da18bc4ecec20d29861b4ab7b60cb9ef9a9cc0";
    };
    dependencies = [
      sources."commander-2.9.0"
      sources."source-map-0.5.6"
