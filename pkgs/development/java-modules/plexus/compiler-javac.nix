{fetchMaven}: {
  plexusCompilerJavac_2_2 = map (obj:
    ...
    {
      type = "jar";
      sha512 = "12xsiaqd1q6mmmkcsxf4nr4wdjl8fa1nwz32yqwrrbj9cgakph0368cnk1apjzngsmnl6bws87nlxcz64sg0rb7i2vdzggplj0a41br";
    }
    {
      type = "pom";
  ...
  plexusCompilerJavac_2_4 = map (obj:
    ...
    {
      type = "jar";
      sha512 = "272iaf7mgmhjssj0k4a9r8rzb3c8pskb4aqypcdvj217l8hbih6rsqhh9nd2xmwrwa1ifvc336b8ihz6f419lj74gp4p1za6mp0nps3";
    }
    {
      type = "pom";
