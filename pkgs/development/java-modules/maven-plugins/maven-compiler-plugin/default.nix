...
rec {
  ...
  mavenCompiler21 = mavenCompilerGen {
    ...
    mavenDeps = [ bootstrapMavenClean23Jar bootstrapMavenCompiler202Jar bootstrapMavenEnforcer10beta1Jar bootstrapMavenPlugin251Jar bootstrapMavenRemoteResources10Jar bootstrapMavenResources23Jar apacheParent6 mavenParent15 mavenPlugins16 ];
