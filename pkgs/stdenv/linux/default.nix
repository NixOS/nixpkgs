...
in [
  ...
  (prevStage:
    stageFun prevStage {
      ...
      extraNativeBuildInputs = lib.optional (localSystem.isRiscV)
    ...
    stageFun prevStage {
      ...
      overrides = self: super: rec {
        inherit (prevStage)
          ...
          gnum4 bison libidn2 libunistring;
        ${localSystem.libc} = getLibc prevStage;
        ...
        isl_0_20 = super.isl_0_20.override {
          stdenv = self.makeStaticLibraries self.stdenv;
        };
  ...
  (prevStage:
    stageFun prevStage {
      ...
      overrides = self: super: {
        ...
        inherit (prevStage)
          gettext gnum4 bison gmp perl texinfo zlib linuxHeaders libidn2
          libunistring;
        ${localSystem.libc} = getLibc prevStage;
