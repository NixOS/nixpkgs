...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    # These bootstrap hashes generated by compiling from nixpkgs b8d12c580142f03d0384d4009c0349b29d02a06b on x86_64-linux
    x86_64-freebsd14 = {
      bash = {
      ...
      bootstrapFiles = {
        url = "http://192.168.1.154:8000/9zh1mzkb21grdy8lf8lq3slwpii8lynx-x86_64-freebsd14-bootstrap-files.tar.xz";
        hash = "sha256-+wSuNkVL6+kaekRvaZzVgdvCr0Lq3yI0DAKgNEy9Fsw=";
      };
    };
  };
