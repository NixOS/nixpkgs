...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    # These bootstrap hashes generated by compiling from nixpkgs 0b9c8b6b0952b56c961291fcfdfba40339a17fe1 on x86_64-linux
    x86_64-freebsd = {
      bash = {
      ...
      bootstrapFiles = {
        url = "https://f005.backblazeb2.com/file/nixbsd/y0svkf8swq2ps98kx75ln0fbid2hnlzk-x86_64-freebsd-bootstrap-files.tar.xz";
        hash = "sha256-Bloa58FBjX9FC0QSyAaJZ5i9OBMG4ze0iTfnRrYsEFo=";
