...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    ...
    x86_64-freebsd14 = {
      bash = {
        url = "https://f005.backblazeb2.com/file/nixbsd/csbvka6avgsfps360w2qy1qmmk4fvkyb-x86_64-freebsd14-bash";
        hash = "sha256-cwMTbaJcnChQsUHhEyhrykua64N7E19cn+6xzSBCwRc=";
      };
      mkdir = {
        url = "https://f005.backblazeb2.com/file/nixbsd/jhgx13i05pnavaky74vrmbw9aamwz6fn-x86_64-freebsd14-mkdir";
        hash = "sha256-rPNJ8R4EgyXsdsgxUKg05JbtoWrsd+3Txlhn2fiyan4=";
      };
      tar = {
        url = "https://f005.backblazeb2.com/file/nixbsd/r2s046l8h4dpmz2d7hr7xzwaj7m7779r-x86_64-freebsd14-tar";
        hash = "sha256-F2yW6mh3081BlHh1TEodAWQ5vUaM18Biu22R53L+Imo=";
      };
      unxz = {
        url = "https://f005.backblazeb2.com/file/nixbsd/arhglckq73q4nhp8hs5n8vwx4i0sk059-x86_64-freebsd14-unxz";
        hash = "sha256-GSwqOktp0RzYT6bWozpSXzKyV1+81jw2L6MpoAgn8TY=";
      };
      chmod = {
        url = "https://f005.backblazeb2.com/file/nixbsd/4iwy0333wrisdgp21l7swy5hlhwdpj99-x86_64-freebsd14-chmod";
        hash = "sha256-iBdzCXKU+03MfOA75ASrXOD3arPtQnvKqsdCf32oKxk=";
      };
      bootstrapFiles = {
        url = "https://f005.backblazeb2.com/file/nixbsd/x2h3j962z075243xzpg7lx0df74ajyjv-x86_64-freebsd14-bootstrap-files.tar.xz";
        hash = "sha256-90b1h7LpKqWCHoMWTThb1TdbBiclAntsJdhg+pV82Zk=";
