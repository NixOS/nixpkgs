...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    ...
    x86_64-freebsd14 = {
      bash = {
        url = "http://192.168.122.1:8000/i6ih4cynhx28bi0k29l3pw74aidbs4kq-x86_64-freebsd14-bash";
        hash = "sha256-Bc+rmOcYcsWo89F45JNlDbvtIxJvzfE3Ixnlh5Chsnc=";
      };
      mkdir = {
        url = "http://192.168.122.1:8000/yml67zp951q3ihgq86acrv2wlmlc56ny-x86_64-freebsd14-mkdir";
      ...
      chmod = {
        url = "http://192.168.122.1:8000/251pcbqpsa5fak8avml2wf6r3xwdvnp4-x86_64-freebsd14-chmod";
        hash = "sha256-iBdzCXKU+03MfOA75ASrXOD3arPtQnvKqsdCf32oKxk=";
      };
      bootstrapFiles = {
        url = "http://192.168.122.1:8000/9s9gdpysarbsz6b2z6h13wsq8xksz7vp-x86_64-freebsd14-bootstrap-files.tar.xz";
        hash = "sha256-iZ8Q8aSszn1xS4UTT/9mcbJT8f7L+ti/P61jIEVKkqw=";
