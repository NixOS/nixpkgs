...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    # These bootstrap hashes generated by compiling from nixpkgs (dirty) on x86_64-linux
    x86_64-freebsd14 = {
      bash = {
        url = "http://192.168.122.1:8000/50zn91a7a4xbnk7daga8dhjznr21ks82-x86_64-freebsd14-bash";
        hash = "sha256-vGcMcsko0WNg8f04d+o7oi8WskF89ZzXZQxIOwIwrEc=";
      };
      mkdir = {
        url = "http://192.168.122.1:8000/psrha89cjrb32f766fh2fy6yx5k2v3ss-x86_64-freebsd14-mkdir";
        hash = "sha256-fOEu9DAGL1iT0Pc7eDfc5CMyTAqObI9C268TEAulHqU=";
      };
      tar = {
        url = "http://192.168.122.1:8000/y238ncg7x3q3h7i1ag2gjs9jy7skhg5i-x86_64-freebsd14-tar";
        hash = "sha256-7d8euOP5ok0KDUxxRJn2GbVYVOCml9AKhYWfQwF9yrg=";
      };
      unxz = {
        url = "http://192.168.122.1:8000/gn6y33zd1nmpcfc95fcp42l98995fv70-x86_64-freebsd14-unxz";
        hash = "sha256-AVKol+Bc6qX2zDuilV9i4JCBnNLsGEm7UJp2VpakJVM=";
      };
      chmod = {
        url = "http://192.168.122.1:8000/lbvrpbgblg8kajrklwwknbcqp0kavg46-x86_64-freebsd14-chmod";
        hash = "sha256-ZU7kfwFlFPLkoLlgymZNDYFd2C5gfuAFs0GkLP1pdT8=";
      };
      bootstrapFiles = {
        url = "http://192.168.122.1:8000/a4sfa27z9clp2dd8gji70mdjqvm0sygd-x86_64-freebsd14-bootstrap-files.tar.xz";
        hash = "sha256-gJhvgOlYhTBX8djkPNheeSW0WGnIP0+2Vvwh98Ra0Wc=";
