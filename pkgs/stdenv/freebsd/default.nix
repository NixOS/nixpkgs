...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    ...
    x86_64-freebsd14 = {
      ...
      bootstrapFiles = {
        url = "http://192.168.122.1:8000/x2vr8jk3gbvrx6plqr8wbhy8l6kxa043-x86_64-freebsd14-bootstrap-files.tar.xz";
        hash = "sha256-VOytY/acNXEDPvHGtTORFBAHbOqKXacZwe+YisuIgD4=";
