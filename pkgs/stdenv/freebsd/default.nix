...
let inherit (localSystem) system;
  all-bootstrap-urls-table = {
    # These bootstrap hashes generated by compiling from nixpkgs a7d1c6aad790a592f67e7438e200de9b220b7cc8 on x86_64-linux
    x86_64-freebsd = {
      bash = {
        url = "https://f005.backblazeb2.com/file/nixbsd/9sqr7ya6z34mj3f4jd3sg06ksblk1p31-x86_64-freebsd-bash";
        hash = "sha256-P69xo8/B7KiovGlLq9U/PXU/iDKm7BjONzRGJH3PtOA=";
      };
      mkdir = {
        url = "https://f005.backblazeb2.com/file/nixbsd/822h12q3fql52yz17npw5apkfq03wxl5-x86_64-freebsd-mkdir";
        hash = "sha256-rPNJ8R4EgyXsdsgxUKg05JbtoWrsd+3Txlhn2fiyan4=";
      };
      tar = {
        url = "https://f005.backblazeb2.com/file/nixbsd/kljfv0d3xz6zsyab6428kgryzn7m4sz9-x86_64-freebsd-tar";
        hash = "sha256-ZwwB+/Yk2SoUIi0Nn65/gdsOGI6lVyuNmbZ+MKVEk/Y=";
      };
      unxz = {
        url = "https://f005.backblazeb2.com/file/nixbsd/zm2qriwwbf40dlrdz2swlllwgjwvmq0a-x86_64-freebsd-unxz";
        hash = "sha256-GSwqOktp0RzYT6bWozpSXzKyV1+81jw2L6MpoAgn8TY=";
      };
      chmod = {
        url = "https://f005.backblazeb2.com/file/nixbsd/syfiypqld0j2xmnz08vcv55y6p03v7dd-x86_64-freebsd-chmod";
        hash = "sha256-iBdzCXKU+03MfOA75ASrXOD3arPtQnvKqsdCf32oKxk=";
      };
      bootstrapFiles = {
        url = "https://f005.backblazeb2.com/file/nixbsd/ws2f1c3j4rrdbkqcwqf04hhvlmvap4q7-x86_64-freebsd-bootstrap-files.tar.xz";
        hash = "sha256-xVyYWWevHCq12c6inymqZhczKIHkI8FDaP4S+NfI9CY=";
