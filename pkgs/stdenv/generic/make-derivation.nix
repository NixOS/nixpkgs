...
let
  ...
  defaultHardeningFlags = if (stdenv.hostPlatform.isAarch && stdenv.hostPlatform.isStatic)
    then lib.remove "pie" supportedHardeningFlags
    else supportedHardeningFlags;
