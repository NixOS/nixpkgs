...
rec {
  ...
  stageFun = step: last: { shell ? "${bootstrapTools}/bin/bash"
    ...
    let
      ...
      cc =
        if last == null then "/dev/null" else import ../../build-support/cc-wrapper {
          inherit shell;
          inherit (last) stdenvNoCC;
      ...
      thisStdenv = import ../generic {
        ...
        allowedRequisites =
          if allowedRequisites == null then null else allowedRequisites ++ [
  ...
  stage3 = prevStage:
    let
      persistent = self: super: with prevStage; {
        ...
        llvmPackages_7 = super.llvmPackages_7 // (
          let
