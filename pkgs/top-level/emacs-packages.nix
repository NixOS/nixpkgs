...
in rec {
  ...
  # version
  otherPackages = {
    auto-complete = callPackage ../applications/editors/emacs-modes/auto-complete { };
    ...
    color-theme = callPackage ../applications/editors/emacs-modes/color-theme { };
    ...
    emacs-w3m = callPackage ../applications/editors/emacs-modes/emacs-w3m { texinfo = pkgs.texinfo5; };
    emms = callPackage ../applications/editors/emacs-modes/emms { texinfo = pkgs.texinfo5; };
    ess = callPackage ../applications/editors/emacs-modes/ess { };
    flymake-cursor = callPackage ../applications/editors/emacs-modes/flymake-cursor { };
    gh = callPackage ../applications/editors/emacs-modes/gh { };
    graphviz-dot-mode = callPackage ../applications/editors/emacs-modes/graphviz-dot { };
    ...
    haskell-mode = callPackage ../applications/editors/emacs-modes/haskell { };
    ocamlMode = callPackage ../applications/editors/emacs-modes/ocaml { };
    tuareg = callPackage ../applications/editors/emacs-modes/tuareg { };
    hol_light_mode = callPackage ../applications/editors/emacs-modes/hol_light { };
    htmlize = callPackage ../applications/editors/emacs-modes/htmlize { };
    logito = callPackage ../applications/editors/emacs-modes/logito { };
    lorem-ipsum = callPackage ../applications/editors/emacs-modes/lorem-ipsum { };
    ...
    php-mode = callPackage ../applications/editors/emacs-modes/php { };
    prolog = callPackage ../applications/editors/emacs-modes/prolog { };
    ...
    rect-mark = callPackage ../applications/editors/emacs-modes/rect-mark { };
    remember = callPackage ../applications/editors/emacs-modes/remember { };
    rudel = callPackage ../applications/editors/emacs-modes/rudel { };
    scala-mode = callPackage ../applications/editors/emacs-modes/scala-mode { };
    sunriseCommander = callPackage ../applications/editors/emacs-modes/sunrise-commander { };
    xml-rpc = callPackage ../applications/editors/emacs-modes/xml-rpc { };
  };
}
