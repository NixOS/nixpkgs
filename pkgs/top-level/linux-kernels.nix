...
in {
  ...
  packagesFor = kernel_: lib.makeExtensible (self: with self;
    ...
    system76-power = throw "kernelPackages.system76-power is now pkgs.system76-power"; # Added 2024-10-16
    system76-scheduler = throw "kernelPackages.system76-scheduler is now pkgs.system76-scheduler"; # Added 2024-10-16
