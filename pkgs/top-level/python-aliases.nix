...
mapAliases ({
  ...
  abodepy = self.jaraco-abode; # added 2023-02-01
  ...
  amazon_kclpy = self.amazon-kclpy; # added 2023-08-08
  ...
  argon2_cffi = self.argon2-cffi; # added 2022-05-09
  APScheduler = self.apscheduler; # added 2023-02-19
  async_generator = self.async-generator; # added 2023-08-08
  async_stagger = self.async-stagger; # added 2023-08-08
  asyncio-mqtt = throw "asyncio-mqtt has been replaced by aiomqtt, which is not API compatible."; # added 2024-07-07
  asyncio-nats-client = self.nats-py; # added 2022-02-08
  atsim_potentials = self.atsim-potentials; # added 2023-10-08
  awkward0 = throw "awkward0 has been removed, use awkward instead"; # added 2022-12-13
  Babel = self.babel; # added 2022-05-06
  ...
  backports_shutil_get_terminal_size = self.backports-shutil-get-terminal-size; # added 2024-04-21
  ...
  bash_kernel = self.bash-kernel; # added 2023-11-10
  beancount_docverif = self.beancount-docverif; # added 2023-10-08
  bedup = throw "bedup was removed because it was broken and abandoned upstream"; # added 2023-02-04
  bip_utils = self.bip-utils; # 2023-10-08
  bitcoin-price-api = throw "bitcoin-price-api has been removed, it was using setuptools 2to3 translation feautre, which has been removed in setuptools 58"; # added 2022-02-15
  BlinkStick = self.blinkstick; # added 2023-02-19
  blockdiagcontrib-cisco = throw "blockdiagcontrib-cisco is not compatible with blockdiag 2.0.0 and has been removed."; # added 2020-11-29
  bsblan = self.python-bsblan; # added 2022-11-04
  btchip = self.btchip-python; # added 2023-03-03
  ...
  btsmarthub_devicelist = self.btsmarthub-devicelist; # added 2024-01-03
  bt_proximity = self.bt-proximity; # added 2021-07-02
  BTrees = self.btrees; # added 2023-02-19
  ...
  can = self.python-can; # added 2024-08-12
  ...
  cchardet = self.faust-cchardet; # added 2023-03-02
  ...
  class-registry = self.phx-class-registry; # added 2021-10-05
  ...
  ColanderAlchemy = self.colanderalchemy; # added 2023-02-19
  command_runner = self.command-runner; # added 2024-03-06
  CommonMark = self.commonmark; # added 2023-02-1
  ...
  cx_Freeze = self.cx-freeze; # added 2023-08-02
  cx_oracle = self.cx-oracle; # added 2024-01-03
  ...
  dateutil = self.python-dateutil; # added 2021-07-03
  ...
  dictpath = self.pathable; # added 2023-01-28
  diff_cover = self.diff-cover; # added 2021-07-02
  discogs_client = self.discogs-client; # added 2021-07-02
  distutils_extra = self.distutils-extra; # added 2023-10-12
  digital-ocean = self.python-digitalocean; # addad 2024-04-12
  djangorestframework-jwt = self.drf-jwt; # added 2021-07-20
  ...
  django_appconf = self.django-appconf; # added 2022-03-03
  django_classytags = self.django-classy-tags; # added 2023-07-25
  django_colorful = self.django-colorful; # added 2023-07-25
  django_compat = self.django-compat; # added 2023-07-25
  ...
  django_contrib_comments = self.django-contrib-comments; # added 2023-07-25
  ...
  django_environ = self.django-environ; # added 2021-12-25
  django_extensions = self.django-extensions; # added 2022-01-09
  django_guardian = self.django-guardian; # added 2022-05-19
  django_hijack = self.django-hijack; # added 2023-05-16
  django_hijack_admin = self.django-hijack-admin; # added 2023-05-16
  ...
  django_modelcluster = self.django-modelcluster; # added 2022-04-02
  django-mysql = throw "django-mysql has been removed, since it was an unused leaf package"; # added 2024-07-02
  django_nose = self.django-nose; # added 2023-07-25
  ...
  django_reversion = self.django-reversion; # added 2022-06-18
  django_polymorphic = self.django-polymorphic; # added 2022-05-24
  django_redis = self.django-redis; # added 2021-10-11
  django_silk = self.django-silk; # added 2023-07-25
  django-sr = throw "django-sr has been removed since it has been unmaintained for 10 years"; # added 2024-05-26
  django_tagging = self.django-tagging; # added 2023-07-25
  django_taggit = self.django-taggit; # added 2021-10-11
  django_treebeard = self.django-treebeard; # added 2023-07-25
  dns = self.dnspython; # added 2017-12-10
  docker_pycreds = self.docker-pycreds; # added 2024-01-03
  ...
  dogpile_cache = self.dogpile-cache; # added 2021-10-28
  dogpile-core = throw "dogpile-core is no longer maintained, use dogpile-cache instead"; # added 2021-11-20
  eebrightbox = throw "eebrightbox is unmaintained upstream and has therefore been removed"; # added 2022-02-03
  EasyProcess = self.easyprocess; # added 2023-02-19
  email_validator = self.email-validator; # added 2022-06-22
  enhancements = throw "enhancements is unmaintained upstream and has therefore been removed"; # added 2023-10-27
  et_xmlfile = self.et-xmlfile; # added 2023-10-16
  etebase-server = throw "pkgs.python3.etebase-server has been removed, use pkgs.etebase-server"; # added 2024-07-16
  ev3dev2 = self.python-ev3dev2; # added 2023-06-19
  eyeD3 = self.eyed3; # added 2024-01-03
  Fabric = self.fabric; # addedd 2023-02-19
  face_recognition = self.face-recognition; # added 2022-10-15
  face_recognition_models = self.face-recognition-models; # added 2022-10-15
  factory_boy = self.factory-boy; # added 2023-10-08
  ...
  fastnlo_toolkit = self.fastnlo-toolkit; # added 2024-01-03
  fastpair = throw "fastpair is unmaintained upstream and has therefore been removed"; # added 2024-05-01
  faulthandler = throw "faulthandler is built into ${self.python.executable}"; # added 2021-07-12
  inherit (super.pkgs) fetchPypi; # added 2023-05-25
  filebrowser_safe = self.filebrowser-safe; # added 2024-01-03
  filemagic = throw "inactive since 2014, so use python-magic instead"; # added 2022-11-19
  flaskbabel = self.flask-babel; # added 2023-01-19
  flask_assets = self.flask-assets; # added 2023-08-23
  flask_elastic = self.flask-elastic; # added 2023-08-23
  flask_login = self.flask-login; # added 2022-10-17
  flask_mail = self.flask-mail; # added 2023-08-23
  flask_marshmallow = self.flask-marshmallow; # added 2023-08-16
  flask_migrate = self.flask-migrate; # added 2023-08-23
  flask_principal = self.flask-principal; # added 2023-08-23
  flask-restplus = throw "flask-restplus is no longer maintained, use flask-restx instead"; # added 2023-02-21
  flask_script = self.flask-script; # added 2023-08-23
  flask-security-too = self.flask-security; # added 2024-08-26
  flask_sqlalchemy = self.flask-sqlalchemy; # added 2022-07-20
  flask_testing = self.flask-testing; # added 2022-04-25
  flask_wtf = self.flask-wtf; # added 2022-05-24
  ...
  flowlogs_reader = self.flowlogs-reader; # added 2024-01-03
  flufl_bounce = self.flufl-bounce; # added 2023-11-03
  flufl_i18n = self.flufl-i18n; # added 2023-11-03
  flufl_lock = self.flufl-lock; # added 2023-11-03
  ...
  FormEncode = self.formencode; # added 2023-02-19
  ...
  google_api_python_client = self.google-api-python-client; # added 2021-03-19
  googleapis_common_protos = self.googleapis-common-protos; # added 2021-03-19
  ...
  gradient_statsd = self.gradient-statsd; # added 2024-01-06
  ...
  grappelli_safe = self.grappelli-safe; # added 2023-10-08
  groestlcoin_hash = self.groestlcoin-hash; # added 2024-01-06
  grpc_google_iam_v1 = self.grpc-google-iam-v1; # added 2021-08-21
  inherit (self.pkgs) gtimelog;
  guzzle_sphinx_theme = self.guzzle-sphinx-theme; # added 2023-10-16
  ha-av = throw "ha-av was removed, because it is no longer maintained"; # added 2022-04-06
  HAP-python = self.hap-python; # added 2021-06-01
  hangups = throw "hangups was removed because Google Hangouts has been shut down"; # added 2023-02-13
  hbmqtt = throw "hbmqtt was removed because it is no longer maintained"; # added 2021-11-07
  hcs_utils = self.hcs-utils; # added 2024-01-06
  hdlparse = throw "hdlparse has been removed, it was using setuptools 2to3 translation feature, which has been removed in setuptools 58"; # added 2022-01-18
  hglib = self.python-hglib; # added 2023-10-13
  homeassistant-bring-api = self.bring-api; # added 2024-04-11
  ...
  ipython_genutils = self.ipython-genutils; # added 2023-10-12
  influxgraph = throw "influxgraph has been removed because it is no longer maintained"; # added 2022-07-10
  itanium_demangler = self.itanium-demangler; # added 2022-10-17
  jaraco_classes = self.jaraco-classes; # added 2023-07-14
  jaraco_collections = self.jaraco-collections; # added 2023-07-14
  jaraco_functools = self.jaraco-functools; # added 2023-07-14
  jaraco_itertools = self.jaraco-itertools; # added 2023-07-14
  jaraco_logging = self.jaraco-logging; # added 2023-07-14
  jaraco_text = self.jaraco-text; # added 2023-07-14
  jaraco_stream = self.jaraco-stream; # added 2023-07-14
  JayDeBeApi = self.jaydebeapi; # added 2023-02-19
  jinja2_pluralize = self.jinja2-pluralize; # added 2023-11-01
  jinja2_time = self.jinja2-time; # added 2022-11-07
  JPype1 = self.jpype1; # added 2023-02-19
  jsonpath_rw = self.jsonpath-rw; # added 2024-01-06
  jsonschema_3 = throw "jsonschema 3 is neither the latest version nor needed inside nixpkgs anymore"; # added 2023-06-28
  jupyter_client = self.jupyter-client; # added 2021-10-15
  jupyter_console = self.jupyter-console; # added  2023-07-31
  jupyter_core = self.jupyter-core; # added 2023-01-05
  jupyter_server = self.jupyter-server; # added 2023-01-05
  jupyter-server-ydoc = self.jupyter-collaboration; # added 2023-07-18
  ...
  jupyterlab_server = self.jupyterlab-server; # added 2023-11-12
  Kajiki = self.kajiki; # added 2023-02-19
  keepkey_agent = self.keepkey-agent; # added 2024-01-06
  Keras = self.keras; # added 2021-11-25
  ldap = self.python-ldap; # added 2022-09-16
  lammps-cython = throw "lammps-cython no longer builds and is unmaintained"; # added 2021-07-04
  langchainplus-sdk = self.langsmith; # added 2023-08-01
  lazr_config = self.lazr-config; # added 2023-11-03
  lazr_delegates = self.lazr-delegates; # added 2023-11-03
  lazy_import = self.lazy-import; # added 2024-01-07
  lazy-import = throw "lazy-import has been removed because it was unused."; # added 2024-05-20
  lazy_imports = self.lazy-imports; # added 2023-10-13
  ledger_agent = self.ledger-agent; # Added 2024-01-07
  ...
  line_profiler = self.line-profiler; # added 2023-11-04
  linear_operator = self.linear-operator; # added 2024-01-07
  ...
  logilab_common = self.logilab-common; # added 2022-11-21
  loo-py = self.loopy; # added 2022-05-03
  ludios_wpull = throw "ludios_wpull has been removed because it's unmaintained and broken"; # added 2023-11-12
  lcov_cobertura = self.lcov-cobertura; # added 2024-01-07
  Mako = self.mako; # added 2023-02-19
  Markups = self.markups; # added 2022-02-14
  ...
  mac_alias = self.mac-alias; # added 2024-01-07
  MDP = self.mdp; # added 2023-02-19
  MechanicalSoup = self.mechanicalsoup; # added 2021-06-01
  memcached = self.python-memcached; # added 2022-05-06
  ...
  memory_profiler = self.memory-profiler; # added 2023-10-09
  mir_eval = self.mir-eval; # added 2024-01-07
  mistune_0_8 = throw "mistune_0_8 was removed because it was outdated and insecure"; # added 2022-08-12
  mistune_2_0 = self.mistune; # added 2022-08-12
  ...
  mkdocs-minify = self.mkdocs-minify-plugin; # added 2023-11-28
  ...
  multi_key_dict = self.multi-key-dict; # added 2023-11-05
  ...
  nose_warnings_filters = self.nose-warnings-filters; # added 2024-01-07
  ...
  Nuitka = self.nuitka; # added 2023-02-19
  ...
  openai-triton = self.triton; # added 2024-07-18
  openai-triton-bin = self.triton-bin; # added 2024-07-18
  openai-triton-cuda = self.triton-cuda; # added 2024-07-18
  openai-triton-no-cuda = self.triton-no-cuda; # added 2024-07-18
  ...
  opsdroid_get_image_size = self.opsdroid-get-image-size; # added 2023-10-16
  ...
  pam = self.python-pam; # added 2020-09-07.
  PasteDeploy = self.pastedeploy; # added 2021-10-07
  pathlib = throw "pathlib was removed as it has been integrated in python standard library in version 3.4"; # added 2024-05-13
  pathpy = self.path; # added 2022-04-12
  pcbnew-transition = self.pcbnewtransition; # added 2024-03-21
  pdfposter = throw "pdfposter was promoted to a top-level attribute"; # Added 2023-06-29
  pdfminer = self.pdfminer-six; # added 2022-05-25
  pep257 = self.pydocstyle; # added 2022-04-12
  ...
  Polygon3 = self.polygon3; # Added 2023-08-08
  posix_ipc = self.posix-ipc; # added 2024-01-07
  poster3 = throw "poster3 is unmaintained and source is no longer available"; # added 2023-05-29
  postorius = throw "Please use pkgs.mailmanPackages.postorius"; # added 2022-04-29
  powerlineMemSegment = self.powerline-mem-segment; # added 2021-10-08
  prayer-times-calculator = self.prayer-times-calculator-offline; # added 2024-08-11
  ...
  prometheus_client = self.prometheus-client; # added 2021-06-10
  prompt_toolkit = self.prompt-toolkit; # added 2021-07-22
  protonup = self.protonup-ng; # Added 2022-11-06
  proxy_tools = self.proxy-tools; # added 2023-11-05
  pur = throw "pur has been renamed to pkgs.pur"; # added 2021-11-08
  pushbullet = self.pushbullet-py;  # Added 2022-10-15
  Pweave = self.pweave; # added 2023-02-19
  ...
  py_stringmatching = self.py-stringmatching; # added 2023-11-12
  ...
  pygame_sdl2 = self.pygame-sdl2; # added 2024-01-07
  ...
  PyGithub = self.pygithub; # added 2023-02-19
  ...
  PyChromecast = self.pychromecast; # added 2023-02-19
  ...
  pyflunearyou = self.pyoutbreaksnearme; # added 2023-02-11
  pyialarmxr = self.pyialarmxr-homeassistant; # added 2022-06-07
  ...
  pymc3 = self.pymc; # added 2022-06-05, module was rename starting with 4.0.0
  pymssql = throw "pymssql has been abandoned upstream."; # added 2020-05-04
  PyMVGLive = self.pymvglive; # added 2023-02-19
  pymyq = self.python-myq; # added 2023-10-20
  pynose = throw "pynose was removed, because it violates the license of nose, by redistributing modified LGPL code under MIT.";
  python-ethtool = self.ethtool; # added 2024-07-23
  ...
  pyqt5_sip = self.pyqt5-sip; # added 2024-01-07
  pyqt5_with_qtmultimedia = self.pyqt5-multimedia; # added 2024-01-07
  pyqt5_with_qtwebkit = self.pyqt5-webkit; # added 2024-01-07
  pyramid_beaker = self.pyramid-beaker; # added 2023-08-23
  pyramid_chameleon = self.pyramid-chameleon; # added 2023-08-23
  pyramid_exclog = self.pyramid-exclog; # added 2023-08-24
  pyramid_hawkauth = throw "pyramid_hawkauth has been removed because it is no longer maintained"; # added 2023-02-2
  pyramid_jinja2 = self.pyramid-jinja2; # added 2023-06-06
  pyramid_mako = self.pyramid-mako; # added 2023-08-24
  pyramid_multiauth = self.pyramid-multiauth; # added 2023-08-24
  pyreadability = self.readability-lxml; # added 2022-05-24
  ...
  pyRFC3339 = self.pyrfc3339; # added 2024-01-07
  ...
  Pyro4 = self.pyro4; # added 2023-02-19
  Pyro5 = self.pyro5; # added 2023-02-19
  PyRSS2Gen = self.pyrss2gen; # added 2023-02-19
  pyruckus = throw "pyruckus has been removed, it was deprecrated in favor of aioruckus."; # added 2023-09-07
  py_scrypt = self.py-scrypt; # added 2024-01-07
  pysha3 = throw "pysha3 has been removed, use safe-pysha3 instead"; # added 2023-05-20
  pysmart-smartx = self.pysmart; # added 2021-10-22
  pySmartDL = self.pysmartdl; # added 2023-10-11
  pysmi-lextudio = self.pysmi; # added 2024-07-18
  pysnmp-lextudio = self.pysnmp; # added 2024-07-18
  ...
  PyStemmer = self.pystemmer; # added 2023-02-19
  pytest_6 = self.pytest; # added 2022-02-10
  pytestcov = self.pytest-cov; # added 2021-01-04
  ...
  pytestquickcheck = self.pytest-quickcheck; # added 2021-07-20
  pytestrunner = self.pytest-runner; # added 2021-01-04
  python-forecastio = throw "python-forecastio has been removed, as the Dark Sky service was shut down."; # added 2023-04-05
  python-igraph = self.igraph; # added 2021-11-11
  python_openzwave = self.python-openzwave; # added 2024-01-07
  ...
  python_docs_theme = self.python-docs-theme; # added 2023-11-04
  python_fedora = self.python-fedora; # added 2023-11-15
  python_keyczar = throw "python_keyczar has been removed because it's been archived upstream and deprecated"; # added 2023-05-16
  python-lz4 = self.lz4; # added 2018-06-01
  python_magic = self.python-magic; # added 2022-05-07
  python_mimeparse = self.python-mimeparse; # added 2021-10-31
  ...
  python-Levenshtein = self.levenshtein;
  python-pushover = throw "python-pushover has been removed, since it is unmaintained and is broken"; # added 2023-07-03
  python-subunit = self.subunit; # added 2021-09-10
  pytest_xdist = self.pytest-xdist; # added 2021-01-04
  python_simple_hipchat = self.python-simple-hipchat; # added 2021-07-21
  pytoml = throw "pytoml has been removed because it is unmaintained and is superseded by toml"; # Added 2023-04-11
  pytorch = self.torch; # added 2022-09-30
  pytorch-bin = self.torch-bin; # added 2022-09-30
  pytorchWithCuda = self.torchWithCuda; # added 2022-09-30
  pytorchWithoutCuda = self.torchWithoutCuda; # added 2022-09-30
  pytwitchapi = self.twitchapi; # added 2022-03-07
  ...
  pyvicare = self.pyvicare-neo; # added 2024-08-31
  PyVirtualDisplay = self.pyvirtualdisplay; # added 2023-02-19
  ...
  qds_sdk = self.qds-sdk; # added 2023-10-21
  Quandl = self.quandl; # added 2023-02-19
  querystring_parser = self.querystring-parser; # added 2024-01-07
  ...
  radicale_infcloud = self.radicale-infcloud; # added 2024-01-07
  radio_beam = self.radio-beam; # added 2023-11-04
  ...
  readme_renderer = self.readme-renderer; # added 2024-01-07
  recaptcha_client = throw "recaptcha_client has been removed since it is no longer maintained"; # added 2023-10-20
  recursivePthLoader = self.recursive-pth-loader; # added 2024-01-07
  rednose = throw "rednose is no longer maintained (since February 2018)"; # added 2023-08-06
  repeated_test = self.repeated-test; # added 2022-11-15
  repoze_lru = self.repoze-lru; # added 2023-11-11
  repoze_sphinx_autointerface = self.repoze-sphinx-autointerface; # added 2023-11-11
  repoze_who = self.repoze-who; # added 2023-11-11
  requests_download = self.requests-download; # added 2024-01-07
  requests_ntlm = self.requests-ntlm; # added 2024-01-07
  requests_oauthlib = self.requests-oauthlib; # added 2022-02-12
  requests_toolbelt = self.requests-toolbelt; # added 2017-09-26
  restructuredtext_lint = self.restructuredtext-lint; # added 2023-11-04
  retry_decorator = self.retry-decorator; # added 2024-01-07
  retworkx = self.rustworkx; # added 2023-05-14
  ...
  ROPGadget = self.ropgadget; # added 2021-07-06
  rotate-backups = throw "rotate-backups was removed in favor of the top-level rotate-backups"; # added 2021-07-01
  ruamel_base = self.ruamel-base; # added 2021-11-01
  ruamel_yaml = self.ruamel-yaml; # added 2021-11-01
  ruamel_yaml_clib = self.ruamel-yaml-clib; # added 2021-11-01
  ...
  sapi-python-client = self.kbcstorage; # added 2022-04-20
  scikitimage = self.scikit-image; # added 2023-05-14
  scikitlearn = self.scikit-learn; # added 2021-07-21
  ...
  setuptools_dso = self.setuptools-dso; # added 2024-03-03
  setuptools_scm = self.setuptools-scm; # added 2021-06-03
  setuptoolsTrial = self.setuptools-trial; # added 2023-11-11
  sharkiqpy = self.sharkiq; # added 2022-05-21
  ...
  sip_4 = self.sip4; # added 2024-01-07
  slackclient = self.slack-sdk; # added 2024-06-27
  ssh-mitm = throw "ssh-mitm was removed in favor of the top-level ssh-mitm"; # added 2023-05-09
  smart_open = self.smart-open; # added 2021-03-14
  smmap2 = throw "smmap2 has been deprecated, use smmap instead."; # added 2020-03-14
  smpp_pdu = self.smpp-pdu; # added 2024-03-05
  ...
  sorl_thumbnail = self.sorl-thumbnail; # added 2023-11-12
  spacy_models = self.spacy-models; # added 2024-04-21
  SPARQLWrapper = self.sparqlwrapper;
  spark_parser = self.spark-parser; # added 2024-01-07
  sphinx-jquery = self.sphinxcontrib-jquery; # added 2023-02-24
  sphinx_pypi_upload = throw "sphinx_pypi_upload has been removed since it is abandoned."; # added 2023-10-11
  sphinx_rtd_theme = self.sphinx-rtd-theme; # added 2022-08-03
  sphinxcontrib-autoapi = self.sphinx-autoapi; # added 2023-02-28
  sphinxcontrib_httpdomain = self.sphinxcontrib-httpdomain; # added 2023-07-20
  sphinxcontrib_newsfeed = self.sphinxcontrib-newsfeed; # added 2023-07-20
  sphinxcontrib_plantuml = self.sphinxcontrib-plantuml; # added 2021-08-02
  ...
  sqlalchemy_migrate = self.sqlalchemy-migrate; # added 2021-10-28
  ...
  supervise_api = self.supervise-api; # added 2023-10-11
  suseapi = throw "suseapi has been removed because it is no longer maintained"; # added 2023-02-27
  synologydsm-api = self.py-synologydsm-api; # added 2024-07-29
  sysv_ipc = self.sysv-ipc; # added 2024-01-07
  ...
  tensorflow-estimator = self.tensorflow-estimator-bin; # added 2023-01-17
  tensorflow-estimator_2 = self.tensorflow-estimator; # added 2021-11-25
  tensorflow-tensorboard = self.tensorboard; # added 2022-03-06
  tensorflow-tensorboard_2 = self.tensorflow-tensorboard; # added 2021-11-25
  Theano = self.theano; # added 2023-02-19
  TheanoWithCuda = self.theanoWithCuda; # added 2023-02-19
  TheanoWithoutCuda = self.theanoWithoutCuda; # added 2023-02-19
  ...
  torrent_parser = self.torrent-parser; # added 2023-11-04
  ...
  trezor_agent = self.trezor-agent; # Added 2024-01-07
  tumpa = throw "tumpa was promoted to a top-level attribute"; # added 2022-11-19
  tvdb_api = self.tvdb-api; # added 2023-10-20
  ...
  ufoLib2 = self.ufolib2; # added 2024-01-07
  ...
  update_checker = self.update-checker; # added 2024-01-07
  ...
  websocket_client = self.websocket-client; # added 2021-06-15
  ...
  wxPython_4_2 = self.wxpython; # added 2024-01-07
  WSME = self.wsme; # added 2023-02-19
  x11_hash = self.x11-hash; # added 2023-11-05
  xapp = self.python-xapp; # added 2024-07-19
  xenomapper = throw "xenomapper was moved to pkgs.xenomapper"; # added 2021-12-31
  XlsxWriter = self.xlsxwriter; # added 2023-02-19
  xsser = "xsser has been removed because it was unmaintained and relies on a archived project"; # added 2024-07-27
  Yapsy = self.yapsy; # added 2023-02-19
  yanc  = throw "yanc has been removed because it relies on nose"; # added 2024-07-27
  z3 = self.z3-solver; # added 2023-12-03
  zake = throw "zake has been removed because it is abandoned"; # added 2023-06-20
  zc_buildout_nix = throw "zc_buildout_nix was pinned to a version no longer compatible with other modules";
  zc-buildout221 = self.zc-buildout; # added 2021-07-21
  zc_lockfile = self.zc-lockfile; # added 2024-01-06
  ...
  zope_component = self.zope-component; # added 2023-07-28
  zope_configuration = self.zope-configuration; # added 2023-11-12
  zope_contenttype = self.zope-contenttype; # added 2023-10-11
  zope_copy = self.zope-copy; # added 2024-01-06
  zope_deprecation = self.zope-deprecation; # added 2023-10-07
  zope_dottedname = self.zope-dottedname; # added 2023-11-12
  zope_event = self.zope-event; # added 2024-01-06
  zope_exceptions = self.zope-exceptions; # added 2023-10-11
  zope_filerepresentation = self.zope-filerepresentation; # added 2024-01-06
  zope_i18nmessageid = self.zope-i18nmessageid; # added 2023-07-29
  zope_interface = self.zope-interface; # added 2024-01-06
  zope_lifecycleevent = self.zope-lifecycleevent; # added 2023-10-11
  zope_location = self.zope-location; # added 2024-01-06
  zope_proxy = self.zope-proxy; # added 2023-10-07
  zope_schema = self.zope-schema; # added 2024-01-06
  zope_size = self.zope-size; # added 2024-01-06
  zope_testing = self.zope-testing; # added 2023-11-12
  zope_testrunner = self.zope-testrunner; # added 2024-01-06
  zxing_cpp = self.zxing-cpp; # added 2023-11-05
})
