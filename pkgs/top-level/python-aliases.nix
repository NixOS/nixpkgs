...
mapAliases ({
  ...
  ionhash = throw "ionhash has been removed due to being unmaintained upstream"; # added 2025-07-21
  ...
  pyqldb = throw "pyqldb has been removed, because the underlying service is reaching end of support"; # added 2025-07-21
