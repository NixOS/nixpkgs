...
mapAliases {
  ...
  beets-extrafiles = throw "beets-extrafiles is unmaintained since 2020 and broken since beets 2.0.0"; # added 2024-12-07
  ...
  cryptography_vectors = throw "'cryptography_vectors' has been renamed to/replaced by 'cryptography-vectors'"; # Added 2022-03-23
  ...
  evernote = throw "evernote is intended for use with Python 2.X"; # added 2025-04-22
  ...
  flask-autoindex = throw "flask-autoindex was removed, as it is not compatible with flask 3.0 and unmaintained since 2020."; # added 2024-01-26
  ...
  flask-basicauth = throw "flask-basicauth was removed, as it is not compatible with flask 3.0 and unmaintained since 2016."; # added 2024-01-26
  flask-sessionstore = throw "flask-sessionstore was removed, as it is not compatible with flask 3.0 and unmaintained since 2017."; # added 2024-01-26
  ...
  glances = throw "glances has moved to pkgs.glances"; # added 2020-12-28
  ...
  nose_warnings_filters = throw "nose_warning_filters has been removed as it has been unmaintained since 2016"; # added 2024-01-07
  ...
  ntlm-auth = throw "ntlm-auth has been removed, because it relies on the md4 implementation provided by openssl. Use pyspnego instead."; # added 2023-03-14
  ...
  pixelmatch = throw "pixelmatch has been removed as it was unmaintained"; # Added 2024-08-18
  ...
  premailer = throw "premailer was removed, as it is not compatible with lxml>4.9.4."; # added 2024-09-14
  ...
  pynose = throw "pynose was removed, because it violates the license of nose, by redistributing modified LGPL code under MIT."; # added 2024-08-07
  ...
  python-wifi = throw "python-wifi does not support Python3"; # added 2025-04-23
  ...
  qiskit-aqua = throw "qiskit-aqua has been removed due to deprecation, with its functionality moved to different qiskit packages"; # added 2022-02-11
  ...
  rl-coach = throw "rl-coach was removed because the project is discontinued and was archived by upstream"; # added 2023-05-03
  ...
  xsser = throw "xsser has been removed because it was unmaintained and relies on a archived project"; # added 2024-07-27
  ...
  zc_buildout_nix = throw "zc_buildout_nix was pinned to a version no longer compatible with other modules"; # added 2022-10-14
