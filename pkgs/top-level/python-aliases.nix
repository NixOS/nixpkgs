...
mapAliases ({
  ...
  nixpkgs = throw "nixpkgs has been removed, because it was relying on pythonix, which is incompatible with nix>2.3 and has been removed."; # added 2023-10-17
  ...
  pythonix = throw "pythonix has been removed, because it was archived upstream and it is incompatible with nix>2.3."; # Added 2022-12-04
