  ...
  packageOverrides = super:
    ...
    lib.mapAttrs (_: set: recurseIntoAttrs set) {
      inherit (super)
        ...
        haskellPackages idrisPackages nodePackages nodePackages_latest
        platformioPackages quicklispPackagesClisp quicklispPackagesSBCL
        rPackages roundcubePlugins sconsPackages sourceHanPackages steamPackages
        ut2004Packages zabbix40 zabbix50 zeroadPackages;
