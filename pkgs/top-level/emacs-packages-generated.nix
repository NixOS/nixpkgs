...
gnu = rec {
  ...
  csv-mode = buildEmacsPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "0zfpwq3s1wlk6hlnzcii7w277mz7nclh8565l22i1lj23cmwsy4s";
    };
  ...
  sokoban = buildEmacsPackage {
    name = "sokoban-1.0.4";
    src = fetchurl {
      url = "http://elpa.gnu.org/packages/sokoban-1.0.4.tar";
      sha256 = "0jmlx3bmml4lgr2lp7ab152qa70hk35wnq9vb994f9wncg1ylgs0";
    };

    deps = [  ];
    description = "Sokoban game for emacs";
  };
...
marmalade = rec {
  ...
  clues-theme = buildEmacsPackage {
    name = "clues-theme-20130905.211";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/clues-theme-20130905.211.el";
      sha256 = "0j2zfx5qn8wysdh15r4x0bndkhybabijj32hfhnxl9l3diw0f6jb";
    };
  ...
  coffee-mode = buildEmacsPackage {
    name = "coffee-mode-0.3.0";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/coffee-mode-0.3.0.el";
      sha256 = "00sxp30mi1dnkcgjfv1bhxzavv0dyc1lpwlvr0ag4jfp2mir87a6";
    };

    deps = [  ];
    description = "Major mode to edit CoffeeScript files in Emacs";
  };
  ...
  evil-nerd-commenter = buildEmacsPackage {
    name = "evil-nerd-commenter-1.2.1";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/evil-nerd-commenter-1.2.1.tar";
      sha256 = "181ch8nmvww781p5ahajqf4v58g8bbyh6wg7czv0d8imgq32cqpa";
    };
  ...
  ioccur = buildEmacsPackage {
    name = "ioccur-0.2";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/ioccur-0.2.el";
      sha256 = "0fr4r714yrdxkb4cgwvhy47phh6ky75inz5glvq8n4vw5wg4i9kl";
    };
  ...
  minimap = buildEmacsPackage {
    name = "minimap-1.0";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/minimap-1.0.el";
      sha256 = "1zlhny08bm2kv5qwvv5bh28mdjibz1djs5pqk8xv84jalzsig8n4";
    };
  ...
  org-trello = buildEmacsPackage {
    ...
    deps = [  dash request  json elnode esxml s ];
  ...
  smart-operator = buildEmacsPackage {
    name = "smart-operator-1.9.20110812";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/smart-operator-1.9.20110812.el";
      sha256 = "0y2aqc8ba30gfajv4247ia5f7p2bah00mpdh4mpk9azi8iwqzy1m";
    };
  ...
  undo-tree = buildEmacsPackage {
    name = "undo-tree-0.3.1";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/undo-tree-0.3.1.el";
      sha256 = "05k6f0lwaq2mkvp61scbhf8gwdyvpxs80a4k6amyqnzzkwfjf3x6";
    };
  ...
  yasnippet = buildEmacsPackage {
    name = "yasnippet-0.6.1";
    src = fetchurl {
      url = "http://marmalade-repo.org/packages/yasnippet-0.6.1.tar";
      sha256 = "1gj096b2hy27qnc073ai9j2dn77izfajcm3y4hn7gvzdllji2s1a";
    };

    deps = [  ];
    description = "Yasnippet template engine";
  };
