...
assert lib.versionAtLeast perl.version "5.30.3"; let
  ...
  _self = with self;
    {
      ...
      AppMusicChordPro = buildPerlPackage {
        ...
        propagatedBuildInputs =
          [AppPackager FileLoadLines IOString ImageInfo PDFAPI2 StringInterpolateNamed TextLayout]
      ...
      CLDRNumber = buildPerlModule {
        ...
        propagatedBuildInputs = [ClassMethodModifiers MathRound Moo namespaceclean];
        meta = {
      ...
      HTTPHeaderParserXS = buildPerlPackage {
        ...
        meta.broken =
          stdenv.isi686
          # loadable library and perl binaries are mismatched (got handshake key 0x7d40080, needed 0x7dc0080)
      ...
      PDL = buildPerlPackage rec {
        ...
        buildInputs =
          [DevelChecklib TestDeep TestException TestWarn]
