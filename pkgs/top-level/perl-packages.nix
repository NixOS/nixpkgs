...
#    buildInputs = [ TestPodLinkCheck ];
 ...
 JSONWebToken = buildPerlModule {
  ...
  Mojolicious = buildPerlPackage {
    ...
    version = "8.54";
    src = fetchurl {
      url = mirror://cpan/authors/id/S/SR/SRI/Mojolicious-8.54.tar.gz;
      sha256 = "1z8br3i2z72fb9vja5023qzvhq2gh8gmx0bh35fwqj25pgfbkj62";
    };
    meta = {
  ...
  MojoliciousPluginOpenAPI = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "642f9dc440b7060cb201edc3d3d07e5bb3c6c77ba73b23078a2cb2c1acda8c51";
    };
