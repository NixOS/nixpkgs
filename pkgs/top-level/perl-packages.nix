...
let
  ...
  */
  ...
  CPANPerlReleases = buildPerlPackage {
    ...
    version = "4.08";
    src = fetchurl {
      url = mirror://cpan/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-4.08.tar.gz;
      sha256 = "00fdq7q2i42ww8b8lsvbswkssccnbpxp2lnd8j6vbzddzr3p5qgv";
    };
    meta = {
...
#    buildInputs = [ TestPodLinkCheck ];
 ...
 JSONWebToken = buildPerlModule {
  ...
  MCE = buildPerlPackage {
     ...
     version = "1.841";
     src = fetchurl {
       url = mirror://cpan/authors/id/M/MA/MARIOROY/MCE-1.841.tar.gz;
       sha256 = "0jgh7h8y9rqjcb7az83ypww3lzajr0p8m9lbhfq7x27v6i0l2aas";
     };
     meta = {
  ...
  Mojolicious = buildPerlPackage {
    ...
    version = "8.21";
    src = fetchurl {
      url = mirror://cpan/authors/id/S/SR/SRI/Mojolicious-8.21.tar.gz;
      sha256 = "1p5ri6ib0pd58jyzzdx98j45b4bj9bs59m6srzx3n21b5gd5jf3y";
    };
    meta = {
