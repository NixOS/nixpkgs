...
let
  ...
  */
  ...
  ack = buildPerlPackage {
    ...
    src = fetchurl {
      url = mirror://cpan/authors/id/P/PE/PETDANCE/ack-v3.3.0.tar.gz;
      sha256 = "0h57fi5cardvjdj2dxncnxgww0p6y2vmrvan2wjcvmg30h6m9c5l";
    };
  ...
  AlienBuild = buildPerlPackage {
    ...
    version = "1.94";
    src = fetchurl {
      url = mirror://cpan/authors/id/P/PL/PLICEASE/Alien-Build-1.94.tar.gz;
      sha256 = "135h7s6c1in9ddl9w584yw7pg27cqajnphwmjkshpbnzj4pxn0s9";
    };
  ...
  CPANPerlReleases = buildPerlPackage {
    ...
    version = "5.20191220";
    src = fetchurl {
      url = mirror://cpan/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20191220.tar.gz;
      sha256 = "02cxafmn6ci3rfr5chin4ypcqs6064fryhl017fp0k5kg0p1i35i";
    };
    meta = {
...
#    buildInputs = [ TestPodLinkCheck ];
  ...
  ExtUtilsMakeMaker = buildPerlPackage {
    ...
    version = "7.42";
    src = fetchurl {
      url = mirror://cpan/authors/id/B/BI/BINGOS/ExtUtils-MakeMaker-7.42.tar.gz;
 ...
 JSONWebToken = buildPerlModule {
  ...
  Mojolicious = buildPerlPackage {
    ...
    version = "8.30";
    src = fetchurl {
      url = mirror://cpan/authors/id/S/SR/SRI/Mojolicious-8.30.tar.gz;
      sha256 = "1ggd1fah8pi3ibiiw78m46gf5xmgs2914pyhvbz20sskcb9gsz91";
    };
    meta = {
  ...
  MojoliciousPluginOpenAPI = buildPerlPackage {
    ...
    version = "2.20";
    src = fetchurl {
      url = mirror://cpan/authors/id/J/JH/JHTHORSEN/Mojolicious-Plugin-OpenAPI-2.20.tar.gz;
      sha256 = "53e7c02d9786ae9559f02cfde4e5f2e1433c8288f548ec7449b9cd04549be1fb";
    };
  ...
  TaskFreecellSolverTesting = buildPerlModule {
    ...
    propagatedBuildInputs = [ EnvPath FileWhich GamesSolitaireVerify InlineC MooX StringShellQuote TaskTestRunAllPlugins TemplateToolkit ];
    meta = {
  ...
  TestSimple13 = buildPerlPackage {
    ...
    version = "1.302170";
    src = fetchurl {
      url = mirror://cpan/authors/id/E/EX/EXODIST/Test-Simple-1.302170.tar.gz;
      sha256 = "50dc374f93316ed1c251433e1f91050e82a56711ff47a7b333602e017e3bfe3a";
    };
    meta = {
  ...
  XMLLibXSLT = buildPerlPackage {
    ...
    version = "1.97";
    src = fetchurl {
      url = mirror://cpan/authors/id/S/SH/SHLOMIF/XML-LibXSLT-1.97.tar.gz;
      sha256 = "0pvaizyqxrzjz0lcpqbr1imf70axx6hk66ym8ya3yd2hp7jdzy12";
    };
