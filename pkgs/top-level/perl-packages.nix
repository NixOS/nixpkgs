...
let
  ...
  CatalystRuntime = buildPerlPackage rec {
    name = "Catalyst-Runtime-5.90122";
    src = fetchurl {
      url = mirror://cpan/authors/id/H/HA/HAARG/Catalyst-Runtime-5.90122.tar.gz;
      sha256 = "88d2ab5e6a5bebf0f78cfd43fb984c04d32898940f6aeec68ab7e10f14ade7c7";
    };
  ...
  CPANPerlReleases = buildPerlPackage rec {
    name = "CPAN-Perl-Releases-3.80";
    src = fetchurl {
      url = "mirror://cpan/authors/id/B/BI/BINGOS/${name}.tar.gz";
      sha256 = "0d43cnnp4fnyw7bwm2y55axsa15y6jm7qwx1n26w59vis3jq6dna";
    };
    meta = {
  ...
  CryptX = buildPerlPackage rec {
    ...
    src = fetchurl {
      url = "mirror://cpan/authors/id/M/MI/MIK/${name}.tar.gz";
      sha256 = "026db0c97284fddcb01f2aff7197c3c2d73a0a5a004289a782c7158d41295543";
    };
    meta = {
...
#    buildInputs = [ TestPodLinkCheck ];
 ...
 JSONWebToken = buildPerlModule rec {
  ...
  libintl_perl = buildPerlPackage rec {
    name = "libintl-perl-1.30";
    src = fetchurl {
      url = mirror://cpan/authors/id/G/GU/GUIDO/libintl-perl-1.30.tar.gz;
      sha256 = "021iz53v9h367jphs3d30jy6v6d5n4674mp83djy1vijazxprp0c";
    };
    meta = {
      maintainers = with maintainers; [ ];
      platforms   = stdenv.lib.platforms.unix;
  ...
  ModuleCoreList = buildPerlPackage {
    name = "Module-CoreList-5.20181020";
    src = fetchurl {
      url = mirror://cpan/authors/id/B/BI/BINGOS/Module-CoreList-5.20181020.tar.gz;
      sha256 = "13zm3vmwx33j8zfb3p8b2n21n8n9h6lji2qrx3qa6dp0zvyw3szx";
    };
    meta = {
  ...
  RTClientREST = buildPerlModule {
    name = "RT-Client-REST-0.53";
    src = fetchurl {
      url = mirror://cpan/authors/id/D/DJ/DJZORT/RT-Client-REST-0.53.tar.gz;
      sha256 = "c6f2bcc388b3ed021f6a62e0af51897cfd2430e4ea681282558f4cd39805369d";
    };
