...
mapAliases {
  ...
  heroic = throw "Heroic Games Launcher has been removed due to frequent breakages and no maintainer. Upstream recommends using the Flatpak."; # Added  2026-01-25
