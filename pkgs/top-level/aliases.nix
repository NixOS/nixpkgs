...
mapAliases {
  ...
  fetchmtn = throw "fetchmtn has been removed as monotone was unmaintained upstream."; # Added 2026-07-25
  ...
  monotone = throw "monotone has been removed due to being unmaintained upstream"; # Added 2026-07-25
