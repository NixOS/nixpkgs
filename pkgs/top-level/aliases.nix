...
mapAliases {
  ...
  go-neb = throw "'go-neb' has been removed as it has been archived upstream, its developers consider 'matrix-hookshot' to be its spiritual successor"; # Added 2026-05-03
