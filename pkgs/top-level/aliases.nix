...
mapAliases {
  ...
  tengine = throw "tengine has been removed as it has seen seriously delayed responses to security vurnerabilites. Consider switching to nginx or another supported webserver by updating or removing your `services.nginx.package` option."; # Added 2026-08-03
