...
mapAliases ({
  ...
  gcc7 = throw "gcc7 has been removed from Nixpkgs, as it is unmaintained and obsolete"; # Added 2024-09-16
  gcc7Stdenv = throw "gcc7Stdenv has been removed from Nixpkgs, as it is unmaintained and obsolete"; # Added 2024-09-16
  ...
  gfortran7 = throw "'gfortran7' has been removed from nixpkgs"; # Added 2024-09-16
