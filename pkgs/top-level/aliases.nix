...
mapAliases ({
  ...
  nixfmt = lib.warn "nixfmt was renamed to nixfmt-classic. The nixfmt attribute will be used for the new RFC 166-style formatter in the future." nixfmt-classic; # Added 2024-03-31
