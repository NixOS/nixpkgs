...
mapAliases {
  ...
  apacheKafka_3_7 = throw "`apacheKafka_3_7` has been removed from nixpkgs as outdated"; # Added 2025-09-27
  apacheKafka_3_8 = throw "`apacheKafka_3_8` has been removed from nixpkgs as outdated"; # Added 2025-09-27
  ...
  artim-dark = warnAlias "artim-dark was renamed to aritim-dark" aritim-dark; # Added 2025-07-27
  ...
  atlassian-cli = warnAlias "`atlassian-cli` has been renamed to/replaced by `appfire-cli`" appfire-cli; # Added 2025-09-29
  ...
  banking = warnAlias "`banking` has been renamed to/replaced by `saldo`" saldo; # Added 2025-08-29
  ...
  ChowCentaur = throw "`ChowCentaur` has been renamed to `chow-centaur`"; # Converted to throw 2025-10-27
  ChowKick = throw "`ChowKick` has been renamed to by `chow-kick`"; # Converted to throw 2025-10-27
  ChowPhaser = throw "`ChowPhaser` has been renamed to by `chow-phaser`"; # Converted to throw 2025-10-27
  CHOWTapeModel = throw "`CHOWTapeModel` has been renamed to `chow-tape-model`"; # Converted to throw 2025-10-27
  ...
  cinnamon-common = warnAlias "`cinnamon-common` has been renamed to/replaced by `cinnamon`" cinnamon; # Added 2025-08-06
  ...
  duckstation-bin = warnAlias "`duckstation-bin` has been renamed to/replaced by `duckstation`" duckstation; # Added 2025-09-20
  ...
  edid-decode = warnAlias "`edid-decode` has been renamed to/replaced by `v4l-utils`" v4l-utils; # Added 2025-06-20
  ...
  FIL-plugins = throw "`FIL-plugins` has been renamed to `fil-plugins`"; # Converted to throw 2025-10-27
  ...
  flint3 = warnAlias "`flint3` has been renamed to/replaced by `flint`" flint; # Added 2025-09-21
  ...
  freecad-qt6 = warnAlias "`freecad-qt6` has been renamed to/replaced by `freecad`" freecad; # Added 2025-06-14
  freecad-wayland = warnAlias "`freecad-wayland` has been renamed to/replaced by `freecad`" freecad; # Added 2025-06-14
  ...
  gimp3 = warnAlias "`gimp3` has been renamed to/replaced by `gimp`" gimp; # Added 2025-10-03
  gimp3-with-plugins = warnAlias "`gimp3-with-plugins` has been renamed to/replaced by `gimp-with-plugins`" gimp-with-plugins; # Added 2025-10-03
  gimp3Plugins = warnAlias "`gimp3Plugins` has been renamed to/replaced by `gimpPlugins`" gimpPlugins; # Added 2025-10-03
  ...
  glaxnimate = warnAlias "`glaxnimate` has been renamed to/replaced by `kdePackages.glaxnimate`" kdePackages.glaxnimate; # Added 2025-09-17
  ...
  gpxsee-qt6 = warnAlias "`gpxsee-qt6` has been renamed to/replaced by `gpxsee`" gpxsee; # Added 2025-09-09
  ...
  gutenprintBin = warnAlias "`gutenprintBin` has been renamed to/replaced by `gutenprint-bin`" gutenprint-bin; # Added 2025-08-21
  ...
  HentaiAtHome = throw "`HentaiAtHome` has been renamed to `hentai-at-home`"; # Converted to throw 2025-10-27
  ...
  ir.lv2 = warnAlias "`ir.lv2` has been renamed to/replaced by `ir-lv2`" ir-lv2; # Added 2025-09-37
  ...
  jing = warnAlias "`jing` has been renamed to/replaced by `jing-trang`" jing-trang; # Added 2025-09-18
  joplin = warnAlias "`joplin` has been renamed to/replaced by `joplin-cli`" joplin-cli; # Added 2025-11-03
  ...
  languageMachines.frog = warnAlias "`languageMachines.frog` has been renamed to/replaced by `frog`" frog; # Added 2025-10-7
  languageMachines.frogdata = warnAlias "`languageMachines.frogdata` has been renamed to/replaced by `frogdata`" frogdata; # Added 2025-10-7
  languageMachines.libfolia = warnAlias "`languageMachines.libfolia` has been renamed to/replaced by `libfolia`" libfolia; # Added 2025-10-7
  languageMachines.mbt = warnAlias "`languageMachines.mbt` has been renamed to/replaced by `mbt`" mbt; # Added 2025-10-7
  languageMachines.test = warnAlias "`languageMachines.test` has been renamed to/replaced by `frog.tests.simple`" frog.tests.simple; # Added 2025-10-7
  languageMachines.ticcutils = warnAlias "`languageMachines.ticcutils` has been renamed to/replaced by `ticcutils`" ticcutils; # Added 2025-10-7
  languageMachines.timbl = warnAlias "`languageMachines.timbl` has been renamed to/replaced by `timbl`" timbl; # Added 2025-10-7
  languageMachines.timblserver = warnAlias "`languageMachines.timblserver` has been renamed to/replaced by `timblserver`" timblserver; # Added 2025-10-7
  languageMachines.ucto = warnAlias "`languageMachines.ucto` has been renamed to/replaced by `ucto`" ucto; # Added 2025-10-7
  languageMachines.uctodata = warnAlias "`languageMachines.uctodata` has been renamed to/replaced by `uctodata`" uctodata; # Added 2025-10-7
  ...
  libmusicbrainz5 = warnAlias "`libmusicbrainz5` has been renamed to/replaced by `libmusicbrainz`" libmusicbrainz; # Added 2025-09-16
  ...
  libreoffice-qt6 = warnAlias "`libreoffice-qt6` has been renamed to/replaced by `libreoffice-qt`" libreoffice-qt; # Added 2025-08-30
  libreoffice-qt6-fresh = warnAlias "`libreoffice-qt6-fresh` has been renamed to/replaced by `libreoffice-qt-fresh`" libreoffice-qt-fresh; # Added 2025-08-30
  libreoffice-qt6-fresh-unwrapped = warnAlias "`libreoffice-qt6-fresh-unwrapped` has been renamed to/replaced by `libreoffice-qt-fresh.unwrapped`" libreoffice-qt-fresh.unwrapped; # Added 2025-08-30
  libreoffice-qt6-still = warnAlias "`libreoffice-qt6-still` has been renamed to/replaced by `libreoffice-qt-still`" libreoffice-qt-still; # Added 2025-08-30
  libreoffice-qt6-still-unwrapped = warnAlias "`libreoffice-qt6-still-unwrapped` has been renamed to/replaced by `libreoffice-qt-still.unwrapped`" libreoffice-qt-still.unwrapped; # Added 2025-08-30
  libreoffice-qt6-unwrapped = warnAlias "`libreoffice-qt6-unwrapped` has been renamed to/replaced by `libreoffice-qt.unwrapped`" libreoffice-qt.unwrapped; # Added 2025-08-30
  ...
  linphone = warnAlias "`linphone` has been renamed to/replaced by `linphonePackages.linphone-desktop`" linphonePackages.linphone-desktop; # Added 2025-09-20
  linux-libre = throw "`linux-libre` has been removed due to lack of maintenance"; # Added 2025-10-01
  linux-rt_5_4 = throw "`linux-rt_5_4` has been removed because it will reach its end of life within 25.11"; # Added 2025-10-22
  ...
  linux_6_13 = throw "`linux_6_13` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linux_6_13_hardened = throw "`linux_6_13_hardened` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linux_6_14 = throw "`linux_6_14` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linux_6_14_hardened = throw "`linux_6_14_hardened` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linux_6_15 = throw "`linux_6_15` was removed because it has reached its end of life upstream"; # Added 2025-08-30
  linux_6_16 = throw "`linux_6_16` was removed because it has reached its end of life upstream"; # Added 2025-10-22
  ...
  linuxPackages_5_4 = throw "`linux_5_4` was removed because it will reach its end of life within 25.11"; # Added 2025-10-26
  ...
  linuxPackages_6_13 = throw "`linux_6_13` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linuxPackages_6_13_hardened = throw "`linux_6_13_hardened` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linuxPackages_6_14 = throw "linux 6.14 was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linuxPackages_6_14_hardened = throw "`linux_6_14_hardened` was removed because it has reached its end of life upstream"; # Added 2025-06-29
  linuxPackages_6_15 = throw "`linux_6_15` was removed because it has reached its end of life upstream"; # Added 2025-08-30
  linuxPackages_6_16 = throw "`linux_6_16` was removed because it has reached its end of life upstream"; # Added 2025-10-22
  ...
  linuxPackages_rt_5_4 = throw "`linux_rt_5_4` has been removed because it will reach its end of life within 25.11"; # Added 2025-10-22
  ...
  Literate = throw "`Literate` has been renamed to `literate`"; # Converted to throw 2025-10-27
  ...
  "; # Added 2025-09-05
  lxd-lts = throw "
    `lxd-lts` has been removed from NixOS due to lack of Nixpkgs maintenance.
    Consider migrating or switching to Incus, or remove from your configuration.
    https://linuxcontainers.org/incus/docs/main/howto/server_migrate_lxd/
  "; # Added 2025-09-05
  lxd-ui = throw "
    `lxd-ui` has been removed from NixOS due to lack of Nixpkgs maintenance.
    Consider migrating or switching to Incus, or remove from your configuration.
    https://linuxcontainers.org/incus/docs/main/howto/server_migrate_lxd/
  "; # Added 2025-09-05
  lxd-unwrapped = throw "
    `lxd-unwrapped` has been removed from NixOS due to lack of Nixpkgs maintenance.
    Consider migrating or switching to Incus, or remove from your configuration.
    https://linuxcontainers.org/incus/docs/main/howto/server_migrate_lxd/
  "; # Added 2025-09-05
  lxd-unwrapped-lts = throw "
    `lxd-unwrapped-lts` has been removed from NixOS due to lack of Nixpkgs maintenance.
    Consider migrating or switching to Incus, or remove from your configuration.
    https://linuxcontainers.org/incus/docs/main/howto/server_migrate_lxd/
  "; # Added 2025-09-05
  ...
  MACS2 = throw "`MACS2` has been renamed to `macs2`"; # Converted to throw 2025-10-27
  ...
  melmatcheq.lv2 = warnAlias "`melmatcheq.lv2` has been renamed to/replaced by `melmatcheq-lv2`" melmatcheq-lv2; # Added 2025-09-27
  ...
  microcodeAmd = throw "`microcodeAmd` has been renamed to `microcode-amd`"; # Converted to throw 2025-10-27
  microcodeIntel = throw "`microcodeIntel` has been renamed to `microcode-intel`"; # Converted to throw 2025-10-27
  microsoft_gsl = throw "`microsoft_gsl` has been renamed to `microsoft-gsl`"; # Converted to throw 2025-10-27
  MIDIVisualizer = throw "`MIDIVisualizer` has been renamed to `midivisualizer`"; # Converted to throw 2025-10-27
  ...
  monitor = warnAlias "`monitor` has been renamed to/replaced by `pantheon.elementary-monitor`" pantheon.elementary-monitor; # Added 2025-10-10
  mono4 = warnAlias "`mono4` has been renamed to/replaced by `mono6`" mono6; # Added 2025-08-25
  mono5 = warnAlias "`mono5` has been renamed to/replaced by `mono6`" mono6; # Added 2025-08-25
  ...
  moz-phab = throw "`moz-phab` has been renamed to `mozphab`"; # Converted to throw 2025-10-27
  ...
  nettools = warnAlias "`nettools` has been renamed to/replaced by `net-tools`" net-tools; # Added 2025-06-11
  networkmanager_strongswan = warnAlias "`networkmanager_strongswan` has been renamed to/replaced by `networkmanager-strongswan`" networkmanager-strongswan; # Added 2025-06-29
  ...
  newt-go = warnAlias "`newt-go` has been renamed to/replaced by `fosrl-newt`" fosrl-newt; # Added 2025-06-24
  nextcloud30 = throw "
  ...
  nomacs-qt6 = warnAlias "`nomacs-qt6` has been renamed to/replaced by `nomacs`" nomacs; # Added 2025-08-30
  ...
  openbabel3 = warnAlias "`openbabel3` has been renamed to/replaced by `openbabel`" openbabel; # Added 2025-09-17
  ...
  platformioPackages.platformio-chrootenv = warnAlias "`platformioPackages.platformio-chrootenv` has been renamed to/replaced by `platformio-chrootenv`" platformio-chrootenv; # Added 2025-09-04
  platformioPackages.platformio-core = warnAlias "`platformioPackages.platformio-core` has been renamed to/replaced by `platformio-core`" platformio-core; # Added 2025-09-04
  ...
  skypeexport = throw "`skypeexport` was removed since Skype has been shut down in May 2025"; # Added 2025-09-15
  sladeUnstable = warnAlias "`sladeUnstable` has been renamed to/replaced by `slade-unstable`" slade-unstable; # Added 2025-08-26
  ...
  spago = warnAlias "`spago` has been renamed to/replaced by `spago-legacy`" spago-legacy; # Added 2025-09-23, pkgs.spago should become spago@next which hasn`t been packaged yet
  ...
  tamgamp.lv2 = warnAlias "`tamgamp.lv2` has been renamed to/replaced by `tamgamp-lv2`" tamgamp-lv2; # Added 2025-09-27
  ...
  tbb = warnAlias "`tbb` has been renamed to/replaced by `onetbb`" onetbb; # Added 2025-09-14
  tbb_2020 = throw "`tbb_2020` has been removed because it is unmaintained upstream and had no remaining users; use `onetbb` instead"; # Added 2025-09-14
  tbb_2021 = throw "`tbb_2021` has been removed because it is unmaintained upstream and had no remaining users; use `onetbb` instead"; # Added 2025-09-13
  tbb_2022 = warnAlias "`tbb_2022` has been renamed to/replaced by `onetbb`" onetbb; # Added 2025-09-14
  ...
  teleport_16 = throw "`teleport_16` has been removed as it is EOL. Please upgrade to Teleport 17 or later"; # Added 2025-11-10
  ...
  tlaplusToolbox = warnAlias "`tlaplusToolbox` has been renamed to/replaced by `tlaplus-toolbox`" tlaplus-toolbox; # Added 2025-08-21
  ...
  tooling-language-server = warnAlias "`tooling-language-server` has been renamed to/replaced by `deputy`" deputy; # Added 2025-06-22
  ...
  trilium-next-desktop = warnAlias "`trilium-next-desktop` has been renamed to/replaced by `trilium-desktop`" trilium-desktop; # Added 2025-08-30
  trilium-next-server = warnAlias "`trilium-next-server` has been renamed to/replaced by `trilium-server`" trilium-server; # Added 2025-08-30
  ...
  uade123 = throw "`uade123` has been renamed to `uade`"; # Converted to throw 2025-10-27
  ...
  udisks2 = warnAlias "`udisks2` has been renamed to/replaced by `udisks`" udisks; # Added 2025-10-30
  ...
  vboot_reference = warnAlias "`vboot_reference` has been renamed to/replaced by `vboot-utils`" vboot-utils; # Added 2025-11-01
  ...
  veriT = warnAlias "`veriT` has been renamed to/replaced by `verit`" verit; # Added 2025-08-21
  ...
  wasm-bindgen-cli = warnAlias "`wasm-bindgen-cli` has been renamed to/replaced by `wasm-bindgen-cli_0_2_104`" wasm-bindgen-cli_0_2_104;
  ...
  webfontkitgenerator = warnAlias "`webfontkitgenerator` has been renamed to/replaced by `webfont-bundler`" webfont-bundler; # Added 2025-07-27
  ...
  wxGTK33 = warnAlias "`wxGTK33` has been renamed to/replaced by `wxwidgets_3_3`" wxwidgets_3_3; # Added 2025-07-20
  ...
  xinput_calibrator = warnAlias "`xinput_calibrator` has been renamed to/replaced by `xinput-calibrator`" xinput-calibrator; # Added 2025-08-28
  ...
  xo = throw "`xo` has been removed, use `dbtpl` instead"; # Added 2025-09-28
  ...
  xorg-autoconf = warnAlias "`xorg-autoconf` has been renamed to/replaced by `util-macros`" util-macros; # Added 2025-08-18
  ...
  zig_0_12 = throw "`zig_0_12` has been removed, upgrade to a newer version instead"; # Added 2025-08-18
  zigbee2mqtt_1 = throw "Zigbee2MQTT 1.x has been removed, upgrade to the unversioned attribute."; # Added 2025-08-11
  zigbee2mqtt_2 = warnAlias "`zigbee2mqtt_2` has been renamed to/replaced by `zigbee2mqtt`" zigbee2mqtt; # Added 2025-08-11
