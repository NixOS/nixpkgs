...
mapAliases ({
  ...
  nvidia-podman = throw "podman should use the Container Device Integration (CDI) instead. See https://web.archive.org/web/20240729183805/https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/latest/install-guide.html#configuring-podman"; # Added 2024-08-02
