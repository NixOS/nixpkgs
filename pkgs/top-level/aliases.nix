...
mapAliases {
  ...
  buildRustCrate = throw "'buildRustCrate' has been removed from nixpkgs and will be maintained out of tree"; # Added 2025-01-14
  ...
  defaultCrateOverrides = throw "'defaultCrateOverrides' have been removed from nixpkgs and will be maintained out of tree"; # Added 2025-01-14
