...
mapAliases {
  ...
  seafile-server = throw "'seafile-server' has been removed as non-docker packaging is no longer supported upstream"; # Added 2025-08-21
  seahub = throw "'seahub' has been removed as non-docker packaging is no longer supported upstream"; # Added 2025-08-21
