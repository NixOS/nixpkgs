...
mapAliases {
  ...
  highscore = throw "highscore has been removed at upstream's request. Consider using the Nix expressions provided by https://github.com/chuangzhu/nixpkgs-highscore"; # Added 2026-05-10
