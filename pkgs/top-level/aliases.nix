...
mapAliases {
  ...
  overseerr = throw "'overseerr' and 'jellyseerr' have merged, and the project now uses 'jellyseerr' as its base and which has been renamed to 'seerr'."; # Added 2025-10-08
