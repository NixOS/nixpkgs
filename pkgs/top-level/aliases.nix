...
mapAliases {
  ...
  digitalbitbox = lib.warnOnInstantiate "digitalbitbox has been deprecated since DigitalBitBox is EOL (End of Life) since 2019. Please use 'bitbox' instead." self.bitbox; # Added 2024-12-18
