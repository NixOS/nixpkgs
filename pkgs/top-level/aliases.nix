...
mapAliases ({
  ...
  hdf5_1_10 = throw "'hdf5_1_10' has been removed. It is no longer supported upstream nor used by any packages in nixpkgs, please use 'hdf5' instead."; # Added 2024-03-23
