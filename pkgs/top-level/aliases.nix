...
mapAliases {
  ...
  cortex-tools = throw "'cortex-tools' has been removed because the upstream repository is archived and no longer maintained. If you are using it with Grafana Mimir, use 'mimirtool' instead."; # Added 2026-09-13
