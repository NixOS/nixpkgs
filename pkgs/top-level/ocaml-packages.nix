...
let
    ...
    (lib.makeScope newScope (self: with self;
  {
    ...
    tezos-genesis = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "genesis"; };
    tezos-genesis-carthagenet = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "genesis-carthagenet"; };
    tezos-demo-counter = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "demo-counter"; };
    tezos-demo-noops = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "demo-noops"; };
    tezos-000-Ps9mPmXa = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "000-Ps9mPmXa"; };
    tezos-001-PtCJ7pwo = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "001-PtCJ7pwo"; };
    tezos-002-PsYLVpVv = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "002-PsYLVpVv"; };
    tezos-003-PsddFKi3 = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "003-PsddFKi3"; };
    tezos-004-Pt24m4xi = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "004-Pt24m4xi"; };
    tezos-005-PsBABY5H = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "005-PsBABY5H"; };
    tezos-005-PsBabyM1 = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "005-PsBabyM1"; };
    tezos-006-PsCARTHA = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "006-PsCARTHA"; };
    tezos-007-PsDELPH1 = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "007-PsDELPH1"; };
    tezos-008-PtEdo2Zk = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "008-PtEdo2Zk"; };
    tezos-009-PsFLoren = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "009-PsFLoren"; };
    tezos-010-PtGRANAD = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "010-PtGRANAD"; };
    tezos-011-PtHangz2 = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "011-PtHangz2"; };
    tezos-alpha = callPackage ../development/ocaml-modules/tezos/protocol-make.nix { protocol-name = "alpha"; };
    ...
    tezos-rpc-http-server = callPackage ../development/ocaml-modules/tezos/rpc-http-server.nix { };
    ...
    tezos-validator = callPackage ../development/ocaml-modules/tezos/validator.nix { };
