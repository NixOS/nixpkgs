...
in {
  ...
  compiler = let
    ...
    mkBootstrap = adoptopenjdk: path: args:
      ...
      if adoptopenjdk.jdk-hotspot.meta.available then
    ...
    openjdkDarwinMissing = version:
      ...
      } is currently not supported on Darwin by nixpkgs.";
  ...
  in rec {
    ...
    openjdk17-bootstrap =
      mkBootstrap adoptopenjdk-16 ../development/compilers/openjdk/16.nix
