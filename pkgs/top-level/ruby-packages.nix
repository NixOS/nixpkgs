{
  ...
  camping = {
    dependencies = ["kdl" "mab" "rack" "rack-session" "rackup"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0inda495g1g4amlgxykdzh7j1ly4jpgpp91npwbvslgcli8wjzyh";
      type = "gem";
    };
    version = "3.1.0";
  };
  ...
  git = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "08nwngj0ad1z0sjyq4ad4lc9ik2hc3yyd9aga1k7npjp2vj5zz4w";
      type = "gem";
    };
    version = "2.1.1";
  };
  ...
  jekyll-favicon = {
    dependencies = ["jekyll" "mini_magick"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
