...
with pkgs; {
  ...
  djgpp_i686 = lowPrio (callPackage ../development/compilers/djgpp {
  ...
  inherit
    (callPackages ../build-support/node/fetch-yarn-deps {})
    fixup-yarn-lock
    prefetch-yarn-deps
    yarnConfigHook
    yarnBuildHook
  ...
  fetchFirefoxAddon =
    callPackage ../build-support/fetchfirefoxaddon {}
    // {
  ...
  fetchzip =
    callPackage ../build-support/fetchzip {}
    // {
      tests = pkgs.tests.fetchzip;
    };

  fetchDebianPatch =
    callPackage ../build-support/fetchdebianpatch {}
    // {
  ...
  makeShellWrapper =
    makeSetupHook {
      ...
      substitutions = {
        ...
        shell =
          if targetPackages ? runtimeShell
          then targetPackages.runtimeShell
          else throw "makeWrapper/makeShellWrapper must be in nativeBuildInputs";
      };
      passthru = {
  ...
  inherit
    (recurseIntoAttrs (callPackage ../tools/package-management/akku {}))
    akku
    akkuPackages
    ;
  ...
  box86 = let
    args = {
      hello-x86_32 =
        ...
        then hello
        else pkgsCross.gnu32.hello;
    };
  in
    if stdenv.hostPlatform.is32bit
    then callPackage ../applications/emulators/box86 args
    else if stdenv.hostPlatform.isx86_64
    then pkgsCross.gnu32.callPackage ../applications/emulators/box86 args
    else if stdenv.hostPlatform.isAarch64
    then pkgsCross.armv7l-hf-multiplatform.callPackage ../applications/emulators/box86 args
    else throw "Don't know 32-bit platform for cross from: ${stdenv.hostPlatform.stdenv}";
  ...
  inherit
    (callPackages ../development/tools/ammonite {})
    ammonite_2_12
    ammonite_2_13
    ammonite_3_3
    ;
  ...
  freshBootstrapTools =
    ...
    then callPackage ../stdenv/linux/make-bootstrap-tools.nix {}
    else if stdenv.hostPlatform.isFreeBSD
    then callPackage ../stdenv/freebsd/make-bootstrap-tools.nix {}
  ...
  */
  ...
  inherit
    (callPackages ../misc/logging/beats/7.x.nix {})
    auditbeat7
    filebeat7
    heartbeat7
    metricbeat7
  ...
  charles = charles4;
  inherit
    (callPackages ../applications/networking/charles {})
    charles3
    charles4
    ;
  ...
  cedille =
    callPackage ../applications/science/logic/cedille
    {
  ...
  inherit
    (callPackages ../tools/misc/coreboot-utils {})
    msrtool
    cbmem
    ifdtool
    intelmetool
  ...
  mesonEmulatorHook =
    ...
    (
      ...
      then ../by-name/me/meson/emulator-hook.sh
      else throw "mesonEmulatorHook may only be added to nativeBuildInputs when the target binaries can't be executed; however you are attempting to use it in a situation where ${stdenv.hostPlatform.config} can execute ${stdenv.targetPlatform.config}. Consider only adding mesonEmulatorHook according to a conditional based canExecute in your package expression."
    );
  ...
  clementine = libsForQt5.callPackage ../applications/audio/clementine {
    gst_plugins = with gst_all_1; [gst-plugins-base gst-plugins-good gst-plugins-ugly gst-libav];
    protobuf = protobuf_21;
  };
  ...
  inherit
    (callPackage ../applications/networking/remote/citrix-workspace {})
  ...
  inherit
    (import ../development/libraries/libsbsms pkgs)
    libsbsms
    libsbsms_2_0_2
    libsbsms_2_3_0
    ;
  ...
  inherit
    (callPackages ../applications/networking/p2p/deluge {})
    deluge-gtk
    deluged
    deluge
    ;
  ...
  inherit
    (import ../build-support/dlang/dub-support.nix {inherit callPackage;})
    buildDubPackage
    dub-to-nix
    ;
  ...
  inherit
    (callPackages ../tools/filesystems/garage {})
    garage
    garage_0_8
    garage_0_9
    garage_0_8_7
  ...
  ligo = let
    ocaml_p = ocaml-ng.ocamlPackages_4_14.overrideScope (self: super: {
  ...
  inherit
    (callPackages ../build-support/node/fetch-npm-deps {})
    fetchNpmDeps
    prefetch-npm-deps
    ;
  ...
  inherit
    (callPackages ../servers/nextcloud {})
    nextcloud29
    nextcloud30
    ;
  ...
  inherit
    (callPackages ../applications/networking/cluster/nomad {})
    nomad
    nomad_1_7
    nomad_1_8
    nomad_1_9
  ...
  inherit
    (callPackages ../tools/security/pinentry {})
    pinentry-curses
    pinentry-emacs
    pinentry-gtk2
    pinentry-gnome3
  ...
  platformio =
    if stdenv.hostPlatform.isLinux
    then platformioPackages.platformio-chrootenv
    else platformioPackages.platformio-core;
  ...
  inherit
    (callPackage ../development/tools/pnpm {})
    pnpm_8
    pnpm_9
    pnpm_10
    ;
  ...
  inherit
    (callPackage ../tools/security/rekor {})
    rekor-cli
    rekor-server
    ;
  ...
  inherit
    (callPackage ../development/misc/resholve {})
    resholve
    ;
  ...
  theLoungePlugins = let
    ...
    getPackagesWithPrefix = prefix:
      lib.mapAttrs' (name: pkg: lib.nameValuePair (lib.removePrefix ("thelounge-" + prefix + "-") name) pkg)
  ...
  inherit
    (callPackage ../applications/office/trilium {})
    trilium-desktop
    trilium-server
    ;
  ...
  inherit
    ...
    ;
  inherit
    (callPackages ../servers/varnish/packages.nix {})
    varnish60Packages
    varnish75Packages
    varnish76Packages
    ;
  ...
  clangStdenv =
    ...
    then stdenv
    else lowPrio llvmPackages.stdenv;
  libcxxStdenv =
    if stdenv.hostPlatform.isDarwin
    then stdenv
    else lowPrio llvmPackages.libcxxStdenv;
  ...
  inherit
    (darwin.apple_sdk_11_0.callPackage ../development/compilers/crystal {})
    crystal_1_2
    crystal_1_7
    crystal_1_8
    crystal_1_9
  ...
  fbc =
    if stdenv.hostPlatform.isDarwin
    then callPackage ../development/compilers/fbc/mac-bin.nix {}
    else callPackage ../development/compilers/fbc {};
  ...
  inherit
    (callPackage ../development/compilers/gcc/all.nix {inherit noSysDirs;})
    gcc9
    gcc10
    gcc11
    gcc12
  ...
  haskellPackages =
    ...
    (
      ...
      else if stdenv.hostPlatform.isGhcjs
  ...
  ghc =
    targetPackages.haskellPackages.ghc
    or
    # Prefer native-bignum to avoid linking issues with gmp
    ...
    (
      ...
      # JS backend can't use GMP
      else if stdenv.targetPlatform.isGhcjs
  ...
  tamarin-prover = haskellPackages.callPackage ../applications/science/logic/tamarin-prover {
  ...
  inherit
    (callPackage ../development/tools/database/indradb {})
    indradb-server
    indradb-client
    ;
  ...
  */
  ...
  inherit
    (callPackage ../development/compilers/julia {})
    julia_19-bin
    julia_110-bin
    julia_111-bin
    julia_19
  ...
  inherit
    (callPackage ../development/compilers/mlton {})
    mlton20130715
    mlton20180207Binary
    mlton20180207
    mlton20210117
  ...
  buildRustCrate = let
    ...
    targetAlreadyIncluded =
      lib.elem stdenv.hostPlatform.rust.rustcTarget
  ...
  inherit
    (callPackages ../development/tools/rust/cargo-pgrx {})
  ...
  inherit
    (callPackage ../development/compilers/vala {})
    vala_0_56
    vala
    ;
  ...
  inherit
    (callPackage ../applications/editors/jupyter-kernels/xeus-cling {})
    cpp11-kernel
    cpp14-kernel
    cpp17-kernel
    cpp2a-kernel
  ...
  inherit
    (callPackages ../applications/networking/cluster/hadoop {})
    hadoop_3_4
    hadoop_3_3
    hadoop2
    ;
  ...
  inherit
    (callPackages ../applications/networking/cluster/spark {})
    spark_3_5
    spark_3_4
    ;
  spark3 = spark_3_5;
  ...
  inherit
    (callPackage ../development/tools/alloy {})
    alloy5
    alloy6
    alloy
    ;
  ...
  inherit
    (callPackages ../development/tools/parsing/antlr/4.nix {})
    antlr4_8
    antlr4_9
    antlr4_10
    antlr4_11
  ...
  inherit
    (callPackages ../servers/apache-kafka {})
    apacheKafka_3_6
    apacheKafka_3_7
    apacheKafka_3_8
    ;
  ...
  inherit
    (callPackages ../development/tools/electron/binary {})
    electron_24-bin
    electron_27-bin
    electron_28-bin
    electron_29-bin
  ...
  inherit
    (callPackages ../development/tools/electron/chromedriver {})
  ...
  electron_32 =
    if lib.meta.availableOn stdenv.hostPlatform electron-source.electron_32
    then electron-source.electron_32
    else electron_32-bin;
  electron_33 =
    if lib.meta.availableOn stdenv.hostPlatform electron-source.electron_33
    then electron-source.electron_33
    else electron_33-bin;
  ...
  in
    if linker == "lld"
    then llvmPackages.bintools-unwrapped
    else if linker == "cctools"
    then darwin.binutils-unwrapped
    else if linker == "bfd"
    then binutils-unwrapped
    else if linker == "gold"
    then binutils-unwrapped.override {enableGoldDefault = true;}
    else null;
  ...
  inherit
    (callPackage ../applications/misc/inochi2d {})
    inochi-creator
    inochi-session
    ;
  ...
  python-matter-server = with python3Packages;
    toPythonApplication (
  ...
  inherit
    (callPackage ../development/tools/replay-io {})
    replay-io
    replay-node-cli
    ;
  ...
  inherit
    (callPackage ../development/tools/build-managers/shards {})
    shards_0_17
    shards
    ;
  ...
  inherit
    (callPackage ../development/libraries/boost {inherit (buildPackages) boost-build;})
    boost177
    boost178
    boost179
    boost180
  ...
  inherit
    (callPackages ../development/libraries/c-blosc {})
    c-blosc
    c-blosc2
    ;
  ...
  certbot-full = certbot.withPlugins (cp:
    with cp; [
  ...
  inherit
    (callPackage ../development/libraries/ffmpeg {})
    ffmpeg_4
    ffmpeg_4-headless
    ffmpeg_4-full
    ffmpeg_6
  ...
  inherit
    (callPackages ../development/libraries/getdns {})
    getdns
    stubby
    ;
  ...
  in
    if stdenv.targetPlatform.isMinGW
    then targetPackages.windows.mingw_w64_headers or windows.mingw_w64_headers
    else if libc == "nblibc"
    then targetPackages.netbsd.headers or netbsd.headers
    else null;
  ...
  /**/
    ...
    then targetPackages.glibcCross or glibcCross
    else if name == "bionic"
    then targetPackages.bionic or bionic
    else if name == "uclibc"
    then targetPackages.uclibc or uclibc
    else if name == "avrlibc"
    then targetPackages.avrlibc or avrlibc
    else if name == "newlib" && stdenv.targetPlatform.isMsp430
    then targetPackages.msp430Newlib or msp430Newlib
    else if name == "newlib" && stdenv.targetPlatform.isVc4
    then targetPackages.vc4-newlib or vc4-newlib
    else if name == "newlib" && stdenv.targetPlatform.isOr1k
    then targetPackages.or1k-newlib or or1k-newlib
    else if name == "newlib"
    then targetPackages.newlib or newlib
    else if name == "newlib-nano"
    then targetPackages.newlib-nano or newlib-nano
    else if name == "musl"
    then targetPackages.muslCross or muslCross
    else if name == "msvcrt"
    then targetPackages.windows.mingw_w64 or windows.mingw_w64
    else if name == "ucrt"
    then targetPackages.windows.mingw_w64 or windows.mingw_w64
    ...
    then targetPackages.freebsd.libc or freebsd.libc
    else if name == "oblibc"
    then targetPackages.openbsd.libc or openbsd.libc
    else if name == "nblibc"
    then targetPackages.netbsd.libc or netbsd.libc
    else if name == "wasilibc"
    then targetPackages.wasilibc or wasilibc
    else if name == "relibc"
    then targetPackages.relibc or relibc
    else if name == "llvm"
    then targetPackages.llvmPackages_20.libc or llvmPackages_20.libc
  ...
  threadsCross = lib.optionalAttrs (stdenv.targetPlatform.isMinGW && !(stdenv.targetPlatform.useLLVM or false)) {
  ...
  irrlicht =
    if !stdenv.hostPlatform.isDarwin
    then callPackage ../development/libraries/irrlicht {}
    else
  ...
  libcanberra_kde =
    if (config.kde_runtime.libcanberraWithoutGTK or true)
  ...
  iconv =
    if lib.elem stdenv.hostPlatform.libc ["glibc" "musl"]
    then lib.getBin stdenv.cc.libc
    else if stdenv.hostPlatform.isDarwin
    then lib.getBin libiconv
    else if stdenv.hostPlatform.isFreeBSD
    then lib.getBin freebsd.iconv
    else lib.getBin libiconvReal;
  ...
  libunwind =
    ...
    else if stdenv.hostPlatform.system == "riscv32-linux"
    then llvmPackages.libunwind
  ...
  libglut =
    if stdenv.hostPlatform.isDarwin
    then darwin.apple_sdk.frameworks.GLUT
    else freeglut;
  ...
  inherit
    (callPackages ../development/libraries/ogre {})
    ogre_13
    ogre_14
    ;
  ...
  inherit
    (callPackages ../development/libraries/libressl {})
    libressl_3_6
    libressl_3_7
    libressl_3_8
    libressl_3_9
  ...
  libsForQt5 =
    (recurseIntoAttrs (import ./qt5-packages.nix {
  ...
  wt = wt4;
  inherit
    (libsForQt5.callPackage ../development/libraries/wt {})
    wt4
    ;

  inherit
    (callPackages ../development/libraries/xapian {})
    xapian_1_4
    ;
  xapian = xapian_1_4;
  ...
  apacheHttpdPackagesFor = apacheHttpd: self: let
  ...
  directx-shader-compiler = callPackage ../tools/graphics/directx-shader-compiler {
    ...
    stdenv =
      if stdenv.cc.isGNU && stdenv.hostPlatform.isi686
      then gcc11Stdenv
      else stdenv;
  };
  ...
  inherit
    (callPackage ../applications/networking/mullvad {})
    mullvad
    ;
  ...
  inherit
    (import ../servers/sql/mariadb pkgs)
    mariadb_105
    mariadb_106
    mariadb_1011
    mariadb_114
  ...
  inherit
    (callPackages ../servers/monitoring/sensu-go {})
    sensu-go-agent
    sensu-go-backend
    sensu-go-cli
    ;
  ...
  inherit
    (callPackages ../servers/http/tomcat {})
    tomcat9
    tomcat10
    tomcat11
    ;
  ...
  inherit
    (callPackages ../os-specific/linux/apparmor {})
    libapparmor
    apparmor-utils
    apparmor-bin-utils
    apparmor-parser
  ...
  busybox = callPackage ../os-specific/linux/busybox {
    ...
    stdenv =
      ...
      then overrideCC stdenv buildPackages.llvmPackages.clangNoLibcxx
      else stdenv;
  };
  ...
  inherit
    (callPackages ../os-specific/linux/kernel-headers {inherit (pkgsBuildBuild) elf-header;})
    linuxHeaders
    makeLinuxHeaders
    ;
  ...
  qemu_test = lowPrio (qemu.override {
    hostCpuOnly = true;
  ...
  udev =
    if lib.meta.availableOn stdenv.hostPlatform systemdLibs
    then systemdLibs
    else libudev-zero;
  ...
  inherit
    (callPackages ../data/sgml+xml/stylesheets/xslt/docbook-xsl {})
    docbook-xsl-nons
    docbook-xsl-ns
    ;
  ...
  inherit
    (callPackages ../data/fonts/liberation-fonts {})
    liberation_ttf_v1
    liberation_ttf_v2
    ;
  ...
  inherit
    (callPackages ../data/fonts/gdouros {})
    aegan
    aegyptus
    akkadian
    assyrian
  ...
  inherit
    (callPackages ../data/fonts/pretendard {})
    pretendard
    pretendard-gov
    pretendard-jp
    pretendard-std
  ...
  inherit
    (qt6Packages.callPackage ../applications/office/activitywatch {})
    aw-qt
    aw-notify
    aw-server-rust
    aw-watcher-afk
  ...
  inherit
    (callPackage ../applications/networking/cluster/calico {})
    calico-apiserver
    calico-app-policy
    calico-cni-plugin
  ...
  darcs =
    haskell.lib.compose.disableCabalFlag "library"
  ...
  inherit
    (callPackage ../applications/virtualization/docker {})
    docker_25
    docker_26
    docker_27
    ;
  ...
  inherit
    (recurseIntoAttrs (callPackage ../applications/editors/emacs {}))
    emacs28
    emacs28-gtk3
    emacs28-nox
    emacs29
  ...
  inherit
    (callPackage ../applications/virtualization/singularity/packages.nix {})
    apptainer
    singularity
  ...
  inherit
    (callPackages ../development/libraries/wlroots {})
    wlroots_0_17
    wlroots_0_18
    ;
  ...
  i3 = callPackage ../applications/window-managers/i3 {
    xcb-util-cursor =
      if stdenv.hostPlatform.isDarwin
      then xcb-util-cursor-HEAD
      else xcb-util-cursor;
  };
  ...
  inherit
    (callPackage ../applications/networking/cluster/k3s {})
    k3s_1_29
    k3s_1_30
    k3s_1_31
    k3s_1_32
  ...
  playonlinux =
    callPackage ../applications/misc/playonlinux
    {stdenv = stdenv_32bit;};
  ...
  ripcord =
    if stdenv.hostPlatform.isLinux
    then qt5.callPackage ../applications/networking/instant-messengers/ripcord {}
    else callPackage ../applications/networking/instant-messengers/ripcord/darwin.nix {};
  ...
  inherit
    (callPackages ../applications/radio/rtl-sdr {})
    rtl-sdr-librtlsdr
    rtl-sdr-osmocom
    rtl-sdr-blog
    ;
  ...
  prusa-slicer = darwin.apple_sdk_11_0.callPackage ../applications/misc/prusa-slicer {
    ...
    stdenv =
      if stdenv.hostPlatform.isDarwin
      then overrideSDK llvmPackages.stdenv "11.0"
      else llvmPackages.stdenv;
  };
  ...
  stumpwm = callPackage ../applications/window-managers/stumpwm {
    stdenv = stdenvNoCC;
    sbcl = sbcl_2_4_10.withPackages (ps:
      with ps; [
        alexandria
        cl-ppcre
        clx
  ...
  inherit
    (recurseIntoAttrs (callPackage ../applications/editors/sublime/4/packages.nix {}))
    sublime4
    sublime4-dev
    ;

  inherit
    (callPackage ../applications/version-management/sublime-merge {})
    sublime-merge
    sublime-merge-dev
    ;
  ...
  in
    macvimUtils.makeCustomizable (callPackage ../applications/editors/vim/macvim.nix {
      stdenv = clangStdenv;
    });
  ...
  neovim-unwrapped = callPackage ../by-name/ne/neovim-unwrapped/package.nix {
    lua =
      if lib.meta.availableOn stdenv.hostPlatform luajit
      then luajit
      else lua5_1;
  };
  ...
  inherit
    (callPackages ../applications/blockchains/teos {})
    teos
  ...
  inherit
    (callPackages ../games/dxx-rebirth/assets.nix {})
    descent1-assets
    descent2-assets
    ;

  inherit
    (callPackages ../games/dxx-rebirth/full.nix {})
    d1x-rebirth-full
    d2x-rebirth-full
    ;
  ...
  inherit
    (callPackage ../games/scummvm/games.nix {})
    beneath-a-steel-sky
    broken-sword-25
  ...
  inherit
    (callPackage ../desktops/gnome/extensions {})
    gnomeExtensions
    gnome38Extensions
    gnome40Extensions
    gnome41Extensions
  ...
  inherit
    (callPackages ../applications/science/biology/sumatools {})
    sumalibs
    sumaclust
    sumatra
    ;
  ...
  leo2 =
    callPackage ../applications/science/logic/leo2
  ...
  inherit
    (callPackages ../applications/science/logic/z3 {python = python3;})
    z3_4_13
    z3_4_12
    z3_4_11
    z3_4_8
  ...
  inherit
    (callPackage ../applications/networking/cluster/kops {})
    mkKops
    kops_1_27
    kops_1_28
    kops_1_29
  ...
  inherit
    (callPackages ../applications/networking/cluster/nixops {})
  ...
  */
  ...
  inherit
    (callPackages ../tools/package-management/nix-prefetch-scripts {})
    nix-prefetch-bzr
    nix-prefetch-cvs
    nix-prefetch-git
    nix-prefetch-hg
  ...
  dysnomia = callPackage ../tools/package-management/disnix/dysnomia (config.disnix
    or {
  ...
  mysql-workbench = callPackage ../by-name/my/mysql-workbench/package.nix (let
    mysql = mysql80;
  in {
    gdal = gdal.override {
  ...
  inherit
    (callPackage ../applications/networking/cluster/terraform {})
    mkTerraform
    terraform_1
  ...
  inherit
    (callPackage ../servers/web-apps/wordpress {})
    wordpress
    wordpress_6_7
    ;
