...

{
  ...
  electron_32 =
    if lib.meta.availableOn stdenv.hostPlatform electron-source.electron_32 then
      electron-source.electron_32
    else
      electron_32-bin;
  electron_33 =
  ...
  */
  ...
  satyrographosInstallHook =
    callPackage ../development/satysfi-packages/satyrographosInstallHook/default.nix
      { };
  mergeSatysfiHash = callPackage ../development/satysfi-packages/mergeSatysfiHash/default.nix { };
