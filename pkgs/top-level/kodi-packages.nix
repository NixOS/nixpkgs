...
in let
  self = rec {
    ...
    addonUpdateScript =
      callPackage ../applications/video/kodi-packages/addon-update-script { };
    ...
    kodi-platform =
      callPackage ../applications/video/kodi-packages/kodi-platform { };

    # addon packages

    a4ksubtitles =
      callPackage ../applications/video/kodi-packages/a4ksubtitles { };
    ...
    controllers = {
      ...
      dreamcast = callPackage ../applications/video/kodi-packages/controllers {
        controller = "dreamcast";
      };

      gba = callPackage ../applications/video/kodi-packages/controllers {
        controller = "gba";
      };

      genesis = callPackage ../applications/video/kodi-packages/controllers {
        controller = "genesis";
      };

      mouse = callPackage ../applications/video/kodi-packages/controllers {
        controller = "mouse";
      };

      n64 = callPackage ../applications/video/kodi-packages/controllers {
        controller = "n64";
      };

      nes = callPackage ../applications/video/kodi-packages/controllers {
        controller = "nes";
      };

      ps = callPackage ../applications/video/kodi-packages/controllers {
        controller = "ps";
      };

      snes = callPackage ../applications/video/kodi-packages/controllers {
        controller = "snes";
      };
    };
    ...
    libretro-genplus =
      callPackage ../applications/video/kodi-packages/libretro-genplus {
        inherit genesis-plus-gx;
      };

    libretro-mgba =
      callPackage ../applications/video/kodi-packages/libretro-mgba {
        inherit mgba;
      };

    libretro-snes9x =
      callPackage ../applications/video/kodi-packages/libretro-snes9x {
        inherit snes9x;
      };
    ...
    steam-controller =
      callPackage ../applications/video/kodi-packages/steam-controller { };

    steam-launcher =
      callPackage ../applications/video/kodi-packages/steam-launcher { };

    steam-library =
      callPackage ../applications/video/kodi-packages/steam-library { };
    ...
    pvr-hdhomerun =
      callPackage ../applications/video/kodi-packages/pvr-hdhomerun { };
    ...
    vfs-libarchive =
      callPackage ../applications/video/kodi-packages/vfs-libarchive { };
    ...
    archive_tool =
      callPackage ../applications/video/kodi-packages/archive_tool { };
    ...
    inputstream-adaptive =
      callPackage ../applications/video/kodi-packages/inputstream-adaptive { };

    inputstream-ffmpegdirect =
      callPackage ../applications/video/kodi-packages/inputstream-ffmpegdirect
      { };

    inputstream-rtmp =
      callPackage ../applications/video/kodi-packages/inputstream-rtmp { };

    inputstreamhelper =
      callPackage ../applications/video/kodi-packages/inputstreamhelper { };
    ...
    requests-cache =
      callPackage ../applications/video/kodi-packages/requests-cache { };
