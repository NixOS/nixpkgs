...
#  };
  ...
  # borked, unused. Supports python3? https://github.com/appleseedhq/appleseed/pull/2021
  #appleseed = toPythonModule (pkgs.appleseed.override { inherit (self) python; });

  # https://github.com/AGProjects/python3-application updated version
  ...
  # 2 derivations, supports python3
