  ...
  compiler = {
    ...
    ghc884 = callPackage ../development/compilers/ghc/8.8.4.nix {
      bootPkgs =
        ...
        if stdenv.isAarch64 || stdenv.hostPlatform.isMusl
        then packages.ghc8102BinaryMinimal
        else packages.ghc865Binary;
    ...
    ghc8107 = callPackage ../development/compilers/ghc/8.10.7.nix {
      bootPkgs =
        ...
        then packages.ghc8107BinaryMinimal
        else packages.ghc8107Binary;
      inherit (buildPackages.python3Packages) sphinx;
