...
, curl, cyrus_sasl, enchant1, fetchpatch, freetds, freetype, gd, gettext, gmp
, html-tidy, icu64, libXpm, libedit, libffi, libiconv, libjpeg, libpng
, libsodium, libwebp, libxml2, libxslt, libzip, net-snmp, oniguruma, openldap
, openssl, pam, pcre2, postgresql, re2c, readline, rsync, sqlite, unixODBC
, uwimap, valgrind, zlib }:
...
lib.makeScope pkgs.newScope (self:
  with self; {
    ...
    mkExtension = { name, configureFlags ? [ "--enable-${name}" ]
      , internalDeps ? [ ], postPhpize ? "", buildInputs ? [ ]
      , zendExtension ? false, doCheck ? true, ... }@args:
      stdenv.mkDerivation ((builtins.removeAttrs args [ "name" ]) // {
        ...
        '';
        checkPhase =
          "runHook preCheck; NO_INTERACTON=yes make test; runHook postCheck";
        outputs = [ "out" "dev" ];
        installPhase = ''
      ...
      extensionData = [
        ...
        }
        {
          ...
          patches = lib.optionals (lib.versionOlder php.version "7.4") [
            (fetchpatch {
              url =
                "https://github.com/php/php-src/commit/632b6e7aac207194adc3d0b41615bfb610757f41.patch";
        ...
        }
        {
          ...
          patches = lib.optionals (lib.versionOlder php.version "8.0") [
            ...
            (fetchpatch {
              url =
                "https://github.com/fossar/nix-phps/raw/263861a8c9bdafd7abe44db6db4ef0179643680c/pkgs/iconv-header-path.patch";
        ...
        }
        {
          ...
          patches = lib.optionals (lib.versionOlder php.version "7.4") [
            (fetchpatch {
              url =
                "https://github.com/php/php-src/commit/93a9b56c90c334896e977721bfb3f38b1721cec6.patch";
        ...
        }
        {
          ...
          buildInputs = [ oniguruma ]
            ++ lib.optionals (lib.versionAtLeast php.version "8.0") [ pcre2 ];
          doCheck = false;
        }
        {
          name = "mysqli";
        ...
        {
          name = "opcache";
          buildInputs = [ pcre2 ] ++ lib.optionals
            (!stdenv.isDarwin && lib.versionAtLeast php.version "8.0")
            [ valgrind.dev ];
          patches = lib.optionals (lib.versionOlder php.version "7.4") [
        ...
        {
          name = "session";
          doCheck = !(lib.versionAtLeast php.version "8.0");
        }
        { name = "shmop"; }
        {
          name = "simplexml";
        ...
        { name = "tokenizer"; }
        {
          ...
          configureFlags =
            [ "--enable-wddx" "--with-libxml-dir=${libxml2.dev}" ];
          # Removed in php 7.4.
          enable = lib.versionOlder php.version "7.4";
        }
        {
