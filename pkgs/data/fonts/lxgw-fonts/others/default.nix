...
let
  ...
  fonts = {
    ...
    bright-code-nf = {
      fontName = "LxgwBrightCodeNF";
      repoName = "LxgwBright-Code";
      suffix = "7z";
      meta.description = "LXGW WenKai font merged with Monaspace Argon font (Nerd Font Edition)";
    };
    bright-code-nf-gb = {
      fontName = "LxgwBrightCodeNFGB";
      repoName = "LxgwBright-Code";
      suffix = "7z";
      meta.description = "LXGW WenKai font merged with Monaspace Argon font (Nerd Font Edition, GB Edition)";
    };
    bright-code-nf-tc = {
      fontName = "LxgwBrightCodeNFTC";
      repoName = "LxgwBright-Code";
      suffix = "7z";
      meta.description = "LXGW WenKai font merged with Monaspace Argon font (Nerd Font Edition, TC Edition)";
    };
    fusionkai = {
      fontName = "FusionKai";
      repoName = "FusionKai";
