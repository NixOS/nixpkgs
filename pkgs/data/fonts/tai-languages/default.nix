...

{
  tai-ahom = fetchzip {
    ...
    url =
      "https://github.com/enabling-languages/tai-languages/blob/b57a3ea4589af69bb8e87c6c4bb7cd367b52f0b7/ahom/.fonts/ttf/.original/AhomUnicode_FromMartin.ttf?raw=true";

    postFetch =
      "install -Dm644 $downloadedFile $out/share/fonts/truetype/AhomUnicode.ttf";
