...
lib.makeOverridable (
  /**
    Create a wrapped fish shell binary with some plugins, completions,
    configuration snippets and functions sourced from the given paths.
    This provides a convenient way to test fish plugins and scripts
    without having to alter the environment.
  ...
  */
  ...
  writeShellApplication {
    ...
    name = "fish";
    # TODO: escapeShellArgs doesn't fully work here,
    # e.g. `escapeShellArg ''"''` => `'"'`
    # unescaped double quotes in double-quoted-Strings will terminate the string
    # and potentially leave dangling double quotes
    text = ''
