{ lib, stdenv, buildPackages, fetchurl, binutils ? null, bison, autoconf
, util-linux

# patch for cygwin requires readline support
, interactive ? stdenv.isCygwin, readline70 ? null, withDocs ? false
, texinfo ? null }:
...
in stdenv.mkDerivation rec {
  ...
  patches = upstreamPatches ++ [ ./pgrp-pipe-4.4.patch ]
