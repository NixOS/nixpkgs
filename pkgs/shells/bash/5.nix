    ...
    passthru = {
      ...
      tests.withChecks = fa.finalPackage.overrideAttrs (attrs: {
        ...
        patches = attrs.patches or [ ] ++ [
          ...
          # This patch makes the tests fail if there's a diff,
          # which works well enough for a bunch of them,
          # while the rest are manually disabled for now
          ./fail-tests.patch
        ...
        preCheck = attrs.preCheck or "" + ''
          ...
          export BASH_TST_ACTUAL=$(mktemp -d)
