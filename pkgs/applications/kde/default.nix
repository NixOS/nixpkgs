...
let
  ...
  packages = self: with self;
    ...
    in {
      ...
      grantlee-editor = callPackage ./grantlee-editor.nix {};
      ...
      klickety = callPackage ./klickety.nix {};
