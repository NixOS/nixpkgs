...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-lzQDaF+fxyiwZxfpGkZL9MtMIxfv8p9Zebpk6FD977M=";
  ...
  manifest = fetchurl {
    ...
    hash = "sha256-qgJRyIbr+u55ad9BBSFQMP7y88va1KMyQBlP8JMiD7Q=";
  };
  ...
  manifestSignature = fetchurl {
    ...
    hash = "sha256-MPgaTr5jNAIIMyfqeK+xsIWJezw93yQbONQsrffg1ks=";
  };
