{ lib, stdenv, fetchFromGitHub, openssl, boost, libb2, libevent, autoreconfHook
, db4, pkg-config, protobuf, hexdump, zeromq, libsodium, withGui, qtbase ? null
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl boost libevent db4 zeromq libsodium libb2 ]
