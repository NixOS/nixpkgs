...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1rc3/bitcoin-${finalAttrs.version}.tar.gz";
  ...
  preUnpack =
    let
      ...
      checksums = fetchurl {
        url = "https://raw.githubusercontent.com/dathonohm/guix.sigs/refs/heads/bip110/29.2.knots20251110%2Bbip110-v0.1rc3/leo-haf/all.SHA256SUMS";
        hash = "sha256-IquyIXfctM4N8CZA7gSnJ6FgzxIfnFR2lZco9QlrkQs=";
      };

      signatures = fetchurl {
        url = "https://raw.githubusercontent.com/dathonohm/guix.sigs/refs/heads/bip110/29.2.knots20251110%2Bbip110-v0.1rc3/leo-haf/all.SHA256SUMS.asc";
        hash = "sha256-KHgJhYO/MCaavW/lXoBWX01qlgvX7EekFu+M1uDyOI4=";
      };
