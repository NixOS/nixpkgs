...
stdenv.mkDerivation (finalAttrs: {
  ...
  version = "29.2.knots20251110+bip110-v0.1rc2";

  src = fetchurl {
    url = "https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1rc2/bitcoin-${finalAttrs.version}.tar.gz";
    # hash retrieved from signed SHA256SUMS
    hash = "sha256-XT02e1yasZFmkvTup1AD9tHnenliToRsLIQFSGzTlno=";
  };
  ...
  preUnpack =
    let
      ...
      checksums = fetchurl {
        url = "https://raw.githubusercontent.com/dathonohm/guix.sigs/refs/heads/bip110/29.2.knots20251110%2Bbip110-v0.1rc2/leo-haf/all.SHA256SUMS";
        hash = "sha256-LP1p51hFbz8bQCupLijVqJOMs1nHLys4wcBASEowzQQ=";
      };

      signatures = fetchurl {
        url = "https://raw.githubusercontent.com/dathonohm/guix.sigs/refs/heads/bip110/29.2.knots20251110%2Bbip110-v0.1rc2/leo-haf/all.SHA256SUMS.asc";
        hash = "sha256-4pALIfDlv6E3TFk69CpxAXtSqF1sLyN9lxhvf/I3Qzc=";
      };
