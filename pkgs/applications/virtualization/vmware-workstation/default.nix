...
let
  ...
  in lib.mapAttrsToList fetchComponent {
      windows = "sha256-hEv/Cffh2D+9K/+85OKFzxiEIkIImAFk+bIowsvMVD4=";
      windows-x86 = "sha256-swUfqWRdgq2F8lHvk070cngGBA8KY2AT1MmJ4iDbDJw=";
  };
...
stdenv.mkDerivation rec {
  ...
  src = fetchzip {
    ...
    sha256 = "sha256-WgjJ8AuTzuEBGBDEl+vsI6nP7cSMRx4ifNVubmvG/yc=";
    stripRoot = false;
