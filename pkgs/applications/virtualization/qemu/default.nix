...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ makeWrapper removeReferencesTo pkg-config flex bison meson ninja perl python3 buildPackages.python3.pkgs.sphinx buildPackages.python3.pkgs.sphinx-rtd-theme ]
