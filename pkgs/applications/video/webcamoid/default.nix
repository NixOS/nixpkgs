{ lib, fetchFromGitHub, pkg-config, libxcb, mkDerivation, qmake, qtbase
, qtdeclarative, qtquickcontrols, qtquickcontrols2, ffmpeg-full, gst_all_1
...
mkDerivation rec {
  ...
  qmakeFlags =
    [ "Webcamoid.pro" "INSTALLQMLDIR=${placeholder "out"}/lib/qt/qml" ];
