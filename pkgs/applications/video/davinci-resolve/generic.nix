    ...
    stdenv.mkDerivation {
      ...
      src = runCommandLocal "${pname}-src.zip"
        rec {
          ...
          SITEURL = "https://www.blackmagicdesign.com/api/register/us/download/${args.downloadid}";
        ...
        RESOLVEURL=$(curl \
          ...
          -H "Referer: https://www.blackmagicdesign.com/support/download/$args.referid/Linux" \
...
buildFHSUserEnv {
  ...
  runScript = "${bash}/bin/bash ${
    ...
    export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:${self}/libs
    ${self}/bin/resolve
    ''
  }";
