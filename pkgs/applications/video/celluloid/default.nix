{ lib, stdenv, fetchFromGitHub, appstream-glib, desktop-file-utils, libepoxy
, gettext, glib, gtk3, meson, mpv, ninja, nix-update-script, pkg-config, python3
, wrapGAppsHook }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libepoxy glib gtk3 mpv ];
