...
, libX11 ? null, libXext ? null, libGLU, libGL ? null, xineramaSupport ? true
, libXinerama ? null, xvSupport ? true, libXv ? null
, alsaSupport ? stdenv.isLinux, alsa-lib ? null, screenSaverSupport ? true
...
, bs2bSupport ? false, libbs2b ? null, v4lSupport ? false, libv4l ? null
  # For screenshots
...
assert x11Support
  -> (libX11 != null && libXext != null && libGLU != null && libGL != null);
