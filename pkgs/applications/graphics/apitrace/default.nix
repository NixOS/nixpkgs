{ lib, stdenv, fetchFromGitHub, cmake, libX11, procps, python3, libdwarf, qtbase, qtwebkit, wrapQtAppsHook, libglvnd }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    sha256 = "sha256-rvC6iVWNNxH11hzQvRTo+SQi9jEUCPWGSdJmKJe9SQ0=";
    rev = version;
    repo = "apitrace";
    owner = "apitrace";
  ...
  buildInputs = [ libX11 procps python3 libdwarf qtbase qtwebkit ];
