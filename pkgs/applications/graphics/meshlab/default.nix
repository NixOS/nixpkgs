...
let
  ...
  stdenv' = if stdenv.hostPlatform.isDarwin then llvmPackages.stdenv else stdenv;
...
stdenv'.mkDerivation (finalAttrs: {
  ...
  buildInputs =
    ...
    ++ lib.optional (!stdenv'.cc.isClang) levmar # FIXME: clang throw error implicit-function-declaration
    ++ lib.optional stdenv'.cc.isClang llvmPackages.openmp;

  nativeBuildInputs = [ cmake ] ++ lib.optional stdenv'.hostPlatform.isDarwin wrapQtAppsHook;
