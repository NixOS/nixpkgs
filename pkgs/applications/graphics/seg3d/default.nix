{ fetchurl, stdenv, cmake, wxGTK_2, itk, libGLU_combined, libXft, libXext, libXi, zlib, libXmu,
libuuid }:
...
stdenv.mkDerivation {
  ...
  buildInputs = [ cmake wxGTK_2 itk libGLU_combined libXft libXext libXi zlib libXmu libuuid ];
