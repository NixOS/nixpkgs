{ lib, stdenv, fetchFromGitHub, nix-update-script, substituteAll, plymouth, pam
, pkg-config, autoconf, automake, libtool, libxcb, glib, libXdmcp, itstool
, intltool, libxklavier, libgcrypt, audit, busybox, polkit, accountsservice
, gtk-doc, gnome, gobject-introspection, vala, fetchpatch, withQt4 ? false, qt4
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/canonical/lightdm/commit/a99376f5f51aa147aaf81287d7ce70db76022c47.patch";
    ...
    (fetchpatch {
      url =
        "https://github.com/canonical/lightdm/commit/03f218981733e50d810767f9d04e42ee156f7feb.patch";
