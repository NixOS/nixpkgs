{ lib, stdenv, fetchurl, dpkg, wrapGAppsHook, autoPatchelfHook, alsa-lib, atk
...
, libXi, libXrandr, libXrender, libXScrnSaver, libXtst, mesa, nspr, nss, pango
, systemd }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://upwork-usw2-desktopapp.upwork.com/binaries/v5_6_9_3_10c2eb9781db4d7f/${pname}_${version}_amd64.deb";
