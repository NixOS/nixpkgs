{ lib, stdenv, fetchurl, autoreconfHook, pkg-config, libzen, libmediainfo
, wxGTK30-gtk3, desktop-file-utils, libSM, imagemagick }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ libzen libmediainfo wxGTK30-gtk3 desktop-file-utils libSM imagemagick ];
