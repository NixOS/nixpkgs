...
(javaPackages.mavenfod.override {
  ...
  pname = "dbeaver";
  version = "22.3.3"; # When updating also update mvnSha256

  src = fetchFromGitHub {
    owner = "dbeaver";
    repo = "dbeaver";
    rev = version;
    sha256 = "sha256-9lGET8n6GVsYYoJ6dmLFi14smpSUWDDOWJK85F44yn8=";
  };

  mvnSha256 = "vS7lPTDfMiA0m0nR8B2x8t5Qag031jxxjfOeEXJ/SaE=";
