...
mavenJdk17.buildMavenPackage rec {
  pname = "dbeaver";
  version = "23.1.4"; # When updating also update mvnHash

  src = fetchFromGitHub {
    owner = "dbeaver";
    repo = "dbeaver";
    rev = version;
    hash = "sha256-LyZgztp/ahFDZoXzmGRHe0IhISj92+xt+qvSRF571mQ=";
  };

  mvnHash = "sha256-GnpQYmyasYqB4IKHZ6R9UHbQlMMtIHbGcP3y9GoI8LE=";
