{ lib, stdenv, fetchFromGitHub, fetchpatch, readline, ncurses, autoreconfHook
, pkg-config, gettext }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/dvorka/hstr/commit/7fbd852c464ae3cfcd2f4fed9c62a21fb84c5439.patch";
