...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches =
    lib.singleton ./fix-paths.patch
    ++ lib.optional (!textToSpeechSupport) ./disable-tts.patch;
  ...
  buildInputs = [
    ...
    qtx11extras
    qtxmlpatterns
  ] ++ lib.optional textToSpeechSupport qtspeech;

  # RPATH of binary /nix/store/.../bin/... contains a forbidden reference to /build/
  cmakeFlags = lib.singleton (lib.cmakeBool "CMAKE_SKIP_BUILD_RPATH" true);
