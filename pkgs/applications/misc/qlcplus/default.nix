...
, qtmultimedia, qtscript, qt5, alsa-lib, ola, libftdi1, libusb-compat-0_1
, libsndfile, libmad
}:
...
mkDerivation rec {
  ...
  buildInputs = [
    udev qtmultimedia qtscript qt5.qtserialport alsa-lib ola libftdi1 libusb-compat-0_1 libsndfile libmad
  ];
