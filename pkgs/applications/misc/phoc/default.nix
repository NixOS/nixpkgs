...
, wrapGAppsHook, libinput, gnome, glib, gtk3, wayland, libdrm, libxkbcommon
, wlroots }:
  ...
  phocWlroots = wlroots.overrideAttrs (old: {
    patches = (old.patches or [ ]) ++ [
      ...
      (fetchpatch {
        ...
        url =
          "https://gitlab.alpinelinux.org/alpine/aports/-/raw/78fde4aaf1a74eb13a3f083cb6dfb29f578c3265/community/wlroots/0001-Revert-layer-shell-error-on-0-dimension-without-anch.patch";
      ...
      (fetchpatch {
        ...
        url =
          "https://github.com/swaywm/wlroots/commit/e18599b05e0f0cbeba11adbd489e801285470eab.patch";
      ...
      (fetchpatch {
        ...
        url =
          "https://github.com/swaywm/wlroots/commit/66593071bc90a1cccaeedc636eb6f33c973f5362.patch";
      ...
      (fetchpatch {
        ...
        url =
          "https://github.com/swaywm/wlroots/commit/235bb6f2fcb8ee4174215ba74b5bc2f191c5960a.patch";
