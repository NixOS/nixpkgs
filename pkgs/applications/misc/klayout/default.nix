{ lib, mkDerivation, fetchFromGitHub, fetchpatch, python3, ruby, qtbase
, qtmultimedia, qttools, qtxmlpatterns, which, perl, makeWrapper }:
...
mkDerivation rec {
  ...
  nativeBuildInputs = [ which python3 ruby ];
