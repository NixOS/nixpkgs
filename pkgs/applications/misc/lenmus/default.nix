{ lib, stdenv, pkg-config, fetchFromGitHub, fetchpatch, cmake, boost, portmidi
, sqlite, freetype, libpng, pngpp, zlib, wxGTK30, wxsqlite3 }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ boost portmidi sqlite freetype libpng pngpp zlib wxGTK30 wxsqlite3 ];
