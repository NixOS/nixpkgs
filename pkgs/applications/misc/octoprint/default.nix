{ pkgs, stdenv, lib, fetchFromGitHub, python3, substituteAll, nix-update-script
    ...
    packageOverrides = lib.foldr lib.composeExtensions (self: super: { }) ([
      ...
      (self: super: {
        websocket-client = super.websocket-client.overridePythonAttrs
          (oldAttrs: rec {
            ...
            propagatedBuildInputs = with self; [ six pysocks ];
            disabledTests = [
      ...
      (self: super: {
        zeroconf = super.zeroconf.overrideAttrs (oldAttrs: rec {
          ...
          buildInputs = with self; [ pytestCheckHook nose ];
