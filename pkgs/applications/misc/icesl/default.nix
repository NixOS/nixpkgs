{ stdenv, lib, fetchArchive, freeglut, libXmu, libXi, libX11, libICE, libGLU, libGL, libSM
...
stdenv.mkDerivation rec {
  ...
  src =  if stdenv.hostPlatform.system == "x86_64-linux" then fetchArchive {
  ...
  } else if stdenv.hostPlatform.system == "i686-linux" then fetchArchive {
