...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://prosecco.gforge.inria.fr/personal/bblanche/proverif/proverif${version}.tar.gz";
    sha256 = "163vdcixs764jj8xa08w80qm4kcijf7xj911yp8jvz6pi1q5g13i";
  };

  pf-patch = fetchurl {
    url =
      "http://markryan.eu/research/statverif/files/proverif-${version}-statverif-2657ab4.patch";
