...
let
  fetchArchive' = args: (fetchArchive args).overrideAttrs (old: { UNZIP = "-j -P iagreetotheeula"; });
in
{
  minigames = fetchArchive {
  ...
  ladder2017season1 = fetchArchive' {
  ...
  ladder2017season2 = fetchArchive' {
  ...
  ladder2017season3 = fetchArchive' {
  ...
  ladder2017season4 = fetchArchive' {
  ...
  ladder2018season1 = fetchArchive' {
  ...
  ladder2018season2 = fetchArchive' {
  ...
  ladder2018season3 = fetchArchive' {
  ...
  ladder2018season4 = fetchArchive' {
  ...
  ladder2019season1 = fetchArchive' {
