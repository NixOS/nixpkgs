{ lib, stdenv, fetchurl, apfel, apfelgrid, applgrid, blas, gfortran, lhapdf
, lapack, libyaml, lynx, mela, root5, qcdnum, which, libtirpc, memorymappingHook
, memstreamHook }:
...
stdenv.mkDerivation rec {
  ...
  NIX_CFLAGS_COMPILE = lib.optional (stdenv.hostPlatform.libc == "glibc")
