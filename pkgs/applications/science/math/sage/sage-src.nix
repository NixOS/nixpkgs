...
stdenv.mkDerivation rec {
  ...
  packageUpgradePatches = [
    ...
    # https://github.com/sagemath/sage/pull/37951, landed in 10.4.beta7
    (fetchpatch {
      name = "gap-elementpyx-segfault.patch";
      url = "https://github.com/sagemath/sage/commit/a2c88a666661475f22a73c19abb3e2f4e4eaae18.diff";
      hash = "sha256-+Zwi4fIT30uCGRptGK9RA1jEpWoM55ZdpxdsnDPpO6I=";
    })
