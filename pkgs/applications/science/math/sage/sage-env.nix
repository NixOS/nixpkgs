{ stdenv, lib, writeTextFile, sagelib, sage_docbuild, env-locations, gfortran
...
, sqlite, ppl, ecm, lcalc, rubiks, flintqs, blas, lapack, flint, gmp, mpfr
, pynac, zlib, gsl, ntl, jdk8, less }:
