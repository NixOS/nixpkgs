{ lib, stdenv, coreutils, patchelf, requireFile, callPackage, alsa-lib, dbus
, fontconfig, freetype, gcc, glib, ncurses, opencv2, openssl, unixODBC
, xkeyboard_config, xorg, zlib, libxml2, libuuid, lang ? "en", libGL, libGLU }:
