{ stdenv, fetchurl, cmake, freetype, libpng, mesa, gettext, libssl, qt5Full, perl, libiconv }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ cmake freetype libpng mesa gettext libssl perl libiconv qt5Full ];
