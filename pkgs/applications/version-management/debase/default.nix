...
stdenv.mkDerivation rec {
  ...
  prePatch = ''
    ...
    substituteInPlace Makefile --replace-warn 'git rev-parse HEAD' 'echo bbe9f1737ab229dd370640a4b5d5e742a051c13b'

    substituteInPlace Makefile --replace-quiet '$(GITHASHHEADER): .git/HEAD .git/index' '$(GITHASHHEADER):'
  '';
