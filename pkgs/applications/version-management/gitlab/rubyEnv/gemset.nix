{
  ...
  byebug = {
    groups = [ "default" "development" "test" ];
    platforms = [ { engine = "maglev"; } { engine = "ruby"; } ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  http = {
    dependencies =
      [ "addressable" "http-cookie" "http-form_data" "http-parser" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  json_schemer = {
    dependencies =
      [ "ecma-re-validator" "hana" "regexp_parser" "uri_template" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  rspec-parameterized = {
    dependencies =
      [ "binding_ninja" "parser" "proc_to_ast" "rspec" "unparser" ];
    groups = [ "test" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  tty-markdown = {
    dependencies =
      [ "kramdown" "pastel" "rouge" "strings" "tty-color" "tty-screen" ];
    groups = [ "default" "development" "test" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
