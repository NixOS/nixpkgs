...
[
  ...
  {
    goPackagePath = "github.com/kataras/iris/v12";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "github.com/labstack/echo/v4";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "github.com/libgit2/git2go/v30";
    fetch = {
      type = "git";
  ...
  {
    goPackagePath = "github.com/mediocregopher/radix/v3";
    fetch = {
      type = "git";
  ...
  }
  {
    ...
    fetch = {
      ...
      rev = "3f5e218def93";
      sha256 = "182fw45p45mqi0x4r6rhkmvnz5j6pyimr5jkj2s9mz0gfkp3p7g1";
      moduleDir = "";
    };
  }
  {
