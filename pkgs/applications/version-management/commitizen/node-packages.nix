...
let
  sources = {
    ...
    "@commitlint/execute-rule-12.0.0" = {
      ...
      version = "12.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@commitlint/execute-rule/-/execute-rule-12.0.0.tgz";
        sha512 = "X9vZDKdyOz8MNDZqJN39K9UbjQmMsyQ74d1lUaw0QuCE4jOesmynYkLc4Y4MWKqq9ElWdjswZyLMyOgm3kAMrg==";
      };
    };
    "@commitlint/load-12.0.0" = {
      ...
      version = "12.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@commitlint/load/-/load-12.0.0.tgz";
        sha512 = "B7rwRGWE3j+4dWsLD4s82fIbIJP1xGOJYfAvKDWOa/FnAb8s8ZQOK8HHuDC8BD/MU3Ierl8KJMfzGiO63d1rlA==";
      };
    };
    "@commitlint/resolve-extends-12.0.0" = {
      ...
      version = "12.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@commitlint/resolve-extends/-/resolve-extends-12.0.0.tgz";
        sha512 = "5i0ZieVFzXuRqyYxnoEJ7InYyXQC/K98nF75Ro6wVQqpmzi01/KHYwo8uCcy1Q+rPB48FSmCB84br0t5Ulr/KA==";
      };
    };
    "@commitlint/types-12.0.0" = {
      ...
      version = "12.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@commitlint/types/-/types-12.0.0.tgz";
        sha512 = "ADW/GEwDdgf7ppNq+S2T8J6XgATi2yndXddu+ZV8wlHFpL1DhjPbuPA9RYLnJcp44xQSe/cEV7a7Z43Ryy1S9Q==";
      };
    };
    ...
    "@octokit/openapi-types-3.1.1" = {
      ...
      version = "3.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@octokit/openapi-types/-/openapi-types-3.1.1.tgz";
        sha512 = "4BsrIf9/WLRbl0IVPEPLDTROduvYR57xCldy47YFQp/TZ9DbREQZbeCrJIe7a+Qjb3qk0KwZmxNYYW8mNQY/HQ==";
      };
    };
    ...
    "@octokit/types-6.4.2" = {
      ...
      version = "6.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@octokit/types/-/types-6.4.2.tgz";
        sha512 = "c3OswFOjp0MydgIxWcu/wIXK9sfoBL2gLjqMZA+KKdvvcwh6g2z0eMu219rFrZzi0KQunO9l/a9yHb9T/AlU1A==";
      };
    };
    ...
    "commitizen-4.2.3" = {
      ...
      version = "4.2.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/commitizen/-/commitizen-4.2.3.tgz";
        sha512 = "pYlYEng7XMV2TW4xtjDKBGqeJ0Teq2zyRSx2S3Ml1XAplHSlJZK8vm1KdGclpMEZuGafbS5TeHXIVnHk8RWIzQ==";
      };
    };
    "commondir-1.0.1" = {
      name = "commondir";
...
in
{
  commitizen = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."@commitlint/execute-rule-12.0.0"
      (sources."@commitlint/load-12.0.0" // {
        dependencies = [
      ...
      sources."@commitlint/resolve-extends-12.0.0"
      (sources."@commitlint/types-12.0.0" // {
        dependencies = [
          sources."ansi-styles-4.3.0"
          sources."chalk-4.1.0"
          sources."color-convert-2.0.1"
      ...
      sources."@octokit/openapi-types-3.1.1"
