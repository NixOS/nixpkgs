...
let
  sources = {
    ...
    "commitizen-4.2.2" = {
      ...
      version = "4.2.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/commitizen/-/commitizen-4.2.2.tgz";
        sha512 = "uz+E6lGsDBDI2mYA4QfOxFeqdWUYwR1ky11YmLgg2BnEEP3YbeejpT4lxzGjkYqumnXr062qTOGavR9NtX/iwQ==";
      };
    };
    "commondir-1.0.1" = {
      name = "commondir";
    ...
    "electron-to-chromium-1.3.622" = {
      ...
      version = "1.3.622";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.622.tgz";
        sha512 = "AJT0Fm1W0uZlMVVkkJrcCVvczDuF8tPm3bwzQf5WO8AaASB2hwTRP7B8pU5rqjireH+ib6am8+hH5/QkXzzYKw==";
      };
    };
    "emoji-regex-7.0.3" = {
      name = "emoji-regex";
...
in
{
  commitizen = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.622"
