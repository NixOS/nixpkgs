{ lib, stdenv, mkDerivation, fetchFromGitHub, fetchpatch, substituteAll, gdal
, cmake, ninja, proj, clipper, zlib, qttools, qtlocation, qtsensors
, qttranslations, doxygen, cups, qtimageformats }:
...
mkDerivation rec {
  ...
  buildInputs =
    [ gdal qtlocation qtimageformats qtsensors clipper zlib proj cups ];
