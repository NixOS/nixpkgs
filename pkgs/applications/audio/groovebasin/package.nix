...

{
  ...
  by-version."amdefine"."0.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/amdefine/-/amdefine-0.1.1.tgz";
  ...
  by-version."base64url"."0.0.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/base64url/-/base64url-0.0.3.tgz";
  ...
  by-version."base64url"."1.0.4" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/base64url/-/base64url-1.0.4.tgz";
  ...
  by-version."bluebird"."2.9.30" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/bluebird/-/bluebird-2.9.30.tgz";
  ...
  by-version."browserify-lite"."0.2.4" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/browserify-lite/-/browserify-lite-0.2.4.tgz";
  ...
  by-version."clarinet"."0.8.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/clarinet/-/clarinet-0.8.1.tgz";
  ...
  by-version."connect-static"."1.5.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/connect-static/-/connect-static-1.5.0.tgz";
  ...
  by-version."curlydiff"."2.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/curlydiff/-/curlydiff-2.0.1.tgz";
  ...
  by-version."diacritics"."1.2.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/diacritics/-/diacritics-1.2.1.tgz";
  ...
  by-version."fast-future"."1.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/fast-future/-/fast-future-1.0.1.tgz";
  ...
  by-version."findit2"."2.2.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/findit2/-/findit2-2.2.3.tgz";
  ...
  by-version."gapitoken"."0.1.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/gapitoken/-/gapitoken-0.1.4.tgz";
  ...
  by-version."google-auth-library"."0.9.6" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/google-auth-library/-/google-auth-library-0.9.6.tgz";
  ...
  by-version."google-p12-pem"."0.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/google-p12-pem/-/google-p12-pem-0.0.1.tgz";
  ...
  by-version."googleapis"."2.0.5" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/googleapis/-/googleapis-2.0.5.tgz";
  ...
  by-version."groove"."2.3.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/groove/-/groove-2.3.4.tgz";
  ...
  by-version."gtoken"."1.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/gtoken/-/gtoken-1.1.1.tgz";
  ...
  by-version."har-validator"."1.7.1" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/har-validator/-/har-validator-1.7.1.tgz";
  ...
  by-version."httpolyglot"."0.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/httpolyglot/-/httpolyglot-0.1.1.tgz";
  ...
  by-version."human-size"."1.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/human-size/-/human-size-1.1.0.tgz";
  ...
  by-version."jstream"."0.2.7" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/jstream/-/jstream-0.2.7.tgz";
  ...
  by-version."jwa"."1.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/jwa/-/jwa-1.0.0.tgz";
      name = "jwa-1.0.0.tgz";
  ...
  by-version."jws"."0.0.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/jws/-/jws-0.0.2.tgz";
      name = "jws-0.0.2.tgz";
  ...
  by-version."keese"."1.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/keese/-/keese-1.1.1.tgz";
  ...
  by-version."lastfm"."0.9.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lastfm/-/lastfm-0.9.2.tgz";
  ...
  by-version."leveldown"."1.0.7" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/leveldown/-/leveldown-1.0.7.tgz";
  ...
  by-version."lodash.noop"."3.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash.noop/-/lodash.noop-3.0.0.tgz";
  ...
  by-version."mess"."0.1.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mess/-/mess-0.1.2.tgz";
      name = "mess-0.1.2.tgz";
  ...
  by-version."mime-db"."1.13.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-db/-/mime-db-1.13.0.tgz";
  ...
  by-version."mime-types"."2.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-types/-/mime-types-2.1.1.tgz";
  ...
  by-version."multiparty"."4.1.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/multiparty/-/multiparty-4.1.2.tgz";
  ...
  by-version."music-library-index"."1.3.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/music-library-index/-/music-library-index-1.3.0.tgz";
  ...
  by-version."mv"."2.0.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mv/-/mv-2.0.3.tgz";
      name = "mv-2.0.3.tgz";
  ...
  by-version."osenv"."0.1.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/osenv/-/osenv-0.1.2.tgz";
  ...
  by-version."request"."2.54.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/request/-/request-2.54.0.tgz";
  ...
  by-version."streamsink"."1.2.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/streamsink/-/streamsink-1.2.0.tgz";
  ...
  by-version."tap"."0.3.3" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/tap/-/tap-0.3.3.tgz";
      name = "tap-0.3.3.tgz";
  ...
  by-version."type-is"."1.6.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/type-is/-/type-is-1.6.3.tgz";
  ...
  by-version."yauzl"."2.3.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/yauzl/-/yauzl-2.3.1.tgz";
  ...
  by-version."yawl"."1.0.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/yawl/-/yawl-1.0.2.tgz";
      name = "yawl-1.0.2.tgz";
  ...
  by-version."yazl"."2.2.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/yazl/-/yazl-2.2.2.tgz";
      name = "yazl-2.2.2.tgz";
  ...
  by-version."ytdl-core"."0.5.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ytdl-core/-/ytdl-core-0.5.1.tgz";
