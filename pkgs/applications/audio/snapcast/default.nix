...
, boost17x, flac, libogg, libvorbis, soxr, pulseaudioSupport ? false
, libpulseaudio, nixosTests }:
...
in stdenv.mkDerivation rec {
  ...
  # not needed
  buildInputs =
    [ boost17x alsa-lib asio avahi flac libogg libvorbis aixlog popl soxr ]
