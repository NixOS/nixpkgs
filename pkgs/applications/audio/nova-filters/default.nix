...
stdenv.mkDerivation {
  ...
  patchPhase = ''
    ...
    sed -i "s@-fomit-frame-pointer -ffast-math -mfpmath=sse@-I ${lib.getDev boost}/include@g" SConstruct
    sed -i "s@env.has_key('cxx')@'cxx' in env@g" SConstruct
    sed -i "s@ladspa.h@${lib.getDev ladspaH}/include/ladspa.h@g" filters.cpp
