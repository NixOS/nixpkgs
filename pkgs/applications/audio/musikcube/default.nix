{ cmake, pkg-config, alsa-lib, boost, curl, fetchFromGitHub, fetchpatch, ffmpeg
, lame, libev, libmicrohttpd, ncurses, pulseaudio, lib, stdenv, taglib
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/clangen/musikcube/commit/1240720e27232fdb199a4da93ca6705864442026.patch";
