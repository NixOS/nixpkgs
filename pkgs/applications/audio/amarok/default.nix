...
, qtscriptgenerator, gettext, curl, libxml2, mysql57, taglib
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    qtscriptgenerator stdenv.cc.libc gettext curl libxml2 mysql57.server mysql57.server.static /*libmysqld*/
