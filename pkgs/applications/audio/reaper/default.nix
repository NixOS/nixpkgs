...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    hash =
      if stdenv.hostPlatform.isDarwin then
        "sha256-8i7BjeNSfo9/hUfJw/zxcXjLfCHBO4NuFkKrDozh6u0="
      else
        {
          x86_64-linux = "sha256-Bf7rS7vGnCnvwEQJqjpBzbs2XfXI8Rckii4txQuY5lA=";
          aarch64-linux = "sha256-uanjGVBpeoBr/q1KcZXfRDJbdjiWP0VOFvMynWJuZ7U=";
        }
