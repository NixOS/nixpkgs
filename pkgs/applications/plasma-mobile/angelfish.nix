{ lib, mkDerivation, fetchurl, cmake, corrosion, extra-cmake-modules, kconfig
, kcoreaddons, kdbusaddons, ki18n, kirigami2, knotifications, kpurpose
, kwindowsystem, qtfeedback, qtquickcontrols2, qtwebengine, rustPlatform, srcs
...
if cargoShaForVersion != srcs.angelfish.version then
  ...
  mkDerivation rec {
    ...
    cmakeFlags = [ "-DRust_CARGO=${rustPlatform.rust.cargo}/bin/cargo" ];
