...
stdenv.mkDerivation {
  ...
  src = fetchurl {
     url = https://www.cs.mun.ca/~gstarkes/wmaker/dockapps/files/wmCalClock-1.25.tar.gz;
  ...
  meta = {
    ...
    homepage = "https://www.cs.mun.ca/~gstarkes/wmaker/dockapps/time.html#wmcalclock";
