...
rec {
  ...
  clap_2_26_2 = clap_2_26_2_ rec {
    dependencies = [ ansi_term_0_9_0 atty_0_2_3 bitflags_0_9_1 strsim_0_6_0 term_size_0_3_0 textwrap_0_8_0 unicode_width_0_1_4 vec_map_0_8_0 ]
      ++ (if lib.lists.any (x: x == "ansi_term") features then [ansi_term_0_9_0] else [])      ++ (if lib.lists.any (x: x == "atty") features then [atty_0_2_3] else [])      ++ (if lib.lists.any (x: x == "strsim") features then [strsim_0_6_0] else [])      ++ (if lib.lists.any (x: x == "term_size") features then [term_size_0_3_0] else []);
    features = mkFeatures clap_2_26_2_features;
  };
  clap_2_26_2_features."".self = true;
  clap_2_26_2_features."ansi_term".self_color = hasFeature (clap_2_26_2_features."color" or {});
  clap_2_26_2_features."atty".self_color = hasFeature (clap_2_26_2_features."color" or {});
  clap_2_26_2_features."suggestions".self_default = hasDefault clap_2_26_2_features;
  clap_2_26_2_features."color".self_default = hasDefault clap_2_26_2_features;
  clap_2_26_2_features."wrap_help".self_default = hasDefault clap_2_26_2_features;
  clap_2_26_2_features."yaml".self_doc = hasFeature (clap_2_26_2_features."doc" or {});
  clap_2_26_2_features."clippy".self_lints = hasFeature (clap_2_26_2_features."lints" or {});
  clap_2_26_2_features."strsim".self_suggestions = hasFeature (clap_2_26_2_features."suggestions" or {});
  clap_2_26_2_features."term_size".self_wrap_help = hasFeature (clap_2_26_2_features."wrap_help" or {});
  clap_2_26_2_features."yaml-rust".self_yaml = hasFeature (clap_2_26_2_features."yaml" or {});
  ansi_term_0_9_0_features."default".from_clap_2_26_2__default = true;
  atty_0_2_3_features."default".from_clap_2_26_2__default = true;
  bitflags_0_9_1_features."default".from_clap_2_26_2__default = true;
  clippy_0_0_0_features."default".from_clap_2_26_2__default = true;
  strsim_0_6_0_features."default".from_clap_2_26_2__default = true;
  term_size_0_3_0_features."default".from_clap_2_26_2__default = true;
  textwrap_0_8_0_features."default".from_clap_2_26_2__default = true;
  unicode_width_0_1_4_features."default".from_clap_2_26_2__default = true;
  vec_map_0_8_0_features."default".from_clap_2_26_2__default = true;
  yaml_rust_0_0_0_features."default".from_clap_2_26_2__default = true;
  ...
  flate2_0_2_20 = flate2_0_2_20_ rec {
    dependencies = [ libc_0_2_32 miniz_sys_0_1_10 ]
  ...
  libc_0_2_32_features."default".from_flate2_0_2_20__default = true;
  ...
  image_0_10_4 = image_0_10_4_ rec {
    dependencies = [ byteorder_0_5_3 enum_primitive_0_1_1 gif_0_9_2 glob_0_2_11 jpeg_decoder_0_1_13 num_iter_0_1_34 num_rational_0_1_39 num_traits_0_1_40 png_0_5_2 scoped_threadpool_0_1_8 ]
  ...
  num_traits_0_1_40_features."default".from_image_0_10_4__default = true;
  ...
  libc_0_2_32 = libc_0_2_32_ rec {
    features = mkFeatures libc_0_2_32_features;
  };
  libc_0_2_32_features."use_std".self_default = hasDefault libc_0_2_32_features;
  ...
  libc_0_2_32_features."default".from_miniz_sys_0_1_10__default = true;
  num_bigint_0_1_40 = num_bigint_0_1_40_ rec {
    dependencies = [ num_integer_0_1_35 num_traits_0_1_40 rand_0_3_17 rustc_serialize_0_3_24 ]
      ++ (if lib.lists.any (x: x == "rand") features then [rand_0_3_17] else [])      ++ (if lib.lists.any (x: x == "rustc-serialize") features then [rustc_serialize_0_3_24] else []);
  ...
  num_traits_0_1_40_features."default".from_num_bigint_0_1_40__default = true;
  rand_0_3_17_features."default".from_num_bigint_0_1_40__default = true;
  ...
  num_rational_0_1_39 = num_rational_0_1_39_ rec {
    dependencies = [ num_bigint_0_1_40 num_integer_0_1_35 num_traits_0_1_40 rustc_serialize_0_3_24 ]
  ...
  num_traits_0_1_40_features."default".from_num_rational_0_1_39__default = true;
  ...
  libc_0_2_32_features."default".from_num_cpus_1_7_0__default = true;
  ...
  phf_generator_0_7_21 = phf_generator_0_7_21_ rec {
    dependencies = [ phf_shared_0_7_21 rand_0_3_17 ];
  };
  phf_shared_0_7_21_features."default".from_phf_generator_0_7_21__default = true;
  rand_0_3_17_features."default".from_phf_generator_0_7_21__default = true;
  ...
  rand_0_3_17 = rand_0_3_17_ rec {
    dependencies = [ libc_0_2_32 ]
      ++ (if kernel == "fuchsia" then [ fuchsia_zircon_0_2_1 ] else []);
    features = mkFeatures rand_0_3_17_features;
  };
  rand_0_3_17_features."i128_support".self_nightly = hasFeature (rand_0_3_17_features."nightly" or {});
  libc_0_2_32_features."default".from_rand_0_3_17__default = true;
  fuchsia_zircon_0_2_1_features."default".from_rand_0_3_17__default = true;
  ...
  rayon_core_1_2_1 = rayon_core_1_2_1_ rec {
    dependencies = [ coco_0_1_1 futures_0_1_16 lazy_static_0_2_9 libc_0_2_32 num_cpus_1_7_0 rand_0_3_17 ];
  };
  ...
  lazy_static_0_2_9_features."default".from_rayon_core_1_2_1__default = true;
  libc_0_2_32_features."default".from_rayon_core_1_2_1__default = true;
  num_cpus_1_7_0_features."default".from_rayon_core_1_2_1__default = true;
  rand_0_3_17_features."default".from_rayon_core_1_2_1__default = true;
  ...
  tempfile_2_2_0 = tempfile_2_2_0_ rec {
    dependencies = [ rand_0_3_17 ]
      ++ (if kernel == "redox" then [ redox_syscall_0_1_31 ] else [])
      ++ (if (kernel == "linux" || kernel == "darwin") then [ libc_0_2_32 ] else [])
      ++ (if kernel == "windows" then [ kernel32_sys_0_2_2 winapi_0_2_8 ] else []);
  };
  rand_0_3_17_features."default".from_tempfile_2_2_0__default = true;
  redox_syscall_0_1_31_features."default".from_tempfile_2_2_0__default = true;
  libc_0_2_32_features."default".from_tempfile_2_2_0__default = true;
  ...
  term_size_0_3_0 = term_size_0_3_0_ rec {
    dependencies = []
      ++ (if !(kernel == "windows") then [ libc_0_2_32 ] else [])
      ++ (if kernel == "windows" then [ kernel32_sys_0_2_2 winapi_0_2_8 ] else []);
  ...
  libc_0_2_32_features."default".from_term_size_0_3_0__default = true;
  ...
  termion_1_5_1 = termion_1_5_1_ rec {
    dependencies = (if !(kernel == "redox") then [ libc_0_2_32 ] else [])
      ++ (if kernel == "redox" then [ redox_syscall_0_1_31 redox_termios_0_1_1 ] else []);
  };
  libc_0_2_32_features."default".from_termion_1_5_1__default = true;
  ...
  textwrap_0_8_0 = textwrap_0_8_0_ rec {
    dependencies = [ term_size_0_3_0 unicode_width_0_1_4 ];
  };
  hyphenation_0_0_0_features."default".from_textwrap_0_8_0__default = true;
  term_size_0_3_0_features."default".from_textwrap_0_8_0__default = true;
  unicode_width_0_1_4_features."default".from_textwrap_0_8_0__default = true;
  ...
  way_cooler_client_helpers_0_1_0 = way_cooler_client_helpers_0_1_0_ rec {
    dependencies = [ wayland_client_0_9_10 wayland_sys_0_9_10 ];
  };
  wayland_client_0_9_10_features."cursor".from_way_cooler_client_helpers_0_1_0 = true;
  wayland_client_0_9_10_features."dlopen".from_way_cooler_client_helpers_0_1_0 = true;
  wayland_client_0_9_10_features."default".from_way_cooler_client_helpers_0_1_0__default = true;
  wayland_sys_0_9_10_features."client".from_way_cooler_client_helpers_0_1_0 = true;
  wayland_sys_0_9_10_features."dlopen".from_way_cooler_client_helpers_0_1_0 = true;
  wayland_sys_0_9_10_features."default".from_way_cooler_client_helpers_0_1_0__default = true;
  wayland_client_0_9_10 = wayland_client_0_9_10_ rec {
    dependencies = [ bitflags_0_9_1 libc_0_2_32 wayland_sys_0_9_10 ];
    buildDependencies = [ wayland_scanner_0_9_10 ];
    features = mkFeatures wayland_client_0_9_10_features;
  };
  wayland_client_0_9_10_features."egl".self_default = hasDefault wayland_client_0_9_10_features;
  wayland_client_0_9_10_features."cursor".self_default = hasDefault wayland_client_0_9_10_features;
  bitflags_0_9_1_features."default".from_wayland_client_0_9_10__default = true;
  libc_0_2_32_features."default".from_wayland_client_0_9_10__default = true;
  wayland_sys_0_9_10_features."client".from_wayland_client_0_9_10 = true;
  wayland_sys_0_9_10_features."cursor".from_wayland_client_0_9_10__cursor = hasFeature (wayland_client_0_9_10_features."cursor" or {});
  wayland_sys_0_9_10_features."dlopen".from_wayland_client_0_9_10__dlopen = hasFeature (wayland_client_0_9_10_features."dlopen" or {});
  wayland_sys_0_9_10_features."egl".from_wayland_client_0_9_10__egl = hasFeature (wayland_client_0_9_10_features."egl" or {});
  wayland_sys_0_9_10_features."default".from_wayland_client_0_9_10__default = true;
  wayland_scanner_0_9_10 = wayland_scanner_0_9_10_ rec {
    dependencies = [ xml_rs_0_6_1 ];
  };
  xml_rs_0_6_1_features."default".from_wayland_scanner_0_9_10__default = true;
  wayland_sys_0_9_10 = wayland_sys_0_9_10_ rec {
    dependencies = [ dlib_0_3_1 lazy_static_0_2_9 ]
      ++ (if lib.lists.any (x: x == "lazy_static") features then [lazy_static_0_2_9] else []);
  ...
  libc_0_0_0_features."default".from_wayland_sys_0_9_10__default = true;
  wc_bg_0_3_0 = wc_bg_0_3_0_ rec {
    dependencies = [ byteorder_0_5_3 clap_2_26_2 image_0_10_4 tempfile_2_2_0 way_cooler_client_helpers_0_1_0 wayland_client_0_9_10 wayland_sys_0_9_10 ];
    buildDependencies = [ wayland_scanner_0_9_10 ];
  };
  byteorder_0_5_3_features."default".from_wc_bg_0_3_0__default = true;
  clap_2_26_2_features."default".from_wc_bg_0_3_0__default = true;
  image_0_10_4_features."default".from_wc_bg_0_3_0__default = true;
  tempfile_2_2_0_features."default".from_wc_bg_0_3_0__default = true;
  way_cooler_client_helpers_0_1_0_features."default".from_wc_bg_0_3_0__default = true;
  wayland_client_0_9_10_features."cursor".from_wc_bg_0_3_0 = true;
  wayland_client_0_9_10_features."dlopen".from_wc_bg_0_3_0 = true;
  wayland_client_0_9_10_features."default".from_wc_bg_0_3_0__default = true;
  wayland_sys_0_9_10_features."client".from_wc_bg_0_3_0 = true;
  wayland_sys_0_9_10_features."dlopen".from_wc_bg_0_3_0 = true;
  wayland_sys_0_9_10_features."default".from_wc_bg_0_3_0__default = true;
  winapi_0_2_8 = winapi_0_2_8_ rec {};
  winapi_build_0_1_1 = winapi_build_0_1_1_ rec {};
  xml_rs_0_6_1 = xml_rs_0_6_1_ rec {
    dependencies = [ bitflags_0_9_1 ];
  };
  bitflags_0_9_1_features."default".from_xml_rs_0_6_1__default = true;
}
