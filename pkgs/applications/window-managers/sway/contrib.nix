...
, fetchurl, coreutils, makeWrapper, sway-unwrapped, installShellFiles
, wl-clipboard, libnotify, slurp, grim, jq
...

{
  ...
  grimshot = stdenv.mkDerivation rec {
    ...
    meta = with lib; {
      ...
      maintainers = with maintainers; [ sway-unwrapped.meta.maintainers evils ];
    };
  };
