{ lib, stdenv, fetchFromGitHub, fetchpatch, asciidoc, cmake, expat, fontconfig
...
, libXft, libXinerama, libXpm, libXrandr, libjpeg, libpng, libpthreadstubs
, libsndfile, libtiff, libxcb, mkfontdir, pcre, perl, pkg-config }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/ice-wm/icewm/pull/57/commits/ebd2c45341cc31755758a423392a0f78a64d2d37.patch";
      sha256 = "16m9znd3ijcfl7la3l27ac3clx8l9qng3fprkpxqcifd89ny1ml5";
    })
  ];

  nativeBuildInputs = [ asciidoc cmake perl pkg-config ];
  buildInputs = [
    expat
    fontconfig
    freetype
