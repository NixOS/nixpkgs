...
, comedilib, libusb1, SDL, gsl, cppzmq, zeromq
# GUI related
, gtk2, pango, cairo, qt4, qwt6_qt4
...
let
  ...
  featuresInfo = {
    ...
    gr-atsc = { cmakeEnableFlag = "GR_ATSC"; };
    gr-audio = {
    ...
    gr-noaa = { cmakeEnableFlag = "GR_NOAA"; };
    gr-pager = { cmakeEnableFlag = "GR_PAGER"; };
    gr-qtgui = {
    ...
    gr-utils = { cmakeEnableFlag = "GR_UTILS"; };
    gr-video-sdl = {
      runtime = [ SDL ];
  ...
  shared = (import ./shared.nix {
    inherit lib stdenv python removeReferencesTo featuresInfo features
...
in stdenv.mkDerivation rec {
  inherit pname;
  inherit (shared)
    version src nativeBuildInputs buildInputs disallowedReferences postInstall
    doCheck dontWrapPythonPrograms meta;
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/gnuradio/gnuradio/commit/acef55433d15c231661fa44751f9a2d90a4baa4b.diff";
      sha256 = "2CEX44Ll8frfLXTIWjdDhKl7aXcjiAWsezVdwrynelE=";
    })
    (fetchpatch {
      url =
        "https://github.com/gnuradio/gnuradio/commit/a2681edcfaabcb1ecf878ae861161b6a6bf8459d.diff";
