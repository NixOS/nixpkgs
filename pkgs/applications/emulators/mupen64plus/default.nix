{lib, stdenv, fetchurl, fetchpatch, boost, dash, freetype, libpng, libGLU, pkg-config, SDL2, which, zlib, nasm, vulkan-loader}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ boost dash freetype libpng libGLU SDL2 which zlib vulkan-loader ];
