...
let
  ...
  darwin = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      ...
      sha256 = {
        aarch64-darwin = "bdbcb9a98211f866ca089d440aebcd1d313aa99e8ab4104aae4e65ea3cee74ca";
        x86_64-darwin = "0b7ef18ed08341ac6c15339fe9a161ad17f6b469009d987cfc7d50c628d12a4e";
      }.${system} or throwSystem;
    };
