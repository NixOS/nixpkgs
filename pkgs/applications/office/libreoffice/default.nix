...
in stdenv.mkDerivation rec {
  ...
  '' + lib.optionalString stdenv.isDarwin ''
    ...
    substituteInPlace vcl/osx/salframeview.mm \
      --replace NSWindowCollectionBehaviorFullScreenNone '1 << 9'
  '';
  ...
  buildInputs = with xorg; [
    ...
    freetype GConf getopt gperf gtk3 gtk2
    ...
    mdds libcmis libwps libabw libzmf libtool
  ...
  ++ lib.optionals stdenv.isDarwin (with darwin; with apple_sdk.frameworks;
    [ cf-private AVFoundation CoreMedia MediaToolbox AddressBook ]);
