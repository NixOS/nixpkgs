...
stdenvNoCC.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://raw.githubusercontent.com/simonmichael/hledger/hledger-lib-${version}/bin/hledger-check-fancyassertions.hs";
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/simonmichael/hledger/blob/master/CHANGES.md";
