...
, pkg-config, desktop-file-utils, python3, glib, gtk4, json-glib, libadwaita
, libgee, wrapGAppsHook4 }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ desktop-file-utils meson ninja vala pkg-config python3 wrapGAppsHook4 ];
