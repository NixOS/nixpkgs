{ lib, stdenv, fetchFromGitHub, pkg-config, mono, meson, ninja, gtk-sharp-2_0
, gettext, makeWrapper, glib, gtk2-x11, libxslt, docbook_xsl, python3 }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ pkg-config meson ninja gettext makeWrapper libxslt docbook_xsl python3 ];
