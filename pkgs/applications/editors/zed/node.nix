...

{
  ...
  by-version."graceful-fs"."3.0.7" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/graceful-fs/-/graceful-fs-3.0.7.tgz";
  ...
  by-version."mime-db"."1.10.0" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/mime-db/-/mime-db-1.10.0.tgz";
  ...
  by-version."mime-types"."2.0.12" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/mime-types/-/mime-types-2.0.12.tgz";
