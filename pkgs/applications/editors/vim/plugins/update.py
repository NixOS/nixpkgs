...
NVIM_TREESITTER_SOURCE_DIR = \
    "pkgs/applications/editors/vim/plugins/nvim-treesitter"

NVIM_TREESITTER_GENERATED_NIX = os.path.join(NVIM_TREESITTER_SOURCE_DIR, "generated.nix")
...
""".format(
    ...
    def update(self, args):
        ...
        if self.nvim_treesitter_updated:
            ...
            lockfile = json.load(open(os.path.join(os.environ['NVIM_TREESITTER'], "lockfile.json")))

            update_grammars(
                lockfile=lockfile,
                treesitter_source_path=os.path.join(args.nixpkgs, NVIM_TREESITTER_SOURCE_DIR)
            )
