...

{
  ...
  clion = buildClion rec {
    name = "clion-${version}";
    version = "2022.1"; /* updated by script */
    description  = "C/C++ IDE. New. Intelligent. Cross-platform";
    license = lib.licenses.unfree;
    src = fetchurl {
      url = "https://download.jetbrains.com/cpp/CLion-${version}.tar.gz";
      sha256 = "12x3vrl8p02micv9r0qc8bl15gbxi0822md7c37aaq1d6sv8vbd8"; /* updated by script */
    };
  ...
  datagrip = buildDataGrip rec {
    ...
    version = "2022.1.2"; /* updated by script */
    description = "Your Swiss Army Knife for Databases and SQL";
    license = lib.licenses.unfree;
    src = fetchurl {
      url = "https://download.jetbrains.com/datagrip/${name}.tar.gz";
      sha256 = "14d6y5xcvzbqgvvh22hvdrycbagcflmaijya4mdlswnf145n922b"; /* updated by script */
    };
  ...
  goland = buildGoland rec {
    ...
    src = fetchurl {
      ...
      sha256 = "0ix9hbgqxpkmw5q2n19b87jv0q0dymsq7m0g6jgrlyrbnqrg80vq"; /* updated by script */
    };
  ...
  idea-community = buildIdea rec {
    ...
    src = fetchurl {
      ...
      sha256 = "1rfbbdz45c9y1f66b61ji5893wgqxsc66k2ik973w5x05wayc004"; /* updated by script */
    };
  ...
  idea-ultimate = buildIdea rec {
    ...
    src = fetchurl {
      ...
      sha256 = "1dkp9hl07wkn81apyz5h5yrs4ymknx7mi5hrhzv768n8lzabp1pp"; /* updated by script */
    };
  ...
  mps = buildMps rec {
    ...
    src = fetchurl {
      ...
      sha256 = "1rmk7mwaaw4xl7j0wrd9xvkc0npx1b1hx7zdxank07z7c91irm5p"; /* updated by script */
    };
  ...
  phpstorm = buildPhpStorm rec {
    ...
    src = fetchurl {
      ...
      sha256 = "15bkhxn29wiv2my1ph3kvc2xd5r7qk827ih5mc1crpcar68nj3g3"; /* updated by script */
    };
  ...
  pycharm-community = buildPycharm rec {
    ...
    src = fetchurl {
      ...
      sha256 = "1sw5pqs0b95gya90ak898bhlnnc3j6f35b30pb57dgf41bgmgn1m"; /* updated by script */
    };
  ...
  pycharm-professional = buildPycharm rec {
    ...
    src = fetchurl {
      url = "https://download.jetbrains.com/python/${name}.tar.gz";
      sha256 = "01gndhg2cbxjh6jl5q8c8kk158i437wp7bvnycgy6jrq9zbhw5lv"; /* updated by script */
    };
  ...
  rider = buildRider rec {
    name = "rider-${version}";
    version = "2022.1.1"; /* updated by script */
    description = "A cross-platform .NET IDE based on the IntelliJ platform and ReSharper";
    license = lib.licenses.unfree;
    src = fetchurl {
      url = "https://download.jetbrains.com/rider/JetBrains.Rider-${version}.tar.gz";
      sha256 = "0p5xn2nj0wfs5d9hcfxx2xs6qgf46k42n68lq53li7kw2nrbl6fs"; /* updated by script */
    };
  ...
  ruby-mine = buildRubyMine rec {
    ...
    src = fetchurl {
      ...
      sha256 = "008ljmmxn4d3j4wcm4g8ib2k7cxkx0vsx9wjsq7fsfvzxf30sp29"; /* updated by script */
    };
  ...
  webstorm = buildWebStorm rec {
    ...
    src = fetchurl {
      ...
      sha256 = "0v3ls40lxc79b8ysnk8crvwz5l4h77g3lls7vkvp8va5rhamipfr"; /* updated by script */
    };
