...
let
  ...
  urls = {
    x86_64-linux = {
      url = "https://download.jetbrains.com/rider/JetBrains.Rider-2026.2.2.tar.gz";
      hash = "sha256-M7XEaoUKGa88RXNmNClew3rBBPzMg1bSFd+5Q5i9AhE=";
    };
    aarch64-linux = {
      url = "https://download.jetbrains.com/rider/JetBrains.Rider-2026.2.2-aarch64.tar.gz";
      hash = "sha256-+F5BuvlXGhaAbFlrmbRAEre5xN9c7XdBG8iB8oyhj+k=";
    };
    aarch64-darwin = {
      url = "https://download.jetbrains.com/rider/JetBrains.Rider-2026.2.2-aarch64.dmg";
      hash = "sha256-6ZECbVKeMcFuFjOJa4+Wk38o73hzKiKh+ar63dSN5hU=";
    };
  };
