...
let
  ...
  urls = {
    x86_64-linux = {
      url = "https://download.jetbrains.com/cpp/CLion-2026.2.2.tar.gz";
      hash = "sha256-TgqzsHEKI8i2y6jHIwGlIoI2Xt11BtthtFhqvCHqbf4=";
    };
    aarch64-linux = {
      url = "https://download.jetbrains.com/cpp/CLion-2026.2.2-aarch64.tar.gz";
      hash = "sha256-L+ZZWAYfyz+ZpBHOlBVHr1E7mlc8eAhjz6yuMiAnE6A=";
    };
    aarch64-darwin = {
      url = "https://download.jetbrains.com/cpp/CLion-2026.2.2-aarch64.dmg";
      hash = "sha256-UU/QPlLT8QH8eY+H8I3uwha+rIZLaniwT5CV4V1a6Jg=";
    };
  };
