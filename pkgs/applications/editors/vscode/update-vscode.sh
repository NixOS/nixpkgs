...
NIXPKGS_ROOT="$(dirname $(dirname $(dirname $(dirname $ROOT))))"
...
VSCODE_X64_LINUX_SHA256=${VSCODE_X64_LINUX[0]}
VSCODE_X64_LINUX_PATH=${VSCODE_X64_LINUX[1]}
sed -i "s/x86_64-linux = \".\{52\}\"/x86_64-linux = \"${VSCODE_X64_LINUX_SHA256}\"/" "$ROOT/vscode.nix"

tar xf $VSCODE_X64_LINUX_PATH -C $TEMP_FOLDER
