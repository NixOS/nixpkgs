...
let
  supported = {
    x86_64-linux = {
      hash = "sha256-J+e+qT5poHb9DwqjvIntdskk+KA5RmsqAbFpN/df32U=";
      arch = "linux-x64";
    };
    x86_64-darwin = {
      hash = "sha256-uhyleney0iC8hEsc+hGBqWIex56AhdgRU8E3fEZgJyM=";
      arch = "darwin-x64";
    };
    aarch64-linux = {
      hash = "sha256-IcdjG/UEDewvEKkyemOcnCPzFa/SgnMnpg6kNS0lby4=";
      arch = "linux-arm64";
    };
    aarch64-darwin = {
      hash = "sha256-4edrhIJ2Kn1oRb27Mjao7EkuyO+RrcMauHMTfcaMTo0=";
      arch = "darwin-arm64";
    };
  };
