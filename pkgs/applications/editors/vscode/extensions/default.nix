    ...
    lib.mapAttrs (_n: lib.recurseIntoAttrs) {
      ...
      asvetliakov.vscode-neovim = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          version = "1.18.18";
          hash = "sha256-pPsUSEsolAWWJs9epvLipOJuOJ38zBWTpV2XEtLgdmY=";
        };
        meta = {
      ...
      bradlc.vscode-tailwindcss = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "bradlc";
          version = "0.14.8";
          hash = "sha256-IPD8nsm6z6Pxeqjj00I/dQyGEORxFpDZ2yS8xpK1H9U=";
        };
        meta = {
      ...
      coder.coder-remote = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "coder";
          version = "1.4.2";
          hash = "sha256-TKQUKUuuR9UBNTFWedzDQrKxGB4Apd2I2b50YdOnBKA=";
        };
        meta = {
      ...
      cweijan.vscode-database-client2 = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "cweijan";
          version = "8.1.9";
          hash = "sha256-6/UV3Q5FToF+OXCe2Z4oPYTKKGVoXSXgyk8dBd5kp7E=";
        };
        meta = {
      ...
      danielsanmedium.dscodegpt = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          name = "dscodegpt";
          version = "3.9.34";
          hash = "sha256-PGMTO4WDUqmKMFS397sC3zyP3cXsPvVwWIy7IayWqbc=";
        };
        meta = {
      ...
      dart-code.dart-code = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          hash = "sha256-soeCh6873BzpcSf5RKK2Kmr2wvK1sLKER7mYOIvvsEs=";
        };
      ...
      emmanuelbeziat.vscode-great-icons = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          version = "2.1.115";
          hash = "sha256-mEVvEagl+FMHq/TUISDub2yHMPhshKSM544RcPDBrlk=";
        };
        meta = {
          license = lib.licenses.mit;
        };
      ...
      foam.foam-vscode = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "foam";
          version = "0.26.7";
          hash = "sha256-n0UvauL1nzRAKiikhjROhzdH9f77QaQgVOzue736ooQ=";
        };
        meta = {
      ...
      gitlab.gitlab-workflow = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "gitlab";
          version = "6.2.2";
          hash = "sha256-vGzDDCykxO3gbAPnD6p+j7uZoMQzXt13xfQOpQ6s43k=";
        };
        meta = {
      ...
      jdinhlife.gruvbox = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "jdinhlife";
          version = "1.24.5";
          hash = "sha256-17Tzbed+AZ6G1Rmw/eClFtsATWtUk1+AAeCSpeSurXk=";
        };
        meta = {
      ...
      marp-team.marp-vscode = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "marp-team";
          version = "3.1.0";
          hash = "sha256-dEwwsRXxocJdZQ1Ks5sfTf6KKm8i16FqNr0ZwB/nJWM=";
        };
        meta = {
          license = lib.licenses.mit;
        };
      ...
      ms-vscode.cmake-tools = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "ms-vscode";
          version = "1.21.3";
          hash = "sha256-9n7kAst7fjuC5Po0eZ2givfrDMXz1ctulQfl973gLsg=";
        };
        meta.license = lib.licenses.mit;
      };
      ...
      prisma.prisma = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "Prisma";
          version = "6.4.1";
          hash = "sha256-cftmEKH+nfGaSyNuDq2XxPYXmXV5ygWQgVZiNQaIgm4=";
        };
        meta = {
      ...
      redhat.ansible = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "redhat";
          version = "25.2.0";
          hash = "sha256-jgb12UJ+YtBKgdYWtZDq9KXWpsSq6NzMOIMNPGXwDe0=";
        };
        meta = {
      ...
      scalameta.metals = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "scalameta";
          version = "1.47.7";
          hash = "sha256-K1Er+0phNlWJhoQ1RtWt0/i2GzXcCdSFCy/JcgEukrQ=";
        };
        meta = {
          license = lib.licenses.asl20;
        };
      ...
      tabnine.tabnine-vscode = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          publisher = "tabnine";
          version = "3.241.0";
          hash = "sha256-pBnvSG3jgKHrmxi4R5UwyDZaLKTLPn4ZZcakHBy2oxM=";
        };
        meta = {
          license = lib.licenses.mit;
        };
