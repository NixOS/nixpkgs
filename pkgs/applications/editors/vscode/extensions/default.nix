...
let
  ...
  baseExtensions =
    ...
    lib.mapAttrs (_n: lib.recurseIntoAttrs) {
      ...
      danielatanasov.todo = buildVscodeMarketplaceExtension {
        mktplcRef = {
          name = "todo";
      ...
      prateekmahendrakar.prettyxml = vscode-utils.buildVscodeMarketplaceExtension {
        mktplcRef = {
          name = "prettyxml";
      ...
      zhiyuan-lin.simple-perl = vscode-utils.buildVscodeMarketplaceExtension {
        mktplcRef = {
          name = "simple-perl";
