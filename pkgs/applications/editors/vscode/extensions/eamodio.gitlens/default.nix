...
let
  vsix = stdenvNoCC.mkDerivation (finalAttrs: {
    ...
    postPatch = ''
      substituteInPlace scripts/generateLicenses.mjs --replace-fail 'https://raw.github.com/microsoft/vscode/main/LICENSE.txt' '${pkgs.vscode-json-languageserver.src}/LICENSE.txt'
    '';
