...
let
  ...
  supported = {
    x86_64-linux = {
      hash = "sha256-x0fzeqy24ELVMkSP4aYQHh1A3ybItZOg1qcrkxY0jUs=";
      arch = "linux-x64";
    };
    aarch64-linux = {
      hash = "sha256-fFky2dPcj504NVU0i7vX7rbXc2NY5NX0BDoJDkWPhGg=";
      arch = "linux-arm64";
    };
    aarch64-darwin = {
      hash = "sha256-T9KprjjB9gZUeJ/7d0CtVxzJV0fecyCCySAg+WegQr0=";
      arch = "darwin-arm64";
    };
  };
