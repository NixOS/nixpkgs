...
let
  ...
  supported = {
    x86_64-linux = {
      hash = "sha256-hvIF+mGJgqre4WOOh8vJI9tHjLm7BrogmEdVytdnQYQ=";
      arch = "linux-x64";
    };
    aarch64-linux = {
      hash = "sha256-dFOlUehCiw8lZzOx7eN6/e53IUcHhmrzwzVnsQeDBq0=";
      arch = "linux-arm64";
    };
    aarch64-darwin = {
      hash = "sha256-dotOosbJu/bofuWTHy8AcQbWzijDFStVFIS7a3PN7c4=";
      arch = "darwin-arm64";
    };
  };
