...
let
  ...
  supported = {
    x86_64-linux = {
      hash = "sha256-X/GDf4vvhprjidTSlDoDErszyaIY2SMctaYaZXbfXQ0=";
      arch = "linux-x64";
    };
    aarch64-linux = {
      hash = "sha256-/OElryysyt6Xy4ohctpaThh16euRjIzbrvCJ6QfLvKg=";
      arch = "linux-arm64";
    };
    aarch64-darwin = {
      hash = "sha256-e5HEGpcI5UwtedYYUp3mYIgdO80bHjYVVYAocSg0iXE=";
      arch = "darwin-arm64";
    };
  };
