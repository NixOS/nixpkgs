...
rec {
  ...
  cdt = buildEclipseUpdateSite rec {
    ...
    src = fetchzip {
      stripRoot = false;
      url =
        "https://www.eclipse.org/downloads/download.php?r=1&nf=1&file=/tools/cdt/releases/${
  ...
  freemarker = buildEclipseUpdateSite rec {
    ...
    meta = with lib; {
      ...
      description =
        "Plugin that provides an editor for Apache FreeMarker files";
    };
  };
  ...
  ivyde = buildEclipsePlugin rec {
    ...
    meta = with lib; {
      ...
      description =
        "A plugin which integrates Apache Ivy's dependency management";
      license = licenses.asl20;
      platforms = platforms.all;
  ...
  ivy = buildEclipsePlugin rec {
    ...
    meta = with lib; {
      ...
      description =
        "A popular dependency manager focusing on flexibility and simplicity";
      license = licenses.asl20;
      platforms = platforms.all;
      maintainers = [ maintainers.r3dl3g ];
    };
