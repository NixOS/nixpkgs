...
let
  ...
  betaVersion = {
    version = "4.1.0.15"; # Android Studio 4.1.0.15 Beta 5
    build = "201.6692364"; # Beta build number
    sha256Hash = "16gn3yz6fld717slzhdpz49hpl4vi4bk0yda6z5gbnig1a6lh81q"; # Beta SHA
  };
