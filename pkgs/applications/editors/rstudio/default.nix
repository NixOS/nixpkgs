{ stdenv, fetchurl, cmake, boost155, zlib, libssl, R, qt4, libuuid, hunspellDicts, unzip, ant, jdk }:
...
stdenv.mkDerivation {
  ...
  buildInputs = [ cmake boost155 zlib libssl R qt4 libuuid unzip ant jdk ];
