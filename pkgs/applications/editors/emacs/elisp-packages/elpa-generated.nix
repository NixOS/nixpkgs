{ callPackage }: {
  ...
  ada-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, uniquify-files, wisi }:
      elpaBuild {
        pname = "ada-mode";
        ename = "ada-mode";
        version = "7.1.8";
  ...
  eglot = callPackage ({ eldoc, elpaBuild, emacs, fetchurl, flymake ? null
    , jsonrpc, lib, project, xref }:
    elpaBuild {
      pname = "eglot";
      ename = "eglot";
      version = "1.7";
  ...
  gnu-elpa-keyring-update = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/packages/gnu-elpa-keyring-update-2019.3.tar";
  ...
  modus-operandi-theme = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, modus-themes }:
      elpaBuild {
  ...
  verilog-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/packages/verilog-mode-2021.10.14.127365406.tar";
  ...
  wisitoken-grammar-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, mmm-mode, wisi }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/packages/wisitoken-grammar-mode-1.2.0.tar";
