{ callPackage }:
  {
    ...
    vertico-posframe = callPackage ({ elpaBuild
      ...
      elpaBuild {
        ...
        version = "0.6.0";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/vertico-posframe-0.6.0.tar";
          sha256 = "1cwi26jz9dn8la6zxxai2pfkcpz8lwf4cd8hr44lak6x0ca9bwr3";
        };
    ...
    xref = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        version = "1.6.1";
        src = fetchurl {
          url = "https://elpa.gnu.org/packages/xref-1.6.1.tar";
          sha256 = "0z9kpbnrdh9y9qlj2fa64v660biakvw6x3z9klqa47qcx8gbyqp6";
        };
        packageRequires = [ emacs ];
        meta = {
