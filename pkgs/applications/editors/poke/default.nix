{ lib, stdenv, fetchurl, gettext, help2man, pkg-config, texinfo, makeWrapper
, boehmgc, readline, guiSupport ? false, tcl, tcllib, tk, miSupport ? true
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ gettext help2man pkg-config texinfo ]
  ...
  configureFlags = [ "--datadir=${placeholder "lib"}/share" ]
