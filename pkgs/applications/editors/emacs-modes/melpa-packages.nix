...
let
  dontConfigure = pkg:
    ...
    then pkg.override
      (args: {
        melpaBuild = drv: args.melpaBuild
          (drv // {
            dontConfigure = true;
          }
          );
  ...
  fix-rtags = pkg:
    if pkg != null
    then dontConfigure (externalSrc pkg external.rtags)
    else null;
      ...
      let
        ...
        overrides = rec {
          shared = rec {
            ...
            evil-magit = super.evil-magit.overrideAttrs
              (attrs: {
            ...
            gnuplot = super.gnuplot.overrideAttrs
              (old: {
                nativeBuildInputs =
            ...
            hindent = (externalSrc super.hindent external.hindent).overrideAttrs
              (attrs: {
            ...
            magit-annex = super.magit-annex.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
            ...
            magit-todos = super.magit-todos.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
            ...
            magit-filenotify = super.magit-filenotify.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
            ...
            magit-gitflow = super.magit-gitflow.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
            ...
            magithub = super.magithub.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
            ...
            magit-svn = super.magit-svn.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
          ...
          unstable = shared // {
            ...
            forge = super.forge.overrideAttrs
              (attrs: {
                # searches for Git at build time
                nativeBuildInputs =
                  (attrs.nativeBuildInputs or [ ]) ++ [ external.git ];
