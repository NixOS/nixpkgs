{ lib, stdenv, fetchurl, cmake, flex, bison, openssl, libpcap, zlib, file, curl
, libmaxminddb, gperftools, python3, swig, gettext, coreutils, ncurses, caf }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ openssl libpcap zlib curl libmaxminddb gperftools python3 swig ncurses ]
  ...
  cmakeFlags = [
    ...
    "-DZEEK_PYTHON_DIR=${
      placeholder "py"
    }/lib/${python3.libPrefix}/site-packages"
