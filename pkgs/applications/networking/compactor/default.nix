...
, libctemplate, libmaxminddb, libpcap, libtins, libtool, xz, openssl, pkg-config
, lib, stdenv, tcpdump, wireshark-cli }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ autoconf automake libtool pkg-config cbor-diag cddl wireshark-cli ];
  buildInputs = [ boost libpcap openssl libtins xz libctemplate libmaxminddb ];
