{ lib, stdenv, fetchurl, pkg-config, libxslt, telepathy-glib, python2, libxml2
, dbus-glib, dbus, sqlite, libsoup, libnice, gnutls }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ libxml2 dbus-glib sqlite libsoup libnice telepathy-glib gnutls python2 ];
