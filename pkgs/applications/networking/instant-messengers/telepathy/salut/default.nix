{ lib, stdenv, fetchurl, libxslt, glib, libxml2, telepathy-glib, python2, avahi
, libsoup, libuuid, openssl, pcre, sqlite, pkg-config }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://telepathy.freedesktop.org/releases/telepathy-salut/telepathy-salut-${version}.tar.gz";
