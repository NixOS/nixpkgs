{ lib, stdenv, fetchFromGitHub, fetchpatch, libsodium, ncurses, curl, libtoxcore
, openal, libvpx, freealut, libconfig, pkg-config, libopus, qrencode, gdk-pixbuf
, libnotify }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/JFreegman/toxic/commit/41e93adbdbd56db065166af5a6676a7996e9e451.patch";
