...
Linphone is a SIP softphone application developed by Belledone Communications.
...
2. Update all libraries derived from the `linphone-sdk` monorepo, by updating the monorepo version and hash in
   `./default.nix`
