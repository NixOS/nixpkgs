...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitLab {
    ...
    repo = "jami-client-qt";
    rev = "stable/${version}";
    hash = "sha256-3e197jXb4xkEoIarLECRSagCxgGumWLLvcbx7rQJpWs=";
  ...
  dhtnet = stdenv.mkDerivation {
    ...
    src = fetchFromGitLab {
      ...
      owner = "savoirfairelinux";
      repo = "dhtnet";
      rev = "cee36262f24ed0e26cd0de06aff5b6caa8dd9c39";
      hash = "sha256-9kMoH2+CZXKUxQUmoYsheTLV0UK9JO4D93pxk8o3KEs=";
    };
