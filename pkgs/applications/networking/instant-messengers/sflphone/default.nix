{ stdenv, fetchurl, libyaml, alsaLib, libssl, libuuid, pkgconfig, libpulseaudio, libsamplerate
...
rec {
  daemon = stdenv.mkDerivation {
    ...
    buildInputs = [ libyaml alsaLib libssl libuuid pkgconfig libpulseaudio libsamplerate
      commoncpp2 ccrtp libzrtpcpp dbus dbus_cplusplus expat pcre gsm speex ilbc libopus
      autoconf automake libtool gettext perl ];
  };
