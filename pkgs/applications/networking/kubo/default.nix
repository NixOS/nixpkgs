...
buildGoModule rec {
  pname = "kubo";
  version = "0.18.0"; # When updating, also check if the repo version changed and adjust repoVersion below
  rev = "v${version}";
  ...
  src = fetchurl {
    ...
    hash = "sha256-qjzecHNTdzMoB3RM72JIY0w7/h+was53T+J5SE5SpTs=";
  };
