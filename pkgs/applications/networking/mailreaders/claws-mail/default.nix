{ stdenv, fetchgit, wrapGAppsHook, autoreconfHook, bison, flex
, curl, gtk2, gtk3, pkgconfig, python2, python3, shared-mime-info
...
let
  ...
  # The corresponding commit in the gtk3 branch. There is no git tag.
  gtk3src = {
    rev = "991a58f03b5f1ae092c0594a80f3e13cc3a3bbfa";
    sha256 = "0nzzln4l6hcd58lgr294vnay59pxfybyfw2kjx18xysa2pi5bw2r";
  };
...
in stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ autoreconfHook pkgconfig bison flex wrapGAppsHook ];
