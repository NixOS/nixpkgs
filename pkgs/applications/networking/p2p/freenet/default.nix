{ lib, fetchurl, fetchFromGitHub, jdk, jre, gradle, bash, coreutils
, substituteAll, nixosTests, fetchpatch }:
...
in gradle.buildPackage rec {
  ...
  gradleOpts.flags = [ "-Dorg.gradle.java.home=${jdk}" ];
  gradleOpts.buildSubcommand = "jar";
  gradleOpts.depsHash = "sha256-v4YnXfbeiALjaVmGrfDddDh62+HotMRLubACJkQrYQI=";
