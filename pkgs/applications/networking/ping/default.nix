...
, pkg-config, pantheon, python3, glib, gtk3, gtksourceview, json-glib, libsoup
, libgee, wrapGAppsHook, vala_0_40 }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ meson ninja vala_0_40 pkg-config python3 wrapGAppsHook ];

  buildInputs =
    [ glib gtk3 gtksourceview json-glib libgee libsoup pantheon.granite ];
