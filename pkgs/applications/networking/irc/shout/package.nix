...

{
  ...
  by-version."ansi-styles"."2.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ansi-styles/-/ansi-styles-2.1.0.tgz";
  ...
  by-version."bl"."1.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/bl/-/bl-1.0.0.tgz";
      name = "bl-1.0.0.tgz";
  ...
  by-version."boom"."2.8.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/boom/-/boom-2.8.0.tgz";
      name = "boom-2.8.0.tgz";
  ...
  by-version."camelcase"."1.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/camelcase/-/camelcase-1.1.0.tgz";
  ...
  by-version."event-stream"."3.3.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/event-stream/-/event-stream-3.3.1.tgz";
  ...
  by-version."express"."4.13.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/express/-/express-4.13.1.tgz";
  ...
  by-version."form-data"."1.0.0-rc2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/form-data/-/form-data-1.0.0-rc2.tgz";
  ...
  by-version."grunt-contrib-uglify"."0.5.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/grunt-contrib-uglify/-/grunt-contrib-uglify-0.5.1.tgz";
  ...
  by-version."grunt-legacy-log"."0.1.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/grunt-legacy-log/-/grunt-legacy-log-0.1.2.tgz";
  ...
  by-version."gzip-size"."0.2.0" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/gzip-size/-/gzip-size-0.2.0.tgz";
  ...
  by-version."hawk"."3.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/hawk/-/hawk-3.1.0.tgz";
      name = "hawk-3.1.0.tgz";
  ...
  by-version."ipaddr.js"."1.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ipaddr.js/-/ipaddr.js-1.0.1.tgz";
  ...
  by-version."jsonpointer"."1.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/jsonpointer/-/jsonpointer-1.1.0.tgz";
  ...
  by-version."maxmin"."0.2.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/maxmin/-/maxmin-0.2.2.tgz";
  ...
  by-version."mime-db"."1.15.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-db/-/mime-db-1.15.0.tgz";
  ...
  by-version."mime-types"."2.1.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-types/-/mime-types-2.1.3.tgz";
  ...
  by-version."mocha"."2.0.1" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/mocha/-/mocha-2.0.1.tgz";
  ...
  by-version."oauth-sign"."0.8.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/oauth-sign/-/oauth-sign-0.8.0.tgz";
  ...
  by-version."process-nextick-args"."1.0.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/process-nextick-args/-/process-nextick-args-1.0.2.tgz";
  ...
  by-version."proxy-addr"."1.0.8" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/proxy-addr/-/proxy-addr-1.0.8.tgz";
  ...
  by-version."readable-stream"."2.0.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/readable-stream/-/readable-stream-2.0.2.tgz";
  ...
  by-version."serve-static"."1.10.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/serve-static/-/serve-static-1.10.0.tgz";
  ...
  by-version."strip-ansi"."3.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/strip-ansi/-/strip-ansi-3.0.0.tgz";
  ...
  by-version."tough-cookie"."2.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/tough-cookie/-/tough-cookie-2.0.0.tgz";
  ...
  by-version."tunnel-agent"."0.4.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/tunnel-agent/-/tunnel-agent-0.4.1.tgz";
  ...
  by-version."type-is"."1.6.5" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/type-is/-/type-is-1.6.5.tgz";
  ...
  by-version."util-deprecate"."1.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/util-deprecate/-/util-deprecate-1.0.1.tgz";
