...
let
  sources = {
    ...
    "n8n-core-0.59.0" = {
      ...
      version = "0.59.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/n8n-core/-/n8n-core-0.59.0.tgz";
        sha512 = "fpAyG7bHHp1cdnVguLEu6AJ/UjKDzFH84PYxXnj9k18nDJoI0sMBRCXQCB5W2lNdnfp8Hq1fKpAuFrn2PARz9Q==";
      };
    };
    "n8n-editor-ui-0.72.0" = {
      ...
      version = "0.72.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/n8n-editor-ui/-/n8n-editor-ui-0.72.0.tgz";
        sha512 = "O3ZdlQtOvR9HXYwiXGpiD6rxIQL89gTwluOiTwY5G/9BoqrWnmt3U1mNjmVkKrA4CzSDlRYe7gyVfRri7E6n9w==";
      };
    };
    "n8n-nodes-base-0.98.1" = {
      name = "n8n-nodes-base";
      packageName = "n8n-nodes-base";
      version = "0.98.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/n8n-nodes-base/-/n8n-nodes-base-0.98.1.tgz";
        sha512 = "NmKjzGypIR63AjnYA9tI+2mNvJes1ONPRrAaE9r9EYLE91Zzw58GKNRUh1UcSR754y3ha//9TAtkL2j9MTXiKA==";
      };
    };
    "n8n-workflow-0.48.0" = {
      name = "n8n-workflow";
      ...
      version = "0.48.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/n8n-workflow/-/n8n-workflow-0.48.0.tgz";
        sha512 = "3L1PM30NR3tpUNhUGI+eNI8smNEmxo+V5Vy+twqwM2d9hLA08ur1lwIqEQRzPnEMwLUtFohKuT5zN2bi1CNg+w==";
      };
    };
...
in
{
  n8n = nodeEnv.buildNodePackage {
    ...
    version = "0.103.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/n8n/-/n8n-0.103.1.tgz";
      sha512 = "5iEVB2AyWp/fj9/0oxJY/x/A2SaJ5zpmn9KdAgTOjLerxPFzaDD2MBjr5wPt69GpuanEkA2htt2wNw3xwSGWgQ==";
    };
    dependencies = [
      ...
      sources."mz-2.7.0"
      sources."n8n-core-0.59.0"
      sources."n8n-editor-ui-0.72.0"
      (sources."n8n-nodes-base-0.98.1" // {
        dependencies = [
          sources."moment-2.28.0"
        ];
      })
      sources."n8n-workflow-0.48.0"
