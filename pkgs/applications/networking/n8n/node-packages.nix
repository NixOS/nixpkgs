...
let
  sources = {
    ...
    "snowflake-sdk-1.6.11" = {
      ...
      version = "1.6.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/snowflake-sdk/-/snowflake-sdk-1.6.11.tgz";
        sha512 = "w4oCXjNQ1peAJjhnrwihr+epYw1pSxbe5/+PdxexYb2rzowyOn0RA5PFbir90q/dx0jzM2gvPiHDjnSBEZ1/zA==";
      };
    };
    "source-map-0.6.1" = {
      name = "source-map";
