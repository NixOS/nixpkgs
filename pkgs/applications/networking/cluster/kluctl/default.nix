{ lib, buildGoModule, fetchFromGitHub, testers, makeWrapper, python3, kluctl }:
...
buildGoModule rec {
  ...
  postInstall = ''
    ...
    wrapProgram $out/bin/kluctl --set KLUCTL_USE_SYSTEM_PYTHON 1 --prefix PATH : '${lib.makeBinPath buildInputs}'
  '';
