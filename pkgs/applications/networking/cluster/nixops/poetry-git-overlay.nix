...
self: super: {
  ...
  nixops-digitalocean = super.nixops-digitalocean.overridePythonAttrs (_: {
    src = pkgs.fetchgit {
  ...
  nixops-hercules-ci = super.nixops-hercules-ci.overridePythonAttrs (_: {
    src = pkgs.fetchgit {
  ...
  nixops-hetzner = super.nixops-hetzner.overridePythonAttrs (_: {
    src = pkgs.fetchgit {
  ...
  nixops-virtd = super.nixops-virtd.overridePythonAttrs (_: {
    src = pkgs.fetchgit {
  ...
  nixopsvbox = super.nixopsvbox.overridePythonAttrs (_: {
    src = pkgs.fetchgit {
