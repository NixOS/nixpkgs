  ...
  widevineCdm = stdenv.mkDerivation {
    ...
    unpackCmd = let
      widevineCdmPath =
        ...
        then "./opt/google/chrome/WidevineCdm"
        else if channel == "beta"
        then "./opt/google/chrome-beta/WidevineCdm"
        else if channel == "dev"
        then "./opt/google/chrome-unstable/WidevineCdm"
...
in
  stdenv.mkDerivation {
    name =
      lib.optionalString ungoogled "ungoogled-"
