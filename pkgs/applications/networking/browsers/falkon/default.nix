...
, extra-cmake-modules, pkg-config, qmake, libpthreadstubs, libxcb, libXdmcp
, qtsvg, qttools, qtwebengine, qtx11extras, qtwayland, wrapQtAppsHook, kwallet
}:
...
mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/KDE/falkon/commit/bbde5c6955c43bc744ed2c4024598495de908f2a.diff";
  ...
  nativeBuildInputs =
    [ cmake extra-cmake-modules pkg-config qmake qttools wrapQtAppsHook ];
