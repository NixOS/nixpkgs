...

{
  ...
  firefox-beta = buildMozillaMach rec {
    ...
    src = fetchurl {
      url = "mirror://mozilla/firefox/releases/${version}/source/firefox-${version}.source.tar.xz";
      sha512 = "3a0efb840502763e022d87dd13c2affd751dd50dfce8999ba12ac039b1c1558f87829dcb676995595ac089d58f8503dd2e9eb93ff6ec2484cf1e2070ad4a3a42";
    };
  ...
  firefox-devedition = buildMozillaMach rec {
    ...
    src = fetchurl {
      ...
      sha512 = "afa34a69609bbe0a70f795265c843723637c36fc9010a553224c3bd322eeda9151cbe1350451fb20e47447f1ff7aa66b181b991083610956ff0e5f8fe1e6a35b";
    };
