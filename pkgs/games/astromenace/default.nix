{ fetchurl, lib, stdenv, cmake, xlibsWrapper, libGLU, libGL, SDL, openal
, freealut, libogg, libvorbis, runtimeShell }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs =
    [ xlibsWrapper libGLU libGL SDL openal freealut libogg libvorbis ];
