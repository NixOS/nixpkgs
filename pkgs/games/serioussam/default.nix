...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = with lib; {
    ...
    longDescription = ''
      ...
      For serioussam:
      - https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/${finalAttrs.src.rev}/SamTFE/ModEXT.txt
      - https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/${finalAttrs.src.rev}/SamTFE/SE1_10b.gro
      For serioussamse:
      - https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/${finalAttrs.src.rev}/SamTSE/ModEXT.txt
      - https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/${finalAttrs.src.rev}/SamTSE/SE1_10b.gro
    '';
