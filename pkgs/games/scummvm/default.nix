{ lib, stdenv, fetchurl, nasm, alsa-lib, curl, flac, fluidsynth, freetype
, libjpeg, libmad, libmpeg2, libogg, libvorbis, libGLU, libGL, SDL2, zlib, Cocoa
, AudioToolbox, Carbon, CoreMIDI, AudioUnit, cctools }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://scummvm.org/frs/scummvm/${version}/${pname}-${version}.tar.xz";
