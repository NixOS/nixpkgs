...
stdenv.mkDerivation rec {
  ...
  # https://www.moddb.com/downloads/start/170664
  # https://www.moddb.com/downloads/mirror/170664/135/883cb20b13815468b12019841be535a8/
  # https://web.archive.org/web/20250310093216/https://fmt3.dl.dbolical.com/dl/2018/11/06/q3a-hqq-v37.zip?st=0XzNnNvOYWrJAi_6AB3mKw==&e=1741602736
  ...
  quake3-live-sounds = fetchurl {
    url = "https://github.com/diegoulloao/ioquake3-mac-install/raw/master/extras/quake3-live-sounds.pk3";
  ...
  hd-weapons = fetchurl {
    # TODO consider to take only zzczhdwr1.pk3 from that mod, as that is what diego did
  ...
  zpack-weapons = fetchurl {
    url = "https://github.com/diegoulloao/ioquake3-mac-install/raw/master/extras/zpack-weapons.pk3";
