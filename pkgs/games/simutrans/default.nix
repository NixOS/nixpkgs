...
let
  ...
  pakSpec = lib.mapAttrs (pakName:
    ...
    })
    {
      ...
      pak64 = {
        srcPath = [ "123-0" "simupak64-123-0.zip" ];
        prefix = "/pak";
      ...
      pak128 = {
        srcPath = [ "pak128 2.8.2 for ST 123up" "simupak128-2.8.2-for123.zip" ];
        prefix = "/pak128";
      ...
      "pak128.german" = {
        ...
        srcPath = [ "PAK128.german_2.1_for_ST_123.0" "PAK128.german_2.1_for_ST_123.0.zip" ];
