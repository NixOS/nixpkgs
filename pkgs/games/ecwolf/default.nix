{ stdenv, lib, fetchurl, makeDesktopItem, copyDesktopItems, cmake, pkg-config
, zlib, bzip2, libjpeg, SDL, SDL_mixer, gtk2 }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://maniacsvault.net/ecwolf/files/ecwolf/1.x/${pname}-${version}-src.tar.xz";
