{ stdenv, lib, fetchurl, fetchzip, makeDesktopItem, imake, gccmakedep, libX11, libXext, installShellFiles }:
...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    install -Dm644 ${desktopItem}/share/applications/koules.desktop $out/share/applications/koules.desktop
    installManPage xkoules.6
    runHook postInstall
  '';

  nativeBuildInputs = [ imake gccmakedep installShellFiles ];
