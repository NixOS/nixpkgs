...
let
  ...
  srcs = {
    ...
    dfhack = fetchurl {
      url = "https://github.com/DFHack/dfhack/releases/download/0.40.24-r3/dfhack-0.40.24-r3-Linux-gcc-4.9.2.tar.bz2";
      sha256 = "e36984c06aa8c0865bcccba9869413709a5429b52f83dbf2771cfa5e6d3f2d36";
    };
...
stdenv.mkDerivation rec {
  ...
  '' + stdenv.lib.optionalString dfHackEnabled ''
    ...
    cp -r hack stonesense dfhack dfhack-run dfhack.init-example $out/share/df_linux
