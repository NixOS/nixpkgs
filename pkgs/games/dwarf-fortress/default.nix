...
let
  ...
  latestVersion = if stdenv.hostPlatform.isLinux then "51.05"
    ...
    (dfVersion: {
      ...
      value =
        let
          ...
          mkDfWrapper = { dwarf-fortress, dfhack, dwarf-therapist ? null, ... }@args: callPackage ./wrapper ({
            inherit (self) themes;
        ...
        in mkDfWrapper { inherit dwarf-fortress dfhack dwarf-therapist; };
    })
