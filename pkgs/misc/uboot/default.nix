...
}:
{
  ...
  ubootNanoPCT4 = buildUBoot (finalAttrs: {
    ...
    postBuild = ''
      ./tools/mkimage -n rk3399 -T rksd -d ${finalAttrs.rkbin}/rk33/rk3399_ddr_800MHz_v1.24.bin idbloader.img
      cat ${finalAttrs.rkbin}/rk33/rk3399_miniloader_v1.19.bin >> idbloader.img
    '';
  });
