...
in rec {
  ...
  metricbeat7 = beat "metricbeat" {
    ...
    passthru.tests = assert metricbeat7.drvPath
      == nixosTests.elk.ELK-7.elkPackages.metricbeat.drvPath; {
  ...
  journalbeat7 = beat "journalbeat" {
    ...
    postFixup = let libPath = lib.makeLibraryPath [ (lib.getLib systemd) ];
    in ''
