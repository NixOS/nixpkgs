{ lib, fetchFromGitHub, elk7Version, elk8Version, buildGoModule, libpcap, nixosTests, systemd, config }:

let beat = package: extraArgs: elkVersion: buildGoModule (lib.attrsets.recursiveUpdate (rec {
  pname = package;
  version = elkVersion;
...
in rec {
  auditbeat7 = auditbeat elk7Version;
  filebeat7 = filebeat elk7Version;
  heartbeat7 = heartbeat elk7Version;
  ...
  packetbeat7 = packetbeat elk7Version;

  auditbeat8 = auditbeat elk8Version;
  filebeat8 = filebeat elk8Version;
  heartbeat8 = heartbeat elk8Version;
  metricbeat8 = beat "metricbeat" {
    meta.description = "Lightweight shipper for metrics";
    passthru.tests =
      lib.optionalAttrs config.allowUnfree (
        assert metricbeat8.drvPath == nixosTests.elk.unfree.ELK-8.elkPackages.metricbeat.drvPath;
        {
          elk = nixosTests.elk.unfree.ELK-8;
        }
      );
  } elk8Version;
  packetbeat8 = packetbeat elk8Version;
}
