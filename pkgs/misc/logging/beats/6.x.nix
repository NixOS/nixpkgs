{ lib, fetchFromGitHub, fetchpatch, elk6Version, buildGoPackage, libpcap
, nixosTests, systemd }:
    ...
    buildGoPackage (rec {
      ...
      patches = [
        (fetchpatch {
          ...
          url =
            "https://github.com/elastic/beats/commit/5d796571de1aa2a299393d2045dacc2efac41a04.diff";
          sha256 =
            "sha256:0b79fljbi5xd3h8iiv1m38ad0zhmj09f187asc0m9rxlqrz2l9r2";
        })
      ];
...
in rec {
  ...
  metricbeat6 = beat "metricbeat" {
    ...
    passthru.tests = assert metricbeat6.drvPath
      == nixosTests.elk.ELK-6.elkPackages.metricbeat.drvPath; {
