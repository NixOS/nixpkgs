...
, libjpeg, libpng, perl, ijs, qpdf, dbus, avahi, makeWrapper, coreutils, gnused
, bc, gawk, gnugrep, which, ghostscript, mupdf, dejavu_fonts, liblouis }:

let binPath = lib.makeBinPath [ coreutils gnused bc gawk gnugrep which ];
