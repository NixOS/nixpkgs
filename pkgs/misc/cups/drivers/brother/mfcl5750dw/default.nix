...
stdenv.mkDerivation rec{
  ...
  src = fetchurl {
    url = "https://download.brother.com/welcome/dlf102614/mfcl5750dwcupswrapper-${version}.i386.deb";
    sha256 = "afe6d18e17d26348f3b8a4f9a003107984940c429a7dd193054303a21f5e65b5";
  };

  lpr_src = fetchurl {
    url = "https://download.brother.com/welcome/dlf102613/mfcl5750dwlpr-${version}.i386.deb";
  ...
  '' + lib.concatMapStrings
    ...
    ln -s \
      "$out/opt/brother/Printers/MFCL5750DW/lpd/${stdenv.hostPlatform.linuxArch}/"* \
  ...
  meta = with lib; {
    ...
    maintainers = [ maintainers.qdlmcfresh ];
  };
}
