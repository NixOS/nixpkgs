{ lib, vscode-utils, fetchurl, mono, writeScript, runtimeShell, jq, clang-tools
, gdbUseFixed ? true
...
in vscode-utils.buildVscodeMarketplaceExtension rec {
  ...
  vsix = fetchurl {
    ...
    url =
      "https://github.com/microsoft/vscode-cpptools/releases/download/${mktplcRef.version}/cpptools-linux.vsix";
