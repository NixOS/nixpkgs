...
let
  sources = {
    ...
    "rollup-2.3.2" = {
      ...
      version = "2.3.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/rollup/-/rollup-2.3.2.tgz";
        sha512 = "p66+fbfaUUOGE84sHXAOgfeaYQMslgAazoQMp//nlR519R61213EPFgrMZa48j31jNacJwexSAR1Q8V/BwGKBA==";
      };
    };
    "run-async-2.4.0" = {
      name = "run-async";
