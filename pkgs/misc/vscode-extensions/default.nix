...
, jdk, llvmPackages_8, nixpkgs-fmt, protobuf, jq, shellcheck, moreutils
, racket-minimal, clojure-lsp }:
    ...
    lib.mapAttrs (_n: lib.recurseIntoAttrs) {
      ...
      davidanson.vscode-markdownlint = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          version = "0.42.1";
          sha256 =
            "c8c0647e0dd786fe68becca6dc73eade5f4220a26ab9faff8dd813a14b25df51";
        };
        meta = with lib; { license = licenses.mit; };
      };
      ...
      faustinoaq.lex-flex-yacc-bison = buildVscodeMarketplaceExtension {
        mktplcRef = {
          ...
          version = "0.0.3";
          sha256 =
            "6254f52157dc796eae7bf135ac88c1c9cc19d884625331a1e634f9768722cc3d";
        };
        meta = with lib; {
          changelog =
            "https://marketplace.visualstudio.com/items/faustinoaq.lex-flex-yacc-bison/changelog";
      ...
      valentjn.vscode-ltex = vscode-utils.buildVscodeMarketplaceExtension rec {
        ...
        vsix = fetchurl {
          ...
          sha256 =
            "6db4846dee4e394f7bcfb7e29520d45d6bc1534482ba73cf40cd5edf3f6ec266";
        };
