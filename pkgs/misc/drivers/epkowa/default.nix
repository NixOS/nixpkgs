      ...
      gt1500 = stdenv.mkDerivation rec {
        ...
        src = fetchurl {
          urls = [
            ...
            "https://web.archive.org/web/https://download2.ebz.epson.net/iscan/plugin/gt-s650/rpm/x64/iscan-gt-1500-bundle-${version}.x64.rpm.tar.gz"
          ];
          sha256 = "0pvjzg09mkcmmpxh2yc8vqhdj9mwc0lb6i9x7510py8v3dn6rdfn";
        };
