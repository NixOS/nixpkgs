...
# nixpkgs functions
, buildGoModule, buildVimPluginFrom2Nix, fetchFromGitHub, fetchpatch, fetchurl
, substituteAll

# Language dependencies
, python, python3, rustPlatform

# Misc dependencies
, Cocoa, code-minimap, dasht, direnv, fzf, gnome, himalaya, khard, languagetool
, llvmPackages, meson, nim, nodePackages, skim, sqlite, statix, stylish-haskell
, tabnine, vim, which, xkb-switch, ycmd, nodejs
...
, curl, libgit2, libiconv, openssl, pkg-config

# vim-go dependencies
, asmfmt, delve, errcheck, gnused, go-motion, go-tools, gocode, gocode-gomod
, godef, gogetdoc, golangci-lint, golint, gomodifytags, gopls, gotags, gotools
, iferr, impl, reftools
...
self: super:
{
  ...
  forms = super.forms.overrideAttrs
    (old: { dependencies = with self; [ self.self ]; });
  ...
  gruvbox-nvim = super.gruvbox-nvim.overrideAttrs
  ...
  markdown-preview-nvim = super.markdown-preview-nvim.overrideAttrs (old:
    let
      ...
      nodeDep =
        nodePackages."markdown-preview-nvim-../../misc/vim-plugins/markdown-preview-nvim".overrideAttrs
  ...
  null-ls-nvim = super.null-ls-nvim.overrideAttrs
    (old: { dependencies = with self; [ plenary-nvim nvim-lspconfig ]; });
  ...
  nvim-treesitter = super.nvim-treesitter.overrideAttrs (old: {
    passthru.withPlugins = grammarFn:
      self.nvim-treesitter.overrideAttrs (_: {
        postPatch = let grammars = tree-sitter.withPlugins grammarFn;
        in ''
          rm -r parser
  ...
  skim-vim =
    super.skim-vim.overrideAttrs (old: { dependencies = with self; [ skim ]; });
  ...
  telescope-nvim = super.telescope-nvim.overrideAttrs
    (old: { dependencies = with self; [ plenary-nvim popup-nvim ]; });
