...
let
  sources = {
    ...
    "electron-to-chromium-1.3.394" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.3.394";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.394.tgz";
        sha512 = "AEbSKBF49P+GgEP34w0VdYWn9SiMHgWUJbOkPEE1WZMIpWXtvfT9N0sd4Lv4jjD6DeSFjRuzm6+btn/yCz6h2Q==";
      };
    };
...
in
{
  ...
  coc-git = nodeEnv.buildNodePackage {
    ...
    version = "1.7.8";
    src = fetchurl {
      url = "https://registry.npmjs.org/coc-git/-/coc-git-1.7.8.tgz";
      sha512 = "vk00kl59TziICkRmQB5fqfMwgsM8VbTKaaDf0aGutlrvRr+Jl4ClR3pWnivu6SmerMeNMN4y2u+IlAuQgroNfg==";
    };
    buildInputs = globalBuildInputs;
    meta = {
  ...
  coc-prettier = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.394"
