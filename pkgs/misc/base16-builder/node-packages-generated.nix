...
let
  sources = {
    ...
    "hepburn-1.2.1" = {
      ...
      version = "1.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/hepburn/-/hepburn-1.2.1.tgz";
        sha512 = "v/VUHmiHhNbjDBGxYkwDXzYvfOTIKFquAn0KrPtH1D3Zv539VBPEOGYoWpLnb/FBT9vAx9anQef3noJZ2fPIBw==";
      };
    };
