...
buildGoModule (finalAttrs: {
  ...
  postConfigure = ''
    ...
    # Does not check CC_FOR_BUILD or LD_FOR_BUILD:
    # https://github.com/golang/go/blob/b194f5d24a71e34f147c90e4351d80ac75be55de/src/cmd/cgo/gcc.go#L1724
    # ```
    ...
    CC=$CC_FOR_BUILD LD=$CC_FOR_BUILD GOARCH= CGO_ENABLED=0 go generate ./kinds/gen.go
    CC=$CC_FOR_BUILD LD=$LD_FOR_BUILD GOARCH= CGO_ENABLED=0 go generate ./public/app/plugins/gen.go
  '';
