...
stdenv.mkDerivation rec {
  ...
  meta = {
    ...
    knownVulnerabilities = [
      ...
      "The current release is over 3 years old. Please consider migrating to alternatives such as nginx. You can do so by removing your `services.nginx.package` option."
    ];
  };
}
