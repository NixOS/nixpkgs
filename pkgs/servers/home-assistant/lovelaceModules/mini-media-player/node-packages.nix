...
in
{
  "mini-media-player-git+https://github.com/kalkih/mini-media-player.git#v1.8.1" = nodeEnv.buildNodePackage {
    name = "mini-media-player";
    packageName = "mini-media-player";
    version = "v1.8.1";
    src = fetchgit {
      url = "https://github.com/kalkih/mini-media-player.git";
      rev = "4925a6b7ccbb3da528f4d9fc870abf78e7b3834b";
      sha256 = "d54123947f15f3b3ad07b80fc7416f9d66d974480f1c61ea59a0e8dfc159caf5";
    };
    dependencies = [
