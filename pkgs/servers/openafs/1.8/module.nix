...
in stdenv.mkDerivation {
  ...
  patches = [
    ...
    ((fetchpatch {
      url =
        "https://gerrit.openafs.org/changes/14830/revisions/20b8a37950b3718b85a4a3d21b23469a5176eb6a/patch";
    ...
    ((fetchpatch {
      url =
        "https://gerrit.openafs.org/changes/14831/revisions/6cfa9046229d90c0625687e3fddb7877f21fbcff/patch";
