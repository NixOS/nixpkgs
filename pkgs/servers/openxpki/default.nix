...
, extraDependencies1 ? false, extraDependencies2 ? false
, extraDependencies3 ? false }:
...
perlPackages.buildPerlPackage {
  ...
  propagatedBuildInputs = with perlPackages;
    ...
    extraDependencies1 [ # dependencies from parsing through core/server
      ClassAccessor
      PathTools
      DataDumper
      DateTime
      ...
      RTClientREST
      Storable
    ] ++ lib.optionals extraDependencies2 [ # dependencies taken from Debian
    ...
    extraDependencies3 [ # dependencies taken from https://metacpan.org/pod/release/ALECH/Bundle-OpenXPKI-0.06/lib/Bundle/OpenXPKI.pm
      AttributeParamsValidate
      BC
      CGI
      CPAN
      CacheCache
      ClassClassgenclassgen
      ClassContainer
