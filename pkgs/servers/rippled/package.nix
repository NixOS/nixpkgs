...

{
  ...
  by-version."ansi"."0.3.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ansi/-/ansi-0.3.0.tgz";
      name = "ansi-0.3.0.tgz";
  ...
  by-version."are-we-there-yet"."1.0.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/are-we-there-yet/-/are-we-there-yet-1.0.4.tgz";
  ...
  by-version."assert-diff"."0.0.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/assert-diff/-/assert-diff-0.0.4.tgz";
  ...
  by-version."assert-plus"."0.1.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/assert-plus/-/assert-plus-0.1.4.tgz";
  ...
  by-version."basic-auth"."1.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/basic-auth/-/basic-auth-1.0.1.tgz";
  ...
  by-version."bignumber.js"."2.0.7" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/bignumber.js/-/bignumber.js-2.0.7.tgz";
  ...
  by-version."bignumber.js"."1.4.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/bignumber.js/-/bignumber.js-1.4.1.tgz";
  ...
  by-version."bluebird"."2.9.25" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/bluebird/-/bluebird-2.9.25.tgz";
  ...
  by-version."boom"."2.7.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/boom/-/boom-2.7.1.tgz";
      name = "boom-2.7.1.tgz";
  ...
  by-version."coveralls"."2.11.2" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/coveralls/-/coveralls-2.11.2.tgz";
  ...
  by-version."delegates"."0.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/delegates/-/delegates-0.1.0.tgz";
  ...
  by-version."fstream"."1.0.6" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/fstream/-/fstream-1.0.6.tgz";
  ...
  by-version."fstream-ignore"."0.0.7" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/fstream-ignore/-/fstream-ignore-0.0.7.tgz";
  ...
  by-version."gauge"."1.2.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/gauge/-/gauge-1.2.0.tgz";
  ...
  by-version."generate-object-property"."1.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/generate-object-property/-/generate-object-property-1.1.1.tgz";
  ...
  by-version."generic-pool-redux"."0.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/generic-pool-redux/-/generic-pool-redux-0.1.0.tgz";
  ...
  by-version."har-validator"."1.7.0" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/har-validator/-/har-validator-1.7.0.tgz";
  ...
  by-version."has-unicode"."1.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/has-unicode/-/has-unicode-1.0.0.tgz";
  ...
  by-version."hoek"."2.13.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/hoek/-/hoek-2.13.0.tgz";
  ...
  by-version."jayschema-error-messages"."1.0.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/jayschema-error-messages/-/jayschema-error-messages-1.0.3.tgz";
  ...
  by-version."knex"."0.7.6" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/knex/-/knex-0.7.6.tgz";
      name = "knex-0.7.6.tgz";
  ...
  by-version."liftoff"."0.13.6" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/liftoff/-/liftoff-0.13.6.tgz";
  ...
  by-version."lodash._createpadding"."3.6.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash._createpadding/-/lodash._createpadding-3.6.0.tgz";
  ...
  by-version."lodash.pad"."3.1.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash.pad/-/lodash.pad-3.1.0.tgz";
  ...
  by-version."lodash.padleft"."3.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash.padleft/-/lodash.padleft-3.1.1.tgz";
  ...
  by-version."lodash.padright"."3.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash.padright/-/lodash.padright-3.1.1.tgz";
  ...
  by-version."lodash.repeat"."3.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/lodash.repeat/-/lodash.repeat-3.0.0.tgz";
  ...
  by-version."mime-db"."1.9.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-db/-/mime-db-1.9.1.tgz";
  ...
  by-version."mime-types"."2.0.11" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/mime-types/-/mime-types-2.0.11.tgz";
  ...
  by-version."minimatch"."2.0.7" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/minimatch/-/minimatch-2.0.7.tgz";
  ...
  by-version."mocha"."2.2.4" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/mocha/-/mocha-2.2.4.tgz";
  ...
  by-version."nan"."1.6.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/nan/-/nan-1.6.2.tgz";
      name = "nan-1.6.2.tgz";
  ...
  by-version."node-pre-gyp"."0.6.7" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/node-pre-gyp/-/node-pre-gyp-0.6.7.tgz";
  ...
  by-version."npmlog"."1.2.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/npmlog/-/npmlog-1.2.0.tgz";
  ...
  by-version."raw-body"."2.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/raw-body/-/raw-body-2.0.1.tgz";
  ...
  by-version."rc"."1.0.1" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/rc/-/rc-1.0.1.tgz";
      name = "rc-1.0.1.tgz";
  ...
  by-version."require-directory"."1.2.0" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/require-directory/-/require-directory-1.2.0.tgz";
  ...
  by-version."resolve"."1.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/resolve/-/resolve-1.0.0.tgz";
  ...
  by-version."rimraf"."2.3.3" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/rimraf/-/rimraf-2.3.3.tgz";
  ...
  by-version."ripple-lib"."0.12.4" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ripple-lib/-/ripple-lib-0.12.4.tgz";
  ...
  by-version."ripple-lib-transactionparser"."0.3.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ripple-lib-transactionparser/-/ripple-lib-transactionparser-0.3.2.tgz";
  ...
  by-version."ripple-wallet-generator"."1.0.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/ripple-wallet-generator/-/ripple-wallet-generator-1.0.3.tgz";
  ...
  by-version."semver"."4.3.4" = self.buildNodePackage {
    ...
    bin = true;
    src = fetchurl {
      url = "https://registry.npmjs.org/semver/-/semver-4.3.4.tgz";
  ...
  by-version."sinon-chai"."2.7.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/sinon-chai/-/sinon-chai-2.7.0.tgz";
  ...
  by-version."sqlite3"."3.0.8" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/sqlite3/-/sqlite3-3.0.8.tgz";
  ...
  by-version."supertest"."0.13.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/supertest/-/supertest-0.13.0.tgz";
  ...
  by-version."tar"."2.1.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/tar/-/tar-2.1.1.tgz";
      name = "tar-2.1.1.tgz";
  ...
  by-version."tar-pack"."2.0.0" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/tar-pack/-/tar-pack-2.0.0.tgz";
  ...
  by-version."type-is"."1.6.2" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/type-is/-/type-is-1.6.2.tgz";
  ...
  by-version."uid-number"."0.0.3" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/uid-number/-/uid-number-0.0.3.tgz";
  ...
  by-version."utf-8-validate"."1.0.1" = self.buildNodePackage {
    ...
    bin = false;
    src = fetchurl {
      url = "https://registry.npmjs.org/utf-8-validate/-/utf-8-validate-1.0.1.tgz";
