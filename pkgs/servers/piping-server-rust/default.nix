{ lib, rustPlatform, fetchFromGitHub, stdenv, CoreServices, Security, piping-server-rust, testVersion }:
...
rustPlatform.buildRustPackage rec {
  ...
  passthru.tests.version = testVersion { package = piping-server-rust; };
