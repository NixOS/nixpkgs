...
let
  ...
  hash = {
    x64-linux_hash = "sha256-TZ45x3XDuDMqC09Tbr02Plab0gzKdjMdREaez8wJch4=";
    arm64-linux_hash = "sha256-wu66N2EkkBeoJby7oGsfgg1x+0Bffiq2AC3U9tibpxA=";
    x64-osx_hash = "sha256-I0iaGrcWAHci9bEGNtY4OJwkp2QGg2II+Nky4Pn1yLY=";
  }."${arch}-${os}_hash";
