...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "mailpit";
    rev = "v${version}";
    hash = "sha256-4CzpT8G5IMyuBA5rjX51ZISgt/cSJeKFM/JvHF7L9CA=";
  };
  ...
  ui = stdenv.mkDerivation {
    ...
    npmDeps = fetchNpmDeps {
      inherit src;
      hash = "sha256-wPxRS8E2dbuL0XWOO1Lnq89+AmnXyMp1JNG9/xC3Iic=";
    };
...
buildGoModule {
  ...
  vendorHash = "sha256-dMpi1usAsayP+lJ9eQEcX3u+cqJUkpVdwhUPCUUEQiE=";
