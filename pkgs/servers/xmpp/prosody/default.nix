{ stdenv, fetchurl, lib, libidn, openssl, makeWrapper, fetchhg, lua, nixosTests
...
in stdenv.mkDerivation rec {
  ...
  # default setup.
  nixosModuleDeps =
    [ "bookmarks" "cloud_notify" "vcard_muc" "smacks" "http_upload" ];
  src = fetchurl {
  ...
  buildInputs = [ luaEnv libidn openssl ] ++ withExtraLibs;
