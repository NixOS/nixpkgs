  ...
  sources = {
    "@babel/cli-7.12.16" = {
      ...
      src = fetchurl {
        ...
        sha512 = "cKWkNCxbpjSuYLbdeJs4kOnyW1E2D65pu7SodXDOkzahIN/wSgT8geIqf6+pJTgCo47zrOMGcJTmjSFe5WKYwQ==";
      };
    };
    ...
    "@serialport/parser-inter-byte-timeout-9.0.1" = {
      ...
      version = "9.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@serialport/parser-inter-byte-timeout/-/parser-inter-byte-timeout-9.0.1.tgz";
        sha512 = "lFflcUflcP5SF4vLIixAKs1xUI/wfOzCv1Xq78VbPOBlIjZ6ny9lQ6g7cMPR/sB/M1BHwGcdX7CEr90pe3kkog==";
      };
    };
    ...
    "@types/prettier-2.2.1" = {
      ...
      version = "2.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/prettier/-/prettier-2.2.1.tgz";
    ...
    "eslint-plugin-jest-24.1.5" = {
      ...
      version = "24.1.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-jest/-/eslint-plugin-jest-24.1.5.tgz";
    ...
    "typedoc-0.20.24" = {
      ...
      version = "0.20.24";
      src = fetchurl {
        url = "https://registry.npmjs.org/typedoc/-/typedoc-0.20.24.tgz";
        sha512 = "TadOYtcw8agrk7WTZlXUcct4jLZZcGcYe3xbmARkI+rBpXI6Mw+0P8oUo13+9oFreQvK5zZgMem4YEi7lCXLIw==";
      };
    };
    ...
    "typedoc-plugin-markdown-3.4.5" = {
      ...
      version = "3.4.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/typedoc-plugin-markdown/-/typedoc-plugin-markdown-3.4.5.tgz";
        sha512 = "m24mSCGcEk6tQDCHIG4TM3AS2a7e9NtC/YdO0mefyF+z1/bKYnZ/oQswLZmm2zBngiLIoKX6eNdufdBpQNPtrA==";
      };
    };
    ...
    "zigbee-herdsman-0.13.71" = {
      ...
      version = "0.13.71";
      src = fetchurl {
        url = "https://registry.npmjs.org/zigbee-herdsman/-/zigbee-herdsman-0.13.71.tgz";
        sha512 = "fraLNLzA/eT9OERIJHyeGTT7ySJ91/WaCArPja/Or0t2HE2vDSgOaRoN9WhmWU2vd1nsoXGAwzrTMFnM02ECxA==";
      };
    };
    "zigbee-herdsman-converters-14.0.74-0" = {
      ...
      version = "14.0.74-0";
      src = fetchurl {
        url = "https://registry.npmjs.org/zigbee-herdsman-converters/-/zigbee-herdsman-converters-14.0.74-0.tgz";
        sha512 = "XSxe4MtJKwgzGqIRYnCfLyNJXa9/7j9F6/pAMfwRLXGq/fKTYRIaKK1N5w5rVQMPDGMIAu7MDuJX9k8o17murQ==";
      };
    };
    "zigbee2mqtt-frontend-0.3.76" = {
      ...
      version = "0.3.76";
      src = fetchurl {
        url = "https://registry.npmjs.org/zigbee2mqtt-frontend/-/zigbee2mqtt-frontend-0.3.76.tgz";
        sha512 = "UkNggvKDqw1Z+1tLRSPJdnOe3ioEu/vw0nppCqZJOxFgJoAJOBvmYal2ByMbeSnkq82FuDKzCCyWIVHP9gmL1Q==";
      };
    };
  };
  args = {
    ...
    dependencies = [
      ...
      (sources."zigbee-herdsman-0.13.71" // {
        dependencies = [
          sources."@babel/cli-7.12.16"
          ...
          sources."@serialport/parser-inter-byte-timeout-9.0.1"
          ...
          sources."typedoc-0.20.24"
          sources."typedoc-default-themes-0.12.7"
          sources."typedoc-plugin-markdown-3.4.5"
      ...
      (sources."zigbee-herdsman-converters-14.0.74-0" // {
        dependencies = [
          sources."@babel/code-frame-7.12.11"
          ...
          sources."eslint-plugin-jest-24.1.5"
          sources."eslint-scope-5.1.1"
          (sources."eslint-utils-2.1.0" // {
            dependencies = [
              sources."eslint-visitor-keys-1.3.0"
      ...
      sources."zigbee2mqtt-frontend-0.3.76"
    ];
