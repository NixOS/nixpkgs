...
, suggestSupport ? false, zeromq, libevent, msgpack, openssl, lz4Support ? false
, lz4, zlibSupport ? true, zlib }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = with lib;
    [ pkg-config mecab kytea libedit openssl ] ++ optional lz4Support lz4
