{ lib, stdenv, fetchurl, automake, autoconf, libtool, flex, bison, texinfo
, fetchpatch
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.nico.schottelius.org/software/gpm/archives/gpm-${version}.tar.bz2";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/telmich/gpm/commit/f04f24dd5ca5c1c13608b144ab66e2ccd47f106a.patch";
