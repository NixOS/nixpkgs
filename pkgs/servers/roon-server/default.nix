...
, icu66, krb5, lib, makeWrapper, stdenv, openssl }:
stdenv.mkDerivation rec {
  pname = "roon-server";
  version = "1.8-850";

  src =
    let urlVersion = builtins.replaceStrings [ "." "-" ] [ "00" "00" ] version;
    in fetchurl {
      url =
        "http://download.roonlabs.com/builds/RoonServer_linuxx64_${urlVersion}.tar.bz2";
      sha256 = "sha256-NSNaL0ERYTSYn9ETjWcQiuI4hY+w/lWVOz3n9lt6O+4=";
    };

  buildInputs = [ alsa-lib freetype krb5 stdenv.cc.cc.lib ];
