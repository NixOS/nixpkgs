...
aarch64-darwin = fetchzip {
  sha256 = "sha256-lsxxWOX1FPvDS2yo7w5TA0qyHULHjCEeqsXGJnstQJ4=";
  url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.5/AdGuardHome_darwin_arm64.zip";
};
i686-linux = fetchurl {
