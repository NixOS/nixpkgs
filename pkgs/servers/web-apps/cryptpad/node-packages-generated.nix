...
let
  sources = {
    "@mcrowe/minibloom-0.2.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/@mcrowe/minibloom/-/minibloom-0.2.0.tgz";
    ...
    "chainpad-crypto-0.2.6" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/chainpad-crypto/-/chainpad-crypto-0.2.6.tgz";
        sha512 =
          "yk7bBj22rs9PaX6LiqQxiw+Vj/afBStsNP1xP/B4Uh9a8iyJ7JrSZJ2Hj3d6fyqxJlBrMAX82Aj5PCZb5dzzHw==";
      };
    };
    "chainpad-server-5.1.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/chainpad-server/-/chainpad-server-5.1.0.tgz";
        sha512 =
          "BdjgOOLTXXo1EjQ7lURDe7oqsqfQISNvwhILfp3K3diY2K1hxpPLbjYzOSgxNOTADeOAff0xnInR5eUCESVWaQ==";
      };
    };
    ...
    "netflux-websocket-0.1.21" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/netflux-websocket/-/netflux-websocket-0.1.21.tgz";
        sha512 =
          "Zjl5lefg8urC0a0T7YCPGiUgRsISZBsTZl1STylmQz8Bq4ohcZ8cP3r6VoCpeVcvJ1Y/e3ZCXPxndWlNP9Jfug==";
      };
    };
    "nthen-0.1.8" = {
      name = "nthen";
    ...
    "tweetnacl-git+https://github.com/dchest/tweetnacl-js.git#v0.12.2" = {
      ...
      src = fetchgit {
        ...
        sha256 =
          "10f27b673944107995b3f6dcd65caecd705acdae9c37b7e79b810a8a72a40a31";
      };
    };
    "type-is-1.6.18" = {
      name = "type-is";
  ...
  "cryptpad-git+https://github.com/xwiki-labs/cryptpad.git#4.11.0" =
    nodeEnv.buildNodePackage {
      ...
      src = fetchgit {
        ...
        sha256 =
          "d75f0568fd146da6512646d9516138f94b0bbbd9a4691eef11d370bf5810176a";
      };
      dependencies = [
