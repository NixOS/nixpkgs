...
if __name__ == "__main__":
    # Create stable release pin
    #
    # For stable releases lemmy-server and lemmy-ui are released in tandem
    # meaning that we only have to extract the version of lemmy-server and
    # then re-use that for lemmy-ui too.
    version = get_latest_release(OWNER, SERVER_REPO)
