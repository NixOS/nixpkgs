...
let
  packages = {
    ...
    "laravel/framework" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "laravel-framework-675ea868fe36b18c8303e954aac540e6b1caa677";
        src = fetchurl {
          url = "https://api.github.com/repos/laravel/framework/zipball/675ea868fe36b18c8303e954aac540e6b1caa677";
          sha256 = "1yfvgmqfkkr5klsv5wg24glrjxg341m649nh8zgshpp75hjqz2g2";
        };
      };
    };
    ...
    "psy/psysh" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "psy-psysh-3dc5d4018dabd80bceb8fe1e3191ba8460569f0a";
        src = fetchurl {
          url = "https://api.github.com/repos/bobthecow/psysh/zipball/3dc5d4018dabd80bceb8fe1e3191ba8460569f0a";
          sha256 = "17yq3nqvc50f53clpy72cdjw9fkkbm2dhbiy5qiaxaw873ffw4ii";
        };
      };
    };
