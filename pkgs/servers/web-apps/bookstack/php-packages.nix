  ...
  packages = {
    "aws/aws-crt-php" = {
      ...
      src = composerEnv.buildZipPackage {
        name = "aws-aws-crt-php-f5c64ee7c5fce196e2519b3d9b7138649efe032d";
        src = fetchurl {
          url = "https://api.github.com/repos/awslabs/aws-crt-php/zipball/f5c64ee7c5fce196e2519b3d9b7138649efe032d";
          sha256 = "1nrkz23b696azkdhh78wr1dqgrnc8hnxcs8wbma16qjfbrggh23q";
        };
      };
    };
    "aws/aws-sdk-php" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "aws-aws-sdk-php-f45eefe4735d5a16ecc44cfd9a6c29421ae1e802";
        src = fetchurl {
          url = "https://api.github.com/repos/aws/aws-sdk-php/zipball/f45eefe4735d5a16ecc44cfd9a6c29421ae1e802";
          sha256 = "0yych7ixxsivy3a2kd568nlyjjjbzahx7jwirclcil9d8zhxl1g0";
        };
      };
    };
    "bacon/bacon-qr-code" = {
    ...
    "barryvdh/laravel-snappy" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "barryvdh-laravel-snappy-283d9c908e4d63b328edea0ed841bc492b3b73fa";
        src = fetchurl {
          url = "https://api.github.com/repos/barryvdh/laravel-snappy/zipball/283d9c908e4d63b328edea0ed841bc492b3b73fa";
          sha256 = "161z3qxi4xpiflw3pxsjxdspbv06kjfy65m4xxhzspynv7yszdcb";
        };
      };
    };
    "brick/math" = {
    ...
    "symfony/mailer" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "symfony-mailer-cd60799210c488f545ddde2444dc1aa548322872";
        src = fetchurl {
          url = "https://api.github.com/repos/symfony/mailer/zipball/cd60799210c488f545ddde2444dc1aa548322872";
          sha256 = "1vxgd19yv4lc5j099lyi813l59apzh1pjwn72fa0bv99laxvy5f7";
        };
      };
    };
    "symfony/mime" = {
