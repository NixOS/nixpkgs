{fetchNuGet}: [
  ...
  (fetchNuGet {
    pname = "Microsoft.CodeAnalysis.FxCopAnalyzers";
    version = "2.9.8";
  ...
  (fetchNuGet {
    pname = "Microsoft.CodeAnalysis.VersionCheckAnalyzer";
    version = "2.9.8";
    sha256 = "19v25694f9l172snrm4qik5gxzlifiyrmf0kk2zasz7hrciw36bl";
  })
  (fetchNuGet {
    pname = "Microsoft.CodeQuality.Analyzers";
    version = "2.9.8";
  ...
  (fetchNuGet {
    pname = "Microsoft.NetFramework.Analyzers";
    version = "2.9.8";
  ...
  (fetchNuGet {
    pname = "SQLitePCLRaw.provider.sqlite3.netstandard11";
    version = "1.1.14";
