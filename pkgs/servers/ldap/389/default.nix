...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url = "https://git.rockylinux.org/staging/rpms/389-ds-base/-/raw/r9/SOURCES/0004-CVE-2024-2199.patch";
      hash = "sha256-grANphTafCoa9NQy+FowwPhGQnvuCbfGnSpQ1Wp69Vg=";
    })
    (fetchpatch {
      name = "CVE-2024-3657.patch";
      url = "https://git.rockylinux.org/staging/rpms/389-ds-base/-/raw/r9/SOURCES/0005-CVE-2024-3657.patch";
