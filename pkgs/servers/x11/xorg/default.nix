...
lib.makeScope newScope (self: with self; {
  ...
  editres = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xproto, libXt }: stdenv.mkDerivation {
    name = "editres-1.0.7";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  fonttosfnt = callPackage ({ stdenv, pkgconfig, fetchurl, libfontenc, freetype, xproto }: stdenv.mkDerivation {
  ...
  ico = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xproto }: stdenv.mkDerivation {
    name = "ico-1.0.5";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  libXaw3d = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXext, libXmu, libXpm, xproto, libXt }: stdenv.mkDerivation {
    name = "libXaw3d-1.6.3";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  listres = callPackage ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, xproto, libXt }: stdenv.mkDerivation {
    name = "listres-1.0.4";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  transset = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xproto }: stdenv.mkDerivation {
    name = "transset-1.0.2";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  twm = callPackage ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libX11, libXext, libXmu, xproto, libXt }: stdenv.mkDerivation {
    ...
    builder = ./builder.sh;
    src = fetchurl {
      url = mirror://xorg/individual/driver/xf86-video-vboxvideo-1.0.0.tar.bz2mirror://xorg/individual/app/twm-1.0.10.tar.bz2;
  ...
  xconsole = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xproto, libXt }: stdenv.mkDerivation {
    name = "xconsole-1.0.7";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  xf86videoomap = callPackage ({ stdenv, pkgconfig, fetchurl, fontsproto, libdrm, randrproto, renderproto, videoproto, xextproto, xf86driproto, xorgserver, xproto }: stdenv.mkDerivation {
  ...
  xfs = callPackage ({ stdenv, pkgconfig, fetchurl, libXfont2, xproto, xtrans }: stdenv.mkDerivation {
    name = "xfs-1.2.0";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  xload = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xproto, libXt }: stdenv.mkDerivation {
    name = "xload-1.1.3";
    builder = ./builder.sh;
    src = fetchurl {
  ...
  xsetroot = callPackage ({ stdenv, pkgconfig, fetchurl, libX11, xbitmaps, libXcursor, libXmu, xproto }: stdenv.mkDerivation {
    name = "xsetroot-1.1.2";
    builder = ./builder.sh;
    src = fetchurl {
