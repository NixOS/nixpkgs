{ lib, stdenv, fetchurl, openssl, readline, ncurses, zlib
...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://www.softether-download.com/files/softether/v${version}-${build}-rtm-${compiledDate}-tree/Source_Code/softether-src-v${version}-${build}-rtm.tar.gz";
