...
// lib.optionalAttrs config.allowAliases {
  ...
  pg_libversion = throw "PostgreSQL extension `pg_embedding` has been renamed to `libversion` due to Upstream's recommendation (https://repology.org/project/pgsql%3Apg-libversion/report)"; # Added 2026-06-12
