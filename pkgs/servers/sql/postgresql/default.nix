let
  ...
  generic =
    ...
    , lz4, systemd, libossp_uuid, pkg-config, libxml2, tzdata
    ...
    in stdenv.mkDerivation rec {
      ...
      buildInputs = [ zlib readline openssl libxml2 ]
        ++ lib.optionals icuEnabled [ icu ] ++ lib.optionals lz4Enabled [ lz4 ]
      ...
      ] ++ lib.optional stdenv.isLinux (if atLeast "13" then
