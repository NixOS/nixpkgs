...
postgresqlBuildExtension (finalAttrs: {
  ...
  postPatch = ''
    ...
    substituteInPlace scripts/generate_extension_version.sh \
      ...
      --replace-fail 'GIT_SHA=" sha:unknown"'       'GIT_SHA=" sha:${builtins.substring 0 7 finalAttrs.src.rev}"'
  '';
  ...
  passthru.tests.extension = postgresqlTestExtension {
    ...
    asserts = [
      ...
      # }
      {
        ...
        expected = "'${lib.replaceStrings [ "-" ] [ "." ] (builtins.elemAt (lib.splitString "-unstable" finalAttrs.version) 0)}'";
