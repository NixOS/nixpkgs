...
in
  self: {
    ...
    mariadb_106 = self.callPackage generic {
      ...
      version = "10.6.17";
      hash = "sha256-+0GwcCBZwEaDLWAThzOstz5MDloaBoEGFwnSVZHksIY=";
      inherit (self.darwin) cctools;
      inherit (self.darwin.apple_sdk.frameworks) CoreServices;
    };
    mariadb_1011 = self.callPackage generic {
      ...
      version = "10.11.7";
      hash = "sha256-UjmiRe2QUX6WOWYFzQHM2Pc810QtGzB2tv/iWBEOUVc=";
      inherit (self.darwin) cctools;
      inherit (self.darwin.apple_sdk.frameworks) CoreServices;
    };
    mariadb_110 = self.callPackage generic {
      # Supported until 2024-06-07
      # TODO: remove ahead of 24.05 branch-off
      version = "11.0.5";
      hash = "sha256-lPs0psFhy7xDZQc/RelM4yqMLJdL45Xse1h+09eUkQs=";
      inherit (self.darwin) cctools;
      inherit (self.darwin.apple_sdk.frameworks) CoreServices;
    };
  }
