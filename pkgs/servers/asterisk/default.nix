...
let
  ...
  versions = lib.mapAttrs (
    ...
    let
      pjprojectSrc = fetchurl {
        url = "https://raw.githubusercontent.com/asterisk/third-party/master/pjproject/${pjproject.version}/pjproject-${pjproject.version}.tar.bz2";
        sha256 = pjproject.sha256;
      };
    in
    common {
      inherit version sha256;
      externals = {
        "externals_cache/${pjprojectSrc.name}" = pjprojectSrc;
        "addons/mp3" = mp3-204;
      };
    }
...
in
{
  # Supported releases (as of 2026-07-27).
