  ...
  packages = [
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_generator___generator_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/generator/-/generator-7.5.5.tgz";
        sha1 = "873a7f936a3c89491b43536d12245b626664e3cf";
      };
    }
    {
      name =
        "_babel_helper_annotate_as_pure___helper_annotate_as_pure_7.0.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_annotate_as_pure___helper_annotate_as_pure_7.0.0.tgz";
        url =
    ...
    {
      name =
        "_babel_helper_builder_binary_assignment_operator_visitor___helper_builder_binary_assignment_operator_visitor_7.1.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_builder_binary_assignment_operator_visitor___helper_builder_binary_assignment_operator_visitor_7.1.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_helper_call_delegate___helper_call_delegate_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-call-delegate/-/helper-call-delegate-7.4.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_helper_define_map___helper_define_map_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-define-map/-/helper-define-map-7.5.5.tgz";
        sha1 = "3dec32c2046f37e09b28c93eb0b103fd2a25d369";
      };
    }
    {
      name =
        "_babel_helper_explode_assignable_expression___helper_explode_assignable_expression_7.1.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_explode_assignable_expression___helper_explode_assignable_expression_7.1.0.tgz";
        url =
    ...
    {
      name =
        "_babel_helper_get_function_arity___helper_get_function_arity_7.0.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_get_function_arity___helper_get_function_arity_7.0.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "_babel_helper_hoist_variables___helper_hoist_variables_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-hoist-variables/-/helper-hoist-variables-7.4.4.tgz";
        sha1 = "0298b5f25c8c09c53102d52ac4a98f773eb2850a";
      };
    }
    {
      name =
        "_babel_helper_member_expression_to_functions___helper_member_expression_to_functions_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_helper_member_expression_to_functions___helper_member_expression_to_functions_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-member-expression-to-functions/-/helper-member-expression-to-functions-7.5.5.tgz";
    ...
    {
      name =
        "_babel_helper_module_transforms___helper_module_transforms_7.2.2.tgz";
      path = fetchurl {
        name =
          "_babel_helper_module_transforms___helper_module_transforms_7.2.2.tgz";
        url =
    ...
    {
      name =
        "_babel_helper_module_transforms___helper_module_transforms_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_helper_module_transforms___helper_module_transforms_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-module-transforms/-/helper-module-transforms-7.5.5.tgz";
        sha1 = "f84ff8a09038dcbca1fd4355661a500937165b4a";
      };
    }
    {
      name =
        "_babel_helper_optimise_call_expression___helper_optimise_call_expression_7.0.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_optimise_call_expression___helper_optimise_call_expression_7.0.0.tgz";
        url =
    ...
    {
      name =
        "_babel_helper_remap_async_to_generator___helper_remap_async_to_generator_7.1.0.tgz";
      path = fetchurl {
        name =
          "_babel_helper_remap_async_to_generator___helper_remap_async_to_generator_7.1.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_helper_replace_supers___helper_replace_supers_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/helper-replace-supers/-/helper-replace-supers-7.5.5.tgz";
    ...
    {
      name =
        "_babel_helper_split_export_declaration___helper_split_export_declaration_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_helper_split_export_declaration___helper_split_export_declaration_7.4.4.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_proposal_async_generator_functions___plugin_proposal_async_generator_functions_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_async_generator_functions___plugin_proposal_async_generator_functions_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_proposal_dynamic_import___plugin_proposal_dynamic_import_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_dynamic_import___plugin_proposal_dynamic_import_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-proposal-dynamic-import/-/plugin-proposal-dynamic-import-7.5.0.tgz";
        sha1 = "e532202db4838723691b10a67b8ce509e397c506";
      };
    }
    {
      name =
        "_babel_plugin_proposal_json_strings___plugin_proposal_json_strings_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_json_strings___plugin_proposal_json_strings_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_proposal_object_rest_spread___plugin_proposal_object_rest_spread_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_object_rest_spread___plugin_proposal_object_rest_spread_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-proposal-object-rest-spread/-/plugin-proposal-object-rest-spread-7.5.5.tgz";
        sha1 = "61939744f71ba76a3ae46b5eea18a54c16d22e58";
      };
    }
    {
      name =
        "_babel_plugin_proposal_optional_catch_binding___plugin_proposal_optional_catch_binding_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_optional_catch_binding___plugin_proposal_optional_catch_binding_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_proposal_unicode_property_regex___plugin_proposal_unicode_property_regex_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_proposal_unicode_property_regex___plugin_proposal_unicode_property_regex_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-proposal-unicode-property-regex/-/plugin-proposal-unicode-property-regex-7.4.4.tgz";
        sha1 = "501ffd9826c0b91da22690720722ac7cb1ca9c78";
      };
    }
    {
      name =
        "_babel_plugin_syntax_async_generators___plugin_syntax_async_generators_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_syntax_async_generators___plugin_syntax_async_generators_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_syntax_dynamic_import___plugin_syntax_dynamic_import_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_syntax_dynamic_import___plugin_syntax_dynamic_import_7.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-syntax-dynamic-import/-/plugin-syntax-dynamic-import-7.2.0.tgz";
        sha1 = "69c159ffaf4998122161ad8ebc5e6d1f55df8612";
      };
    }
    {
      name =
        "_babel_plugin_syntax_json_strings___plugin_syntax_json_strings_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_syntax_json_strings___plugin_syntax_json_strings_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_syntax_object_rest_spread___plugin_syntax_object_rest_spread_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_syntax_object_rest_spread___plugin_syntax_object_rest_spread_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_syntax_optional_catch_binding___plugin_syntax_optional_catch_binding_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_syntax_optional_catch_binding___plugin_syntax_optional_catch_binding_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_arrow_functions___plugin_transform_arrow_functions_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_arrow_functions___plugin_transform_arrow_functions_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_async_to_generator___plugin_transform_async_to_generator_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_async_to_generator___plugin_transform_async_to_generator_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-async-to-generator/-/plugin-transform-async-to-generator-7.5.0.tgz";
        sha1 = "89a3848a0166623b5bc481164b5936ab947e887e";
      };
    }
    {
      name =
        "_babel_plugin_transform_block_scoped_functions___plugin_transform_block_scoped_functions_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_block_scoped_functions___plugin_transform_block_scoped_functions_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_block_scoping___plugin_transform_block_scoping_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_block_scoping___plugin_transform_block_scoping_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-block-scoping/-/plugin-transform-block-scoping-7.5.5.tgz";
        sha1 = "a35f395e5402822f10d2119f6f8e045e3639a2ce";
      };
    }
    {
      name =
        "_babel_plugin_transform_classes___plugin_transform_classes_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_classes___plugin_transform_classes_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-classes/-/plugin-transform-classes-7.5.5.tgz";
        sha1 = "d094299d9bd680a14a2a0edae38305ad60fb4de9";
      };
    }
    {
      name =
        "_babel_plugin_transform_computed_properties___plugin_transform_computed_properties_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_computed_properties___plugin_transform_computed_properties_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_destructuring___plugin_transform_destructuring_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_destructuring___plugin_transform_destructuring_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-destructuring/-/plugin-transform-destructuring-7.5.0.tgz";
        sha1 = "f6c09fdfe3f94516ff074fe877db7bc9ef05855a";
      };
    }
    {
      name =
        "_babel_plugin_transform_dotall_regex___plugin_transform_dotall_regex_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_dotall_regex___plugin_transform_dotall_regex_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-dotall-regex/-/plugin-transform-dotall-regex-7.4.4.tgz";
        sha1 = "361a148bc951444312c69446d76ed1ea8e4450c3";
      };
    }
    {
      name =
        "_babel_plugin_transform_duplicate_keys___plugin_transform_duplicate_keys_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_duplicate_keys___plugin_transform_duplicate_keys_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-duplicate-keys/-/plugin-transform-duplicate-keys-7.5.0.tgz";
        sha1 = "c5dbf5106bf84cdf691222c0974c12b1df931853";
      };
    }
    {
      name =
        "_babel_plugin_transform_exponentiation_operator___plugin_transform_exponentiation_operator_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_exponentiation_operator___plugin_transform_exponentiation_operator_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_for_of___plugin_transform_for_of_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_for_of___plugin_transform_for_of_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-for-of/-/plugin-transform-for-of-7.4.4.tgz";
        sha1 = "0267fc735e24c808ba173866c6c4d1440fc3c556";
      };
    }
    {
      name =
        "_babel_plugin_transform_function_name___plugin_transform_function_name_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_function_name___plugin_transform_function_name_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-function-name/-/plugin-transform-function-name-7.4.4.tgz";
        sha1 = "e1436116abb0610c2259094848754ac5230922ad";
      };
    }
    {
      name =
        "_babel_plugin_transform_literals___plugin_transform_literals_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_literals___plugin_transform_literals_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_member_expression_literals___plugin_transform_member_expression_literals_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_member_expression_literals___plugin_transform_member_expression_literals_7.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-member-expression-literals/-/plugin-transform-member-expression-literals-7.2.0.tgz";
        sha1 = "fa10aa5c58a2cb6afcf2c9ffa8cb4d8b3d489a2d";
      };
    }
    {
      name =
        "_babel_plugin_transform_modules_amd___plugin_transform_modules_amd_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_modules_amd___plugin_transform_modules_amd_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-modules-amd/-/plugin-transform-modules-amd-7.5.0.tgz";
        sha1 = "ef00435d46da0a5961aa728a1d2ecff063e4fb91";
      };
    }
    {
      name =
        "_babel_plugin_transform_modules_commonjs___plugin_transform_modules_commonjs_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_modules_commonjs___plugin_transform_modules_commonjs_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-modules-commonjs/-/plugin-transform-modules-commonjs-7.5.0.tgz";
        sha1 = "425127e6045231360858eeaa47a71d75eded7a74";
      };
    }
    {
      name =
        "_babel_plugin_transform_modules_systemjs___plugin_transform_modules_systemjs_7.5.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_modules_systemjs___plugin_transform_modules_systemjs_7.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-modules-systemjs/-/plugin-transform-modules-systemjs-7.5.0.tgz";
        sha1 = "e75266a13ef94202db2a0620977756f51d52d249";
      };
    }
    {
      name =
        "_babel_plugin_transform_modules_umd___plugin_transform_modules_umd_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_modules_umd___plugin_transform_modules_umd_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_named_capturing_groups_regex___plugin_transform_named_capturing_groups_regex_7.4.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_named_capturing_groups_regex___plugin_transform_named_capturing_groups_regex_7.4.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-named-capturing-groups-regex/-/plugin-transform-named-capturing-groups-regex-7.4.5.tgz";
        sha1 = "9d269fd28a370258199b4294736813a60bbdd106";
      };
    }
    {
      name =
        "_babel_plugin_transform_new_target___plugin_transform_new_target_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_new_target___plugin_transform_new_target_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-new-target/-/plugin-transform-new-target-7.4.4.tgz";
        sha1 = "18d120438b0cc9ee95a47f2c72bc9768fbed60a5";
      };
    }
    {
      name =
        "_babel_plugin_transform_object_super___plugin_transform_object_super_7.5.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_object_super___plugin_transform_object_super_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-object-super/-/plugin-transform-object-super-7.5.5.tgz";
        sha1 = "c70021df834073c65eb613b8679cc4a381d1a9f9";
      };
    }
    {
      name =
        "_babel_plugin_transform_parameters___plugin_transform_parameters_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_parameters___plugin_transform_parameters_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-parameters/-/plugin-transform-parameters-7.4.4.tgz";
        sha1 = "7556cf03f318bd2719fe4c922d2d808be5571e16";
      };
    }
    {
      name =
        "_babel_plugin_transform_property_literals___plugin_transform_property_literals_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_property_literals___plugin_transform_property_literals_7.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-property-literals/-/plugin-transform-property-literals-7.2.0.tgz";
        sha1 = "03e33f653f5b25c4eb572c98b9485055b389e905";
      };
    }
    {
      name =
        "_babel_plugin_transform_regenerator___plugin_transform_regenerator_7.4.5.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_regenerator___plugin_transform_regenerator_7.4.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-regenerator/-/plugin-transform-regenerator-7.4.5.tgz";
        sha1 = "629dc82512c55cee01341fb27bdfcb210354680f";
      };
    }
    {
      name =
        "_babel_plugin_transform_reserved_words___plugin_transform_reserved_words_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_reserved_words___plugin_transform_reserved_words_7.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-reserved-words/-/plugin-transform-reserved-words-7.2.0.tgz";
        sha1 = "4792af87c998a49367597d07fedf02636d2e1634";
      };
    }
    {
      name =
        "_babel_plugin_transform_shorthand_properties___plugin_transform_shorthand_properties_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_shorthand_properties___plugin_transform_shorthand_properties_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_spread___plugin_transform_spread_7.2.2.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_spread___plugin_transform_spread_7.2.2.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_sticky_regex___plugin_transform_sticky_regex_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_sticky_regex___plugin_transform_sticky_regex_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_template_literals___plugin_transform_template_literals_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_template_literals___plugin_transform_template_literals_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-template-literals/-/plugin-transform-template-literals-7.4.4.tgz";
        sha1 = "9d28fea7bbce637fb7612a0750989d8321d4bcb0";
      };
    }
    {
      name =
        "_babel_plugin_transform_typeof_symbol___plugin_transform_typeof_symbol_7.2.0.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_typeof_symbol___plugin_transform_typeof_symbol_7.2.0.tgz";
        url =
    ...
    {
      name =
        "_babel_plugin_transform_unicode_regex___plugin_transform_unicode_regex_7.4.4.tgz";
      path = fetchurl {
        name =
          "_babel_plugin_transform_unicode_regex___plugin_transform_unicode_regex_7.4.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/plugin-transform-unicode-regex/-/plugin-transform-unicode-regex-7.4.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_preset_env___preset_env_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/preset-env/-/preset-env-7.5.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_runtime_corejs3___runtime_corejs3_7.10.2.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/runtime-corejs3/-/runtime-corejs3-7.10.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_runtime___runtime_7.10.2.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/runtime/-/runtime-7.10.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_runtime___runtime_7.10.4.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/runtime/-/runtime-7.10.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_babel_traverse___traverse_7.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@babel/traverse/-/traverse-7.5.5.tgz";
    ...
    {
      name =
        "_cypress_listr_verbose_renderer___listr_verbose_renderer_0.4.1.tgz";
      path = fetchurl {
        name =
          "_cypress_listr_verbose_renderer___listr_verbose_renderer_0.4.1.tgz";
        url =
          "https://registry.yarnpkg.com/@cypress/listr-verbose-renderer/-/listr-verbose-renderer-0.4.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_cypress_request___request_2.88.5.tgz";
        url =
          "https://registry.yarnpkg.com/@cypress/request/-/request-2.88.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_influxdata_clockface___clockface_2.3.4.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/clockface/-/clockface-2.3.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_influxdata_flux_lsp_browser___flux_lsp_browser_0.5.41.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/flux-lsp-browser/-/flux-lsp-browser-0.5.41.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_influxdata_giraffe___giraffe_0.29.0.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/giraffe/-/giraffe-0.29.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_influxdata_influx___influx_0.5.5.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/influx/-/influx-0.5.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_influxdata_influxdb_templates___influxdb_templates_0.9.0.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/influxdb-templates/-/influxdb-templates-0.9.0.tgz";
    ...
    {
      name =
        "_influxdata_react_custom_scrollbars___react_custom_scrollbars_4.3.8.tgz";
      path = fetchurl {
        name =
          "_influxdata_react_custom_scrollbars___react_custom_scrollbars_4.3.8.tgz";
        url =
          "https://registry.yarnpkg.com/@influxdata/react-custom-scrollbars/-/react-custom-scrollbars-4.3.8.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_environment___environment_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/environment/-/environment-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_fake_timers___fake_timers_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/fake-timers/-/fake-timers-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_reporters___reporters_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/reporters/-/reporters-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_source_map___source_map_24.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/source-map/-/source-map-24.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_test_result___test_result_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/test-result/-/test-result-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_test_sequencer___test_sequencer_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/test-sequencer/-/test-sequencer-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_jest_transform___transform_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/@jest/transform/-/transform-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_testing_library_dom___dom_7.11.0.tgz";
        url =
          "https://registry.yarnpkg.com/@testing-library/dom/-/dom-7.11.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_testing_library_react___react_10.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/@testing-library/react/-/react-10.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_babel__core___babel__core_7.1.2.tgz";
        url =
          "https://registry.yarnpkg.com/@types/babel__core/-/babel__core-7.1.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_babel__generator___babel__generator_7.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/@types/babel__generator/-/babel__generator-7.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_babel__template___babel__template_7.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/@types/babel__template/-/babel__template-7.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_babel__traverse___babel__traverse_7.0.7.tgz";
        url =
          "https://registry.yarnpkg.com/@types/babel__traverse/-/babel__traverse-7.0.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_cheerio___cheerio_0.22.9.tgz";
        url =
          "https://registry.yarnpkg.com/@types/cheerio/-/cheerio-0.22.9.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_chroma_js___chroma_js_1.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/@types/chroma-js/-/chroma-js-1.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_codemirror___codemirror_0.0.56.tgz";
        url =
          "https://registry.yarnpkg.com/@types/codemirror/-/codemirror-0.0.56.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_d3_color___d3_color_1.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/d3-color/-/d3-color-1.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_d3_scale___d3_scale_2.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/@types/d3-scale/-/d3-scale-2.0.2.tgz";
    ...
    {
      name =
        "_types_hoist_non_react_statics___hoist_non_react_statics_3.3.1.tgz";
      path = fetchurl {
        name =
          "_types_hoist_non_react_statics___hoist_non_react_statics_3.3.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/hoist-non-react-statics/-/hoist-non-react-statics-3.3.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_invariant___invariant_2.2.33.tgz";
        url =
          "https://registry.yarnpkg.com/@types/invariant/-/invariant-2.2.33.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_istanbul_lib_coverage___istanbul_lib_coverage_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/istanbul-lib-coverage/-/istanbul-lib-coverage-2.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_istanbul_lib_report___istanbul_lib_report_1.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/istanbul-lib-report/-/istanbul-lib-report-1.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_istanbul_reports___istanbul_reports_1.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/istanbul-reports/-/istanbul-reports-1.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_lodash___lodash_4.14.116.tgz";
        url =
          "https://registry.yarnpkg.com/@types/lodash/-/lodash-4.14.116.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_memoize_one___memoize_one_4.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/@types/memoize-one/-/memoize-one-4.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_papaparse___papaparse_4.5.9.tgz";
        url =
          "https://registry.yarnpkg.com/@types/papaparse/-/papaparse-4.5.9.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_prop_types___prop_types_15.5.6.tgz";
        url =
          "https://registry.yarnpkg.com/@types/prop-types/-/prop-types-15.5.6.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_datepicker___react_datepicker_2.8.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-datepicker/-/react-datepicker-2.8.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_dom___react_dom_16.8.2.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-dom/-/react-dom-16.8.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_grid_layout___react_grid_layout_0.16.5.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-grid-layout/-/react-grid-layout-0.16.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_redux___react_redux_7.1.9.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-redux/-/react-redux-7.1.9.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_router_dom___react_router_dom_5.1.5.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-router-dom/-/react-router-dom-5.1.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_router___react_router_5.1.8.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-router/-/react-router-5.1.8.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_react_virtualized___react_virtualized_9.18.7.tgz";
        url =
          "https://registry.yarnpkg.com/@types/react-virtualized/-/react-virtualized-9.18.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_shallowequal___shallowequal_1.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/shallowequal/-/shallowequal-1.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_sinonjs__fake_timers___sinonjs__fake_timers_6.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/sinonjs__fake-timers/-/sinonjs__fake-timers-6.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_stack_utils___stack_utils_1.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/@types/stack-utils/-/stack-utils-1.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_text_encoding___text_encoding_0.0.32.tgz";
        url =
          "https://registry.yarnpkg.com/@types/text-encoding/-/text-encoding-0.0.32.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_webpack___webpack_4.4.35.tgz";
        url =
          "https://registry.yarnpkg.com/@types/webpack/-/webpack-4.4.35.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_types_yargs_parser___yargs_parser_13.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/@types/yargs-parser/-/yargs-parser-13.1.0.tgz";
    ...
    {
      name =
        "_typescript_eslint_experimental_utils___experimental_utils_2.6.0.tgz";
      path = fetchurl {
        name =
          "_typescript_eslint_experimental_utils___experimental_utils_2.6.0.tgz";
        url =
    ...
    {
      name =
        "_typescript_eslint_typescript_estree___typescript_estree_2.6.0.tgz";
      path = fetchurl {
        name =
          "_typescript_eslint_typescript_estree___typescript_estree_2.6.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "_use_it_event_listener___event_listener_0.1.3.tgz";
        url =
          "https://registry.yarnpkg.com/@use-it/event-listener/-/event-listener-0.1.3.tgz";
    ...
    {
      name =
        "_webassemblyjs_floating_point_hex_parser___floating_point_hex_parser_1.8.5.tgz";
      path = fetchurl {
        name =
          "_webassemblyjs_floating_point_hex_parser___floating_point_hex_parser_1.8.5.tgz";
        url =
    ...
    {
      name =
        "_webassemblyjs_helper_module_context___helper_module_context_1.8.5.tgz";
      path = fetchurl {
        name =
          "_webassemblyjs_helper_module_context___helper_module_context_1.8.5.tgz";
        url =
    ...
    {
      name =
        "_webassemblyjs_helper_wasm_bytecode___helper_wasm_bytecode_1.8.5.tgz";
      path = fetchurl {
        name =
          "_webassemblyjs_helper_wasm_bytecode___helper_wasm_bytecode_1.8.5.tgz";
        url =
    ...
    {
      name =
        "_webassemblyjs_helper_wasm_section___helper_wasm_section_1.8.5.tgz";
      path = fetchurl {
        name =
          "_webassemblyjs_helper_wasm_section___helper_wasm_section_1.8.5.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "abortcontroller_polyfill___abortcontroller_polyfill_1.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/abortcontroller-polyfill/-/abortcontroller-polyfill-1.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "acorn_globals___acorn_globals_3.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/acorn-globals/-/acorn-globals-3.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "acorn_globals___acorn_globals_4.3.2.tgz";
        url =
          "https://registry.yarnpkg.com/acorn-globals/-/acorn-globals-4.3.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "add_px_to_style___add_px_to_style_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/add-px-to-style/-/add-px-to-style-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "ansi_escapes___ansi_escapes_4.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/ansi-escapes/-/ansi-escapes-4.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "array.prototype.flat___array.prototype.flat_1.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/array.prototype.flat/-/array.prototype.flat-1.2.1.tgz";
    ...
    {
      name =
        "babel_plugin_dynamic_import_node___babel_plugin_dynamic_import_node_2.3.0.tgz";
      path = fetchurl {
        name =
          "babel_plugin_dynamic_import_node___babel_plugin_dynamic_import_node_2.3.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "babel_plugin_jest_hoist___babel_plugin_jest_hoist_24.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/babel-plugin-jest-hoist/-/babel-plugin-jest-hoist-24.6.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "babel_preset_jest___babel_preset_jest_24.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/babel-preset-jest/-/babel-preset-jest-24.6.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "bignumber.js___bignumber.js_4.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/bignumber.js/-/bignumber.js-4.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "browser_process_hrtime___browser_process_hrtime_0.1.3.tgz";
        url =
          "https://registry.yarnpkg.com/browser-process-hrtime/-/browser-process-hrtime-0.1.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "browserslist___browserslist_4.3.7.tgz";
        url =
          "https://registry.yarnpkg.com/browserslist/-/browserslist-4.3.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "browserslist___browserslist_4.6.6.tgz";
        url =
          "https://registry.yarnpkg.com/browserslist/-/browserslist-4.6.6.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "calculate_size___calculate_size_1.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/calculate-size/-/calculate-size-1.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "caniuse_db___caniuse_db_1.0.30000890.tgz";
        url =
          "https://registry.yarnpkg.com/caniuse-db/-/caniuse-db-1.0.30000890.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "caniuse_lite___caniuse_lite_1.0.30000926.tgz";
        url =
          "https://registry.yarnpkg.com/caniuse-lite/-/caniuse-lite-1.0.30000926.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "caniuse_lite___caniuse_lite_1.0.30000984.tgz";
        url =
          "https://registry.yarnpkg.com/caniuse-lite/-/caniuse-lite-1.0.30000984.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "clean_webpack_plugin___clean_webpack_plugin_3.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/clean-webpack-plugin/-/clean-webpack-plugin-3.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "color_string___color_string_1.5.3.tgz";
        url =
          "https://registry.yarnpkg.com/color-string/-/color-string-1.5.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "connected_react_router___connected_react_router_6.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/connected-react-router/-/connected-react-router-6.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "content_type_parser___content_type_parser_1.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/content-type-parser/-/content-type-parser-1.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "copy_to_clipboard___copy_to_clipboard_3.0.8.tgz";
        url =
          "https://registry.yarnpkg.com/copy-to-clipboard/-/copy-to-clipboard-3.0.8.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "core_js_compat___core_js_compat_3.1.4.tgz";
        url =
          "https://registry.yarnpkg.com/core-js-compat/-/core-js-compat-3.1.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "core_js_pure___core_js_pure_3.1.4.tgz";
        url =
          "https://registry.yarnpkg.com/core-js-pure/-/core-js-pure-3.1.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "core_js_pure___core_js_pure_3.6.5.tgz";
        url =
          "https://registry.yarnpkg.com/core-js-pure/-/core-js-pure-3.6.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "create_react_context___create_react_context_0.2.2.tgz";
        url =
          "https://registry.yarnpkg.com/create-react-context/-/create-react-context-0.2.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "cross_fetch___cross_fetch_3.0.4.tgz";
        url =
          "https://registry.yarnpkg.com/cross-fetch/-/cross-fetch-3.0.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "css_tree___css_tree_1.0.0_alpha.28.tgz";
        url =
          "https://registry.yarnpkg.com/css-tree/-/css-tree-1.0.0-alpha.28.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "css_tree___css_tree_1.0.0_alpha.29.tgz";
        url =
          "https://registry.yarnpkg.com/css-tree/-/css-tree-1.0.0-alpha.29.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "css_url_regex___css_url_regex_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/css-url-regex/-/css-url-regex-1.1.0.tgz";
    ...
    {
      name =
        "cssnano_util_get_arguments___cssnano_util_get_arguments_4.0.0.tgz";
      path = fetchurl {
        name =
          "cssnano_util_get_arguments___cssnano_util_get_arguments_4.0.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "custom_event___custom_event_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/custom-event/-/custom-event-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "cypress_file_upload___cypress_file_upload_4.0.7.tgz";
        url =
          "https://registry.yarnpkg.com/cypress-file-upload/-/cypress-file-upload-4.0.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "cypress_pipe___cypress_pipe_1.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/cypress-pipe/-/cypress-pipe-1.5.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "d3_collection___d3_collection_1.0.7.tgz";
        url =
          "https://registry.yarnpkg.com/d3-collection/-/d3-collection-1.0.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "d3_interpolate___d3_interpolate_1.3.2.tgz";
        url =
          "https://registry.yarnpkg.com/d3-interpolate/-/d3-interpolate-1.3.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "d3_time_format___d3_time_format_2.1.3.tgz";
        url =
          "https://registry.yarnpkg.com/d3-time-format/-/d3-time-format-2.1.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "date_fns___date_fns_2.0.0_alpha.27.tgz";
        url =
          "https://registry.yarnpkg.com/date-fns/-/date-fns-2.0.0-alpha.27.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "date_fns___date_fns_2.0.0_beta.2.tgz";
        url =
          "https://registry.yarnpkg.com/date-fns/-/date-fns-2.0.0-beta.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "diff_sequences___diff_sequences_24.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/diff-sequences/-/diff-sequences-24.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "discontinuous_range___discontinuous_range_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/discontinuous-range/-/discontinuous-range-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "dom_accessibility_api___dom_accessibility_api_0.4.5.tgz";
        url =
          "https://registry.yarnpkg.com/dom-accessibility-api/-/dom-accessibility-api-0.4.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "dom_helpers___dom_helpers_3.3.1.tgz";
        url =
          "https://registry.yarnpkg.com/dom-helpers/-/dom-helpers-3.3.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "electron_to_chromium___electron_to_chromium_1.3.75.tgz";
        url =
          "https://registry.yarnpkg.com/electron-to-chromium/-/electron-to-chromium-1.3.75.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "electron_to_chromium___electron_to_chromium_1.3.194.tgz";
        url =
          "https://registry.yarnpkg.com/electron-to-chromium/-/electron-to-chromium-1.3.194.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "electron_to_chromium___electron_to_chromium_1.3.96.tgz";
        url =
          "https://registry.yarnpkg.com/electron-to-chromium/-/electron-to-chromium-1.3.96.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "element_resize_event___element_resize_event_2.0.9.tgz";
        url =
          "https://registry.yarnpkg.com/element-resize-event/-/element-resize-event-2.0.9.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "enzyme_adapter_react_16___enzyme_adapter_react_16_1.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/enzyme-adapter-react-16/-/enzyme-adapter-react-16-1.6.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "enzyme_adapter_utils___enzyme_adapter_utils_1.8.1.tgz";
        url =
          "https://registry.yarnpkg.com/enzyme-adapter-utils/-/enzyme-adapter-utils-1.8.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "enzyme_to_json___enzyme_to_json_3.3.4.tgz";
        url =
          "https://registry.yarnpkg.com/enzyme-to-json/-/enzyme-to-json-3.3.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "es_abstract___es_abstract_1.17.4.tgz";
        url =
          "https://registry.yarnpkg.com/es-abstract/-/es-abstract-1.17.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "eslint_config_prettier___eslint_config_prettier_6.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/eslint-config-prettier/-/eslint-config-prettier-6.5.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "eslint_plugin_jest___eslint_plugin_jest_23.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/eslint-plugin-jest/-/eslint-plugin-jest-23.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "eslint_plugin_react_hooks___eslint_plugin_react_hooks_4.0.5.tgz";
        url =
          "https://registry.yarnpkg.com/eslint-plugin-react-hooks/-/eslint-plugin-react-hooks-4.0.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "eslint_plugin_react___eslint_plugin_react_7.16.0.tgz";
        url =
          "https://registry.yarnpkg.com/eslint-plugin-react/-/eslint-plugin-react-7.16.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "eventemitter2___eventemitter2_6.4.3.tgz";
        url =
          "https://registry.yarnpkg.com/eventemitter2/-/eventemitter2-6.4.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "fb_watchman___fb_watchman_2.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/fb-watchman/-/fb-watchman-2.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "file_loader___file_loader_4.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/file-loader/-/file-loader-4.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "find_cache_dir___find_cache_dir_2.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/find-cache-dir/-/find-cache-dir-2.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "find_cache_dir___find_cache_dir_3.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/find-cache-dir/-/find-cache-dir-3.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "follow_redirects___follow_redirects_1.10.0.tgz";
        url =
          "https://registry.yarnpkg.com/follow-redirects/-/follow-redirects-1.10.0.tgz";
    ...
    {
      name =
        "fork_ts_checker_webpack_plugin___fork_ts_checker_webpack_plugin_1.4.3.tgz";
      path = fetchurl {
        name =
          "fork_ts_checker_webpack_plugin___fork_ts_checker_webpack_plugin_1.4.3.tgz";
        url =
          "https://registry.yarnpkg.com/fork-ts-checker-webpack-plugin/-/fork-ts-checker-webpack-plugin-1.4.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "function.prototype.name___function.prototype.name_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/function.prototype.name/-/function.prototype.name-1.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "harmony_reflect___harmony_reflect_1.6.1.tgz";
        url =
          "https://registry.yarnpkg.com/harmony-reflect/-/harmony-reflect-1.6.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "hoist_non_react_statics___hoist_non_react_statics_1.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/hoist-non-react-statics/-/hoist-non-react-statics-1.2.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "hoist_non_react_statics___hoist_non_react_statics_3.3.1.tgz";
        url =
          "https://registry.yarnpkg.com/hoist-non-react-statics/-/hoist-non-react-statics-3.3.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "honeybadger_js___honeybadger_js_1.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/honeybadger-js/-/honeybadger-js-1.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "html_entities___html_entities_1.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/html-entities/-/html-entities-1.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "html_minifier___html_minifier_3.5.21.tgz";
        url =
          "https://registry.yarnpkg.com/html-minifier/-/html-minifier-3.5.21.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "html_minify___html_minify_0.3.2.tgz";
        url =
          "https://registry.yarnpkg.com/html-minify/-/html-minify-0.3.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "html_to_react___html_to_react_1.3.4.tgz";
        url =
          "https://registry.yarnpkg.com/html-to-react/-/html-to-react-1.3.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "html_webpack_plugin___html_webpack_plugin_3.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/html-webpack-plugin/-/html-webpack-plugin-3.2.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "http_proxy_middleware___http_proxy_middleware_0.18.0.tgz";
        url =
          "https://registry.yarnpkg.com/http-proxy-middleware/-/http-proxy-middleware-0.18.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "idtoken_verifier___idtoken_verifier_2.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/idtoken-verifier/-/idtoken-verifier-2.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "intersection_observer___intersection_observer_0.7.0.tgz";
        url =
          "https://registry.yarnpkg.com/intersection-observer/-/intersection-observer-0.7.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "is_boolean_object___is_boolean_object_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/is-boolean-object/-/is-boolean-object-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "is_installed_globally___is_installed_globally_0.3.2.tgz";
        url =
          "https://registry.yarnpkg.com/is-installed-globally/-/is-installed-globally-0.3.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "is_number_object___is_number_object_1.0.3.tgz";
        url =
          "https://registry.yarnpkg.com/is-number-object/-/is-number-object-1.0.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_changed_files___jest_changed_files_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-changed-files/-/jest-changed-files-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_config___jest_config_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-config/-/jest-config-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_docblock___jest_docblock_24.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-docblock/-/jest-docblock-24.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_environment_jsdom___jest_environment_jsdom_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-environment-jsdom/-/jest-environment-jsdom-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_environment_node___jest_environment_node_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-environment-node/-/jest-environment-node-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_fetch_mock___jest_fetch_mock_3.0.3.tgz";
        url =
          "https://registry.yarnpkg.com/jest-fetch-mock/-/jest-fetch-mock-3.0.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_get_type___jest_get_type_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-get-type/-/jest-get-type-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_haste_map___jest_haste_map_24.8.1.tgz";
        url =
          "https://registry.yarnpkg.com/jest-haste-map/-/jest-haste-map-24.8.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_jasmine2___jest_jasmine2_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-jasmine2/-/jest-jasmine2-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_leak_detector___jest_leak_detector_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-leak-detector/-/jest-leak-detector-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_matcher_utils___jest_matcher_utils_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-matcher-utils/-/jest-matcher-utils-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_message_util___jest_message_util_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-message-util/-/jest-message-util-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_regex_util___jest_regex_util_24.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-regex-util/-/jest-regex-util-24.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "jest_resolve_dependencies___jest_resolve_dependencies_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-resolve-dependencies/-/jest-resolve-dependencies-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_resolve___jest_resolve_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-resolve/-/jest-resolve-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_runner___jest_runner_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-runner/-/jest-runner-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_runtime___jest_runtime_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-runtime/-/jest-runtime-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_serializer___jest_serializer_24.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-serializer/-/jest-serializer-24.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_snapshot___jest_snapshot_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-snapshot/-/jest-snapshot-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_validate___jest_validate_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-validate/-/jest-validate-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_watcher___jest_watcher_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-watcher/-/jest-watcher-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jest_worker___jest_worker_24.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/jest-worker/-/jest-worker-24.6.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "js_levenshtein___js_levenshtein_1.1.6.tgz";
        url =
          "https://registry.yarnpkg.com/js-levenshtein/-/js-levenshtein-1.1.6.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "json_schema_ref_parser___json_schema_ref_parser_7.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/json-schema-ref-parser/-/json-schema-ref-parser-7.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jsonlint_mod___jsonlint_mod_1.7.5.tgz";
        url =
          "https://registry.yarnpkg.com/jsonlint-mod/-/jsonlint-mod-1.7.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "jsx_ast_utils___jsx_ast_utils_2.2.3.tgz";
        url =
          "https://registry.yarnpkg.com/jsx-ast-utils/-/jsx-ast-utils-2.2.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "junit_viewer___junit_viewer_4.11.1.tgz";
        url =
          "https://registry.yarnpkg.com/junit-viewer/-/junit-viewer-4.11.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "lodash.isempty___lodash.isempty_4.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/lodash.isempty/-/lodash.isempty-4.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "lodash.tail___lodash.tail_4.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/lodash.tail/-/lodash.tail-4.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "mdast_add_list_metadata___mdast_add_list_metadata_1.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/mdast-add-list-metadata/-/mdast-add-list-metadata-1.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "memoize_one___memoize_one_4.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/memoize-one/-/memoize-one-4.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "mini_create_react_context___mini_create_react_context_0.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/mini-create-react-context/-/mini-create-react-context-0.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "mini_css_extract_plugin___mini_css_extract_plugin_0.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/mini-css-extract-plugin/-/mini-css-extract-plugin-0.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "minipass_pipeline___minipass_pipeline_1.2.2.tgz";
        url =
          "https://registry.yarnpkg.com/minipass-pipeline/-/minipass-pipeline-1.2.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "mixin_object___mixin_object_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/mixin-object/-/mixin-object-2.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "mocha_junit_reporter___mocha_junit_reporter_1.18.0.tgz";
        url =
          "https://registry.yarnpkg.com/mocha-junit-reporter/-/mocha-junit-reporter-1.18.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "monaco_editor_textmate___monaco_editor_textmate_2.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/monaco-editor-textmate/-/monaco-editor-textmate-2.2.1.tgz";
        sha1 = "93f3f1932061dd2311b92a42ea1c027cfeb3e439";
      };
    }
    {
      name =
        "monaco_editor_webpack_plugin___monaco_editor_webpack_plugin_1.8.2.tgz";
      path = fetchurl {
        name =
          "monaco_editor_webpack_plugin___monaco_editor_webpack_plugin_1.8.2.tgz";
        url =
          "https://registry.yarnpkg.com/monaco-editor-webpack-plugin/-/monaco-editor-webpack-plugin-1.8.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "monaco_editor___monaco_editor_0.19.3.tgz";
        url =
          "https://registry.yarnpkg.com/monaco-editor/-/monaco-editor-0.19.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "monaco_languageclient___monaco_languageclient_0.11.0.tgz";
        url =
          "https://registry.yarnpkg.com/monaco-languageclient/-/monaco-languageclient-0.11.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "monaco_textmate___monaco_textmate_3.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/monaco-textmate/-/monaco-textmate-3.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "mutation_observer___mutation_observer_1.0.3.tgz";
        url =
          "https://registry.yarnpkg.com/mutation-observer/-/mutation-observer-1.0.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "node_notifier___node_notifier_5.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/node-notifier/-/node-notifier-5.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "node_releases___node_releases_1.1.25.tgz";
        url =
          "https://registry.yarnpkg.com/node-releases/-/node-releases-1.1.25.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "node_releases___node_releases_1.1.3.tgz";
        url =
          "https://registry.yarnpkg.com/node-releases/-/node-releases-1.1.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "object.entries___object.entries_1.0.4.tgz";
        url =
          "https://registry.yarnpkg.com/object.entries/-/object.entries-1.0.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "object.entries___object.entries_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/object.entries/-/object.entries-1.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "object.fromentries___object.fromentries_2.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/object.fromentries/-/object.fromentries-2.0.0.tgz";
        sha1 = "49a543d92151f8277b3ac9600f1e930b189d30ab";
      };
    }
    {
      name =
        "object.getownpropertydescriptors___object.getownpropertydescriptors_2.0.3.tgz";
      path = fetchurl {
        name =
          "object.getownpropertydescriptors___object.getownpropertydescriptors_2.0.3.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "object.values___object.values_1.0.4.tgz";
        url =
          "https://registry.yarnpkg.com/object.values/-/object.values-1.0.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "openapi_schemas___openapi_schemas_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/openapi-schemas/-/openapi-schemas-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "openapi_types___openapi_types_1.3.5.tgz";
        url =
          "https://registry.yarnpkg.com/openapi-types/-/openapi-types-1.3.5.tgz";
    ...
    {
      name =
        "optimize_css_assets_webpack_plugin___optimize_css_assets_webpack_plugin_5.0.3.tgz";
      path = fetchurl {
        name =
          "optimize_css_assets_webpack_plugin___optimize_css_assets_webpack_plugin_5.0.3.tgz";
        url =
          "https://registry.yarnpkg.com/optimize-css-assets-webpack-plugin/-/optimize-css-assets-webpack-plugin-5.0.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "parse_entities___parse_entities_1.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/parse-entities/-/parse-entities-1.2.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "postcss_calc___postcss_calc_7.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/postcss-calc/-/postcss-calc-7.0.1.tgz";
    ...
    {
      name =
        "postcss_discard_duplicates___postcss_discard_duplicates_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_discard_duplicates___postcss_discard_duplicates_4.0.2.tgz";
        url =
    ...
    {
      name =
        "postcss_discard_overridden___postcss_discard_overridden_4.0.1.tgz";
      path = fetchurl {
        name =
          "postcss_discard_overridden___postcss_discard_overridden_4.0.1.tgz";
        url =
    ...
    {
      name =
        "postcss_minify_font_values___postcss_minify_font_values_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_minify_font_values___postcss_minify_font_values_4.0.2.tgz";
        url =
    ...
    {
      name =
        "postcss_modules_local_by_default___postcss_modules_local_by_default_3.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_modules_local_by_default___postcss_modules_local_by_default_3.0.2.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "postcss_normalize_charset___postcss_normalize_charset_4.0.1.tgz";
        url =
    ...
    {
      name =
        "postcss_normalize_display_values___postcss_normalize_display_values_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_normalize_display_values___postcss_normalize_display_values_4.0.2.tgz";
        url =
    ...
    {
      name =
        "postcss_normalize_positions___postcss_normalize_positions_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_normalize_positions___postcss_normalize_positions_4.0.2.tgz";
        url =
    ...
    {
      name =
        "postcss_normalize_repeat_style___postcss_normalize_repeat_style_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_normalize_repeat_style___postcss_normalize_repeat_style_4.0.2.tgz";
        url =
    ...
    {
      name =
        "postcss_normalize_timing_functions___postcss_normalize_timing_functions_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_normalize_timing_functions___postcss_normalize_timing_functions_4.0.2.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "postcss_normalize_unicode___postcss_normalize_unicode_4.0.1.tgz";
        url =
    ...
    {
      name =
        "postcss_normalize_whitespace___postcss_normalize_whitespace_4.0.2.tgz";
      path = fetchurl {
        name =
          "postcss_normalize_whitespace___postcss_normalize_whitespace_4.0.2.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "postcss_reduce_transforms___postcss_reduce_transforms_4.0.2.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "postcss_selector_parser___postcss_selector_parser_3.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/postcss-selector-parser/-/postcss-selector-parser-3.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "postcss_value_parser___postcss_value_parser_4.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/postcss-value-parser/-/postcss-value-parser-4.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "prefix_style___prefix_style_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/prefix-style/-/prefix-style-2.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "pretty_bytes___pretty_bytes_5.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/pretty-bytes/-/pretty-bytes-5.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "pretty_error___pretty_error_2.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/pretty-error/-/pretty-error-2.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "pretty_format___pretty_format_24.8.0.tgz";
        url =
          "https://registry.yarnpkg.com/pretty-format/-/pretty-format-24.8.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "pretty_format___pretty_format_25.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/pretty-format/-/pretty-format-25.5.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "promise_polyfill___promise_polyfill_8.1.3.tgz";
        url =
          "https://registry.yarnpkg.com/promise-polyfill/-/promise-polyfill-8.1.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "railroad_diagrams___railroad_diagrams_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/railroad-diagrams/-/railroad-diagrams-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_codemirror2___react_codemirror2_4.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-codemirror2/-/react-codemirror2-4.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_copy_to_clipboard___react_copy_to_clipboard_5.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/react-copy-to-clipboard/-/react-copy-to-clipboard-5.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_datepicker___react_datepicker_2.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-datepicker/-/react-datepicker-2.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_dimensions___react_dimensions_1.3.1.tgz";
        url =
          "https://registry.yarnpkg.com/react-dimensions/-/react-dimensions-1.3.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_dnd_html5_backend___react_dnd_html5_backend_9.5.1.tgz";
        url =
          "https://registry.yarnpkg.com/react-dnd-html5-backend/-/react-dnd-html5-backend-9.5.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_draggable___react_draggable_3.0.5.tgz";
        url =
          "https://registry.yarnpkg.com/react-draggable/-/react-draggable-3.0.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_draggable___react_draggable_3.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-draggable/-/react-draggable-3.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_grid_layout___react_grid_layout_0.16.6.tgz";
        url =
          "https://registry.yarnpkg.com/react-grid-layout/-/react-grid-layout-0.16.6.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_loadable___react_loadable_5.5.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-loadable/-/react-loadable-5.5.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_markdown___react_markdown_4.0.4.tgz";
        url =
          "https://registry.yarnpkg.com/react-markdown/-/react-markdown-4.0.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_monaco_editor___react_monaco_editor_0.33.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-monaco-editor/-/react-monaco-editor-0.33.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_onclickoutside___react_onclickoutside_6.7.1.tgz";
        url =
          "https://registry.yarnpkg.com/react-onclickoutside/-/react-onclickoutside-6.7.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_popper___react_popper_1.3.3.tgz";
        url =
          "https://registry.yarnpkg.com/react-popper/-/react-popper-1.3.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_redux___react_redux_7.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-redux/-/react-redux-7.2.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_resizable___react_resizable_1.7.5.tgz";
        url =
          "https://registry.yarnpkg.com/react-resizable/-/react-resizable-1.7.5.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_router_dom___react_router_dom_5.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-router-dom/-/react-router-dom-5.2.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_router___react_router_5.2.0.tgz";
        url =
          "https://registry.yarnpkg.com/react-router/-/react-router-5.2.0.tgz";
        sha1 = "424e75641ca8747fbf76e5ecca69781aa37ea293";
      };
    }
    {
      name =
        "react_scrollbars_custom___react_scrollbars_custom_4.0.0_alpha.8.tgz";
      path = fetchurl {
        name =
          "react_scrollbars_custom___react_scrollbars_custom_4.0.0_alpha.8.tgz";
        url =
          "https://registry.yarnpkg.com/react-scrollbars-custom/-/react-scrollbars-custom-4.0.0-alpha.8.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_test_renderer___react_test_renderer_16.5.2.tgz";
        url =
          "https://registry.yarnpkg.com/react-test-renderer/-/react-test-renderer-16.5.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "react_virtualized___react_virtualized_9.20.1.tgz";
        url =
          "https://registry.yarnpkg.com/react-virtualized/-/react-virtualized-9.20.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "redux_auth_wrapper___redux_auth_wrapper_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/redux-auth-wrapper/-/redux-auth-wrapper-1.1.0.tgz";
    ...
    {
      name =
        "regenerate_unicode_properties___regenerate_unicode_properties_8.1.0.tgz";
      path = fetchurl {
        name =
          "regenerate_unicode_properties___regenerate_unicode_properties_8.1.0.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "regenerator_runtime___regenerator_runtime_0.13.3.tgz";
        url =
          "https://registry.yarnpkg.com/regenerator-runtime/-/regenerator-runtime-0.13.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "regenerator_transform___regenerator_transform_0.14.1.tgz";
        url =
          "https://registry.yarnpkg.com/regenerator-transform/-/regenerator-transform-0.14.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "regexp_tree___regexp_tree_0.1.11.tgz";
        url =
          "https://registry.yarnpkg.com/regexp-tree/-/regexp-tree-0.1.11.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "regexpu_core___regexpu_core_4.5.4.tgz";
        url =
          "https://registry.yarnpkg.com/regexpu-core/-/regexpu-core-4.5.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "remark_parse___remark_parse_5.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/remark-parse/-/remark-parse-5.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "rst_selector_parser___rst_selector_parser_2.2.3.tgz";
        url =
          "https://registry.yarnpkg.com/rst-selector-parser/-/rst-selector-parser-2.2.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "sass_loader___sass_loader_7.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/sass-loader/-/sass-loader-7.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "schema_utils___schema_utils_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/schema-utils/-/schema-utils-2.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "seamless_immutable___seamless_immutable_7.1.4.tgz";
        url =
          "https://registry.yarnpkg.com/seamless-immutable/-/seamless-immutable-7.1.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "serialize_javascript___serialize_javascript_2.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/serialize-javascript/-/serialize-javascript-2.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "shallow_clone___shallow_clone_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/shallow-clone/-/shallow-clone-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "source_map_loader___source_map_loader_0.2.4.tgz";
        url =
          "https://registry.yarnpkg.com/source-map-loader/-/source-map-loader-0.2.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "string_width___string_width_3.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/string-width/-/string-width-3.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "string_width___string_width_4.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/string-width/-/string-width-4.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name =
          "string.prototype.trimleft___string.prototype.trimleft_2.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/string.prototype.trimleft/-/string.prototype.trimleft-2.1.1.tgz";
        sha1 = "9bdb8ac6abd6d602b17a4ed321870d2f8dcefc74";
      };
    }
    {
      name =
        "string.prototype.trimright___string.prototype.trimright_2.1.1.tgz";
      path = fetchurl {
        name =
          "string.prototype.trimright___string.prototype.trimright_2.1.1.tgz";
        url =
          "https://registry.yarnpkg.com/string.prototype.trimright/-/string.prototype.trimright-2.1.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "style_loader___style_loader_0.23.1.tgz";
        url =
          "https://registry.yarnpkg.com/style-loader/-/style-loader-0.23.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "swagger_methods___swagger_methods_2.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/swagger-methods/-/swagger-methods-2.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "swagger_parser___swagger_parser_8.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/swagger-parser/-/swagger-parser-8.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "symbol_tree___symbol_tree_3.2.2.tgz";
        url =
          "https://registry.yarnpkg.com/symbol-tree/-/symbol-tree-3.2.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "terser_webpack_plugin___terser_webpack_plugin_2.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/terser-webpack-plugin/-/terser-webpack-plugin-2.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "tiny_invariant___tiny_invariant_1.1.0.tgz";
        url =
          "https://registry.yarnpkg.com/tiny-invariant/-/tiny-invariant-1.1.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "to_camel_case___to_camel_case_1.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/to-camel-case/-/to-camel-case-1.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "typed_styles___typed_styles_0.0.7.tgz";
        url =
          "https://registry.yarnpkg.com/typed-styles/-/typed-styles-0.0.7.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "ua_parser_js___ua_parser_js_0.7.18.tgz";
        url =
          "https://registry.yarnpkg.com/ua-parser-js/-/ua-parser-js-0.7.18.tgz";
    ...
    {
      name =
        "unicode_match_property_value_ecmascript___unicode_match_property_value_ecmascript_1.1.0.tgz";
      path = fetchurl {
        name =
          "unicode_match_property_value_ecmascript___unicode_match_property_value_ecmascript_1.1.0.tgz";
        url =
    ...
    {
      name =
        "unicode_property_aliases_ecmascript___unicode_property_aliases_ecmascript_1.0.4.tgz";
      path = fetchurl {
        name =
          "unicode_property_aliases_ecmascript___unicode_property_aliases_ecmascript_1.0.4.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "unist_util_visit_parents___unist_util_visit_parents_1.1.2.tgz";
        url =
          "https://registry.yarnpkg.com/unist-util-visit-parents/-/unist-util-visit-parents-1.1.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "unist_util_visit_parents___unist_util_visit_parents_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/unist-util-visit-parents/-/unist-util-visit-parents-2.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "unist_util_visit___unist_util_visit_1.4.0.tgz";
        url =
          "https://registry.yarnpkg.com/unist-util-visit/-/unist-util-visit-1.4.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "use_persisted_state___use_persisted_state_0.3.0.tgz";
        url =
          "https://registry.yarnpkg.com/use-persisted-state/-/use-persisted-state-0.3.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "vfile_location___vfile_location_2.0.4.tgz";
        url =
          "https://registry.yarnpkg.com/vfile-location/-/vfile-location-2.0.4.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "vfile_message___vfile_message_1.0.2.tgz";
        url =
          "https://registry.yarnpkg.com/vfile-message/-/vfile-message-1.0.2.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "vscode_jsonrpc___vscode_jsonrpc_4.1.0_next.3.tgz";
        url =
          "https://registry.yarnpkg.com/vscode-jsonrpc/-/vscode-jsonrpc-4.1.0-next.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "vscode_jsonrpc___vscode_jsonrpc_5.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/vscode-jsonrpc/-/vscode-jsonrpc-5.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "vscode_languageclient___vscode_languageclient_5.3.0_next.9.tgz";
        url =
          "https://registry.yarnpkg.com/vscode-languageclient/-/vscode-languageclient-5.3.0-next.9.tgz";
        sha1 = "34f58017647f15cd86015f7af45935dc750611f7";
      };
    }
    {
      name =
        "vscode_languageserver_protocol___vscode_languageserver_protocol_3.15.2.tgz";
      path = fetchurl {
        name =
          "vscode_languageserver_protocol___vscode_languageserver_protocol_3.15.2.tgz";
        url =
          "https://registry.yarnpkg.com/vscode-languageserver-protocol/-/vscode-languageserver-protocol-3.15.2.tgz";
        sha1 = "e52c62923140b2655ad2472f6f29cfb83bacf5b8";
      };
    }
    {
      name =
        "vscode_languageserver_types___vscode_languageserver_types_3.15.1.tgz";
      path = fetchurl {
        name =
          "vscode_languageserver_types___vscode_languageserver_types_3.15.1.tgz";
        url =
    ...
    }
    {
      ...
      path = fetchurl {
        name = "w3c_hr_time___w3c_hr_time_1.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/w3c-hr-time/-/w3c-hr-time-1.0.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "webpack_bundle_analyzer___webpack_bundle_analyzer_3.6.0.tgz";
        url =
          "https://registry.yarnpkg.com/webpack-bundle-analyzer/-/webpack-bundle-analyzer-3.6.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "webpack_dev_server___webpack_dev_server_3.10.3.tgz";
        url =
          "https://registry.yarnpkg.com/webpack-dev-server/-/webpack-dev-server-3.10.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "webpack_merge___webpack_merge_4.2.1.tgz";
        url =
          "https://registry.yarnpkg.com/webpack-merge/-/webpack-merge-4.2.1.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "websocket_driver___websocket_driver_0.7.3.tgz";
        url =
          "https://registry.yarnpkg.com/websocket-driver/-/websocket-driver-0.7.3.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "whatwg_fetch___whatwg_fetch_3.0.0.tgz";
        url =
          "https://registry.yarnpkg.com/whatwg-fetch/-/whatwg-fetch-3.0.0.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        name = "xml_name_validator___xml_name_validator_2.0.1.tgz";
        url =
          "https://registry.yarnpkg.com/xml-name-validator/-/xml-name-validator-2.0.1.tgz";
