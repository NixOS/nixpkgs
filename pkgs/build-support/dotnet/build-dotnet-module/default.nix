...
stdenvNoCC.mkDerivation (args // {
  ...
  passthru = {
    ...
    fetch-deps = let
      ...
      flags = lib.optionalString (flagsList != [ ]) (toString flagsList);
      disableParallel =
      ...
      projectFileStr = toString (lib.toList projectFile);
      testProjectFileStr = toString (lib.toList testProjectFile);
