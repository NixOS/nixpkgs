...
let
  transformArgs =
    finalAttrs:
    {
      ...
      # The path to packages.lock.json for projects using RestorePackagesWithLockFile or
      # true to enable automatic finding of the packages.lock.json files
      nugetLockFile ? null,
      # NuGet configuration used for managing NuGet sources
      nugetConfig ? null,
...
stdenvNoCC.mkDerivation (
  ...
  else if nugetLockFile != null then
    addPackageLockDeps {
      inherit nugetLockFile;
    } args'' finalAttrs
  else
    args''
)
