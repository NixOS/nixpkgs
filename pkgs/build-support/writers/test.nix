{ glib, haskellPackages, lib, nodePackages, perlPackages, python2Packages
, python3Packages, runCommand, writers, writeText }:
with writers;
let
  ...
  bin = {
    ...
    python2 = writePython2Bin "test-writers-python2-bin" {
  ...
  simple = {
    ...
    python2 = writePython2 "test-writers-python2" {
      libraries = [ python2Packages.enum ];
    } ''
      from enum import Enum
