...
rec {
  ...
  crates.carnix."0.8.9" = deps: { features?(features_.carnix."0.8.9" deps {}) }: buildRustCrate {
    crateName = "carnix";
    version = "0.8.9";
    authors = [ "pe@pijul.org <pe@pijul.org>" ];
    sha256 = "1knd6znmwbc58h9g8fplmacc30jskbdn1sdyvilh5l5bxfws78cy";
    crateBin =
      [{  name = "cargo-generate-nixfile";  path = "src/cargo-generate-nixfile.rs"; }] ++
      [{  name = "carnix";  path = "src/main.rs"; }];
    dependencies = mapFeatures features ([
      (crates."clap"."${deps."carnix"."0.8.9"."clap"}" deps)
      (crates."dirs"."${deps."carnix"."0.8.9"."dirs"}" deps)
      (crates."env_logger"."${deps."carnix"."0.8.9"."env_logger"}" deps)
      (crates."error_chain"."${deps."carnix"."0.8.9"."error_chain"}" deps)
      (crates."itertools"."${deps."carnix"."0.8.9"."itertools"}" deps)
      (crates."log"."${deps."carnix"."0.8.9"."log"}" deps)
      (crates."nom"."${deps."carnix"."0.8.9"."nom"}" deps)
      (crates."regex"."${deps."carnix"."0.8.9"."regex"}" deps)
      (crates."rusqlite"."${deps."carnix"."0.8.9"."rusqlite"}" deps)
      (crates."serde"."${deps."carnix"."0.8.9"."serde"}" deps)
      (crates."serde_derive"."${deps."carnix"."0.8.9"."serde_derive"}" deps)
      (crates."serde_json"."${deps."carnix"."0.8.9"."serde_json"}" deps)
      (crates."tempdir"."${deps."carnix"."0.8.9"."tempdir"}" deps)
      (crates."toml"."${deps."carnix"."0.8.9"."toml"}" deps)
    ]);
  };
  features_.carnix."0.8.9" = deps: f: updateFeatures f (rec {
    carnix."0.8.9".default = (f.carnix."0.8.9".default or true);
    clap."${deps.carnix."0.8.9".clap}".default = true;
    dirs."${deps.carnix."0.8.9".dirs}".default = true;
    env_logger."${deps.carnix."0.8.9".env_logger}".default = true;
    error_chain."${deps.carnix."0.8.9".error_chain}".default = true;
    itertools."${deps.carnix."0.8.9".itertools}".default = true;
    log."${deps.carnix."0.8.9".log}".default = true;
    nom."${deps.carnix."0.8.9".nom}".default = true;
    regex."${deps.carnix."0.8.9".regex}".default = true;
    rusqlite."${deps.carnix."0.8.9".rusqlite}".default = true;
    serde."${deps.carnix."0.8.9".serde}".default = true;
    serde_derive."${deps.carnix."0.8.9".serde_derive}".default = true;
    serde_json."${deps.carnix."0.8.9".serde_json}".default = true;
    tempdir."${deps.carnix."0.8.9".tempdir}".default = true;
    toml."${deps.carnix."0.8.9".toml}".default = true;
  }) [
    (features_.clap."${deps."carnix"."0.8.9"."clap"}" deps)
    (features_.dirs."${deps."carnix"."0.8.9"."dirs"}" deps)
    (features_.env_logger."${deps."carnix"."0.8.9"."env_logger"}" deps)
    (features_.error_chain."${deps."carnix"."0.8.9"."error_chain"}" deps)
    (features_.itertools."${deps."carnix"."0.8.9"."itertools"}" deps)
    (features_.log."${deps."carnix"."0.8.9"."log"}" deps)
    (features_.nom."${deps."carnix"."0.8.9"."nom"}" deps)
    (features_.regex."${deps."carnix"."0.8.9"."regex"}" deps)
    (features_.rusqlite."${deps."carnix"."0.8.9"."rusqlite"}" deps)
    (features_.serde."${deps."carnix"."0.8.9"."serde"}" deps)
    (features_.serde_derive."${deps."carnix"."0.8.9"."serde_derive"}" deps)
    (features_.serde_json."${deps."carnix"."0.8.9"."serde_json"}" deps)
    (features_.tempdir."${deps."carnix"."0.8.9"."tempdir"}" deps)
    (features_.toml."${deps."carnix"."0.8.9"."toml"}" deps)
  ];
