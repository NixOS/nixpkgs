# Generated by carnix 0.4.14: carnix -o carnix.nix Cargo.lock
...
let kernel = buildPlatform.parsed.kernel.name;
    ...
    carnix_0_4_14_ = { dependencies?[], buildDependencies?[], features?[] }: buildRustCrate {
      crateName = "carnix";
      version = "0.4.14";
