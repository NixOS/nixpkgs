# Generated by carnix 0.6.4: carnix -o carnix.nix --src ./. Cargo.lock
...
in
rec {
  carnix = f: carnix_0_6_4 { features = carnix_0_6_4_features { carnix_0_6_4 = f; }; };
  ...
  carnix_0_6_4_ = { dependencies?[], buildDependencies?[], features?[] }: buildRustCrate {
    crateName = "carnix";
    version = "0.6.4";
  ...
  aho_corasick_0_6_3 = { features?(aho_corasick_0_6_3_features {}) }: aho_corasick_0_6_3_ {
    dependencies = [ (memchr_1_0_2 { features = features; }) ];
  };
  aho_corasick_0_6_3_features = f:
  ...
  atty_0_2_3 = { features?(atty_0_2_3_features {}) }: atty_0_2_3_ {
    dependencies = (if kernel == "redox" then [ (termion_1_5_1 { features = features; }) ] else [])
      ++ (if (kernel == "linux" || kernel == "darwin") then [ (libc_0_2_33 { features = features; }) ] else [])
      ++ (if kernel == "windows" then [ (kernel32_sys_0_2_2 { features = features; }) (winapi_0_2_8 { features = features; }) ] else []);
  };
  atty_0_2_3_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  backtrace_0_3_4 = { features?(backtrace_0_3_4_features {}) }: backtrace_0_3_4_ {
    dependencies = [ (cfg_if_0_1_2 { features = features; }) (rustc_demangle_0_1_5 { features = features; }) ]
      ++ (if (kernel == "linux" || kernel == "darwin") && !(kernel == "fuchsia") && !(kernel == "emscripten") && !(kernel == "darwin") && !(kernel == "ios") then [ ]
      ++ (if features.backtrace_0_3_4."backtrace-sys" or false then [(backtrace_sys_0_1_16 { features = features; })] else []) else [])
      ++ (if (kernel == "linux" || kernel == "darwin") then [ (libc_0_2_33 { features = features; }) ] else [])
      ++ (if kernel == "windows" then [ ]
      ++ (if features.backtrace_0_3_4."dbghelp-sys" or false then [(dbghelp_sys_0_2_0 { features = features; })] else [])
      ++ (if features.backtrace_0_3_4."kernel32-sys" or false then [(kernel32_sys_0_2_2 { features = features; })] else [])
      ++ (if features.backtrace_0_3_4."winapi" or false then [(winapi_0_2_8 { features = features; })] else []) else []);
  ...
  backtrace_sys_0_1_16 = { features?(backtrace_sys_0_1_16_features {}) }: backtrace_sys_0_1_16_ {
    dependencies = [ (libc_0_2_33 { features = features; }) ];
    buildDependencies = [ (cc_1_0_3 { features = features; }) ];
  };
  backtrace_sys_0_1_16_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  bitflags_1_0_1_features = f:
    ...
    [ ]);
  carnix_0_6_4 = { features?(carnix_0_6_4_features {}) }: carnix_0_6_4_ {
    dependencies = [ (clap_2_28_0 { features = features; }) (env_logger_0_4_3 { features = features; }) (error_chain_0_11_0 { features = features; }) (itertools_0_7_3 { features = features; }) (log_0_3_8 { features = features; }) (nom_3_2_1 { features = features; }) (regex_0_2_2 { features = features; }) (rusqlite_0_13_0 { features = features; }) (serde_1_0_21 { features = features; }) (serde_derive_1_0_21 { features = features; }) (serde_json_1_0_6 { features = features; }) (tempdir_0_3_5 { features = features; }) (toml_0_4_5 { features = features; }) ];
  };
  carnix_0_6_4_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        carnix_0_6_4.default = (f.carnix_0_6_4.default or true);
  ...
  clap_2_28_0 = { features?(clap_2_28_0_features {}) }: clap_2_28_0_ {
    dependencies = [ (bitflags_1_0_1 { features = features; }) (textwrap_0_9_0 { features = features; }) (unicode_width_0_1_4 { features = features; }) ]
      ++ (if features.clap_2_28_0."ansi_term" or false then [(ansi_term_0_10_2 { features = features; })] else [])
      ++ (if features.clap_2_28_0."atty" or false then [(atty_0_2_3 { features = features; })] else [])
      ++ (if features.clap_2_28_0."strsim" or false then [(strsim_0_6_0 { features = features; })] else [])
      ++ (if features.clap_2_28_0."vec_map" or false then [(vec_map_0_8_0 { features = features; })] else []);
    features = mkFeatures (features.clap_2_28_0 or {});
  };
  clap_2_28_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  dbghelp_sys_0_2_0 = { features?(dbghelp_sys_0_2_0_features {}) }: dbghelp_sys_0_2_0_ {
    dependencies = [ (winapi_0_2_8 { features = features; }) ];
    buildDependencies = [ (winapi_build_0_1_1 { features = features; }) ];
  };
  dbghelp_sys_0_2_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  env_logger_0_4_3 = { features?(env_logger_0_4_3_features {}) }: env_logger_0_4_3_ {
    dependencies = [ (log_0_3_8 { features = features; }) ]
      ++ (if features.env_logger_0_4_3."regex" or false then [(regex_0_2_2 { features = features; })] else []);
    features = mkFeatures (features.env_logger_0_4_3 or {});
  };
  env_logger_0_4_3_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  error_chain_0_11_0 = { features?(error_chain_0_11_0_features {}) }: error_chain_0_11_0_ {
    dependencies = [ ]
      ++ (if features.error_chain_0_11_0."backtrace" or false then [(backtrace_0_3_4 { features = features; })] else []);
    features = mkFeatures (features.error_chain_0_11_0 or {});
  };
  error_chain_0_11_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  fuchsia_zircon_0_2_1 = { features?(fuchsia_zircon_0_2_1_features {}) }: fuchsia_zircon_0_2_1_ {
    dependencies = [ (fuchsia_zircon_sys_0_2_0 { features = features; }) ];
  };
  fuchsia_zircon_0_2_1_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  fuchsia_zircon_sys_0_2_0 = { features?(fuchsia_zircon_sys_0_2_0_features {}) }: fuchsia_zircon_sys_0_2_0_ {
    dependencies = [ (bitflags_0_7_0 { features = features; }) ];
  };
  fuchsia_zircon_sys_0_2_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  itertools_0_7_3 = { features?(itertools_0_7_3_features {}) }: itertools_0_7_3_ {
    dependencies = [ (either_1_4_0 { features = features; }) ];
    features = mkFeatures (features.itertools_0_7_3 or {});
  };
  itertools_0_7_3_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  libsqlite3_sys_0_9_0 = { features?(libsqlite3_sys_0_9_0_features {}) }: libsqlite3_sys_0_9_0_ {
    ...
    buildDependencies = [ ]
      ++ (if features.libsqlite3_sys_0_9_0."pkg-config" or false then [(pkg_config_0_3_9 { features = features; })] else []);
    features = mkFeatures (features.libsqlite3_sys_0_9_0 or {});
  };
  libsqlite3_sys_0_9_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  linked_hash_map_0_4_2_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  lru_cache_0_1_1 = { features?(lru_cache_0_1_1_features {}) }: lru_cache_0_1_1_ {
    dependencies = [ (linked_hash_map_0_4_2 { features = features; }) ];
    features = mkFeatures (features.lru_cache_0_1_1 or {});
  };
  lru_cache_0_1_1_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  memchr_1_0_2 = { features?(memchr_1_0_2_features {}) }: memchr_1_0_2_ {
    dependencies = [ ]
      ++ (if features.memchr_1_0_2."libc" or false then [(libc_0_2_33 { features = features; })] else []);
    features = mkFeatures (features.memchr_1_0_2 or {});
  };
  memchr_1_0_2_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        libc_0_2_33."use_std" =
          (f.libc_0_2_33."use_std" or false) ||
  ...
  rand_0_3_18 = { features?(rand_0_3_18_features {}) }: rand_0_3_18_ {
    dependencies = [ (libc_0_2_33 { features = features; }) ]
      ++ (if kernel == "fuchsia" then [ (fuchsia_zircon_0_2_1 { features = features; }) ] else []);
    features = mkFeatures (features.rand_0_3_18 or {});
  };
  rand_0_3_18_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  redox_syscall_0_1_32_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  redox_termios_0_1_1 = { features?(redox_termios_0_1_1_features {}) }: redox_termios_0_1_1_ {
    dependencies = [ (redox_syscall_0_1_32 { features = features; }) ];
  };
  redox_termios_0_1_1_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  regex_0_2_2 = { features?(regex_0_2_2_features {}) }: regex_0_2_2_ {
    dependencies = [ (aho_corasick_0_6_3 { features = features; }) (memchr_1_0_2 { features = features; }) (regex_syntax_0_4_1 { features = features; }) (thread_local_0_3_4 { features = features; }) (utf8_ranges_1_0_0 { features = features; }) ];
    features = mkFeatures (features.regex_0_2_2 or {});
  };
  regex_0_2_2_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  rusqlite_0_13_0 = { features?(rusqlite_0_13_0_features {}) }: rusqlite_0_13_0_ {
    dependencies = [ (bitflags_1_0_1 { features = features; }) (libsqlite3_sys_0_9_0 { features = features; }) (lru_cache_0_1_1 { features = features; }) (time_0_1_38 { features = features; }) ];
    features = mkFeatures (features.rusqlite_0_13_0 or {});
  };
  rusqlite_0_13_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        bitflags_1_0_1.default = true;
  ...
  rustc_demangle_0_1_5_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  serde_derive_1_0_21 = { features?(serde_derive_1_0_21_features {}) }: serde_derive_1_0_21_ {
    dependencies = [ (quote_0_3_15 { features = features; }) (serde_derive_internals_0_17_0 { features = features; }) (syn_0_11_11 { features = features; }) ];
  };
  serde_derive_1_0_21_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  serde_derive_internals_0_17_0 = { features?(serde_derive_internals_0_17_0_features {}) }: serde_derive_internals_0_17_0_ {
    dependencies = [ (syn_0_11_11 { features = features; }) (synom_0_11_3 { features = features; }) ];
  };
  serde_derive_internals_0_17_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  serde_json_1_0_6 = { features?(serde_json_1_0_6_features {}) }: serde_json_1_0_6_ {
    dependencies = [ (dtoa_0_4_2 { features = features; }) (itoa_0_3_4 { features = features; }) (num_traits_0_1_40 { features = features; }) (serde_1_0_21 { features = features; }) ];
    features = mkFeatures (features.serde_json_1_0_6 or {});
  };
  serde_json_1_0_6_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  syn_0_11_11 = { features?(syn_0_11_11_features {}) }: syn_0_11_11_ {
    dependencies = [ ]
      ++ (if features.syn_0_11_11."quote" or false then [(quote_0_3_15 { features = features; })] else [])
      ++ (if features.syn_0_11_11."synom" or false then [(synom_0_11_3 { features = features; })] else [])
      ++ (if features.syn_0_11_11."unicode-xid" or false then [(unicode_xid_0_0_4 { features = features; })] else []);
    features = mkFeatures (features.syn_0_11_11 or {});
  };
  syn_0_11_11_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        quote_0_3_15.default = true;
        syn_0_11_11."parsing" =
  ...
  synom_0_11_3 = { features?(synom_0_11_3_features {}) }: synom_0_11_3_ {
    dependencies = [ (unicode_xid_0_0_4 { features = features; }) ];
  };
  synom_0_11_3_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  tempdir_0_3_5 = { features?(tempdir_0_3_5_features {}) }: tempdir_0_3_5_ {
    dependencies = [ (rand_0_3_18 { features = features; }) ];
  };
  tempdir_0_3_5_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  termion_1_5_1 = { features?(termion_1_5_1_features {}) }: termion_1_5_1_ {
    dependencies = (if !(kernel == "redox") then [ (libc_0_2_33 { features = features; }) ] else [])
      ++ (if kernel == "redox" then [ (redox_syscall_0_1_32 { features = features; }) (redox_termios_0_1_1 { features = features; }) ] else []);
  };
  termion_1_5_1_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        libc_0_2_33.default = true;
        redox_syscall_0_1_32.default = true;
  ...
  textwrap_0_9_0 = { features?(textwrap_0_9_0_features {}) }: textwrap_0_9_0_ {
    dependencies = [ (unicode_width_0_1_4 { features = features; }) ];
  };
  textwrap_0_9_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  thread_local_0_3_4 = { features?(thread_local_0_3_4_features {}) }: thread_local_0_3_4_ {
    dependencies = [ (lazy_static_0_2_11 { features = features; }) (unreachable_1_0_0 { features = features; }) ];
  };
  thread_local_0_3_4_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  time_0_1_38 = { features?(time_0_1_38_features {}) }: time_0_1_38_ {
    dependencies = [ (libc_0_2_33 { features = features; }) ]
      ++ (if kernel == "redox" then [ (redox_syscall_0_1_32 { features = features; }) ] else [])
      ++ (if kernel == "windows" then [ (kernel32_sys_0_2_2 { features = features; }) (winapi_0_2_8 { features = features; }) ] else []);
  };
  time_0_1_38_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        kernel32_sys_0_2_2.default = true;
        libc_0_2_33.default = true;
  ...
  toml_0_4_5 = { features?(toml_0_4_5_features {}) }: toml_0_4_5_ {
    dependencies = [ (serde_1_0_21 { features = features; }) ];
  };
  toml_0_4_5_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
        serde_1_0_21.default = true;
  ...
  unicode_width_0_1_4_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
  ...
  unreachable_1_0_0 = { features?(unreachable_1_0_0_features {}) }: unreachable_1_0_0_ {
    dependencies = [ (void_1_0_2 { features = features; }) ];
  };
  unreachable_1_0_0_features = f:
    builtins.deepSeq f (lib.lists.foldl' (features: fun: fun features)
      (lib.attrsets.recursiveUpdate f (rec {
