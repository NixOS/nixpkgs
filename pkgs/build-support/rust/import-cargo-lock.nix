...
let
  ...
  #     Nix >= 2.4 has become more careful about the string context of contents
  #     read from the store. This affects nixosTests.nixops, which evaluates
  #     expression sources from the store.
  #     Fixes the error:
  #         deployer # error: the string '# This file is automatically @generated by Cargo.
  #         deployer #        # It is not intended for manual editing.
  #         deployer #        [[package]]
  #         deployer #        name = "make-initrd-ng"
  #         deployer #        version = "0.1.0"
  #         deployer #        ' is not allowed to refer to a store path (such as '/nix/store/<hash>-multiple-outputs.sh')
