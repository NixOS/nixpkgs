...
''}
  ...
  export CARGO_CFG_TARGET_ARCH=${stdenv.hostPlatform.rust.targetArch}
  export CARGO_CFG_TARGET_OS=${stdenv.hostPlatform.rust.targetOs}
  ...
  export TARGET="${stdenv.hostPlatform.rust.targetSpec}"
  export HOST="${stdenv.buildPlatform.rust.targetSpec}"
