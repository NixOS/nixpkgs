...
let
  ...
  mkFeatures = feat: lib.lists.foldl
...
rec {
  ...
  alloc_no_stdlib_1_3_0_features = f: updateFeatures
    f
    ({
  ...
  brotli_2_5_0_features = f: updateFeatures
    f
    (rec {
  ...
  brotli_decompressor_1_3_1_features = f: updateFeatures
    f
    (rec {
      alloc_no_stdlib_1_3_0.no-stdlib =
        (f.alloc_no_stdlib_1_3_0.no-stdlib or false) ||
