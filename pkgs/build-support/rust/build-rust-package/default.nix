{ lib, importCargoLock, fetchCargoTarball, rust, stdenv, callPackage, cacert
, git, cargoBuildHook, cargoCheckHook, cargoInstallHook, cargoSetupHook, rustc
, libiconv, windows }:
...
, src ? null, srcs ? null, unpackPhase ? null, cargoPatches ? [ ], patches ? [ ]
, sourceRoot ? null, logLevel ? "", buildInputs ? [ ], nativeBuildInputs ? [ ]
...
, checkFeatures ? buildFeatures, depsExtraArgs ? { }
...
assert cargoVendorDir == null && cargoLock == null -> !(args ? cargoSha256)
  && !(args ? cargoHash)
...
stdenv.mkDerivation ((removeAttrs args [ "depsExtraArgs" "cargoLock" ])
