...
, auditable ? !cargo-auditable.meta.broken && (!stdenv.hostPlatform.isStatic || !stdenv.hostPlatform.isAarch64 || stdenv.hostPlatform.isDarwin) && !stdenv.hostPlatform.isWasi
