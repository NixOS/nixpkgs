...
let
  ...
  cargoDeps =
    ...
    else if useCustomVendorFetcher then fetchCargoVendor {
      inherit src srcs sourceRoot preUnpack unpackPhase postUnpack; # TODO: improve
      hash = args.cargoHash;
    }
