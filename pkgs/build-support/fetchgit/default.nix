      ...
      */
      ...
      // {
        ...
        sparseCheckoutText =
          ...
          assert (
            assertMsg (isList finalAttrs.sparseCheckout) "Please provide directories/patterns for sparse checkout as a list of strings. Passing a (multi-line) string is not supported any more."
          );
