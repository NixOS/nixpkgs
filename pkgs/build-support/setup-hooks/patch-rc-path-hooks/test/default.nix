    ...
    (
      ...
      runCommandLocal "patch-rc-path-csh-test"
        ...
        ''
          ...
          substitute ${./sample_source.csh.in} sample_source.csh --replace @sed@ ${lib.getExe gnused}
    ...
    (
      ...
      runCommandLocal "patch-rc-path-posix-test"
        ...
        ''
          ...
          substitute ${./sample_source.sh.in} sample_source.sh --replace @sed@ ${lib.getExe gnused}
