...
# Tests whether inputElem1 occurs without, or after, inputElem2 in inputArrRef.
#
# Arguments:
...
#
# Returns 0 if inputElem1 occurs and inputElem2 does not, or if inputElem1 occurs after inputElem2.
# Returns 1 otherwise.
occursOnlyOrAfterInArray() {
  if (($# != 3)); then
