...
#
# Arguments:
# - inputArrRef: a reference to an array (not mutated, may alias outputArrRef)
# - outputArrRef: a reference to an array (mutated only by appending, may alias inputArrRef)
#
# Returns 0.
sortArray() {
  if (($# != 2)); then
