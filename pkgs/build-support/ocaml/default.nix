...
, createFindlibDestdir ? true, dontStrip ? true
, minimumSupportedOcamlVersion ? null, hasSharedObjects ? false
, setupHook ? null, meta ? { }, ... }@args:
...
stdenv.mkDerivation (args // {
  ...
  setupHook = if setupHook == null && hasSharedObjects then
