...
lib.makeOverridable (
  lib.extendMkDerivation {
    ...
    excludeDrvArgNames = [
      ...
      # Remove iff we decide to make fetchFromGitHub take `useFetchGit`.
      # Specifying `useFetchGit` as a boolean value will non-overridably force the backend choice.
      "useFetchGit"
    ];
  ...
  let
    ...
    getPrivateAttrs = useFetchGit: lib.optionalAttrs private {
      netrcPhase =
