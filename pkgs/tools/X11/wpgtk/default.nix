...
python3Packages.buildPythonApplication rec {
  ...
  meta = with lib; {
    ...
    longDescription = ''
     ...
     wpgtk uses pywal as its colorscheme generator, but builds upon it with a UI and other features, such as the ability to mix and edit the colorschemes generated and save them with their respective wallpapers, having light and dark themes, hackable and fast GTK theme made specifically for wpgtk and custom keywords and values to replace in templates.
