{stdenv, fetchurl, bzip2, zlib, newt, libssl, pkgconfig, slang
...
stdenv.mkDerivation {
  ...
  configureFlags = "--with-ssl-headers=${libssl}/include/openssl";

  buildInputs = [bzip2 zlib newt newt libssl pkgconfig slang
    # automake autoconf libtool gettext
  ];
