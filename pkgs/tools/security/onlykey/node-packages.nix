...
let
  sources = {
    ...
    "nw-0.55.0" = {
      ...
      version = "0.55.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/nw/-/nw-0.55.0.tgz";
        sha512 = "/EYsT55LJraJCZeSCpJoXnftsLtR+8lbhEXABlhye/n+0//F+v9kYsGLbnC+SS3JN7NQksnv/WcnoLVjL1WXcg==";
      };
    };
...
in
{
  "onlykey-git://github.com/trustcrypto/OnlyKey-App.git#v5.3.4" = nodeEnv.buildNodePackage {
    name = "OnlyKey";
    packageName = "OnlyKey";
    version = "5.3.4";
    src = fetchgit {
