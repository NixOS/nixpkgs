{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "_babel_plugin_proposal_async-generator_functions___plugin_proposal_async_generator_functions_7.16.5.tgz";
      path = fetchurl {
        name = "_babel_plugin_proposal_async-generator_functions___plugin_proposal_async_generator_functions_7.16.5.tgz";
    ...
    {
      name = "_testing_library_jest_dom___jest_dom_5.16.1.tgz";
      path = fetchurl {
        name = "_testing_library_jest_dom___jest_dom_5.16.1.tgz";
        url  = "https://registry.yarnpkg.com/@testing-library/jest-dom/-/jest-dom-5.16.1.tgz";
