...
buildGoModule rec {
  ...
  sdkVendorHash = "sha256-afgmZmcQXFYKjSLc7FV/LvKyGNgWdVu2cbvD+NuQn10=";

  src = fetchFromGitHub {
    owner = pname;
    repo = pname;
    rev = "v${version}";
    hash = "sha256-PZqtCwgA020C6etw/9ChDvn7wFtBpk/pypNBZStDfCQ=";
    # Some tests rely on checkout directory name
    name = "pulumi";
  };

  vendorHash = "sha256-rApXZUwbrcnXCohhM6Dc7L5AUC4qtmQEG3FM6vkFTMc=";
