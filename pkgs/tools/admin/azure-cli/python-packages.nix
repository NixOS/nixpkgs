...
let
  ...
  py = python3.override {
    packageOverrides = self: super: {
      ...
      azure-mgmt-compute =
        overrideAzureMgmtPackage super.azure-mgmt-compute "30.6.0" "tar.gz"
          "sha256-TYDXI+xtTLlYNhfr7AcW59dLJzKsuu0CPtLjzHBT0A4=";
      azure-mgmt-core =
      ...
      azure-mgmt-rdbms =
        overrideAzureMgmtPackage super.azure-mgmt-rdbms "10.2.0b14" "tar.gz"
          "sha256-hfgSrWZKUJNU9CeAyETCrKWKxmCyk9kId8RYSNsKwBM=";
      ...
      azure-mgmt-sql =
        overrideAzureMgmtPackage super.azure-mgmt-sql "4.0.0b16" "tar.gz"
          "sha256-+6QKEROlbXe0oCj4qtB+r4/yCPZD4N+71e5Z1Z/zXV0=";
