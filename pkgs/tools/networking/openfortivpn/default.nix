...
let withSystemd = stdenv.isLinux && !(systemd == null);
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl ppp ] ++ lib.optional withSystemd systemd;

  configureFlags = [ "--sysconfdir=/etc" "--with-pppd=${ppp}/bin/pppd" ]
