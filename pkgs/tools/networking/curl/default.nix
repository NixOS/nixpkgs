{ stdenv, lib, fetchurl, pkg-config, perl, http2Support ? true, nghttp2
, idnSupport ? false, libidn ? null, ldapSupport ? false, openldap ? null
, zlibSupport ? true, zlib ? null, opensslSupport ? zlibSupport, openssl ? null
, gnutlsSupport ? false, gnutls ? null, wolfsslSupport ? false, wolfssl ? null
, scpSupport ? zlibSupport && !stdenv.isSunOS && !stdenv.isCygwin
, libssh2 ? null, gssSupport ? with stdenv.hostPlatform;
  (!isWindows &&
...
, libkrb5 ? null, c-aresSupport ? false, c-ares ? null, brotliSupport ? false
, brotli ? null }:
...
stdenv.mkDerivation rec {
  ...
  propagatedBuildInputs = with lib;
    ...
    ++ optional opensslSupport openssl ++ optional gnutlsSupport gnutls
    ++ optional wolfsslSupport wolfssl ++ optional scpSupport libssh2
  ...
  passthru = { inherit opensslSupport openssl; };
