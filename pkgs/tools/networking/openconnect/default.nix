{ lib, stdenv, fetchurl, pkg-config, openssl ? null, gnutls ? null, gmp, libxml2
, stoken, zlib, vpnc-scripts, PCSC, head ? false, fetchFromGitLab
, autoreconfHook }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ pkg-config ] ++ lib.optional head autoreconfHook;
