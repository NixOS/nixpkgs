...
, enableNetworkManager ? false, networkmanager, darwin }:
...
stdenv.mkDerivation rec {
  pname = "strongswan";
  version =
    "5.9.4"; # Make sure to also update <nixpkgs/nixos/modules/services/networking/strongswan-swanctl/swanctl-params.nix> when upgrading!
