{ lib, stdenv, fetchurl, fetchpatch, openssl, libpcap, python2
, withPython ? false }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://raw.githubusercontent.com/archlinux/svntogit-packages/15b11be49997fa94b603e366064690b7cc6bce61/trunk/vde_cryptcab-compile-against-openssl-1.1.0.patch";
  ...
  buildInputs = [ openssl libpcap ] ++ lib.optional withPython python2;
