...

{
  ...
  by-version."base64-url"."1.0.0" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/base64-url/-/base64-url-1.0.0.tgz";
  ...
  by-version."bl"."0.9.3" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/bl/-/bl-0.9.3.tgz";
        name = "bl-0.9.3.tgz";
  ...
  by-version."combined-stream"."0.0.5" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/combined-stream/-/combined-stream-0.0.5.tgz";
  ...
  by-version."connect-redis"."2.1.0" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/connect-redis/-/connect-redis-2.1.0.tgz";
  ...
  by-version."http-signature"."0.10.0" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/http-signature/-/http-signature-0.10.0.tgz";
  ...
  by-version."mz"."1.0.1" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/mz/-/mz-1.0.1.tgz";
        name = "mz-1.0.1.tgz";
  ...
  by-version."native-or-bluebird"."1.1.1" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/native-or-bluebird/-/native-or-bluebird-1.1.1.tgz";
  ...
  by-version."punycode"."1.3.1" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/punycode/-/punycode-1.3.1.tgz";
  ...
  by-version."request"."2.44.0" = lib.makeOverridable self.buildNodePackage {
    ...
    src = [
      (fetchurl {
        url = "https://registry.npmjs.org/request/-/request-2.44.0.tgz";
