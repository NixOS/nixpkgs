...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      url =
        "https://gitlab.com/gnuwget/wget2/-/commit/da9788f5d62b89ba796393d9bc496b1d8d7a7b30.patch";
      sha256 = "0bn3vkgyknks7jzs5722s2c4qlx7k5lwfiyz204bi42v1m28s1a5";
    })
    (fetchpatch {
      name = "fix-double-quotes-in-configure-ac.patch";
      url =
        "https://gitlab.com/gnuwget/wget2/-/commit/574c8ae08dfd8949da039879d85899123d31ab1d.patch";
