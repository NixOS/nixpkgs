{ lib, stdenv, makeWrapper, fetchurl, which, pkg-config, ocamlPackages, libao
, portaudio, alsa-lib, libpulseaudio, libjack2, libsamplerate, libmad, taglib
, lame, libogg, libvorbis, speex, libtheora, libopus, zlib, faad2, flac, ladspaH
, ffmpeg, frei0r, dssi }:
...
in stdenv.mkDerivation {
  ...
  src = fetchurl {
    url =
      "https://github.com/savonet/${pname}/releases/download/v${version}/${pname}-${version}-full.tar.gz";
