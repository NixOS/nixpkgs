...
stdenv.mkDerivation (
  ...
  {
    pname = "netdata";
    version = "2.7.1-unstable-2025-09-30";

    src = fetchFromGitHub {
      owner = "netdata";
      repo = "netdata";
      rev = "cad02713b92f9a026b1683ffdedacc2f993227dc";
      hash = "sha256-vmN0u9yIOaQiDHlAzIZsbXebAJJ8bZhi3/uDZ8rxXfo=";
    ...
    preConfigure = ''
      ...
      substituteInPlace CMakeLists.txt \
        ...
        --replace-fail 'set(NETDATA_BIN_DIR "''${NETDATA_RUNTIME_PREFIX}/''${BINDIR}")' 'set(NETDATA_BIN_DIR "${placeholder "out"}/bin")' \
    ...
    passthru = rec {
      ...
      netdata-go-modules =
        (buildGoModule {
          ...
          vendorHash = "sha256-b0GQ9utvL4NmS3tg2t0n11rxx2UgYp2K/yRBHbb4LDQ=";
          proxyVendor = true;
          doCheck = false;
