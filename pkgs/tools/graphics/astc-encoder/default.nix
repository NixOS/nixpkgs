{ lib, gccStdenv, fetchFromGitHub, cmake, simdExtensions ? null }:
...
with rec {
  ...
  archFlags =
    lib.optionals gccStdenv.hostPlatform.isAarch64 [ "-DARCH=aarch64" ];
  ...
  mainBinary = builtins.replaceStrings [ "AVX2" "SSE41" "SSE2" "NEON" "NONE" ] [
    "avx2"
    "sse4.1"
    "sse2"
    "neon"
...
gccStdenv.mkDerivation rec {
  ...
  cmakeFlags = isaFlags ++ archFlags ++ [ "-DCMAKE_BUILD_TYPE=Release" ];
