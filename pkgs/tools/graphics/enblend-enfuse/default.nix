{ lib, stdenv, fetchurl, boost, freeglut, glew, gsl, lcms2, libpng, libtiff
, libGLU, libGL, vigra, help2man, pkg-config, perl, texlive }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs =
    [ help2man perl pkg-config texlive.combined.scheme-small ];
