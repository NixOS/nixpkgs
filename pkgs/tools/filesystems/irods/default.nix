...
rec {
  ...
  irods = stdenv.mkDerivation (finalAttrs: common // {
    ...
    postPatch = common.postPatch + ''
      patchShebangs ./test
      substituteInPlace plugins/database/CMakeLists.txt --replace-warn "COMMAND cpp" "COMMAND ${gcc.cc}/bin/cpp"
      ...
      substituteInPlace server/auth/CMakeLists.txt --replace-warn SETUID ""
    '';
