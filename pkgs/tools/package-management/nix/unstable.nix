...
stdenv.mkDerivation rec {
  name = "nix-1.9pre4103_1f795f9";

  src = fetchurl {
    url = "http://hydra.nixos.org/build/21814241/download/4/${name}.tar.xz";
    sha256 = "d05d8a12bca80146c2d30da282ba6b787af75aac8d91a84bed87a7882cd63572";
  };
