...
stdenv.mkDerivation (finalAttrs: {
  ...
  mesonFlags =
    [
      ...
      (lib.mesonEnable "perl:tests" (finalAttrs.finalPackage.doCheck && !stdenv.hostPlatform.isDarwin))
  ...
  passthru = {
    ...
    # TODO:
    # perl-bindings = perl.pkgs.toPerlModule (callPackage ./nix-perl.nix { nix = finalAttrs.finalPackage; inherit Security; });
