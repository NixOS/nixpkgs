...
in rec {
  ...
  deps.adler32."1.0.2" = { };
  deps.aho_corasick."0.5.3" = { memchr = "0.1.11"; };
  deps.ansi_term."0.9.0" = { };
  deps.arrayvec."0.4.8" = { nodrop = "0.1.13"; };
  deps.atty."0.2.3" = {
    termion = "1.5.1";
    libc = "0.2.44";
    kernel32_sys = "0.2.2";
  ...
  deps.conv."0.3.3" = { custom_derive = "0.1.7"; };
  deps.core_foundation."0.5.1" = {
    core_foundation_sys = "0.5.1";
    libc = "0.2.44";
  };
  deps.core_foundation_sys."0.5.1" = { libc = "0.2.44"; };
  ...
  deps.crossbeam_utils."0.6.1" = { cfg_if = "0.1.2"; };
  ...
  deps.dtoa."0.4.2" = { };
  deps.either."1.4.0" = { };
  deps.encoding_rs."0.8.13" = { cfg_if = "0.1.2"; };
  deps.exitcode."1.1.2" = { };
  ...
  deps.fnv."1.0.6" = { };
  deps.foreign_types."0.3.2" = { foreign_types_shared = "0.1.1"; };
  deps.foreign_types_shared."0.1.1" = { };
  deps.fuchsia_zircon."0.2.1" = { fuchsia_zircon_sys = "0.2.0"; };
  deps.fuchsia_zircon."0.3.3" = {
    bitflags = "1.0.4";
    fuchsia_zircon_sys = "0.3.3";
  };
  deps.fuchsia_zircon_sys."0.2.0" = { bitflags = "0.7.0"; };
  ...
  deps.itertools."0.6.5" = { either = "1.4.0"; };
  deps.itoa."0.3.4" = { };
  deps.itoa."0.4.3" = { };
  ...
  deps.log."0.3.8" = { };
  deps.log."0.4.6" = { cfg_if = "0.1.2"; };
  deps.maplit."0.1.6" = { };
  deps.matches."0.1.6" = { };
  deps.memchr."0.1.11" = { libc = "0.2.44"; };
  deps.memoffset."0.2.1" = { };
  deps.mime."0.3.12" = { unicase = "2.1.0"; };
  ...
  deps.num_integer."0.1.35" = { num_traits = "0.1.40"; };
  deps.num_iter."0.1.34" = {
    num_integer = "0.1.35";
    num_traits = "0.1.40";
  };
  deps.num_traits."0.1.40" = { };
  deps.num_cpus."1.8.0" = { libc = "0.2.44"; };
  ...
  deps.owning_ref."0.4.0" = { stable_deref_trait = "1.1.1"; };
  ...
  deps.phf."0.7.21" = { phf_shared = "0.7.21"; };
  ...
  deps.rand_core."0.2.2" = { rand_core = "0.3.0"; };
  deps.rand_core."0.3.0" = { };
  deps.rand_hc."0.1.0" = { rand_core = "0.3.0"; };
  deps.rand_isaac."0.1.1" = { rand_core = "0.3.0"; };
  deps.rand_pcg."0.1.1" = {
    rand_core = "0.3.0";
    rustc_version = "0.2.3";
  };
  deps.rand_xorshift."0.1.0" = { rand_core = "0.3.0"; };
  deps.redox_syscall."0.1.31" = { };
  deps.redox_termios."0.1.1" = { redox_syscall = "0.1.31"; };
  deps.regex."0.1.80" = {
    aho_corasick = "0.5.3";
    memchr = "0.1.11";
    regex_syntax = "0.3.9";
  ...
  deps.rustc_version."0.2.3" = { semver = "0.9.0"; };
  deps.safemem."0.3.0" = { };
  ...
  deps.semver."0.9.0" = { semver_parser = "0.7.0"; };
  ...
  deps.smallvec."0.6.7" = { unreachable = "1.0.0"; };
  ...
  deps.synom."0.11.3" = { unicode_xid = "0.0.4"; };
  deps.tar."0.4.13" = {
    filetime = "0.1.14";
    libc = "0.2.44";
    xattr = "0.1.11";
  ...
  deps.textwrap."0.9.0" = { unicode_width = "0.1.4"; };
  deps.thread_id."2.0.0" = {
    kernel32_sys = "0.2.2";
    libc = "0.2.44";
  };
  deps.thread_local."0.2.7" = { thread_id = "2.0.0"; };
  ...
  deps.tokio_executor."0.1.5" = { futures = "0.1.25"; };
  deps.tokio_fs."0.1.4" = {
    futures = "0.1.25";
    tokio_io = "0.1.10";
    tokio_threadpool = "0.1.9";
  ...
  deps.try_lock."0.2.2" = { };
  deps.unicase."1.4.2" = { version_check = "0.1.3"; };
  deps.unicase."2.1.0" = { version_check = "0.1.3"; };
  deps.unicode_bidi."0.3.4" = { matches = "0.1.6"; };
  deps.unicode_normalization."0.1.5" = { };
  deps.unicode_width."0.1.4" = { };
  deps.unicode_xid."0.0.4" = { };
  deps.unreachable."1.0.0" = { void = "1.0.2"; };
  deps.url."1.6.1" = {
    idna = "0.1.4";
    matches = "0.1.6";
