...
in rec {
  ...
  crates.adler32."1.0.2" = deps:
    { features ? (features_.adler32."1.0.2" deps { }) }:
    buildRustCrate {
      crateName = "adler32";
      version = "1.0.2";
  ...
  features_.adler32."1.0.2" = deps: f:
    updateFeatures f ({
  ...
  crates.ansi_term."0.9.0" = deps:
    { features ? (features_.ansi_term."0.9.0" deps { }) }:
    buildRustCrate {
      crateName = "ansi_term";
      version = "0.9.0";
      description =
  ...
  features_.ansi_term."0.9.0" = deps: f:
    updateFeatures f ({
  ...
  crates.arrayvec."0.4.8" = deps:
    { features ? (features_.arrayvec."0.4.8" deps { }) }:
    buildRustCrate {
      crateName = "arrayvec";
      version = "0.4.8";
      description =
  ...
  features_.arrayvec."0.4.8" = deps: f:
    updateFeatures f (rec {
      arrayvec = fold recursiveUpdate { } [
        {
          "0.4.8"."serde" = (f.arrayvec."0.4.8"."serde" or false)
            || (f.arrayvec."0.4.8".serde-1 or false)
            || (arrayvec."0.4.8"."serde-1" or false);
        }
        {
          "0.4.8"."std" = (f.arrayvec."0.4.8"."std" or false)
            || (f.arrayvec."0.4.8".default or false)
            || (arrayvec."0.4.8"."default" or false);
        }
        { "0.4.8".default = (f.arrayvec."0.4.8".default or true); }
      ];
      nodrop."${deps.arrayvec."0.4.8".nodrop}".default =
        (f.nodrop."${deps.arrayvec."0.4.8".nodrop}".default or false);
    }) [ (features_.nodrop."${deps."arrayvec"."0.4.8"."nodrop"}" deps) ];

  # end
  # atty-0.2.3

  crates.atty."0.2.3" = deps:
    { features ? (features_.atty."0.2.3" deps { }) }:
    buildRustCrate {
      crateName = "atty";
      version = "0.2.3";
      ...
      dependencies = (if kernel == "redox" then
        ...
        [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
          ...
          [ ]) ++ (if kernel == "windows" then
            mapFeatures features ([
              (crates."kernel32_sys"."${deps."atty"."0.2.3"."kernel32_sys"}"
                deps)
  ...
  features_.atty."0.2.3" = deps: f:
    updateFeatures f ({
      atty."0.2.3".default = (f.atty."0.2.3".default or true);
      kernel32_sys."${deps.atty."0.2.3".kernel32_sys}".default = true;
      libc."${deps.atty."0.2.3".libc}".default =
        (f.libc."${deps.atty."0.2.3".libc}".default or false);
  ...
  crates.base64."0.9.3" = deps:
    { features ? (features_.base64."0.9.3" deps { }) }:
    buildRustCrate {
      crateName = "base64";
      version = "0.9.3";
  ...
  crates.byteorder."1.1.0" = deps:
    { features ? (features_.byteorder."1.1.0" deps { }) }:
    buildRustCrate {
      crateName = "byteorder";
      version = "1.1.0";
      description =
  ...
  features_.byteorder."1.1.0" = deps: f:
    updateFeatures f (rec {
      byteorder = fold recursiveUpdate { } [
        {
          "1.1.0"."std" = (f.byteorder."1.1.0"."std" or false)
  ...
  crates.cargo_download."0.1.2" = deps:
    { features ? (features_.cargo_download."0.1.2" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."derive_error"."${deps."cargo_download"."0.1.2"."derive_error"}"
          deps)
        ...
        (crates."lazy_static"."${deps."cargo_download"."0.1.2"."lazy_static"}"
          deps)
        ...
        (crates."serde_json"."${deps."cargo_download"."0.1.2"."serde_json"}"
          deps)
        (crates."slog"."${deps."cargo_download"."0.1.2"."slog"}" deps)
        (crates."slog_envlogger"."${deps."cargo_download"."0.1.2"."slog_envlogger"}"
          deps)
        (crates."slog_stdlog"."${deps."cargo_download"."0.1.2"."slog_stdlog"}"
          deps)
        (crates."slog_stream"."${deps."cargo_download"."0.1.2"."slog_stream"}"
          deps)
        (crates."tar"."${deps."cargo_download"."0.1.2"."tar"}" deps)
        (crates."time"."${deps."cargo_download"."0.1.2"."time"}" deps)
      ]);
    };
  features_.cargo_download."0.1.2" = deps: f:
    updateFeatures f ({
      ansi_term."${deps.cargo_download."0.1.2".ansi_term}".default = true;
      cargo_download."0.1.2".default =
        (f.cargo_download."0.1.2".default or true);
      ...
      slog_envlogger."${deps.cargo_download."0.1.2".slog_envlogger}".default =
        true;
      ...
      (features_.derive_error."${deps."cargo_download"."0.1.2"."derive_error"}"
        deps)
      ...
      (features_.lazy_static."${deps."cargo_download"."0.1.2"."lazy_static"}"
        deps)
      ...
      (features_.serde_json."${deps."cargo_download"."0.1.2"."serde_json"}"
        deps)
      (features_.slog."${deps."cargo_download"."0.1.2"."slog"}" deps)
      (features_.slog_envlogger."${deps."cargo_download"."0.1.2"."slog_envlogger"}"
        deps)
      (features_.slog_stdlog."${deps."cargo_download"."0.1.2"."slog_stdlog"}"
        deps)
      (features_.slog_stream."${deps."cargo_download"."0.1.2"."slog_stream"}"
        deps)
  ...
  crates.case."0.1.0" = deps:
    { features ? (features_.case."0.1.0" deps { }) }:
    buildRustCrate {
      crateName = "case";
      version = "0.1.0";
  ...
  crates.cc."1.0.3" = deps:
    { features ? (features_.cc."1.0.3" deps { }) }:
    buildRustCrate {
      crateName = "cc";
      version = "1.0.3";
      description = ''
  ...
  features_.cc."1.0.3" = deps: f:
    updateFeatures f (rec {
      cc = fold recursiveUpdate { } [
        {
          "1.0.3"."rayon" = (f.cc."1.0.3"."rayon" or false)
  ...
  crates.cfg_if."0.1.2" = deps:
    { features ? (features_.cfg_if."0.1.2" deps { }) }:
    buildRustCrate {
      crateName = "cfg-if";
      version = "0.1.2";
      description = ''
  ...
  crates.chrono."0.2.25" = deps:
    { features ? (features_.chrono."0.2.25" deps { }) }:
    buildRustCrate {
      crateName = "chrono";
      version = "0.2.25";
  ...
  features_.chrono."0.2.25" = deps: f:
    updateFeatures f ({
      chrono."0.2.25".default = (f.chrono."0.2.25".default or true);
      num."${deps.chrono."0.2.25".num}".default =
        (f.num."${deps.chrono."0.2.25".num}".default or false);
  ...
  crates.clap."2.27.1" = deps:
    { features ? (features_.clap."2.27.1" deps { }) }:
    buildRustCrate {
      crateName = "clap";
      version = "2.27.1";
      description = ''
      ...
      ] ++ (if features.clap."2.27.1".ansi_term or false then
        [ (crates.ansi_term."${deps."clap"."2.27.1".ansi_term}" deps) ]
      else
        [ ]) ++ (if features.clap."2.27.1".atty or false then
          [ (crates.atty."${deps."clap"."2.27.1".atty}" deps) ]
        else
          [ ]) ++ (if features.clap."2.27.1".strsim or false then
            [ (crates.strsim."${deps."clap"."2.27.1".strsim}" deps) ]
          else
            [ ]) ++ (if features.clap."2.27.1".vec_map or false then
              [ (crates.vec_map."${deps."clap"."2.27.1".vec_map}" deps) ]
            else
              [ ]));
      features = mkFeatures (features."clap"."2.27.1" or { });
    };
  features_.clap."2.27.1" = deps: f:
    updateFeatures f (rec {
      ...
      clap = fold recursiveUpdate { } [
        {
          "2.27.1"."ansi_term" = (f.clap."2.27.1"."ansi_term" or false)
            || (f.clap."2.27.1".color or false)
            || (clap."2.27.1"."color" or false);
        }
        {
          "2.27.1"."atty" = (f.clap."2.27.1"."atty" or false)
            || (f.clap."2.27.1".color or false)
            || (clap."2.27.1"."color" or false);
        }
        {
          "2.27.1"."clippy" = (f.clap."2.27.1"."clippy" or false)
            || (f.clap."2.27.1".lints or false)
            || (clap."2.27.1"."lints" or false);
        }
        {
          "2.27.1"."color" = (f.clap."2.27.1"."color" or false)
            || (f.clap."2.27.1".default or false)
            || (clap."2.27.1"."default" or false);
        }
        {
          "2.27.1"."strsim" = (f.clap."2.27.1"."strsim" or false)
            || (f.clap."2.27.1".suggestions or false)
            || (clap."2.27.1"."suggestions" or false);
        }
        {
          "2.27.1"."suggestions" = (f.clap."2.27.1"."suggestions" or false)
            || (f.clap."2.27.1".default or false)
            || (clap."2.27.1"."default" or false);
        }
        {
          "2.27.1"."term_size" = (f.clap."2.27.1"."term_size" or false)
            || (f.clap."2.27.1".wrap_help or false)
            || (clap."2.27.1"."wrap_help" or false);
        }
        {
          "2.27.1"."vec_map" = (f.clap."2.27.1"."vec_map" or false)
            || (f.clap."2.27.1".default or false)
            || (clap."2.27.1"."default" or false);
        }
        {
          "2.27.1"."yaml" = (f.clap."2.27.1"."yaml" or false)
            || (f.clap."2.27.1".doc or false) || (clap."2.27.1"."doc" or false);
        }
        {
          "2.27.1"."yaml-rust" = (f.clap."2.27.1"."yaml-rust" or false)
  ...
  crates.conv."0.3.3" = deps:
    { features ? (features_.conv."0.3.3" deps { }) }:
    buildRustCrate {
      crateName = "conv";
      version = "0.3.3";
      description =
  ...
  crates.core_foundation."0.5.1" = deps:
    { features ? (features_.core_foundation."0.5.1" deps { }) }:
    buildRustCrate {
  ...
  features_.core_foundation."0.5.1" = deps: f:
    updateFeatures f (rec {
      ...
      (features_.core_foundation_sys."${deps."core_foundation"."0.5.1"."core_foundation_sys"}"
        deps)
  ...
  crates.core_foundation_sys."0.5.1" = deps:
    { features ? (features_.core_foundation_sys."0.5.1" deps { }) }:
    buildRustCrate {
  ...
  features_.core_foundation_sys."0.5.1" = deps: f:
    updateFeatures f ({
      core_foundation_sys."0.5.1".default =
        (f.core_foundation_sys."0.5.1".default or true);
  ...
  crates.crc32fast."1.1.1" = deps:
    { features ? (features_.crc32fast."1.1.1" deps { }) }:
    buildRustCrate {
      crateName = "crc32fast";
      version = "1.1.1";
  ...
  features_.crc32fast."1.1.1" = deps: f:
    updateFeatures f ({
  ...
  crates.crossbeam."0.2.10" = deps:
    { features ? (features_.crossbeam."0.2.10" deps { }) }:
    buildRustCrate {
      crateName = "crossbeam";
      version = "0.2.10";
      description =
  ...
  features_.crossbeam."0.2.10" = deps: f:
    updateFeatures f ({
  ...
  crates.crossbeam_deque."0.6.2" = deps:
    { features ? (features_.crossbeam_deque."0.6.2" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."crossbeam_epoch"."${deps."crossbeam_deque"."0.6.2"."crossbeam_epoch"}"
          deps)
        (crates."crossbeam_utils"."${deps."crossbeam_deque"."0.6.2"."crossbeam_utils"}"
          deps)
      ]);
    };
  features_.crossbeam_deque."0.6.2" = deps: f:
    updateFeatures f ({
      crossbeam_deque."0.6.2".default =
        (f.crossbeam_deque."0.6.2".default or true);
      crossbeam_epoch."${deps.crossbeam_deque."0.6.2".crossbeam_epoch}".default =
        true;
      crossbeam_utils."${deps.crossbeam_deque."0.6.2".crossbeam_utils}".default =
        true;
    }) [
      (features_.crossbeam_epoch."${deps."crossbeam_deque"."0.6.2"."crossbeam_epoch"}"
        deps)
      (features_.crossbeam_utils."${deps."crossbeam_deque"."0.6.2"."crossbeam_utils"}"
        deps)
    ];
  ...
  crates.crossbeam_epoch."0.6.1" = deps:
    { features ? (features_.crossbeam_epoch."0.6.1" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."crossbeam_utils"."${deps."crossbeam_epoch"."0.6.1"."crossbeam_utils"}"
          deps)
        (crates."memoffset"."${deps."crossbeam_epoch"."0.6.1"."memoffset"}"
          deps)
        (crates."scopeguard"."${deps."crossbeam_epoch"."0.6.1"."scopeguard"}"
          deps)
      ] ++ (if features.crossbeam_epoch."0.6.1".lazy_static or false then
        [
          (crates.lazy_static."${deps."crossbeam_epoch"."0.6.1".lazy_static}"
            deps)
        ]
      else
        [ ]));
  ...
  features_.crossbeam_epoch."0.6.1" = deps: f:
    updateFeatures f (rec {
      arrayvec = fold recursiveUpdate { } [
        {
        ...
        {
          "${deps.crossbeam_epoch."0.6.1".arrayvec}".default =
            (f.arrayvec."${deps.crossbeam_epoch."0.6.1".arrayvec}".default or false);
        }
      ];
      ...
      crossbeam_epoch = fold recursiveUpdate { } [
        ...
        {
          "0.6.1"."std" = (f.crossbeam_epoch."0.6.1"."std" or false)
      ...
      crossbeam_utils = fold recursiveUpdate { } [
        ...
        {
          "${deps.crossbeam_epoch."0.6.1".crossbeam_utils}".default =
            (f.crossbeam_utils."${deps.crossbeam_epoch."0.6.1".crossbeam_utils}".default or false);
        }
      ];
      ...
      scopeguard."${deps.crossbeam_epoch."0.6.1".scopeguard}".default =
        (f.scopeguard."${deps.crossbeam_epoch."0.6.1".scopeguard}".default or false);
    }) [
      (features_.arrayvec."${deps."crossbeam_epoch"."0.6.1"."arrayvec"}" deps)
      (features_.cfg_if."${deps."crossbeam_epoch"."0.6.1"."cfg_if"}" deps)
      (features_.crossbeam_utils."${deps."crossbeam_epoch"."0.6.1"."crossbeam_utils"}"
        deps)
      (features_.lazy_static."${deps."crossbeam_epoch"."0.6.1"."lazy_static"}"
        deps)
      (features_.memoffset."${deps."crossbeam_epoch"."0.6.1"."memoffset"}" deps)
      (features_.scopeguard."${deps."crossbeam_epoch"."0.6.1"."scopeguard"}"
        deps)
    ];
  ...
  crates.crossbeam_utils."0.6.1" = deps:
    { features ? (features_.crossbeam_utils."0.6.1" deps { }) }:
    buildRustCrate {
  ...
  features_.crossbeam_utils."0.6.1" = deps: f:
    updateFeatures f (rec {
      cfg_if."${deps.crossbeam_utils."0.6.1".cfg_if}".default = true;
      crossbeam_utils = fold recursiveUpdate { } [
        {
          "0.6.1"."std" = (f.crossbeam_utils."0.6.1"."std" or false)
  ...
  crates.custom_derive."0.1.7" = deps:
    { features ? (features_.custom_derive."0.1.7" deps { }) }:
    buildRustCrate {
  ...
  features_.custom_derive."0.1.7" = deps: f:
    updateFeatures f (rec {
      custom_derive = fold recursiveUpdate { } [
        {
          "0.1.7"."std" = (f.custom_derive."0.1.7"."std" or false)
  ...
  crates.derive_error."0.0.3" = deps:
    { features ? (features_.derive_error."0.0.3" deps { }) }:
    buildRustCrate {
  ...
  features_.derive_error."0.0.3" = deps: f:
    updateFeatures f ({
  ...
  crates.dtoa."0.4.2" = deps:
    { features ? (features_.dtoa."0.4.2" deps { }) }:
    buildRustCrate {
      crateName = "dtoa";
      version = "0.4.2";
      description =
  ...
  crates.either."1.4.0" = deps:
    { features ? (features_.either."1.4.0" deps { }) }:
    buildRustCrate {
      crateName = "either";
      version = "1.4.0";
      description = ''
  ...
  features_.either."1.4.0" = deps: f:
    updateFeatures f (rec {
      either = fold recursiveUpdate { } [
        {
          "1.4.0"."use_std" = (f.either."1.4.0"."use_std" or false)
  ...
  crates.encoding_rs."0.8.13" = deps:
    { features ? (features_.encoding_rs."0.8.13" deps { }) }:
    buildRustCrate {
  ...
  features_.encoding_rs."0.8.13" = deps: f:
    updateFeatures f (rec {
      ...
      encoding_rs = fold recursiveUpdate { } [
        ...
        {
          "0.8.13"."simd" = (f.encoding_rs."0.8.13"."simd" or false)
  ...
  crates.exitcode."1.1.2" = deps:
    { features ? (features_.exitcode."1.1.2" deps { }) }:
    buildRustCrate {
      crateName = "exitcode";
      version = "1.1.2";
  ...
  features_.exitcode."1.1.2" = deps: f:
    updateFeatures f ({
  ...
  crates.filetime."0.1.14" = deps:
    { features ? (features_.filetime."0.1.14" deps { }) }:
    buildRustCrate {
      crateName = "filetime";
      version = "0.1.14";
      description = ''
      ...
      dependencies = mapFeatures features
        ...
        ++ (if kernel == "redox" then
          mapFeatures features ([
            (crates."redox_syscall"."${deps."filetime"."0.1.14"."redox_syscall"}"
              deps)
          ])
        else
          [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
  ...
  features_.filetime."0.1.14" = deps: f:
    updateFeatures f ({
      ...
      (features_.redox_syscall."${deps."filetime"."0.1.14"."redox_syscall"}"
        deps)
  ...
  crates.flate2."0.2.20" = deps:
    { features ? (features_.flate2."0.2.20" deps { }) }:
    buildRustCrate {
      crateName = "flate2";
      version = "0.2.20";
      description = ''
      ...
      dependencies = mapFeatures features
        ([ (crates."libc"."${deps."flate2"."0.2.20"."libc"}" deps) ]
          ++ (if features.flate2."0.2.20".miniz-sys or false then
            [ (crates.miniz_sys."${deps."flate2"."0.2.20".miniz_sys}" deps) ]
          else
            [ ]));
      features = mkFeatures (features."flate2"."0.2.20" or { });
    };
  features_.flate2."0.2.20" = deps: f:
    updateFeatures f (rec {
      flate2 = fold recursiveUpdate { } [
        {
          "0.2.20"."futures" = (f.flate2."0.2.20"."futures" or false)
            || (f.flate2."0.2.20".tokio or false)
            || (flate2."0.2.20"."tokio" or false);
        }
        {
          "0.2.20"."libz-sys" = (f.flate2."0.2.20"."libz-sys" or false)
            || (f.flate2."0.2.20".zlib or false)
            || (flate2."0.2.20"."zlib" or false);
        }
        {
          "0.2.20"."miniz-sys" = (f.flate2."0.2.20"."miniz-sys" or false)
            || (f.flate2."0.2.20".default or false)
            || (flate2."0.2.20"."default" or false);
        }
        {
          "0.2.20"."tokio-io" = (f.flate2."0.2.20"."tokio-io" or false)
            || (f.flate2."0.2.20".tokio or false)
            || (flate2."0.2.20"."tokio" or false);
        }
  ...
  crates.fuchsia_zircon."0.2.1" = deps:
    { features ? (features_.fuchsia_zircon."0.2.1" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."fuchsia_zircon_sys"."${deps."fuchsia_zircon"."0.2.1"."fuchsia_zircon_sys"}"
          deps)
      ]);
    };
  features_.fuchsia_zircon."0.2.1" = deps: f:
    updateFeatures f ({
      fuchsia_zircon."0.2.1".default =
        (f.fuchsia_zircon."0.2.1".default or true);
      fuchsia_zircon_sys."${deps.fuchsia_zircon."0.2.1".fuchsia_zircon_sys}".default =
        true;
    }) [
      (features_.fuchsia_zircon_sys."${deps."fuchsia_zircon"."0.2.1"."fuchsia_zircon_sys"}"
        deps)
    ];
  ...
  crates.fuchsia_zircon_sys."0.2.0" = deps:
    { features ? (features_.fuchsia_zircon_sys."0.2.0" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."bitflags"."${deps."fuchsia_zircon_sys"."0.2.0"."bitflags"}"
          deps)
      ]);
    };
  features_.fuchsia_zircon_sys."0.2.0" = deps: f:
    updateFeatures f ({
      bitflags."${deps.fuchsia_zircon_sys."0.2.0".bitflags}".default = true;
      fuchsia_zircon_sys."0.2.0".default =
        (f.fuchsia_zircon_sys."0.2.0".default or true);
    }) [
      (features_.bitflags."${deps."fuchsia_zircon_sys"."0.2.0"."bitflags"}"
        deps)
    ];
  ...
  crates.futures."0.1.25" = deps:
    { features ? (features_.futures."0.1.25" deps { }) }:
    buildRustCrate {
      crateName = "futures";
      version = "0.1.25";
      description = ''
  ...
  features_.futures."0.1.25" = deps: f:
    updateFeatures f (rec {
      futures = fold recursiveUpdate { } [
        {
          "0.1.25"."use_std" = (f.futures."0.1.25"."use_std" or false)
  ...
  crates.futures_cpupool."0.1.7" = deps:
    { features ? (features_.futures_cpupool."0.1.7" deps { }) }:
    buildRustCrate {
  ...
  features_.futures_cpupool."0.1.7" = deps: f:
    updateFeatures f (rec {
      futures = fold recursiveUpdate { } [
        ...
        {
          "${deps.futures_cpupool."0.1.7".futures}".default =
            (f.futures."${deps.futures_cpupool."0.1.7".futures}".default or false);
        }
      ];
  ...
  crates.h2."0.1.13" = deps:
    { features ? (features_.h2."0.1.13" deps { }) }:
    buildRustCrate {
      crateName = "h2";
      version = "0.1.13";
  ...
  crates.http."0.1.14" = deps:
    { features ? (features_.http."0.1.14" deps { }) }:
    buildRustCrate {
      crateName = "http";
      version = "0.1.14";
      description = ''
  ...
  crates.httparse."1.2.3" = deps:
    { features ? (features_.httparse."1.2.3" deps { }) }:
    buildRustCrate {
      crateName = "httparse";
      version = "1.2.3";
  ...
  features_.httparse."1.2.3" = deps: f:
    updateFeatures f (rec {
      httparse = fold recursiveUpdate { } [
        {
          "1.2.3"."std" = (f.httparse."1.2.3"."std" or false)
  ...
  crates.hyper."0.12.16" = deps:
    { features ? (features_.hyper."0.12.16" deps { }) }:
    buildRustCrate {
      crateName = "hyper";
      version = "0.12.16";
      ...
      ] ++ (if features.hyper."0.12.16".futures-cpupool or false then
        [
          (crates.futures_cpupool."${deps."hyper"."0.12.16".futures_cpupool}"
            deps)
        ]
      else
        [ ]) ++ (if features.hyper."0.12.16".net2 or false then
          [ (crates.net2."${deps."hyper"."0.12.16".net2}" deps) ]
        else
          [ ]) ++ (if features.hyper."0.12.16".tokio or false then
            [ (crates.tokio."${deps."hyper"."0.12.16".tokio}" deps) ]
          else
            [ ]) ++ (if features.hyper."0.12.16".tokio-executor or false then
              [
                (crates.tokio_executor."${deps."hyper"."0.12.16".tokio_executor}"
                  deps)
              ]
            else
              [ ]) ++ (if features.hyper."0.12.16".tokio-reactor or false then
                [
                  (crates.tokio_reactor."${deps."hyper"."0.12.16".tokio_reactor}"
                    deps)
                ]
              else
                [ ]) ++ (if features.hyper."0.12.16".tokio-tcp or false then
                  [
                    (crates.tokio_tcp."${deps."hyper"."0.12.16".tokio_tcp}"
                      deps)
                  ]
                else
                  [ ])
        ++ (if features.hyper."0.12.16".tokio-threadpool or false then
          [
            (crates.tokio_threadpool."${deps."hyper"."0.12.16".tokio_threadpool}"
              deps)
          ]
        else
          [ ]) ++ (if features.hyper."0.12.16".tokio-timer or false then
            [
              (crates.tokio_timer."${deps."hyper"."0.12.16".tokio_timer}" deps)
            ]
          else
            [ ]));
      features = mkFeatures (features."hyper"."0.12.16" or { });
    };
  features_.hyper."0.12.16" = deps: f:
    updateFeatures f (rec {
      ...
      hyper = fold recursiveUpdate { } [
        ...
        {
          "0.12.16"."net2" = (f.hyper."0.12.16"."net2" or false)
            || (f.hyper."0.12.16".runtime or false)
            || (hyper."0.12.16"."runtime" or false);
        }
        {
          "0.12.16"."runtime" = (f.hyper."0.12.16"."runtime" or false)
            || (f.hyper."0.12.16".default or false)
            || (hyper."0.12.16"."default" or false);
        }
        {
          "0.12.16"."tokio" = (f.hyper."0.12.16"."tokio" or false)
            || (f.hyper."0.12.16".runtime or false)
            || (hyper."0.12.16"."runtime" or false);
        }
        {
        ...
        {
          "0.12.16"."tokio-tcp" = (f.hyper."0.12.16"."tokio-tcp" or false)
            || (f.hyper."0.12.16".runtime or false)
            || (hyper."0.12.16"."runtime" or false);
        }
        {
        ...
        {
          "0.12.16"."tokio-timer" = (f.hyper."0.12.16"."tokio-timer" or false)
            || (f.hyper."0.12.16".runtime or false)
            || (hyper."0.12.16"."runtime" or false);
        }
      ...
      tokio_threadpool."${deps.hyper."0.12.16".tokio_threadpool}".default =
        true;
      ...
      (features_.futures_cpupool."${deps."hyper"."0.12.16"."futures_cpupool"}"
        deps)
      ...
      (features_.tokio_executor."${deps."hyper"."0.12.16"."tokio_executor"}"
        deps)
      ...
      (features_.tokio_threadpool."${deps."hyper"."0.12.16"."tokio_threadpool"}"
        deps)
  ...
  crates.hyper_tls."0.3.1" = deps:
    { features ? (features_.hyper_tls."0.3.1" deps { }) }:
    buildRustCrate {
      crateName = "hyper-tls";
      version = "0.3.1";
  ...
  features_.hyper_tls."0.3.1" = deps: f:
    updateFeatures f (rec {
  ...
  crates.idna."0.1.4" = deps:
    { features ? (features_.idna."0.1.4" deps { }) }:
    buildRustCrate {
      crateName = "idna";
      version = "0.1.4";
      description =
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."unicode_normalization"."${deps."idna"."0.1.4"."unicode_normalization"}"
          deps)
      ]);
    };
  features_.idna."0.1.4" = deps: f:
    updateFeatures f ({
      ...
      unicode_normalization."${deps.idna."0.1.4".unicode_normalization}".default =
        true;
    }) [
      (features_.matches."${deps."idna"."0.1.4"."matches"}" deps)
      (features_.unicode_bidi."${deps."idna"."0.1.4"."unicode_bidi"}" deps)
      (features_.unicode_normalization."${deps."idna"."0.1.4"."unicode_normalization"}"
        deps)
    ];
  ...
  crates.indexmap."1.0.2" = deps:
    { features ? (features_.indexmap."1.0.2" deps { }) }:
    buildRustCrate {
      crateName = "indexmap";
      version = "1.0.2";
      description = ''
  ...
  features_.indexmap."1.0.2" = deps: f:
    updateFeatures f (rec {
      indexmap = fold recursiveUpdate { } [
        {
          "1.0.2"."serde" = (f.indexmap."1.0.2"."serde" or false)
  ...
  crates.iovec."0.1.1" = deps:
    { features ? (features_.iovec."0.1.1" deps { }) }:
    buildRustCrate {
      crateName = "iovec";
      version = "0.1.1";
      description = ''
  ...
  crates.isatty."0.1.5" = deps:
    { features ? (features_.isatty."0.1.5" deps { }) }:
    buildRustCrate {
      crateName = "isatty";
      version = "0.1.5";
      ...
      dependencies = (if (kernel == "linux" || kernel == "darwin") then
        ...
        [ ]) ++ (if kernel == "windows" then
          mapFeatures features ([
            (crates."kernel32_sys"."${deps."isatty"."0.1.5"."kernel32_sys"}"
              deps)
  ...
  crates.itertools."0.6.5" = deps:
    { features ? (features_.itertools."0.6.5" deps { }) }:
    buildRustCrate {
      crateName = "itertools";
      version = "0.6.5";
      description =
  ...
  features_.itertools."0.6.5" = deps: f:
    updateFeatures f ({
      either."${deps.itertools."0.6.5".either}".default =
        (f.either."${deps.itertools."0.6.5".either}".default or false);
  ...
  crates.lazy_static."0.2.10" = deps:
    { features ? (features_.lazy_static."0.2.10" deps { }) }:
    buildRustCrate {
  ...
  features_.lazy_static."0.2.10" = deps: f:
    updateFeatures f (rec {
      lazy_static = fold recursiveUpdate { } [
        ...
        {
          "0.2.10"."nightly" = (f.lazy_static."0.2.10"."nightly" or false)
            || (f.lazy_static."0.2.10".spin_no_std or false)
            || (lazy_static."0.2.10"."spin_no_std" or false);
        }
        {
          "0.2.10"."spin" = (f.lazy_static."0.2.10"."spin" or false)
            || (f.lazy_static."0.2.10".spin_no_std or false)
            || (lazy_static."0.2.10"."spin_no_std" or false);
        }
  ...
  crates.lazycell."1.2.0" = deps:
    { features ? (features_.lazycell."1.2.0" deps { }) }:
    buildRustCrate {
      crateName = "lazycell";
      version = "1.2.0";
  ...
  features_.lazycell."1.2.0" = deps: f:
    updateFeatures f (rec {
      lazycell = fold recursiveUpdate { } [
        {
          "1.2.0"."clippy" = (f.lazycell."1.2.0"."clippy" or false)
            || (f.lazycell."1.2.0".nightly-testing or false)
            || (lazycell."1.2.0"."nightly-testing" or false);
        }
        {
          "1.2.0"."nightly" = (f.lazycell."1.2.0"."nightly" or false)
            || (f.lazycell."1.2.0".nightly-testing or false)
            || (lazycell."1.2.0"."nightly-testing" or false);
        }
  ...
  crates.libflate."0.1.19" = deps:
    { features ? (features_.libflate."0.1.19" deps { }) }:
    buildRustCrate {
      crateName = "libflate";
      version = "0.1.19";
      description =
  ...
  features_.libflate."0.1.19" = deps: f:
    updateFeatures f ({
  ...
  crates.lock_api."0.1.5" = deps:
    ...
    buildRustCrate {
      ...
      ] ++ (if features.lock_api."0.1.5".owning_ref or false then
        [ (crates.owning_ref."${deps."lock_api"."0.1.5".owning_ref}" deps) ]
      else
        [ ]));
  ...
  crates.log."0.3.8" = deps:
    { features ? (features_.log."0.3.8" deps { }) }:
    buildRustCrate {
      crateName = "log";
      version = "0.3.8";
      description = ''
  ...
  features_.log."0.3.8" = deps: f:
    updateFeatures f (rec {
      log = fold recursiveUpdate { } [
        {
          "0.3.8"."use_std" = (f.log."0.3.8"."use_std" or false)
  ...
  crates.maplit."0.1.6" = deps:
    { features ? (features_.maplit."0.1.6" deps { }) }:
    buildRustCrate {
      crateName = "maplit";
      version = "0.1.6";
      description =
  ...
  crates.matches."0.1.6" = deps:
    { features ? (features_.matches."0.1.6" deps { }) }:
    buildRustCrate {
      crateName = "matches";
      version = "0.1.6";
      description =
  ...
  features_.matches."0.1.6" = deps: f:
    updateFeatures f ({
  ...
  crates.memoffset."0.2.1" = deps:
    { features ? (features_.memoffset."0.2.1" deps { }) }:
    buildRustCrate {
      crateName = "memoffset";
      version = "0.2.1";
  ...
  features_.memoffset."0.2.1" = deps: f:
    updateFeatures f ({
  ...
  crates.mime."0.3.12" = deps:
    { features ? (features_.mime."0.3.12" deps { }) }:
    buildRustCrate {
      crateName = "mime";
      version = "0.3.12";
  ...
  crates.mime_guess."2.0.0-alpha.6" = deps:
    { features ? (features_.mime_guess."2.0.0-alpha.6" deps { }) }:
    buildRustCrate {
      ...
      buildDependencies = mapFeatures features ([
        (crates."phf_codegen"."${deps."mime_guess"."2.0.0-alpha.6"."phf_codegen"}"
          deps)
        (crates."unicase"."${deps."mime_guess"."2.0.0-alpha.6"."unicase"}" deps)
      ]);
      features = mkFeatures (features."mime_guess"."2.0.0-alpha.6" or { });
    };
  features_.mime_guess."2.0.0-alpha.6" = deps: f:
    updateFeatures f ({
      mime."${deps.mime_guess."2.0.0-alpha.6".mime}".default = true;
      mime_guess."2.0.0-alpha.6".default =
        (f.mime_guess."2.0.0-alpha.6".default or true);
      phf = fold recursiveUpdate { } [
        { "${deps.mime_guess."2.0.0-alpha.6".phf}"."unicase" = true; }
        { "${deps.mime_guess."2.0.0-alpha.6".phf}".default = true; }
      ];
      phf_codegen."${deps.mime_guess."2.0.0-alpha.6".phf_codegen}".default =
        true;
      ...
      (features_.phf_codegen."${deps."mime_guess"."2.0.0-alpha.6"."phf_codegen"}"
        deps)
      (features_.unicase."${deps."mime_guess"."2.0.0-alpha.6"."unicase"}" deps)
    ];
  ...
  crates.miniz_sys."0.1.10" = deps:
    { features ? (features_.miniz_sys."0.1.10" deps { }) }:
    buildRustCrate {
      crateName = "miniz-sys";
      version = "0.1.10";
      description = ''
  ...
  features_.miniz_sys."0.1.10" = deps: f:
    updateFeatures f ({
  ...
  crates.mio."0.6.16" = deps:
    { features ? (features_.mio."0.6.16" deps { }) }:
    buildRustCrate {
      crateName = "mio";
      version = "0.6.16";
      ...
      dependencies = mapFeatures features ([
        ...
        mapFeatures features ([
          (crates."fuchsia_zircon"."${deps."mio"."0.6.16"."fuchsia_zircon"}"
            deps)
          (crates."fuchsia_zircon_sys"."${deps."mio"."0.6.16"."fuchsia_zircon_sys"}"
            deps)
        ])
      else
        [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
          ...
          [ ]) ++ (if kernel == "windows" then
            mapFeatures features ([
              (crates."kernel32_sys"."${deps."mio"."0.6.16"."kernel32_sys"}"
                deps)
  ...
  features_.mio."0.6.16" = deps: f:
    updateFeatures f (rec {
      fuchsia_zircon."${deps.mio."0.6.16".fuchsia_zircon}".default = true;
      fuchsia_zircon_sys."${deps.mio."0.6.16".fuchsia_zircon_sys}".default =
        true;
      ...
      (features_.fuchsia_zircon_sys."${deps."mio"."0.6.16"."fuchsia_zircon_sys"}"
        deps)
  ...
  crates.miow."0.2.1" = deps:
    { features ? (features_.miow."0.2.1" deps { }) }:
    buildRustCrate {
      crateName = "miow";
      version = "0.2.1";
      description = ''
  ...
  features_.miow."0.2.1" = deps: f:
    updateFeatures f ({
      kernel32_sys."${deps.miow."0.2.1".kernel32_sys}".default = true;
      miow."0.2.1".default = (f.miow."0.2.1".default or true);
      net2."${deps.miow."0.2.1".net2}".default =
        (f.net2."${deps.miow."0.2.1".net2}".default or false);
  ...
  crates.native_tls."0.2.2" = deps:
    { features ? (features_.native_tls."0.2.2" deps { }) }:
    buildRustCrate {
      ...
      dependencies = (if kernel == "darwin" || kernel == "ios" then
        mapFeatures features ([
          (crates."lazy_static"."${deps."native_tls"."0.2.2"."lazy_static"}"
            deps)
          (crates."libc"."${deps."native_tls"."0.2.2"."libc"}" deps)
          (crates."security_framework"."${deps."native_tls"."0.2.2"."security_framework"}"
            deps)
          (crates."security_framework_sys"."${deps."native_tls"."0.2.2"."security_framework_sys"}"
            deps)
        ...
        [ ]) ++ (if !(kernel == "windows" || kernel == "darwin" || kernel
          ...
          mapFeatures features ([
            ...
            (crates."openssl_probe"."${deps."native_tls"."0.2.2"."openssl_probe"}"
              deps)
            (crates."openssl_sys"."${deps."native_tls"."0.2.2"."openssl_sys"}"
              deps)
          ])
        else
          [ ]) ++ (if kernel == "android" then
            ...
            [ ]) ++ (if kernel == "windows" then
              mapFeatures features ([
                (crates."schannel"."${deps."native_tls"."0.2.2"."schannel"}"
                  deps)
              ])
            else
              [ ]);
  ...
  features_.native_tls."0.2.2" = deps: f:
    updateFeatures f ({
      ...
      security_framework."${deps.native_tls."0.2.2".security_framework}".default =
        true;
      security_framework_sys."${deps.native_tls."0.2.2".security_framework_sys}".default =
        true;
      ...
      (features_.security_framework."${deps."native_tls"."0.2.2"."security_framework"}"
        deps)
      (features_.security_framework_sys."${deps."native_tls"."0.2.2"."security_framework_sys"}"
        deps)
      (features_.tempfile."${deps."native_tls"."0.2.2"."tempfile"}" deps)
      (features_.openssl."${deps."native_tls"."0.2.2"."openssl"}" deps)
      (features_.openssl_probe."${deps."native_tls"."0.2.2"."openssl_probe"}"
        deps)
  ...
  crates.net2."0.2.33" = deps:
    { features ? (features_.net2."0.2.33" deps { }) }:
    buildRustCrate {
      crateName = "net2";
      version = "0.2.33";
      description = ''
      ...
      dependencies = mapFeatures features
        ...
        ++ (if kernel == "redox"
        || (kernel == "linux" || kernel == "darwin") then
          mapFeatures features
  ...
  crates.num."0.1.40" = deps:
    { features ? (features_.num."0.1.40" deps { }) }:
    buildRustCrate {
      crateName = "num";
      version = "0.1.40";
      description = ''
  ...
  features_.num."0.1.40" = deps: f:
    updateFeatures f (rec {
      num = fold recursiveUpdate { } [
        {
          "0.1.40"."bigint" = (f.num."0.1.40"."bigint" or false)
            || (f.num."0.1.40".default or false)
            || (num."0.1.40"."default" or false);
        }
        {
          "0.1.40"."complex" = (f.num."0.1.40"."complex" or false)
            || (f.num."0.1.40".default or false)
            || (num."0.1.40"."default" or false);
        }
        {
          "0.1.40"."num-bigint" = (f.num."0.1.40"."num-bigint" or false)
            || (f.num."0.1.40".bigint or false)
            || (num."0.1.40"."bigint" or false);
        }
        {
          "0.1.40"."num-complex" = (f.num."0.1.40"."num-complex" or false)
            || (f.num."0.1.40".complex or false)
            || (num."0.1.40"."complex" or false);
        }
        {
          "0.1.40"."num-rational" = (f.num."0.1.40"."num-rational" or false)
            || (f.num."0.1.40".rational or false)
            || (num."0.1.40"."rational" or false);
        }
        {
          "0.1.40"."rational" = (f.num."0.1.40"."rational" or false)
            || (f.num."0.1.40".default or false)
            || (num."0.1.40"."default" or false);
        }
        {
  ...
  crates.num_integer."0.1.35" = deps:
    { features ? (features_.num_integer."0.1.35" deps { }) }:
    buildRustCrate {
  ...
  features_.num_integer."0.1.35" = deps: f:
    updateFeatures f ({
  ...
  crates.num_iter."0.1.34" = deps:
    { features ? (features_.num_iter."0.1.34" deps { }) }:
    buildRustCrate {
      crateName = "num-iter";
      version = "0.1.34";
  ...
  features_.num_iter."0.1.34" = deps: f:
    updateFeatures f ({
  ...
  crates.num_traits."0.1.40" = deps:
    { features ? (features_.num_traits."0.1.40" deps { }) }:
    buildRustCrate {
  ...
  features_.num_traits."0.1.40" = deps: f:
    updateFeatures f ({
  ...
  crates.num_cpus."1.8.0" = deps:
    { features ? (features_.num_cpus."1.8.0" deps { }) }:
    buildRustCrate {
      crateName = "num_cpus";
      version = "1.8.0";
  ...
  features_.num_cpus."1.8.0" = deps: f:
    updateFeatures f ({
  ...
  crates.openssl."0.10.15" = deps:
    { features ? (features_.openssl."0.10.15" deps { }) }:
    buildRustCrate {
      crateName = "openssl";
      version = "0.10.15";
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."foreign_types"."${deps."openssl"."0.10.15"."foreign_types"}"
          deps)
  ...
  features_.openssl."0.10.15" = deps: f:
    updateFeatures f (rec {
      ...
      (features_.foreign_types."${deps."openssl"."0.10.15"."foreign_types"}"
        deps)
  ...
  crates.openssl_sys."0.9.39" = deps:
    { features ? (features_.openssl_sys."0.9.39" deps { }) }:
    buildRustCrate {
  ...
  features_.openssl_sys."0.9.39" = deps: f:
    updateFeatures f (rec {
  ...
  crates.owning_ref."0.4.0" = deps:
    { features ? (features_.owning_ref."0.4.0" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."stable_deref_trait"."${deps."owning_ref"."0.4.0"."stable_deref_trait"}"
          deps)
      ]);
    };
  features_.owning_ref."0.4.0" = deps: f:
    updateFeatures f ({
      owning_ref."0.4.0".default = (f.owning_ref."0.4.0".default or true);
      stable_deref_trait."${deps.owning_ref."0.4.0".stable_deref_trait}".default =
        true;
    }) [
      (features_.stable_deref_trait."${deps."owning_ref"."0.4.0"."stable_deref_trait"}"
        deps)
    ];
  ...
  crates.parking_lot."0.6.4" = deps:
    { features ? (features_.parking_lot."0.6.4" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."parking_lot_core"."${deps."parking_lot"."0.6.4"."parking_lot_core"}"
          deps)
      ]);
      features = mkFeatures (features."parking_lot"."0.6.4" or { });
    };
  features_.parking_lot."0.6.4" = deps: f:
    updateFeatures f (rec {
      ...
      parking_lot = fold recursiveUpdate { } [
        {
          "0.6.4"."owning_ref" = (f.parking_lot."0.6.4"."owning_ref" or false)
      ...
      (features_.parking_lot_core."${deps."parking_lot"."0.6.4"."parking_lot_core"}"
        deps)
    ];
  ...
  crates.parking_lot_core."0.3.1" = deps:
    { features ? (features_.parking_lot_core."0.3.1" deps { }) }:
    buildRustCrate {
      ...
      buildDependencies = mapFeatures features ([
        (crates."rustc_version"."${deps."parking_lot_core"."0.3.1"."rustc_version"}"
          deps)
      ]);
      features = mkFeatures (features."parking_lot_core"."0.3.1" or { });
    };
  features_.parking_lot_core."0.3.1" = deps: f:
    updateFeatures f (rec {
      ...
      parking_lot_core = fold recursiveUpdate { } [
        ...
        {
          "0.3.1"."petgraph" = (f.parking_lot_core."0.3.1"."petgraph" or false)
            || (f.parking_lot_core."0.3.1".deadlock_detection or false)
            || (parking_lot_core."0.3.1"."deadlock_detection" or false);
        }
        {
      ...
      rustc_version."${deps.parking_lot_core."0.3.1".rustc_version}".default =
        true;
      ...
      (features_.rustc_version."${deps."parking_lot_core"."0.3.1"."rustc_version"}"
        deps)
  ...
  crates.phf."0.7.21" = deps:
    { features ? (features_.phf."0.7.21" deps { }) }:
    buildRustCrate {
      crateName = "phf";
      version = "0.7.21";
  ...
  crates.phf_codegen."0.7.21" = deps:
    { features ? (features_.phf_codegen."0.7.21" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."phf_generator"."${deps."phf_codegen"."0.7.21"."phf_generator"}"
          deps)
        (crates."phf_shared"."${deps."phf_codegen"."0.7.21"."phf_shared"}" deps)
      ]);
    };
  features_.phf_codegen."0.7.21" = deps: f:
    updateFeatures f ({
      ...
      (features_.phf_generator."${deps."phf_codegen"."0.7.21"."phf_generator"}"
        deps)
  ...
  crates.phf_generator."0.7.21" = deps:
    { features ? (features_.phf_generator."0.7.21" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."phf_shared"."${deps."phf_generator"."0.7.21"."phf_shared"}"
          deps)
        (crates."rand"."${deps."phf_generator"."0.7.21"."rand"}" deps)
      ]);
    };
  features_.phf_generator."0.7.21" = deps: f:
    updateFeatures f ({
      phf_generator."0.7.21".default =
        (f.phf_generator."0.7.21".default or true);
      phf_shared."${deps.phf_generator."0.7.21".phf_shared}".default = true;
      rand."${deps.phf_generator."0.7.21".rand}".default = true;
    }) [
      (features_.phf_shared."${deps."phf_generator"."0.7.21"."phf_shared"}"
        deps)
  ...
  crates.phf_shared."0.7.21" = deps:
    { features ? (features_.phf_shared."0.7.21" deps { }) }:
    buildRustCrate {
      ...
      ] ++ (if features.phf_shared."0.7.21".unicase or false then
        [ (crates.unicase."${deps."phf_shared"."0.7.21".unicase}" deps) ]
      else
        [ ]));
      features = mkFeatures (features."phf_shared"."0.7.21" or { });
    };
  features_.phf_shared."0.7.21" = deps: f:
    updateFeatures f ({
  ...
  crates.pkg_config."0.3.9" = deps:
    { features ? (features_.pkg_config."0.3.9" deps { }) }:
    buildRustCrate {
  ...
  features_.pkg_config."0.3.9" = deps: f:
    updateFeatures f ({
  ...
  crates.rand."0.3.18" = deps:
    { features ? (features_.rand."0.3.18" deps { }) }:
    buildRustCrate {
      crateName = "rand";
      version = "0.3.18";
      description = ''
      ...
      dependencies = mapFeatures features
        ...
        ++ (if kernel == "fuchsia" then
          mapFeatures features ([
            (crates."fuchsia_zircon"."${deps."rand"."0.3.18"."fuchsia_zircon"}"
              deps)
          ])
        else
          [ ]);
  ...
  crates.rand."0.6.1" = deps:
    { features ? (features_.rand."0.6.1" deps { }) }:
    buildRustCrate {
      crateName = "rand";
      version = "0.6.1";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        mapFeatures features ([ ]
          ++ (if features.rand."0.6.1".cloudabi or false then
            [ (crates.cloudabi."${deps."rand"."0.6.1".cloudabi}" deps) ]
          else
            [ ]))
      else
        [ ]) ++ (if kernel == "fuchsia" then
          mapFeatures features ([ ]
            ++ (if features.rand."0.6.1".fuchsia-zircon or false then
              [
                (crates.fuchsia_zircon."${deps."rand"."0.6.1".fuchsia_zircon}"
                  deps)
              ]
            else
              [ ]))
          ...
          [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
            mapFeatures features ([ ]
              ++ (if features.rand."0.6.1".libc or false then
                [ (crates.libc."${deps."rand"."0.6.1".libc}" deps) ]
              else
                [ ]))
          else
            [ ]) ++ (if kernel == "windows" then
              mapFeatures features ([ ]
                ++ (if features.rand."0.6.1".winapi or false then
                  [ (crates.winapi."${deps."rand"."0.6.1".winapi}" deps) ]
                else
                  [ ]))
            else
              [ ]) ++ (if kernel == "wasm32-unknown-unknown" then
  ...
  features_.rand."0.6.1" = deps: f:
    updateFeatures f (rec {
      cloudabi."${deps.rand."0.6.1".cloudabi}".default = true;
      fuchsia_zircon."${deps.rand."0.6.1".fuchsia_zircon}".default = true;
      libc."${deps.rand."0.6.1".libc}".default =
        (f.libc."${deps.rand."0.6.1".libc}".default or false);
      rand = fold recursiveUpdate { } [
        {
          "0.6.1"."alloc" = (f.rand."0.6.1"."alloc" or false)
            || (f.rand."0.6.1".std or false) || (rand."0.6.1"."std" or false);
        }
        {
          "0.6.1"."cloudabi" = (f.rand."0.6.1"."cloudabi" or false)
            || (f.rand."0.6.1".std or false) || (rand."0.6.1"."std" or false);
        }
        {
          "0.6.1"."fuchsia-zircon" = (f.rand."0.6.1"."fuchsia-zircon" or false)
            || (f.rand."0.6.1".std or false) || (rand."0.6.1"."std" or false);
        }
        {
          "0.6.1"."libc" = (f.rand."0.6.1"."libc" or false)
            || (f.rand."0.6.1".std or false) || (rand."0.6.1"."std" or false);
        }
        {
          "0.6.1"."packed_simd" = (f.rand."0.6.1"."packed_simd" or false)
            || (f.rand."0.6.1".simd_support or false)
            || (rand."0.6.1"."simd_support" or false);
        }
        {
          "0.6.1"."simd_support" = (f.rand."0.6.1"."simd_support" or false)
            || (f.rand."0.6.1".nightly or false)
            || (rand."0.6.1"."nightly" or false);
        }
        {
          "0.6.1"."std" = (f.rand."0.6.1"."std" or false)
            || (f.rand."0.6.1".default or false)
            || (rand."0.6.1"."default" or false);
        }
        {
          "0.6.1"."winapi" = (f.rand."0.6.1"."winapi" or false)
            || (f.rand."0.6.1".std or false) || (rand."0.6.1"."std" or false);
        }
      ...
      rand_core = fold recursiveUpdate { } [
        ...
        {
          "${deps.rand."0.6.1".rand_core}".default =
            (f.rand_core."${deps.rand."0.6.1".rand_core}".default or false);
        }
      ];
  ...
  crates.rand_chacha."0.1.0" = deps:
    { features ? (features_.rand_chacha."0.1.0" deps { }) }:
    buildRustCrate {
      ...
      buildDependencies = mapFeatures features ([
        (crates."rustc_version"."${deps."rand_chacha"."0.1.0"."rustc_version"}"
          deps)
      ]);
    };
  features_.rand_chacha."0.1.0" = deps: f:
    updateFeatures f ({
      rand_chacha."0.1.0".default = (f.rand_chacha."0.1.0".default or true);
      rand_core."${deps.rand_chacha."0.1.0".rand_core}".default =
        (f.rand_core."${deps.rand_chacha."0.1.0".rand_core}".default or false);
      rustc_version."${deps.rand_chacha."0.1.0".rustc_version}".default = true;
    }) [
      (features_.rand_core."${deps."rand_chacha"."0.1.0"."rand_core"}" deps)
      (features_.rustc_version."${deps."rand_chacha"."0.1.0"."rustc_version"}"
        deps)
    ];
  ...
  crates.rand_pcg."0.1.1" = deps:
    { features ? (features_.rand_pcg."0.1.1" deps { }) }:
    buildRustCrate {
      crateName = "rand_pcg";
      version = "0.1.1";
      description = ''
      ...
      buildDependencies = mapFeatures features ([
        (crates."rustc_version"."${deps."rand_pcg"."0.1.1"."rustc_version"}"
          deps)
      ]);
      features = mkFeatures (features."rand_pcg"."0.1.1" or { });
    };
  features_.rand_pcg."0.1.1" = deps: f:
    updateFeatures f (rec {
      rand_core."${deps.rand_pcg."0.1.1".rand_core}".default =
        (f.rand_core."${deps.rand_pcg."0.1.1".rand_core}".default or false);
      rand_pcg = fold recursiveUpdate { } [
        {
          "0.1.1"."serde" = (f.rand_pcg."0.1.1"."serde" or false)
            || (f.rand_pcg."0.1.1".serde1 or false)
            || (rand_pcg."0.1.1"."serde1" or false);
        }
        {
          "0.1.1"."serde_derive" = (f.rand_pcg."0.1.1"."serde_derive" or false)
            || (f.rand_pcg."0.1.1".serde1 or false)
            || (rand_pcg."0.1.1"."serde1" or false);
        }
      ...
      (features_.rustc_version."${deps."rand_pcg"."0.1.1"."rustc_version"}"
        deps)
    ];
  ...
  crates.rand_xorshift."0.1.0" = deps:
    { features ? (features_.rand_xorshift."0.1.0" deps { }) }:
    buildRustCrate {
  ...
  features_.rand_xorshift."0.1.0" = deps: f:
    updateFeatures f (rec {
      rand_core."${deps.rand_xorshift."0.1.0".rand_core}".default =
        (f.rand_core."${deps.rand_xorshift."0.1.0".rand_core}".default or false);
      rand_xorshift = fold recursiveUpdate { } [
        {
          "0.1.0"."serde" = (f.rand_xorshift."0.1.0"."serde" or false)
  ...
  crates.redox_syscall."0.1.31" = deps:
    { features ? (features_.redox_syscall."0.1.31" deps { }) }:
    buildRustCrate {
  ...
  features_.redox_syscall."0.1.31" = deps: f:
    updateFeatures f ({
      redox_syscall."0.1.31".default =
        (f.redox_syscall."0.1.31".default or true);
    }) [ ];
  ...
  crates.reqwest."0.9.5" = deps:
    { features ? (features_.reqwest."0.9.5" deps { }) }:
    buildRustCrate {
      crateName = "reqwest";
      version = "0.9.5";
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."serde_urlencoded"."${deps."reqwest"."0.9.5"."serde_urlencoded"}"
          deps)
      ...
      ] ++ (if features.reqwest."0.9.5".hyper-tls or false then
        [ (crates.hyper_tls."${deps."reqwest"."0.9.5".hyper_tls}" deps) ]
      else
        [ ]) ++ (if features.reqwest."0.9.5".native-tls or false then
          [ (crates.native_tls."${deps."reqwest"."0.9.5".native_tls}" deps) ]
        else
          [ ]));
      features = mkFeatures (features."reqwest"."0.9.5" or { });
    };
  features_.reqwest."0.9.5" = deps: f:
    updateFeatures f (rec {
      ...
      reqwest = fold recursiveUpdate { } [
        {
          "0.9.5"."default-tls" = (f.reqwest."0.9.5"."default-tls" or false)
        ...
        {
          "0.9.5"."hyper-tls" = (f.reqwest."0.9.5"."hyper-tls" or false)
            || (f.reqwest."0.9.5".default-tls or false)
            || (reqwest."0.9.5"."default-tls" or false);
        }
        {
          "0.9.5"."native-tls" = (f.reqwest."0.9.5"."native-tls" or false)
            || (f.reqwest."0.9.5".default-tls or false)
            || (reqwest."0.9.5"."default-tls" or false);
        }
      ...
      serde_urlencoded."${deps.reqwest."0.9.5".serde_urlencoded}".default =
        true;
      ...
      (features_.serde_urlencoded."${deps."reqwest"."0.9.5"."serde_urlencoded"}"
        deps)
  ...
  crates.safemem."0.3.0" = deps:
    { features ? (features_.safemem."0.3.0" deps { }) }:
    buildRustCrate {
      crateName = "safemem";
      version = "0.3.0";
      description =
  ...
  features_.safemem."0.3.0" = deps: f:
    updateFeatures f (rec {
      safemem = fold recursiveUpdate { } [
        {
          "0.3.0"."std" = (f.safemem."0.3.0"."std" or false)
  ...
  crates.schannel."0.1.14" = deps:
    { features ? (features_.schannel."0.1.14" deps { }) }:
    buildRustCrate {
      crateName = "schannel";
      version = "0.1.14";
      description =
  ...
  features_.schannel."0.1.14" = deps: f:
    updateFeatures f ({
  ...
  crates.security_framework."0.2.1" = deps:
    { features ? (features_.security_framework."0.2.1" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."core_foundation"."${deps."security_framework"."0.2.1"."core_foundation"}"
          deps)
        (crates."core_foundation_sys"."${deps."security_framework"."0.2.1"."core_foundation_sys"}"
          deps)
        (crates."libc"."${deps."security_framework"."0.2.1"."libc"}" deps)
        (crates."security_framework_sys"."${deps."security_framework"."0.2.1"."security_framework_sys"}"
          deps)
      ]);
      features = mkFeatures (features."security_framework"."0.2.1" or { });
    };
  features_.security_framework."0.2.1" = deps: f:
    updateFeatures f (rec {
      core_foundation."${deps.security_framework."0.2.1".core_foundation}".default =
        true;
      core_foundation_sys."${deps.security_framework."0.2.1".core_foundation_sys}".default =
        true;
      ...
      security_framework_sys = fold recursiveUpdate { } [
        ...
        {
          "${deps.security_framework."0.2.1".security_framework_sys}".default =
            true;
        }
      ];
    }) [
      (features_.core_foundation."${deps."security_framework"."0.2.1"."core_foundation"}"
        deps)
      (features_.core_foundation_sys."${deps."security_framework"."0.2.1"."core_foundation_sys"}"
        deps)
      (features_.libc."${deps."security_framework"."0.2.1"."libc"}" deps)
      (features_.security_framework_sys."${deps."security_framework"."0.2.1"."security_framework_sys"}"
        deps)
    ];
  ...
  crates.security_framework_sys."0.2.1" = deps:
    { features ? (features_.security_framework_sys."0.2.1" deps { }) }:
    buildRustCrate {
      ...
      build = "build.rs";
      dependencies = mapFeatures features ([
        (crates."core_foundation_sys"."${deps."security_framework_sys"."0.2.1"."core_foundation_sys"}"
          deps)
        (crates."libc"."${deps."security_framework_sys"."0.2.1"."libc"}" deps)
      ]);
      features = mkFeatures (features."security_framework_sys"."0.2.1" or { });
    };
  features_.security_framework_sys."0.2.1" = deps: f:
    updateFeatures f (rec {
      core_foundation_sys."${deps.security_framework_sys."0.2.1".core_foundation_sys}".default =
        true;
      ...
      (features_.core_foundation_sys."${deps."security_framework_sys"."0.2.1"."core_foundation_sys"}"
        deps)
  ...
  crates.serde."1.0.21" = deps:
    { features ? (features_.serde."1.0.21" deps { }) }:
    buildRustCrate {
      crateName = "serde";
      version = "1.0.21";
  ...
  features_.serde."1.0.21" = deps: f:
    updateFeatures f (rec {
      serde = fold recursiveUpdate { } [
        {
          "1.0.21"."serde_derive" = (f.serde."1.0.21"."serde_derive" or false)
        ...
        {
          "1.0.21"."std" = (f.serde."1.0.21"."std" or false)
            || (f.serde."1.0.21".default or false)
            || (serde."1.0.21"."default" or false);
        }
        {
          "1.0.21"."unstable" = (f.serde."1.0.21"."unstable" or false)
  ...
  crates.serde_json."1.0.6" = deps:
    { features ? (features_.serde_json."1.0.6" deps { }) }:
    buildRustCrate {
  ...
  features_.serde_json."1.0.6" = deps: f:
    updateFeatures f (rec {
  ...
  crates.serde_urlencoded."0.5.1" = deps:
    { features ? (features_.serde_urlencoded."0.5.1" deps { }) }:
    buildRustCrate {
  ...
  features_.serde_urlencoded."0.5.1" = deps: f:
    updateFeatures f ({
      ...
      serde_urlencoded."0.5.1".default =
        (f.serde_urlencoded."0.5.1".default or true);
  ...
  crates.siphasher."0.2.2" = deps:
    { features ? (features_.siphasher."0.2.2" deps { }) }:
    buildRustCrate {
      crateName = "siphasher";
      version = "0.2.2";
  ...
  features_.siphasher."0.2.2" = deps: f:
    updateFeatures f ({
  ...
  crates.slab."0.4.0" = deps:
    { features ? (features_.slab."0.4.0" deps { }) }:
    buildRustCrate {
      crateName = "slab";
      version = "0.4.0";
  ...
  crates.slog."1.7.1" = deps:
    { features ? (features_.slog."1.7.1" deps { }) }:
    buildRustCrate {
      crateName = "slog";
      version = "1.7.1";
  ...
  features_.slog."1.7.1" = deps: f:
    updateFeatures f (rec {
      slog = fold recursiveUpdate { } [
        {
          "1.7.1"."std" = (f.slog."1.7.1"."std" or false)
  ...
  crates.slog_envlogger."0.5.0" = deps:
    { features ? (features_.slog_envlogger."0.5.0" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."slog_stdlog"."${deps."slog_envlogger"."0.5.0"."slog_stdlog"}"
          deps)
        (crates."slog_term"."${deps."slog_envlogger"."0.5.0"."slog_term"}" deps)
      ]);
    };
  features_.slog_envlogger."0.5.0" = deps: f:
    updateFeatures f ({
      ...
      slog_envlogger."0.5.0".default =
        (f.slog_envlogger."0.5.0".default or true);
      ...
      (features_.slog_stdlog."${deps."slog_envlogger"."0.5.0"."slog_stdlog"}"
        deps)
  ...
  crates.slog_extra."0.1.2" = deps:
    { features ? (features_.slog_extra."0.1.2" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."thread_local"."${deps."slog_extra"."0.1.2"."thread_local"}"
          deps)
      ]);
    };
  features_.slog_extra."0.1.2" = deps: f:
    updateFeatures f ({
      ...
      (features_.thread_local."${deps."slog_extra"."0.1.2"."thread_local"}"
        deps)
    ];
  ...
  crates.slog_stdlog."1.1.0" = deps:
    { features ? (features_.slog_stdlog."1.1.0" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."lazy_static"."${deps."slog_stdlog"."1.1.0"."lazy_static"}"
          deps)
  ...
  features_.slog_stdlog."1.1.0" = deps: f:
    updateFeatures f ({
  ...
  crates.slog_stream."1.2.1" = deps:
    { features ? (features_.slog_stream."1.2.1" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."thread_local"."${deps."slog_stream"."1.2.1"."thread_local"}"
          deps)
      ]);
    };
  features_.slog_stream."1.2.1" = deps: f:
    updateFeatures f ({
      ...
      (features_.thread_local."${deps."slog_stream"."1.2.1"."thread_local"}"
        deps)
    ];
  ...
  crates.slog_term."1.5.0" = deps:
    { features ? (features_.slog_term."1.5.0" deps { }) }:
    buildRustCrate {
      crateName = "slog-term";
      version = "1.5.0";
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."thread_local"."${deps."slog_term"."1.5.0"."thread_local"}"
          deps)
      ]);
    };
  features_.slog_term."1.5.0" = deps: f:
    updateFeatures f ({
  ...
  crates.smallvec."0.6.7" = deps:
    { features ? (features_.smallvec."0.6.7" deps { }) }:
    buildRustCrate {
      crateName = "smallvec";
      version = "0.6.7";
      description =
  ...
  features_.smallvec."0.6.7" = deps: f:
    updateFeatures f (rec {
      smallvec = fold recursiveUpdate { } [
        {
          "0.6.7"."std" = (f.smallvec."0.6.7"."std" or false)
  ...
  crates.stable_deref_trait."1.1.1" = deps:
    { features ? (features_.stable_deref_trait."1.1.1" deps { }) }:
    buildRustCrate {
  ...
  features_.stable_deref_trait."1.1.1" = deps: f:
    updateFeatures f (rec {
      stable_deref_trait = fold recursiveUpdate { } [
        {
          "1.1.1"."std" = (f.stable_deref_trait."1.1.1"."std" or false)
  ...
  crates.string."0.1.2" = deps:
    { features ? (features_.string."0.1.2" deps { }) }:
    buildRustCrate {
      crateName = "string";
      version = "0.1.2";
  ...
  crates.strsim."0.6.0" = deps:
    { features ? (features_.strsim."0.6.0" deps { }) }:
    buildRustCrate {
      crateName = "strsim";
      version = "0.6.0";
      description = ''
  ...
  crates.tar."0.4.13" = deps:
    { features ? (features_.tar."0.4.13" deps { }) }:
    buildRustCrate {
      crateName = "tar";
      version = "0.4.13";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        mapFeatures features ([ ]
          ++ (if features.tar."0.4.13".xattr or false then
            [ (crates.xattr."${deps."tar"."0.4.13".xattr}" deps) ]
          else
            [ ]))
      else
        [ ]);
  ...
  crates.tempfile."3.0.5" = deps:
    { features ? (features_.tempfile."3.0.5" deps { }) }:
    buildRustCrate {
      crateName = "tempfile";
      version = "3.0.5";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."remove_dir_all"."${deps."tempfile"."3.0.5"."remove_dir_all"}"
          deps)
      ]) ++ (if kernel == "redox" then
        mapFeatures features ([
          (crates."redox_syscall"."${deps."tempfile"."3.0.5"."redox_syscall"}"
            deps)
        ])
      else
        [ ]) ++ (if (kernel == "linux" || kernel == "darwin") then
  ...
  features_.tempfile."3.0.5" = deps: f:
    updateFeatures f ({
      ...
      (features_.remove_dir_all."${deps."tempfile"."3.0.5"."remove_dir_all"}"
        deps)
      (features_.redox_syscall."${deps."tempfile"."3.0.5"."redox_syscall"}"
        deps)
  ...
  crates.thread_local."0.3.4" = deps:
    { features ? (features_.thread_local."0.3.4" deps { }) }:
    buildRustCrate {
      crateName = "thread_local";
      version = "0.3.4";
      description = "Per-object thread-local storage";
      ...
      dependencies = mapFeatures features ([
        (crates."lazy_static"."${deps."thread_local"."0.3.4"."lazy_static"}"
          deps)
        (crates."unreachable"."${deps."thread_local"."0.3.4"."unreachable"}"
          deps)
      ]);
    };
  features_.thread_local."0.3.4" = deps: f:
    updateFeatures f ({
      ...
      (features_.lazy_static."${deps."thread_local"."0.3.4"."lazy_static"}"
        deps)
      (features_.unreachable."${deps."thread_local"."0.3.4"."unreachable"}"
        deps)
    ];
  ...
  crates.time."0.1.38" = deps:
    { features ? (features_.time."0.1.38" deps { }) }:
    buildRustCrate {
      crateName = "time";
      version = "0.1.38";
      description = ''
      ...
      dependencies = mapFeatures features
        ...
        ++ (if kernel == "redox" then
          mapFeatures features ([
            (crates."redox_syscall"."${deps."time"."0.1.38"."redox_syscall"}"
              deps)
          ])
        else
          [ ]) ++ (if kernel == "windows" then
            mapFeatures features ([
              (crates."kernel32_sys"."${deps."time"."0.1.38"."kernel32_sys"}"
                deps)
  ...
  crates.tokio."0.1.7" = deps:
    { features ? (features_.tokio."0.1.7" deps { }) }:
    buildRustCrate {
      crateName = "tokio";
      version = "0.1.7";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."tokio_executor"."${deps."tokio"."0.1.7"."tokio_executor"}"
          deps)
  ...
  features_.tokio."0.1.7" = deps: f:
    updateFeatures f ({
      ...
      (features_.tokio_threadpool."${deps."tokio"."0.1.7"."tokio_threadpool"}"
        deps)
  ...
  crates.tokio_codec."0.1.1" = deps:
    { features ? (features_.tokio_codec."0.1.1" deps { }) }:
    buildRustCrate {
  ...
  features_.tokio_codec."0.1.1" = deps: f:
    updateFeatures f ({
  ...
  crates.tokio_executor."0.1.5" = deps:
    { features ? (features_.tokio_executor."0.1.5" deps { }) }:
    buildRustCrate {
  ...
  features_.tokio_executor."0.1.5" = deps: f:
    updateFeatures f ({
      futures."${deps.tokio_executor."0.1.5".futures}".default = true;
      tokio_executor."0.1.5".default =
        (f.tokio_executor."0.1.5".default or true);
    })
  ...
  crates.tokio_fs."0.1.4" = deps:
    { features ? (features_.tokio_fs."0.1.4" deps { }) }:
    buildRustCrate {
      crateName = "tokio-fs";
      version = "0.1.4";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."tokio_threadpool"."${deps."tokio_fs"."0.1.4"."tokio_threadpool"}"
          deps)
      ]);
    };
  features_.tokio_fs."0.1.4" = deps: f:
    updateFeatures f ({
      ...
      tokio_threadpool."${deps.tokio_fs."0.1.4".tokio_threadpool}".default =
        true;
    }) [
      (features_.futures."${deps."tokio_fs"."0.1.4"."futures"}" deps)
      (features_.tokio_io."${deps."tokio_fs"."0.1.4"."tokio_io"}" deps)
      (features_.tokio_threadpool."${deps."tokio_fs"."0.1.4"."tokio_threadpool"}"
        deps)
    ];
  ...
  crates.tokio_io."0.1.10" = deps:
    { features ? (features_.tokio_io."0.1.10" deps { }) }:
    buildRustCrate {
      crateName = "tokio-io";
      version = "0.1.10";
      description = ''
  ...
  features_.tokio_io."0.1.10" = deps: f:
    updateFeatures f ({
  ...
  crates.tokio_reactor."0.1.7" = deps:
    { features ? (features_.tokio_reactor."0.1.7" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."crossbeam_utils"."${deps."tokio_reactor"."0.1.7"."crossbeam_utils"}"
          deps)
        (crates."futures"."${deps."tokio_reactor"."0.1.7"."futures"}" deps)
        (crates."lazy_static"."${deps."tokio_reactor"."0.1.7"."lazy_static"}"
          deps)
        ...
        (crates."parking_lot"."${deps."tokio_reactor"."0.1.7"."parking_lot"}"
          deps)
        (crates."slab"."${deps."tokio_reactor"."0.1.7"."slab"}" deps)
        (crates."tokio_executor"."${deps."tokio_reactor"."0.1.7"."tokio_executor"}"
          deps)
        (crates."tokio_io"."${deps."tokio_reactor"."0.1.7"."tokio_io"}" deps)
      ]);
    };
  features_.tokio_reactor."0.1.7" = deps: f:
    updateFeatures f ({
      crossbeam_utils."${deps.tokio_reactor."0.1.7".crossbeam_utils}".default =
        true;
      ...
      tokio_executor."${deps.tokio_reactor."0.1.7".tokio_executor}".default =
        true;
      tokio_io."${deps.tokio_reactor."0.1.7".tokio_io}".default = true;
      tokio_reactor."0.1.7".default = (f.tokio_reactor."0.1.7".default or true);
    }) [
      (features_.crossbeam_utils."${deps."tokio_reactor"."0.1.7"."crossbeam_utils"}"
        deps)
      (features_.futures."${deps."tokio_reactor"."0.1.7"."futures"}" deps)
      (features_.lazy_static."${deps."tokio_reactor"."0.1.7"."lazy_static"}"
        deps)
      ...
      (features_.parking_lot."${deps."tokio_reactor"."0.1.7"."parking_lot"}"
        deps)
      (features_.slab."${deps."tokio_reactor"."0.1.7"."slab"}" deps)
      (features_.tokio_executor."${deps."tokio_reactor"."0.1.7"."tokio_executor"}"
        deps)
  ...
  crates.tokio_tcp."0.1.2" = deps:
    { features ? (features_.tokio_tcp."0.1.2" deps { }) }:
    buildRustCrate {
      crateName = "tokio-tcp";
      version = "0.1.2";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."tokio_reactor"."${deps."tokio_tcp"."0.1.2"."tokio_reactor"}"
          deps)
      ]);
    };
  features_.tokio_tcp."0.1.2" = deps: f:
    updateFeatures f ({
      ...
      (features_.tokio_reactor."${deps."tokio_tcp"."0.1.2"."tokio_reactor"}"
        deps)
    ];
  ...
  crates.tokio_threadpool."0.1.9" = deps:
    { features ? (features_.tokio_threadpool."0.1.9" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        (crates."crossbeam_deque"."${deps."tokio_threadpool"."0.1.9"."crossbeam_deque"}"
          deps)
        (crates."crossbeam_utils"."${deps."tokio_threadpool"."0.1.9"."crossbeam_utils"}"
          deps)
        ...
        (crates."tokio_executor"."${deps."tokio_threadpool"."0.1.9"."tokio_executor"}"
          deps)
      ]);
    };
  features_.tokio_threadpool."0.1.9" = deps: f:
    updateFeatures f ({
      crossbeam_deque."${deps.tokio_threadpool."0.1.9".crossbeam_deque}".default =
        true;
      crossbeam_utils."${deps.tokio_threadpool."0.1.9".crossbeam_utils}".default =
        true;
      ...
      tokio_executor."${deps.tokio_threadpool."0.1.9".tokio_executor}".default =
        true;
      tokio_threadpool."0.1.9".default =
        (f.tokio_threadpool."0.1.9".default or true);
    }) [
      (features_.crossbeam_deque."${deps."tokio_threadpool"."0.1.9"."crossbeam_deque"}"
        deps)
      (features_.crossbeam_utils."${deps."tokio_threadpool"."0.1.9"."crossbeam_utils"}"
        deps)
      ...
      (features_.tokio_executor."${deps."tokio_threadpool"."0.1.9"."tokio_executor"}"
        deps)
    ];
  ...
  crates.tokio_timer."0.2.5" = deps:
    { features ? (features_.tokio_timer."0.2.5" deps { }) }:
    buildRustCrate {
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."tokio_executor"."${deps."tokio_timer"."0.2.5"."tokio_executor"}"
          deps)
      ]);
    };
  features_.tokio_timer."0.2.5" = deps: f:
    updateFeatures f ({
      futures."${deps.tokio_timer."0.2.5".futures}".default = true;
      tokio_executor."${deps.tokio_timer."0.2.5".tokio_executor}".default =
        true;
      tokio_timer."0.2.5".default = (f.tokio_timer."0.2.5".default or true);
    }) [
      (features_.futures."${deps."tokio_timer"."0.2.5"."futures"}" deps)
      (features_.tokio_executor."${deps."tokio_timer"."0.2.5"."tokio_executor"}"
        deps)
    ];
  ...
  crates.tokio_udp."0.1.3" = deps:
    { features ? (features_.tokio_udp."0.1.3" deps { }) }:
    buildRustCrate {
      crateName = "tokio-udp";
      version = "0.1.3";
      description = ''
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."tokio_reactor"."${deps."tokio_udp"."0.1.3"."tokio_reactor"}"
          deps)
      ]);
    };
  features_.tokio_udp."0.1.3" = deps: f:
    updateFeatures f ({
      ...
      (features_.tokio_reactor."${deps."tokio_udp"."0.1.3"."tokio_reactor"}"
        deps)
    ];
  ...
  crates.try_lock."0.2.2" = deps:
    { features ? (features_.try_lock."0.2.2" deps { }) }:
    buildRustCrate {
      crateName = "try-lock";
      version = "0.2.2";
  ...
  features_.try_lock."0.2.2" = deps: f:
    updateFeatures f ({
  ...
  crates.unicase."1.4.2" = deps:
    { features ? (features_.unicase."1.4.2" deps { }) }:
    buildRustCrate {
      crateName = "unicase";
      version = "1.4.2";
      ...
      buildDependencies = mapFeatures features ([
        (crates."version_check"."${deps."unicase"."1.4.2"."version_check"}"
          deps)
      ]);
      features = mkFeatures (features."unicase"."1.4.2" or { });
    };
  features_.unicase."1.4.2" = deps: f:
    updateFeatures f (rec {
      unicase = fold recursiveUpdate { } [
        {
          "1.4.2"."heapsize" = (f.unicase."1.4.2"."heapsize" or false)
  ...
  crates.unicase."2.1.0" = deps:
    { features ? (features_.unicase."2.1.0" deps { }) }:
    buildRustCrate {
      crateName = "unicase";
      version = "2.1.0";
      description = "A case-insensitive wrapper around strings.";
      ...
      buildDependencies = mapFeatures features ([
        (crates."version_check"."${deps."unicase"."2.1.0"."version_check"}"
          deps)
      ]);
      features = mkFeatures (features."unicase"."2.1.0" or { });
    };
  features_.unicase."2.1.0" = deps: f:
    updateFeatures f ({
  ...
  crates.unicode_normalization."0.1.5" = deps:
    { features ? (features_.unicode_normalization."0.1.5" deps { }) }:
    buildRustCrate {
  ...
  features_.unicode_normalization."0.1.5" = deps: f:
    updateFeatures f ({
      unicode_normalization."0.1.5".default =
        (f.unicode_normalization."0.1.5".default or true);
    }) [ ];
  ...
  crates.url."1.6.1" = deps:
    { features ? (features_.url."1.6.1" deps { }) }:
    buildRustCrate {
      crateName = "url";
      version = "1.6.1";
      ...
      dependencies = mapFeatures features ([
        ...
        (crates."percent_encoding"."${deps."url"."1.6.1"."percent_encoding"}"
          deps)
      ]);
      features = mkFeatures (features."url"."1.6.1" or { });
    };
  features_.url."1.6.1" = deps: f:
    updateFeatures f (rec {
      ...
      url = fold recursiveUpdate { } [
        {
          "1.6.1"."encoding" = (f.url."1.6.1"."encoding" or false)
            || (f.url."1.6.1".query_encoding or false)
            || (url."1.6.1"."query_encoding" or false);
        }
        {
          "1.6.1"."heapsize" = (f.url."1.6.1"."heapsize" or false)
      ...
      (features_.percent_encoding."${deps."url"."1.6.1"."percent_encoding"}"
        deps)
    ];
  ...
  crates.uuid."0.7.1" = deps:
    { features ? (features_.uuid."0.7.1" deps { }) }:
    buildRustCrate {
      crateName = "uuid";
      version = "0.7.1";
      ...
      dependencies = mapFeatures features ([ ]
        ++ (if features.uuid."0.7.1".rand or false then
          [ (crates.rand."${deps."uuid"."0.7.1".rand}" deps) ]
        else
          [ ]));
      features = mkFeatures (features."uuid"."0.7.1" or { });
    };
  features_.uuid."0.7.1" = deps: f:
    updateFeatures f (rec {
      rand."${deps.uuid."0.7.1".rand}".default = true;
      uuid = fold recursiveUpdate { } [
        {
          "0.7.1"."byteorder" = (f.uuid."0.7.1"."byteorder" or false)
            || (f.uuid."0.7.1".u128 or false) || (uuid."0.7.1"."u128" or false);
        }
        {
          "0.7.1"."md5" = (f.uuid."0.7.1"."md5" or false)
            || (f.uuid."0.7.1".v3 or false) || (uuid."0.7.1"."v3" or false);
        }
        {
          "0.7.1"."nightly" = (f.uuid."0.7.1"."nightly" or false)
            || (f.uuid."0.7.1".const_fn or false)
            || (uuid."0.7.1"."const_fn" or false);
        }
        {
          "0.7.1"."rand" = (f.uuid."0.7.1"."rand" or false)
            || (f.uuid."0.7.1".v3 or false) || (uuid."0.7.1"."v3" or false)
            || (f.uuid."0.7.1".v4 or false) || (uuid."0.7.1"."v4" or false)
            || (f.uuid."0.7.1".v5 or false) || (uuid."0.7.1"."v5" or false);
        }
        {
          "0.7.1"."sha1" = (f.uuid."0.7.1"."sha1" or false)
            || (f.uuid."0.7.1".v5 or false) || (uuid."0.7.1"."v5" or false);
        }
        {
          "0.7.1"."std" = (f.uuid."0.7.1"."std" or false)
  ...
  crates.vcpkg."0.2.2" = deps:
    { features ? (features_.vcpkg."0.2.2" deps { }) }:
    buildRustCrate {
      crateName = "vcpkg";
      version = "0.2.2";
      description = ''
  ...
  crates.vec_map."0.8.0" = deps:
    { features ? (features_.vec_map."0.8.0" deps { }) }:
    buildRustCrate {
      crateName = "vec_map";
      version = "0.8.0";
  ...
  features_.vec_map."0.8.0" = deps: f:
    updateFeatures f (rec {
      vec_map = fold recursiveUpdate { } [
        {
          "0.8.0"."serde" = (f.vec_map."0.8.0"."serde" or false)
            || (f.vec_map."0.8.0".eders or false)
            || (vec_map."0.8.0"."eders" or false);
        }
        {
          "0.8.0"."serde_derive" = (f.vec_map."0.8.0"."serde_derive" or false)
            || (f.vec_map."0.8.0".eders or false)
            || (vec_map."0.8.0"."eders" or false);
        }
  ...
  crates.version_check."0.1.3" = deps:
    { features ? (features_.version_check."0.1.3" deps { }) }:
    buildRustCrate {
  ...
  features_.version_check."0.1.3" = deps: f:
    updateFeatures f ({
  ...
  crates.want."0.0.6" = deps:
    { features ? (features_.want."0.0.6" deps { }) }:
    buildRustCrate {
      crateName = "want";
      version = "0.0.6";
  ...
  crates.ws2_32_sys."0.2.1" = deps:
    { features ? (features_.ws2_32_sys."0.2.1" deps { }) }:
    buildRustCrate {
      ...
      buildDependencies = mapFeatures features ([
        (crates."winapi_build"."${deps."ws2_32_sys"."0.2.1"."winapi_build"}"
          deps)
      ]);
    };
  features_.ws2_32_sys."0.2.1" = deps: f:
    updateFeatures f ({
      ...
      (features_.winapi_build."${deps."ws2_32_sys"."0.2.1"."winapi_build"}"
        deps)
    ];
  ...
  features_.xattr."0.1.11" = deps: f:
    updateFeatures f (rec {
      libc."${deps.xattr."0.1.11".libc}".default = true;
      xattr = fold recursiveUpdate { } [
        {
          "0.1.11"."unsupported" = (f.xattr."0.1.11"."unsupported" or false)
