{ lib, fetchFromGitHub, rustPlatform, makeWrapper, openssh, nix-serve, nix-simple-deploy, testVersion }:
...
rustPlatform.buildRustPackage rec {
  ...
  passthru.tests.version = testVersion { package = nix-simple-deploy; };
