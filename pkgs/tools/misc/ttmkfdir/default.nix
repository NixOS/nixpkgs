...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = https://mirror.fsf.org/trisquel/pool/main/t/ttmkfdir/ttmkfdir_3.0.9.orig.tar.gz;
  ...
  patches =
    [ (fetchurl {
        url = https://mirror.fsf.org/trisquel/pool/main/t/ttmkfdir/ttmkfdir_3.0.9-6.diff.gz;
