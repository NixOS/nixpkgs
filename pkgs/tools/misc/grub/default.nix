...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      name = "001_i386-custom-linker-script.patch";
      url = "https://git.savannah.gnu.org/cgit/grub.git/patch/?id=ba2f3511452484710c27cad10160943d98cdc351";
      hash = "sha256-5TLSR5+O8sbyboOsq2V38D7yRxUu3lEpDYD/Wj3JO6Y=";
    })
    (fetchpatch {
      name = "002_revert-autoconf-archive-message.patch";
      url = "https://git.savannah.gnu.org/cgit/grub.git/patch/?id=7b72d6cbd548f714a0122c3cd1dd9a70db10894a";
      hash = "sha256-8kDC79Y06R+A7f+gbGTxq+IoFMPQ62yMc+urreA60Po=";
    })
    (fetchpatch {
      name = "003_revert-linker-check.patch";
      url = "https://git.savannah.gnu.org/cgit/grub.git/patch/?id=1dc2986c7e8480d955f87d276d31400116a21fac";
      hash = "sha256-T1V7Rklc7RNsKTwk2gLoWHxoXUlCM0/mxcnymqUcyRg=";
    })
    (fetchpatch {
      name = "004_i386-drop-ttext-checks.patch";
      url = "https://git.savannah.gnu.org/cgit/grub.git/patch/?id=86283bfd4ed056fba15fcbfb90b9ad91016d838a";
      hash = "sha256-zT6sspZd7B5iPp7XGXIMyTDL/IMACqZ+7zlbQlnVesI=";
    })
  ];
