{ lib, stdenv, fetchurl, fetchpatch, perl, finger_bsd, abook ? null
, gnupg ? null, goobook ? null, khard ? null, mu ? null }:

let perl' = perl.withPackages (p: with p; [ ConvertASN1 perlldap AuthenSASL ]);
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ goobook perl' ] ++ lib.optional (!stdenv.isDarwin) finger_bsd
    ++ lib.optional (abook != null) abook ++ lib.optional (gnupg != null) gnupg
    ++ lib.optional (goobook != null) goobook
    ++ lib.optional (khard != null) khard ++ lib.optional (mu != null) mu;

  configureFlags = [ ] ++ lib.optional (abook != null) "--with-abook"
