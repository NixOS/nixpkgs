...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner =
      "tennox"; # Using my fork because of https://github.com/linux-china/task-keeper/pull/5
    repo = "task-keeper";
  ...
  doCheck =
    false; # tests depend on many packages (java, node, python, sbt, ...) - which I'm not currently willing to set up 😅
