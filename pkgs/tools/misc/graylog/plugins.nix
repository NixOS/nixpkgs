...
in {
  aggregates = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://github.com/cvtienhoven/${pluginName}/releases/download/${version}/${pluginName}-${version}.jar";
    ...
    meta = {
      ...
      description =
        "A plugin that enables users to execute term searches and get notified when the given criteria are met";
    };
  };
  auth_sso = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://github.com/Graylog2/${pluginName}/releases/download/${version}/${pluginName}-${version}.jar";
  ...
  dnsresolver = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://github.com/graylog-labs/${pluginName}/releases/download/${version}/${pluginName}-${version}.jar";
  ...
  enterprise-integrations = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://downloads.graylog.org/releases/graylog-enterprise-integrations/graylog-enterprise-integrations-plugins-${version}.tgz";
    ...
    meta = {
      homepage =
        "https://docs.graylog.org/en/3.3/pages/integrations.html#enterprise";
      description =
  ...
  filter-messagesize = glPlugin rec {
    ...
    meta = {
      homepage =
        "https://github.com/graylog-labs/graylog-plugin-filter-messagesize";
      description =
  ...
  integrations = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://downloads.graylog.org/releases/graylog-integrations/graylog-integrations-plugins-${version}.tgz";
  ...
  spaceweather = glPlugin rec {
    ...
    src = fetchurl {
      url =
        "https://github.com/graylog-labs/${pluginName}/releases/download/${version}/spaceweather-input.jar";
    ...
    meta = {
      ...
      description =
        "Correlate proton density to the response time of your app and the ion temperature to your exception rate.";
    };
  };
