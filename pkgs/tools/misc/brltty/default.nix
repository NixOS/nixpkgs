{ lib, stdenv, fetchurl, pkg-config, python3, bluez, tcl, acl, kmod, coreutils
, shadow, util-linux, udev, alsaSupport ? stdenv.isLinux, alsa-lib
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ bluez ] ++ lib.optional alsaSupport alsa-lib
