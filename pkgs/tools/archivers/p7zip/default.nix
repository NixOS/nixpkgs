{ stdenv, fetchFromGitHub, lib, removeUnfreeCode ? false }:
...
stdenv.mkDerivation rec {
  ...
  '' + lib.optionalString removeUnfreeCode ''
  ...
  meta = {
    ...
    license = if removeUnfreeCode then lib.licenses.lgpl2Plus else lib.licenses.unfree;
  };
}
