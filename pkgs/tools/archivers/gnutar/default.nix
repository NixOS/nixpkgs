{ lib, stdenv, fetchurl, makeBinaryWrapper, autoreconfHook, acl, libintl }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ makeBinaryWrapper ] ++ lib.optional stdenv.isDarwin autoreconfHook;
  ...
  preFixup = ''
    wrapProgram $out/bin/tar \
      --add-flags "\''${GNUTAR_REPRODUCIBLE:+--mtime="@''$SOURCE_DATE_EPOCH" --owner=0 --group=0 --numeric-owner --sort=name}"
  '';
