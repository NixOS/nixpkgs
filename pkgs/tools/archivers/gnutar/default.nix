{ stdenv, fetchurl, autoreconfHook, acl, writeText }:
...
stdenv.mkDerivation rec {
  ...
  # set TAR_OPTIONS environment variable to make archives reproducible
  # https://github.com/NixOS/nixpkgs/issues/106643
  setupHook = writeText "setup-hook" ''
    export TAR_OPTIONS="''${SOURCE_DATE_EPOCH:+--mtime="@$SOURCE_DATE_EPOCH"} --sort=name ''${TAR_OPTIONS:-}"
  '';
