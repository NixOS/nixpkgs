{ lib, stdenv, fetchurl, texlive, zlib, libiconv, libpng, libX11, freetype, gd
, libXaw, icu, ghostscript, libXpm, libXmu, libXext, perl, perlPackages
, python3Packages, pkg-config, libpaper, graphite2, zziplib, harfbuzz, potrace
, gmp, mpfr, brotli, cairo, pixman, xorg, clisp, biber, woff2, xxHash
...
in rec { # un-indented
  ...
  core-big = stdenv.mkDerivation { # TODO: upmendex
    ...
    postConfigure = let luajit = lib.optionalString withLuaJIT ",luajit";
    in ''
