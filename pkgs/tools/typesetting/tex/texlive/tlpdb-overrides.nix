{ stdenv, lib, tlpdb, tlcontrib, bin, tlpdbxz, tlcontribxz, tl
, installShellFiles
...
let
  ...
  tlcontribVersion = tlcontrib."00texlive.config";
...
in lib.recursiveUpdate orig rec {
  ...
  texdoc = {
    extraRevision = "-tlpdb${toString tlpdbVersion.revision}-tlcontrib${toString tlcontribVersion.revision}";
    extraVersion = "-tlpdb-${toString tlpdbVersion.revision}-tlcontrib-${toString tlcontribVersion.revision}";
