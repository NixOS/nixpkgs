{ lib, stdenv, ocaml, makeWrapper, fetchsvn, ghostscript, imagemagick, perl, poppler, tesseract, unpaper }:
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    wrapProgram $out/bin/pdfsandwich --prefix PATH : ${lib.makeBinPath [ imagemagick ghostscript poppler unpaper tesseract ]}
