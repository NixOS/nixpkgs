...
- README-capt-2.7xUS.txt (This document)
...
Object Printer:
    ...
    Canon LBP6200 (CNCUPSLBP6200CAPTS.ppd)
    LBP6200
...
- If you are using LBP7200Cdn, LBP6300dn, LBP6200, LBP6018, or LBP6000, blank 
  paper is not output according to Glue Code specifications, even if the print 
  job includes blank pages.
