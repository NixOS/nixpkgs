...
let
  ...
  # Don't do this in real code, as this relies on builtins.currentSystem, and
  # it reinvokes Nixpkgs, which is somewhat costly. Get your pkgs somewhere else.
  # pkgs = import ../../.. { };

  traceList = l: v: lib.foldl' (a: b: builtins.trace b a) v l;
