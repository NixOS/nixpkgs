...
in
{
  imports = [
    ...
    # spuriously reject. (The genuine-conflict case -- two DIFFERENT providers at
    # one leaf, which still throws -- is exercised by `dupConflict` once routing
    # forces `module.loc`; added alongside `defaultProviderName`.)
  ...
  config = {
    ...
    # Both providers registered for the duplicate-merge contract type.
