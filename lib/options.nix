...
rec {
  ...
  */
  ...
  /**
    ...
    : Attribute set containing none or some of the following attributes.
      ...
      `defaultText`
      : Optional textual representation of the default, for the manual.
  ...
  */
  ...
  /**
    Alias of mkPackageOption.

    Previously used to create options with markdown
  ...
  */
  ...
  /**
    ...
    : Attribute set containing the following attributes.
      ...
      `message`
      : Message to display when the option is not unique.
        Type: A string or anything that can be coerced to a string.

      `merge`
      : Optional merge function to use when the option is not unique. Default: `loc: defs: (head defs).value`
  ...
  */
  ...
  /**
    ...
    `list`
    : List of attribute sets. Each attribute set must have a "value" key.
  ...
  */
  ...
  /**
    ...
    `list`
    : List of attribute sets. Each attribute set must have a "file" key.
  ...
  */
  ...
  /**
    Transforms a list of NixOS options into a list of documentation items. These items can be used to render documentation in various formats.

    # Inputs

    `options`
    : List of NixOS options

    # Documentation items

    Each documentation item is an attribute set with the following keys:
    ...
    `visible`
    : Optional boolean indicating whether the option should show up in the manual. (default: `true`)
      Convention `false` to hide the option and any sub-options from submodules. "shallow" to hide only sub-options.

    `readOnly`
    : Optional boolean indicating whether the option can be set only once.

    `type`
    : Optional string describing the option type.
    ...
    `relatedPackages`
    : Optional related packages used in the manual.
  ...
  */
  ...
  /**
    For use in the `defaultText` and `example` option attributes.
  ...
  */
  ...
  /**
    ...
    `v`
    : Any value to print the warning on.
  ...
  */
  ...
  /**
    Pretty prints a list of definitions
    ...
    # Examples
    :::{.example}
    ## `lib.options.showDefs` usage example

    ```nix
    showDefs [ { file ="foo.nix"; value = 1;} { file = "bar.nix"; value = "bar"; } ]
    => "\n- In `foo.nix': 1\n- In `bar.nix': \"bar\""
    ...
    ```
    showDefs :: [ { file :: string; value :: a; } ] -> string
    ```
  */
