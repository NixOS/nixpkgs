...
rec {
  ...
  */
  ...
  /**
    ...
    which can be overridden by `args`. This function is intended to be partially
    ...
    ## Create a custom `callPackage` function
      ...
      This custom `callPackage` will call whichever function
      (or file with a function) passed to it with `libfoo` and `libbar` in the
      function arguments.
