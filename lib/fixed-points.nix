...
rec {
  /**
    ...
    **Relation to syntactic recursion**
    ...
    For context, Nix lets you define attributes in terms of other attributes syntactically using the [`rec { }` syntax](https://nix.dev/manual/nix/stable/language/constructs.html#recursive-sets).
