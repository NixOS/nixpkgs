  ...
  outer_types =
    rec {
      ...
      types = rec {
        ...
        string =
          warn "types.string is deprecated because it quietly concatenates strings"
            (separatedString "");
                ...
                let
                  ...
                  matched =
                    let
                      ...
                      fallback = { name = "name"; };
                    in
                    findFirst ({ path, ... }: all (v: v == true) (zipListsWith equals loc path)) fallback nameAttrs;
