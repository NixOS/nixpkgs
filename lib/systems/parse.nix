  ...
  mkSkeletonFromList = l: {
    ...
    "3" = # Awkwards hacks, beware!
      ...
      then { cpu = elemAt l 0; vendor = "apple"; kernel = elemAt l 2; }
        ...
        if (elemAt l 1 == "linux") || (elemAt l 2 == "gnu")
        then { cpu = elemAt l 0; kernel = elemAt l 1; abi = elemAt l 2; }
        else
          if (elemAt l 2 == "mingw32") # autotools breaks on -gnu for window
          then { cpu = elemAt l 0; vendor = elemAt l 1; kernel = "windows"; }
          else
            if (elemAt l 2 == "wasi")
            then { cpu = elemAt l 0; vendor = elemAt l 1; kernel = "wasi"; }
            else
              if hasPrefix "netbsd" (elemAt l 2)
              then { cpu = elemAt l 0; vendor = elemAt l 1; kernel = elemAt l 2; }
              else
                if (elem (elemAt l 2) [ "eabi" "eabihf" "elf" ])
        ...
        parsed = {
          ...
          kernel =
            ...
            then getKernel "darwin"
              ...
              if hasPrefix "netbsd" args.kernel
          ...
          abi =
            ...
            then getAbi args.abi
              ...
              if isLinux parsed || isWindows parsed
              then
                if isAarch32 parsed
                then
