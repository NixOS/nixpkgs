...
These types are based on the [component type](https://cyclonedx.org/docs/1.7/json/#components_items_type) in the [CycloneDX SBOM](https://cyclonedx.org) &
[`SoftwarePurpose`](https://spdx.github.io/spdx-spec/v3.0.1/model/Software/Vocabularies/SoftwarePurpose/) vocabulary in the [SPDX SBOM](https://spdx.dev/) formats.
