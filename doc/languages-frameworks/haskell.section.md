...
These will also be set in the [`passthru.env` attribute in the returned derivation](#haskell-development-environments), but will not be set in a [`shellFor`](#haskell-shellFor) that includes this package.
