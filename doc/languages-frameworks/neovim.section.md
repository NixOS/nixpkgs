...
- `plugins`: A list of plugins to add to the wrapper. If a plugin is missing from nixpkgs, you can package it yourself as, described in [](#what-if-your-favourite-vim-plugin-isnt-already-packaged).
