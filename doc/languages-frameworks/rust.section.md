...
::: {.note}
The following projects cannot be used within Nixpkgs, since [Import From Derivation](https://nix.dev/manual/nix/unstable/language/import-from-derivation) (IFD) is disallowed in Nixpkgs.
