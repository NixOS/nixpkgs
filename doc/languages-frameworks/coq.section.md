...
For more flexibility, you can use `coq.withPackages'` with a list (which can make use of arbitrary package sets).


```nix
coq_8_20.withPackages' [
  coqPackages_8_19.mathcomp
  coqPackages_8_20.bignums
]
```
