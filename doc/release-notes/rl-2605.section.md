...
- `maven.buildMaven` has been removed, as it relied on mvn2nix, which is outdated and is not used in nixpkgs. Use [`maven.buildMavenPackage`](#maven-buildmavenpackage) instead.
