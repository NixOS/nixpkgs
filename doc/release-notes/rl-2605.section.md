...
- A new `programs.motus` module has been added for the [motus](https://github.com/oleiade/motus) password generator. Clipboard support is enabled automatically on systems with a graphical session and disabled on headless systems.
