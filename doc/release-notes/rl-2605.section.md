...
- `comodoro` has been updated from `0.1.2` to `1.0.0`, introducing few breaking changes. Check out the [release note](https://github.com/pimalaya/comodoro/releases/tag/v1.0.0) for more details.
