...
- `netbootxyz-efi` has been updated from `2.0.88` to `3.0.0`. Version `3.0.0` includes breaking changes. For more information read the [release notes for 3.0.0](https://github.com/netbootxyz/netboot.xyz/releases/tag/3.0.0).
