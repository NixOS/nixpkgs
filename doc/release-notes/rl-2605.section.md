...
- `cataclysmDDA` has been renamed to `cataclysmPackages`.

- `cataclysmDDA.stable` has been renamed to `catclysm.dark-days-ahead`.

- `cataclysmDDA.stable.curses` has been renamed to `cataclysmPackages.dark-days-ahead`.

- `cataclysmDDA.stable.tiles` has been renamed to `cataclysmPackages.dark-days-ahead.withTiles`.

- `cataclysmDDA.git` has been renamed to `cataclysmPackages.dark-days-ahead-unstable`.

- `cataclysmDDA.git.curses` has been renamed to `cataclysmPackages.dark-days-ahead-unstable`.

- `cataclysmDDA.git.tiles` has been renamed to `cataclysmPackages.dark-days-ahead-unstable.withTiles`.

- `cataclysmDDA.buildMod` has been renamed to `cataclysmPackages.pkgs.buildMod`.

- `cataclysmDDA.buildSoundPack` has been renamed to `cataclysmPackages.pkgs.buildSoundPack`.

- `cataclysmDDA.buildTileSet` has been renamed to `cataclysmPackages.pkgs.buildTileSet`.

- `cataclysmDDA.stable` has been renamed to `cataclysmPackages.dark-days-ahead`.

- `cataclysmDDA.pkgs.tileset.UndeadPeople` has been renamed to `cataclysmPackages.pkgs.tileSets.undead-people`.

- `cataclysmDDA.pkgs.mod` has been renamed to `cataclysmPackages.pkgs.mods`.

- `cataclysmDDA.pkgs.soundpack` has been renamed to `cataclysmPackages.pkgs.soundPacks`.

- `cataclysmDDA.pkgs.tileset` has been renamed to `cataclysmPackages.pkgs.tileSets`.
