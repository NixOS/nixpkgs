...
- `python313Packages.kubernetes` was upgraded to v33. See the [upstream changelogs](https://github.com/kubernetes-client/python/blob/release-33.0/CHANGELOG.md) for breaking changes.
