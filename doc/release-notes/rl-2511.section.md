...
- `ghostty` now supports a `settings` override option. This is meant to be an attribute set mapping to [Ghostty's native configuration](https://ghostty.org/docs/config).
