...
- `duckduckgo-search` has been updated to v9+ and therefore has be renamed to `ddgs`.
  If you'd like to keep using v8, the package has been renamed `duckduckgo-search_8`.
