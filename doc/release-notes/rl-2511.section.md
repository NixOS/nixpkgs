...
- `searx` was updated to use `envsubst` instead of `sed` for parsing config environment variables.
  For information on how to migrate see the [usage](https://github.com/a8m/envsubst) of `envsubst` and view the updated examples.
