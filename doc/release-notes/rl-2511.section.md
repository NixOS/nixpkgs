...
- `tauon` has been updated to 8.1.0 which changes the schema of the user music library
  database. See [uptream changelog](https://github.com/Taiko2k/Tauon/releases/tag/v8.1.0)
  for instructions how to revert it back if going back to an older version is necessary.
