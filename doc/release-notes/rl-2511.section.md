...
- `t-rex` has been removed due to being broken in nixpkgs and the upstream maintainer replacing it with the [BBOX project](https://www.bbox.earth/). To migrate to BBOX refer the [migration guide](https://www.bbox.earth/docs/tile-server/guides/#migration-from-t-rex).
