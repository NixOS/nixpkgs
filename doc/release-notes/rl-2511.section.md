...
- `ferretdb` has been updated to `>= 2.1.0`. Due to incompatibilities in previous releases, DocumentDB can't be updated in place, even with a manual ALTER EXTENSION UPDATE query or other means.
