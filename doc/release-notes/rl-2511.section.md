...
- `rofi` has been updated to `2.0.0`. `rofi-wayland` has been merged into `rofi` and `rofi-wayland-unwrapped` has been merged into `rofi-unwrapped`. For more information and instructions see the [v2.0.0 changelog entry](https://github.com/davatorium/rofi/releases/tag/2.0.0).

- `rofi` has been updated to `2.0.0`. `rofi-emoji-wayland` has been merged into `rofi-emoji`. For more information and instructions see the [v2.0.0 changelog entry](https://github.com/davatorium/rofi/releases/tag/2.0.0).
