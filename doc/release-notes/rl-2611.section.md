...
- `terminal-notifier` was updated from version 2.0.0 to version 3.1.0 which adds native support for Apple silicon. See the "[Differences from version 2](https://github.com/julienXX/terminal-notifier#differences-from-version-2)" for more details.
