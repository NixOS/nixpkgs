...
- `gitbeaker-cli` has been updated from `43.8.0` to `44.0.0`. See the [release notes](https://github.com/jdalrymple/gitbeaker/releases/tag/43.0.0) for breaking changes.
