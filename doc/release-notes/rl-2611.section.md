...
- `nexusmods-app` has been removed, as it was archived upstream during an early stage of development and no longer receives updates.
  It is recommended to switch to an actively maintained mod manager.
  Users who still require NexusMods.App can find a community-maintained package at: <https://github.com/MattSturgeon/nma-nix>
