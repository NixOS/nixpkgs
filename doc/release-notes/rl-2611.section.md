...
- GCC has been updated from GCC 15 to GCC 16.
  This introduces some backwards incompatible changes; Refer to the [upstream porting guide](https://gcc.gnu.org/gcc-16/porting_to.html) for details.
