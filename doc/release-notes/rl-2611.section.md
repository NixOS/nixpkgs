...
- `astal`, `ags` and `ags_1` have been dropped, as they were largely untested and the main and only consumer (`hyprpanel`) has been also dropped. Instead, use upstream flake.
