...
- `dependency-track` has been updated to >= 5.0.0, this includes breaking changes to config and API. Additionally a manual database migration is required. See the [upstream migration guide](https://dependencytrack.github.io/docs/next/guides/administration/migrating-from-v4/) for more information.
