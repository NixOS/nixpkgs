...
- `fedimint` has been updated to `0.10.1`. This removes the legacy Bitcoin
  RPC configuration and Electrum support. Direct package users must migrate
  their deployment configuration following the [upstream 0.10.1 upgrade
  guidance](https://github.com/fedimint/fedimint/releases/tag/v0.10.1) and
  ...
  [0.10.0](https://github.com/fedimint/fedimint/releases/tag/v0.10.0) release
  notes.
