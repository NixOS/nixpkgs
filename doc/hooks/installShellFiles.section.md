...
This hook helps with installing artifacts like binaries, manpages and shell completions. It exposes the following functions that can be used from your `postInstall` hook:

- `installBin`
- `installManPage`
- `installShellCompletion`

The `installBin` function takes one or more paths to files to install as executable files. This function will place them into [`outputBin`](#outputbin).
