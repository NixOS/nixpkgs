...
If applicable, the `class` should match the "prefix" of the attributes used in (experimental) [flakes](https://nix.dev/manual/nix/stable/command-ref/new-cli/nix3-flake.html#description). Some examples are:
