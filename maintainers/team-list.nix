...
with lib.maintainers; {
  ...
  beam = {
    members = [ankhers Br1ght0ne DianaOlympos gleber happysalada minijackson yurrriq];
    githubTeams = ["beam"];
  ...
  matrix = {
    members = [ma27 fadenb mguentner ralith dandellion sumnerevans nickcao teutat3s];
